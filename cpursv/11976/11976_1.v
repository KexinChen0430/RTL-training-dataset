...
module ram_ctl(input  pixclk,
  ...
  wire  apply_lin = !(sixbitlin | colres);
  ...
  always @(posedge pixclk or negedge hresetn)
      if (!hresetn) 
        ...
        begin
          p0_red_pal <= apply_lin ? {palr2dac_evn[7:2],palr2dac_evn[7:6]} : palr2dac_evn;
          p0_grn_pal <= apply_lin ? {palg2dac_evn[7:2],palg2dac_evn[7:6]} : palg2dac_evn;
          p0_blu_pal <= apply_lin ? {palb2dac_evn[7:2],palb2dac_evn[7:6]} : palb2dac_evn;
        end
endmodule
