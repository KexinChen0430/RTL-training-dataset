...
module EHRU_6(CLK,read_0,write_0,EN_write_0,read_1,write_1,EN_write_1,
  ...
  input  EN_write_3;
  output [(0-1)+DATA_SZ:0] read_4;
  input  [(0-1)+DATA_SZ:0] write_4;
  input  EN_write_4;
  output [(0-1)+DATA_SZ:0] read_5;
  input  [(0-1)+DATA_SZ:0] write_5;
  input  EN_write_5;
  reg  [(0-1)+DATA_SZ:0] r;
  ...
  wire [(0-1)+DATA_SZ:0] wire_5;
  wire [(0-1)+DATA_SZ:0] wire_6;
