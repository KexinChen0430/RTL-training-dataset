...
module EHRU_6(CLK,read_0,write_0,EN_write_0,read_1,write_1,EN_write_1,
  ...
  input  EN_write_2;
  output [DATA_SZ+(0-1):0] read_3;
  input  [DATA_SZ+(0-1):0] write_3;
  input  EN_write_3;
  output [DATA_SZ+(0-1):0] read_4;
  input  [DATA_SZ+(0-1):0] write_4;
  input  EN_write_4;
  output [DATA_SZ+(0-1):0] read_5;
  input  [DATA_SZ+(0-1):0] write_5;
  input  EN_write_5;
  reg  [DATA_SZ+(0-1):0] r;
  ...
  wire [DATA_SZ+(0-1):0] wire_4;
  wire [DATA_SZ+(0-1):0] wire_5;
  wire [DATA_SZ+(0-1):0] wire_6;
