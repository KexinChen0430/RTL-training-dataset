  ...
  always @(posedge clock or posedge reset)
      begin
        if (reset == 1'b1) out <= seed;
          ...
          begin
            out[n+(-1)] <= ((((~in[n+(-1)] | in[n+(-1)]) & (in[n+(-1)] | poly[n+(-1)])) & in[n+(-1)]) | (((~in[n+(-1)] | in[n+(-1)]) & (in[n+(-1)] | poly[n+(-1)])) & out[0])) & (((poly[n+(-1)] & ~in[n+(-1)]) | ~(poly[n+(-1)] & out[0])) & (~(poly[n+(-1)] & out[0]) | out[0]));
            for (i = 0; i < (n+(-1)); i = 1+i)
                begin
                  out[i] <= ((((~in[i] | ~(out[0] & poly[i])) & out[0]) & poly[i]) | ((out[1+i] & ~(((~in[i] | ~(out[0] & poly[i])) & (in[i] & (~in[i] | ~(out[0] & poly[i])))) ^ ((~in[i] | ~(out[0] & poly[i])) & (((~in[i] | ~(out[0] & poly[i])) & out[0]) & poly[i])))) | (~(out[0] & poly[i]) & in[i]))) & (((((~(out[0] & poly[i]) & in[i]) & ~out[1+i]) | ~(((~in[i] | ~(out[0] & poly[i])) & (in[i] & (~in[i] | ~(out[0] & poly[i])))) ^ ((~in[i] | ~(out[0] & poly[i])) & (((~in[i] | ~(out[0] & poly[i])) & out[0]) & poly[i])))) | (~out[1+i] & (~in[i] & out[0]))) & (poly[i] | (((~(out[0] & poly[i]) & in[i]) & ~out[1+i]) | ~(((~in[i] | ~(out[0] & poly[i])) & (in[i] & (~in[i] | ~(out[0] & poly[i])))) ^ ((~in[i] | ~(out[0] & poly[i])) & (((~in[i] | ~(out[0] & poly[i])) & out[0]) & poly[i]))))));
                end
          end
