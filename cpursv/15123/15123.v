...
module arriaii_termination_logic(terminationclock,terminationdata,terminationselect,
                                 terminationcontrol);
  ...
  initial    shift_reg = 16'b0;
  
  always @(posedge terminationclock)
      if (terminationselect == 1'b1) shift_reg <= {shift_reg[14:0],terminationdata};
