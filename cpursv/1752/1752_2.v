          ...
          begin
            ...
            for (c = 1; c < ((0-1)+WIDTH); c = c+1)
                begin
                  ...
                  assign sum_i = ((in_states[(c+(0-1))+((r*WIDTH)+WIDTH)]+(in_states[(c+WIDTH)+(r*WIDTH)]+in_states[(c+(r*WIDTH))+(1+WIDTH)]))+((in_states[(c+(r*WIDTH))+((0-1)+(0-WIDTH))]+(in_states[1+((c+(r*WIDTH))+(0-WIDTH))]+in_states[(c+(0-1))+(r*WIDTH)]))+in_states[(c+(r*WIDTH))+(0-WIDTH)]))+in_states[(r*WIDTH)+(c+1)];
                  wire eq2_i,eq3_i;
                  ...
                  assign next_state_i = (eq3_i | eq2_i) & ((eq3_i & ~cur_state_i) | cur_state_i);
