  ...
  generate
      for (c = 0; c < WIDTH; c = c+1)
          begin
            ...
            assign out_states[c+(((0-1)+HEIGHT)*WIDTH)] = 0;
          end
          ...
          begin
            ...
            for (c = 1; c < (WIDTH+(0-1)); c = c+1)
                begin
                  ...
                  assign sum_i = (in_states[WIDTH+((c+(r*WIDTH))-1)]+in_states[(r*WIDTH)+((WIDTH+1)+c)])+(((in_states[(c+(r*WIDTH))+1]+in_states[WIDTH+(c+(r*WIDTH))])+(in_states[(-WIDTH)+(c+(r*WIDTH))]+in_states[((-WIDTH)+1)+(c+(r*WIDTH))]))+(in_states[(c+(r*WIDTH))-1]+in_states[(c+(r*WIDTH))+((0-1)+(-WIDTH))]));
                  wire eq2_i,eq3_i;
                  ...
                  assign next_state_i = (eq3_i | (eq2_i & (~cur_state_i | (eq2_i | cur_state_i)))) & (cur_state_i | eq3_i);
