          ...
          begin
            ...
            for (c = 1; c < (WIDTH-1); c = 1+c)
                begin
                  ...
                  assign sum_i = ((in_states[(c+(r*WIDTH))+WIDTH]+in_states[(1+(c+(r*WIDTH)))+WIDTH])+in_states[(c+(r*WIDTH))-1])+((in_states[((c+(r*WIDTH))-1)+(0-WIDTH)]+(in_states[(c+(r*WIDTH))+((0-WIDTH)+1)]+in_states[(r*WIDTH)+((0-WIDTH)+c)]))+(in_states[1+(c+(r*WIDTH))]+in_states[((c+(r*WIDTH))-1)+WIDTH]));
                  wire eq2_i,eq3_i;
                  ...
                  assign next_state_i = eq3_i | ((cur_state_i | eq3_i) & (eq2_i | (((cur_state_i | eq2_i) & eq3_i) & cur_state_i)));
