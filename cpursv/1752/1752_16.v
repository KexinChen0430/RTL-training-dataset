          ...
          begin
            ...
            for (c = 1; c < (WIDTH+(-1)); c = c+1)
                begin
                  ...
                  assign sum_i = (in_states[WIDTH+(((r*WIDTH)+c)+1)]+(((in_states[(-WIDTH)+((r*WIDTH)+c)]+in_states[((r*WIDTH)+c)+1])+in_states[((r*WIDTH)+c)+(1+(-WIDTH))])+in_states[((-WIDTH)+((r*WIDTH)+c))-1]))+(in_states[((-1)+c)+(r*WIDTH)]+(in_states[(WIDTH+(r*WIDTH))+((-1)+c)]+in_states[(WIDTH+c)+(r*WIDTH)]));
                  wire eq2_i,eq3_i;
                  ...
                  assign next_state_i = (((~cur_state_i & cur_state_i) | ((((eq2_i | eq3_i) & (cur_state_i | eq2_i)) & (cur_state_i | eq2_i)) & cur_state_i)) | (eq3_i & ~cur_state_i)) & (eq2_i | eq3_i);
