...
module flt_fx_mult(input  clk,
  ...
  always @* 
      sfl_1 = (sbfl_1 | (sfx_1 & (sbfl_1 | ~sbfl_1))) & (~sbfl_1 | ((sbfl_1 & ((sfx_1 & (sbfl_1 | ~sbfl_1)) & (((sbfl_1 & ~sfx_1) | ((sfx_1 & (sbfl_1 | ~sbfl_1)) & ~sfx_1)) | (~sfx_1 | sfx_1)))) ^ ((sbfl_1 & (((sbfl_1 & ~sfx_1) | ((sfx_1 & (sbfl_1 | ~sbfl_1)) & ~sfx_1)) | (~sfx_1 | sfx_1))) & sbfl_1)));
