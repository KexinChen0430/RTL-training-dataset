...
module flt_fx_mult(input  clk,
  ...
  always @* 
      sfl_1 = (((sfx_1 | ~sfx_1) | ((sbfl_1 & ~sfx_1) | (~sfx_1 & ((sfx_1 | (sbfl_1 & ~sfx_1)) & ~sbfl_1)))) & ((sfx_1 | ~sfx_1) & ((sbfl_1 & ~sfx_1) | (sfx_1 & sbfl_1)))) ^ (sfx_1 & ((sfx_1 | ~sfx_1) | ((sbfl_1 & ~sfx_1) | (~sfx_1 & ((sfx_1 | (sbfl_1 & ~sfx_1)) & ~sbfl_1)))));
  
  always @* 
      efl_1 = (-nom_shft_1)+(8'h10+ebfl_1);
