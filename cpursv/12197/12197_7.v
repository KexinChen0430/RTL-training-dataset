  ...
  always @(posedge clock)
      begin
        ...
        if (idle_Special == no_idle) 
          begin
            zout_Multiply[35] <= ~((a_sign & ((a_sign | ~a_sign) | ((b_sign & ~a_sign) | ((~b_sign & (b_sign | a_sign)) & ~a_sign)))) ^ (((a_sign | ~a_sign) | ((b_sign & ~a_sign) | ((~b_sign & (b_sign | a_sign)) & ~a_sign))) & ((a_sign | ~a_sign) & (b_sign & (a_sign | ~a_sign)))));
