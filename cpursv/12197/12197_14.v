...
module MultiplyState_Y(input  [32:0] aout_Special,
  ...
  assign a_exponent = aout_Special[31:24]+(0-127);
  assign a_mantissa = {aout_Special[23:0]};
  assign b_sign = bout_Special[32];
  assign b_exponent = bout_Special[31:24]+(0-127);
  ...
  always @(posedge clock)
      begin
        ...
        if (idle_Special == no_idle) 
          begin
            zout_Multiply[35] <= ~((((~a_sign & a_sign) | (a_sign & ~b_sign)) & (((((((((a_sign | ~a_sign) & b_sign) & b_sign) & b_sign) ^ (b_sign & (b_sign & a_sign))) & ~a_sign) ^ ((((a_sign & (b_sign | ~b_sign)) & b_sign) ^ ((a_sign & (b_sign | ~b_sign)) & (b_sign & a_sign))) & ~a_sign)) | (~a_sign & (~b_sign & (b_sign | a_sign)))) | (a_sign | ~a_sign))) ^ ((~((((((a_sign | ~a_sign) & b_sign) & b_sign) & b_sign) ^ (b_sign & (b_sign & a_sign))) & (((((((((a_sign | ~a_sign) & b_sign) & b_sign) & b_sign) ^ (b_sign & (b_sign & a_sign))) & ~a_sign) ^ ((((a_sign & (b_sign | ~b_sign)) & b_sign) ^ ((a_sign & (b_sign | ~b_sign)) & (b_sign & a_sign))) & ~a_sign)) | (~a_sign & (~b_sign & (b_sign | a_sign)))) | (a_sign | ~a_sign))) & ((((a_sign & (b_sign | ~b_sign)) & b_sign) ^ ((a_sign & (b_sign | ~b_sign)) & (b_sign & a_sign))) & (((((((((a_sign | ~a_sign) & b_sign) & b_sign) & b_sign) ^ (b_sign & (b_sign & a_sign))) & ~a_sign) ^ ((((a_sign & (b_sign | ~b_sign)) & b_sign) ^ ((a_sign & (b_sign | ~b_sign)) & (b_sign & a_sign))) & ~a_sign)) | (~a_sign & (~b_sign & (b_sign | a_sign)))) | (a_sign | ~a_sign)))) | (((((((a_sign | ~a_sign) & b_sign) & b_sign) & b_sign) ^ (b_sign & (b_sign & a_sign))) & (((((((((a_sign | ~a_sign) & b_sign) & b_sign) & b_sign) ^ (b_sign & (b_sign & a_sign))) & ~a_sign) ^ ((((a_sign & (b_sign | ~b_sign)) & b_sign) ^ ((a_sign & (b_sign | ~b_sign)) & (b_sign & a_sign))) & ~a_sign)) | (~a_sign & (~b_sign & (b_sign | a_sign)))) | (a_sign | ~a_sign))) & ~((((a_sign & (b_sign | ~b_sign)) & b_sign) ^ ((a_sign & (b_sign | ~b_sign)) & (b_sign & a_sign))) & (((((((((a_sign | ~a_sign) & b_sign) & b_sign) & b_sign) ^ (b_sign & (b_sign & a_sign))) & ~a_sign) ^ ((((a_sign & (b_sign | ~b_sign)) & b_sign) ^ ((a_sign & (b_sign | ~b_sign)) & (b_sign & a_sign))) & ~a_sign)) | (~a_sign & (~b_sign & (b_sign | a_sign)))) | (a_sign | ~a_sign))))));
            zout_Multiply[34:27] <= (b_exponent+1)+a_exponent;
