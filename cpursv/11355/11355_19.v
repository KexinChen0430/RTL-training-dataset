...
module AXI_SP32B1024(input  CLK,
                     input  RST,
                     input  axi_awvalid,
                     output axi_awready,
  ...
  always @(posedge CLK)
      begin
        if (RST == 1'b0) 
          ...
          begin
            if ((axi_rready == 1'b1) && (reading2 == 1'b1) && 
                (reading1 == 1'b1)) 
              begin
                reading1 <= 1'b0;
              end
  ...
  always @(posedge CLK)
      begin
        if (RST == 1'b0) 
          ...
          begin
            if ((writting2 == 1'b1) && (axi_bready == 1'b1) && 
                ((writting3 == 1'b1) && (writting1 == 1'b1))) 
              begin
                writting3 <= 1'b0;
              end
            else if (writting2 == 1'b1) 
              begin
                writting3 <= 1'b1;
              end
