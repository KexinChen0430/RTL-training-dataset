...
module DRAMReader(input  ACLK,
  ...
  assign M_AXI_RREADY = DATA_READY_DOWNSTREAM && (r_state == RWAIT);
      ...
      begin
        if (ARESETN == 0) 
          ...
          case (r_state)
            ...
            RWAIT: begin
                  if (DATA_READY_DOWNSTREAM && M_AXI_RVALID) 
                    begin
                      if ((b_count+(0-8)) == 0) r_state <= IDLE;
