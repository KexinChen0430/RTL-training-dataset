...
module axis_alex(input  wire aclk,
                 input  wire aresetn,
  ...
  always @* 
      begin
        ...
        if (int_enbl_reg) 
          begin
            int_cntr_next = 1'b1+int_cntr_reg;
          end
        ...
        if (int_cntr_reg[11] & int_cntr_reg[7]) 
          begin
            int_cntr_next = 12'd0;
            int_load_next = 2'd0;
            int_enbl_next = 1'b0;
  ...
  assign alex_data[1] = ~int_cntr_reg[11] & int_cntr_reg[6];
  assign alex_data[2] = int_cntr_reg[11] & (int_load_reg[0] & int_cntr_reg[6]);
  assign alex_data[3] = int_cntr_reg[6] & (int_cntr_reg[11] & int_load_reg[1]);
endmodule
