...
module Counter_x(clk,rst,clk0,clk1,clk2,counter_we,counter_val,counter_ch,
                 counter0_OUT,counter1_OUT,counter2_OUT,counter_out);

  input  clk,rst;
  input  wire clk0,clk1,clk2;
        ...
        if (rst) 
          ...
          begin
            case (counter_Ctrl[2:1])
              ...
              2'b01: begin
                    sq1 <= counter1[32];
                    if (sq1 != counter1[32]) counter1[31:0] <= {1'b0,counter1_Lock[31:1]};
                    else counter1 <= (0-1'b1)+counter1;
                  end
        ...
        if (rst) 
          ...
          begin
            case (counter_Ctrl[2:1])
              ...
              2'b01: begin
                    sq2 <= counter2[32];
                    if (sq2 != counter2[32]) counter2[31:0] <= {1'b0,counter2_Lock[31:1]};
                    else counter2 <= counter2+(0-1'b1);
                  end
  ...
  assign counter_out = curr_ch[1] ? counter2[31:0] : 
                       curr_ch[0] ? counter1[31:0] : counter0[31:0];
endmodule
