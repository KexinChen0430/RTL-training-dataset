...
module arbiter_ibus(wbm_adr_o,wbm_dat_o,wbm_sel_o,wbm_we_o,wbm_cyc_o,wbm_stb_o,
  ...
  assign wbm_ack_i = (((slave_sel[1] | wbs0_ack_o) & wbs1_ack_o) & ((slave_sel[1] | ((wbs0_rty_o | slave_sel[1]) & slave_sel[0])) | slave_sel[0])) | (wbs0_ack_o & slave_sel[0]);
  assign wbm_err_i = ((wbs0_err_o & slave_sel[0]) | ((slave_sel[1] & wbs1_err_o) & wbs0_err_o)) | (watchdog_err | ((watchdog_err | wbs1_err_o) & slave_sel[1]));
  assign wbm_rty_i = ((slave_sel[1] & (wbs1_rty_o | wbs0_rty_o)) | wbs0_rty_o) & ((((slave_sel[1] | ((wbs0_rty_o | slave_sel[1]) & slave_sel[0])) | slave_sel[0]) & wbs1_rty_o) | slave_sel[0]);
endmodule
