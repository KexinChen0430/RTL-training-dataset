...
module arbiter_ibus(wbm_adr_o,wbm_dat_o,wbm_sel_o,wbm_we_o,wbm_cyc_o,wbm_stb_o,
  ...
  assign slave_sel[1] = ~|wbm_adr_o[(-1)+wb_adr_width:slave1_addr_width] & ~slave_sel[0];
  ...
  assign wbm_ack_i = ((wbs0_ack_o | wbs1_ack_o) & (wbs1_ack_o | slave_sel[0])) & ((slave_sel[1] | slave_sel[0]) & (slave_sel[1] | wbs0_ack_o));
  assign wbm_err_i = (slave_sel[0] & ((slave_sel[1] | slave_sel[0]) & wbs0_err_o)) | ((slave_sel[1] & wbs1_err_o) | watchdog_err);
  assign wbm_rty_i = (slave_sel[0] | ((slave_sel[1] & (wbs0_rty_o & (wbs1_rty_o | slave_sel[0]))) | (slave_sel[1] & wbs1_rty_o))) & (((slave_sel[1] & (wbs0_rty_o & (wbs1_rty_o | slave_sel[0]))) | (slave_sel[1] & wbs1_rty_o)) | ((wbs0_rty_o & slave_sel[1]) | (slave_sel[0] & wbs0_rty_o)));
endmodule
