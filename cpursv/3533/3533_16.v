...
module arbiter_ibus(wbm_adr_o,wbm_dat_o,wbm_sel_o,wbm_we_o,wbm_cyc_o,wbm_stb_o,
  ...
  input  wb_clk;
  input  wb_rst;
  input  [(-1)+wb_adr_width:0] wbm_adr_o;
  ...
  output wbm_err_i;
  output wbm_rty_i;
  output [(-1)+wb_adr_width:0] wbs0_adr_i;
  ...
  input  wbs0_err_o;
  input  wbs0_rty_o;
  output [(-1)+wb_adr_width:0] wbs1_adr_i;
  ...
  assign slave_sel[0] = ~|wbm_adr_o[(-1)+wb_adr_width:slave0_addr_width];
  assign slave_sel[1] = ~slave_sel[0] & ~|wbm_adr_o[(-1)+wb_adr_width:slave1_addr_width];
  ...
  assign wbm_ack_i = (wbs0_ack_o & ((wbs0_ack_o | slave_sel[1]) & slave_sel[0])) | (wbs1_ack_o & slave_sel[1]);
  assign wbm_err_i = watchdog_err | ((slave_sel[1] & (watchdog_err | ((slave_sel[0] | wbs1_err_o) & ((wbs0_err_o | wbs1_err_o) | watchdog_err)))) | ((watchdog_err | ((slave_sel[0] | wbs1_err_o) & ((wbs0_err_o | wbs1_err_o) | watchdog_err))) & (wbs0_err_o & (slave_sel[0] | slave_sel[1]))));
  assign wbm_rty_i = ((((slave_sel[1] & slave_sel[0]) | (slave_sel[0] & (wbs0_rty_o & (slave_sel[0] | slave_sel[1])))) | (slave_sel[1] | ((slave_sel[1] | wbs0_rty_o) & ((slave_sel[1] & wbs1_rty_o) | (wbs1_rty_o & slave_sel[0]))))) & ((slave_sel[1] & wbs1_rty_o) | (slave_sel[1] & ((wbs1_rty_o | slave_sel[0]) & wbs0_rty_o)))) | (slave_sel[0] & (wbs0_rty_o & (slave_sel[0] | slave_sel[1])));
endmodule
