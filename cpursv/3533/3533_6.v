...
module arbiter_ibus(wbm_adr_o,wbm_dat_o,wbm_sel_o,wbm_we_o,wbm_cyc_o,wbm_stb_o,
  ...
  input  [wb_dat_width+(0-1):0] wbm_dat_o;
  input  [3:0] wbm_sel_o;
  input  wbm_we_o;
  input  wbm_cyc_o;
  input  wbm_stb_o;
  ...
  input  [1:0] wbm_bte_o;
  output [wb_dat_width+(0-1):0] wbm_dat_i;
  output wbm_ack_i;
  output wbm_err_i;
  output wbm_rty_i;
  output [(0-1)+wb_adr_width:0] wbs0_adr_i;
  output [wb_dat_width+(0-1):0] wbs0_dat_i;
  ...
  input  [wb_dat_width+(0-1):0] wbs0_dat_o;
  input  wbs0_ack_o;
  input  wbs0_err_o;
  input  wbs0_rty_o;
  output [(0-1)+wb_adr_width:0] wbs1_adr_i;
  output [wb_dat_width+(0-1):0] wbs1_dat_i;
  ...
  input  [wb_dat_width+(0-1):0] wbs1_dat_o;
  input  wbs1_ack_o;
  input  wbs1_err_o;
  input  wbs1_rty_o;
  wire [1:0] slave_sel;
  ...
  assign slave_sel[1] = ~slave_sel[0] & ~|wbm_adr_o[(0-1)+wb_adr_width:slave1_addr_width];
  ...
  assign wbs0_stb_i = slave_sel[0] & wbm_stb_o;
  ...
  assign wbm_ack_i = (((slave_sel[1] | wbs0_ack_o) & (slave_sel[1] | slave_sel[0])) & (wbs1_ack_o | wbs0_ack_o)) & (wbs1_ack_o | slave_sel[0]);
  assign wbm_err_i = (((slave_sel[1] | slave_sel[0]) | watchdog_err) & ((watchdog_err | slave_sel[0]) | wbs1_err_o)) & (((wbs0_err_o | wbs1_err_o) | watchdog_err) & (wbs0_err_o | (slave_sel[1] | watchdog_err)));
  assign wbm_rty_i = (slave_sel[0] | (((wbs1_rty_o & (slave_sel[1] | slave_sel[0])) & wbs0_rty_o) | (slave_sel[1] & (wbs1_rty_o & (slave_sel[1] | slave_sel[0]))))) & (((wbs1_rty_o | wbs0_rty_o) & ((wbs0_rty_o | slave_sel[1]) & (slave_sel[1] | slave_sel[0]))) & ((wbs0_rty_o | slave_sel[1]) & (slave_sel[1] | slave_sel[0])));
endmodule
