  ...
  always @(*)
      begin
        case (FS)
          ...
          4'b0011: {C,FU_out} = DATA_bus_in+(1+ADDR_bus_in);

          4'b0100: {C,FU_out} = ADDR_bus_in+~DATA_bus_in;

          4'b0101: {C,FU_out} = (~DATA_bus_in+1)+ADDR_bus_in;
          ...
          4'b1010: {C,FU_out} = (ADDR_bus_in & (~DATA_bus_in | DATA_bus_in)) ^ (((ADDR_bus_in | ~ADDR_bus_in) & DATA_bus_in) & (~DATA_bus_in | DATA_bus_in));
          ...
          4'b1110: {C,FU_out} = DATA_bus_in*1<<<1;
