...
module Computer_Datapath_FunctionUnit(output reg [WORD_WIDTH-1:0] FU_out,
                                      output [(0-1)+FLAG_WIDTH:0] FLAG_bus_out,
  ...
  always @(*)
      begin
        case (FS)
          ...
          4'b0101: {C,FU_out} = ADDR_bus_in+(1+~DATA_bus_in);
          ...
          4'b1010: {C,FU_out} = (~DATA_bus_in & (ADDR_bus_in | (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in)))) | (((~ADDR_bus_in & (DATA_bus_in & (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in)))) & ~((DATA_bus_in & ADDR_bus_in) & ~ADDR_bus_in)) | (~(~ADDR_bus_in & (DATA_bus_in & (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in)))) & ((DATA_bus_in & ADDR_bus_in) & ~ADDR_bus_in)));
          ...
          4'b1110: {C,FU_out} = 1<<1*DATA_bus_in;
