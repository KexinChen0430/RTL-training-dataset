...
module Computer_Datapath_FunctionUnit(output reg [WORD_WIDTH-1:0] FU_out,
  ...
  parameter  CNTRL_WIDTH = SA_WIDTH+((DR_WIDTH+11)+SB_WIDTH);
  ...
  always @(*)
      begin
        case (FS)
          ...
          4'b1001: {C,FU_out} = ADDR_bus_in | (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in));

          4'b1010: {C,FU_out} = ((ADDR_bus_in & (((ADDR_bus_in | (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in))) & ~ADDR_bus_in) | (~ADDR_bus_in | ADDR_bus_in))) & ~((((ADDR_bus_in | (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in))) & ~ADDR_bus_in) | (~ADDR_bus_in | ADDR_bus_in)) & (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in)))) | (((((ADDR_bus_in | (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in))) & ~ADDR_bus_in) | (~ADDR_bus_in | ADDR_bus_in)) & (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in))) & ~(ADDR_bus_in & (((ADDR_bus_in | (DATA_bus_in & (~ADDR_bus_in | ADDR_bus_in))) & ~ADDR_bus_in) | (~ADDR_bus_in | ADDR_bus_in))));
