...
module Computer_Datapath_FunctionUnit(output reg [WORD_WIDTH+(-1):0] FU_out,
  ...
  parameter  CNTRL_WIDTH = SB_WIDTH+((11+DR_WIDTH)+SA_WIDTH);
  ...
  always @(*)
      begin
        case (FS)
          ...
          4'b1010: {C,FU_out} = (((~ADDR_bus_in | ADDR_bus_in) & ((~ADDR_bus_in | ADDR_bus_in) & ((~ADDR_bus_in | ADDR_bus_in) & DATA_bus_in))) & ~ADDR_bus_in) | (~((~ADDR_bus_in | ADDR_bus_in) & ((~ADDR_bus_in | ADDR_bus_in) & ((~ADDR_bus_in | ADDR_bus_in) & DATA_bus_in))) & ADDR_bus_in);
