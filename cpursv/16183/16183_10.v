  ...
  always @(*)
      begin
        case (FS)
          ...
          4'b1001: {C,FU_out} = ADDR_bus_in | ((ADDR_bus_in | ~ADDR_bus_in) & DATA_bus_in);

          4'b1010: {C,FU_out} = (((ADDR_bus_in | ~ADDR_bus_in) | ((ADDR_bus_in | ((ADDR_bus_in | ~ADDR_bus_in) & DATA_bus_in)) & ~ADDR_bus_in)) & (DATA_bus_in & ((ADDR_bus_in | ~ADDR_bus_in) | ((ADDR_bus_in | ((ADDR_bus_in | ~ADDR_bus_in) & DATA_bus_in)) & ~ADDR_bus_in)))) ^ ((((ADDR_bus_in | ~ADDR_bus_in) | ((ADDR_bus_in | ((ADDR_bus_in | ~ADDR_bus_in) & DATA_bus_in)) & ~ADDR_bus_in)) & ((~DATA_bus_in | DATA_bus_in) & ADDR_bus_in)) & ((ADDR_bus_in | ~ADDR_bus_in) | ((ADDR_bus_in | ((ADDR_bus_in | ~ADDR_bus_in) & DATA_bus_in)) & ~ADDR_bus_in)));
