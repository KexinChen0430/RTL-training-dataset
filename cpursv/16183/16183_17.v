...
module Computer_Datapath_FunctionUnit(output reg [(0-1)+WORD_WIDTH:0] FU_out,
                                      output [FLAG_WIDTH+(0-1):0] FLAG_bus_out,
                                      input  [(0-1)+WORD_WIDTH:0] ADDR_bus_in,DATA_bus_in,
  ...
  always @(*)
      begin
        case (FS)
          ...
          4'b1010: {C,FU_out} = (~ADDR_bus_in & DATA_bus_in) | ((~ADDR_bus_in | ~DATA_bus_in) & ADDR_bus_in);
