...
module pr_region_default_mm_bridge_1  #(parameter 
  ...
  (input  wire clk,
   ...
   output wire [BURSTCOUNT_WIDTH+(0-1):0] m0_burstcount,
   output wire [DATA_WIDTH+(0-1):0] m0_writedata,
   output wire [HDL_ADDR_WIDTH+(0-1):0] m0_address,
   ...
   input  wire [BURSTCOUNT_WIDTH+(0-1):0] s0_burstcount,
   input  wire [DATA_WIDTH+(0-1):0] s0_writedata,
   input  wire [HDL_ADDR_WIDTH+(0-1):0] s0_address,
   input  wire s0_write,
   input  wire s0_read,
