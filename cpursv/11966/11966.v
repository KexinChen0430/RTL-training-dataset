...
module Control(input  irq,PC31,
  ...
  assign EXC = ~(((OpCode <= 6'hd) && (OpCode >= 6'h1)) || 
((OpCode == 6'hf) || (OpCode == 6'h23) || (OpCode == 6'h2b)) || 
((OpCode == 6'h0) && 
((Funct == 6'h8) || (Funct == 6'h9) || (Funct == 6'h0) || 
(Funct == 6'h2) || (Funct == 6'h3) || 
((Funct >= 6'h20) && (Funct <= 6'h27)) || (Funct == 6'h2a) || (Funct == 6'h2b))));
  ...
  assign RegDst = ((~PC31 & irq) | (~PC31 & EXC)) ? 2'h3 : 
                  ...
                  (OpCode == 6'h9) || (OpCode == 6'hc) || (OpCode == 6'hd) || (OpCode == 6'ha) || 
                  (OpCode == 6'hb)) ? 2'h1 : 
                  ((OpCode == 6'h03) || 
...
(Funct == 6'h8)) ? 1'b1 : 1'b0) : 
                 ...
                 ((OpCode >= 6'h4) && (OpCode <= 6'h7))) ? 1'b1 : 1'b0;
