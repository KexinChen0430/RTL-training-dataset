...
module multiplier(clk,sign,enable,multi_1,multi_2,product,multready);
  ...
  always @(posedge clk)
      begin
        if (enable & (i == 7'd32)) 
          begin
            multi_2_copy <= ((multi_1[31] || sign) && multi_2[31] && sign) ? {32'd0,1'b1+~multi_2} : {32'd0,multi_2};
            multi_1_copy <= (multi_1[31] && sign) ? (1'b1+~multi_1) : multi_1;
            neg_output <= (multi_2[31] || multi_1[31]) && 
                         (multi_2[31] || ~multi_2[31]) && (sign || multi_2[31]) && 
                         (
((multi_1[31] && ~multi_2[31]) || 
((multi_1[31] && ~multi_2[31] && ~multi_1[31]) || sign)) && 
