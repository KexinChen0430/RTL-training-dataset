...
(multi_1[31] && 
((multi_1[31] && (multi_2[31] || ~multi_2[31])) || 
multi_2[31])))) && sign) ? {32'd0,1'b1+~multi_2} : {32'd0,multi_2};
            multi_1_copy <= (sign && multi_1[31]) ? (~multi_1+1'b1) : multi_1;
            neg_output <= 
(
(multi_1[31] && 
(
...
(multi_1[31] && 
((multi_1[31] && (multi_2[31] || ~multi_2[31])) || 
multi_2[31])))) && sign) || (sign && ~multi_2[31]))) || 
(
(
(multi_2[31] && 
(
...
(multi_1[31] && 
((multi_1[31] && (multi_2[31] || ~multi_2[31])) || 
multi_2[31])))) && sign) || (sign && ~multi_2[31])) && multi_2[31])) && 
