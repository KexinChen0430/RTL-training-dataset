      ...
      begin
        if (enable & (i == 7'd32)) 
          begin
            ...
            multi_1_copy <= (sign && ((sign || ~multi_2[31]) && multi_1[31])) ? (~multi_1+1'b1) : multi_1;
            neg_output <= 
(~multi_2[31] || 
(~multi_1[31] && 
(sign || (~multi_2[31] && multi_1[31])) && sign)) && 
                         (
(~multi_1[31] && 
(sign || (~multi_2[31] && multi_1[31])) && sign) || multi_1[31]) && 
                         (((multi_2[31] && sign) || multi_1[31]) && 
(
(sign && ~multi_2[31] && 
((~multi_2[31] && multi_1[31]) || ~multi_1[31])) || (multi_2[31] && sign)));
            i <= i-1'b1;
          end
        else if ((enable & i) > 0) 
          begin
