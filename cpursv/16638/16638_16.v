...
module axis_demux_4  #(parameter  DATA_WIDTH = 8)
  ...
  always @* 
      begin
        ...
        else if ((~current_output_tvalid & enable) & input_axis_tvalid) 
          begin
            frame_next = 1;
            select_next = select;
          end
  ...
  assign output_axis_tready_int_early = current_output_tready | ((~output_axis_tvalid_int | ~current_output_tvalid) & ~temp_axis_tvalid_reg);
        ...
        if (rst) 
          ...
          begin
            ...
            if (output_axis_tready_int) 
              begin
                if (~current_output_tvalid | ((~current_output_tvalid & ~temp_axis_tvalid_reg) | current_output_tready)) 
                  begin
