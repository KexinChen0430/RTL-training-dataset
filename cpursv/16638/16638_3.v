...
module axis_demux_4  #(parameter  DATA_WIDTH = 8)
  ...
  always @* 
      begin
        ...
        else if (enable & (input_axis_tvalid & ~current_output_tvalid)) 
          begin
            frame_next = 1;
            select_next = select;
          end
  ...
  assign output_axis_tready_int_early = current_output_tready | ((~current_output_tvalid & (~temp_axis_tvalid_reg | (current_output_tready & (~temp_axis_tvalid_reg | ~current_output_tvalid)))) | (~output_axis_tvalid_int & ~temp_axis_tvalid_reg));
