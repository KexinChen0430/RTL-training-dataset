...
module axis_demux_4  #(parameter  DATA_WIDTH = 8)
  ...
  always @* 
      begin
        ...
        else if (enable & (~current_output_tvalid & input_axis_tvalid)) 
          begin
            frame_next = 1;
            select_next = select;
          end
          
        input_axis_tready_next = frame_next & output_axis_tready_int_early;
  ...
  assign output_axis_tready_int_early = current_output_tready | ((~output_axis_tvalid_int & (~temp_axis_tvalid_reg & ((~output_axis_tvalid_int | ~current_output_tvalid) & (~output_axis_tvalid_int | ~temp_axis_tvalid_reg)))) | (~temp_axis_tvalid_reg & (current_output_tready | ~current_output_tvalid)));
