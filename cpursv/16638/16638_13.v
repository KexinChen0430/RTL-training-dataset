...
module axis_demux_4  #(parameter  DATA_WIDTH = 8)
  ...
  assign output_axis_tready_int_early = ((current_output_tready & ~temp_axis_tvalid_reg) | (~current_output_tvalid & ~temp_axis_tvalid_reg)) | (current_output_tready | (~temp_axis_tvalid_reg & (~output_axis_tvalid_int & (~temp_axis_tvalid_reg | ~current_output_tvalid))));
