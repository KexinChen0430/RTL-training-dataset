...
module control_unit(output reg ext_signed,
                    output reg bSelect,
  ...
  always @(*)
      begin
        case (cond)
          ...
          4'b1010: condflag = !psr[6] && !psr[2];

          4'b1011: condflag = psr[6] || psr[2];
  ...
  always @(*)
      begin
        ...
        case (opcode)
          ...
          4'b0001,4'b0010,4'b0011,4'b1101,4'b1111: begin
                rwren = 1;
                wregSelect = 2'b10;
                aluSelect = 1;
                bSelect = 0;
