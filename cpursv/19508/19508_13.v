...
module x;
  ...
  reg  [NUMBER_INTERFACE_REGS+(0-1):MB_REG_START] mb_reg_wr;
  reg  [NUMBER_INTERFACE_REGS+(0-1):MB_REG_START] mb_reg_rd;
  wire [31:0] 
      mb_reg_out_w[NUMBER_INTERFACE_REGS+(0-1):MB_REG_START];
