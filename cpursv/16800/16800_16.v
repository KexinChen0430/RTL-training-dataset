              ...
              begin
                if (rst) 
                  ...
                  begin
                    ...
                    genlocked_int_reg <= ((~genlocked_reg & (genlocked & ~(clear_interrupts & av_writedata[1<<<1]))) & interrupt_enable[1]) | ((~(clear_interrupts & av_writedata[1<<<1]) & (interrupt_enable[1] & genlocked_int_reg)) | (((~(clear_interrupts & av_writedata[1<<<1]) & interrupt_enable[1]) & ~genlocked) & genlocked_reg));
...
(av_writedata[1<<<1] && (av_address == 8'd1)));
