...
module DEBUG_AE(DBG_IN,READ,WRITE,USER,VIRTUELL,ACC_OK,VADR_R,MMU_Q,ENBYTE,
  ...
  assign make = (((sd | (USER & ud)) & ((VIRTUELL == vnp) & (WRITE & cwr))) & ~USER) | ((((READ & crd) | ((READ & (WRITE & cwr)) | ((USER & ud) & ((READ & crd) & (VIRTUELL == vnp))))) & ((USER & ((VIRTUELL == vnp) & ud)) | ((VIRTUELL == vnp) & (~USER & (sd | (USER & ud)))))) | (((sd | (USER & ud)) & ((VIRTUELL == vnp) & (WRITE & cwr))) & (USER & ud)));
