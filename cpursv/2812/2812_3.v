...
module DEBUG_AE(DBG_IN,READ,WRITE,USER,VIRTUELL,ACC_OK,VADR_R,MMU_Q,ENBYTE,
  ...
  assign make = (((VIRTUELL == vnp) & ((crd & READ) | ((WRITE & cwr) & READ))) | ((WRITE & cwr) & (VIRTUELL == vnp))) & (((USER & ud) | ~USER) & (sd | ((sd | ud) & USER)));
  ...
  assign DBG_HIT = (((ACC_OK & make) & (VIRTUELL ? virt_adr : real_adr)) & page_adr) & byte_en;
endmodule
