...
module DEBUG_AE(DBG_IN,READ,WRITE,USER,VIRTUELL,ACC_OK,VADR_R,MMU_Q,ENBYTE,
  ...
  assign make = (((ud & ((USER | ~USER) & (sd | USER))) & ((READ & crd) & (VIRTUELL == vnp))) | (((sd & ~USER) & (READ & crd)) & (VIRTUELL == vnp))) | ((cwr & ((READ & crd) | (WRITE | (((sd & ~USER) & (READ & crd)) & (VIRTUELL == vnp))))) & ((((READ & crd) & ((VIRTUELL == vnp) & ((~USER & (((ud & (sd | USER)) | sd) | ud)) & (sd | USER)))) | (USER & ((VIRTUELL == vnp) & ud))) | ((VIRTUELL == vnp) & (sd & ~USER))));
