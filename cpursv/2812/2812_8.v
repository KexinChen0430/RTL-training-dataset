...
module DEBUG_AE(DBG_IN,READ,WRITE,USER,VIRTUELL,ACC_OK,VADR_R,MMU_Q,ENBYTE,
  ...
  assign make = ((ud & (((READ & crd) & (VIRTUELL == vnp)) | (((WRITE & cwr) & (VIRTUELL == vnp)) | ((((READ & crd) | (WRITE & cwr)) & (ud & (VIRTUELL == vnp))) & USER)))) | ((((READ & crd) & (VIRTUELL == vnp)) | (((WRITE & cwr) & (VIRTUELL == vnp)) | ((((READ & crd) | (WRITE & cwr)) & (ud & (VIRTUELL == vnp))) & USER))) & ~USER)) & (sd | (USER & ud));
  ...
  assign DBG_HIT = (page_adr & ((VIRTUELL ? virt_adr : real_adr) & byte_en)) & (ACC_OK & make);
endmodule
