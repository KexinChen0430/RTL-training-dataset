...
module DEBUG_AE(DBG_IN,READ,WRITE,USER,VIRTUELL,ACC_OK,VADR_R,MMU_Q,ENBYTE,
  ...
  assign make = ((VIRTUELL == vnp) & ((ud | (sd & ~USER)) & ((USER | (sd & ~USER)) & (crd & (((crd | cwr) & (cwr | READ)) & READ))))) | ((((((crd & (((crd | cwr) & (cwr | READ)) & READ)) & (VIRTUELL == vnp)) & (((USER | (ud & USER)) | sd) & (ud | sd))) & (ud & USER)) | ((~USER & (((crd & (((crd | cwr) & (cwr | READ)) & READ)) & (VIRTUELL == vnp)) & (((USER | (ud & USER)) | sd) & (ud | sd)))) | ((((VIRTUELL == vnp) & (ud | (sd & ~USER))) & WRITE) & (USER | (sd & ~USER))))) & cwr);
  ...
  assign DBG_HIT = ((VIRTUELL ? virt_adr : real_adr) & byte_en) & (ACC_OK & (make & page_adr));
endmodule
