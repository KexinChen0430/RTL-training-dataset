...
module sonic_sensor(input  clk,
        ...
        if (rst) state <= STATE_INIT;
          ...
          case (state)
            ...
            STATE_IN_SIG: begin
                  ...
                  else if (time_out && (echo == 0)) state <= STATE_INIT;
      ...
      begin
        if (rst) counter <= 0;
          ...
          case (state)
            ...
            STATE_OUT_SIG,STATE_WAIT750,STATE_IN_SIG,STATE_WAIT200: counter <= 1+counter;
  ...
  always @(posedge clk)
      begin
        if (rst) echo <= 0;
        else if (state == STATE_IN_SIG) echo <= echo+1;
        else echo <= 0;
      end
