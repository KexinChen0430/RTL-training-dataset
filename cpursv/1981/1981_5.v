...
module cameraReader_sim(input  clk,
                        input  reset_n,
                        output refclk,
                        input  pclk,
                        input  [7:0] data,
  ...
  always @(negedge clk)  wrclk1 <= ~wrclk1;
          ...
          begin
            case (state)
              ...
              2'b00: begin
                    ...
                    else wait_counter_vs <= wait_counter_vs+1;
                  end

              2'b01: begin
                    if ((pixel_counter%640) == 0) 
                      begin
                        if (pixel_counter == (480*640)) 
                          begin
                            pixel_counter <= 0;
                            state <= 2'b11;
                          end
                    ...
                    else pixel_counter <= 1+pixel_counter;
                  end
              ...
              2'b10: begin
                    ...
                    else wait_counter_hs <= wait_counter_hs+1;
                  end
