...
module DRAMWriter(input  ACLK,
  ...
  assign M_AXI_WVALID = DATA_VALID && (w_state == RWAIT);
  assign DATA_READY = M_AXI_WREADY && (w_state == RWAIT);
  assign CONFIG_READY = (a_state == IDLE) && (w_state == IDLE);
