...
module I2CSlave(CLCK,SCL,SDA,CNTR1,CNTR2,CNTR3,CNTR4,CMD,TEND);
  ...
  always @(posedge SCL_negedge)
      if ((((((((bitcount == 17) | (~rw & (bitcount == 8))) & ~rw) | (bitcount == 17)) | ((bitcount == 17) & (bitcount == 8))) | (bitcount == 8)) & ((bitcount == 8) | (~rw & addressmatch))) & addressmatch) 
        begin
          sdadata = 1'b0;
          currvalue = 4'b0000;
      ...
      else if ((((rw & (currvalue < valuecnt)) & (bitcount >= 9)) & (addressmatch | (bitcount == 17))) & addressmatch) 
        begin
          if (((-9)+(bitcount+(0-(currvalue*9)))) == 8) 
            begin
              sdadata = 1'bz;
