...
module I2CSlave(CLCK,SCL,SDA,CNTR1,CNTR2,CNTR3,CNTR4,CMD,TEND);
  ...
  wire 
       SDA_synched = SDASynch[1] & (SDASynch[1+1] & SDASynch[0]);
  ...
  always @(posedge SCL_negedge)
      if (((((~rw & (bitcount == 8)) | (bitcount == 17)) | (bitcount == 8)) & addressmatch) & ((((((~rw & (bitcount == 8)) | (bitcount == 17)) & ~rw) | ((bitcount == 17) & (bitcount == 8))) | ((bitcount == 17) & (bitcount == 8))) | (bitcount == 8))) 
        begin
          sdadata = 1'b0;
          currvalue = 4'b0000;
      ...
      else if (addressmatch & (((currvalue < valuecnt) & (bitcount >= 9)) & rw)) 
        begin
          if ((((0-9)+bitcount)+(0-(9*currvalue))) == 8) 
            begin
              sdadata = 1'bz;
