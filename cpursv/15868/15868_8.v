...
module top;
  ...
  begin
    ...
    if ((array1[2] !== 2'd0) || (array1[1] !== 2'd0)) failed = 1;
    ...
    if ((array2[1] !== 2'd0) || (array2[0] !== 2'd0)) failed = 1;
    ...
    assign array3[1] = 1.;
    #1 $display("array = %0g %0g",array3[2],array3[1]);
    if ((array3[2] != 0.) || (array3[1] != 1.)) failed = 1;
      
    deassign array3[1];
    assign array3[2] = var2;
    var2 = 1.;
    #1 $display("array = %0g %0g",array3[2],array3[1]);
    if ((array3[2] != 1.) || (array3[1] != 0.)) failed = 1;
      
    var2 = 2.;
    #1 $display("array = %0g %0g",array3[2],array3[1]);
    if ((array3[2] != 2.) || (array3[1] != 0.)) failed = 1;
