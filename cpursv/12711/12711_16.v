        ...
        if (rst) 
          ...
          begin
            case (state)
              ...
              ST_IDLE: begin
                    if (randomReady && seedStrobe) 
                      begin
                        state <= ST_SEED;
                      end
                    else if (randomReady && read) 
                      begin
                        state <= ST_SWAP;
                      end
                    else 
            ...
            if (state == ST_IDLE) 
              begin
                randomValue <= s1+s0;
                randomReady <= (~read | ~randomReady) & (~randomReady | ~seedStrobe);
              end
            else 
              begin
            ...
            case (state)
              ...
              default: s1 <= (((((xorWord & ~(xorWord & ((~xorWord | xorWord) & (s1 & (~xorWord | xorWord))))) | ~xorWord) & ((xorWord & ~(xorWord & ((~xorWord | xorWord) & (s1 & (~xorWord | xorWord))))) | (xorWord & ((~xorWord | xorWord) & (s1 & (~xorWord | xorWord)))))) | s1) & (((~s1 & s1) | ~xorWord) & ((~s1 & s1) | s1))) | (((((xorWord & ~(xorWord & ((~xorWord | xorWord) & (s1 & (~xorWord | xorWord))))) | ~xorWord) & ((xorWord & ~(xorWord & ((~xorWord | xorWord) & (s1 & (~xorWord | xorWord))))) | (xorWord & ((~xorWord | xorWord) & (s1 & (~xorWord | xorWord)))))) | s1) & ((~xorWord | xorWord) & ~s1));
