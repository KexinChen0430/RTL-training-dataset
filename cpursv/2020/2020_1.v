...
module velocityControlHdl_Dynamic_Saturation_block1(up,u,lo,y,sat_mode);
  ...
  assign LowerRelop1_relop1 = (u > LowerRelop1_1_cast) ? 1'b1 : 1'b0;
  assign UpperRelop_1_cast = {{11{lo[17]}},{lo,7'b0000000}};
  assign UpperRelop_relop1 = (u < UpperRelop_1_cast) ? 1'b1 : 1'b0;
  ...
  assign LowerRelop1_out1 = UpperRelop_relop1 | LowerRelop1_relop1;
