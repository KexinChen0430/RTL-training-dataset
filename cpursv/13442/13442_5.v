...
module pippo_barrel(shift_in,shift_cnt,insert_in,mask_begin,mask_end,shift_left,
  ...
  assign mask_and_out = (shifted[95:64] & mask_last) | (mask_last & shifted[63:32]);
  assign mask_insert_out = (((((shifted[95:64] | (~mask_last & insert_in)) & mask_last) | ((~mask_last & insert_in) & shifted[95:64])) | (~mask_last & insert_in)) | ((shifted[63:32] | shifted[95:64]) & (((~mask_last & mask_last) | ((~mask_last & insert_in) & shifted[95:64])) | (~mask_last & insert_in)))) | (((shifted[95:64] & mask_last) | (mask_last & shifted[63:32])) & (((~mask_last | mask_last) & shifted[63:32]) | ~mask_last));
