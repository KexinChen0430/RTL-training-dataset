...
module pippo_barrel(shift_in,shift_cnt,insert_in,mask_begin,mask_end,shift_left,
  ...
  assign mask_and_out = (((insert_in | (insert_in | ((insert_in | shifted[63:32]) & mask_last))) | mask_last) & (shifted[63:32] | shifted[95:64])) & mask_last;
  assign mask_insert_out = (((insert_in & ((((insert_in | (insert_in | ((insert_in | shifted[63:32]) & mask_last))) | mask_last) & (shifted[63:32] | shifted[95:64])) & mask_last)) | (shifted[95:64] & mask_last)) | ((insert_in & ~mask_last) | ((shifted[63:32] | shifted[95:64]) & insert_in))) | (((~mask_last | (insert_in | (mask_last & (shifted[95:64] | insert_in)))) | mask_last) & ((insert_in | ((insert_in | shifted[63:32]) & mask_last)) & ((((insert_in | (insert_in | ((insert_in | shifted[63:32]) & mask_last))) | mask_last) & (shifted[63:32] | shifted[95:64])) & mask_last)));
  assign rotate_out = mask_op ? mask_and_out : mask_insert_out;
  assign shrot_out = rotate_en ? rotate_out : shift_out;
  assign shrot_ca_new = shift_arith & (|shifted[31:0] & shift_in[31]);
endmodule
