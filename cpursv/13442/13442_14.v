...
module pippo_barrel(shift_in,shift_cnt,insert_in,mask_begin,mask_end,shift_left,
  ...
  assign fill = (shift_in[31] & !rotate_en) & shift_arith;
  ...
  assign mask_and_out = mask_last & (shifted[63:32] | shifted[95:64]);
  assign mask_insert_out = (shifted[95:64] & mask_last) | ((((mask_last & (shifted[63:32] | shifted[95:64])) & shifted[63:32]) | (insert_in & (((mask_last | shifted[95:64]) | ~mask_last) & (shifted[63:32] | shifted[95:64])))) | (insert_in & ~mask_last));
