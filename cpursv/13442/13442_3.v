...
module pippo_barrel(shift_in,shift_cnt,insert_in,mask_begin,mask_end,shift_left,
  ...
  assign mask_last = mask_select ? (mask_second & mask_first) : (mask_second | mask_first);
  wire [31:0] mask_and_out;

  wire [31:0] mask_insert_out;

  assign mask_and_out = (shifted[95:64] | (mask_last & shifted[63:32])) & mask_last;
  assign mask_insert_out = ((mask_last & shifted[63:32]) | (~mask_last & (((shifted[95:64] | (mask_last & shifted[63:32])) & (mask_last & ~mask_last)) | insert_in))) | ((((shifted[95:64] | (mask_last & shifted[63:32])) & mask_last) & (((shifted[95:64] & mask_last) | ((insert_in | shifted[95:64]) & mask_last)) | insert_in)) & (~mask_last | ((shifted[95:64] | (mask_last & shifted[63:32])) & mask_last)));
  assign rotate_out = mask_op ? mask_and_out : mask_insert_out;
  assign shrot_out = rotate_en ? rotate_out : shift_out;
  assign shrot_ca_new = |shifted[31:0] & (shift_in[31] & shift_arith);
endmodule
