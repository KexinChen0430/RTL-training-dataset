...
module pippo_barrel(shift_in,shift_cnt,insert_in,mask_begin,mask_end,shift_left,
  ...
  assign mask_and_out = ((mask_last & shifted[95:64]) | ((mask_last & shifted[63:32]) & insert_in)) | ((((mask_last & shifted[63:32]) & (shifted[95:64] | shifted[63:32])) | ((insert_in | (mask_last & shifted[95:64])) & (shifted[95:64] | shifted[63:32]))) & (mask_last & shifted[63:32]));
  assign mask_insert_out = (((~mask_last & insert_in) | ((mask_last | (insert_in | (mask_last & shifted[95:64]))) & shifted[63:32])) & (insert_in | (((mask_last & shifted[63:32]) & (shifted[95:64] | shifted[63:32])) | ((insert_in | (mask_last & shifted[95:64])) & (shifted[95:64] | shifted[63:32]))))) | (mask_last & shifted[95:64]);
