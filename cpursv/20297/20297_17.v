...
module top;
  ...
  begin
    ...
    $display("The time one unit ago was        : %t",$realtime+(0-1.));
    $display("The time one unit ago was        : %t",
             $realtime+(0-offset));
    $display("The time now is                  : %t",$realtime);
    $display("One time unit from now it will be: %t",$realtime+1.);
    $display("The time at 20 will be           : %t",future);
    $display("The time at 40 will be           : %t",40.);
    #100 ;
    $display("\n----- Using integer times -----");
    $display("The time one unit ago was        : %t",(0-1)+$time);
    $display("The time one unit ago was        : %t",(-ioffset)+$time);
