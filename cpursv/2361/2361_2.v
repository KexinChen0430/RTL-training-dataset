...
module identificador_teclas(input  wire clk,reset,
  ...
  always @(posedge clk or posedge reset)
      if (reset) state_reg <= wait_break_code;
  ...
  always @* 
      begin
        ...
        case (state_reg)
          ...
          wait_break_code: if ((rx_done_tick == 1'b1) && (dout == break_code)) state_next = get_code;
