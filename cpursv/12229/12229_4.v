...
module sgdma_tx_command_grabber(clk,command_fifo_empty,command_fifo_q,m_read_waitrequest,
                                read_go,reset_n,command_fifo_rdreq,read_command_data,
                                read_command_valid);
  ...
  assign command_fifo_rdreq_in = (command_valid || command_fifo_rdreq_reg) ? 1'b0 : (~m_read_waitrequest && ~read_go);
