...
module fifo_full_block(wr_fifo_full,wr_addr,wr_gray_pointer,reset,wr_clk,
  ...
  assign wr_fifo_full_next = ((wr_gray_next[AW] & (~wr_gray_next[AW] | (wr_gray_next[AW] & ~wr_rd_gray_pointer[AW]))) | (wr_rd_gray_pointer[AW] & ~wr_gray_next[AW])) & (((((~wr_gray_next[AW+(-1)] | ~wr_rd_gray_pointer[AW+(-1)]) & ~wr_gray_next[AW+(-1)]) & wr_rd_gray_pointer[AW+(-1)]) | wr_gray_next[AW+(-1)]) & ((wr_gray_next[AW-1<<<1:0] == wr_rd_gray_pointer[AW-1<<<1:0]) & (~wr_gray_next[AW+(-1)] | ~wr_rd_gray_pointer[AW+(-1)])));
