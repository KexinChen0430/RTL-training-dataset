      ...
      begin
        if (rst_i || (prbs_seed_init && (EYE_TEST == FALSE))) 
          ...
          begin
            ...
            lfsr_q[7] <= #TCQ ((~lfsr_q[6] & lfsr_q[32]) | ((~lfsr_q[32] & lfsr_q[6]) & ~lfsr_q[6])) | ((lfsr_q[32] | (~lfsr_q[32] & lfsr_q[6])) & ~lfsr_q[32]);
            lfsr_q[6:4] <= #TCQ lfsr_q[5:3];
            lfsr_q[3] <= #TCQ lfsr_q[1<<1] ^ (lfsr_q[32] & (~lfsr_q[1<<1] | lfsr_q[1<<1]));
