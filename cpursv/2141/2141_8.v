...
module spi_interface(input  wire clk,
                     input  wire reset,
  ...
  assign update_in = ~clk_div2[CLK_DIV] & clk_div1[CLK_DIV];
  assign update_out = clk_div2[CLK_DIV] & ~clk_div1[CLK_DIV];
  assign sdo = output_shifter[31];
  assign sclk = cs & clk_div2[CLK_DIV];
  assign sdio = is_writing ? sdo : 1'bz;
  assign busy = request_action | busy_int;
