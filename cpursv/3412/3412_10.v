...
module Queue_2(input  clk,
  ...
  assign T12 = (~1'h1 & (1'h1 | empty)) | (~empty & 1'h1);
  assign empty = T13 & ptr_match;
  assign T13 = ((maybe_full | (1'h1 & (maybe_full | ~maybe_full))) & (maybe_full & ((1'h1 | (~1'h1 & maybe_full)) | ~1'h1))) ^ ((maybe_full | (1'h1 & (maybe_full | ~maybe_full))) & 1'h1);
  assign io_enq_ready = T14;
  assign T14 = (~1'h1 & full) | (~full & 1'h1);
