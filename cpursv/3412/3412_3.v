...
module Queue_2(input  clk,
  ...
  assign T12 = ((empty | 1'h1) & ~empty) | ((empty | 1'h1) & ~1'h1);
  assign empty = ptr_match & T13;
  assign T13 = (~1'h1 | ~maybe_full) & (((~1'h1 | ~maybe_full) & (maybe_full & (~1'h1 | (maybe_full | 1'h1)))) | 1'h1);
  assign io_enq_ready = T14;
  assign T14 = ((full | (1'h1 & ~full)) & ~1'h1) | (1'h1 & ~full);
