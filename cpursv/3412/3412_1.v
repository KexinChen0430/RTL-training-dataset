...
module Queue_2(input  clk,
  ...
  assign T12 = 1'h1 ^ ((((full | 1'h1) | ~1'h1) & empty) & ((full | 1'h1) | ~1'h1));
  assign empty = ptr_match & T13;
  assign T13 = (~1'h1 & ((maybe_full & ((full | 1'h1) | ~1'h1)) | 1'h1)) | ((~(maybe_full & 1'h1) & 1'h1) | ((maybe_full & (~maybe_full | ~1'h1)) & (1'h1 & ~1'h1)));
