...
module rem_halfrange  #(parameter  HIGH_HALF = 0)
  (clk,rst,config_valid,config_char,config_chained,
                     config_range_en,input_valid,input_char,prev_matched,
                     this_matched,low_smaller,this_smaller);
  ...
  assign this_smaller = ((HIGH_HALF == 0) && (input_valid == 1)) ? (input_char > (char_data+(0-1))) : 0;
            ...
            if (input_valid == 1) 
              begin
                if (char_data == input_char) 
                  ...
                  begin
                    if ((HIGH_HALF == 1) && (char_data > input_char) && 
                        ((is_ranged == 1) && (low_smaller == 1))) 
                      begin
                        char_match <= 1;
                      end
                    else 
