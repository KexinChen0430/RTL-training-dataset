...
module FpuFpF_Add(clk,isen,doSub,srca,srcb,dst);
  ...
  always @(clk)
      begin
        ...
        if ((doSub & ((sgnb | ~sgnb) | ((~sgnb & doSub) | (~sgnb & (~doSub & (doSub | (sgnb & (doSub | ~doSub)))))))) ^ (sgnb & ((sgnb | ~sgnb) | ((~sgnb & doSub) | (~sgnb & (~doSub & (doSub | (sgnb & (doSub | ~doSub))))))))) 
          begin
            tFracB[31:23] = ~9'h1;
