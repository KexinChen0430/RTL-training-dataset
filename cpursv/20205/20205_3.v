...
module stream_tg  #(parameter 
  ...
  (input  aclk,
   ...
   output [(0-1)+KEEP_WIDTH:0] write_data_keep,
   ...
   input  [(0-1)+KEEP_WIDTH:0] read_data_keep,
  ...
  reg  [(0-1)+KEEP_WIDTH:0] write_data_keep_r,write_data_keep_r1;
  reg  write_data_last_r;
  reg  [71:0] read_cmd_r;
  reg  read_cmd_valid_r;
  reg  [DATA_WIDTH-1:0] read_data_r,read_data_r1;
  reg  read_data_valid_r;
  reg  [(0-1)+KEEP_WIDTH:0] read_data_keep_r,read_data_keep_r1;
