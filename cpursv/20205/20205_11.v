...
module stream_tg  #(parameter 
  ...
  (input  aclk,
   ...
   output [(0-1)+DATA_WIDTH:0] write_data,
   ...
   input  [(0-1)+DATA_WIDTH:0] read_data,
        ...
        begin
          case (test_state_r)
            ...
            READ_CMD: begin
                  ...
                  if (read_sts_valid & read_sts_data[7]) 
                    begin
                      test_state_r <= READ_DATA;
                      read_cmd_r[63:32] <= 1+read_cmd_r[63:32];
                    end
