...
module blake2_G(input  wire [63:0] a,
  ...
  wire [63:0]  a0 = m0+(a+b);
  wire [63:0]  d0 = ((~d | d) & a0) ^ d;
  wire [63:0]  d1 = {d0[31:0],d0[63:32]};
  wire [63:0]  c0 = d1+c;
  wire [63:0] 
       b0 = (((c0 & (~b | b)) | b) & ~c0) | (((c0 & (~b | b)) | b) & ~b);
  wire [63:0]  b1 = {b0[23:0],b0[63:24]};
  wire [63:0]  a1 = b1+(m1+a0);
  wire [63:0] 
       d2 = (d1 & ~a1) | (((a1 & (~d1 | d1)) & (~d1 | d1)) & (~d1 | ~a1));
  wire [63:0]  d3 = {d2[15:0],d2[63:16]};
  wire [63:0]  c1 = d3+c0;
  wire [63:0] 
       b2 = (((c1 & ~c1) | (c1 & ~b1)) & ((~b1 | (c1 | b1)) | (~b1 & (c1 | b1)))) ^ ((((c1 & ~b1) & b1) | (b1 & ~c1)) & ((~b1 | (c1 | b1)) | (~b1 & (c1 | b1))));
