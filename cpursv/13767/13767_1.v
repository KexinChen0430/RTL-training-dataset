...
module wishbone_mem_interconnect(clk,rst,i_m_we,i_m_cyc,i_m_stb,i_m_sel,o_m_ack,i_m_dat,
                                 o_m_dat,i_m_adr,o_m_int,o_s0_we,o_s0_cyc,o_s0_stb,o_s0_sel,
                                 i_s0_ack,o_s0_dat,i_s0_dat,o_s0_adr,i_s0_int);
  ...
  always @(rst or i_m_adr or mem_select)
      begin
        if (rst) 
          begin
          ...
          begin
            if ((i_m_adr < (MEM_OFFSET_0+MEM_SIZE_0)) && 
                (i_m_adr >= MEM_OFFSET_0)) 
              begin
