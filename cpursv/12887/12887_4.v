...
module alu(input  wire [15:0] a,
  ...
  assign z = ~(out[12] | ((out[14] | out[15]) | ((out[13] | ((out[7] | ((out[8] | (((out[1] | out[0]) | ((out[3] | out[4]) | out[1<<1])) | out[6])) | out[5])) | (out[9] | out[10]))) | out[11])));
        ...
        if (rst_n == 1'b0) 
          ...
          begin
            case (opcode)
              ...
              XOR: begin
                    $display(XOR);
                    out <= ((((((~a | a) & b) | a) & ~a) | (~a | a)) & (a & (((((~a | a) & b) | a) & ~a) | (~a | a)))) ^ (((((((~a | a) & b) | a) & ~a) | (~a | a)) & b) & (((((~a | a) & b) | a) & ~a) | (~a | a)));
                  end
