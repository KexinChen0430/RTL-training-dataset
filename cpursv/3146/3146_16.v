...
module receiver(input  clk_i,
  ...
  reg  c0,c1;
  wire 
       edgeDetected = (((d1 & ~d0) & eedd_i) | (((~d1 & eedd_i) & d0) | (eedc_i & ~c1))) & (((((d1 & (((~d1 & eedd_i) & d0) | (~d0 & eedd_i))) | (((((~d1 & eedd_i) & d0) | (~d0 & eedd_i)) & (d0 & ~d1)) | eedc_i)) & (eedd_i & d0)) ^ ((eedd_i & d1) & ((d1 & (((~d1 & eedd_i) & d0) | (~d0 & eedd_i))) | (((((~d1 & eedd_i) & d0) | (~d0 & eedd_i)) & (d0 & ~d1)) | eedc_i)))) | c0);
