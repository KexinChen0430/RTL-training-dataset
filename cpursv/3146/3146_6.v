...
module receiver(input  clk_i,
  ...
  reg  c0,c1;
  wire 
       edgeDetected = (eedd_i & ((d0 & (~d0 | ~d1)) & ~d1)) | ((((~c1 & c0) & eedc_i) | ((((((eedd_i & ((d0 & (~d0 | ~d1)) & ~d1)) | (~c1 & c0)) | eedd_i) & ((d0 & (~d0 | ~d1)) & ~d1)) | ((((eedd_i & ((d0 & (~d0 | ~d1)) & ~d1)) | (~c1 & c0)) | eedd_i) & (~d0 & ((d1 | d0) & (d1 | ~d1))))) & eedc_i)) | (((d1 & ~d0) & (((d1 & ~d0) & (eedc_i | eedd_i)) | ((d0 | eedc_i) & (eedc_i | (eedd_i & ~d1))))) & eedd_i));
