...
module receiver(input  clk_i,
  ...
  reg  c0,c1;
  wire 
       edgeDetected = ((~d1 & d0) & (((eedd_i & eedc_i) | ((((d0 ^ d1) | eedc_i) & eedd_i) & eedd_i)) | (((((d0 & ((~d1 & eedd_i) | eedc_i)) | eedc_i) & c0) | ((d1 & (eedd_i & ~d0)) & c0)) & ~c1))) | ((((eedd_i & eedc_i) | ((((d0 ^ d1) | eedc_i) & eedd_i) & eedd_i)) | (((((d0 & ((~d1 & eedd_i) | eedc_i)) | eedc_i) & c0) | ((d1 & (eedd_i & ~d0)) & c0)) & ~c1)) & ((~d0 & d1) | (~c1 & c0)));
