...
module receiver(input  clk_i,
  ...
  parameter  BRW = BAUD_RATE_WIDTH+(0-1);
  ...
  reg  c0,c1;
  wire 
       edgeDetected = (((((~(eedd_i & d0) & d1) & eedd_i) | (((((~d1 & ((eedd_i & d0) | eedc_i)) | eedc_i) | (~d0 & eedd_i)) & (((~d1 & ((eedd_i & d0) | eedc_i)) | eedc_i) | d1)) & (c0 | (eedd_i & (d0 & ~(d1 & eedd_i)))))) & ~c1) & ((((~d1 & ((eedd_i & d0) | eedc_i)) | eedc_i) | (~d0 & eedd_i)) & (((~d1 & ((eedd_i & d0) | eedc_i)) | eedc_i) | d1))) | (((~d1 | ~d0) & (((~d1 | (d0 | d1)) & d0) | d1)) & (((((~d1 & ((eedd_i & d0) | eedc_i)) | eedc_i) | (~d0 & eedd_i)) & (((~d1 & ((eedd_i & d0) | eedc_i)) | eedc_i) | d1)) & eedd_i));
