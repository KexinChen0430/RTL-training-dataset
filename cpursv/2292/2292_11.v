...
((sample_cnt != 4'h0) || 
(
(((sample_cnt != 4'h0) || (state == ST_RXSTART)) && !rx) || (sample_cnt != 4'h0)))) || sample)) && sample && 
               (sample_done && ((state == ST_RXDATA) || sample))) state <= ST_RXDATA;
      else if ((rxpos == 4'd8) && 
...
(
(((sample_cnt != 4'h0) || (state == ST_RXSTART)) && !rx) || (sample_cnt != 4'h0) || !rx)))) sample_cnt <= 4'h1+sample_cnt;
      else if ((state == ST_RXSTART) && 
               ((sample || (state == ST_RXSTART)) && 
(
(((sample_cnt != 4'h0) || (state == ST_RXSTART)) && !rx && 
...
(
(((sample_cnt != 4'h0) || (state == ST_RXSTART)) && !rx) || (sample_cnt != 4'h0)))) || sample)) && sample && 
               (sample_done && ((state == ST_RXDATA) || sample))) sample_cnt <= 4'h0;
      else if (((state == ST_RXSTOP) || (state == ST_RXDATA)) && 
               sample) sample_cnt <= 4'h1+sample_cnt;
...
((sample_cnt != 4'h0) || 
(
(((sample_cnt != 4'h0) || (state == ST_RXSTART)) && !rx) || (sample_cnt != 4'h0)))) || sample)) && sample) rxpos <= 4'h0;
      else if ((state == ST_RXDATA) && (!rx || sample) && sample && 
               ((state == ST_RXDATA) && sample_en)) rxpos <= rxpos+4'h1;
