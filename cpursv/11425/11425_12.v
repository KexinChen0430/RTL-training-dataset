...
module mpfe_rst(input  bus_clk,
  ...
  wire 
       timer_resetn = cpu_resetn_sync[1] & pcie_perstn_sync[1];
  ...
  wire 
       mpfe_arstn = (cal_success & global_reset_n) & (pcie_ready & pll_locked);
  ...
  wire 
       ctrl_arstn = (global_reset_n & (pll_locked & cal_success)) & (init_done & pcie_ready);
