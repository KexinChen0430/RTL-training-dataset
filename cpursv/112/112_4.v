...
module rptr_empty  #(parameter  ADDRSIZE = 3, ALMOST_EMPTY_SIZE = 3)
  ...
  assign raddr = rbin[ADDRSIZE+(0-1):0];
  assign rbinnext = rbin+(rinc & ~rempty);
  assign rgraynext = ((((~((rbinnext & rbinnext>>1) & ~rbinnext>>1) & (~rbinnext>>1 & (((rbinnext>>1 | ~rbinnext>>1) & rbinnext) & rbinnext))) | (((rbinnext & rbinnext>>1) & ~rbinnext>>1) & ~(~rbinnext>>1 & (((rbinnext>>1 | ~rbinnext>>1) & rbinnext) & rbinnext)))) | ~rbinnext) & (((rbinnext | ~rbinnext) & rbinnext>>1) & (((rbinnext | rbinnext>>1) & ~rbinnext>>1) | (rbinnext>>1 | ~rbinnext>>1)))) ^ (((((rbinnext | rbinnext>>1) & ~rbinnext>>1) | (rbinnext>>1 | ~rbinnext>>1)) & rbinnext) & (((~((rbinnext & rbinnext>>1) & ~rbinnext>>1) & (~rbinnext>>1 & (((rbinnext>>1 | ~rbinnext>>1) & rbinnext) & rbinnext))) | (((rbinnext & rbinnext>>1) & ~rbinnext>>1) & ~(~rbinnext>>1 & (((rbinnext>>1 | ~rbinnext>>1) & rbinnext) & rbinnext)))) | ~rbinnext));
  ...
  wire [ADDRSIZE:0] 
       subtract = (ALMOST_EMPTY_SIZE+rbinnext)+(-rq2_wptr_bin);
