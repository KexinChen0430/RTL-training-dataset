...
module rptr_empty  #(parameter  ADDRSIZE = 3, ALMOST_EMPTY_SIZE = 3)
  ...
  assign rgraynext = (((~rbinnext>>1 | rbinnext>>1) & rbinnext) & ~((rbinnext>>1 | ((~rbinnext>>1 | rbinnext>>1) & rbinnext)) & ((rbinnext>>1 & (~rbinnext | rbinnext)) & (~rbinnext>>1 | rbinnext>>1)))) | (~((~rbinnext>>1 | rbinnext>>1) & rbinnext) & ((rbinnext>>1 | ((~rbinnext>>1 | rbinnext>>1) & rbinnext)) & ((rbinnext>>1 & (~rbinnext | rbinnext)) & (~rbinnext>>1 | rbinnext>>1))));
