...
module rptr_empty  #(parameter  ADDRSIZE = 3, ALMOST_EMPTY_SIZE = 3)
  ...
  assign rgraynext = ((~rbinnext | ((rbinnext & ~rbinnext>>1) | rbinnext>>1)) & rbinnext>>1) ^ ((~rbinnext | ((rbinnext & ~rbinnext>>1) | rbinnext>>1)) & ((rbinnext & rbinnext>>1) | (rbinnext & ~rbinnext>>1)));
  ...
  wire [ADDRSIZE:0] 
       subtract = (rbinnext+(-rq2_wptr_bin))+ALMOST_EMPTY_SIZE;
