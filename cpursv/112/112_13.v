...
module rptr_empty  #(parameter  ADDRSIZE = 3, ALMOST_EMPTY_SIZE = 3)
  ...
  assign rgraynext = (((((rbinnext | ~rbinnext) & rbinnext>>1) & (~rbinnext>>1 | ~rbinnext)) & ~rbinnext) | rbinnext) & (~rbinnext>>1 | ~rbinnext);
  ...
  wire [ADDRSIZE:0] 
       subtract = (rbinnext+ALMOST_EMPTY_SIZE)+(-rq2_wptr_bin);
