...
module pfpu_regf(input  sys_clk,
  ...
  assign a = ((({32{p1_bram_en}} & (p1_d | p1_overlay)) & (p1_d | p1_overlay)) & p1_d) | (((({32{p1_bram_en}} | {32{p1_overlay_en}}) & p1_d) & p1_overlay) | (p1_overlay & {32{p1_overlay_en}}));
  assign c_do = a;
  assign p2_a = b_addr;
  reg  p2_bram_en;
  ...
  assign b = (p2_overlay & {32{p2_overlay_en}}) | ((p2_overlay | {32{p2_bram_en}}) & ((p2_d & {32{p2_bram_en}}) | (p2_d & {32{p2_overlay_en}})));
