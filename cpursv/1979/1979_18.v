      ...
      begin
        if (input_rst_sync2) 
          ...
          begin
            ...
            wr_ptr <= wr_ptr_next;
            wr_ptr_gray <= (wr_ptr_next & (~wr_ptr_next>>1 | ~wr_ptr_next)) | ((~wr_ptr_next & ((wr_ptr_next>>1 & ((wr_ptr_next | ~wr_ptr_next) & wr_ptr_next>>1)) ^ (((wr_ptr_next | ~wr_ptr_next) & wr_ptr_next>>1) & (wr_ptr_next & wr_ptr_next>>1)))) ^ (~wr_ptr_next & ((wr_ptr_next & wr_ptr_next>>1) ^ (wr_ptr_next & (wr_ptr_next & wr_ptr_next>>1)))));
          end
      ...
      begin
        if (output_rst_sync2) 
          ...
          begin
            ...
            rd_ptr <= rd_ptr_next;
            rd_ptr_gray <= ((rd_ptr_next>>1 & (rd_ptr_next | (~rd_ptr_next>>1 | ~rd_ptr_next))) & ~((rd_ptr_next | (~rd_ptr_next>>1 | ~rd_ptr_next)) & ((rd_ptr_next>>1 | ~rd_ptr_next>>1) & rd_ptr_next))) | (~(rd_ptr_next>>1 & (rd_ptr_next | (~rd_ptr_next>>1 | ~rd_ptr_next))) & ((rd_ptr_next | (~rd_ptr_next>>1 | ~rd_ptr_next)) & ((rd_ptr_next>>1 | ~rd_ptr_next>>1) & rd_ptr_next)));
          end
