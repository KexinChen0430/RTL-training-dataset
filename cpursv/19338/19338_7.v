...
module vga_mem_arbitrer(input  clk_i,
                        input  rst_i,
                        input  [17:1] wb_adr_i,
                        input  [1:0] wb_sel_i,
                        input  wb_we_i,
