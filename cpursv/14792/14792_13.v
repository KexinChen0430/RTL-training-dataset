      ...
      begin
        if (zer) r0[0:15] <= 16'b0;
          ...
          begin
            ...
            else if ((((s_1 & c2) & (~s0 | s0)) & (c2 | ((~s0 & ((s_1 & (s_1 & (s_1 & (~s0 | s0)))) ^ (s_1 & (s0 & s_1)))) ^ (~s0 & (s_1 & ((~s_1 | ~s0) & ((s_1 | ~s_1) & s0))))))) ^ (((~s0 | s0) & (c2 & ((c2 | ~s_1) & s0))) & (c2 | ((~s0 & ((s_1 & (s_1 & (s_1 & (~s0 | s0)))) ^ (s_1 & (s0 & s_1)))) ^ (~s0 & (s_1 & ((~s_1 | ~s0) & ((s_1 | ~s_1) & s0)))))))) r0[2] <= 1'b1;
