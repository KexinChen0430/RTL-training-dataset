...
module dpMem_dc(addrIn,addrOut,wrClk,rdClk,dataIn,writeEn,readEn,dataOut);
  ...
  input  writeEn;
  input  readEn;
  input  [(0-1)+ADDR_WIDTH:0] addrIn;
  input  [(0-1)+ADDR_WIDTH:0] addrOut;
  wire wrClk;
  wire rdClk;
  ...
  wire writeEn;
  wire readEn;
  wire [(0-1)+ADDR_WIDTH:0] addrIn;
  wire [(0-1)+ADDR_WIDTH:0] addrOut;
  reg  [FIFO_WIDTH+(0-1):0] buffer[0:FIFO_DEPTH-1];
