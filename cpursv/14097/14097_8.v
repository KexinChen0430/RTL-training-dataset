...
module hardcopyiv_dpa_retime_block(clkin,datain,reset,clk0,clk1,clk2,clk3,clk4,clk5,clk6,clk7,
...
(
((last_clk_period != 0) && 
(clk_period == last_clk_period)) || (clk_period == (last_clk_period-1)) || 
(clk_period == (1+last_clk_period))) && ((clk_period != 0) && (last_clk_period != 0))) lock_tmp = 1'b1;
        else lock_tmp = 1'b0;
      end
