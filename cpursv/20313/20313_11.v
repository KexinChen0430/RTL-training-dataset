      ...
      begin
        if (piso_actual == 3'b000) 
          begin
            ...
            if ((((solicitud_p1 == (solicitud_p2 | 2'bx0)) == (2'bx0 | solicitud_p3)) == (solicitud_p4 | 2'bx0)) == 2'bx0) accion <= 2'b10;
          ...
          begin
            ...
            if ((((solicitud_ps == (solicitud_p1 | 2'b0x)) == (solicitud_p2 | 2'b0x)) == (solicitud_p3 | 2'b0x)) == 2'b0x) accion <= 2'b11;
