...
module base_forwarding_unit(input  ex_mem_reg_write,
  ...
  always @* 
      begin
        ...
        if (ex_mem_dst_reg_is_not_zero & ex_mem_reg_write) 
          begin
        ...
        if (mem_wb_dst_reg_is_not_zero & mem_wb_reg_write) 
          begin
            if ((ex_mem_dst_reg != rs) & (mem_wb_dst_reg == rs)) forward_control[2] = 1'b1;
            else forward_control[2] = 1'b0;
            if ((ex_mem_dst_reg != rt) & (mem_wb_dst_reg == rt)) forward_control[3] = 1'b1;
