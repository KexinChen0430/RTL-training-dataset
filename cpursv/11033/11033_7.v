...
module vga_sync(input  wire clk,
  ...
  assign line_pulse = (q_hcnt == (((0-1)+H_FP)+(H_BP+(H_RT+H_DISP)))) && 
                      pix_pulse;
  assign screen_pulse = (q_vcnt == ((V_FP+V_RT)+((V_DISP+(0-1))+V_BP))) && 
                        line_pulse;
  ...
  assign y_next = (y == ((V_BP+(V_RT+(-10'h001)))+(V_FP+V_DISP))) ? 10'h000 : (10'h001+q_vcnt);
  assign en = q_en;
