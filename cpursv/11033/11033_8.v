...
module vga_sync(input  wire clk,
  ...
  assign line_pulse = (q_hcnt == ((H_FP+((-1)+H_DISP))+(H_BP+H_RT))) && 
                      pix_pulse;
  assign screen_pulse = (q_vcnt == ((-1)+(V_BP+((V_FP+V_DISP)+V_RT)))) && 
                        line_pulse;
  ...
  assign y_next = (y == ((V_BP+V_DISP)+((V_FP+V_RT)+(0-10'h001)))) ? 10'h000 : (10'h001+q_vcnt);
  assign en = q_en;
