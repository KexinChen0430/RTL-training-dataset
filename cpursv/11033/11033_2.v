...
module vga_sync(input  wire clk,
  ...
  assign line_pulse = pix_pulse && 
                      (q_hcnt == (((H_DISP+H_FP)+((0-1)+H_BP))+H_RT));
  assign screen_pulse = (q_vcnt == ((V_RT+V_FP)+(((0-1)+V_BP)+V_DISP))) && 
                        line_pulse;
  ...
  assign y_next = (y == ((((-10'h001)+V_DISP)+V_RT)+(V_FP+V_BP))) ? 10'h000 : (q_vcnt+10'h001);
  assign en = q_en;
      ...
      begin
        if (rst) 
          ...
          begin
            ...
            d_hsync = (q_hcnt < (H_RT+(H_DISP+H_FP))) && 
                      (q_hcnt >= (H_DISP+H_FP));
