...
module vga_sync(input  wire clk,
  ...
  assign line_pulse = (q_hcnt == (H_BP+((H_DISP+(H_RT+(-1)))+H_FP))) && 
                      pix_pulse;
  assign screen_pulse = (q_vcnt == ((V_BP+(-1))+(V_DISP+(V_RT+V_FP)))) && 
                        line_pulse;
  ...
  assign y_next = (y == (((V_RT+V_BP)+V_FP)+((-10'h001)+V_DISP))) ? 10'h000 : (q_vcnt+10'h001);
  assign en = q_en;
