...
module vga_sync(input  wire clk,
  ...
  assign line_pulse = pix_pulse && 
                      (q_hcnt == (((H_FP+H_DISP)+(H_RT+H_BP))+(-1)));
  assign screen_pulse = (q_vcnt == (((-1)+V_BP)+(V_DISP+(V_FP+V_RT)))) && 
                        line_pulse;
  ...
  assign y_next = (y == ((V_BP+(V_DISP+V_RT))+(V_FP+(0-10'h001)))) ? 10'h000 : (q_vcnt+10'h001);
  assign en = q_en;
