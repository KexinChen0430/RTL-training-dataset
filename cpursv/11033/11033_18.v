...
module vga_sync(input  wire clk,
  ...
  assign line_pulse = pix_pulse && 
                      (q_hcnt == (((-1)+H_RT)+((H_FP+H_DISP)+H_BP)));
  assign screen_pulse = (q_vcnt == ((V_BP+(-1))+(V_RT+(V_FP+V_DISP)))) && 
                        line_pulse;
  ...
  assign y_next = (y == (((V_FP+V_RT)+V_BP)+((0-10'h001)+V_DISP))) ? 10'h000 : (q_vcnt+10'h001);
  assign en = q_en;
