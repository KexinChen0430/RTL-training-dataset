...
module vga_sync(input  wire clk,
  ...
  assign line_pulse = (q_hcnt == (((H_BP+H_RT)+H_DISP)+(H_FP+(0-1)))) && 
                      pix_pulse;
  assign screen_pulse = (q_vcnt == ((V_DISP+(0-1))+(V_FP+(V_RT+V_BP)))) && 
                        line_pulse;
  ...
  assign y_next = (y == (V_BP+((((0-10'h001)+V_RT)+V_DISP)+V_FP))) ? 10'h000 : (10'h001+q_vcnt);
  assign en = q_en;
