  ...
  always @(*)
      begin
        case (op_code)
          ...
          6: {overflow,result} = (((operand2 | ~operand2) & operand1) ^ operand2) | operand2;

          7: {overflow,result} = ((operand2 | ~operand2) & operand1) ^ operand2;

          8: {overflow,result} = ~((((operand2 | ~operand2) & operand1) ^ operand2) | operand2);
