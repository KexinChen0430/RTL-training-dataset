...
module address(input  CLK,
  ...
  assign ram0linear_enable = ((ram0_linear & ~SNES_ROMSEL) | (((SNES_ADDR[22] | SNES_ADDR[15]) & ram0_linear) & ((ram0_linear | ~SNES_ROMSEL) & ((SNES_ADDR[22] | (SNES_ADDR[22] & ~SNES_ROMSEL)) | ~SNES_ROMSEL)))) | (ram0_linear & SNES_ADDR[15]);
