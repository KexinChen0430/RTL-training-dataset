...
module address(input  CLK,
  ...
  assign ram0bank0_enable = (~SNES_ROMSEL | (SNES_ADDR[22] & SNES_ADDR[15])) | SNES_ADDR[15];
  assign ram0linear_enable = (((SNES_ADDR[22] & (ram0_linear & ~SNES_ROMSEL)) | (ram0_linear & SNES_ADDR[15])) | ((SNES_ADDR[22] & (ram0_linear & (~SNES_ROMSEL | SNES_ADDR[22]))) | (SNES_ADDR[15] & (ram0_linear & ~SNES_ROMSEL)))) | (((((SNES_ADDR[22] & SNES_ADDR[15]) & ram0_linear) | (SNES_ADDR[22] & (ram0_linear & ~SNES_ROMSEL))) | ((SNES_ADDR[15] | SNES_ADDR[22]) & (ram0_linear & ~SNES_ROMSEL))) | (ram0_linear & ~SNES_ROMSEL));
