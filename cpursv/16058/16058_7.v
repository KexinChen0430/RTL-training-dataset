...
module address(input  CLK,
  ...
  assign ram0bank0_enable = (SNES_ADDR[15] | (SNES_ADDR[15] & ~SNES_ROMSEL)) | ~SNES_ROMSEL;
  assign ram0linear_enable = ((SNES_ADDR[15] | (((SNES_ADDR[22] | ram0_linear) & SNES_ADDR[15]) | SNES_ADDR[22])) & ram0_linear) | (((ram0_linear & (SNES_ADDR[15] & SNES_ADDR[22])) | ((((SNES_ADDR[22] | ram0_linear) & ~SNES_ROMSEL) & ram0_linear) & (((SNES_ADDR[22] | ram0_linear) & SNES_ADDR[15]) | SNES_ADDR[22]))) | (((SNES_ADDR[22] | ram0_linear) & ~SNES_ROMSEL) & ram0_linear));
  ...
  wire 
       irq_enable_ = (SNES_ADDR[10:0] == 11'h722) & ~ram0linear_enable;
