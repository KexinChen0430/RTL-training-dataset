...
module SmallBpf  #(parameter 
  ...
  reg  signed  [(0-1)+(K0_SHIFT+WIDTH):0] acc0;
      ...
      begin
        if (rst) 
          ...
          begin
            ...
            if (CLAMP) 
              begin
                acc0 <= ^acc0In[K0_SHIFT+WIDTH -: 1<<1] ? {acc0In[K0_SHIFT+WIDTH],{(0-1)+(K0_SHIFT+WIDTH){acc0In[(0-1)+(K0_SHIFT+WIDTH)]}}} : acc0In;
                acc1 <= ^acc1In[K1_SHIFT+WIDTH -: 1<<1] ? {acc1In[K1_SHIFT+WIDTH],{(0-1)+(K1_SHIFT+WIDTH){acc1In[(0-1)+(K1_SHIFT+WIDTH)]}}} : acc1In;
              end
            else 
              begin
                acc0 <= acc0In;
