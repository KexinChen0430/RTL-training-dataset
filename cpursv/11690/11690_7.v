...
module up_xfer_status(up_rstn,up_clk,up_data_status,d_rst,d_clk,d_data_status);
  ...
  assign d_xfer_enable_s = d_xfer_state ^ (d_xfer_toggle & ((d_xfer_state | d_xfer_toggle) | ~d_xfer_state));
  ...
  assign up_xfer_toggle_s = (up_xfer_toggle_m2 | (up_xfer_toggle_m3 & ~up_xfer_toggle_m2)) & (~up_xfer_toggle_m2 | ~up_xfer_toggle_m3);
