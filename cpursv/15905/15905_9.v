...
module TimeHoldOver_Qsys_uart_0_regs(input  [2:0] address,
  ...
  assign selected_read_data = (((control_reg & (status_reg & {16{address == 3'd2}})) | (({16{address == 3'd3}} | (({16{address == 3'd0}} & rx_data) | (tx_data & {16{address == 3'd1}}))) & control_reg)) | (status_reg & ({16{address == 3'd2}} | ((((tx_data | rx_data) & {16{address == 3'd0}}) | tx_data) & (({16{address == 3'd2}} | {16{address == 3'd1}}) | (({16{address == 3'd0}} | {16{address == 3'd1}}) & rx_data)))))) | (({16{address == 3'd0}} & rx_data) | (tx_data & {16{address == 3'd1}}));
  assign qualified_irq = (ie_parity_error && parity_error) || 
                         (
((ie_tx_overrun && tx_overrun) || 
((any_error && ie_any_error) || 
(ie_rx_overrun && rx_overrun) || (tx_shift_empty && ie_tx_shift_empty)) || 
...
(ie_tx_overrun && tx_overrun)))) || framing_error)) && 
(
(ie_parity_error || 
