...
module TimeHoldOver_Qsys_uart_0_regs(input  [2:0] address,
  ...
  assign selected_read_data = ((((rx_data | {16{address == 3'd1}}) & ({16{address == 3'd0}} | {16{address == 3'd1}})) & ((({16{address == 3'd0}} | tx_data) & (tx_data | rx_data)) | ({16{address == 3'd2}} & status_reg))) | ({16{address == 3'd2}} & status_reg)) | ((((({16{address == 3'd0}} | {16{address == 3'd1}}) & (tx_data & (rx_data | {16{address == 3'd1}}))) | ({16{address == 3'd3}} | (((({16{address == 3'd0}} | tx_data) & (tx_data | rx_data)) & rx_data) & {16{address == 3'd0}}))) & control_reg) | (control_reg & ((status_reg & ((tx_data & {16{address == 3'd1}}) | ({16{address == 3'd2}} | {16{address == 3'd0}}))) & (((tx_data & {16{address == 3'd1}}) | rx_data) | {16{address == 3'd2}}))));
...
(tx_shift_empty || any_error) && any_error && ie_any_error))) || break_detect) && 
(break_detect || 
(
((tx_shift_empty || ie_any_error) && 
(tx_shift_empty || any_error) && any_error && ie_any_error) || 
((ie_tx_shift_empty && tx_shift_empty) || 
(tx_overrun && ie_tx_overrun) || rx_overrun)))) || ie_parity_error) && 
(ie_parity_error || 
...
(tx_overrun || 
((tx_shift_empty || ie_any_error) && 
(tx_shift_empty || any_error) && any_error && ie_any_error))))) || (break_detect && ie_break_detect) || parity_error || 
(framing_error && 
(
(
((rx_overrun && ie_rx_overrun) || 
