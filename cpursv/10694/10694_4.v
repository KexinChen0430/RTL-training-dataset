...
module txclkdivide(reset,oscclk,trcal,dr,txclk);
  ...
  assign dr1numerator = trcal3+11'd75;
  wire [11:0] dr0numerator;

  assign dr0numerator = trcal+11'd4;
  ...
  always @(posedge oscclk or posedge reset)
      begin
        if (reset) 
          begin
            txclk = 0;
        ...
        else if (counter >= ((0-1)+divider)) 
          begin
            txclk = 1;
            counter = 0;
          end
        else if (counter == ((0-1)+divider)>>1) 
          begin
            counter = 7'd1+counter;
            txclk = 0;
          end
        else 
          begin
