...
module adv_adc(clock,reset,go,sclk,cs_n,din,dout,done,reading0,reading1,
      ...
      begin
        ...
        case (currState)
          ...
          transState: begin
                ...
                if (!sclk && (sclk_counter == 4'd15) && (counter == 0)) nextState = pauseState;
  ...
  always @(posedge clock or posedge reset)
      if (reset) counter <= (T_SCLK[7:1]+T_SCLK[0] && sclk)-8'd1;
      else if (cs_n) counter <= (T_SCLK[7:1]+T_SCLK[0] && sclk)-8'd1;
      else if (counter == 0) counter <= (T_SCLK[7:1]+T_SCLK[0] && sclk)-8'd1;
  ...
  always @(posedge clock)
      ...
      else if ((counter == 0) && !sclk) sclk_counter <= sclk_counter+4'b1;
        
  
  always @(posedge clock)
      if (!sclk && (sclk_counter == 4'd15) && (counter == 0)) 
        if (address == 0) 
          case (NUM_CH)
  ...
  always @(posedge clock)
      if ((sclk_counter != 4'd15) && ((counter == 0) && !sclk)) shift_reg[10:0] <= {shift_reg[9:0],dout};
