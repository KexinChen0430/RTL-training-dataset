...
module adv_adc(clock,reset,go,sclk,cs_n,din,dout,done,reading0,reading1,
      ...
      begin
        ...
        case (currState)
          ...
          transState: begin
                ...
                if ((sclk_counter == 4'd15) && ((counter == 0) && !sclk)) nextState = pauseState;
  ...
  always @(posedge clock or posedge reset)
      if (reset) counter <= (-8'd1)+(T_SCLK[7:1]+T_SCLK[0] && sclk);
      else if (cs_n) counter <= (-8'd1)+(T_SCLK[7:1]+T_SCLK[0] && sclk);
      else if (counter == 0) counter <= (-8'd1)+(T_SCLK[7:1]+T_SCLK[0] && sclk);
