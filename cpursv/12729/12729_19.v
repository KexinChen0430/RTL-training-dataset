...
module ps2  #(parameter  csr_addr = 4'h0, clk_freq = 100000000)
  ...
  parameter  divisor = (clk_freq/12800)*(1/16);
  ...
  always @(posedge sys_clk)
      begin
        if (sys_rst || ps2_clk_out) watchdog_timer <= divisor_100us+(0-1);
            ...
            if (enable) 
              begin
                ...
                if ((rx_clk_count == 5'd4) && 
                    (state_receive && (rx_clk_data == 1'b0))) 
                  begin
                ...
                if ((rx_clk_count == 5'd0) && (rx_clk_data == 1'b0) && 
                    state_transmit) 
                  begin
