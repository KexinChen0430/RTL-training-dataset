...
module crubits(input  [0:3] cru_base,
               input  ti_cru_clk,
               input  ti_memen,
               input  ti_ph3,
               input  [0:14] addr,
  ...
  always @(negedge ti_cru_clk)
      begin
        if ((addr[4:7] == cru_base) && (addr[0:3] == 4'b0001)) 
          begin
  ...
  always @(negedge ti_ph3)
      begin
        if ((addr[4:7] == cru_base) && 
            (ti_memen && (addr[0:3] == 4'b0001))) 
          begin
