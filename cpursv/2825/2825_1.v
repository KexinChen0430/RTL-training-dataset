...
module sha256_k_constants(input  wire [5:0] round,
                          output wire [31:0] K);
  ...
  always @* 
      begin : round_mux
        case (round)
          ...
          2: tmp_K = 32'hb5c0fbcf;

          3: tmp_K = 32'he9b5dba5;

          4: tmp_K = 32'h3956c25b;

          5: tmp_K = 32'h59f111f1;

          6: tmp_K = 32'h923f82a4;

          7: tmp_K = 32'hab1c5ed5;

          8: tmp_K = 32'hd807aa98;

          9: tmp_K = 32'h12835b01;
