...
module sirv_queue_1(input  clock,
                    input  reset,
                    output io_enq_ready,
                    input  io_enq_valid,
  ...
  wire [1<<<1:0] ram_T_51_addr;
  wire [7:0] ram_T_35_data;
  wire [1<<<1:0] ram_T_35_addr;
  wire ram_T_35_mask;
  wire ram_T_35_en;
  reg  [1<<<1:0] T_27;
  reg  [31:0] GEN_1;
  ...
  assign empty = T_32 & ptr_match;
  assign full = ptr_match & maybe_full;
  assign T_33 = io_enq_valid & io_enq_ready;
  assign do_enq = T_33;
  assign T_34 = io_deq_valid & io_deq_ready;
  assign do_deq = T_34;
  assign T_39 = T_27+3'h1;
  assign T_40 = T_39[1<<<1:0];
  assign GEN_4 = do_enq ? T_40 : T_27;
  assign T_44 = 3'h1+T_29;
  assign T_45 = T_44[1<<<1:0];
  ...
  assign ptr_diff = T_52[1<<<1:0];
  assign T_53 = ptr_match & maybe_full;
  assign T_54 = {T_53,ptr_diff};
  
  always @(posedge clock)
      begin
        if (ram_T_35_mask & ram_T_35_en) 
          begin
