...
module pfpu_sincos(input  sys_clk,
  ...
  always @(posedge sys_clk)
      begin
        ...
        if (s1_cos) 
          begin
            s2_sign <= ((~s1_a[12] & ((s1_a[12] & s1_a[11]) ^ ((s1_a[12] & s1_a[11]) & s1_a[12]))) ^ (~s1_a[12] & ((~(s1_a[11] & (s1_a[12] & s1_a[11])) & s1_a[11]) | ((s1_a[11] & (s1_a[12] & s1_a[11])) & ~s1_a[11])))) | ((((~s1_a[11] & s1_a[11]) | ~s1_a[12]) | ~s1_a[11]) & (s1_a[12] & (~s1_a[11] | s1_a[11])));
