...
module pfpu_sincos(input  sys_clk,
  ...
  always @(posedge sys_clk)
      begin
        ...
        if (s1_cos) 
          begin
            s2_sign <= (((~s1_a[12] | ~s1_a[11]) & ((s1_a[12] & (~s1_a[11] | s1_a[11])) & (~s1_a[12] | s1_a[12]))) & ~(s1_a[11] & (~s1_a[12] | ~s1_a[11]))) | (~((~s1_a[12] | ~s1_a[11]) & ((s1_a[12] & (~s1_a[11] | s1_a[11])) & (~s1_a[12] | s1_a[12]))) & (s1_a[11] & (~s1_a[12] | ~s1_a[11])));
            if (s1_a[11]) s2_rom_a <= s1_a[10:0];
            else 
              begin
                s2_rom_a <= (-s1_a[10:0])+11'd0;
