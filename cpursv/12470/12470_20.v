...
module pfpu_sincos(input  sys_clk,
  ...
  reg  s1_cos;
  reg  [12:0] s1_a;
  wire [12:0]  neg_a = 13'd0+(0-a[12:0]);
  ...
  always @(posedge sys_clk)
      begin
        ...
        if (s1_cos) 
          begin
            s2_sign <= ((s1_a[11] | s1_a[12]) & ~s1_a[11]) | (((s1_a[11] | ~s1_a[11]) & (((((s1_a[11] | ~s1_a[11]) & s1_a[12]) & s1_a[11]) & ((s1_a[11] | ~s1_a[11]) & s1_a[12])) ^ (((s1_a[11] | ~s1_a[11]) & s1_a[12]) & s1_a[11]))) ^ ((s1_a[11] | ~s1_a[11]) & ((~s1_a[11] & ((s1_a[12] & s1_a[11]) & s1_a[11])) | (s1_a[11] & ~((s1_a[12] & s1_a[11]) & s1_a[11])))));
