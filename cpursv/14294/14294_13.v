...
(Nvel[1:0] == 2) ? ((Fclk*(1/2))*(1/V100kb)) : 
(Nvel[1:0] == 1) ? (((1/V50kb)*Fclk)*(1/2)) : ((Fclk*(1/2))*(1/V12_5kb));
  reg  [10:0]  cb_tce = 0;
  reg  [7:0]  sr_adr = 0;
  reg  [22:0]  sr_dat = 0;
  ...
  assign SDAT = ((FT_cp & T_cp) | (FT_cp & sr_adr[7])) | sr_adr[7];
        ...
        if ((cb_bit == 32) || reset) 
          ...
          begin
            ...
            FT_cp <= (start | (T_cp & ce)) ? 1 : 
                    ((sr_adr[7] & (((T_cp | sr_adr[7]) | (FT_cp | T_cp)) & ce)) & (((T_cp & (T_adr_dat & (start | T_cp))) | (sr_adr[7] & T_adr_dat)) & (sr_adr[7] | (((T_cp & (T_adr_dat & (start | T_cp))) & sr_adr[7]) | (FT_cp | (((FT_cp & T_cp) | (FT_cp & sr_adr[7])) | (T_cp & sr_adr[7]))))))) ? !FT_cp : FT_cp;
            sr_adr <= start ? ADR : 
                     (ce & (((((T_cp & sr_adr[7]) | ce) | T_cp) | (start | (T_cp & ce))) & en_tx)) ? sr_adr<<<(1 | sr_dat[0]) : sr_adr;
            sr_dat <= start ? DAT : 
                     (ce & (((((T_cp & sr_adr[7]) | ce) | T_cp) | (start | (T_cp & ce))) & en_tx)) ? sr_dat>>1 : sr_dat;
          end
      end
endmodule
