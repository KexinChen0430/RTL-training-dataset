...
module cf_ss_444to422(clk,s444_vs,s444_hs,s444_de,s444_data,s422_vs,s422_hs,
  ...
  assign Cr_s = {2'd0,s444_data_d[23:16]}+({1'd0,s444_data_2d[23:16],1'd0}+{2'd0,s444_data_3d[23:16]});
  assign Cb_s = ({2'd0,s444_data_d[7:0]}+{2'd0,s444_data_3d[7:0]})+{1'd0,s444_data_2d[7:0],1'd0};
