...
module top(input  clk,
  ...
  always @* 
      begin
        next_xorshift32_state = (~(((2**13)*xorshift32_state) & ((xorshift32_state | ((2**13)*xorshift32_state)) | ~xorshift32_state)) & xorshift32_state) | ((((2**13)*xorshift32_state) & ((xorshift32_state | ((2**13)*xorshift32_state)) | ~xorshift32_state)) & ~xorshift32_state);
        next_xorshift32_state = next_xorshift32_state>>17 ^ next_xorshift32_state;
