...
module relational_7e0e56c195(input  [(0-1)+5:0] a,
                             input  [6+(0-1):0] b,
                             input  [(0-1)+1:0] en,
                             output [(0-1)+1:0] op,
                             input  clk,
  ...
  localparam [(0-1)+1:0]  const_value = 1'b1;

  wire [6+(0-1):0] cast_14_12;
  ...
  always @(posedge clk)
      begin : proc_op_mem_32_22
        ...
        if ((op_mem_32_22_push_front_pop_back_en == 1'b1) && 
            (ce == 1'b1)) 
          begin
