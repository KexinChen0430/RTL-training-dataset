...
((!ep_setup || setup) && (!ep_out_stall || setup))) && 
(
((!ep_out_stall && ep_out_full) || 
(setup || 
(((setup || ep_out_full) && !ep_out_stall && setup) || 
(ep_out_full && !ep_setup)))) && (setup || ep_out_full) && 
((!ep_out_stall || setup) && 
((!ep_out_stall && !ep_setup) || ep_out_full || setup))))) toggle = 1'b0;
      ...
      begin
        if (direction_in) 
          begin
            ...
            else if (ep_in_stall && (!ep_setup || (!ep_out_stall || setup)) && 
                     !ep_setup) 
              begin
                handshake = hs_stall;
              end
...
(ep_out_full && !ep_setup)))) && (setup || ep_out_full) && 
                ((!ep_out_stall || setup) && 
((!ep_out_stall && !ep_setup) || ep_out_full || setup)) && ((!ep_setup || setup) && (!ep_out_stall || setup))) 
              begin
                handshake = hs_ack;
              end
