...
(
(ep_out_full && 
(setup || (!ep_out_stall && ep_out_full)) && 
(
(!ep_setup && ((!ep_setup && !ep_out_stall) || setup)) || 
(
(
(!ep_setup && 
((setup || ep_out_full) && 
((ep_out_full && !ep_setup) || !ep_out_stall || setup)) && 
((ep_out_full || !ep_setup) && 
(
(setup && 
((ep_out_full || !ep_setup || setup) && 
((ep_out_full && !ep_setup) || !ep_out_stall || setup) && !ep_out_stall)) || ep_out_full))) || setup) && 
((ep_out_full || !ep_setup) && (setup || !ep_setup)) && ep_out_full))) || setup) && 
            (
(
(!ep_setup && 
((setup || ep_out_full) && 
...
((ep_out_full && !ep_setup) || !ep_out_stall || setup) && 
(!ep_out_stall || 
((!ep_setup && !ep_out_stall) || setup)))) && setup) toggle = 1'b0;
