...
module usb_ep(input  clk,
  ...
  always @(*)
      begin
        if (!direction_in && 
            (!ep_out_stall || (setup && !ep_setup) || setup) && 
            ((!ep_setup && !ep_out_stall) || ep_out_full || setup) && setup) toggle = 1'b0;
  ...
  always @(*)
      begin
        if (direction_in) 
          ...
          begin
            if (
((ep_out_full && !ep_out_stall) || (setup && !ep_setup) || 
setup || 
(
(
(!ep_out_stall && 
...
((ep_out_full && !ep_out_stall) || (setup && !ep_setup) || 
setup)) && 
(((setup && !ep_out_stall) || ep_out_full || setup) && 
(!ep_setup || !ep_out_stall || setup) && ep_out_full) && 
(
((setup && !ep_setup) || (!ep_setup && ep_out_full)) && 
(
((ep_out_full && !ep_out_stall) || (setup && !ep_setup) || 
setup) && !ep_out_stall)))) && 
                ((ep_out_full && !ep_out_stall) || (setup && !ep_setup) || 
