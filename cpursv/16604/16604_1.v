...
module ps2_host_to_kb(input  wire clk,
      ...
      begin
        ...
        if (!ps2clknedge) 
          begin
            ...
            if ((state != 3'b110) && (timeoutcnt == 16'hFFFF)) 
              begin
                error <= 1'b1;
                state <= 3'b110;
              end
  ...
  assign ps2data_ext = ((state == 3'b001) || (state == 3'b000)) ? 1'b0 : 
                       ((state == 3'b010) && (shiftreg[0] == 1'b0)) ? 1'b0 : 
                       ((state == 3'b011) && (paritycalculated == 1'b0)) ? 1'b0 : 1'bZ;
