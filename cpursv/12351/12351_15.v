...
module flt_fx(input  [31:0] fp_in,
  ...
  assign bias_exp = fp_in[30:23]+(0-8'd127);
  ...
  always @* 
      begin
        ...
        else int_fixed_out = bias_mant[38:0]*(2**bias_exp);
        fixed_out = int_fixed_out[6]+int_fixed_out[38:7];
