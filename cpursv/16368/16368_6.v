...
module rfid_reader_tx(reset,clk,reader_modulation,tx_done,tx_running,tx_go,
  ...
  assign bit_transition = ((data0_bit_transition & (!current_bit | (data0_bit_transition & data1_bit_transition))) | (!current_bit & data1_bit_transition)) | data1_bit_transition;
