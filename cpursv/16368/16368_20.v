...
module rfid_reader_tx(reset,clk,reader_modulation,tx_done,tx_running,tx_go,
  ...
  assign data1_end_count = (1<<1*tari_counts)+pw_counts;
  assign data0_tran_count = tari_counts;
  assign data1_tran_count = 1<<1*tari_counts;
  ...
  assign bit_transition = data1_bit_transition | ((((!current_bit & data0_bit_transition) | (data1_bit_transition & data0_bit_transition)) | (!current_bit & data1_bit_transition)) & (data1_bit_transition | !current_bit));
  assign bit_end = ((data0_bit_end | (!current_bit & ((!current_bit & data1_bit_end) | data0_bit_end))) & (data1_bit_end | !current_bit)) | data1_bit_end;
  wire 
      rtcal_end       ,
      rtcal_transition,
      trcal_end       ,
