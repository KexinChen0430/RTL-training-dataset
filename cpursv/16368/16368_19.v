...
module rfid_reader_tx(reset,clk,reader_modulation,tx_done,tx_running,tx_go,
  ...
  assign data1_end_count = (tari_counts*1<<<1)+pw_counts;
  ...
  assign bit_transition = (data0_bit_transition | data1_bit_transition) & (data1_bit_transition | !current_bit);
  assign bit_end = (((data0_bit_end & (!current_bit | (data0_bit_end & data1_bit_end))) | (data1_bit_end & !current_bit)) | (data0_bit_end & data1_bit_end)) | data1_bit_end;
  wire 
      rtcal_end       ,
      rtcal_transition,
      trcal_end       ,
