...
module rfid_reader_tx(reset,clk,reader_modulation,tx_done,tx_running,tx_go,
  ...
  assign data1_end_count = pw_counts+(tari_counts*1<<1);
  assign data0_tran_count = tari_counts;
  assign data1_tran_count = tari_counts*1<<1;
  ...
  assign bit_end = data1_bit_end | ((data1_bit_end & !current_bit) | (!current_bit & data0_bit_end));
  wire 
      rtcal_end       ,
      rtcal_transition,
      trcal_end       ,
