...
module rfid_reader_tx(reset,clk,reader_modulation,tx_done,tx_running,tx_go,
  ...
  assign data1_end_count = tari_counts<<<1+pw_counts;
  ...
  assign bit_transition = (!current_bit & data0_bit_transition) | data1_bit_transition;
              ...
              STATE_IDLE: begin
                    ...
                    if (tx_go) 
                      begin
                        ...
                        tx_running <= 1;
                        modout <= 0;
                        current_tx_bit <= (-1)+tx_packet_length;
                      end
                    else 
                      begin
                        tx_running <= 0;
                    ...
                    if (bit_end) 
                      begin
                        ...
                        if (current_tx_bit == 0) 
                          ...
                          begin
                            current_tx_bit <= (-1)+current_tx_bit;
                          end
                      end
