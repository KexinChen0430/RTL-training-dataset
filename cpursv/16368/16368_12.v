...
module rfid_reader_tx(reset,clk,reader_modulation,tx_done,tx_running,tx_go,
  ...
  assign data1_end_count = (tari_counts+pw_counts)+tari_counts;
  ...
  assign bit_transition = data1_bit_transition | (data0_bit_transition & (data1_bit_transition | !current_bit));
