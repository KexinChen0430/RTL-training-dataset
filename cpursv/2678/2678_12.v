...
(wr_ptr[(-1)+ADDR_WIDTH:0] == rd_ptr[(-1)+ADDR_WIDTH:0]);
  ...
  wire 
       read = (((output_axis_tready & ~output_axis_tvalid_reg) | (~output_axis_tvalid_reg & ~empty)) | output_axis_tready) & ~empty;
  ...
  always @(posedge clk or posedge rst)
      begin
        ...
        else if ((~output_axis_tvalid_reg | (output_axis_tready & ~empty)) | (((output_axis_tready & ~output_axis_tvalid_reg) | (~output_axis_tvalid_reg & ~empty)) | output_axis_tready)) 
          begin
