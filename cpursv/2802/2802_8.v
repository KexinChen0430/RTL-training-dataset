...
module BET_FSM(clk_50,rst,ram_addr,ram_r,ram_w,ram_w_en,garbage_en,
               garbage_state,garbage_addr);
        ...
        if (rst == 1'b0) 
          ...
          begin
            ...
            case (S)
              ...
              cmp_ratio: begin
                    if (ratio < T) NS <= cmp_ratio;
                    else NS <= cmp_flag_count;
                  end

              cmp_flag_count: begin
                    if (f_cnt < BET_size) NS <= read_bet;
                    else NS <= rst_bet;
                  end
              ...
              check_flag: begin
                    if (flag == 1'b1) 
                      begin
                        ...
                        f_index_next <= 1'b1+f_index_next;
                      end
                    else 
                      begin
                        NS <= errase_start;
