...
module hazard_unit(input  clk,
  ...
  always @* 
      begin
        coincidence = 0;
        if (
((id_rt == ex_dst_reg) && id_rt_is_source | (id_rs == ex_dst_reg)) && ex_reg_write) coincidence[0] = 1'b1;
        else if (
(id_rt_is_source && (id_rt == mem_dst_reg) | (id_rs == mem_dst_reg)) && mem_reg_write) coincidence[1] = 1'b1;
