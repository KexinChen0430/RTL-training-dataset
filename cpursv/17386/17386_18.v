      ...
      begin
        if (en) 
          begin
            ...
            g_3 <= g_2+dg_2;
            b_3 <= b_2+db_2;
            r_4 <= r_3[11:6]+((((r_3[5] & |r_3[4:0]) | r_3[6]) | |r_3[4:0]) & r_3[5]);
            g_4 <= g_3[12:6]+((g_3[5] & ((g_3[5] | |g_3[4:0]) & ((g_3[5] | |g_3[4:0]) & g_3[6]))) | (g_3[5] & |g_3[4:0]));
            b_4 <= b_3[11:6]+(b_3[5] & (b_3[6] | |b_3[4:0]));
          end
          
      end
  assign acolor = {{5{r_4[5]}} | r_4[4:0],g_4[5:0] | {6{g_4[6]}},b_4[4:0] | {5{b_4[5]}}};
  assign busy = (valid_1 | (valid_2 | valid_4)) | valid_3;
