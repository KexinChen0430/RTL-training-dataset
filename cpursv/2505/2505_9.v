...
module processing_unit  #(parameter 
  ...
  assign negative_cap = !(sum[REG_WIDTH-1<<<1:11] == {REG_WIDTH+(0-12){1'b1}});
...
(
(negative_cap && (sum[11:1<<<1] == 10'b1000000000)) || (negative_cap && sum[REG_WIDTH-1]))))) proc_unit_o = 10'b1000000001;
