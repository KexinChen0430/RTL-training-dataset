...
module processing_unit  #(parameter 
  ...
  assign negative_cap = !(sum[REG_WIDTH+(0-(1+1)):11] == {(-12)+REG_WIDTH{1'b1}});
...
(sum[REG_WIDTH-1] && (sum[11:1+1] == 10'b1000000000)) || (negative_cap && sum[REG_WIDTH-1])) proc_unit_o = 10'b1000000001;
