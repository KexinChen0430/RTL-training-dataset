...
(
(
((handB <= MAXH) && ((handA > MAXH) && (handB > handA))) || (handB > MAXH) || ((handA > MAXH) || (handB > handA))) && (handB > MAXH)) || 
                  (
(
((handB <= MAXH) && ((handA > MAXH) && (handB > handA))) || (handB > MAXH) || ((handA > MAXH) || (handB > handA))) && 
(
((handA > MAXH) && 
(((handA > MAXH) && (handB > handA)) || (handB <= MAXH)) && (handB <= MAXH)) || ((handA > handB) && (handB > MAXH)) || (handA > MAXH)))) next_state = ST_OUTPUT;
...
(((handA > MAXH) && (handB > handA)) || (handB <= MAXH)) && (handB <= MAXH)) || ((handA > handB) && (handB > MAXH)) || (handA > MAXH)))) next_state = ST_OUTPUT;
  ...
  always @(posedge CLK)
      begin
        if ((handA <= MAXH) && 
            (((handA <= MAXH) && (handB > MAXH)) || (handA > handB))) 
          begin
            WIN <= 2'b00;
            SUM <= handA;
          end
        else if (((handB <= MAXH) || (handA > MAXH)) && 
                 ((handA > MAXH) || (handB > handA)) && (handB <= MAXH)) 
          begin
            WIN <= 2'b01;
            SUM <= handB;
          end
