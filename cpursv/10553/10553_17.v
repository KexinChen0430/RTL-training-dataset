  ...
  always @(state or handA or handB or MORE or inIN or inBT or inMR or RESET)
      begin
        case (state)
          ...
          ST_SC: if (
(((handB <= MAXH) || (handB > handA)) && (handA > MAXH)) || 
                  (
((handB <= MAXH) && 
((handB > handA) && 
(((handB <= MAXH) || (handB > handA)) && (handA > MAXH)))) || 
((handB > MAXH) && ((handA > handB) || (handA <= MAXH))) || (handB > MAXH)) || (handA > MAXH)) next_state = ST_OUTPUT;
...
((handB > MAXH) && ((handA > handB) || (handA <= MAXH)))) && (handA <= MAXH)) 
          begin
            ...
            SUM <= handA;
                 ...
                 (((handA > MAXH) || (handB > handA)) && 
(
(((handB <= MAXH) || (handB > handA)) && (handA > MAXH)) || (handB <= MAXH) || (handA > MAXH)))) 
          begin
            WIN <= 2'b01;
            SUM <= handB;
          end
