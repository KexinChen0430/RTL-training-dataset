  ...
  always @(state or handA or handB or MORE or inIN or inBT or inMR or RESET)
      begin
        case (state)
          ...
          ST_SC: if ((handA > MAXH) || ((handB > MAXH) && (handA > handB)) || 
                  (handB > MAXH)) next_state = ST_OUTPUT;
              else next_state = ST_WAIT;

          ST_A: if ((handA > MAXH) || ((handB > MAXH) && (handA > handB)) || 
                  (handB > MAXH)) next_state = ST_OUTPUT;
              else next_state = ST_WAIT;

          ST_B: if ((handA > MAXH) || ((handB > MAXH) && (handA > handB)) || 
                  (handB > MAXH)) next_state = ST_OUTPUT;
              else next_state = ST_WAIT;
...
((handB > MAXH) && ((handA > handB) || (handA <= MAXH)))) && (handA <= MAXH)) 
          begin
            ...
            SUM <= handA;
                 ...
                 (((handB <= MAXH) && (handA > MAXH)) || (handB > handA))) 
          begin
            WIN <= 2'b01;
            SUM <= handB;
          end
