      ...
      begin
        case (state)
          ...
          ST_SC: if ((handA > MAXH) || 
                  ((handA <= MAXH) && 
(
((handA <= MAXH) || ((handB > MAXH) && (handA > handB))) && ((handB > MAXH) || (handA > handB))) && (handA > handB) && 
(((handA <= MAXH) && (handB > MAXH)) || 
((handB > MAXH) && (handA > handB)))) || ((handB > MAXH) && (handA > handB)) || (handB > MAXH)) next_state = ST_OUTPUT;
...
((handB > MAXH) && (handA > handB)))) || ((handB > MAXH) && (handA > handB)) || (handB > MAXH)) next_state = ST_OUTPUT;
  ...
  always @(posedge CLK)
      begin
        if ((handA <= MAXH) && 
            (
((handA <= MAXH) || ((handB > MAXH) && (handA > handB))) && ((handB > MAXH) || (handA > handB)))) 
          begin
            WIN <= 2'b00;
            SUM <= handA;
          end
...
(
(((handB <= MAXH) || (handA > MAXH)) && (handB > handA)) || (handA > MAXH)) && (handB <= MAXH)) 
          begin
            WIN <= 2'b01;
            SUM <= handB;
          end
