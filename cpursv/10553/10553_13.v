  ...
  always @(state or handA or handB or MORE or inIN or inBT or inMR or RESET)
      begin
        case (state)
          ...
          ST_SC: if (
((handA > handB) && (handA <= MAXH) && 
((handB > MAXH) && (handA > handB))) || (handA > MAXH) || 
                  (
((handA > MAXH) && ((handB <= MAXH) && (handB > handA))) || (handB > MAXH))) next_state = ST_OUTPUT;
