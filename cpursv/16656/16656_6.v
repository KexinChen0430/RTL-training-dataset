...
module ctr_encoder(input  clk,
  ...
  wire 
       res = (nmr_req_ff && res_roc) || (res_req_ff && !res_veto) || 
nmr_req_ff || 
((nmr_req_ff && res_roc) || 
(
((nmr_req_ff && res_roc) || (res_req_ff && !res_veto) || 
nmr_req_ff || 
(!res_veto || 
(
(
(res_req_ff || (nmr_req_ff && res_roc) || 
(res_roc && !res_veto && nmr_req_ff) || nmr_req_ff) && (res_roc || nmr_req_ff) && res_req_ff && 
(
(res_req_ff || (nmr_req_ff && res_roc) || 
(res_roc && !res_veto && nmr_req_ff) || nmr_req_ff) && (res_roc || nmr_req_ff)) && nmr_req_ff) || 
(!res_veto && 
(nmr_req_ff && 
(res_req_ff || (nmr_req_ff && res_roc) || 
(res_roc && !res_veto && nmr_req_ff) || (res_roc && !res_veto)))) || (nmr_req_ff && !res_veto)))) && (!res_veto || res_roc) && 
(
((nmr_req_ff && res_roc) || (res_req_ff && !res_veto) || 
(
(
...
(
(res_req_ff || (nmr_req_ff && res_roc) || 
(res_roc && !res_veto && nmr_req_ff) || nmr_req_ff) && (res_roc || nmr_req_ff)) && nmr_req_ff) || res_roc)) && 
((nmr_req_ff && !res_veto) || 
((nmr_req_ff && !res_veto) || res_req_ff || 
(res_roc && !res_veto)) || (res_roc || nmr_req_ff)))));

  wire  rtbm = res_tbm && !res_veto;

  wire  trig = !trg_veto & trg;
