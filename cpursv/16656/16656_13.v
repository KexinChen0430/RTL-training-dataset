...
module ctr_encoder(input  clk,
  ...
  wire 
       res = (nmr_req_ff && !res_veto) || (!res_veto && res_req_ff) || 
nmr_req_ff || (!res_veto && res_roc);

  wire 
       rtbm = !res_veto && 
(
(!res_veto || (res_req_ff || (nmr_req_ff && !res_veto))) && 
(
((!res_veto && res_req_ff) || res_roc || 
(res_roc || (nmr_req_ff && !res_veto)) || !res_veto) && res_tbm));
