...
module ctr_encoder(input  clk,
  ...
  wire 
       res = (!res_veto && res_req_ff) || (res_roc && nmr_req_ff) || 
(res_roc && (nmr_req_ff && !res_veto)) || nmr_req_ff || 
((res_req_ff && nmr_req_ff) || (res_roc && nmr_req_ff) || 
((res_roc && !res_veto) || (res_req_ff && nmr_req_ff)));

  wire 
       rtbm = !res_veto && (res_tbm && (res_req_ff || !res_veto));
