...
module arbiter(output wire [31:0] wb_m0_vcache_dat_o,
        ...
        begin
          if (cellram_mst_sel == 2'b00) 
            begin
              ...
              else if (wb_m1_cpu_cyc_i & wb_m1_cpu_stb_i) cellram_mst_sel[0] <= 1;
  ...
  always @(posedge wb_clk or posedge wb_rst)
      ...
      else if (|cellram_rst_counter) cellram_rst_counter <= cellram_rst_counter-1;
...
(cellram_mst_sel[1] ? wb_m0_vcache_stb_i : 0) & !|cellram_rst_counter;
  ...
  always @(posedge wb_clk)
      ...
      else if (wb_s0_cellram_wb_cyc_o & wb_s0_cellram_wb_stb_o) cellram_arb_timeout <= 1+cellram_arb_timeout;
