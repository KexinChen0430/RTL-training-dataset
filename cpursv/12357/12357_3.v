  ...
  always @(posedge clk or posedge rst)
      begin
        if (rst) 
          ...
          begin
            input_axis_tready_reg <= ((output_axis_tready | ((~output_axis_tvalid_reg & (output_axis_tready | ~temp_axis_tvalid_reg)) & ~temp_axis_tvalid_reg)) | (~input_axis_tvalid & ((~temp_axis_tvalid_reg | ~output_axis_tvalid_reg) & (output_axis_tready | ~temp_axis_tvalid_reg)))) | (~input_axis_tvalid & output_axis_tready);
