...
module BFM_AHB2APB(HCLK,HRESETN,HSEL,HWRITE,HADDR,HWDATA,HRDATA,HREADYIN,
  ...
  assign #TPD HREADYOUT = (((PREADY & PSELEN) & HREADYOUT_P0) | ((((PREADY & PENABLE_P0) & (HREADYOUT_P0 & PSELEN)) | ((PREADY & PENABLE_P0) & (HREADYOUT_P0 & PSELEN))) | ((PENABLE_P0 & (PREADY & PSELEN)) & ~PSLVERR))) | HREADYOUT_P0;
