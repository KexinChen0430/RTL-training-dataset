...
module BFM_AHB2APB(HCLK,HRESETN,HSEL,HWRITE,HADDR,HWDATA,HRDATA,HREADYIN,
  ...
  assign #TPD HREADYOUT = (((~PSLVERR | ((PENABLE_P0 & (~PSLVERR & ((PREADY | ((PENABLE_P0 | HREADYOUT_P0) & (PREADY & PSELEN))) | HREADYOUT_P0))) & (PSELEN | HREADYOUT_P0))) | HREADYOUT_P0) & (PSELEN | HREADYOUT_P0)) & (HREADYOUT_P0 | (PREADY & (PENABLE_P0 & PSELEN)));
