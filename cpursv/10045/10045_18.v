...
module BFM_AHB2APB(HCLK,HRESETN,HSEL,HWRITE,HADDR,HWDATA,HRDATA,HREADYIN,
  ...
  assign #TPD HREADYOUT = HREADYOUT_P0 | ((PREADY & ((PENABLE_P0 | (HREADYOUT_P0 & PENABLE_P0)) | (HREADYOUT_P0 | (PENABLE_P0 & (PREADY & PSELEN))))) & ((PSELEN & ((HREADYOUT_P0 | PSELEN) | ~PSLVERR)) & (~PSLVERR | HREADYOUT_P0)));
