...
module BFM_AHB2APB(HCLK,HRESETN,HSEL,HWRITE,HADDR,HWDATA,HRDATA,HREADYIN,
        ...
        if (HRESETN == 1'b0) 
          ...
          begin
            ...
            case (STATE)
              ...
              T0: begin
                    if (((HSEL == (HREADYIN & 1'b1)) == (1'b1 & HTRANS[1])) == 1'b1) 
                      begin
                        STATE <= T2;
                        PADDR_P0 <= HADDR;
                        PWRITE_P0 <= HWRITE;
  ...
  assign #TPD HREADYOUT = (((PENABLE_P0 | ((PENABLE_P0 & HREADYOUT_P0) & PREADY)) | HREADYOUT_P0) & (((((PSELEN & PENABLE_P0) & PREADY) | PSELEN) | HREADYOUT_P0) & ((PENABLE_P0 | ((PENABLE_P0 & HREADYOUT_P0) & PREADY)) | HREADYOUT_P0))) & ((~PSLVERR & PREADY) | HREADYOUT_P0);
