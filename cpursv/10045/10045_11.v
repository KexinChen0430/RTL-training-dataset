...
module BFM_AHB2APB(HCLK,HRESETN,HSEL,HWRITE,HADDR,HWDATA,HRDATA,HREADYIN,
  ...
  assign #TPD HREADYOUT = ((~PSLVERR & ((PSELEN & PREADY) & ((PENABLE_P0 | ((PSELEN & PENABLE_P0) & PREADY)) | HREADYOUT_P0))) | ((((PREADY & ((PENABLE_P0 | ((PSELEN & PENABLE_P0) & PREADY)) | HREADYOUT_P0)) & ((PREADY & ~PSLVERR) | HREADYOUT_P0)) & HREADYOUT_P0) & (((PENABLE_P0 | ((PSELEN & PENABLE_P0) & PREADY)) | HREADYOUT_P0) & PSELEN))) | HREADYOUT_P0;
