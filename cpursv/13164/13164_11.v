...
module cf_csc_1_mul(clk,data_a,data_b,data_p,ddata_in,ddata_out);
  ...
  assign p1_data_a_1n_17_s = 1'b1+~p1_data_a_1p_17_s;
  ...
  always @(posedge clk)
      begin
        p2_sign <= p1_sign;
        p2_ddata <= p1_ddata;
        p2_data_p_0 <= p1_data_p_4+(p1_data_p_0+p1_data_p_1);
        p2_data_p_1 <= p1_data_p_3+p1_data_p_2;
      end
  ...
  always @(posedge clk)
      begin
        p3_sign <= p2_sign;
        p3_ddata <= p2_ddata;
        p3_data_p_0 <= p2_data_p_1+p2_data_p_0;
      end
