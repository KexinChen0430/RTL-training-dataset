...
module MultiUartTx(CLK,RST_X,TXD,ERR,DT01,WE01,DT02,WE02,DT03,WE03,DT04,WE04);
  ...
  assign RE02 = (TxRdy & ~RDY01) & (RDY02 & ~en01);
  assign RE03 = (~RDY02 & (~RDY01 & ~en02)) & ((TxRdy & ~en01) & RDY03);
  assign RE04 = (((~RDY02 & ~RDY01) & TxRdy) & (RDY04 & ~en01)) & (~en03 & (~RDY03 & ~en02));
  assign data = en01 ? {data01,8'h30} : 
                en02 ? {data02,8'h31} : 
                en03 ? {data03,8'h32} : {data04,8'h33};
  assign en = ((en03 | en04) | en02) | en01;
