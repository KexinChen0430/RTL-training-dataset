...
module MultiUartTx(CLK,RST_X,TXD,ERR,DT01,WE01,DT02,WE02,DT03,WE03,DT04,WE04);
  ...
  assign ERR = ((ERR04 | ERR01) | ERR03) | ERR02;
  assign RE01 = TxRdy & RDY01;
  assign RE02 = (~en01 & TxRdy) & (~RDY01 & RDY02);
  assign RE03 = ((~RDY02 & (~en02 & ~RDY01)) & (RDY03 & TxRdy)) & ~en01;
  assign RE04 = ((~RDY02 & ~en01) & (~en02 & ~RDY01)) & ((RDY04 & TxRdy) & (~en03 & ~RDY03));
  assign data = en01 ? {data01,8'h30} : 
                en02 ? {data02,8'h31} : 
                en03 ? {data03,8'h32} : {data04,8'h33};
  assign en = ((en04 | en02) | en01) | en03;
