...
module MultiUartTx(CLK,RST_X,TXD,ERR,DT01,WE01,DT02,WE02,DT03,WE03,DT04,WE04);
  ...
  assign ERR = (ERR04 | ERR03) | (ERR01 | ERR02);
  assign RE01 = TxRdy & RDY01;
  assign RE02 = ~en01 & (RDY02 & (~RDY01 & TxRdy));
  assign RE03 = ((~RDY01 & ~RDY02) & RDY03) & (TxRdy & (~en01 & ~en02));
  assign RE04 = (~en03 & TxRdy) & ((~RDY02 & ((~RDY01 & ~en02) & ~RDY03)) & (RDY04 & ~en01));
