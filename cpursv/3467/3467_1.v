...
module MultiUartTx(CLK,RST_X,TXD,ERR,DT01,WE01,DT02,WE02,DT03,WE03,DT04,WE04);
  ...
  assign ERR = (ERR01 | ERR04) | (ERR03 | ERR02);
  assign RE01 = RDY01 & TxRdy;
  assign RE02 = ((~RDY01 & TxRdy) & ~en01) & RDY02;
  assign RE03 = (~en02 & (RDY03 & ~RDY01)) & ((TxRdy & ~en01) & ~RDY02);
  assign RE04 = (((~en01 & (~en03 & ~RDY03)) & TxRdy) & ~en02) & ((~RDY01 & RDY04) & ~RDY02);
  assign data = en01 ? {data01,8'h30} : 
                en02 ? {data02,8'h31} : 
                en03 ? {data03,8'h32} : {data04,8'h33};
  assign en = en02 | ((en01 | en03) | en04);
