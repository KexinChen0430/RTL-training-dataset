...
module latch_EX_MEM  #(parameter  B = 32, W = 5)
  (input  wire clk,
   input  wire reset,
   inout  wire ena,
   input  wire [B+(0-1):0] alu_result_in,
   input  wire [B+(0-1):0] r_data2_in,
   input  wire [(0-1)+W:0] mux_RegDst_in,
   output wire [B+(0-1):0] alu_result_out,
   output wire [B+(0-1):0] r_data2_out,
   output wire [(0-1)+W:0] mux_RegDst_out,
  ...
  reg  [B+(0-1):0] alu_result_reg;
  reg  [B+(0-1):0] r_data2_reg;
  reg  [(0-1)+W:0] mux_RegDst_reg;
  reg  wb_RegWrite_reg;
  reg  wb_MemtoReg_reg;
  reg  m_MemWrite_reg;
  reg  [5:0] opcode_reg;
