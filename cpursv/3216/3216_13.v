...
module register_sync  #(parameter 
  ...
  input  clk_en;
  input  nrst;
  input  [(-1)+reg_width:0] reg_i;
  output [(-1)+reg_width:0] reg_o;
  reg  [(-1)+reg_width:0]  reg_synced_3 = reg_preset;
  reg  [(-1)+reg_width:0]  reg_synced_2 = reg_preset;
  reg  [(-1)+reg_width:0]  reg_synced_1 = reg_preset;
  reg  [(-1)+reg_width:0]  reg_synced_0 = reg_preset;
