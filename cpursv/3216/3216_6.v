...
module register_sync  #(parameter 
  ...
  input  clk_en;
  input  nrst;
  input  [(0-1)+reg_width:0] reg_i;
  output [(0-1)+reg_width:0] reg_o;
  reg  [(0-1)+reg_width:0]  reg_synced_3 = reg_preset;
  reg  [(0-1)+reg_width:0]  reg_synced_2 = reg_preset;
  reg  [(0-1)+reg_width:0]  reg_synced_1 = reg_preset;
  reg  [(0-1)+reg_width:0]  reg_synced_0 = reg_preset;
  ...
  generate
      for (int_idx = 0; int_idx < reg_width; int_idx = 1+int_idx)
          begin : gen_rtl
