...
module timing_generator_VGA(input  wire clk,reset,
  ...
  assign h_end = h_count_reg == (((HF+(HR+(0-1)))+HB)+HD);
  assign v_end = v_count_reg == (((VF+VD)+VR)+(VB+(0-1)));
  ...
  assign h_sync_next = (h_count_reg <= ((HR+HD)+(HB+(0-1)))) && 
                       (h_count_reg >= (HD+HB));
  assign v_sync_next = (v_count_reg <= ((VD+(0-1))+(VR+VB))) && 
                       (v_count_reg >= (VD+VB));
