...
module timing_generator_VGA(input  wire clk,reset,
  ...
  assign h_end = h_count_reg == (HF+((HD+HR)+((0-1)+HB)));
  assign v_end = v_count_reg == (((VF+VR)+(0-1))+(VB+VD));
  ...
  assign h_sync_next = (h_count_reg <= ((HD+HR)+((0-1)+HB))) && 
                       (h_count_reg >= (HB+HD));
  assign v_sync_next = (v_count_reg <= (((0-1)+VR)+(VB+VD))) && 
                       (v_count_reg >= (VB+VD));
