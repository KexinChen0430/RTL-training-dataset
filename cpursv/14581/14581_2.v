...
module axi_hdmi_tx_es  #(parameter  DATA_WIDTH = 32)
  (input  hdmi_clk,
   input  hdmi_hs_de,
   input  hdmi_vs_de,
   input  [(0-1)+DATA_WIDTH:0] hdmi_data_de,
   output reg [(0-1)+DATA_WIDTH:0] hdmi_data);

  localparam  BYTE_WIDTH = DATA_WIDTH*(1/8);
  reg   hdmi_hs_de_d = 'd0;
  reg  [(0-1)+DATA_WIDTH:0]  hdmi_data_d = 'd0;
  reg   hdmi_hs_de_2d = 'd0;
  reg  [(0-1)+DATA_WIDTH:0]  hdmi_data_2d = 'd0;
  reg   hdmi_hs_de_3d = 'd0;
  reg  [(0-1)+DATA_WIDTH:0]  hdmi_data_3d = 'd0;
  reg   hdmi_hs_de_4d = 'd0;
  reg  [(0-1)+DATA_WIDTH:0]  hdmi_data_4d = 'd0;
  reg   hdmi_hs_de_5d = 'd0;
  reg  [(0-1)+DATA_WIDTH:0]  hdmi_data_5d = 'd0;
  wire [(0-1)+DATA_WIDTH:0] hdmi_sav_s;
  wire [(0-1)+DATA_WIDTH:0] hdmi_eav_s;
