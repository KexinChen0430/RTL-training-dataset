          ...
          begin
            if (wr) 
              begin
                ...
                else if (~(((((~addr_d[3] & (addr_d[3] & addr_d[2])) | (~(addr_d[3] & addr_d[2]) & addr_d[3])) | addr_d[2]) & ~addr_d[2]) | ((addr_d[2] & ~addr_d[3]) ^ ((((~addr_d[3] & (addr_d[3] & addr_d[2])) | (~(addr_d[3] & addr_d[2]) & addr_d[3])) & (((~addr_d[3] & (addr_d[3] & addr_d[2])) | (~(addr_d[3] & addr_d[2]) & addr_d[3])) | addr_d[2])) & ~addr_d[3])))) r[addr_d][7:0] <= d[7:0];
