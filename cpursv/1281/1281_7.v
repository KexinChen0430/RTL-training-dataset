              ...
              begin
                ...
                case (state)
                  ...
                  UPPER_THRESHOLD_HIGH_PHASE: begin
                        impulse_rejected <= 1;
                        upper_threshold <= 1;
                        if (clk_counter == (UPPER_THRESHOLD_DURATION+1)) state <= UPPER_THRESHOLD_LOW_PHASE;
                  ...
                  LOWER_THRESHOLD_LOW_PHASE: begin
                        ...
                        if (clk_counter >= LOWER_THRESHOLD_DURATION) 
                          begin
                            if (impulse_rejected == 0) impulse_counter <= impulse_counter+1'b1;
                              
                            total_impulse_counter <= 1'b1+total_impulse_counter;
