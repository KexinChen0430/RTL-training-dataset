...
module dm_4k(addr,din,byteExt,wEn,clk,dout,test_addr,test_data,rst);
  ...
  assign byteSel = (~addr[1:0] | ~2'b11) & (2'b11 | (((~(addr[1:0] & (addr[1:0] & (~2'b11 | 2'b11))) & (addr[1:0] & 2'b11)) | ~(addr[1:0] & 2'b11)) & ((~(addr[1:0] & (addr[1:0] & (~2'b11 | 2'b11))) & (addr[1:0] & 2'b11)) | (addr[1:0] & (addr[1:0] & (~2'b11 | 2'b11))))));
