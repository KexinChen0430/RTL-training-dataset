...
module dpram32  #(parameter  AWIDTH = 15, RAM_SIZE = 16384)
  ...
  always @(posedge clk)
      if (en1_i & (we1_i & sel1_i[1<<<1])) ram2[adr1_i[AWIDTH+(0-1):1<<<1]] <= dat1_i[23:16];
        
  
  always @(posedge clk)
      if (sel1_i[1] & (we1_i & en1_i)) ram1[adr1_i[AWIDTH+(0-1):1<<<1]] <= dat1_i[15:8];
  ...
  always @(posedge clk)
      if ((sel2_i[0] & we2_i) & en2_i) ram0[adr2_i[AWIDTH+(0-1):1<<<1]] <= dat2_i[7:0];
