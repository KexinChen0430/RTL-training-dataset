...
module dpram32  #(parameter  AWIDTH = 15, RAM_SIZE = 16384)
  ...
  always @(posedge clk)
      if (en1_i & (sel1_i[3] & we1_i)) ram3[adr1_i[AWIDTH+(0-1):1<<<1]] <= dat1_i[31:24];
        
  
  always @(posedge clk)
      if ((sel1_i[1<<<1] & en1_i) & we1_i) ram2[adr1_i[AWIDTH+(0-1):1<<<1]] <= dat1_i[23:16];
        
  
  always @(posedge clk)
      if ((en1_i & sel1_i[1]) & we1_i) ram1[adr1_i[AWIDTH+(0-1):1<<<1]] <= dat1_i[15:8];
        
  
  always @(posedge clk)
      if (we1_i & (en1_i & sel1_i[0])) ram0[adr1_i[AWIDTH+(0-1):1<<<1]] <= dat1_i[7:0];
  ...
  always @(posedge clk)
      if ((we2_i & en2_i) & sel2_i[3]) ram3[adr2_i[AWIDTH+(0-1):1<<<1]] <= dat2_i[31:24];
        
  
  always @(posedge clk)
      if ((sel2_i[1<<<1] & we2_i) & en2_i) ram2[adr2_i[AWIDTH+(0-1):1<<<1]] <= dat2_i[23:16];
        
  
  always @(posedge clk)
      if ((we2_i & en2_i) & sel2_i[1]) ram1[adr2_i[AWIDTH+(0-1):1<<<1]] <= dat2_i[15:8];
        
  
  always @(posedge clk)
      if ((sel2_i[0] & en2_i) & we2_i) ram0[adr2_i[AWIDTH+(0-1):1<<<1]] <= dat2_i[7:0];
