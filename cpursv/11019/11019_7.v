...
module button_pio(address,chipselect,clk,in_port,reset_n,write_n,writedata,irq,
  ...
  assign clk_en = 1;
  assign read_mux_out = ((data_in & ({4{address == 0}} | {4{address == (1+1)}})) & {4{address == 0}}) | (((irq_mask & (({4{address == (1+1)}} | data_in) & ({4{address == 0}} | {4{address == (1+1)}}))) & ((data_in & ({4{address == 0}} | {4{address == (1+1)}})) & {4{address == 0}})) | (((({4{address == (1+1)}} | {4{address == 3}}) & (irq_mask | {4{address == 3}})) & (edge_capture | irq_mask)) & (edge_capture | {4{address == (1+1)}})));
