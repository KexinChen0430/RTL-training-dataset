...
module pkt_waiting_for_transmit(input  exe2disp_data_wr,
  ...
  always @* 
      begin
        if (exe2disp_direction_req == 1'b1) 
          begin
            if (exe2disp_direction == 1'b0) 
              begin
