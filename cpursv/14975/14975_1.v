...
module up_xfer_cntrl  #(parameter  DATA_WIDTH = 8)
  ...
  assign up_xfer_enable_s = ((up_xfer_toggle & (up_xfer_state & (~up_xfer_state | (~up_xfer_toggle & (up_xfer_toggle | up_xfer_state))))) | (~up_xfer_state & up_xfer_toggle)) | (~up_xfer_toggle & (up_xfer_toggle | up_xfer_state));
  ...
  assign d_xfer_toggle_s = ((~d_xfer_toggle_m2 & (d_xfer_toggle_m3 | d_xfer_toggle_m2)) & d_xfer_toggle_m3) | (d_xfer_toggle_m2 & ~d_xfer_toggle_m3);
