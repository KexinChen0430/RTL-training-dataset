...
(
(
((!send_resp && !is_req) || (!send_req && !is_req)) && !tx_ena_bus && 
((!tx_ena_bus && !send_resp) || is_req || !send_resp)) || 
(
(!send_resp && !is_req && 
(!send_req && (!tx_ena_bus && is_req))) || !send_req)) && 
                    (
((!tx_ena_bus && !send_resp) || is_req || !send_resp) && ((is_req && !send_req) || !tx_ena_bus) && !tx_ena_bus)) 
                  begin
                    bus_state <= IDLE;
                  end
