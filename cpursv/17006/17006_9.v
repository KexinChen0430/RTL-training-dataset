...
module vgafb_pixelfeed  #(parameter  fml_depth = 26)
  (input  sys_clk,
   ...
   input  vga_rst,
   input  [17:0] nbursts,
   input  [(-1)+fml_depth:0] baseaddress,
          ...
          begin
            if (next_address) 
              begin
                ...
                else fml_adr <= fml_adr+{{(0-6)+fml_depth{1'b0}},6'd32};
              end
  ...
  assign dcb_adr = {fml_adr[(-1)+fml_depth:5],dcb_index,3'b000};
  reg  [3:0] state;
