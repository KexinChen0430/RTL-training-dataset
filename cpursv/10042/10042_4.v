...
module branch_control  #(parameter 
  ...
  assign select_new_pc_out = (((branch_inst_in | (branch_result_in & jmp_inst_in)) & (jmp_inst_in | branch_result_in)) & branch_result_in) | jmp_inst_in;
  assign branch_val = branch_use_r_in ? reg_a_data_in : ({reg_b_data_in,{1+1{1'b0}}}+(pc_in+4));
