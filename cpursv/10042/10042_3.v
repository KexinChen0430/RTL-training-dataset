...
module branch_control  #(parameter 
  ...
  assign select_new_pc_out = (branch_result_in & (branch_inst_in | jmp_inst_in)) | jmp_inst_in;
  assign branch_val = branch_use_r_in ? reg_a_data_in : ((4+pc_in)+{reg_b_data_in,{2{1'b0}}});
