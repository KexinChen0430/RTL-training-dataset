        ...
        if (!rst_n) 
          begin
            ...
            recv_detect <= 8'h0;
                 ...
                 (spi_tx_en || 
((spi_tx_en && spi_rx_en) || 
((data_count < 8'd64) && spi_rx_en) || 
(spi_tx_en && 
((data_count < 8'd64) || 
((spi_tx_en && spi_rx_en) || 
((data_count < 8'd64) && spi_rx_en)) || spi_rx_en))))) 
          begin
            if (cnt8 < mode_reg) cnt8 <= 1'b1+cnt8;
            else 
              begin
                if (spi_tx_en && spi_rx_en && 
                    (
((spi_tx_en && spi_rx_en) || 
((data_count < 8'd64) && spi_rx_en)) && (delay_flag == 1'b1))) 
                  begin
                    cnt8 <= 5'd0;
