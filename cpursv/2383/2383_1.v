...
module vga_sync(input  wire clock,
  ...
  localparam  H_TOTAL = H_ACT+((H_BACK+H_SYNC)+H_FRONT);
  ...
  reg  [H_TOTAL_WIDTH+(0-1):0] hor_pos;
      ...
      begin
        if (~aresetn) 
          ...
          begin
            ...
            if (hor_pos == (H_SYNC+(H_FRONT+(0-1)))) h_sync <= 1'b0;
      ...
      begin
        if (~aresetn) 
          ...
          begin
            ...
            if (ver_pos == ((V_SYNC+V_FRONT)+(0-1))) v_sync <= 1'b0;
