...
module scl_v_fltr(clk,nd,d_in,d_out_1,d_out_2,d_out_4);
  ...
  always @(posedge clk)
      begin
        ...
        add_2_tmp_1 <= {2'b00,buff_out_reg3}+{2'b00,buff_out_reg1};
        add_2_tmp_2 <= {1'b0,buff_out_reg2,1'b0};
        add_2_tmp <= add_2_tmp_2+add_2_tmp_1;
        add_4_tmp_1 <= {4'b0000,buff_out_reg7}+{4'b0000,buff_out_reg1};
        add_4_tmp_2 <= {3'b000,buff_out_reg6,1'b0}+{3'b000,buff_out_reg2,1'b0};
        add_4_tmp_3 <= {3'b000,buff_out_reg3,1'b0}+{3'b000,buff_out_reg5,1'b0};
        add_4_tmp_4 <= {4'b0000,buff_out_reg5}+{4'b0000,buff_out_reg3};
        add_4_tmp_5 <= {2'b00,buff_out_reg4,2'b00};
        add_4_tmp_6 <= add_4_tmp_1+add_4_tmp_2;
        add_4_tmp_7 <= add_4_tmp_4+add_4_tmp_3;
        add_4_tmp_8 <= add_4_tmp_6+add_4_tmp_5;
        add_4_tmp <= add_4_tmp_8+add_4_tmp_7;
      end
endmodule
