...
module Selector_Casillas(clk,boton_arriba,boton_abajo,boton_izq,boton_der,boton_elige,
  ...
  always @(posedge clk)
      begin
        ...
        else if ((boton_arriba == 1'b1) & ((cuadro <= 4'b1001) & (cuadro >= 4'b0100))) cuadro = cuadro-4'b0011;
        else if ((((cuadro > 4'b0001) & (cuadro <= 4'b1001)) & (cuadro != 4'b0100)) & ((boton_izq == 1'b1) & (cuadro != 4'b0111))) cuadro = cuadro-4'b0001;
        else if (((cuadro != 4'b0110) & (cuadro < 4'b1001)) & ((cuadro != 4'b0011) & ((boton_der == 1'b1) & (cuadro >= 4'b0001)))) cuadro = cuadro+4'b0001;
