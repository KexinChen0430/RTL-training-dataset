...
module id_ex_reg  #(parameter 
  ...
  (input  clk,
   ...
   input  [(-1)+PC_WIDTH:0] new_pc_in,
   input  [(-1)+INSTRUCTION_WIDTH:0] instruction_in,
   ...
   output reg [(-1)+PC_WIDTH:0] new_pc_out,
   output reg [(-1)+INSTRUCTION_WIDTH:0] instruction_out,
