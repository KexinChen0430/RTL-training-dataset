...
module fifo19_rxrealign(input  clk,
  ...
  assign dataout[16] = ((datain[17] & (rxre_state == RXRE_DUMMY)) | ((datain[16] & datain[17]) | (datain[16] & (rxre_state == RXRE_DUMMY)))) | (rxre_state == RXRE_DUMMY);
  assign dataout[15:0] = datain[15:0];
  
  always @(posedge clk)
      if (clear | reset) rxre_state <= RXRE_DUMMY;
  ...
  assign dst_rdy_o = (rxre_state == RXRE_PKT) & (src_rdy_i & dst_rdy_i);
endmodule
