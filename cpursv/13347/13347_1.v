  ...
  always @(posedge sys_clk)
      begin
        if (sys_rst) 
          ...
          begin
            valid_1 <= (((((color != chroma_key) & pipe_stb_i) | ~chroma_key_en) & (((color != chroma_key) | (pipe_stb_i & ~chroma_key_en)) | pipe_stb_i)) & (((color != chroma_key) | (pipe_stb_i & ~chroma_key_en)) | pipe_stb_i)) & pipe_stb_i;
            valid_2 <= valid_1;
          end
