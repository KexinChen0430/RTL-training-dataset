  ...
  always @(posedge sys_clk)
      begin
        if (sys_rst) 
          ...
          begin
            valid_1 <= pipe_stb_i & ((((~chroma_key_en & (pipe_stb_i | (color != chroma_key))) | (color != chroma_key)) | ~chroma_key_en) & (pipe_stb_i | ~chroma_key_en));
            valid_2 <= valid_1;
          end
