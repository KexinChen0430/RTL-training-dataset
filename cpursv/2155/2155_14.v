...
module pc_ctrl_pm1  #(parameter 
        ...
        if (!ARESETn) 
          ...
          begin
            if (reg_bank_wr_start) 
              begin
                case (reg_bank_wr_addr[DCADDR_LOW_BIT_W+(0-1):2])
  ...
  always @(*)
      begin
        reg_bank_rd_data = 'd0;
        case (reg_bank_rd_addr[DCADDR_LOW_BIT_W+(0-1):2])
