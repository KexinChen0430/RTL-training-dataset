...
module fpu_denorm_3b(din1,din2,din2_din1_nz,din2_din1_denorm);
  ...
  assign din2_din1_denorm = ((din2[1] || din2[2]) && din2_din1_zero[2]) || 
                            (
(din2[2] || 
((din2_din1_zero[2] && din2[2]) || (din2[2] && din2[1]) || 
(din2[1] && din2_din1_zero[2]))) && &din2_din1_zero[2:1]) || (din2[0] && &din2_din1_zero[2:1]) || din2[2];
endmodule
