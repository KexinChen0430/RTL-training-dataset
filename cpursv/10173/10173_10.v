  ...
  always @(posedge Clk or negedge nLoad)
      begin
        if (~nLoad) 
          ...
          begin
            if (((thour2 == chour2) & ((thour1 == chour1) & (tminute2 == cminute2))) & (((tsecond1 == csecond1) & (tsecond2 == csecond2)) & (tminute1 == cminute1))) active <= 1;
            ...
            if (active) 
              begin
                ...
                if ((count < (PulseAngleRot+(delay+(PulseAngleRot+700000)))) & (count >= (delay+PulseAngleRot))) 
                  begin
                    ME <= 1;
                    MT1 <= 0;
                    MT2 <= 1;
