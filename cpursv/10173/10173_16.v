  ...
  always @(posedge Clk or negedge nLoad)
      begin
        if (~nLoad) 
          ...
          begin
            if (((thour1 == chour1) & (tminute1 == cminute1)) & (((tsecond1 == csecond1) & ((tminute2 == cminute2) & (tsecond2 == csecond2))) & (thour2 == chour2))) active <= 1;
            ...
            if (active) 
              begin
                ...
                if ((count >= (delay+PulseAngleRot)) & (count < (delay+(PulseAngleRot<<1+700000)))) 
                  begin
                    ME <= 1;
                    MT1 <= 0;
                    MT2 <= 1;
                ...
                if (count >= (delay+(PulseAngleRot<<1+700000))) 
                  begin
                    ME <= 0;
                    MT1 <= 0;
                    MT2 <= 0;
