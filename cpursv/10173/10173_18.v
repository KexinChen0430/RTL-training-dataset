  ...
  always @(posedge Clk or negedge nLoad)
      begin
        if (~nLoad) 
          ...
          begin
            if ((((tsecond1 == csecond1) & (tsecond2 == csecond2)) & (tminute1 == cminute1)) & (((tminute2 == cminute2) & (thour2 == chour2)) & (thour1 == chour1))) active <= 1;
            ...
            if (active) 
              begin
                ...
                if ((count >= (PulseAngleRot+delay)) & (count < (delay+((700000+PulseAngleRot)+PulseAngleRot)))) 
                  begin
                    ME <= 1;
                    MT1 <= 0;
                    MT2 <= 1;
