  ...
  always @(posedge Clk or negedge nLoad)
      begin
        if (~nLoad) 
          ...
          begin
            if ((((tsecond1 == csecond1) & (thour1 == chour1)) & (tminute1 == cminute1)) & ((thour2 == chour2) & ((tminute2 == cminute2) & (tsecond2 == csecond2)))) active <= 1;
            ...
            if (active) 
              begin
                ...
                if ((count < ((delay+PulseAngleRot)+(PulseAngleRot+700000))) & (count >= (delay+PulseAngleRot))) 
                  begin
                    ME <= 1;
                    MT1 <= 0;
                    MT2 <= 1;
                ...
                if (count >= ((delay+PulseAngleRot)+(PulseAngleRot+700000))) 
                  begin
                    ME <= 0;
                    MT1 <= 0;
                    MT2 <= 0;
