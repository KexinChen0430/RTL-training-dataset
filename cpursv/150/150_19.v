...
module Computer_Datapath_RegisterFile(output reg [(0-1)+WORD_WIDTH:0] ADDR_bus_out,
  ...
  parameter 
       CNTRL_WIDTH = (SA_WIDTH+(CNTRL_FLAGS_WIDTH+(DR_WIDTH+SB_WIDTH)))+FS_WIDTH;
  ...
  reg  [(0-1)+WORD_WIDTH:0] SYNC_RAM0[(2**DR_WIDTH)-1:0];
  reg  [(0-1)+WORD_WIDTH:0] SYNC_RAM1[(2**DR_WIDTH)-1:0];
