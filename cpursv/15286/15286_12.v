  ...
  always @(*)
      begin
        case (op_code)
          ...
          7: {overflow,result} = ((operand2 & ((operand1 | ~operand1) | (~operand1 & (operand2 | operand1)))) & (operand1 | ~operand1)) ^ ((operand1 | ~operand1) & (operand1 & ((operand1 | ~operand1) | (~operand1 & (operand2 | operand1)))));
