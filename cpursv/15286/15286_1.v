  ...
  always @(*)
      begin
        case (op_code)
          ...
          4: {overflow,result} = (0-operand2)+operand1;

          5: {overflow,result} = operand2 & operand1;

          6: {overflow,result} = operand1 | operand2;

          7: {overflow,result} = ((((operand1 | operand2) & ~operand1) | (~operand1 | operand1)) & ((~operand1 | operand1) & operand2)) ^ ((((operand1 | operand2) & ~operand1) | (~operand1 | operand1)) & operand1);
