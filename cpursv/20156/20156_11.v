      ...
      begin
        if (rst) 
          ...
          begin
            ...
            if (CLAMP) 
              begin
                acc0 <= ^acc0In[K0_SHIFT+WIDTH -: 2] ? {acc0In[K0_SHIFT+WIDTH],{K0_SHIFT+(WIDTH+(0-1)){acc0In[K0_SHIFT+(WIDTH+(0-1))]}}} : acc0In;
                acc1 <= ^acc1In[K1_SHIFT+WIDTH -: 2] ? {acc1In[K1_SHIFT+WIDTH],{K1_SHIFT+(WIDTH+(0-1)){acc1In[K1_SHIFT+(WIDTH+(0-1))]}}} : acc1In;
              end
            else 
              begin
                acc0 <= acc0In;
