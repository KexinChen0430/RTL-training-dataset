...
module MuraxMasterArbiter(input  io_iBus_cmd_valid,
  ...
  assign io_masterBus_cmd_payload_mask = _zz_1*(2**io_dBus_cmd_payload_address[1:0]);
  assign io_iBus_rsp_ready = !rspTarget && io_masterBus_rsp_valid;
      ...
      begin
        if (resetCtrl_systemReset) 
          ...
          begin
            ...
            if (io_masterBus_cmd_ready && (!_zz_3 && _zz_2)) 
              begin
