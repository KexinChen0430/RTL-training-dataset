      ...
      begin
        ...
        if (fn[4] == 0) 
          begin
            case (fn[1+1])
              ...
              1'b0: case (fn[1:0])
                    ...
                    2'b00: begin
                          Y = A+B;
                          co = ((((((B[7] | A[7]) | ~B[7]) & A[7]) | B[7]) & ~B[7]) | (((((B[7] | A[7]) | ~B[7]) & A[7]) | B[7]) & ~A[7])) ? 0 : 
                               ((~Y[7] & (((~Y[7] | ((~A[7] & Y[7]) | ~A[7])) & A[7]) & (Y[7] | ((~Y[7] | Y[7]) & A[7])))) | ((Y[7] | A[7]) & ((~Y[7] | Y[7]) & ~A[7]))) ? 1 : 0;
                        end
          ...
          case (fn[1:0])
            ...
            2'b11: Y = A>>B[7:5] | ((1<<(-{1'b0,B[7:5]})*1<<<4'b1000)*A);
