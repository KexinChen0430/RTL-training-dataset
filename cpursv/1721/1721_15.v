                  ...
                  begin
                    ...
                    for (i = 1; i < N; i = 1+i)
                        begin
                          ...
                          pipe[i] <= (-diffdelay[i][M-1])+pipe[i+(-1)];
  ...
  generate
      if (DATAOUT_EXTRA_BITS == 0) 
        ...
        begin
          if (ROUND_CONVERGENT) 
            begin
              assign data_out = ((data_int[DATAOUT_EXTRA_BITS-1:0] == {1'b1,{DATAOUT_EXTRA_BITS-1{1'b0}}}) ? data_int[DATAOUT_EXTRA_BITS] : data_int[DATAOUT_EXTRA_BITS-1])+data_int[DATAOUT_FULL_WIDTH-1:DATAOUT_EXTRA_BITS];
            end
          else 
            begin
