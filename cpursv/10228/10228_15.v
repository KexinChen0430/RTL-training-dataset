...
module fb_topstatem(clk_top,rst,SystemEnd,SystemStart,PHYInitEnd,
  ...
  assign StartDist = StateWait & ((ConfigEnd | StateWait) & NumbFrameReturned);
  assign StartDelay = DistFrameReturned & StateWait;
  assign StartDelayDist = DelayFrameReturned & StateWait;
  assign StartData = (DelayDistFrameReturned | ((DataFrameGo & DelayDistFrameReturned) | (ConfigEnd & DataFrameGo))) & StateWait;
  assign StartWait = (StateData | (StateDist | StateDelay)) | (StateDelayDist | StateNumb);
      ...
      begin
        if (rst) 
          ...
          begin
            ...
            if (((StartDelay | StartDelayDist) | StartIdle) | (StartDist | StartData)) StateWait <= 1'b0;
