...
module fb_topstatem(clk_top,rst,SystemEnd,SystemStart,PHYInitEnd,
  ...
  assign StartDist = (((((DataFrameGo & DelayDistFrameReturned) | ((DelayDistFrameReturned & StateWait) & ((DataFrameGo & DelayDistFrameReturned) & ConfigEnd))) | StateWait) | DelayDistFrameReturned) & (((StateWait | ConfigEnd) | (((StateWait & (DataFrameGo & DelayDistFrameReturned)) | ConfigEnd) | ((StateWait & (ConfigEnd & ((((DataFrameGo & DelayDistFrameReturned) | ((DelayDistFrameReturned & StateWait) & ((DataFrameGo & DelayDistFrameReturned) & ConfigEnd))) | StateWait) | DelayDistFrameReturned))) | ((((DelayDistFrameReturned & StateWait) | (ConfigEnd & DelayDistFrameReturned)) | ((DataFrameGo & ConfigEnd) & StateWait)) | DelayDistFrameReturned)))) & NumbFrameReturned)) & StateWait;
  assign StartDelay = StateWait & (DistFrameReturned & (StateWait | ConfigEnd));
  assign StartDelayDist = DelayFrameReturned & StateWait;
  assign StartData = ((DelayDistFrameReturned & StateWait) | ((ConfigEnd & (DelayDistFrameReturned & StateWait)) | (DataFrameGo & ConfigEnd))) & StateWait;
  assign StartWait = (StateNumb | StateData) | (StateDist | (StateDelayDist | StateDelay));
      ...
      begin
        if (rst) 
          ...
          begin
            ...
            if ((((StartDist | StartDelayDist) | StartData) | StartIdle) | StartDelay) StateWait <= 1'b0;
