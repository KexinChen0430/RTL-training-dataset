...
module fb_topstatem(clk_top,rst,SystemEnd,SystemStart,PHYInitEnd,
  ...
  assign StartDist = StateWait & (((NumbFrameReturned & ((StateWait | (DelayDistFrameReturned & ConfigEnd)) | ((((DelayDistFrameReturned & DataFrameGo) & StateWait) | ConfigEnd) | (DelayDistFrameReturned | ((ConfigEnd & StateWait) | (DelayDistFrameReturned & ConfigEnd)))))) & ((DelayDistFrameReturned | ((ConfigEnd & StateWait) | (DelayDistFrameReturned & ConfigEnd))) | StateWait)) & (((((((ConfigEnd & DataFrameGo) | (((DelayDistFrameReturned & DataFrameGo) & StateWait) | (ConfigEnd & StateWait))) | DataFrameGo) | (DelayDistFrameReturned & StateWait)) & ((ConfigEnd & DataFrameGo) | (DelayDistFrameReturned & ConfigEnd))) | ((ConfigEnd & DataFrameGo) & StateWait)) | StateWait));
  assign StartDelay = StateWait & (DistFrameReturned & ((StateWait | (DelayDistFrameReturned & ConfigEnd)) | ((((DelayDistFrameReturned & DataFrameGo) & StateWait) | ConfigEnd) | (DelayDistFrameReturned | ((ConfigEnd & StateWait) | (DelayDistFrameReturned & ConfigEnd))))));
  assign StartDelayDist = (((StateWait | ((ConfigEnd & DataFrameGo) | (DelayDistFrameReturned & ConfigEnd))) | ConfigEnd) & DelayFrameReturned) & StateWait;
  assign StartData = ((StateWait & DataFrameGo) | (DelayDistFrameReturned & StateWait)) & (((ConfigEnd & DataFrameGo) | (DelayDistFrameReturned & ConfigEnd)) | DelayDistFrameReturned);
  assign StartWait = (StateDist | (StateDelay | (StateNumb | StateDelayDist))) | StateData;
