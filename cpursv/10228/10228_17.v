...
module fb_topstatem(clk_top,rst,SystemEnd,SystemStart,PHYInitEnd,
  ...
  assign StartDist = StateWait & (NumbFrameReturned & ((((((DelayDistFrameReturned | ConfigEnd) & StateWait) & ((((DelayDistFrameReturned | ConfigEnd) & StateWait) & DelayDistFrameReturned) | (DataFrameGo & StateWait))) | (DelayDistFrameReturned & DataFrameGo)) | StateWait) | (DataFrameGo | ((((DelayDistFrameReturned | ConfigEnd) & StateWait) & ConfigEnd) & (((DelayDistFrameReturned | ConfigEnd) & StateWait) & ((((DelayDistFrameReturned | ConfigEnd) & StateWait) & DelayDistFrameReturned) | (DataFrameGo & StateWait)))))));
  assign StartDelay = StateWait & DistFrameReturned;
  assign StartDelayDist = (((DataFrameGo & ConfigEnd) | StateWait) & DelayFrameReturned) & StateWait;
  assign StartData = ((DelayDistFrameReturned | ConfigEnd) & StateWait) & ((((DelayDistFrameReturned | ConfigEnd) & StateWait) & DelayDistFrameReturned) | (DataFrameGo & StateWait));
  assign StartWait = (StateNumb | StateDelay) | ((StateData | StateDist) | StateDelayDist);
      ...
      begin
        if (rst) 
          ...
          begin
            ...
            if ((StartData | StartDist) | (StartIdle | (StartDelay | StartDelayDist))) StateWait <= 1'b0;
