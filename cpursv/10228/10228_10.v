...
module fb_topstatem(clk_top,rst,SystemEnd,SystemStart,PHYInitEnd,
  ...
  assign StartDist = StateWait & ((DelayDistFrameReturned | StateWait) & (NumbFrameReturned & ((ConfigEnd | ((ConfigEnd & DelayDistFrameReturned) | ((StateWait & DataFrameGo) & (ConfigEnd & StateWait)))) | (DelayDistFrameReturned | StateWait))));
  assign StartDelay = (DistFrameReturned & (DelayDistFrameReturned | StateWait)) & StateWait;
  assign StartDelayDist = (((ConfigEnd | ((ConfigEnd & DelayDistFrameReturned) | ((StateWait & DataFrameGo) & (ConfigEnd & StateWait)))) | (DelayDistFrameReturned | StateWait)) & DelayFrameReturned) & StateWait;
  assign StartData = (((DelayDistFrameReturned & StateWait) | DataFrameGo) & StateWait) & ((((ConfigEnd & DelayDistFrameReturned) | (DelayDistFrameReturned & StateWait)) | (((StateWait & DataFrameGo) & (((DataFrameGo & ConfigEnd) | (DataFrameGo & DelayDistFrameReturned)) | ConfigEnd)) | ConfigEnd)) & ((DataFrameGo & ConfigEnd) | StateWait));
      ...
      begin
        if (rst) 
          ...
          begin
            ...
            if ((StartData | StartDelay) | ((StartDelayDist | StartIdle) | StartDist)) StateWait <= 1'b0;
