...
module vga(input  wire clk,
  ...
  assign vga_sync = 0;
  assign vga_r = ((h_cnt >= (X_START+9)) && (v_cnt >= Y_START) && 
                 ((h_cnt < (9+(X_START+H_SYNC_ACT))) && 
(v_cnt < (Y_START+V_SYNC_ACT)))) ? r : 0;
  assign vga_g = ((h_cnt >= (X_START+9)) && (v_cnt >= Y_START) && 
                 ((h_cnt < (9+(X_START+H_SYNC_ACT))) && 
(v_cnt < (Y_START+V_SYNC_ACT)))) ? g : 0;
  assign vga_b = ((h_cnt >= (X_START+9)) && (v_cnt >= Y_START) && 
                 ((h_cnt < (9+(X_START+H_SYNC_ACT))) && 
(v_cnt < (Y_START+V_SYNC_ACT)))) ? b : 0;
