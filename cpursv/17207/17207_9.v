...
module vga(input  wire clk,
  ...
  assign vga_r = ((v_cnt < (V_SYNC_ACT+Y_START)) && 
                 (h_cnt < ((X_START+9)+H_SYNC_ACT)) && ((h_cnt >= (X_START+9)) && (v_cnt >= Y_START))) ? r : 0;
  assign vga_g = ((v_cnt < (V_SYNC_ACT+Y_START)) && 
                 (h_cnt < ((X_START+9)+H_SYNC_ACT)) && ((h_cnt >= (X_START+9)) && (v_cnt >= Y_START))) ? g : 0;
  assign vga_b = ((v_cnt < (V_SYNC_ACT+Y_START)) && 
                 (h_cnt < ((X_START+9)+H_SYNC_ACT)) && ((h_cnt >= (X_START+9)) && (v_cnt >= Y_START))) ? b : 0;
  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) 
          ...
          begin
            if ((h_cnt >= X_START) && (v_cnt < (V_SYNC_ACT+Y_START)) && 
