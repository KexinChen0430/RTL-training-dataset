...
module vga(input  wire clk,
  ...
  assign vga_sync = 0;
  assign vga_r = ((h_cnt < ((X_START+9)+H_SYNC_ACT)) && 
                 (h_cnt >= (X_START+9)) && 
                 ((v_cnt >= Y_START) && (v_cnt < (Y_START+V_SYNC_ACT)))) ? r : 0;
  assign vga_g = ((h_cnt < ((X_START+9)+H_SYNC_ACT)) && 
                 (h_cnt >= (X_START+9)) && 
                 ((v_cnt >= Y_START) && (v_cnt < (Y_START+V_SYNC_ACT)))) ? g : 0;
  assign vga_b = ((h_cnt < ((X_START+9)+H_SYNC_ACT)) && 
                 (h_cnt >= (X_START+9)) && 
        ...
        if (!rst) 
          ...
          begin
            if ((h_cnt < (X_START+H_SYNC_ACT)) && 
                (v_cnt < (Y_START+V_SYNC_ACT)) && ((v_cnt >= Y_START) && (h_cnt >= X_START))) 
              begin
                x <= h_cnt-X_START;
                y <= v_cnt+(-Y_START);
              end
