...
module rxStatusMonitor(connectStateIn,connectStateOut,resumeDetectedIn,
                       connectionEventOut,resumeIntOut,clk,rst);
      ...
      begin
        if (rst == 1'b1) 
          ...
          begin
            ...
            if ((resumeDetectedIn == 1'b1) && 
                (oldResumeDetected == 1'b0)) resumeIntOut <= 1'b1;
