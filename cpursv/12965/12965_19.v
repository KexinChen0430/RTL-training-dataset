...
!main_id_match) && main_req) && !main_id_match) || (main_rsp && !main_id_match) || main_rsp || 
(!main_addr_match && 
(
(((!main_id_match || main_req) && !main_addr_match) || 
!main_id_match) && main_req) && !main_id_match) || 
(!main_addr_match && 
(
(((!main_id_match || main_req) && !main_addr_match) || 
...
!main_id_match) && main_req));
  ...
  wire 
       sub_2_sub = (sub_addr_match && sub_req) || 
((sub_rsp && (sub_addr_match && sub_req)) || 
(sub_id_match && sub_req && sub_addr_match) || (sub_id_match && sub_rsp));

  wire  no_cross = sub_2_sub || main_2_main;

  wire 
       main_2_sub = (main_id_match || main_req) && 
((main_rsp && main_addr_match) || 
(main_req && main_addr_match) || 
(
((main_id_match && main_rsp) || 
(main_id_match && main_addr_match)) && main_rsp) || 
(main_req && 
((main_id_match && main_rsp) || 
...
(!sub_addr_match && (!sub_id_match && sub_rsp)));
