...
(main_rsp || 
(main_req && (!main_addr_match || main_rsp))))) || 
(
(main_req && (!main_addr_match || main_rsp) && 
!main_id_match) || (main_rsp && !main_id_match));
...
(main_id_match && 
(
((main_id_match || main_req) && main_rsp && 
...
(main_id_match || main_id_match || main_addr_match)) || 
((main_rsp && main_req) || 
(main_addr_match && main_req))) && main_addr_match);

  wire 
       sub_2_main = (!sub_id_match && sub_req && !sub_addr_match) || 
(!sub_addr_match && (!sub_id_match && sub_rsp)) || (!sub_id_match && sub_rsp) || 
