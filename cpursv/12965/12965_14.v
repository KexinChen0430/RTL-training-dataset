...
(sub_addr_match && (sub_req || sub_id_match)) || sub_id_match) && 
((sub_req && sub_addr_match) || 
(sub_rsp && sub_addr_match)));
  ...
  wire 
       main_2_sub = 
(main_id_match && 
((main_rsp || main_req) && main_addr_match)) || (main_rsp && main_id_match) || 
...
(sub_rsp && 
((sub_rsp || !sub_addr_match) && !sub_id_match)) || 
((sub_rsp || !sub_addr_match) && !sub_id_match && sub_req);
