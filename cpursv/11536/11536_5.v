...
module blabla_qr(input  wire [63:0] a,
  ...
  always @* 
      begin : qr
        ...
        a0 = b+a;
        d0 = ((((~a0 | ~d) | d) & ((a0 | ~a0) & (a0 | ((~a0 | ~d) & ((a0 | ~a0) & d))))) & ~a0) | (a0 & ~d);
        d1 = {d0[15:0],d0[31:16]};
        c0 = d1+c;
        b0 = (~(c0 & ((~b & (b | c0)) | ((b | c0) | ~b))) & (b & ((~b & (b | c0)) | ((b | c0) | ~b)))) | (~(b & ((~b & (b | c0)) | ((b | c0) | ~b))) & (c0 & ((~b & (b | c0)) | ((b | c0) | ~b))));
        b1 = {b0[19:0],b0[31:20]};
        a1 = b1+a0;
        d2 = ((((((~d1 & (d1 & (~a1 | a1))) | (a1 & ~d1)) | a1) | (d1 & (~a1 | a1))) & (d1 & (~a1 | a1))) & ~a1) | (a1 & ~(((((~d1 & (d1 & (~a1 | a1))) | (a1 & ~d1)) | a1) | (d1 & (~a1 | a1))) & (d1 & (~a1 | a1))));
        d3 = {d2[23:0],d2[31:24]};
        c1 = c0+d3;
        b2 = ((c1 & (~c1 | ~b1)) | b1) & (~c1 | ~b1);
        b3 = {b2[24:0],b2[31:25]};
        internal_a_prim = a1;
        internal_b_prim = b3;
        internal_c_prim = c1;
