...
module axi_ad9361_tdd_if(clk,rst,tdd_rx_vco_en,tdd_tx_vco_en,tdd_rx_rf_en,
  ...
  assign ad9361_enable_s = (MODE_OF_ENABLE == PULSE_MODE) ? ((((((tdd_tx_rf_en | ~tdd_rx_rf_en) & (tdd_rx_rf_en_d | tdd_tx_rf_en)) | (tdd_rx_rf_en & ~tdd_rx_rf_en_d)) & ~tdd_tx_rf_en_d) | (~tdd_tx_rf_en & tdd_tx_rf_en_d)) | ((((tdd_rx_rf_en_d | tdd_rx_rf_en) & ~tdd_rx_rf_en) | ~tdd_rx_rf_en_d) & ((tdd_rx_rf_en_d | (~tdd_tx_rf_en & tdd_tx_rf_en_d)) | (~tdd_rx_rf_en_d & (tdd_rx_rf_en_d | tdd_rx_rf_en))))) : (tdd_tx_rf_en | tdd_rx_rf_en);
