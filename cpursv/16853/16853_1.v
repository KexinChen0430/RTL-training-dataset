...
module emesh_split(ems_rd_wait,ems_wr_wait,emm0_access,emm0_write,emm0_datamode,
                   emm0_ctrlmode,emm0_dstaddr,emm0_srcaddr,emm0_data,emm1_access,
                   emm1_write,emm1_datamode,emm1_ctrlmode,emm1_dstaddr,
                   emm1_srcaddr,emm1_data,ems_access,ems_write,ems_datamode,
                   ems_ctrlmode,ems_dstaddr,ems_srcaddr,ems_data,emm0_rd_wait,
                   emm0_wr_wait);
