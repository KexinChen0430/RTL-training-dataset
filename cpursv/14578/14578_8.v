          ...
          begin
            if (Bus_Locked == 2'b00) 
              begin
                ...
                if ((Data_Read_in | Data_Write_in) && !SD_Ready_out) Bus_Locked = 2'b01;
            ...
            if (Bus_Locked == 2'b01) 
              begin
                ...
                if (~(Inst_Read_in | Inst_Write_in) && 
                    (~(Data_Read_in | Data_Write_in) && !SD_Ready_out)) Bus_Locked = 2'b00;
            ...
            if (Bus_Locked == 2'b10) 
              begin
                if (~(Inst_Read_in | Inst_Write_in) && 
                    (Data_Read_in | Data_Write_in) && !SD_Ready_out) Bus_Locked = 2'b01;
