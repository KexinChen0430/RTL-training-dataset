...
module fifo19_to_ll8(input  clk,
  ...
  assign ll_eof = f19_eof & (((((state == 1) & (advance & ((state == 1) | ll_eof))) | ((f19_eof & ((state == 1) | ll_eof)) & (state == 1))) | (((f19_occ == 1) & f19_eof) | (((state == 1) & (advance & ((state == 1) | ll_eof))) | (((f19_eof & ((state == 1) | ll_eof)) & (state == 1)) & ((f19_occ == 1) & f19_eof))))) | (state == 1));
