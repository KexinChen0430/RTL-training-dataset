          ...
          begin
            ...
            if (saturate_mode == symmetric) 
              begin
                ...
                for (i = datain_width-round_width; i < ((0-saturate_width)+datain_width); i = i+1)
                    begin
            ...
            if (saturate_mode == asymmetric) 
              begin
                for (i = 0; i < ((0-saturate_width)+datain_width); i = i+1)
                    begin
                      max[i] = 1'b1;
                      min[i] = 1'b0;
                    end
            ...
            if (saturate_width == 1) 
              ...
              begin
                for (i = (0-saturate_width)+datain_width; i < datain_width; i = i+1)
                    begin
            ...
            if ((sign_tmp == 1'b1) && 
                ((saturate_mode == symmetric) && (data_tmp == 1'b0))) saturation_overflow_tmp = 1'b1;
