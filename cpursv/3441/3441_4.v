...
module Queue_1(input  clk,
  ...
  assign T28 = (((~1'h1 & (1'h1 & ((~1'h1 & empty) | (empty & ~empty)))) | ~empty) & (1'h1 | (~1'h1 & (1'h1 & ((~1'h1 & empty) | (empty & ~empty)))))) | (~1'h1 & empty);
  assign empty = T29 & ptr_match;
  assign T29 = (~((1'h1 | (~1'h1 & (1'h1 | maybe_full))) & (maybe_full & ((1'h1 | maybe_full) | ~1'h1))) & (1'h1 & (1'h1 | (~1'h1 & (1'h1 | maybe_full))))) | (((1'h1 | (~1'h1 & (1'h1 | maybe_full))) & (maybe_full & ((1'h1 | maybe_full) | ~1'h1))) & ~(1'h1 & (1'h1 | (~1'h1 & (1'h1 | maybe_full)))));
  assign io_enq_ready = T30;
  assign T30 = (~1'h1 | ~full) & (full | 1'h1);
