...
module Queue_1(input  clk,
  ...
  assign T28 = (((((~1'h1 & empty) | ((~empty & 1'h1) & ~1'h1)) | 1'h1) & (1'h1 & (~empty | empty))) & ~((((~1'h1 & empty) | ((~empty & 1'h1) & ~1'h1)) | 1'h1) & empty)) | (~((((~1'h1 & empty) | ((~empty & 1'h1) & ~1'h1)) | 1'h1) & (1'h1 & (~empty | empty))) & ((((~1'h1 & empty) | ((~empty & 1'h1) & ~1'h1)) | 1'h1) & empty));
  assign empty = ptr_match & T29;
  assign T29 = (((maybe_full | ~maybe_full) | ((((~maybe_full & maybe_full) | (maybe_full & ~1'h1)) & (1'h1 & (maybe_full | ~maybe_full))) | (~maybe_full & (1'h1 & (maybe_full | ~maybe_full))))) & 1'h1) ^ (((maybe_full | ~maybe_full) | ((((~maybe_full & maybe_full) | (maybe_full & ~1'h1)) & (1'h1 & (maybe_full | ~maybe_full))) | (~maybe_full & (1'h1 & (maybe_full | ~maybe_full))))) & ((~1'h1 | (1'h1 | full)) & maybe_full));
  assign io_enq_ready = T30;
  assign T30 = (full & ~1'h1) | ((~full & (full & (~1'h1 | (1'h1 | full)))) | (~full & 1'h1));
  assign full = maybe_full & ptr_match;
