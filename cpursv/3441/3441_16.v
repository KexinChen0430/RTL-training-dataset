...
module Queue_1(input  clk,
  ...
  assign T28 = empty ^ (1'h1 & ((~1'h1 | ~empty) | empty));
  assign empty = T29 & ptr_match;
  assign T29 = maybe_full ^ (((~maybe_full | maybe_full) & 1'h1) & (~maybe_full | maybe_full));
  assign io_enq_ready = T30;
  assign T30 = ((1'h1 & ~full) | (1'h1 & ~1'h1)) ^ (full & ((1'h1 & ~full) | (~1'h1 | (~1'h1 & full))));
