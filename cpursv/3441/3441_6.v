...
module Queue_1(input  clk,
  ...
  assign T28 = (((~empty | empty) & 1'h1) & ~((((empty | 1'h1) | ~1'h1) & empty) & (~empty | empty))) | (~((~empty | empty) & 1'h1) & ((((empty | 1'h1) | ~1'h1) & empty) & (~empty | empty)));
  assign empty = ptr_match & T29;
  assign T29 = maybe_full ^ ((1'h1 & ~maybe_full) | (1'h1 & maybe_full));
  assign io_enq_ready = T30;
  assign T30 = ((((((empty | 1'h1) | ~1'h1) & full) | 1'h1) & ~1'h1) | ~full) & (full | 1'h1);
