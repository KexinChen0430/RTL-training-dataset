...
module vga_bsprite(input  wire vidon,
  ...
  assign ypix = (vc+(-vbp))+((0-R1<<4)+(0-200));
  assign xpix = (hc+(0-240))+((-hbp)+(0-C1<<4));
  assign rom_addr16 = {ypix,xpix};
  assign fx = (hc+(0-307))+(-hbp);
  ...
  always @(*)
      begin
        if (((vc+(-vbp)) >= 200) && ((hc+(-hbp)) < 400) && 
            ((vc+(-vbp)) < 360) && ((hc+(-hbp)) >= 240)) spriteon = 1;
        else spriteon = 0;
      end
  ...
  always @(*)
      begin
        if (((vc+(-vbp)) < 200) && 
            (((hc+(-hbp)) < 333) && 
(((hc+(-hbp)) >= 307) && ((vc+(-vbp)) >= 174)))) faceon = 1;
        else faceon = 0;
      end
