...
module vga_bsprite(input  wire vidon,
  ...
  assign R1 = vc+((0-200)+(-vbp))>>4;
  assign ypix = ((0-R1<<4)+vc)+((0-200)+(-vbp));
  assign xpix = (0-hbp)+(hc+((-240)+(0-C1<<4)));
  assign rom_addr16 = {ypix,xpix};
  assign fx = ((0-hbp)+hc)-307;
  assign fy = (-174)+(vc-vbp);
  assign addrface = (({4'b0000,fy,1'b0}+{2'b0,fy,3'b000})+{1'b0,fy,4'b0000})+{5'b00000,fx};
  assign rom_addr26 = addrface[9:0];
  
  always @(*)
      begin
        if ((((0-hbp)+hc) < 400) && (((0-hbp)+hc) >= 240) && 
            (((vc-vbp) < 360) && ((vc-vbp) >= 200))) spriteon = 1;
        else spriteon = 0;
      end
  ...
  always @(*)
      begin
        if (((vc-vbp) < 200) && 
            ((((0-hbp)+hc) < 333) && ((vc-vbp) >= 174) && 
(((0-hbp)+hc) >= 307))) faceon = 1;
        else faceon = 0;
      end
