...
module vga_bsprite(input  wire vidon,
  ...
  assign C1 = ((0-hbp)+(-240))+hc>>4;
  assign R1 = (-200)+(vc+(0-vbp))>>4;
  assign ypix = (0-R1<<4)+((-200)+(vc+(0-vbp)));
  assign xpix = (((0-hbp)+(-240))+hc)-((2**4)*C1);
  ...
  always @(*)
      begin
        if (((vc+(0-vbp)) < 360) && 
            (((vc+(0-vbp)) >= 200) && ((hc-hbp) >= 240) && 
((hc-hbp) < 400))) spriteon = 1;
        else spriteon = 0;
      end
  ...
  always @(*)
      begin
        if (((vc+(0-vbp)) < 200) && 
            (((hc-hbp) >= 307) && 
(((hc-hbp) < 333) && ((vc+(0-vbp)) >= 174)))) faceon = 1;
        else faceon = 0;
      end
