...
module quadrature_clocked(clk,reset,quadA,quadB,count);
  ...
  wire 
       count_direction = (((((quadA_delayed[1] | ~quadA_delayed[1]) & (quadA_delayed[1] & ~quadB_delayed[1<<<1])) | ((quadA_delayed[1] | ~quadA_delayed[1]) & ~quadA_delayed[1])) & ~quadA_delayed[1]) & quadB_delayed[1<<<1]) | (quadA_delayed[1] & ~quadB_delayed[1<<<1]);
