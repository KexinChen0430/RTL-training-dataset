...
module flash_cntrl(input  wb_clk_i,
                   input  wb_rst_i,
                   input  [15:0] wb_dat_i,
  ...
  assign opbase = wb_tga_i & (wb_we_i & op);
  
  always @(posedge wb_clk_i)
      flash_addr_ <= wb_tga_i ? {1'b1,base,wb_adr_i[8:1]} : {5'h0,wb_adr_i[16:1]};
