...
module GameLoader(input  clk,
  ...
  assign mem_write = 
(((state == 1<<<1) && (bytes_left != 0)) || 
((state == 1) && indata_clk)) && (bytes_left != 0) && indata_clk;
  wire [1<<<1:0] 
       prg_size = (prgrom <= 1) ? 0 : 
(prgrom <= 1<<<1) ? 1 : 
(prgrom <= 4) ? 1<<<1 : 
...
(
((ines[11] != 0) || 
((ines[13] != 0) || (ines[12] != 0) || (ines[14] != 0)) || (ines[15] != 0)) && !is_nes20) || 
((((ines[9] != 0) || (ines[10] != 0)) && !is_nes20) || 
((ines[8] != 0) && !is_nes20));
            ...
            case (state)
              ...
              0: if (indata_clk) 
                    begin
                      ...
                      if (ctr == 4'b1111) 
                        state <= ((ines[1] == 8'h45) && 
                                ((ines[0] == 8'h4E) && (ines[3] == 8'h1A)) && ((ines[1<<<1] == 8'h53) && !ines[6][1<<<1])) ? 1 : 3;
