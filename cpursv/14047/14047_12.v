...
(state == (1+1)) && (bytes_left != 0)))) && ((bytes_left != 0) && indata_clk);
  wire [1+1:0] 
       prg_size = (prgrom <= 1) ? 0 : 
(prgrom <= (1+1)) ? 1 : 
(prgrom <= 4) ? (1+1) : 
...
((ines[8] != 0) || (ines[9] != 0) || 
((ines[11] != 0) || (ines[12] != 0) || 
((ines[14] != 0) || (ines[13] != 0))) || (ines[10] != 0)) && ((ines[14] != 0) || !is_nes20))) && !is_nes20;
            ...
            case (state)
              ...
              0: if (indata_clk) 
                    begin
                      ...
                      if (ctr == 4'b1111) 
                        state <= ((ines[3] == 8'h1A) && (ines[1+1] == 8'h53) && 
                                (ines[1] == 8'h45) && ((ines[0] == 8'h4E) && !ines[6][1+1])) ? 1 : 3;
