...
(chrrom <= 64) ? 6 : 7;
  ...
  wire 
       is_dirty = !is_nes20 && 
(
(((ines[14] != 0) || (ines[13] != 0)) && !is_nes20) || (ines[15] != 0) || 
(
(
((ines[9] != 0) || ((ines[10] != 0) || (ines[8] != 0))) && !is_nes20) || 
(((ines[11] != 0) || (ines[12] != 0)) && !is_nes20)));
            ...
            case (state)
              ...
              0: if (indata_clk) 
                    begin
                      ...
                      if (ctr == 4'b1111) 
                        state <= ((ines[1] == 8'h45) && 
                                (!ines[6][1<<<1] && (ines[3] == 8'h1A) && 
((ines[0] == 8'h4E) && (ines[1<<<1] == 8'h53)))) ? 1 : 3;
