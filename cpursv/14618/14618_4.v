...
(tx_overrun || rx_overrun));
  ...
  assign selected_read_data = (({16{address == 3'd4}} & baud_divisor) | ((({16{address == 3'd2}} & status_reg) | (({16{address == 3'd0}} & rx_data) | (control_reg & {16{address == 3'd3}}))) | {16{address == 3'd1}})) & (({16{address == 3'd4}} & baud_divisor) | ((((rx_data | tx_data) & {16{address == 3'd0}}) | ((rx_data | tx_data) & tx_data)) | (((status_reg | control_reg) & (control_reg | {16{address == 3'd2}})) & (({16{address == 3'd3}} | status_reg) & ({16{address == 3'd3}} | {16{address == 3'd2}})))));
...
(
((ie_any_error || ie_tx_shift_empty) && 
(any_error || ie_tx_shift_empty)) || tx_overrun))) || (break_detect && ie_break_detect))) && 
((parity_error && ie_parity_error) || 
(
(
(
...
(
((ie_any_error || ie_tx_shift_empty) && 
(any_error || ie_tx_shift_empty)) || tx_overrun))) || (rx_overrun || (break_detect && ie_break_detect))))) || (framing_error && ie_framing_error));
