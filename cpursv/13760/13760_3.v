              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,1'd1}] <= dina[(B_DATA_WIDTH*1<<1)+(0-1):B_DATA_WIDTH];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd1}] <= dina[(B_DATA_WIDTH*1<<1)+(0-1):B_DATA_WIDTH];
                    m_ram[{addra,2'd2}] <= dina[(0-1)+(B_DATA_WIDTH*3):B_DATA_WIDTH*1<<1];
                    m_ram[{addra,2'd3}] <= dina[(0-1)+(B_DATA_WIDTH*4):B_DATA_WIDTH*3];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd1}] <= dina[(B_DATA_WIDTH*1<<1)+(0-1):B_DATA_WIDTH];
                    m_ram[{addra,3'd2}] <= dina[(0-1)+(B_DATA_WIDTH*3):B_DATA_WIDTH*1<<1];
                    m_ram[{addra,3'd3}] <= dina[(0-1)+(B_DATA_WIDTH*4):B_DATA_WIDTH*3];
                    m_ram[{addra,3'd4}] <= dina[(0-1)+(5*B_DATA_WIDTH):B_DATA_WIDTH*4];
                    m_ram[{addra,3'd5}] <= dina[(6*B_DATA_WIDTH)-1:5*B_DATA_WIDTH];
                    m_ram[{addra,3'd6}] <= dina[(B_DATA_WIDTH*7)+(0-1):6*B_DATA_WIDTH];
                    m_ram[{addra,3'd7}] <= dina[(0-1)+(B_DATA_WIDTH*8):B_DATA_WIDTH*7];
                  end
