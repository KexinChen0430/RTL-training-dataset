              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,1'd1}] <= dina[B_DATA_WIDTH<<<1-1:B_DATA_WIDTH];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd1}] <= dina[B_DATA_WIDTH<<<1-1:B_DATA_WIDTH];
                    m_ram[{addra,2'd2}] <= dina[(3*B_DATA_WIDTH)+(-1):B_DATA_WIDTH<<<1];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd1}] <= dina[B_DATA_WIDTH<<<1-1:B_DATA_WIDTH];
                    m_ram[{addra,3'd2}] <= dina[(3*B_DATA_WIDTH)+(-1):B_DATA_WIDTH<<<1];
                    ...
                    m_ram[{addra,3'd7}] <= dina[(8*B_DATA_WIDTH)-1:7*B_DATA_WIDTH];
                  end
