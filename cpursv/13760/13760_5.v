              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,1'd1}] <= dina[(-1)+(B_DATA_WIDTH+B_DATA_WIDTH):B_DATA_WIDTH];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd1}] <= dina[(-1)+(B_DATA_WIDTH+B_DATA_WIDTH):B_DATA_WIDTH];
