              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd2}] <= dina[(B_DATA_WIDTH*3)-1:B_DATA_WIDTH+B_DATA_WIDTH];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd2}] <= dina[(B_DATA_WIDTH*3)-1:B_DATA_WIDTH+B_DATA_WIDTH];
                    m_ram[{addra,3'd3}] <= dina[(4*B_DATA_WIDTH)-1:B_DATA_WIDTH*3];
                    m_ram[{addra,3'd4}] <= dina[(-1)+(5*B_DATA_WIDTH):4*B_DATA_WIDTH];
                    m_ram[{addra,3'd5}] <= dina[(B_DATA_WIDTH*6)-1:5*B_DATA_WIDTH];
                    m_ram[{addra,3'd6}] <= dina[(-1)+(7*B_DATA_WIDTH):B_DATA_WIDTH*6];
