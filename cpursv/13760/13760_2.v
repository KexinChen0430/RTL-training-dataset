              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd2}] <= dina[(0-1)+(3*B_DATA_WIDTH):B_DATA_WIDTH*(1+1)];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd2}] <= dina[(0-1)+(3*B_DATA_WIDTH):B_DATA_WIDTH*(1+1)];
                    m_ram[{addra,3'd3}] <= dina[(4*B_DATA_WIDTH)-1:3*B_DATA_WIDTH];
                    m_ram[{addra,3'd4}] <= dina[(B_DATA_WIDTH*5)-1:4*B_DATA_WIDTH];
                    m_ram[{addra,3'd5}] <= dina[(6*B_DATA_WIDTH)+(0-1):B_DATA_WIDTH*5];
                    m_ram[{addra,3'd6}] <= dina[(B_DATA_WIDTH*7)-1:6*B_DATA_WIDTH];
                    m_ram[{addra,3'd7}] <= dina[(8*B_DATA_WIDTH)+(0-1):B_DATA_WIDTH*7];
                  end
