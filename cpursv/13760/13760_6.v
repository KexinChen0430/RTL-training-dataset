              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,1'd1}] <= dina[(2*B_DATA_WIDTH)+(-1):B_DATA_WIDTH];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd1}] <= dina[(2*B_DATA_WIDTH)+(-1):B_DATA_WIDTH];
                    m_ram[{addra,2'd2}] <= dina[(-1)+(B_DATA_WIDTH*3):2*B_DATA_WIDTH];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd1}] <= dina[(2*B_DATA_WIDTH)+(-1):B_DATA_WIDTH];
                    m_ram[{addra,3'd2}] <= dina[(-1)+(B_DATA_WIDTH*3):2*B_DATA_WIDTH];
