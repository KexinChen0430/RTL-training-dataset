...
module ad_mem_asym(clka,wea,addra,dina,clkb,addrb,doutb);
  ...
  reg  [(-1)+B_DATA_WIDTH:0] m_ram[0:(-1)+MEM_SIZE];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,1'd1}] <= dina[(-1)+(1<<<1*B_DATA_WIDTH):B_DATA_WIDTH];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd1}] <= dina[(-1)+(1<<<1*B_DATA_WIDTH):B_DATA_WIDTH];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd1}] <= dina[(-1)+(1<<<1*B_DATA_WIDTH):B_DATA_WIDTH];
                    ...
                    m_ram[{addra,3'd5}] <= dina[(B_DATA_WIDTH*6)+(-1):B_DATA_WIDTH*5];
                    m_ram[{addra,3'd6}] <= dina[(7*B_DATA_WIDTH)-1:B_DATA_WIDTH*6];
                    m_ram[{addra,3'd7}] <= dina[(-1)+(8*B_DATA_WIDTH):7*B_DATA_WIDTH];
                  end
