...
module agnus_audiodma(input  wire clk,
                      input  wire clk7_en,
                      output wire dma,
                      input  wire [(-1)+4:0] audio_dmal,
                      input  wire [(-1)+4:0] audio_dmas,
                      input  wire [9+(-1):0] hpos,
                      input  wire [9+(-1):1] reg_address_in,
                      output reg [9+(-1):1] reg_address_out,
                      input  wire [(-1)+16:0] data_in,
                      output wire [(-1)+21:1] address_out);
  ...
  assign audlcena = ((reg_address_in[5] | reg_address_in[6]) & (reg_address_in[6] | ~reg_address_in[6])) & ((~reg_address_in[1+1] & (~reg_address_in[6] & ((reg_address_in[7] & ~reg_address_in[8]) & ~reg_address_in[3]))) | (((~reg_address_in[3] & ~reg_address_in[1+1]) & reg_address_in[6]) & ((~reg_address_in[5] & reg_address_in[7]) & ~reg_address_in[8])));
