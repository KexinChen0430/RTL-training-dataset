...
module agnus_audiodma(input  wire clk,
                      ...
                      input  wire [9+(0-1):0] hpos,
                      input  wire [9+(0-1):1] reg_address_in,
                      output reg [9+(0-1):1] reg_address_out,
                      input  wire [16-1:0] data_in,
                      output wire [(0-1)+21:1] address_out);
  ...
  assign audlcena = ((~reg_address_in[8] & reg_address_in[7]) & (((((reg_address_in[6] & ~reg_address_in[5]) | ~reg_address_in[5]) | (reg_address_in[5] & ~reg_address_in[6])) | reg_address_in[6]) & (~reg_address_in[1<<1] & (~reg_address_in[3] & reg_address_in[5])))) ^ ((~reg_address_in[8] & reg_address_in[7]) & (((((reg_address_in[6] & ~reg_address_in[5]) | ~reg_address_in[5]) | (reg_address_in[5] & ~reg_address_in[6])) | reg_address_in[6]) & (~reg_address_in[1<<1] & (~reg_address_in[3] & reg_address_in[6]))));
  ...
  always @(posedge clk)
      begin
        if (clk7_en) 
          begin
            if (reg_address_in[1] & audlcena) audlcl[audlcsel] <= #1 data_in[15:1];
  ...
  always @(*)
      begin
        case (hpos)
          ...
          9'b0001_0110_1: dmal = audio_dmal[1<<1];
  ...
  always @(*)
      begin
        case (hpos)
          ...
          9'b0001_0110_1: dmas = audio_dmas[1<<1];
  ...
  always @(*)
      begin
        case (channel)
          ...
          1<<1: reg_address_out[8:1] = AUD2DAT_REG[8:1];
