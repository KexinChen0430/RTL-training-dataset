...
module agnus_audiodma(input  wire clk,
  ...
  assign audlcena = ((~reg_address_in[8] & (reg_address_in[7] & (~reg_address_in[1<<<1] & reg_address_in[5]))) ^ (~reg_address_in[8] & (reg_address_in[7] & (~reg_address_in[1<<<1] & reg_address_in[6])))) & ~reg_address_in[3];
