...
module agnus_audiodma(input  wire clk,
                      ...
                      input  wire [(-1)+9:0] hpos,
                      input  wire [(-1)+9:1] reg_address_in,
                      output reg [(-1)+9:1] reg_address_out,
  ...
  assign audlcena = ((((~reg_address_in[5] | ~reg_address_in[6]) & reg_address_in[5]) & ((~reg_address_in[3] & ~reg_address_in[2]) & (~reg_address_in[8] & reg_address_in[7]))) & ~(((~reg_address_in[3] & ~reg_address_in[2]) & (~reg_address_in[8] & reg_address_in[7])) & (reg_address_in[6] & (~reg_address_in[5] | ~reg_address_in[6])))) | (~(((~reg_address_in[5] | ~reg_address_in[6]) & reg_address_in[5]) & ((~reg_address_in[3] & ~reg_address_in[2]) & (~reg_address_in[8] & reg_address_in[7]))) & (((~reg_address_in[3] & ~reg_address_in[2]) & (~reg_address_in[8] & reg_address_in[7])) & (reg_address_in[6] & (~reg_address_in[5] | ~reg_address_in[6]))));
