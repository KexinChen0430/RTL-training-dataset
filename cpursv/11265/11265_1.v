...
module InstrDecod(instr,pc,regWrite,writeData,writeRegister,opcode,funct,
                  regOut1,regOut2,regRt,regRd,immValue,jumpDest,branchDest);
  ...
  always @(*)
      begin
        if (regWrite == 1) registerMem[writeRegister] = writeData;
