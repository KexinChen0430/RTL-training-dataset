...
module write_back  #(parameter  DATA_WIDTH = 32, REG_ADDR_WIDTH = 5)
  (input  [DATA_WIDTH+(0-1):0] mem_data_in,
   ...
   output [(0-1)+REG_ADDR_WIDTH:0] reg_a_wr_addr_out,
   output [(0-1)+REG_ADDR_WIDTH:0] reg_b_wr_addr_out,
   output [DATA_WIDTH+(0-1):0] reg_a_wr_data_out,
   output [DATA_WIDTH+(0-1):0] reg_b_wr_data_out,
