...
module write_back  #(parameter  DATA_WIDTH = 32, REG_ADDR_WIDTH = 5)
  (input  [(-1)+DATA_WIDTH:0] mem_data_in,
   input  [(-1)+DATA_WIDTH:0] alu_data_in,
   input  [(-1)+DATA_WIDTH:0] hi_data_in,
   ...
   output [(-1)+REG_ADDR_WIDTH:0] reg_a_wr_addr_out,
   output [(-1)+REG_ADDR_WIDTH:0] reg_b_wr_addr_out,
   output [(-1)+DATA_WIDTH:0] reg_a_wr_data_out,
   output [(-1)+DATA_WIDTH:0] reg_b_wr_data_out,
