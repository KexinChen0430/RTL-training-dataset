      ...
      begin
        if (rst) 
          ...
          begin
            ...
            else if (din_activate != 0) 
              begin
                if (write_count < din_size) 
                  begin
                    din_stb <= 1;
                    din <= write_count;
            ...
            if (dout_ready && !dout_activate) 
              begin
                read_count <= 0;
                dout_activate <= 1;
                if (dout_size != 24'h0800) 
                  begin
                    count_error <= 1;
            ...
            else if (dout_activate) 
              begin
                if (read_count < dout_size) 
                  begin
                    dout_stb <= 1;
