      ...
      begin
        if (rst_n == 1'b0) 
          ...
          begin
            ...
            if ((a == 16'h0066) && (m1_n == 1'b0) && 
                ((page_configrom_active == 1'b1) && (mreq_n == 1'b0))) nmiout_n <= 1'b1;
              
            case (state)

              IDLE: begin
                    if ((rd_n == 1'b0) && (page_configrom_active == 1'b1) && 
                        ((a == 16'h006A) && (mreq_n == 1'b0)) && (m1_n == 1'b0)) state <= ABOUT_TO_EXIT;
