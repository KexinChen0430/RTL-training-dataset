...
module wasca_nios2_gen2_0_cpu_nios2_avalon_reg(input  [8:0] address,
                                               input  clk,
                                               input  debugaccess,
                                               input  monitor_error,
                                               input  monitor_go,
  ...
  always @(posedge clk or negedge reset_n)
      begin
        if (reset_n == 0) oci_ienable <= 32'b00000000000000000000000000001010;
        else if (take_action_oci_intr_mask_reg) 
          oci_ienable <= ~32'b00000000000000000000000000001010 | writedata;
