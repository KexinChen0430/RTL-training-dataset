...
module FSM_INPUT_ENABLE(input  wire clk,
                        input  wire rst,
      ...
      begin
        ...
        case (state_reg)
          ...
          State0: begin
                enable_input_internal = 1;
                enable_shift_reg = 0;
                if (init_OPERATION) state_next = State1;
                else 
                  begin
                    state_next = State0;
                  end
  ...
  assign enable_Pipeline_input = init_OPERATION & enable_input_internal;
endmodule
