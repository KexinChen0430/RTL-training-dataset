...
module stage  #(parameter  N = 8, LOG_N = 3, WIDTH = 32)
  (input  wire clk,
   ...
   input  wire in_nd,
   input  wire [(0-1)+WIDTH:0] in_data0,
   input  wire [(0-1)+WIDTH:0] in_data1,
   input  wire in_active,
   input  wire [LOG_N+(0-1):0] out_addr0,
   input  wire [LOG_N+(0-1):0] out_addr1,
   output wire [(0-1)+WIDTH:0] out_data0,
   output wire [(0-1)+WIDTH:0] out_data1,
