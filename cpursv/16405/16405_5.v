...
module input_pipeline(clk,clk_ena,in_stream,pipeline_reg_0,pipeline_reg_1,
                      ...
                      pipeline_reg_25,pipeline_reg_26,pipeline_reg_27,reset);
  ...
  output [WIDTH+(0-1):0] pipeline_reg_11;
  output [WIDTH+(0-1):0] pipeline_reg_12;
  output [WIDTH+(0-1):0] pipeline_reg_13;
  output [WIDTH+(0-1):0] pipeline_reg_14;
  output [WIDTH+(0-1):0] pipeline_reg_15;
  output [WIDTH+(0-1):0] pipeline_reg_16;
  output [WIDTH+(0-1):0] pipeline_reg_17;
  output [WIDTH+(0-1):0] pipeline_reg_18;
  output [WIDTH+(0-1):0] pipeline_reg_19;
  output [WIDTH+(0-1):0] pipeline_reg_20;
  output [WIDTH+(0-1):0] pipeline_reg_21;
  output [WIDTH+(0-1):0] pipeline_reg_22;
  output [WIDTH+(0-1):0] pipeline_reg_23;
  output [WIDTH+(0-1):0] pipeline_reg_24;
  output [WIDTH+(0-1):0] pipeline_reg_25;
  output [WIDTH+(0-1):0] pipeline_reg_26;
  output [WIDTH+(0-1):0] pipeline_reg_27;
  ...
  reg  [WIDTH+(0-1):0] pipeline_reg_11;
  reg  [WIDTH+(0-1):0] pipeline_reg_12;
  reg  [WIDTH+(0-1):0] pipeline_reg_13;
  reg  [WIDTH+(0-1):0] pipeline_reg_14;
  reg  [WIDTH+(0-1):0] pipeline_reg_15;
  reg  [WIDTH+(0-1):0] pipeline_reg_16;
  reg  [WIDTH+(0-1):0] pipeline_reg_17;
  reg  [WIDTH+(0-1):0] pipeline_reg_18;
  reg  [WIDTH+(0-1):0] pipeline_reg_19;
  reg  [WIDTH+(0-1):0] pipeline_reg_20;
  reg  [WIDTH+(0-1):0] pipeline_reg_21;
  reg  [WIDTH+(0-1):0] pipeline_reg_22;
  reg  [WIDTH+(0-1):0] pipeline_reg_23;
  reg  [WIDTH+(0-1):0] pipeline_reg_24;
  reg  [WIDTH+(0-1):0] pipeline_reg_25;
  reg  [WIDTH+(0-1):0] pipeline_reg_26;
  reg  [WIDTH+(0-1):0] pipeline_reg_27;
  input  reset;
