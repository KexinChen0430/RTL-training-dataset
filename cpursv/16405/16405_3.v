...
module input_pipeline(clk,clk_ena,in_stream,pipeline_reg_0,pipeline_reg_1,
  ...
  output [(-1)+WIDTH:0] pipeline_reg_21;
  output [(-1)+WIDTH:0] pipeline_reg_22;
  output [(-1)+WIDTH:0] pipeline_reg_23;
  output [(-1)+WIDTH:0] pipeline_reg_24;
  output [(-1)+WIDTH:0] pipeline_reg_25;
  output [(-1)+WIDTH:0] pipeline_reg_26;
  output [(-1)+WIDTH:0] pipeline_reg_27;
  ...
  reg  [(-1)+WIDTH:0] pipeline_reg_21;
  reg  [(-1)+WIDTH:0] pipeline_reg_22;
  reg  [(-1)+WIDTH:0] pipeline_reg_23;
  reg  [(-1)+WIDTH:0] pipeline_reg_24;
  reg  [(-1)+WIDTH:0] pipeline_reg_25;
  reg  [(-1)+WIDTH:0] pipeline_reg_26;
  reg  [(-1)+WIDTH:0] pipeline_reg_27;
  input  reset;
