...
module COREAHBLITE_DEFAULTSLAVESM(input  HCLK,
                                  input  HRESETN,
  ...
  always @(*)
      begin
        ...
        case (defSlaveSMCurrentState)
          ...
          default: defSlaveSMNextState = IDLE;
  ...
  always @(posedge HCLK or negedge HRESETN)
      begin
        if (!HRESETN) defSlaveSMCurrentState <= IDLE;
        else defSlaveSMCurrentState <= defSlaveSMNextState;
      end
endmodule
