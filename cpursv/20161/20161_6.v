  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) 
          ...
          begin
            if ((time_cnt < 'd44500) && (start_bits == 3'b111) && 
                (data_start == 0)) 
              begin
                time_cnt <= 1'b1+time_cnt;
              end
            else if ((time_cnt == 'd44500) && (start_bits == 3'b111) && 
                     (data_start == 0)) 
              begin
                time_cnt <= 'h0;
                data_start <= 'h1;
              ...
              begin
                if ((time_cnt < 'd89000) && 
                    ((start_bits == 3'b111) && (cyc_cnt < 'd11)) && (data_start == 1)) 
                  begin
                    time_cnt <= 1'b1+time_cnt;
                  end
...
(time_cnt < 'd60000))) 
            ...
            else if ((time_cnt > 'd30000) && (cyc_cnt < 'd11) && 
                     ((time_cnt < 'd60000) && rising_edge)) 
              begin
