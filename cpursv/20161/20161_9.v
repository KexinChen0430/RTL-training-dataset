  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) 
          ...
          begin
            if ((start_bits == 3'b111) && 
                ((time_cnt < 'd44500) && (data_start == 0))) 
              begin
                time_cnt <= time_cnt+1'b1;
              end
            else if ((time_cnt == 'd44500) && (data_start == 0) && 
                     (start_bits == 3'b111)) 
              begin
                time_cnt <= 'h0;
                data_start <= 'h1;
              ...
              begin
                if ((time_cnt < 'd89000) && (cyc_cnt < 'd11) && 
                    ((data_start == 1) && (start_bits == 3'b111))) 
                  begin
                    time_cnt <= time_cnt+1'b1;
                  end
                else if ((start_bits == 3'b111) && (time_cnt == 'd89000) && 
                         ((cyc_cnt < 'd11) && (data_start == 1))) 
                  begin
                    time_cnt <= 'h0;
  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) 
          ...
          begin
            if ((cyc_cnt < 'd11) && (time_cnt < 'd60000) && 
                ((time_cnt > 'd30000) && falling_edge)) 
              begin
                received_data[cyc_cnt] <= 1'b1;
              end
            else if (rising_edge && (time_cnt < 'd60000) && 
                     ((time_cnt > 'd30000) && (cyc_cnt < 'd11))) 
              begin
