      ...
      begin
        if (!rst) 
          ...
          begin
            ...
            else if ((data_start == 0) && (start_bits == 3'b111) && 
                     (time_cnt == 'd44500)) 
              begin
                time_cnt <= 'h0;
                data_start <= 'h1;
...
(time_cnt < 'd89000))) 
                ...
                else if ((time_cnt == 'd89000) && (cyc_cnt < 'd11) && 
  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) 
          ...
          begin
            if ((time_cnt > 'd30000) && 
                ((cyc_cnt < 'd11) && (time_cnt < 'd60000) && falling_edge)) 
              begin
                received_data[cyc_cnt] <= 1'b1;
              end
            else if ((time_cnt < 'd60000) && 
                     ((time_cnt > 'd30000) && rising_edge && (cyc_cnt < 'd11))) 
              begin
