  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) 
          ...
          begin
            if ((time_cnt < 'd44500) && 
                ((start_bits == 3'b111) && (data_start == 0))) 
              begin
              ...
              begin
                ...
                else if ((start_bits == 3'b111) && (data_start == 1) && 
                         ((time_cnt == 'd89000) && (cyc_cnt < 'd11))) 
                  begin
                    time_cnt <= 'h0;
