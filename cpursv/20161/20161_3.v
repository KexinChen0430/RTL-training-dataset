        ...
        if (!rst) 
          ...
          begin
            if ((start_bits == 3'b111) && 
              ...
              begin
                if ((data_start == 1) && (time_cnt < 'd89000) && 
                    ((start_bits == 3'b111) && (cyc_cnt < 'd11))) 
                  begin
                    time_cnt <= 1'b1+time_cnt;
                  end
                else if ((start_bits == 3'b111) && (cyc_cnt < 'd11) && 
                         (time_cnt == 'd89000) && (data_start == 1)) 
                  begin
                    time_cnt <= 'h0;
                    cyc_cnt <= 1'b1+cyc_cnt;
                  end
                else 
                  begin
                    time_cnt <= time_cnt;
  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) 
          ...
          begin
            if ((time_cnt > 'd30000) && falling_edge && 
                ((cyc_cnt < 'd11) && (time_cnt < 'd60000))) 
              begin
                received_data[cyc_cnt] <= 1'b1;
              end
            else if ((cyc_cnt < 'd11) && (time_cnt < 'd60000) && 
                     (rising_edge && (time_cnt > 'd30000))) 
              begin
