  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) 
          ...
          begin
            if ((time_cnt < 'd44500) && (data_start == 0) && 
                (start_bits == 3'b111)) 
              begin
                time_cnt <= time_cnt+1'b1;
              end
            else if ((time_cnt == 'd44500) && 
                     ((data_start == 0) && (start_bits == 3'b111))) 
              begin
                time_cnt <= 'h0;
                data_start <= 'h1;
              end
              ...
              begin
                if ((time_cnt < 'd89000) && (data_start == 1) && 
                    (start_bits == 3'b111) && (cyc_cnt < 'd11)) 
                  begin
                    time_cnt <= time_cnt+1'b1;
                  end
                else if ((data_start == 1) && 
                         ((time_cnt == 'd89000) && (cyc_cnt < 'd11)) && (start_bits == 3'b111)) 
                  begin
                    time_cnt <= 'h0;
  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) 
          ...
          begin
            if ((time_cnt < 'd60000) && (cyc_cnt < 'd11) && 
                (time_cnt > 'd30000) && falling_edge) 
              begin
                received_data[cyc_cnt] <= 1'b1;
              end
            else if ((time_cnt > 'd30000) && rising_edge && 
                     ((time_cnt < 'd60000) && (cyc_cnt < 'd11))) 
              begin
