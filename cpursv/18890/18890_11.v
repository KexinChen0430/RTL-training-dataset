...
module cpu_vreg(input  wire clk,
  ...
  assign cpu_data = ((cpu_wr == 1) && (cpu_rd == 0) && 
                    ((cpu_mreq == 0) && (cpu_addr == 16'h92c0))) ? (close_to_vlank || copy_in_progress) : 8'bzzzzzzzz;
  
  always @(posedge clk)
      begin
        if ((cpu_wr == 0) && (copy_in_progress == 0) && 
            ((cpu_addr <= 16'h92bf) && (cpu_mreq == 0) && 
((cpu_rd == 1) && (cpu_addr >= 16'h8000)))) 
          begin
