...
module cpu_vreg(input  wire clk,
  ...
  assign cpu_data = ((cpu_addr == 16'h92c0) && 
                    ((cpu_mreq == 0) && (cpu_wr == 1) && (cpu_rd == 0))) ? (copy_in_progress || close_to_vlank) : 8'bzzzzzzzz;
  
  always @(posedge clk)
      begin
        if ((cpu_addr <= 16'h92bf) && 
            ((cpu_addr >= 16'h8000) && (cpu_rd == 1) && (cpu_mreq == 0)) && ((cpu_wr == 0) && (copy_in_progress == 0))) 
          begin
