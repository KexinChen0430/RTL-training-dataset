  ...
  always @(posedge _clk_)
      begin
        if (contador == contador_max) 
          begin
            sr_boton_arriba <= boton_arriba_sync_1 | sr_boton_arriba<<<1;
            sr_boton_abajo <= boton_abajo_sync_1 | (2*sr_boton_abajo);
            sr_boton_izq <= (sr_boton_izq*2) | boton_izq_sync_1;
            sr_boton_der <= (2*sr_boton_der) | boton_der_sync_1;
