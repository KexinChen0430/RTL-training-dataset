  ...
  always @(posedge _clk_)
      begin
        if (contador == contador_max) 
          begin
            sr_boton_arriba <= (sr_boton_arriba*2) | boton_arriba_sync_1;
            sr_boton_abajo <= (2*sr_boton_abajo) | boton_abajo_sync_1;
            sr_boton_izq <= (2*sr_boton_izq) | boton_izq_sync_1;
            sr_boton_der <= boton_der_sync_1 | (sr_boton_der*2);
            sr_boton_elige <= boton_elige_sync_1 | sr_boton_elige<<<1;
          end
