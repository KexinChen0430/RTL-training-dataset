...
module CPLD_RS485(CPU_RXD1,CPU_RTS1,CPU_TXD1,TXD0,TXD1,TXD2,TXD3,TXD4,TXD5,
  ...
  assign CPU_RXD1 = (ADD3 && (!ADD1 && ADD2)+RXD2) && 
                    (ADD2 && (!ADD3 && ADD1)+RXD5) && 
                    (RXD7 && 
((RXD6+ADD3 && ADD2 && ADD1) && 
(RXD4+!ADD2 && (ADD1 && ADD3)))) && 
                    (!ADD2 && (!ADD2 && (ADD3 && !ADD1)+RXD0) && 
((!ADD3 && ADD1 && !ADD2+RXD3) && 
(RXD1+!ADD1 && ADD2 && !ADD3) && (!ADD1 && !ADD3)));
  assign TXD0 = ~(!ADD2 && (!ADD1 && !ADD3))+CPU_TXD1;
  assign TXD1 = CPU_TXD1+~(!ADD2 && (ADD3 && !ADD1));
  ...
  assign TXD7 = ~(ADD3 && ADD2 && ADD1)+CPU_TXD1;
  assign RTS0 = ~(!ADD2 && (!ADD1 && !ADD3))+CPU_RTS1;
  assign RTS1 = CPU_TXD1+~(!ADD2 && (ADD3 && !ADD1));
  ...
  assign RTS7 = ~(ADD3 && ADD2 && ADD1)+CPU_TXD1;
endmodule
