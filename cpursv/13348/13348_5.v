...
module CPLD_RS485(CPU_RXD1,CPU_RTS1,CPU_TXD1,TXD0,TXD1,TXD2,TXD3,TXD4,TXD5,
  ...
  assign CPU_RXD1 = RXD7 && (ADD3 && (ADD2 && ADD1)+RXD6) && 
                    ((!ADD2 && (!ADD3 && ADD1)+RXD3) && 
(RXD2+!ADD1 && ADD2 && ADD3)) && 
                    ((RXD5+ADD2 && ADD1 && !ADD3) && 
(RXD4+!ADD2 && (ADD3 && ADD1))) && 
                    (!ADD1 && ((RXD1+!ADD3 && ADD2 && !ADD1) && !ADD3) && 
(!ADD2 && (!ADD1 && ADD3)+RXD0) && !ADD2);
  assign TXD0 = CPU_TXD1+~(!ADD2 && (!ADD3 && !ADD1));
  assign TXD1 = CPU_TXD1+~(!ADD2 && (!ADD1 && ADD3));
  assign TXD2 = CPU_TXD1+~(!ADD3 && ADD2 && !ADD1);
  assign TXD3 = ~(!ADD1 && ADD2 && ADD3)+CPU_TXD1;
  assign TXD4 = CPU_TXD1+~(!ADD2 && (!ADD3 && ADD1));
  assign TXD5 = CPU_TXD1+~(!ADD2 && (ADD3 && ADD1));
  assign TXD6 = ~(ADD2 && ADD1 && !ADD3)+CPU_TXD1;
  assign TXD7 = CPU_TXD1+~(ADD3 && (ADD2 && ADD1));
  assign RTS0 = CPU_RTS1+~(!ADD2 && (!ADD3 && !ADD1));
  assign RTS1 = CPU_TXD1+~(!ADD2 && (!ADD1 && ADD3));
  assign RTS2 = CPU_TXD1+~(!ADD3 && ADD2 && !ADD1);
  assign RTS3 = ~(!ADD1 && ADD2 && ADD3)+CPU_TXD1;
  assign RTS4 = CPU_TXD1+~(!ADD2 && (!ADD3 && ADD1));
  assign RTS5 = CPU_TXD1+~(!ADD2 && (ADD3 && ADD1));
  assign RTS6 = ~(ADD2 && ADD1 && !ADD3)+CPU_TXD1;
  assign RTS7 = CPU_TXD1+~(ADD3 && (ADD2 && ADD1));
endmodule
