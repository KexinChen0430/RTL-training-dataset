...
module CPLD_RS485(CPU_RXD1,CPU_RTS1,CPU_TXD1,TXD0,TXD1,TXD2,TXD3,TXD4,TXD5,
  ...
  assign CPU_RXD1 = RXD7 && (ADD3 && ADD1 && ADD2+RXD6) && 
                    ((RXD4+ADD3 && (ADD1 && !ADD2)) && 
(ADD2 && ADD1 && !ADD3+RXD5)) && 
                    (!ADD3 && !ADD1 && 
((ADD3 && (!ADD1 && !ADD2)+RXD0) && !ADD2)) && 
                    ((RXD1+!ADD1 && (!ADD3 && ADD2)) && 
(RXD3+!ADD3 && ADD1 && !ADD2) && (ADD2 && (ADD3 && !ADD1)+RXD2));
  assign TXD0 = CPU_TXD1+~(!ADD1 && (!ADD2 && !ADD3));
  assign TXD1 = CPU_TXD1+~(ADD3 && (!ADD1 && !ADD2));
  ...
  assign RTS0 = ~(!ADD1 && (!ADD2 && !ADD3))+CPU_RTS1;
  assign RTS1 = CPU_TXD1+~(ADD3 && (!ADD1 && !ADD2));
