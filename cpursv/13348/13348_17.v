...
module CPLD_RS485(CPU_RXD1,CPU_RTS1,CPU_TXD1,TXD0,TXD1,TXD2,TXD3,TXD4,TXD5,
  ...
  assign CPU_RXD1 = RXD7 && (RXD5+!ADD3 && (ADD2 && ADD1)) && 
                    (ADD3 && (ADD2 && ADD1)+RXD6) && 
                    (!ADD1 && !ADD3 && (RXD2+ADD2 && !ADD1 && ADD3) && 
((RXD0+!ADD2 && ADD3 && !ADD1) && !ADD2)) && 
                    ((!ADD3 && (ADD2 && !ADD1)+RXD1) && 
(RXD4+ADD1 && (!ADD2 && ADD3)) && (RXD3+!ADD2 && (ADD1 && !ADD3)));
  ...
  assign TXD6 = CPU_TXD1+~(!ADD3 && (ADD2 && ADD1));
  ...
  assign RTS6 = CPU_TXD1+~(!ADD3 && (ADD2 && ADD1));
