...
module CPLD_RS485(CPU_RXD1,CPU_RTS1,CPU_TXD1,TXD0,TXD1,TXD2,TXD3,TXD4,TXD5,
  ...
  assign CPU_RXD1 = (RXD4+ADD1 && (ADD3 && !ADD2)) && 
                    (ADD1 && ADD2 && ADD3+RXD6) && RXD7 && !ADD2 && 
                    ((!ADD3 && (ADD1 && ADD2)+RXD5) && 
((ADD1 && !ADD3 && !ADD2+RXD3) && 
(ADD2 && (ADD3 && !ADD1)+RXD2)) && !ADD1 && 
((!ADD3 && (ADD2 && !ADD1)+RXD1) && 
(!ADD3 && (!ADD1 && (ADD3 && !ADD2)+RXD0))));
  assign TXD0 = ~(!ADD1 && !ADD3 && !ADD2)+CPU_TXD1;
  assign TXD1 = CPU_TXD1+~(!ADD1 && (ADD3 && !ADD2));
  assign TXD2 = ~(!ADD3 && (ADD2 && !ADD1))+CPU_TXD1;
  assign TXD3 = ~(ADD2 && (ADD3 && !ADD1))+CPU_TXD1;
  assign TXD4 = ~(ADD1 && !ADD3 && !ADD2)+CPU_TXD1;
  assign TXD5 = ~(ADD1 && (ADD3 && !ADD2))+CPU_TXD1;
  assign TXD6 = CPU_TXD1+~(!ADD3 && (ADD1 && ADD2));
  assign TXD7 = CPU_TXD1+~(ADD1 && ADD2 && ADD3);
  assign RTS0 = CPU_RTS1+~(!ADD1 && !ADD3 && !ADD2);
  assign RTS1 = CPU_TXD1+~(!ADD1 && (ADD3 && !ADD2));
  assign RTS2 = ~(!ADD3 && (ADD2 && !ADD1))+CPU_TXD1;
  assign RTS3 = ~(ADD2 && (ADD3 && !ADD1))+CPU_TXD1;
  assign RTS4 = ~(ADD1 && !ADD3 && !ADD2)+CPU_TXD1;
  assign RTS5 = ~(ADD1 && (ADD3 && !ADD2))+CPU_TXD1;
  assign RTS6 = CPU_TXD1+~(!ADD3 && (ADD1 && ADD2));
