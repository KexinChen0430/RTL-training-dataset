...
module CPLD_RS485(CPU_RXD1,CPU_RTS1,CPU_TXD1,TXD0,TXD1,TXD2,TXD3,TXD4,TXD5,
  ...
  assign CPU_RXD1 = RXD7 && (RXD6+ADD2 && (ADD1 && ADD3)) && 
                    ((RXD5+ADD2 && !ADD3 && ADD1) && 
(RXD4+ADD3 && (ADD1 && !ADD2))) && (ADD3 && ADD2 && !ADD1+RXD2) && 
                    ((ADD2 && !ADD3 && !ADD1+RXD1) && !ADD3 && 
(!ADD3 && (ADD1 && !ADD2)+RXD3)) && ((ADD3 && !ADD2 && !ADD1+RXD0) && !ADD2 && !ADD1);
  ...
  assign TXD6 = ~(ADD2 && !ADD3 && ADD1)+CPU_TXD1;
  ...
  assign RTS6 = ~(ADD2 && !ADD3 && ADD1)+CPU_TXD1;
