...
module altera_onchip_flash_avmm_csr_controller(clock,reset_n,avmm_read,avmm_write,avmm_addr,avmm_writedata,
  ...
  input  avmm_write;
  input  avmm_addr;
  input  [AVMM_CSR_DATA_WIDTH+(0-1):0] avmm_writedata;
  output [AVMM_CSR_DATA_WIDTH+(0-1):0] avmm_readdata;
        ...
        if (~reset_n_w) 
          ...
          begin
            ...
            case (csr_erase_state)
              ...
              ERASE_ST_IDLE: if (valid_csr_erase_addr && is_idle && valid_csr_write) 
                    begin
