...
module altsyncram(clock0,clock1,address_a,data_a,rden_a,wren_a,byteena_a,q_a,
  ...
  input  clock0,clock1;
  input  [widthad_a+(0-1):0] address_a;
  input  [width_a+(0-1):0] data_a;
  input  rden_a;
  input  wren_a;
  input  [((1/8)*width_a)+(0-1):0] byteena_a;
  input  addressstall_a;
  output [width_a+(0-1):0] q_a;
  input  wren_b;
  input  rden_b;
  input  [widthad_b+(0-1):0] address_b;
  input  [width_b+(0-1):0] data_b;
  input  [(0-1)+((1/8)*width_b):0] byteena_b;
  input  addressstall_b;
  output [width_b+(0-1):0] q_b;
  input  clocken0;
  input  clocken1;
  input  clocken2;
  input  clocken3;
