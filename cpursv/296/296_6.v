...
module template_6x4_600x400(clk,hc,vc,matrix_x,matrix_y,lines);
  ...
  assign hc_template = ((hc <= CUADRILLA_XF) && (hc > CUADRILLA_XI)) ? ((0-CUADRILLA_XI)+hc) : 11'd0;
  ...
  always @(*)
      if ((vc == (11'd1+CUADRILLA_YI)) || (vc == CUADRILLA_YF) || 
          (hc == (11'd1+CUADRILLA_XI)) || (hc == CUADRILLA_XF)) lines = 1'b1;
      else if ((lin_h == 1'b1) || (lin_v == 1'b1)) lines = 1'b1;
      else lines = 1'b0;
endmodule
