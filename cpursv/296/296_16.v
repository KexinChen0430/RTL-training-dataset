...
module template_6x4_600x400(clk,hc,vc,matrix_x,matrix_y,lines);
  ...
  assign vc_template = ((vc > CUADRILLA_YI) && (vc <= CUADRILLA_YF)) ? ((-CUADRILLA_YI)+vc) : 11'd0;
  ...
  always @(*)
      if ((hc == CUADRILLA_XF) || (hc == (CUADRILLA_XI+11'd1)) || 
          ((vc == CUADRILLA_YF) || (vc == (11'd1+CUADRILLA_YI)))) lines = 1'b1;
