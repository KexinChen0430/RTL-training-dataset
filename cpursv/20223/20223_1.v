...
module bw_r_l2d_rep_bot(fuse_l2d_rden_buf,fuse_l2d_wren_buf,si_buf,arst_l_buf,se_buf,
                        ...
                        fuse_clk2_buf,mem_write_disable_buf,fuse_l2d_rden,
                        fuse_l2d_wren,si,arst_l,se,sehold,fuse_l2d_rid,
                        fuse_read_data_in,fuse_l2d_data_in,word_en,col_offset,set,
                        wr_en,way_sel,decc_in,fbdt_l,fbdb_l,scdata_scbuf_decc_top,
                        scdata_scbuf_decc_bot,efc_scdata_fuse_clk1,
                        efc_scdata_fuse_clk2,mem_write_disable);
  ...
  assign way_sel_l[11:0] = ~way_sel[11:0];
