...
module syntheses_implementation_interface_in(input  ready_out,
                                             input  [(0-1)+32:0] data_in,
                                             input  [1+(0-1):0] last_in,
                                             input  [1+(0-1):0] reset_in,
                                             input  [8-1:0] set_addr_in,
                                             input  [1+(0-1):0] set_stb_in,
                                             input  [1+(0-1):0] valid_in);

  wire [1+(0-1):0] set_stb_in_net;
  wire [1+(0-1):0] valid_in_net;
  wire [1+(0-1):0] last_in_net;
  wire [1+(0-1):0] reset_in_net;
  wire [8-1:0] set_addr_in_net;
  wire 
      ifft_fast_fourier_transform_8_1_s_axis_data_tready_net;
  wire [(0-1)+32:0] data_in_net;
