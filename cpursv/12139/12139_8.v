...
module syntheses_implementation_interface_in(input  ready_out,
                                             ...
                                             input  [(0-1)+1:0] last_in,
                                             input  [(0-1)+1:0] reset_in,
                                             input  [(0-1)+8:0] set_addr_in,
                                             input  [(0-1)+1:0] set_stb_in,
                                             input  [(0-1)+1:0] valid_in);

  wire [(0-1)+1:0] set_stb_in_net;
  wire [(0-1)+1:0] valid_in_net;
  wire [(0-1)+1:0] last_in_net;
  wire [(0-1)+1:0] reset_in_net;
  wire [(0-1)+8:0] set_addr_in_net;
  wire 
