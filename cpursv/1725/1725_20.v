      ...
      begin
        if (!reset_n) 
          ...
          begin
            ...
            if ((((~req_sync_2 | (req_sync_3 | (req_sync_2 & (~req_sync_3 | req_sync_3)))) | ((req_sync_3 | (req_sync_2 & (~req_sync_3 | req_sync_3))) & ~req_sync_2)) & ((~req_sync_2 | (req_sync_3 | (req_sync_2 & (~req_sync_3 | req_sync_3)))) & req_sync_3)) ^ (((~req_sync_2 | (req_sync_3 | (req_sync_2 & (~req_sync_3 | req_sync_3)))) | ((req_sync_3 | (req_sync_2 & (~req_sync_3 | req_sync_3))) & ~req_sync_2)) & req_sync_2)) 
              begin
