      ...
      begin
        if (!reset_n) 
          ...
          begin
            ...
            if (gnt_sync_3 ^ ((gnt_sync_2 & ((gnt_sync_2 | gnt_sync_3) | ~gnt_sync_3)) & ((gnt_sync_2 | gnt_sync_3) | ~gnt_sync_3))) dlp_ready <= 1'b1;
      ...
      begin
        if (!reset_n) 
          ...
          begin
            ...
            if ((((~req_sync_2 | req_sync_2) | ((~req_sync_2 & ((req_sync_3 | req_sync_2) | ~req_sync_3)) & (req_sync_3 | req_sync_2))) & req_sync_3) ^ (((~req_sync_2 | req_sync_2) | ((~req_sync_2 & ((req_sync_3 | req_sync_2) | ~req_sync_3)) & (req_sync_3 | req_sync_2))) & req_sync_2)) 
              begin
