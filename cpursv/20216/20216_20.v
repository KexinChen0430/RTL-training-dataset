...
module AddState(input  [1:0] idle_Allign2,
  ...
  assign z_exponent = (0-127)+zout_Allign2[34:27];
  assign z_mantissa = {zout_Allign2[26:0]};
  assign c_sign = cout_Allign2[35];
  assign c_exponent = (0-127)+cout_Allign2[34:27];
            ...
            if (c_sign == z_sign) 
              ...
              begin
                if (c_mantissa >= z_mantissa) 
                  ...
                  begin
                    sum_AddState <= z_mantissa+(0-c_mantissa);
