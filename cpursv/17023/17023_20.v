  ...
  always @(i_in or ib_in or DQS_BIAS_BINARY)
      begin
        if ((i_in == 1'b1) && (ib_in == 1'b0)) o_out <= 1'b1;
                 ...
                 ((ib_in == 1'b1) && 
((i_in === 1'bz) || 
((ib_in === 1'bz) || (i_in == 1'b0)))) && (i_in == 1'b0)) o_out <= 1'b0;
        else if (
((ib_in == 1'b1) || 
...
((ib_in == 1'b1) && 
((i_in === 1'bz) || 
((ib_in === 1'bz) || (i_in == 1'b0)))))) && ((ib_in === 1'bz) || (ib_in == 1'b1))) && 
                 (
((ib_in === 1'bz) && 
((ib_in == 1'b1) || ((i_in === 1'bz) || (i_in == 1'b0))) && 
(((i_in === 1'bz) || (ib_in === 1'bz)) && 
((i_in === 1'bz) || (i_in == 1'b0))) && ((i_in === 1'bz) || (ib_in == 1'b1)) && 
(i_in === 1'bz)) || 
((ib_in == 1'b1) && 
((ib_in == 1'b1) && 
((i_in === 1'bz) || 
((ib_in === 1'bz) || (i_in == 1'b0)))) && (i_in == 1'b0)) || 
(((i_in === 1'bz) || (ib_in === 1'bz)) && 
((i_in === 1'bz) || (i_in == 1'b0))))) 
