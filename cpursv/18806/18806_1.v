...
module arduino_switch_analog_bit(input  [1:0] gpio_sel,
                                 input  tri_i_out,
  ...
  always @(gpio_sel or tri_o_in or scl_o_in or sda_o_in)
      case (gpio_sel)
  ...
  always @(gpio_sel or tri_t_in or scl_t_in or sda_t_in)
      case (gpio_sel)
