...
module template_periph_8b(per_dout,mclk,per_addr,per_din,per_en,per_we,puc_rst);
  ...
  wire [DEC_SZ-1:0] 
       reg_dec = ((((({DEC_SZ{reg_addr == CNTRL3>>1}} | ((CNTRL2_D | {DEC_SZ{reg_addr == CNTRL1>>1}}) & (CNTRL1_D | CNTRL2_D))) & ((({DEC_SZ{reg_addr == CNTRL2>>1}} | CNTRL1_D) | {DEC_SZ{reg_addr == CNTRL3>>1}}) & ({DEC_SZ{reg_addr == CNTRL3>>1}} | ({DEC_SZ{reg_addr == CNTRL2>>1}} | {DEC_SZ{reg_addr == CNTRL1>>1}})))) & (((CNTRL1_D | (((CNTRL2_D | {DEC_SZ{reg_addr == CNTRL1>>1}}) & (CNTRL1_D | CNTRL2_D)) & {DEC_SZ{reg_addr == CNTRL2>>1}})) & ((((CNTRL2_D | {DEC_SZ{reg_addr == CNTRL1>>1}}) & (CNTRL1_D | CNTRL2_D)) & {DEC_SZ{reg_addr == CNTRL1>>1}}) | (((CNTRL2_D | {DEC_SZ{reg_addr == CNTRL1>>1}}) & (CNTRL1_D | CNTRL2_D)) & {DEC_SZ{reg_addr == CNTRL2>>1}}))) | (CNTRL4_D | CNTRL3_D))) | CNTRL4_D) & {DEC_SZ{reg_addr == CNTRL4>>1}}) | ((({DEC_SZ{reg_addr == CNTRL1>>1}} & CNTRL1_D) | ({DEC_SZ{reg_addr == CNTRL3>>1}} & CNTRL3_D)) | (((CNTRL2_D | {DEC_SZ{reg_addr == CNTRL1>>1}}) & (CNTRL1_D | CNTRL2_D)) & {DEC_SZ{reg_addr == CNTRL2>>1}}));
  ...
  wire [15:0] 
       per_dout = (cntrl1_rd | cntrl3_rd) | (cntrl4_rd | cntrl2_rd);
