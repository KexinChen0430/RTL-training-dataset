...
module template_periph_8b(per_dout,mclk,per_addr,per_din,per_en,per_we,puc_rst);
  ...
  wire [DEC_SZ-1:0] 
       reg_dec = ((({DEC_SZ{reg_addr == CNTRL3>>1}} & CNTRL3_D) | (CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4>>1}})) | (CNTRL1_D & {DEC_SZ{reg_addr == CNTRL1>>1}})) | (CNTRL2_D & (((CNTRL1_D | {DEC_SZ{reg_addr == CNTRL2>>1}}) & {DEC_SZ{reg_addr == CNTRL1>>1}}) | {DEC_SZ{reg_addr == CNTRL2>>1}}));
  ...
  wire [15:0] 
       cntrl4_rd = {8'h00,{8{reg_rd[CNTRL4]}} & cntrl4}*((1+1)**(8 & {4{CNTRL4[0]}}));
