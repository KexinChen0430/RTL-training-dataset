...
module template_periph_8b(per_dout,mclk,per_addr,per_din,per_en,per_we,puc_rst);
  ...
  wire [(0-1)+DEC_SZ:0] 
       reg_dec = (({DEC_SZ{reg_addr == CNTRL4>>1}} | (({DEC_SZ{reg_addr == CNTRL3>>1}} | (CNTRL2_D & {DEC_SZ{reg_addr == CNTRL2>>1}})) & ((CNTRL3_D | {DEC_SZ{reg_addr == CNTRL2>>1}}) & (CNTRL2_D | CNTRL3_D)))) | ((CNTRL1_D & ((CNTRL2_D | {DEC_SZ{reg_addr == CNTRL1>>1}}) & (CNTRL1_D | CNTRL2_D))) & {DEC_SZ{reg_addr == CNTRL1>>1}})) & ((({DEC_SZ{reg_addr == CNTRL3>>1}} | CNTRL4_D) & (CNTRL3_D | CNTRL4_D)) | (({DEC_SZ{reg_addr == CNTRL2>>1}} | CNTRL1_D) & (({DEC_SZ{reg_addr == CNTRL1>>1}} | {DEC_SZ{reg_addr == CNTRL2>>1}}) & ((((CNTRL1_D | CNTRL2_D) | {DEC_SZ{reg_addr == CNTRL3>>1}}) & ((CNTRL2_D | {DEC_SZ{reg_addr == CNTRL1>>1}}) | {DEC_SZ{reg_addr == CNTRL3>>1}})) & (((CNTRL1_D & ((CNTRL2_D | {DEC_SZ{reg_addr == CNTRL1>>1}}) & (CNTRL1_D | CNTRL2_D))) & {DEC_SZ{reg_addr == CNTRL1>>1}}) | (CNTRL2_D | CNTRL3_D))))));
  ...
  wire [15:0] 
       cntrl2_rd = {8'h00,cntrl2 & {8{reg_rd[CNTRL2]}}}*(1<<1**(8 & {4{CNTRL2[0]}}));

  wire [15:0] 
       cntrl3_rd = {8'h00,{8{reg_rd[CNTRL3]}} & cntrl3}*(1<<1**({4{CNTRL3[0]}} & 8));
