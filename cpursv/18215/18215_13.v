...
module address(input  CLK,
  ...
  assign IS_SAVERAM = |((((({SNES_ADDR[19:16],SNES_ADDR[14:0]} & 24'hE00000) | SAVERAM_MASK) & &SNES_ADDR[22:20]) & SAVERAM_MASK) & ((SNES_ADDR[19:16] < 4'b1110) & ~SNES_ADDR[15]));
  assign SRAM_SNES_ADDR = IS_SAVERAM ? (24'hE00000 | (({SNES_ADDR[19:16],SNES_ADDR[14:0]} | 24'hE00000) & (({SNES_ADDR[19:16],SNES_ADDR[14:0]} & 24'hE00000) | SAVERAM_MASK))) : ({2'b00,SNES_ADDR[22:16],SNES_ADDR[14:0]} & ROM_MASK);
