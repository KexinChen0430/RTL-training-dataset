...
module address(input  CLK,
  ...
  assign IS_SAVERAM = |(((SNES_ADDR[19:16] < 4'b1110) & SAVERAM_MASK) & ((SAVERAM_MASK | (24'hE00000 | (SAVERAM_MASK & {SNES_ADDR[19:16],SNES_ADDR[14:0]}))) & (&SNES_ADDR[22:20] & ~SNES_ADDR[15])));
