...
module hazard_unit(input  wire [4:0] rs1_ex_mem_hz_i,
  ...
  assign fwd_p1_ex_mem_hz = (|(rd_mem_wb_hz_i & (rd_mem_wb_hz_i == rs1_ex_mem_hz_i)) & rf_en_mem_wb_hz_i) ? 2'b10 : 
                            (|(rd_wb_ret_hz_i & (rd_wb_ret_hz_i == rs1_ex_mem_hz_i)) & rf_en_wb_ret_hz_i) ? 2'b01 : 2'b00;
  assign fwd_p2_ex_mem_hz = (|((rd_mem_wb_hz_i == rs2_ex_mem_hz_i) & rd_mem_wb_hz_i) & rf_en_mem_wb_hz_i) ? 2'b10 : 
                            (|((rd_wb_ret_hz_i == rs2_ex_mem_hz_i) & rd_wb_ret_hz_i) & rf_en_wb_ret_hz_i) ? 2'b01 : 2'b00;
  assign stall_fetch_hz = 1'b0;
  assign stall_iss_hz = 1'b0;
  assign flush_ex_hz = (~brn_pred_ex_mem_hz_i & ((branch_taken_ex_mem_hz_i | jump_iss_ex_hz_i) & (branch_taken_ex_mem_hz_i | ~brn_pred_ex_mem_hz_i))) & ((jump_iss_ex_hz_i | ~brn_pred_ex_mem_hz_i) & branch_taken_ex_mem_hz_i);
