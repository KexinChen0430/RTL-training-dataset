...
module MM_slave(input  wire [7:0] avs_s0_address,
  ...
  assign avs_s0_waitrequest = Reg_Status_Write || Reg_Status_Read;
  ...
  always @(posedge clock_clk)
      ...
      else if (!avs_s0_waitrequest && avs_s0_write) 
        begin
          Reg_Status_Write <= 1'b0;
  ...
  always @(posedge clock_clk)
      ...
      else if (!avs_s0_waitrequest && avs_s0_read) 
        begin
          Reg_Status_Read <= 1'b0;
        end
      else 
