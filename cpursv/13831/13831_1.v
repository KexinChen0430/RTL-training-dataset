...
module neo_f0(input  nRESET,
  ...
  assign M68K_DATA = nDIPRD0 ? 8'bzzzzzzzz : 
                     M68K_ADDR[7] ? 8'b11000000 : DIPSW;
  assign M68K_DATA = nDIPRD1 ? 8'bzzzzzzzz : {RTC_DOUT,RTC_TP,1'b1,5'b11111};
  
  always @(nRESET or nBITWD0)
      begin
        if (!nRESET) 
          begin
            SLOTS <= 3'b000;
          ...
          begin
            ...
            case (M68K_ADDR[6:4])
              ...
              3'b010: SLOTS <= M68K_DATA[2:0];

              3'b011: LED_LATCH <= M68K_DATA[5:3];

              3'b100: LED_DATA <= M68K_DATA[7:0];

              3'b101: REG_RTCCTRL <= M68K_DATA[2:0];
