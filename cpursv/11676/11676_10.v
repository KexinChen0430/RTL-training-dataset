...
module DisplayCtrl(Clk,reset,memoryData,An0,An1,An2,An3,Ca,Cb,Cc,Cd,Ce,Cf,Cg,Dp);
  ...
  assign An0 = !(~ssdscan_clk[0] && ~ssdscan_clk[1]);
  assign An1 = !(ssdscan_clk[0] && ~ssdscan_clk[1]);
  assign An2 = !(~ssdscan_clk[0] && ssdscan_clk[1]);
  assign An3 = !(ssdscan_clk[0] && ssdscan_clk[1]);
  
  always @(ssdscan_clk or SSD0 or SSD1 or SSD2 or SSD3)
      begin : SSD_SCAN_OUT
        case (ssdscan_clk)
