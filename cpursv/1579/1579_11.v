...
module axis_rate_limit  #(parameter  DATA_WIDTH = 8)
  ...
  assign output_axis_tready_int_early = output_axis_tready | ((~temp_axis_tvalid_reg & (~output_axis_tvalid_reg | ~output_axis_tvalid_int)) | (~temp_axis_tvalid_reg & output_axis_tready));
