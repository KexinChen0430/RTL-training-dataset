...
module axis_rate_limit  #(parameter  DATA_WIDTH = 8)
  ...
  assign output_axis_tready_int_early = (~temp_axis_tvalid_reg | output_axis_tready) & (((~output_axis_tvalid_reg | (~temp_axis_tvalid_reg & output_axis_tready)) | output_axis_tready) | ((((~temp_axis_tvalid_reg | ((~temp_axis_tvalid_reg | ~output_axis_tvalid_reg) & output_axis_tready)) & ~output_axis_tvalid_int) & ~temp_axis_tvalid_reg) | output_axis_tready));
        ...
        if (rst) 
          ...
          begin
            ...
            if (output_axis_tready_int) 
              begin
                if ((~output_axis_tvalid_reg | (~temp_axis_tvalid_reg & output_axis_tready)) | output_axis_tready) 
                  begin
