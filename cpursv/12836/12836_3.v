...
module receptor_teclado_ps2(input  wire clk,reset,
  ...
  assign f_ps2clk_next = (filter_reg == 8'b11111111) ? 1'b1 : 
                         (filter_reg == 8'b00000000) ? 1'b0 : f_ps2clk_reg;
  assign fall_edge = ~f_ps2clk_next & f_ps2clk_reg;
