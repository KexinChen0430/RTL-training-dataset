...
((operation_alu == 5) && (operator2 == 0))) && (operation_alu == 5)) || 
(
(((operation_alu == 1) || (operation_alu == 4)) && 
((operation_alu == 4) || ((operator1+(-operator2)) < 0))) || 
(((operator1+operator2) > 255) && (operation_alu == 0)) || 
((operation_alu == 5) && ((operator1/operator2) > 255))))) || 
            (
(
((operation_alu == 1) || ((operator1+operator2) > 255)) && ((operator1+(-operator2)) < 0) && 
((operation_alu == 0) || (operation_alu == 1))) || 
(
(((operator1+operator2) > 255) && (operation_alu == 0)) || 
(
((operation_alu == 5) && ((operator1/operator2) > 255)) || 
(((operator1/operator2) < 0) && (operation_alu == 5)) || ((operation_alu == 5) && (operator2 == 0)))))) overflow = 1;
        else 
          begin
            overflow = 0;
          end
