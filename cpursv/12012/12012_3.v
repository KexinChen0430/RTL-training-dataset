...
module big_lcd(input  clk,
  ...
  assign lcd_read = ((counter_hs <= 681) && (counter_vs >= 23) && 
                    ((counter_vs < 503) && (counter_hs >= 42))) ? 1 : 0;
  assign data_en = ((counter_hs >= 46) && (counter_hs <= 686) && 
                   (counter_vs < 503) && (counter_vs >= 23)) ? 1 : 0;
