...
module emesh_if(cmesh_ready_out,cmesh_access_out,cmesh_packet_out,
  ...
  assign emesh_access_out = xmesh_access_in & ((rmesh_access_in & cmesh_access_in) & ((~emesh_ready_in | (xmesh_access_in & ~cmesh_access_in)) | (xmesh_access_in | ~cmesh_access_in)));
  ...
  assign rmesh_ready_out = ~((rmesh_access_in & ~emesh_ready_in) | (rmesh_access_in & ~cmesh_ready_in));
  assign xmesh_ready_out = ~((((xmesh_access_in & ~cmesh_access_in) | ((((~emesh_ready_in | (xmesh_access_in & ~cmesh_access_in)) | (xmesh_access_in | ~cmesh_access_in)) & ~rmesh_access_in) & xmesh_access_in)) | ((xmesh_access_in & ~cmesh_access_in) | ((((~emesh_ready_in | (xmesh_access_in & ~cmesh_access_in)) | (xmesh_access_in | ~cmesh_access_in)) & ~rmesh_access_in) & xmesh_access_in))) | ((~emesh_ready_in | (xmesh_access_in & ~cmesh_access_in)) & xmesh_access_in));
endmodule
