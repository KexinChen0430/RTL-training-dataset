        ...
        if (rst) 
          ...
          begin
            if ((MEMWBregisterRd == rs) && 
                !(EXMEMregWrite && 
((EXMEMregisterRd == rs) && (EXMEMregisterRd != 0))) && ((MEMWBregisterRd != 0) && MEMWBregWrite)) forwardA <= 2'b01;
            else if (EXMEMregWrite && 
                     ((EXMEMregisterRd == rs) && (EXMEMregisterRd != 0))) forwardA <= 2'b10;
            else forwardA <= 0;
            if (MEMWBregWrite && 
                ((MEMWBregisterRd != 0) && 
!(EXMEMregWrite && 
((EXMEMregisterRd != 0) && (EXMEMregisterRd == rt))) && (MEMWBregisterRd == rt))) forwardB <= 2'b01;
            else if (EXMEMregWrite && 
