        ...
        if (rst) 
          ...
          begin
            if ((MEMWBregisterRd != 0) && 
                ((MEMWBregisterRd == rs) && MEMWBregWrite) && 
                !((EXMEMregisterRd != 0) && EXMEMregWrite && 
(EXMEMregisterRd == rs))) forwardA <= 2'b01;
...
EXMEMregWrite) && (MEMWBregisterRd != 0) && MEMWBregWrite) forwardB <= 2'b01;
            else if ((EXMEMregisterRd != 0) && (EXMEMregisterRd == rt) && 
