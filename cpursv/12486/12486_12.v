        ...
        if (rst) 
          ...
          begin
            if ((MEMWBregisterRd != 0) && MEMWBregWrite && 
                (MEMWBregisterRd == rs) && 
                !((EXMEMregisterRd != 0) && 
((EXMEMregisterRd == rs) && EXMEMregWrite))) forwardA <= 2'b01;
            else if ((EXMEMregisterRd != 0) && 
                     ((EXMEMregisterRd == rs) && EXMEMregWrite)) forwardA <= 2'b10;
            else forwardA <= 0;
            if ((MEMWBregisterRd != 0) && 
                (
!((EXMEMregisterRd != 0) && 
((EXMEMregisterRd == rt) && EXMEMregWrite)) && (MEMWBregisterRd == rt)) && MEMWBregWrite) forwardB <= 2'b01;
            else if ((EXMEMregisterRd != 0) && 
