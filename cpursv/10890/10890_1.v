...
module velocityControlHdl_MinMax(in0,in1,in2,out0);
  ...
  assign MinMax_stage1_val[0] = (MinMax_muxout[0] <= MinMax_muxout[1]) ? MinMax_muxout[0] : MinMax_muxout[1];
  assign MinMax_stage1_val[1] = MinMax_muxout[2];
  assign MinMax_stage2_val = (MinMax_stage1_val[0] <= MinMax_stage1_val[1]) ? MinMax_stage1_val[0] : MinMax_stage1_val[1];
