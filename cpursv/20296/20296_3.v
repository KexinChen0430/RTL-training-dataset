...
module t_math_imm2(LogicImm,LowLogicImm,HighLogicImm,LowMaskSel_Top,
                   HighMaskSel_Top,LowMaskSel_Bot,HighMaskSel_Bot);
  ...
  assign LogicImm = HighLogicImm & LowLogicImm;
endmodule
