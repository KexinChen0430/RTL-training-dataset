...
module znmi(input  wire rst_n,
  ...
  assign nmi_start = imm_nmi_now || 
                     (int_start && (imm_nmi_now || pending_nmi));
...
(nmi_start && 
(
((!in_nmi || (rfsh_n_reg[1] && !rfsh_n_reg[0])) && 
(last_m1_0066 || !in_nmi) && !last_m1_rom) || 
(last_m1_0066 && (rfsh_n_reg[1] && !rfsh_n_reg[0]))))) && 
(rfsh_n_reg[1] && (in_nmi_2 && last_m1_0066) && 
!rfsh_n_reg[0])) || 
                   (
(
(last_m1_0066 && (rfsh_n_reg[1] && !rfsh_n_reg[0])) || 
...
(
((!in_nmi && !last_m1_rom) || 
(in_nmi_2 && !rfsh_n_reg[0] && rfsh_n_reg[1])) && 
((last_m1_0066 || !last_m1_rom) && 
(last_m1_0066 || !in_nmi)))))) in_nmi <= 1'b1;
