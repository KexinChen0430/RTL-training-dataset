  ...
  always @(posedge fclk or negedge rst_n)
      if (!rst_n) in_nmi_2 <= 1'b0;
        ...
        begin
          ...
          else if (!rfsh_n_reg[0] && (last_m1_0066 && rfsh_n_reg[1])) in_nmi_2 <= 1'b0;
...
(in_nmi_2 || 
(((nmi_start && !last_m1_rom) || in_nmi_2) && !in_nmi)) && 
                   (!last_m1_rom || 
(!rfsh_n_reg[0] && (last_m1_0066 && rfsh_n_reg[1]))) && 
                   (
((!in_nmi && nmi_start) || 
(last_m1_0066 && rfsh_n_reg[1])) && ((!in_nmi && nmi_start) || !rfsh_n_reg[0]))) in_nmi <= 1'b1;
