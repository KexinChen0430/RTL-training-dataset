...
module znmi(input  wire rst_n,
  ...
  always @(posedge fclk)
      ...
      else if (clr_count[1] && (rfsh_n_reg[1] && !rfsh_n_reg[0])) clr_count <= (0-2'd1)+clr_count;
...
((in_nmi_2 || !last_m1_rom) && (nmi_start || in_nmi_2) && 
!in_nmi)) || 
                   (rfsh_n_reg[1] && in_nmi_2 && 
(last_m1_0066 && !rfsh_n_reg[0])) || 
                   (!in_nmi && 
((!last_m1_rom || last_m1_0066) && 
(last_m1_0066 || (nmi_start && !in_nmi)) && (!last_m1_rom && nmi_start)))) in_nmi <= 1'b1;
