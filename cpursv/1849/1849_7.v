...
module scheduler1_commit_entry  #(parameter  ENTRY_ID = 6'h00)
  (input  wire iCLOCK,
   input  wire inRESET,
   input  wire iLOCK,
  ...
  assign w_regist_pointer1 = 6'h1+iREGIST_POINTER;
...
(
(
(((b_state == 2'h1) || iRESTART_VALID) && 
(b_state == 2'h2)) || (b_state == 2'h3) || (b_state == 2'h2) || iRESTART_VALID) && iRESTART_VALID) || 
                 (
(
(((b_state == 2'h1) || iRESTART_VALID) && 
(b_state == 2'h2)) || (b_state == 2'h3) || (b_state == 2'h2) || iRESTART_VALID) && 
(
((b_state == 2'h1) && 
((b_state == 2'h2) && iRESTART_VALID)) || (b_state == 2'h3)))) 
          begin
            b_state <= 2'h0;
            b_pc <= {32{1'b0}};
            b_make_flags_validl <= 1'b0;
          ...
          begin
            case (b_state)
              ...
              2'h0: begin
                    if (!iLOCK) 
                      begin
                        if ((ENTRY_ID[5:0] == w_regist_pointer0) && 
                            iREGIST_0_VALID) 
                          begin
                            b_state <= 2'h1;
                            b_pc <= iREGIST_PC;
                        ...
                        else if (iREGIST_1_VALID && 
                                 (ENTRY_ID[5:0] == w_regist_pointer1)) 
                          begin
                            b_state <= 2'h1;
                            b_pc <= 32'h4+iREGIST_PC;
              ...
              2'h1: begin
                    if ((iEXEND_ALU0_COMMIT_TAG == ENTRY_ID[5:0]) && 
                        iEXEND_ALU0_VALID) 
                      begin
                        b_state <= 2'h2;
                      end
                    else if (iEXEND_ALU1_VALID && 
                             (iEXEND_ALU1_COMMIT_TAG == ENTRY_ID[5:0])) 
                      begin
                        b_state <= 2'h2;
                      end
                    else if (iEXEND_ALU2_VALID && 
                             (iEXEND_ALU2_COMMIT_TAG == ENTRY_ID[5:0])) 
                      begin
                        b_state <= 2'h2;
                      end
                    else if (iEXEND_ALU3_VALID && 
                             (iEXEND_ALU3_COMMIT_TAG == ENTRY_ID[5:0])) 
                      begin
                        b_state <= 2'h2;
                      end
  ...
  assign oINFO_VALID = ((b_state == 2'h2) || (b_state == 2'h1)) ? 1'b1 : 1'b0;
  ...
  assign oINFO_FREE = (iRESTART_VALID && 
                      (((b_state == 2'h1) && iRESTART_VALID) || 
(b_state == 2'h2))) ? 1'b1 : 1'b0;
endmodule
