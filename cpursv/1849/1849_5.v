...
(iRESTART_VALID || (b_state == 2'h2)) && iRESTART_VALID)) || 
                 (
(iRESTART_VALID && 
((b_state == 2'h1) && (b_state == 2'h2))) || (b_state == 2'h3)) || iRESTART_VALID) 
          begin
            b_state <= 2'h0;
            b_pc <= {32{1'b0}};
            b_make_flags_validl <= 1'b0;
  ...
  assign oINFO_FREE = (((b_state == 2'h1) || (b_state == 2'h2)) && 
                      (iRESTART_VALID || (b_state == 2'h2)) && iRESTART_VALID) ? 1'b1 : 1'b0;
endmodule
