...
(
(
(((b_state == 2'h2) || iRESTART_VALID) && 
((b_state == 2'h2) || (b_state == 2'h1))) || 
(
(((b_state == 2'h2) || iRESTART_VALID) && 
(b_state == 2'h1)) || 
((b_state == 2'h3) || 
((b_state == 2'h1) && 
((b_state == 2'h2) && iRESTART_VALID))) || iRESTART_VALID)) && iRESTART_VALID) || 
                 (
(
(((b_state == 2'h2) || iRESTART_VALID) && 
((b_state == 2'h2) || (b_state == 2'h1))) || 
...
((b_state == 2'h3) || 
((b_state == 2'h1) && 
((b_state == 2'h2) && iRESTART_VALID))) || iRESTART_VALID)) && 
((b_state == 2'h3) || 
((b_state == 2'h1) && 
((b_state == 2'h2) && iRESTART_VALID))))) 
          begin
            ...
            case (b_state)
              ...
              2'h0: begin
                    if (!iLOCK) 
                      begin
                        if (iREGIST_0_VALID && 
                            (ENTRY_ID[5:0] == w_regist_pointer0)) 
                          begin
                            b_state <= 2'h1;
                            b_pc <= iREGIST_PC;
              ...
              2'h1: begin
                    ...
                    else if ((iEXEND_ALU3_COMMIT_TAG == ENTRY_ID[5:0]) && 
                             iEXEND_ALU3_VALID) 
                      begin
                        b_state <= 2'h2;
                      end
  ...
  assign oINFO_FREE = (((b_state == 2'h2) || (b_state == 2'h1)) && 
                      iRESTART_VALID) ? 1'b1 : 1'b0;
endmodule
