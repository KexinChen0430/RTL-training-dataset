...
(b_state == 2'h3))) 
          ...
          begin
            case (b_state)
              ...
              2'h1: begin
                    if (iEXEND_ALU0_VALID && 
                        (iEXEND_ALU0_COMMIT_TAG == ENTRY_ID[5:0])) 
                      begin
                        b_state <= 2'h2;
                      end
                    ...
                    else if ((iEXEND_ALU2_COMMIT_TAG == ENTRY_ID[5:0]) && 
                             iEXEND_ALU2_VALID) 
                      begin
                        b_state <= 2'h2;
                      end
  ...
  assign oINFO_VALID = ((b_state == 2'h2) || 
                       ((b_state == 2'h1) && iRESTART_VALID) || (b_state == 2'h1)) ? 1'b1 : 1'b0;
  ...
  assign oINFO_FREE = (
((b_state == 2'h2) || 
((b_state == 2'h1) && iRESTART_VALID)) && iRESTART_VALID) ? 1'b1 : 1'b0;
endmodule
