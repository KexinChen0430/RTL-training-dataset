  ...
  always @(shift_value)
      begin
        case (shift_value)
          ...
          6'b000010: shift_out = shift_in*(2**2);
          ...
          6'b010011: shift_out = shift_in*(2**19);
          ...
          6'b011111: shift_out = shift_in*(2**31);

          6'b100000: shift_out = shift_in*(2**32);
          ...
          6'b110011: shift_out = shift_in*(2**51);

          6'b110100: shift_out = shift_in*(2**52);
