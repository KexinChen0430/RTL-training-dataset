  ...
  always @(shift_value)
      begin
        case (shift_value)
          ...
          6'b001000: shift_out = (2**8)*shift_in;

          6'b001001: shift_out = shift_in<<9;

          6'b001010: shift_out = (2**10)*shift_in;

          6'b001011: shift_out = shift_in*(2**11);

          6'b001100: shift_out = shift_in<<<12;

          6'b001101: shift_out = shift_in*(2**13);

          6'b001110: shift_out = shift_in*(2**14);

          6'b001111: shift_out = shift_in<<15;

          6'b010000: shift_out = (2**16)*shift_in;

          6'b010001: shift_out = shift_in<<17;

          6'b010010: shift_out = shift_in*(2**18);
          ...
          6'b011010: shift_out = (2**26)*shift_in;

          6'b011011: shift_out = shift_in*(2**27);

          6'b011100: shift_out = shift_in*(2**28);

          6'b011101: shift_out = shift_in<<<29;

          6'b011110: shift_out = (2**30)*shift_in;

          6'b011111: shift_out = (2**31)*shift_in;

          6'b100000: shift_out = (2**32)*shift_in;

          6'b100001: shift_out = shift_in*(2**33);

          6'b100010: shift_out = (2**34)*shift_in;

          6'b100011: shift_out = (2**35)*shift_in;
          ...
          6'b101110: shift_out = shift_in*(2**46);

          6'b101111: shift_out = shift_in<<<47;

          6'b110000: shift_out = (2**48)*shift_in;

          6'b110001: shift_out = shift_in<<<49;

          6'b110010: shift_out = (2**50)*shift_in;

          6'b110011: shift_out = (2**51)*shift_in;
          ...
          6'b111000: shift_out = shift_in*(2**56);
