  ...
  always @(shift_value)
      begin
        case (shift_value)
          ...
          6'b000111: shift_out = shift_in*(2**7);

          6'b001000: shift_out = shift_in<<8;

          6'b001001: shift_out = (2**9)*shift_in;

          6'b001010: shift_out = shift_in*(2**10);

          6'b001011: shift_out = shift_in<<11;

          6'b001100: shift_out = (2**12)*shift_in;

          6'b001101: shift_out = shift_in<<<13;

          6'b001110: shift_out = shift_in*(2**14);

          6'b001111: shift_out = shift_in*(2**15);
          ...
          6'b010101: shift_out = (2**21)*shift_in;

          6'b010110: shift_out = (2**22)*shift_in;

          6'b010111: shift_out = (2**23)*shift_in;

          6'b011000: shift_out = shift_in<<24;

          6'b011001: shift_out = shift_in*(2**25);

          6'b011010: shift_out = shift_in*(2**26);

          6'b011011: shift_out = shift_in<<27;

          6'b011100: shift_out = shift_in<<28;

          6'b011101: shift_out = shift_in*(2**29);
          ...
          6'b100110: shift_out = (2**38)*shift_in;
          ...
          6'b101010: shift_out = shift_in*(2**42);
          ...
          6'b110101: shift_out = shift_in*(2**53);
