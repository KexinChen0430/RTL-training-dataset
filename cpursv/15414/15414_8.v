  ...
  always @(shift_value)
      begin
        case (shift_value)
          ...
          6'b000011: shift_out = (2**3)*shift_in;
          ...
          6'b010000: shift_out = shift_in*(2**16);

          6'b010001: shift_out = shift_in*(2**17);
          ...
          6'b011000: shift_out = (2**24)*shift_in;
          ...
          6'b100001: shift_out = (2**33)*shift_in;

          6'b100010: shift_out = shift_in*(2**34);
          ...
          6'b101001: shift_out = shift_in*(2**41);

          6'b101010: shift_out = shift_in<<42;

          6'b101011: shift_out = shift_in<<<43;

          6'b101100: shift_out = (2**44)*shift_in;

          6'b101101: shift_out = shift_in*(2**45);
