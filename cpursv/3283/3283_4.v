...
module controller(clock,reset,run,wrSize,config_data,validIn,dataIn,busy,arm,
                  send,memoryWrData,memoryRead,memoryWrite,memoryLastWrite);
  ...
  wire [17:0]  counter_inc = 1'b1+counter;
