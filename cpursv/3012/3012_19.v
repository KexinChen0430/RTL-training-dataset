...
(Nvel[1:0] == 1) ? ((1/V50kb)*((1/2)*Fclk)) : ((1/V12_5kb)*((1/2)*Fclk));
  ...
  always @(posedge clk)
      begin
        ...
        if (cur_state == WaitPos) 
          ...
          begin
            tmp_buf <= in1 ? (2*tmp_buf) : 
                      in0 ? (2*tmp_buf) : tmp_buf;
            act_par_bit <= (((~act_par_bit | act_par_bit) & (in1 & (~act_par_bit | act_par_bit))) & (((~act_par_bit & in1) | act_par_bit) | ~in1)) ^ ((((~act_par_bit & in1) | act_par_bit) | ~in1) & act_par_bit);
