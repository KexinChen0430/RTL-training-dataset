...
module AR_RXD_2(input  clk,
  ...
  wire [10:0] 
       AR_Nt = (Nvel[1:0] == 3) ? ((Fclk/1<<<1)/V1Mb) : 
(Nvel[1:0] == 1<<<1) ? ((Fclk/V100kb)/1<<<1) : 
(Nvel[1:0] == 1) ? ((Fclk/1<<<1)/V50kb) : ((Fclk/1<<<1)*(1/V12_5kb));
      ...
      begin
        ...
        if (cur_state == WaitPos) 
          ...
          begin
            ...
            act_par_bit <= (((((act_par_bit & in1) | (~act_par_bit & in1)) & ((act_par_bit | (~act_par_bit & in1)) | ~act_par_bit)) & ((act_par_bit | (~act_par_bit & in1)) | ~act_par_bit)) & ~act_par_bit) | (~((((act_par_bit & in1) | (~act_par_bit & in1)) & ((act_par_bit | (~act_par_bit & in1)) | ~act_par_bit)) & ((act_par_bit | (~act_par_bit & in1)) | ~act_par_bit)) & act_par_bit);
