...
module AR_RXD_2(input  clk,
  ...
  wire [10:0] 
       AR_Nt = (Nvel[1:0] == 3) ? (((1/V1Mb)*Fclk)/(1+1)) : 
(Nvel[1:0] == (1+1)) ? ((1/V100kb)*(Fclk/(1+1))) : 
(Nvel[1:0] == 1) ? ((Fclk/V50kb)/(1+1)) : (Fclk*(1/((1+1)*V12_5kb)));
      ...
      begin
        ...
        if (cur_state == WaitPos) 
          ...
          begin
            ...
            act_par_bit <= (~((act_par_bit | ~act_par_bit) & (act_par_bit & (~in1 | in1))) & ((((act_par_bit | ~act_par_bit) & in1) & (~in1 | in1)) & (act_par_bit | ~act_par_bit))) | (((act_par_bit | ~act_par_bit) & (act_par_bit & (~in1 | in1))) & ~((((act_par_bit | ~act_par_bit) & in1) & (~in1 | in1)) & (act_par_bit | ~act_par_bit)));
