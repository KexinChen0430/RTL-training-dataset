...
(Nvel[1:0] == 1<<<1) ? (((1/V100kb)*Fclk)*(1/1<<<1)) : 
(Nvel[1:0] == 1) ? (((1/1<<<1)*Fclk)/V50kb) : ((Fclk/V12_5kb)*(1/1<<<1));
      ...
      begin
        ...
        if (cur_state == WaitPos) 
          ...
          begin
            ...
            act_par_bit <= (~((act_par_bit | ~act_par_bit) & in1) & ((act_par_bit | ~act_par_bit) & ((in1 | ~in1) & (act_par_bit & (in1 | ~in1))))) | (((act_par_bit | ~act_par_bit) & in1) & ~((act_par_bit | ~act_par_bit) & ((in1 | ~in1) & (act_par_bit & (in1 | ~in1)))));
