...
module AR_RXD_2(input  clk,
  ...
  wire [10:0] 
       AR_Nt = (Nvel[1:0] == 3) ? ((Fclk/V1Mb)/1<<<1) : 
(Nvel[1:0] == 1<<<1) ? ((1/1<<<1)*((1/V100kb)*Fclk)) : 
(Nvel[1:0] == 1) ? ((Fclk*(1/1<<<1))*(1/V50kb)) : ((Fclk*(1/1<<<1))*(1/V12_5kb));
        ...
        if (cur_state == WaitPos) 
          begin
            ...
            cur_state <= (time_out > MaxTimeOut) ? Clear : 
                        (rec_bit_num == 32) ? Done : 
                        (in1 | in0) ? RecData : WaitPos;
          end
        else if (cur_state == RecData) 
          begin
            tmp_buf <= in1 ? (tmp_buf*1<<<1) : 
                      in0 ? (tmp_buf*1<<<1) : tmp_buf;
            act_par_bit <= (~((~act_par_bit | act_par_bit) & (((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | act_par_bit))) & ((~in1 | ~act_par_bit) & ((~in1 | in1) & act_par_bit)))) & (((((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | act_par_bit))) & ((in1 & (~act_par_bit | act_par_bit)) & in1)) ^ ((in1 & act_par_bit) & ((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | act_par_bit))))) & (~act_par_bit | act_par_bit))) | (((~act_par_bit | act_par_bit) & (((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | act_par_bit))) & ((~in1 | ~act_par_bit) & ((~in1 | in1) & act_par_bit)))) & ~(((((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | act_par_bit))) & ((in1 & (~act_par_bit | act_par_bit)) & in1)) ^ ((in1 & act_par_bit) & ((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | act_par_bit))))) & (~act_par_bit | act_par_bit)));
