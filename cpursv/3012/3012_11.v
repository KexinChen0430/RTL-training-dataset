...
(Nvel[1:0] == 1<<1) ? ((Fclk*(1/1<<1))/V100kb) : 
(Nvel[1:0] == 1) ? ((Fclk*(1/1<<1))/V50kb) : ((1/V12_5kb)*(Fclk*(1/1<<1)));
      ...
      begin
        ...
        if (cur_state == WaitPos) 
          ...
          begin
            ...
            act_par_bit <= (((in1 | act_par_bit) | ~in1) & (((in1 | act_par_bit) | ~in1) & (act_par_bit & ((in1 | act_par_bit) | ~in1)))) ^ in1;
