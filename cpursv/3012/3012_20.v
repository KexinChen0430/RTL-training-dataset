...
module AR_RXD_2(input  clk,
  ...
  generate
      for (i = 0; i <= 22; i = i+1)
          begin : data_loop
            assign sr_dat[i] = out_buf[23+(0-i)];
          end
  endgenerate
  ...
  wire [10:0] 
       AR_Nt = (Nvel[1:0] == 3) ? ((Fclk*(1/V1Mb))/1<<<1) : 
(Nvel[1:0] == 1<<<1) ? ((Fclk/V100kb)*(1/1<<<1)) : 
(Nvel[1:0] == 1) ? ((1/1<<<1)*((1/V50kb)*Fclk)) : (Fclk*((1/1<<<1)/V12_5kb));
      ...
      begin
        ...
        if (cur_state == WaitPos) 
          ...
          begin
            ...
            act_par_bit <= ((~act_par_bit | (act_par_bit & ~in1)) & (((act_par_bit & ~in1) | (act_par_bit & ~act_par_bit)) & ((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | (act_par_bit & (in1 | ~in1))))))) ^ ((~act_par_bit | (act_par_bit & ~in1)) & ((~(((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | (act_par_bit & (in1 | ~in1))))) & (((act_par_bit & ~in1) | (act_par_bit & ~act_par_bit)) & in1)) & (((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | (act_par_bit & (in1 | ~in1))))) & (((in1 & (in1 & (~act_par_bit | act_par_bit))) & in1) ^ ((in1 & act_par_bit) & in1)))) | ((((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | (act_par_bit & (in1 | ~in1))))) & (((act_par_bit & ~in1) | (act_par_bit & ~act_par_bit)) & in1)) & ~(((~act_par_bit | act_par_bit) | (~act_par_bit & (in1 | (act_par_bit & (in1 | ~in1))))) & (((in1 & (in1 & (~act_par_bit | act_par_bit))) & in1) ^ ((in1 & act_par_bit) & in1))))));
