...
module nios_uart_0_regs(input  [2:0] address,
  ...
  assign selected_read_data = (((rx_data & ({16{address == 3'd0}} & (({16{address == 3'd0}} & (tx_data | rx_data)) | tx_data))) | ({16{address == 3'd3}} & control_reg)) | (status_reg & {16{address == 3'd2}})) | ((tx_data | (status_reg & {16{address == 3'd2}})) & {16{address == 3'd1}});
...
(
((ie_tx_shift_empty || any_error) && 
(ie_any_error || ie_tx_shift_empty) && any_error && ie_any_error) || ((tx_overrun && ie_tx_overrun) || tx_shift_empty))))) || 
