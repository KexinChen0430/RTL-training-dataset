...
module nios_uart_0_regs(input  [2:0] address,
  ...
  assign selected_read_data = ((status_reg | (rx_data & {16{address == 3'd0}})) & (({16{address == 3'd2}} | {16{address == 3'd0}}) & ({16{address == 3'd2}} | rx_data))) | (((tx_data & {16{address == 3'd1}}) | ((rx_data & {16{address == 3'd0}}) & tx_data)) | (control_reg & {16{address == 3'd3}}));
...
(ie_tx_shift_empty || ie_any_error))) && 
((ie_any_error || tx_shift_empty) && 
(tx_shift_empty || any_error))) && (any_error || ie_tx_shift_empty)) || (tx_overrun && ie_tx_overrun)))))) && 
(ie_framing_error || 
(
((ie_tx_shift_empty || ie_any_error) && 
(
...
((ie_any_error || tx_shift_empty) && 
(tx_shift_empty || any_error))) && (any_error || ie_tx_shift_empty)) || (tx_overrun && ie_tx_overrun) || 
(break_detect && ie_break_detect)) || (ie_rx_overrun && rx_overrun) || parity_error)) || (rx_char_ready && ie_rx_char_ready) || tx_ready) && 
                         (
...
((ie_any_error || tx_shift_empty) && 
(tx_shift_empty || any_error))) && (any_error || ie_tx_shift_empty)) || (tx_overrun && ie_tx_overrun) || 
(break_detect && ie_break_detect)) || (ie_rx_overrun && rx_overrun) || ie_parity_error)) || tx_ready) && 
(
(
(
(parity_error || 
...
((ie_any_error || tx_shift_empty) && 
(tx_shift_empty || any_error))) && (any_error || ie_tx_shift_empty)) || (tx_overrun && ie_tx_overrun) || 
(break_detect && ie_break_detect)) || (ie_rx_overrun && rx_overrun) || parity_error)) || (rx_char_ready && ie_rx_char_ready) || ie_tx_ready) && 
(ie_tx_ready || 
((rx_char_ready && ie_rx_char_ready) || 
(
(ie_parity_error || 
...
((ie_any_error || tx_shift_empty) && 
(tx_shift_empty || any_error))) && (any_error || ie_tx_shift_empty)) || (tx_overrun && ie_tx_overrun) || 
(break_detect && ie_break_detect)) || (ie_rx_overrun && rx_overrun) || ie_parity_error))))));
