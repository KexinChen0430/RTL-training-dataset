...
(rx_overrun || parity_error));
  ...
  assign selected_read_data = ((tx_data & {16{address == 3'd1}}) | ({16{address == 3'd3}} & control_reg)) | ((status_reg & {16{address == 3'd2}}) | (rx_data & {16{address == 3'd0}}));
...
(any_error || (ie_tx_shift_empty && tx_shift_empty)))) && 
((ie_any_error || ie_tx_shift_empty) && 
(ie_tx_shift_empty || any_error)))) || break_detect) && 
(
(tx_overrun && 
(ie_tx_overrun && 
(
...
(any_error || (ie_tx_shift_empty && tx_shift_empty)))) && 
((ie_any_error || ie_tx_shift_empty) && 
(ie_tx_shift_empty || any_error))) || rx_overrun) || break_detect))) && 
(ie_framing_error || 
(ie_break_detect || 
(
(tx_shift_empty && 
...
(any_error || (ie_tx_shift_empty && tx_shift_empty)))) && 
((ie_any_error || ie_tx_shift_empty) && 
(ie_tx_shift_empty || any_error))))))))) && break_detect)) || (parity_error && ie_parity_error) || framing_error)) && 
(
((tx_shift_empty || (any_error && ie_any_error)) && 
(
(ie_tx_overrun || 
...
(any_error || (ie_tx_shift_empty && tx_shift_empty)))) && 
((ie_any_error || ie_tx_shift_empty) && 
(ie_tx_shift_empty || any_error))))))))) && break_detect)) || (parity_error && ie_parity_error) || ie_framing_error || 
...
(any_error || (ie_tx_shift_empty && tx_shift_empty)))) && 
((ie_any_error || ie_tx_shift_empty) && 
(ie_tx_shift_empty || any_error))))))))) && break_detect)) || framing_error) && 
(framing_error || 
(rx_overrun || 
(ie_break_detect && 
(
...
((ie_any_error || ie_tx_shift_empty) && 
(ie_tx_shift_empty || any_error))))))) || (any_error && ie_any_error) || 
(ie_tx_shift_empty && tx_shift_empty))))))) || ie_tx_ready)) || 
                         (
(rx_char_ready || 
(
((tx_shift_empty || (any_error && ie_any_error)) && 
