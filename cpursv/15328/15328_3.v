...
module soc_system_button_pio(address,chipselect,clk,in_port,reset_n,write_n,writedata,
  ...
  assign clk_en = 1;
  assign read_mux_out = (({4{address == 3}} & edge_capture) | ((data_in & ({4{address == 0}} & {4{address == 3}})) | ((edge_capture & data_in) & {4{address == 3}}))) | (({4{address == 0}} & ((data_in | edge_capture) & ({4{address == 3}} | {4{address == 0}}))) & data_in);
