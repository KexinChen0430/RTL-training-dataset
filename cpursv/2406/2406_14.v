...
module axis_rate_limit_64  #(parameter  DATA_WIDTH = 64, KEEP_WIDTH = DATA_WIDTH/8)
  ...
  assign output_axis_tready_int_early = (output_axis_tready | ((~output_axis_tvalid_int | output_axis_tready) & (~temp_axis_tvalid_reg | ((~temp_axis_tvalid_reg | ~output_axis_tvalid_reg) & output_axis_tready)))) | (~output_axis_tvalid_reg & ~temp_axis_tvalid_reg);
