...
module axis_rate_limit_64  #(parameter  DATA_WIDTH = 64, KEEP_WIDTH = DATA_WIDTH*(1/8))
      ...
      begin
        ...
        if (input_axis_tvalid & input_axis_tready) 
          begin
            ...
            acc_next = (rate_denom-rate_num)+acc_reg;
          end
  ...
  assign output_axis_tready_int_early = ((~temp_axis_tvalid_reg | (((((((output_axis_tready | (~output_axis_tvalid_reg | ~output_axis_tvalid_int)) & (~temp_axis_tvalid_reg | ~output_axis_tvalid_int)) & ~temp_axis_tvalid_reg) | (output_axis_tready & ~temp_axis_tvalid_reg)) & ~output_axis_tvalid_reg) | output_axis_tready) & (~temp_axis_tvalid_reg | ~output_axis_tvalid_reg))) | output_axis_tready) & (output_axis_tready | (~output_axis_tvalid_reg | ~output_axis_tvalid_int));
