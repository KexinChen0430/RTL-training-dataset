...
module axis_rate_limit_64  #(parameter  DATA_WIDTH = 64, KEEP_WIDTH = (1/8)*DATA_WIDTH)
  ...
  assign output_axis_tready_int_early = (~temp_axis_tvalid_reg & (((~output_axis_tvalid_int & ~temp_axis_tvalid_reg) | ~output_axis_tvalid_reg) & (~temp_axis_tvalid_reg | ~output_axis_tvalid_reg))) | output_axis_tready;
        ...
        if (rst) 
          ...
          begin
            ...
            if (output_axis_tready_int) 
              begin
                if (((~output_axis_tvalid_reg & ~temp_axis_tvalid_reg) | output_axis_tready) | ~output_axis_tvalid_reg) 
                  begin
