...
module top;
  ...
  begin
    ...
    if (al !== {8{a_res}}) 
      begin
        $display("FAILED: & (large) test, expected %b, got %b",
                 {8{a_res}},al);
        pass = 1'b0;
      end
      
    o = (y & (z | ~z)) | (((~y & (y & (z | ~z))) | (z & ~y)) | z);
    if (o !== o_res) 
      begin
    ...
    xl = (((yl | ((yl | ~yl) & zl)) & (((~yl & (yl | ((yl | ~yl) & zl))) | (yl | ~yl)) & ((yl | ~yl) & zl))) & ~((yl | ((yl | ~yl) & zl)) & (((~yl & (yl | ((yl | ~yl) & zl))) | (yl | ~yl)) & yl))) | (~((yl | ((yl | ~yl) & zl)) & (((~yl & (yl | ((yl | ~yl) & zl))) | (yl | ~yl)) & ((yl | ~yl) & zl))) & ((yl | ((yl | ~yl) & zl)) & (((~yl & (yl | ((yl | ~yl) & zl))) | (yl | ~yl)) & yl)));
    if (xl !== {8{x_res}}) 
      begin
        $display("FAILED: ^ (large) test, expected %b, got %b",
                 {8{x_res}},xl);
