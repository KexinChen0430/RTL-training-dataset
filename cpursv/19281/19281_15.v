...
module top;
  ...
  begin
    ...
    x = ((z & ((y | ~y) | (((~z | z) & ~y) & (((~z | z) & y) | z)))) & ~(((~z | z) & y) & ((y | ~y) | (((~z | z) & ~y) & (((~z | z) & y) | z))))) | (~(z & ((y | ~y) | (((~z | z) & ~y) & (((~z | z) & y) | z)))) & (((~z | z) & y) & ((y | ~y) | (((~z | z) & ~y) & (((~z | z) & y) | z)))));
    if (x !== x_res) 
      begin
    ...
    xl = ((((((zl | ~zl) & ~yl) & (zl | yl)) | (~yl | yl)) & ((~yl | yl) & zl)) & (zl | yl)) ^ ((zl | yl) & (((((zl | ~zl) & ~yl) & (zl | yl)) | (~yl | yl)) & yl));
    if (xl !== {8{x_res}}) 
      begin
        $display("FAILED: ^ (large) test, expected %b, got %b",
                 {8{x_res}},xl);
