...
module lp_fltr(clk,din,dout,ce);
  ...
  reg  [8-1:0] din_tmp_2;
  reg  [8-1:0] din_tmp_3;
  reg  [8+((0-1)+1<<1):0] sum_tmp_1;
  reg  [8+((0-1)+1<<1):0] sum_tmp_2;
  reg  [8+((0-1)+1<<1):0] sum_tmp_3;
  reg  [8+((0-1)+1<<1):0] add_tmp_1;
  reg  [8+((0-1)+1<<1):0] add_tmp_2;
