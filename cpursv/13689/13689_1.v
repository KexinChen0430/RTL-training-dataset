  ...
  always @(*)
      begin
        ...
        case (rep_state)
          ...
          rep_idle: begin
                if ((rep_ctrl_in == 2'b01) && in_rep_rdy && 
                    (rep_flit_in[9:5] == instrep_cmd) && (ic_download_state_in == ic_idle)) 
                  begin
                    ack_rep = 1'b1;
                    v_ic = 1'b1;
                    flit_ic = rep_flit_in;
                ...
                else if ((rep_flit_in[13] == 1'b0) && 
                         ((rep_ctrl_in == 2'b01) && in_rep_rdy && 
  ...
  always @(*)
      begin
        ...
        case (req_state)
          ...
          req_idle: begin
                if ((req_ctrl_in == 2'b01) && 
                    (in_req_rdy && (rep_win == 1'b0))) 
                  begin
