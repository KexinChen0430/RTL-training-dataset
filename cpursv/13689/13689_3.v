  ...
  always @(*)
      begin
        ...
        case (rep_state)
          ...
          rep_idle: begin
                if ((ic_download_state_in == ic_idle) && in_rep_rdy && 
                    ((rep_ctrl_in == 2'b01) && 
(rep_flit_in[9:5] == instrep_cmd))) 
                  begin
                    ...
                    rep_nstate = rep_ic_downloading;
                         ...
                         (in_rep_rdy && (rep_flit_in[13] == 1'b0)) && (rep_ctrl_in == 2'b01)) 
                  begin
                    ack_rep = 1'b1;
                    v_dc_rep = 1'b1;
                    ...
                    rep_win = 1'b1;
                         ...
                         (rep_flit_in[13] == 1'b1) && (in_rep_rdy && (rep_ctrl_in == 2'b01))) 
                  begin
                    ack_rep = 1'b1;
                    v_mem_rep = 1'b1;
  ...
  always @(*)
      begin
        ...
        case (req_state)
          ...
          req_idle: begin
                if (in_req_rdy && 
                    ((rep_win == 1'b0) && (req_ctrl_in == 2'b01))) 
                  begin
