  ...
  always @(*)
      begin
        ...
        case (rep_state)
          ...
          rep_idle: begin
                if ((rep_flit_in[9:5] == instrep_cmd) && 
                    ((ic_download_state_in == ic_idle) && 
(in_rep_rdy && (rep_ctrl_in == 2'b01)))) 
                  begin
                    ack_rep = 1'b1;
                    v_ic = 1'b1;
                    flit_ic = rep_flit_in;
                ...
                else if ((rep_flit_in[13] == 1'b0) && in_rep_rdy && 
...
(rep_ctrl_in == 2'b01))) 
                ...
                else if ((rep_flit_in[13] == 1'b1) && 
                         (in_rep_rdy && (rep_ctrl_in == 2'b01)) && (mem_download_state_in == mem_idle)) 
                  begin
                    ack_rep = 1'b1;
                    v_mem_rep = 1'b1;
  ...
  always @(*)
      begin
        ...
        case (req_state)
          ...
          req_idle: begin
                if ((req_ctrl_in == 2'b01) && (rep_win == 1'b0) && in_req_rdy) 
                  begin
