  ...
  always @(*)
      begin
        ...
        case (rep_state)
          ...
          rep_idle: begin
                if (in_rep_rdy && (rep_flit_in[9:5] == instrep_cmd) && 
...
(rep_ctrl_in == 2'b01))) 
                  begin
                    ...
                    rep_nstate = rep_ic_downloading;
                         ...
                         (dc_download_state_in == dc_idle) && ((rep_ctrl_in == 2'b01) && in_rep_rdy)) 
                  begin
                    ack_rep = 1'b1;
                    v_dc_rep = 1'b1;
                ...
                else if ((rep_ctrl_in == 2'b01) && 
                         (mem_download_state_in == mem_idle) && in_rep_rdy && (rep_flit_in[13] == 1'b1)) 
                  begin
                    ack_rep = 1'b1;
                    v_mem_rep = 1'b1;
