      ...
      begin
        ...
        case (rep_state)
          ...
          rep_idle: begin
                ...
                else if ((dc_download_state_in == dc_idle) && in_rep_rdy && 
                         ((rep_flit_in[13] == 1'b0) && (rep_ctrl_in == 2'b01))) 
                  begin
                    ack_rep = 1'b1;
                    v_dc_rep = 1'b1;
                    ...
                    rep_win = 1'b1;
                         ...
                         (rep_ctrl_in == 2'b01) && (in_rep_rdy && (rep_flit_in[13] == 1'b1))) 
                  begin
                    ack_rep = 1'b1;
                    v_mem_rep = 1'b1;
