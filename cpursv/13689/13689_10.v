  ...
  always @(*)
      begin
        ...
        case (rep_state)
          ...
          rep_idle: begin
                if ((rep_ctrl_in == 2'b01) && 
                    (rep_flit_in[9:5] == instrep_cmd) && (in_rep_rdy && (ic_download_state_in == ic_idle))) 
                  begin
                    ack_rep = 1'b1;
                    v_ic = 1'b1;
                    flit_ic = rep_flit_in;
                ...
                else if ((dc_download_state_in == dc_idle) && 
                         (rep_flit_in[13] == 1'b0) && (in_rep_rdy && (rep_ctrl_in == 2'b01))) 
                  begin
                    ack_rep = 1'b1;
                    v_dc_rep = 1'b1;
                ...
                else if ((rep_ctrl_in == 2'b01) && (rep_flit_in[13] == 1'b1) && 
                         (in_rep_rdy && (mem_download_state_in == mem_idle))) 
                  begin
                    ack_rep = 1'b1;
                    v_mem_rep = 1'b1;
  ...
  always @(*)
      begin
        ...
        case (req_state)
          ...
          req_idle: begin
                if (in_req_rdy && 
                    ((req_ctrl_in == 2'b01) && (rep_win == 1'b0))) 
                  begin
                    if ((dc_download_state_in == dc_idle) && 
                        (req_flit_in[13] == 1'b0)) 
                      begin
                        ack_req = 1'b1;
                        v_dc_req = 1'b1;
                    ...
                    else if ((mem_download_state_in == mem_idle) && 
                             (req_flit_in[13] == 1'b1)) 
                      begin
                        ack_req = 1'b1;
                        v_mem_req = 1'b1;
