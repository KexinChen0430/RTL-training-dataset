...
module template_periph_16b(per_dout,mclk,per_addr,per_din,per_en,per_we,puc_rst);
  ...
  wire 
       reg_sel = (per_addr[13:DEC_WD+(0-1)] == BASE_ADDR[14:DEC_WD]) & per_en;
  wire [DEC_WD+(0-1):0]  reg_addr = {per_addr[DEC_WD+(-2):0],1'b0};
  wire [(0-1)+DEC_SZ:0] 
       reg_dec = ({DEC_SZ{reg_addr == CNTRL2}} & CNTRL2_D) | ((CNTRL3_D & {DEC_SZ{reg_addr == CNTRL3}}) | ((CNTRL1_D & {DEC_SZ{reg_addr == CNTRL1}}) | (CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}})));
