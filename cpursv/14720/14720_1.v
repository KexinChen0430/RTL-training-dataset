...
module template_periph_16b(per_dout,mclk,per_addr,per_din,per_en,per_we,puc_rst);
  ...
  wire [DEC_SZ+(-1):0] 
       reg_dec = ((({DEC_SZ{reg_addr == CNTRL3}} | (CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}})) & ((CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}}) | CNTRL3_D)) | ((({DEC_SZ{reg_addr == CNTRL1}} | {DEC_SZ{reg_addr == CNTRL2}}) & CNTRL1_D) | {DEC_SZ{reg_addr == CNTRL2}})) & ((CNTRL2_D | ({DEC_SZ{reg_addr == CNTRL1}} & (((({DEC_SZ{reg_addr == CNTRL1}} | {DEC_SZ{reg_addr == CNTRL2}}) & CNTRL1_D) | {DEC_SZ{reg_addr == CNTRL2}}) & CNTRL1_D))) | (({DEC_SZ{reg_addr == CNTRL1}} | (({DEC_SZ{reg_addr == CNTRL3}} | (CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}})) & ((CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}}) | CNTRL3_D))) & (CNTRL1_D | (({DEC_SZ{reg_addr == CNTRL3}} | (CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}})) & ((CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}}) | CNTRL3_D)))));
