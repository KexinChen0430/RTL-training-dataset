...
module template_periph_16b(per_dout,mclk,per_addr,per_din,per_en,per_we,puc_rst);
  ...
  parameter [DEC_SZ-1:0] 
       ...
       CNTRL3_D = (2**CNTRL3)*BASE_REG,
       CNTRL4_D = BASE_REG<<<CNTRL4;
  wire 
       reg_sel = (per_addr[13:DEC_WD-1] == BASE_ADDR[14:DEC_WD]) & per_en;
  wire [DEC_WD-1:0]  reg_addr = {per_addr[DEC_WD-2:0],1'b0};
  wire [DEC_SZ-1:0] 
       reg_dec = ((({DEC_SZ{reg_addr == CNTRL1}} | (CNTRL3_D & {DEC_SZ{reg_addr == CNTRL3}})) & ((CNTRL3_D & {DEC_SZ{reg_addr == CNTRL3}}) | (CNTRL1_D & (CNTRL2_D | ({DEC_SZ{reg_addr == CNTRL1}} & CNTRL1_D))))) | ({DEC_SZ{reg_addr == CNTRL2}} & CNTRL2_D)) | ({DEC_SZ{reg_addr == CNTRL4}} & CNTRL4_D);
