...
module template_periph_16b(per_dout,mclk,per_addr,per_din,per_en,per_we,puc_rst);
  ...
  wire [DEC_WD-1:0]  reg_addr = {per_addr[(0-1<<<1)+DEC_WD:0],1'b0};
  wire [DEC_SZ-1:0] 
       reg_dec = (((CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}}) | ({DEC_SZ{reg_addr == CNTRL1}} | ({DEC_SZ{reg_addr == CNTRL3}} & CNTRL3_D))) & ((({DEC_SZ{reg_addr == CNTRL3}} & CNTRL3_D) | CNTRL1_D) | (CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}}))) | ({DEC_SZ{reg_addr == CNTRL2}} & (({DEC_SZ{reg_addr == CNTRL1}} | CNTRL2_D) & (CNTRL2_D | CNTRL1_D)));
