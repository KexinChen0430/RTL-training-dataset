...
module template_periph_16b(per_dout,mclk,per_addr,per_din,per_en,per_we,puc_rst);
  ...
  wire [DEC_SZ+(0-1):0] 
       reg_dec = (((CNTRL1_D & ((CNTRL2_D | {DEC_SZ{reg_addr == CNTRL1}}) & (CNTRL1_D | CNTRL2_D))) | ((CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}}) | (((CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}}) | {DEC_SZ{reg_addr == CNTRL3}}) & CNTRL3_D))) & ({DEC_SZ{reg_addr == CNTRL1}} | ((CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}}) | (((CNTRL4_D & {DEC_SZ{reg_addr == CNTRL4}}) | {DEC_SZ{reg_addr == CNTRL3}}) & CNTRL3_D)))) | ((((CNTRL1_D | CNTRL2_D) & (CNTRL1_D | {DEC_SZ{reg_addr == CNTRL2}})) & CNTRL2_D) & {DEC_SZ{reg_addr == CNTRL2}});
  ...
  wire [15:0] 
       per_dout = cntrl3_rd | (cntrl4_rd | (cntrl2_rd | cntrl1_rd));
