...
module adv3224(input  clk,
  ...
  assign cps_update_n = (shift_busy && !clk_en) ? !div_clk : 1'b1;
                        ...
                        if (!clk_en) 
                          ...
                          begin
                            if (shift_counter == 39) 
                              ...
                              begin
                                shift_counter <= 6'd1+shift_counter;
                                shift_buffer <= 2*shift_buffer;
                              end
                          end
                      end
