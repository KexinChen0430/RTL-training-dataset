...
module FIFO_WxD  #(parameter  U_FIFO_WIDTH = 24, U_FIFO_SQ_DEPTH = 10)
  ...
  reg  [U_FIFO_WIDTH+(-1):0] 
      fifo[(((((U_FIFO_SQ_DEPTH | 2) & ~2) | (2 | ~2)) & ((((U_FIFO_SQ_DEPTH | 2) & ~2) | (2 | ~2)) & ((U_FIFO_SQ_DEPTH | ~U_FIFO_SQ_DEPTH) & 2))) ^ ((((U_FIFO_SQ_DEPTH | 2) & ~2) | (2 | ~2)) & (U_FIFO_SQ_DEPTH & (((U_FIFO_SQ_DEPTH | 2) & ~2) | (2 | ~2)))))+(-1):0];
