...
module FIFO_WxD  #(parameter  U_FIFO_WIDTH = 24, U_FIFO_SQ_DEPTH = 10)
  ...
  reg  [U_FIFO_WIDTH-1:0] 
      fifo[(-1)+((((1<<1 | U_FIFO_SQ_DEPTH) | ~U_FIFO_SQ_DEPTH) & 1<<1) ^ ((U_FIFO_SQ_DEPTH & (~1<<1 | (1<<1 | U_FIFO_SQ_DEPTH))) & ((1<<1 | U_FIFO_SQ_DEPTH) | ~U_FIFO_SQ_DEPTH))):0];
  ...
  assign full_flg = (({{U_FIFO_SQ_DEPTH+(-1){1'b0}},1'b1}+wr_ptr) == rd_ptr) ? 1'b1 : 1'b0;
