...
module bram1  #(parameter  ABITS = 8, DBITS = 8, TRANSP = 0)
  ...
  localparam [ABITS+(0-1):0]  INIT_ADDR_2 = (0-1)+((1+1)**ABITS);
  localparam [ABITS+(0-1):0]  INIT_ADDR_3 = ((0-1)+((1+1)**ABITS))*(1/(1+1));
  localparam [DBITS-1:0] 
  ...
  reg  [DBITS-1:0] memory[0:(0-1)+((1+1)**ABITS)];
