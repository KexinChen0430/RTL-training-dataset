...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = ((StateSFD & (MRxDV & MRxDEqD)) | ByteCntMaxFrame) & (((MRxDV & StateSFD) | (StateData[0] & MRxDV)) & ((StateData[0] & MRxDV) | MRxDEqD));
  assign IncrementByteCounter = ((((StatePreamble | StateIdle) | (StatePreamble | StateSFD)) & ((~ResetByteCounter & MRxDV) & ~Transmitting)) | (StateSFD & (~ResetByteCounter & MRxDV))) | ((((~(DlyCrcEn & |DlyCrcCnt) & (~ResetByteCounter & MRxDV)) & StateData[1]) & ~ByteCntMax) | ((~ResetByteCounter & MRxDV) & StatePreamble));
  ...
  assign ResetIFGCounter = ((MRxDV & StateSFD) | StateDrop) & (StateDrop | MRxDEqD);
  assign IncrementIFGCounter = (((((StatePreamble & ~ResetIFGCounter) & ~IFGCounterEq24) | (((~ResetIFGCounter & StateDrop) | StateIdle) & ~ResetIFGCounter)) & ~IFGCounterEq24) | (StateSFD & ~ResetIFGCounter)) & ~IFGCounterEq24;
