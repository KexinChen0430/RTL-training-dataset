...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = (((StateSFD & MRxDEqD) & MRxDV) | ((StateSFD & MRxDEqD) & MRxDV)) | ((MRxDV & StateData[0]) & ByteCntMaxFrame);
  assign IncrementByteCounter = ((((((StateData[1] & ~ByteCntMax) | StatePreamble) | StateSFD) & (~ResetByteCounter & MRxDV)) | (((StateIdle & ~Transmitting) & ~ResetByteCounter) & MRxDV)) & (~(|DlyCrcCnt & DlyCrcEn) | (StateSFD | StatePreamble))) | ((((((StateData[1] & ~ByteCntMax) | StatePreamble) | StateSFD) & (~ResetByteCounter & MRxDV)) | (((StateIdle & ~Transmitting) & ~ResetByteCounter) & MRxDV)) & ((~Transmitting & (StateIdle | StateSFD)) | (~Transmitting & StatePreamble)));
      ...
      begin
        if (Reset) ByteCnt[15:0] <= 16'd0;
          ...
          begin
            ...
            else if (IncrementByteCounter) ByteCnt[15:0] <= ByteCnt[15:0]+16'd1;
  ...
  assign ByteCntMaxFrame = ByteCnt == (~HugEn & MaxFL[15:0]);
  assign ResetIFGCounter = ((StateDrop | StateDrop) | (MRxDV & StateSFD)) & ((StateDrop | StateDrop) | MRxDEqD);
  assign IncrementIFGCounter = ~ResetIFGCounter & (((StateSFD & ~IFGCounterEq24) & ~ResetIFGCounter) | ((~IFGCounterEq24 & (StateIdle | StatePreamble)) | (~IFGCounterEq24 & StateDrop)));
