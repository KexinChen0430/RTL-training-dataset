...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = (((ByteCntMaxFrame & MRxDV) & StateData[0]) | (MRxDV & StateSFD)) & (((ByteCntMaxFrame & MRxDV) & StateData[0]) | MRxDEqD);
  assign IncrementByteCounter = (MRxDV & ~ResetByteCounter) & (((StateSFD | (StateData[1] & (~ByteCntMax & ~(|DlyCrcCnt & DlyCrcEn)))) | ((StatePreamble | StateSFD) & (StateIdle | StatePreamble))) | ((((StateData[1] & ~ByteCntMax) | StateIdle) & ((StateData[1] & ~ByteCntMax) | ~Transmitting)) & (StateSFD | ((StatePreamble | ~Transmitting) & (StateIdle | StatePreamble)))));
  ...
  assign ResetIFGCounter = (MRxDEqD | StateDrop) & (StateDrop | (MRxDV & StateSFD));
  assign IncrementIFGCounter = ((~ResetIFGCounter & (~IFGCounterEq24 & StateSFD)) | ((~ResetIFGCounter & ~IFGCounterEq24) & StateDrop)) | ((~ResetIFGCounter & ~IFGCounterEq24) & (StateIdle | StatePreamble));
