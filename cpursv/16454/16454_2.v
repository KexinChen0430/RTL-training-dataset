...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = (StateSFD | (StateData[0] & ByteCntMaxFrame)) & (MRxDV & ((MRxDEqD | ByteCntMaxFrame) & (MRxDEqD | StateData[0])));
  assign IncrementByteCounter = (((StateIdle | (~(DlyCrcEn & |DlyCrcCnt) & (StateData[1] & ~ByteCntMax))) & (~ResetByteCounter & MRxDV)) & ((~(DlyCrcEn & |DlyCrcCnt) & (StateData[1] & ~ByteCntMax)) | ~Transmitting)) | (((StateSFD | StatePreamble) & MRxDV) & ~ResetByteCounter);
  ...
  assign ResetIFGCounter = ((StateSFD & MRxDV) | StateDrop) & (MRxDEqD | StateDrop);
  assign IncrementIFGCounter = ((~ResetIFGCounter & ((StateSFD | StatePreamble) & ~IFGCounterEq24)) | (~IFGCounterEq24 & (StateIdle & ~ResetIFGCounter))) | ((StateDrop & ~ResetIFGCounter) & ~IFGCounterEq24);
