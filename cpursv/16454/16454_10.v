...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = (((StateData[0] & ByteCntMaxFrame) | (ByteCntMaxFrame & (StateSFD & MRxDEqD))) & MRxDV) | ((StateSFD & MRxDEqD) & MRxDV);
  assign IncrementByteCounter = ((((~(|DlyCrcCnt & DlyCrcEn) & MRxDV) & ~ResetByteCounter) & (~ByteCntMax & StateData[1])) | (~ResetByteCounter & (MRxDV & (StateSFD | StatePreamble)))) | ((MRxDV & ~ResetByteCounter) & (StateIdle & ((StatePreamble | ~Transmitting) | StateSFD)));
  ...
  assign ResetIFGCounter = (((StateDrop | MRxDV) & StateSFD) | StateDrop) & (MRxDEqD | StateDrop);
  assign IncrementIFGCounter = (((StateDrop & ~IFGCounterEq24) | (StateIdle & ~IFGCounterEq24)) & ~ResetIFGCounter) | ((~IFGCounterEq24 & ~ResetIFGCounter) & (StateSFD | StatePreamble));
