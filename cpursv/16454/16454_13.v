...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = ((MRxDEqD | ((StateData[0] & MRxDV) & ByteCntMaxFrame)) & MRxDV) & ((StateData[0] | StateSFD) & (StateSFD | ByteCntMaxFrame));
  assign IncrementByteCounter = (((~ResetByteCounter & (~Transmitting & StateIdle)) & MRxDV) | ((MRxDV & ~ResetByteCounter) & StatePreamble)) | ((((StateData[1] & ~(|DlyCrcCnt & DlyCrcEn)) & ~ByteCntMax) | StateSFD) & (MRxDV & ~ResetByteCounter));
  ...
  assign ResetIFGCounter = (StateDrop | (MRxDV & (StateSFD | StateDrop))) & ((StateDrop | StateDrop) | MRxDEqD);
  assign IncrementIFGCounter = (((~IFGCounterEq24 & (StateSFD & ~ResetIFGCounter)) | ((~ResetIFGCounter & StateDrop) & ~IFGCounterEq24)) | (~IFGCounterEq24 & (StateIdle & ~ResetIFGCounter))) | ((~IFGCounterEq24 & ~ResetIFGCounter) & StatePreamble);
