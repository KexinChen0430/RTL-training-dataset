...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = (MRxDV & (StateSFD & (((ByteCntMaxFrame & StateData[0]) | (ByteCntMaxFrame & StateData[0])) | MRxDEqD))) | ((MRxDV & StateData[0]) & ByteCntMaxFrame);
  assign IncrementByteCounter = ((MRxDV & ~ResetByteCounter) & (((~ByteCntMax | ((StateIdle | StateSFD) & (StatePreamble | StateSFD))) | StatePreamble) & (((StateData[1] & ~(DlyCrcEn & |DlyCrcCnt)) | StateSFD) | ((StatePreamble | StateSFD) & (StatePreamble | StateIdle))))) | (StateIdle & (~Transmitting & (MRxDV & ~ResetByteCounter)));
  ...
  assign ResetIFGCounter = StateDrop | (StateSFD & (((StateDrop | (MRxDV & ~ResetByteCounter)) | MRxDV) & ((StateDrop | StateDrop) | MRxDEqD)));
  assign IncrementIFGCounter = (((StateIdle | StateDrop) | ((~ResetIFGCounter & ~IFGCounterEq24) & StateSFD)) | (~IFGCounterEq24 & (StatePreamble & ~ResetIFGCounter))) & (~ResetIFGCounter & ~IFGCounterEq24);
