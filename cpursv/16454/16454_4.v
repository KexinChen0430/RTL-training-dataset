...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = (MRxDV & (((StateData[0] & ByteCntMaxFrame) & MRxDV) | StateSFD)) & ((ByteCntMaxFrame | MRxDEqD) & (MRxDEqD | StateData[0]));
  assign IncrementByteCounter = ((MRxDV & ~ResetByteCounter) & ((StateData[1] & (~(DlyCrcEn & |DlyCrcCnt) & ~ByteCntMax)) | (StatePreamble | StateSFD))) | (~Transmitting & (((MRxDV & ~ResetByteCounter) & StatePreamble) | (((MRxDV & ~ResetByteCounter) & StateSFD) | (StateIdle & (MRxDV & ~ResetByteCounter)))));
  ...
  assign ResetIFGCounter = ((StateDrop | MRxDEqD) & (StateDrop | MRxDV)) & (StateDrop | StateSFD);
  assign IncrementIFGCounter = (((StateIdle | StateDrop) & ~IFGCounterEq24) & ~ResetIFGCounter) | (((StatePreamble & ~IFGCounterEq24) & ~ResetIFGCounter) | (~ResetIFGCounter & (StateSFD & ~IFGCounterEq24)));
