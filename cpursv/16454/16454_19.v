...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = ((((StateSFD & MRxDEqD) | StateData[0]) & MRxDV) & (StateSFD | ByteCntMaxFrame)) & (MRxDEqD | ByteCntMaxFrame);
  assign IncrementByteCounter = ((((~Transmitting | ~(DlyCrcEn & |DlyCrcCnt)) & (~(DlyCrcEn & |DlyCrcCnt) | StateIdle)) & (MRxDV & ~ResetByteCounter)) | ((((~ResetByteCounter & (((StatePreamble | StateSFD) | StateSFD) | (StatePreamble | StateIdle))) & MRxDV) & StateSFD) | (((~ResetByteCounter & (((StatePreamble | StateSFD) | StateSFD) | (StatePreamble | StateIdle))) & MRxDV) & StatePreamble))) & (((StateData[1] & ~ByteCntMax) | ((((~Transmitting & (MRxDV & ~ResetByteCounter)) | ((MRxDV & ~ResetByteCounter) & StatePreamble)) | (StateSFD & (MRxDV & ~ResetByteCounter))) & (StatePreamble | StateSFD))) | (StateIdle & (((~Transmitting & (MRxDV & ~ResetByteCounter)) | ((MRxDV & ~ResetByteCounter) & StatePreamble)) | (StateSFD & (MRxDV & ~ResetByteCounter)))));
  ...
  assign ResetIFGCounter = (((StateDrop | ((MRxDV & (~Transmitting & StateIdle)) & ~ResetByteCounter)) | MRxDV) & (StateDrop | MRxDEqD)) & (StateSFD | StateDrop);
  assign IncrementIFGCounter = ((~ResetIFGCounter & (StatePreamble & ~IFGCounterEq24)) | ((~ResetIFGCounter & ~IFGCounterEq24) & StateDrop)) | ((StateSFD | StateIdle) & (~ResetIFGCounter & ~IFGCounterEq24));
      ...
      begin
        if (Reset) IFGCounter[4:0] <= 5'h0;
          ...
          begin
            ...
            else if (IncrementIFGCounter) IFGCounter[4:0] <= IFGCounter[4:0]+5'd1;
              
          end
      end
  assign IFGCounterEq24 = r_IFG | (IFGCounter[4:0] == 5'h18);
