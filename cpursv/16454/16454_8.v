...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = MRxDV & (((StateSFD & MRxDV) & (MRxDEqD & MRxDV)) | ((StateData[0] | (MRxDEqD & StateSFD)) & ByteCntMaxFrame));
  assign IncrementByteCounter = ((StateSFD & (~ResetByteCounter & MRxDV)) | (((~Transmitting & StateIdle) & MRxDV) & ~ResetByteCounter)) | ((~ResetByteCounter & MRxDV) & (StatePreamble | ((~(|DlyCrcCnt & DlyCrcEn) & ~ByteCntMax) & StateData[1])));
  ...
  assign ResetIFGCounter = StateDrop | ((StateSFD & MRxDV) & (MRxDEqD & MRxDV));
  assign IncrementIFGCounter = ((((~ResetIFGCounter & StateSFD) & ~IFGCounterEq24) | ((~ResetIFGCounter & StatePreamble) & ~IFGCounterEq24)) | (StateDrop | StateIdle)) & (~ResetIFGCounter & ~IFGCounterEq24);
