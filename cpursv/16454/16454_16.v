...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = ((MRxDEqD & StateSFD) & MRxDV) | (MRxDV & (ByteCntMaxFrame & (StateData[0] | (MRxDEqD & StateSFD))));
  assign IncrementByteCounter = (((MRxDV & ~ResetByteCounter) & StatePreamble) | ((StateSFD & (MRxDV & ~ResetByteCounter)) | (((StateData[1] & (~(|DlyCrcCnt & DlyCrcEn) & ~ByteCntMax)) & ~ResetByteCounter) & MRxDV))) | (((((StateIdle | StatePreamble) | StateSFD) & ~ResetByteCounter) & MRxDV) & ~Transmitting);
  ...
  assign ResetIFGCounter = (StateDrop | (StateSFD & ((StateDrop | (MRxDV & ~ResetByteCounter)) | MRxDV))) & (MRxDEqD | StateDrop);
  assign IncrementIFGCounter = (~ResetIFGCounter & ~IFGCounterEq24) & (StateSFD | ((~ResetIFGCounter & (~IFGCounterEq24 & (StateDrop | StateIdle))) | (~IFGCounterEq24 & (StatePreamble & ~ResetIFGCounter))));
