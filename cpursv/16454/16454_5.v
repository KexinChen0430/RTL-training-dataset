...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = MRxDV & ((((MRxDEqD | StateData[0]) & ByteCntMaxFrame) & (StateData[0] | StateSFD)) | (MRxDEqD & StateSFD));
  assign IncrementByteCounter = (((StatePreamble & (~ResetByteCounter & MRxDV)) | ((~ResetByteCounter & MRxDV) & ((~ByteCntMax & StateData[1]) & ~(DlyCrcEn & |DlyCrcCnt)))) | (StateSFD & (~ResetByteCounter & MRxDV))) | ((~Transmitting & (~ResetByteCounter & MRxDV)) & StateIdle);
  ...
  assign ResetIFGCounter = (StateSFD | StateDrop) & ((MRxDEqD | StateDrop) & (StateDrop | MRxDV));
  assign IncrementIFGCounter = ~ResetIFGCounter & (((StateSFD | (~ResetIFGCounter & (StateIdle | StatePreamble))) | (StateDrop & ~ResetIFGCounter)) & ~IFGCounterEq24);
