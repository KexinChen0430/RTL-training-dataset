...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = (((MRxDEqD & StateSFD) & MRxDV) | StateData[0]) & ((ByteCntMaxFrame | (MRxDEqD & StateSFD)) & MRxDV);
  assign IncrementByteCounter = (((StateSFD | StatePreamble) & MRxDV) & ~ResetByteCounter) | ((MRxDV & (~ResetByteCounter & (~ByteCntMax & (~(|DlyCrcCnt & DlyCrcEn) & StateData[1])))) | (((StateSFD | StatePreamble) | StateIdle) & (~Transmitting & (~ResetByteCounter & MRxDV))));
  ...
  assign ResetIFGCounter = (StateDrop | MRxDEqD) & ((StateDrop | StateDrop) | ((StateDrop | StateSFD) & MRxDV));
  assign IncrementIFGCounter = ((StatePreamble & ~IFGCounterEq24) & ~ResetIFGCounter) | (((~ResetIFGCounter & (~IFGCounterEq24 & StateSFD)) | ((~ResetIFGCounter & StateDrop) & ~IFGCounterEq24)) | ((StateIdle & ~ResetIFGCounter) & ~IFGCounterEq24));
