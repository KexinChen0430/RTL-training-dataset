...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = (((StateSFD & MRxDV) & MRxDEqD) | ((StateSFD & MRxDV) & MRxDEqD)) | ((StateData[0] & MRxDV) & ByteCntMaxFrame);
  assign IncrementByteCounter = ((((~(|DlyCrcCnt & DlyCrcEn) & StateSFD) | ((((StateData[1] & ~ByteCntMax) | (StateIdle & ~Transmitting)) | StatePreamble) & ~(|DlyCrcCnt & DlyCrcEn))) & (~ResetByteCounter & MRxDV)) | (MRxDV & ((StateSFD | StatePreamble) & ~ResetByteCounter))) | ((StateIdle & ~Transmitting) & (~ResetByteCounter & MRxDV));
  ...
  assign IncrementIFGCounter = ~ResetIFGCounter & (~IFGCounterEq24 & ((StateIdle | ((StateDrop | StateSFD) | StatePreamble)) & (((StateSFD | (~ResetIFGCounter & StateIdle)) | (StateDrop & ~ResetIFGCounter)) | ~ResetIFGCounter)));
