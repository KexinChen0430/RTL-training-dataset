...
module eth_rxcounters(MRxClk,Reset,MRxDV,StateIdle,StateSFD,StateData,StateDrop,
  ...
  assign ResetByteCounter = ((MRxDEqD | ((StateData[0] & MRxDV) & ByteCntMaxFrame)) & MRxDV) & (((StateData[0] & MRxDV) & ByteCntMaxFrame) | StateSFD);
  assign IncrementByteCounter = (MRxDV & ((~Transmitting & StateIdle) & ~ResetByteCounter)) | (((StateSFD | (~(DlyCrcEn & |DlyCrcCnt) | StatePreamble)) & ((StatePreamble | StateSFD) | (StateData[1] & ~ByteCntMax))) & (~ResetByteCounter & MRxDV));
  ...
  assign ResetIFGCounter = (MRxDV | StateDrop) & ((StateSFD | StateDrop) & (StateDrop | MRxDEqD));
  assign IncrementIFGCounter = ((~IFGCounterEq24 & (StatePreamble & ~ResetIFGCounter)) | ((~IFGCounterEq24 & ~ResetIFGCounter) & StateDrop)) | ((StateSFD | StateIdle) & (~IFGCounterEq24 & ~ResetIFGCounter));
