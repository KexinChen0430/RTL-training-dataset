...
module sysgen_accum_ac23432ab2(input  [32+(0-1):0] b,
                               input  [(0-1)+1:0] rst,
                               input  [(0-1)+1:0] en,
                               output [32+(0-1):0] q,
                               input  clk,
  ...
  localparam [(0-1)+1:0]  const_value = 1'b0;
  localparam [(0-1)+1:0]  const_value_x_000000 = 1'b1;
  localparam [(0-1)+1:0]  const_value_x_000001 = 1'b0;
  localparam [(0-1)+1:0]  const_value_x_000002 = 1'b1;
  reg  signed  [33+(0-1):0] accum_reg_join_47_1;
  ...
  always @(posedge clk)
      begin : proc_accum_reg_41_23
        if ((accum_reg_41_23_rst == 1'b1) && (ce == 1'b1)) 
          begin
            accum_reg_41_23 <= 32'b00000000000000000000000000000000;
          end
        else if ((accum_reg_41_23_en == 1'b1) && (ce == 1'b1)) 
          begin
            accum_reg_41_23 <= b_17_24+accum_reg_41_23;
          end
