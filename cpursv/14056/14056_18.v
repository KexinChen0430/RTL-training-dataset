...
module sysgen_accum_ac23432ab2(input  [32-1:0] b,
                               input  [1+(0-1):0] rst,
                               input  [1+(0-1):0] en,
                               output [32-1:0] q,
                               input  clk,
  ...
  localparam [1+(0-1):0]  const_value = 1'b0;
  localparam [1+(0-1):0]  const_value_x_000000 = 1'b1;
  localparam [1+(0-1):0]  const_value_x_000001 = 1'b0;
  localparam [1+(0-1):0]  const_value_x_000002 = 1'b1;
