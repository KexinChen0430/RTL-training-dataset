...
module video_sys_Chroma_Resampler(clk,reset,stream_in_data,stream_in_startofpacket,
  ...
  always @(posedge clk)
      begin
        ...
        else if ((valid & (stream_in_valid | transfer_data)) & transfer_data) saved_CrCb <= data[15:8];
  ...
  assign transfer_data = ((stream_out_ready & stream_out_valid) | (~stream_out_valid & stream_out_valid)) | ~stream_out_valid;
