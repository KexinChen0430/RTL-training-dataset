...
module tmu2_serialize  #(parameter  fml_depth = 26)
  (input  sys_clk,
   ...
   input  [fml_depth+((0-5)+(-1)):0] tadra,
   input  [fml_depth+((0-5)+(-1)):0] tadrb,
   input  [fml_depth+((0-5)+(-1)):0] tadrc,
   input  [fml_depth+((0-5)+(-1)):0] tadrd,
   input  miss_a,
   input  miss_b,
   input  miss_c,
   input  miss_d,
   ...
   input  pipe_ack_i,
   output reg [fml_depth+((0-5)+(-1)):0] adr);

  reg  load_en;
  reg  [fml_depth+((0-5)+(-1)):0] r_tadra;
  reg  [fml_depth+((0-5)+(-1)):0] r_tadrb;
  reg  [fml_depth+((0-5)+(-1)):0] r_tadrc;
  reg  [fml_depth+((0-5)+(-1)):0] r_tadrd;
  reg  r_miss_a;
  reg  r_miss_b;
  reg  r_miss_c;
  reg  r_miss_d;
