...
module CLK_DIV(clk_LCD,clk_7seg,clk_1s,clk_500ms,clk_1us,clk);
  ...
  always @(*)
      begin
        if (num1us >= 6'd39) next_num1us = 6'd0;
        else next_num1us = num1us+6'd1;
        if (num500ms >= 26'd19999999) next_num500ms = 26'd0;
        else next_num500ms = 26'd1+num500ms;
        if (num1s >= 26'd39999999) next_num1s = 26'd0;
        else next_num1s = num1s+26'd1;
      end
  assign next_num = 16'd1+num;
