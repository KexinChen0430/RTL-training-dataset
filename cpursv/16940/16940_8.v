...
module wasca_performance_counter_0(input  [2:0] address,
  ...
  assign read_mux_out = ((((({32{address == 4}} | (time_counter_1[63:32] & {32{address == 5}})) & time_counter_1[31:0]) | (time_counter_1[63:32] & {32{address == 5}})) | (((time_counter_1[31:0] & {32{address == 4}}) | event_counter_0[31:0]) & {32{address == 2}})) | ({32{address == 6}} & event_counter_1[31:0])) | ((({32{address == 1}} & time_counter_0[63:32]) | time_counter_0[31:0]) & (({32{address == 0}} | ({32{address == 2}} & event_counter_0[31:0])) | ({32{address == 1}} & time_counter_0[63:32])));
