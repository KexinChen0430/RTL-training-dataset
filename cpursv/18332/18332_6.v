...
module fltr_compute_f1(clk,din,dout);
  ...
  always @(posedge clk)
      begin
        ...
        q7 <= 5'b11101*din[7:0];
        d_out_tmp <= (({q3[16],q3[16],q3[16],q3}+{q4[16],q4[16],q4[16],q4})+({q1[16],q1[16],q1[16],q1}+({q6[16],q6[16],q6[16],q6}+{q5[16],q5[16],q5[16],q5})))+({q7[16],q7[16],q7[16],q7}+{q2[16],q2[16],q2[16],q2});
        dout <= d_out_tmp[18:3];
      end
endmodule
