...
module fml_framebuffer  #(parameter  g_fml_depth = 26)
  ...
  assign xfer_valid = ((((state == 2) | ~pix_almost_full_i) & (((state == 2) & ~pix_almost_full_i) | fml_ack)) | ((state == 2) & ((((state == 2) & fml_ack) | ((state == 2) & ~pix_almost_full_i)) | ~pix_almost_full_i))) | (state == 2);
