...
module axi_write_controller  #(parameter 
  ...
  (input  m_axi_aclk,
   ...
   output [(0-1)+(M_AXI_TDATA_WIDTH*(1/8)):0] m_axi_wstrb,
   output m_axi_wvalid,
   input  m_axi_wready,
  ...
  always @(mem_req_bar_hit_r or mem_req_pcie_address_r)
      case (mem_req_bar_hit_r)
        ...
        3'b000: m_axi_addr_c <= {BAR0AXI[(0-1)+M_AXI_ADDR_WIDTH:BAR0SIZE],mem_req_pcie_address_r[BAR0SIZE+(0-1):2],2'b00};

        3'b001: m_axi_addr_c <= {BAR1AXI[(0-1)+M_AXI_ADDR_WIDTH:BAR1SIZE],mem_req_pcie_address_r[BAR1SIZE+(0-1):2],2'b00};

        3'b010: m_axi_addr_c <= {BAR2AXI[(0-1)+M_AXI_ADDR_WIDTH:BAR2SIZE],mem_req_pcie_address_r[BAR2SIZE-1:2],2'b00};

        3'b011: m_axi_addr_c <= {BAR3AXI[(0-1)+M_AXI_ADDR_WIDTH:BAR3SIZE],mem_req_pcie_address_r[BAR3SIZE+(0-1):2],2'b00};

        3'b100: m_axi_addr_c <= {BAR4AXI[(0-1)+M_AXI_ADDR_WIDTH:BAR4SIZE],mem_req_pcie_address_r[(0-1)+BAR4SIZE:2],2'b00};

        3'b101: m_axi_addr_c <= {BAR5AXI[(0-1)+M_AXI_ADDR_WIDTH:BAR5SIZE],mem_req_pcie_address_r[(0-1)+BAR5SIZE:2],2'b00};
