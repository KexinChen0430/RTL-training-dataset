  ...
  always @(posedge enable)
      begin
        case (control)
          ...
          2'b00010: o = ((~a1 & a2) | (a2 & a1)) | a1;

          2'b00011: o = a2 & a1;

          2'b00100: o = (((a2 & ((a1 & (~a2 | a2)) & (~a2 | ((~a1 & (a1 & (~a2 | a2))) | (~a1 & a2))))) | (~a1 & a2)) & ~((~(a2 & a1) & (a1 & (a1 & (~a2 | a2)))) | (~(a1 & (a1 & (~a2 | a2))) & (a2 & a1)))) | (~((a2 & ((a1 & (~a2 | a2)) & (~a2 | ((~a1 & (a1 & (~a2 | a2))) | (~a1 & a2))))) | (~a1 & a2)) & ((~(a2 & a1) & (a1 & (a1 & (~a2 | a2)))) | (~(a1 & (a1 & (~a2 | a2))) & (a2 & a1))));
