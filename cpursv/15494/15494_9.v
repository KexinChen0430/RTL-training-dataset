...
module NIOS_Sys_key(address,chipselect,clk,in_port,reset_n,write_n,writedata,irq,
  ...
  assign clk_en = 1;
  assign read_mux_out = ((((irq_mask & {2{address == 2}}) & edge_capture) | (((data_in & {2{address == 0}}) | ({2{address == 3}} | ((data_in & {2{address == 0}}) & {2{address == 2}}))) & edge_capture)) | (irq_mask & {2{address == 2}})) | (data_in & {2{address == 0}});
