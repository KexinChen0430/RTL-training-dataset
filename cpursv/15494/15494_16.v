...
module NIOS_Sys_key(address,chipselect,clk,in_port,reset_n,write_n,writedata,irq,
  ...
  assign clk_en = 1;
  assign read_mux_out = ((irq_mask & ({2{address == 2}} & ((data_in | irq_mask) & (data_in | {2{address == 2}})))) | (irq_mask & ({2{address == 0}} & data_in))) | (({2{address == 0}} & data_in) | (edge_capture & {2{address == 3}}));
