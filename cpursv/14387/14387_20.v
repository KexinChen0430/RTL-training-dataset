...
module limbus_uart_regs(input  [2:0] address,
  ...
  assign selected_read_data = ((control_reg & {16{address == 3'd3}}) | (status_reg & ((control_reg & {16{address == 3'd3}}) | {16{address == 3'd2}}))) | ((tx_data | (({16{address == 3'd0}} | tx_data) & rx_data)) & (({16{address == 3'd1}} | (({16{address == 3'd1}} | rx_data) & {16{address == 3'd0}})) | (control_reg & {16{address == 3'd3}})));
...
(
((any_error || ie_tx_shift_empty) && 
(ie_any_error || ie_tx_shift_empty)) || ie_tx_overrun)) || (rx_overrun && ie_rx_overrun) || break_detect) && 
(break_detect || 
(tx_overrun || 
(
((any_error || ie_tx_shift_empty) && 
(ie_any_error || ie_tx_shift_empty) && ie_any_error && any_error) || (rx_overrun && ie_rx_overrun) || 
(tx_shift_empty && ie_tx_shift_empty))))) || ie_framing_error) && 
(
(framing_error || 
...
((tx_overrun && ie_tx_overrun) || 
((any_error || ie_tx_shift_empty) && 
(ie_any_error || ie_tx_shift_empty)) || rx_overrun)))) && 
(framing_error || 
(
(
((tx_overrun && ie_tx_overrun) || 
...
((tx_overrun && ie_tx_overrun) || 
(tx_shift_empty && ie_tx_shift_empty)))) || 
((break_detect && ie_break_detect) || ie_rx_overrun))))) || ie_tx_ready) && 
(tx_ready || 
(
(
(parity_error || 
...
((any_error || ie_tx_shift_empty) && 
(ie_any_error || ie_tx_shift_empty) && ie_any_error && any_error) || (rx_overrun && ie_rx_overrun) || 
(tx_shift_empty && ie_tx_shift_empty))))) || ie_framing_error))))) || (ie_rx_char_ready && rx_char_ready))));
