...
module limbus_uart_regs(input  [2:0] address,
  ...
  assign selected_read_data = ({16{address == 3'd1}} & tx_data) | (((status_reg & {16{address == 3'd2}}) | ({16{address == 3'd0}} & rx_data)) | ({16{address == 3'd3}} & control_reg));
...
(
(framing_error || 
(break_detect || (ie_rx_overrun && rx_overrun) || 
(
(((tx_overrun && ie_tx_overrun) || ie_any_error) && 
((tx_overrun && ie_tx_overrun) || any_error)) || (ie_tx_shift_empty && tx_shift_empty)))) && 
(
(ie_framing_error || 
(break_detect || (ie_rx_overrun && rx_overrun) || 
(
...
(tx_overrun && ie_tx_overrun) || ie_break_detect || 
((ie_tx_shift_empty && tx_shift_empty) || 
(ie_any_error && any_error)) || ie_framing_error))));
