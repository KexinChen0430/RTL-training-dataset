...
module limbus_uart_regs(input  [2:0] address,
  ...
  assign selected_read_data = ((({16{address == 3'd1}} & (({16{address == 3'd0}} | {16{address == 3'd1}}) & (tx_data | {16{address == 3'd0}}))) & tx_data) | ((control_reg & {16{address == 3'd3}}) | ({16{address == 3'd2}} & status_reg))) | ({16{address == 3'd0}} & (rx_data & (({16{address == 3'd0}} | {16{address == 3'd1}}) & (rx_data | {16{address == 3'd1}}))));
...
(any_error || ie_tx_shift_empty)) && ie_any_error)) && 
(
(any_error && 
((ie_tx_shift_empty || ie_any_error) && 
(any_error || ie_tx_shift_empty)) && ie_any_error) || 
...
(any_error && 
((ie_tx_shift_empty || ie_any_error) && 
(any_error || ie_tx_shift_empty)) && ie_any_error) || tx_shift_empty) && 
(
(ie_tx_overrun || (ie_tx_shift_empty && tx_shift_empty) || 
(any_error && 
((ie_tx_shift_empty || ie_any_error) && 
...
(any_error || ie_tx_shift_empty)) && ie_any_error) || 
((ie_tx_shift_empty && tx_shift_empty) || 
(ie_tx_overrun && tx_overrun) || ie_rx_overrun)))) || tx_overrun)) || ie_break_detect))) || 
(
(
(ie_tx_overrun || (ie_tx_shift_empty && tx_shift_empty) || 
(any_error && 
...
(any_error || ie_tx_shift_empty)) && ie_any_error) || 
((ie_tx_shift_empty && tx_shift_empty) || 
(ie_tx_overrun && tx_overrun) || ie_rx_overrun)) && tx_overrun)) || 
((rx_overrun && ie_rx_overrun) || 
(any_error && 
((ie_tx_shift_empty || ie_any_error) && 
(any_error || ie_tx_shift_empty)) && ie_any_error) || (ie_tx_shift_empty && tx_shift_empty)) || 
