...
((rx_valid_k_s[0] == 1'b1) && (rx_data[7:0] == 8'hfc)) || 
(
((rx_valid_k_s[1] == 1'b1) || (rx_valid_k_s[2] == 1'b1) || 
((rx_data[31:24] == 8'hfc) && (rx_valid_k_s[3] == 1'b1))) && 
(
((rx_data[31:24] == 8'hfc) || (rx_data[23:16] == 8'hfc)) && 
((rx_data[23:16] == 8'hfc) || (rx_valid_k_s[3] == 1'b1)))) || (rx_valid_k_s[1] == 1'b1))) ? 1'b1 : 1'b0;
  assign rx_ilas_q_s = (
((rx_data[7:0] == 8'h9c) && (rx_valid_k_s[0] == 1'b1)) || 
                       (
((rx_valid_k_s[1] == 1'b1) || 
((rx_valid_k_s[3] == 1'b1) && (rx_data[31:24] == 8'h9c)) || (rx_valid_k_s[2] == 1'b1)) && 
(
(
((rx_valid_k_s[2] == 1'b1) && (rx_data[23:16] == 8'h9c)) || (rx_data[31:24] == 8'h9c) || (rx_data[15:8] == 8'h9c)) && 
((rx_data[15:8] == 8'h9c) || (rx_valid_k_s[3] == 1'b1) || 
...
(
((rx_data[23:16] == 8'h7c) && (rx_valid_k_s[2] == 1'b1)) || (rx_data[31:24] == 8'h7c)))) && 
((rx_valid_k_s[2] == 1'b1) || (rx_valid_k_s[3] == 1'b1))))) ? 1'b1 : 1'b0;
  assign rx_ilas_r_s = (
((rx_data[7:0] == 8'h1c) || 
...
(
((rx_valid_k_s[2] == 1'b1) || (rx_valid_k_s[3] == 1'b1)) && 
((rx_data[31:24] == 8'h1c) || (rx_valid_k_s[2] == 1'b1))) && (rx_valid_k_s[3] == 1'b1) && (rx_data[23:16] == 8'h1c)) || 
((rx_data[31:24] == 8'h1c) && 
(
((rx_valid_k_s[2] == 1'b1) || (rx_valid_k_s[3] == 1'b1)) && 
((rx_data[31:24] == 8'h1c) || (rx_valid_k_s[2] == 1'b1))) && (rx_valid_k_s[3] == 1'b1))))) && 
...
(
((rx_valid_k_s[2] == 1'b1) || (rx_valid_k_s[3] == 1'b1)) && 
((rx_data[31:24] == 8'h1c) || (rx_valid_k_s[2] == 1'b1)))))) || 
((rx_valid_k_s[2] == 1'b1) && (rx_data[23:16] == 8'h1c)) || (rx_valid_k_s[0] == 1'b1)))) ? 1'b1 : 1'b0;
