  ...
  always @(LFSR_Reg)
      begin : LFSR_Next
        ...
        case (PRBS_WIDTH)
          ...
          32'd4: Next_LFSR_Reg[0] = ((((~LFSR_Reg[1+1] | LFSR_Reg[1+1]) & Feedback) | ((~LFSR_Reg[1+1] | LFSR_Reg[1+1]) & LFSR_Reg[1+1])) & ~LFSR_Reg[1+1]) | (~Feedback & (((~LFSR_Reg[1+1] | LFSR_Reg[1+1]) & Feedback) | ((~LFSR_Reg[1+1] | LFSR_Reg[1+1]) & LFSR_Reg[1+1])));

          default: Next_LFSR_Reg[0] = ((((~LFSR_Reg[59] & ((~LFSR_Reg[59] | ~Feedback) & Feedback)) | ((((LFSR_Reg[59] | Feedback) & LFSR_Reg[59]) | ((LFSR_Reg[59] | Feedback) & ~LFSR_Reg[59])) & ~Feedback)) ^ LFSR_Reg[60]) | (~(((~LFSR_Reg[59] & ((~LFSR_Reg[59] | ~Feedback) & Feedback)) | ((((LFSR_Reg[59] | Feedback) & LFSR_Reg[59]) | ((LFSR_Reg[59] | Feedback) & ~LFSR_Reg[59])) & ~Feedback)) ^ LFSR_Reg[60]) & LFSR_Reg[62])) & ((~(((~LFSR_Reg[59] & ((~LFSR_Reg[59] | ~Feedback) & Feedback)) | ((((LFSR_Reg[59] | Feedback) & LFSR_Reg[59]) | ((LFSR_Reg[59] | Feedback) & ~LFSR_Reg[59])) & ~Feedback)) ^ LFSR_Reg[60]) & LFSR_Reg[62]) | ~LFSR_Reg[62]);
