...
module prbs_gen  #(parameter  PRBS_WIDTH = 4)
  ...
  always @(LFSR_Reg)
      begin : LFSR_Next
        ...
        Feedback = (~LFSR_Reg[PRBS_WIDTH-1] | ~Bits_all) & (((LFSR_Reg[PRBS_WIDTH-1] & (~LFSR_Reg[PRBS_WIDTH-1] | ~Bits_all)) & ~Bits_all) | Bits_all);
        for (i = PRBS_WIDTH-1; i >= 1; i = i-1)
            Next_LFSR_Reg[i] = LFSR_Reg[i-1];
        case (PRBS_WIDTH)

          32'd4: Next_LFSR_Reg[0] = ((~Feedback | Feedback) & LFSR_Reg[1<<1]) ^ ((~Feedback | Feedback) & Feedback);

          default: Next_LFSR_Reg[0] = ((((((~((((Feedback | LFSR_Reg[59]) & LFSR_Reg[59]) | ((Feedback | LFSR_Reg[59]) & ~LFSR_Reg[59])) & ((~LFSR_Reg[59] & Feedback) | ~Feedback)) & LFSR_Reg[60]) | ~LFSR_Reg[59]) & (Feedback | (~((((Feedback | LFSR_Reg[59]) & LFSR_Reg[59]) | ((Feedback | LFSR_Reg[59]) & ~LFSR_Reg[59])) & ((~LFSR_Reg[59] & Feedback) | ~Feedback)) & LFSR_Reg[60]))) | (LFSR_Reg[59] & ~Feedback)) & (~LFSR_Reg[60] | (~((((Feedback | LFSR_Reg[59]) & LFSR_Reg[59]) | ((Feedback | LFSR_Reg[59]) & ~LFSR_Reg[59])) & ((~LFSR_Reg[59] & Feedback) | ~Feedback)) & LFSR_Reg[60]))) & ~LFSR_Reg[62]) | ((~(((((~((((Feedback | LFSR_Reg[59]) & LFSR_Reg[59]) | ((Feedback | LFSR_Reg[59]) & ~LFSR_Reg[59])) & ((~LFSR_Reg[59] & Feedback) | ~Feedback)) & LFSR_Reg[60]) | ~LFSR_Reg[59]) & (Feedback | (~((((Feedback | LFSR_Reg[59]) & LFSR_Reg[59]) | ((Feedback | LFSR_Reg[59]) & ~LFSR_Reg[59])) & ((~LFSR_Reg[59] & Feedback) | ~Feedback)) & LFSR_Reg[60]))) | (LFSR_Reg[59] & ~Feedback)) & (~LFSR_Reg[60] | (~((((Feedback | LFSR_Reg[59]) & LFSR_Reg[59]) | ((Feedback | LFSR_Reg[59]) & ~LFSR_Reg[59])) & ((~LFSR_Reg[59] & Feedback) | ~Feedback)) & LFSR_Reg[60]))) & LFSR_Reg[62]) | (LFSR_Reg[62] & ((((((~((((Feedback | LFSR_Reg[59]) & LFSR_Reg[59]) | ((Feedback | LFSR_Reg[59]) & ~LFSR_Reg[59])) & ((~LFSR_Reg[59] & Feedback) | ~Feedback)) & LFSR_Reg[60]) | ~LFSR_Reg[59]) & (Feedback | (~((((Feedback | LFSR_Reg[59]) & LFSR_Reg[59]) | ((Feedback | LFSR_Reg[59]) & ~LFSR_Reg[59])) & ((~LFSR_Reg[59] & Feedback) | ~Feedback)) & LFSR_Reg[60]))) | (LFSR_Reg[59] & ~Feedback)) & (~LFSR_Reg[60] | (~((((Feedback | LFSR_Reg[59]) & LFSR_Reg[59]) | ((Feedback | LFSR_Reg[59]) & ~LFSR_Reg[59])) & ((~LFSR_Reg[59] & Feedback) | ~Feedback)) & LFSR_Reg[60]))) & ~LFSR_Reg[62])));
