...
module drac_wb_adapter(output drac_srd_o,
                       output drac_swr_o,
  ...
  always @(posedge clk75)
      begin
        if (!wb_stb_delay && wb_we_i && wb_stb_i) 
          begin
            case (wb_adr_i[2:0])
  ...
  always @(posedge clk75 or posedge reset)
      begin
        if (reset) 
          begin
            read <= 1'b0;
          ...
          begin
            ...
            if (!wb_we_i && (!wb_stb_delay && wb_stb_i)) 
              begin
                read <= 1'b1;
              end
            else if (!wb_stb_delay && wb_we_i && wb_stb_i) 
              begin
                write <= 1'b1;
              end
  ...
  always @(posedge clk150 or posedge reset)
      begin
        if (reset) 
          begin
            rdy1 <= 1'b0;
