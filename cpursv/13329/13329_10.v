...
(SATA_CPLL_CFG == VCO_1500MHZ) ? 4 : 1;
  ...
  assign set_burst = (((TXCOMINIT | (~TXCOMFINISH & clr_quiet)) & (state_quiet | TXCOMINIT)) & state_idle) | ((TXCOMWAKE & ((((TXCOMINIT & state_idle) | (state_quiet & ~TXCOMFINISH)) | state_idle) & (clr_quiet | state_idle))) | (~TXCOMFINISH & (clr_quiet & state_quiet)));
  assign set_quiet = (state_burst & clr_burst) & (bursts_cnt < ((0-1)+bursts_cnt_togo));
  ...
  assign stopwatch_clr = (set_burst | state_idle) | set_quiet;
