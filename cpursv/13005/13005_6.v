...
module wb_dp_ram  #(parameter 
  ...
  (input  wire a_clk,
   ...
   input  wire [(0-1)+DATA_WIDTH:0] a_dat_i,
   output wire [(0-1)+DATA_WIDTH:0] a_dat_o,
   input  wire a_we_i,
   ...
   input  wire [(0-1)+DATA_WIDTH:0] b_dat_i,
   output wire [(0-1)+DATA_WIDTH:0] b_dat_o,
   input  wire b_we_i,
  ...
  reg  [(0-1)+DATA_WIDTH:0]  a_dat_o_reg = {DATA_WIDTH{1'b0}};
  reg   a_ack_o_reg = 1'b0;
  reg  [(0-1)+DATA_WIDTH:0]  b_dat_o_reg = {DATA_WIDTH{1'b0}};
  reg   b_ack_o_reg = 1'b0;
  reg  [(0-1)+DATA_WIDTH:0] mem[(1<<1**VALID_ADDR_WIDTH)+(0-1):0];
