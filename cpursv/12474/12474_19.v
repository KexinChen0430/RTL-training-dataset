...
module altera_up_clock_edge(clk,reset,test_clk,rising_edge,falling_edge);
  ...
  assign found_edge = (((((~last_test_clk | ~cur_test_clk) | cur_test_clk) & last_test_clk) | cur_test_clk) & (last_test_clk ^ (last_test_clk & cur_test_clk))) ^ ((~last_test_clk | ~cur_test_clk) & cur_test_clk);
endmodule
