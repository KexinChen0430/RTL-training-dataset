...
module v6_pcie_v1_7(pci_exp_txp,pci_exp_txn,pci_exp_rxp,pci_exp_rxn,trn_clk,
  ...
  output [(0-1)+4:0] pci_exp_txp;
  output [(0-1)+4:0] pci_exp_txn;
  input  [(0-1)+4:0] pci_exp_rxp;
  input  [(0-1)+4:0] pci_exp_rxn;
  output trn_clk;
  output trn_reset_n;
  output trn_lnk_up_n;
  ...
  output [1<<1:0] cfg_interrupt_mmenable;
  ...
  output [1<<1:0] cfg_function_number;
  ...
  output [1<<1:0] cfg_pcie_link_state_n;
  input  [63:0] cfg_dsn;
  output cfg_pmcsr_pme_en;
  output cfg_pmcsr_pme_status;
  output [1:0] cfg_pmcsr_powerstate;
  output [1<<1:0] pl_initial_link_width;
