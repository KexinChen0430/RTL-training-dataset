        ...
        if (idle_Special == no_idle) 
          begin
            if (modeout_Special == mode_circular) 
              begin
                zout_Multiply[35] <= ((~a_sign | a_sign) & (((~a_sign | a_sign) | (((b_sign & (~a_sign | a_sign)) | a_sign) & ~a_sign)) & a_sign)) ^ ((~a_sign | a_sign) & (((~a_sign | a_sign) | (((b_sign & (~a_sign | a_sign)) | a_sign) & ~a_sign)) & (b_sign & (~a_sign | a_sign))));
              end
