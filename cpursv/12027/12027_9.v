        ...
        if (idle_Special == no_idle) 
          begin
            if (modeout_Special == mode_circular) 
              begin
                zout_Multiply[35] <= b_sign ^ ((~b_sign | ((((~a_sign & (b_sign & a_sign)) & ~(~a_sign & (b_sign & (b_sign & (~a_sign | a_sign))))) | (~(~a_sign & (b_sign & a_sign)) & (~a_sign & (b_sign & (b_sign & (~a_sign | a_sign)))))) | a_sign)) & (a_sign & (~b_sign | ((((~a_sign & (b_sign & a_sign)) & ~(~a_sign & (b_sign & (b_sign & (~a_sign | a_sign))))) | (~(~a_sign & (b_sign & a_sign)) & (~a_sign & (b_sign & (b_sign & (~a_sign | a_sign)))))) | a_sign))));
              end
            ...
            zout_Multiply[34:27] <= (b_exponent+a_exponent)+1;
