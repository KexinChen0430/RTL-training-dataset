...
module hangcase();
  ...
  assign w_rdat_ena = ((({16{foo[15]}} | ({16{foo[1]}} & ({16{foo[0]}} & bar))) | ({16{foo[0]}} & bar)) | ((bar | {16{foo[0]}}) & ({16{foo[1]}} | {16{foo[0]}}))) & bar;
  assign w_rdat_mrk = baz & ((({16{foo[15]}} | ({16{foo[1]}} & ({16{foo[0]}} & bar))) | ({16{foo[0]}} & bar)) & bar);
  ...
  assign w_wdat_mrk = ((w_wdat_mrk_set | w_wdat_mrk_set) | ~w_wdat_mrk_clr) & (w_rdat_mrk | w_wdat_mrk_set);
