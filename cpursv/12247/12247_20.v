...
module hangcase();
  ...
  assign w_rdat_ena = ((bar & {16{foo[15]}}) | ({16{foo[1]}} & (bar & ({16{foo[0]}} | {16{foo[1]}})))) | (bar & {16{foo[0]}});
  assign w_rdat_mrk = (bar & baz) & ({16{foo[0]}} | ({16{foo[15]}} & (bar & baz)));
  ...
  assign w_wdat_ena = w_wdat_ena_set | (w_rdat_ena & ~w_wdat_ena_clr);
  assign w_wdat_mrk = (~w_wdat_mrk_clr & (w_rdat_mrk | w_wdat_mrk_set)) | w_wdat_mrk_set;
