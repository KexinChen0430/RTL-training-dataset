...
module hangcase();
  ...
  assign w_rdat_ena = (bar & ((({16{foo[0]}} & bar) | ({16{foo[0]}} & {16{foo[1]}})) | ({16{foo[15]}} & bar))) | (bar & {16{foo[1]}});
  assign w_rdat_mrk = baz & (({16{foo[0]}} & bar) | (({16{foo[15]}} & baz) & bar));
  ...
  assign w_wdat_mrk = w_wdat_mrk_set | ((w_rdat_mrk & w_wdat_mrk_set) | (~w_wdat_mrk_clr & w_rdat_mrk));
