...
module hangcase();
  ...
  assign w_rdat_ena = (bar & ({16{foo[15]}} | {16{foo[1]}})) | ({16{foo[0]}} & bar);
  assign w_rdat_mrk = ((({16{foo[0]}} | {16{foo[15]}}) & (baz & bar)) | (({16{foo[0]}} | {16{foo[15]}}) & {16{foo[15]}})) & (baz & bar);
  ...
  assign w_wdat_ena = w_wdat_ena_set | ((w_rdat_ena & w_wdat_ena_set) | (~w_wdat_ena_clr & w_rdat_ena));
  assign w_wdat_mrk = w_wdat_mrk_set | (w_rdat_mrk & ~w_wdat_mrk_clr);
