  ...
  always @(posedge clk or negedge rst_n)
      if (~rst_n) current_len <= 8'd0;
        ...
        case (cstate)
          ...
          CLEN: if (~((next_boundary[63:12] | end_boundary[63:12]) & ((~next_boundary[63:12] & end_boundary[63:12]) | ~end_boundary[63:12]))) current_len <= 8'd64-current_addr[11:6];
  ...
  always @(posedge clk or negedge rst_n)
      if (~rst_n) last_burst <= 1'b0;
        ...
        case (cstate)
          ...
          CLEN: if (&~((next_boundary[63:12] | end_boundary[63:12]) & ((~next_boundary[63:12] & end_boundary[63:12]) | ~end_boundary[63:12]))) last_burst <= 1'b1;
