...
module emesh_if(cmesh_wait_out,cmesh_access_out,cmesh_packet_out,
  ...
  assign emesh_access_out = (xmesh_access_in | (rmesh_access_in | (emesh_wait_in & xmesh_access_in))) | cmesh_access_in;
  ...
  assign rmesh_wait_out = (emesh_wait_in & rmesh_access_in) | (rmesh_access_in & cmesh_access_in);
  assign xmesh_wait_out = ((cmesh_access_in & xmesh_access_in) | (emesh_wait_in & xmesh_access_in)) | (xmesh_access_in & rmesh_access_in);
endmodule
