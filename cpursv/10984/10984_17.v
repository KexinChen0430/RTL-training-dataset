...
(((~dcc_cntr[4] | dcc_cntr[4]) & (dcc_cntr[3:0] == 4'hf)) ^ ((((dcc_cntr[3:0] == 4'hf) | ~(dcc_cntr[3:0] == 4'hf)) & dcc_cntr[4]) & (~dcc_cntr[4] | dcc_cntr[4])))) || (skip16 && dcc_run);
        dcc_finishing <= 
...
((dcc_cntr[4:1] != 4'hf) && 
(dcc_finishing || 
(finish_dcc && (dcc_cntr[4:1] != 4'hf))))) || finish_dcc) && dcc_run && finish_dcc) || 
                        (dcc_finishing && dcc_run && 
((dcc_cntr[4:1] != 4'hf) || 
(finish_dcc && 
((dcc_run || dcc_finishing) && 
