...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign rt_cnt = i_sw | (b_type | r_type);
  assign sw_lw = (id_LW & (rt == id_td)) & i_sw;
  assign stall = (((id_LW & (((rs == id_td) & (rt == id_td)) | ((((rt == id_td) | (rs == id_td)) & rs_cnt) & (rs == id_td)))) | rt_cnt) & (rs_cnt | rt_cnt)) & (((rt == id_td) | ((id_LW & (((rs == id_td) & (rt == id_td)) | ((((rt == id_td) | (rs == id_td)) & rs_cnt) & (rs == id_td)))) & rs_cnt)) & (id_LW & ~sw_lw));
endmodule
