...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign rs_cnt = ((i_type & ~s_type) | (r_type & ~s_type)) | i_type;
  assign rt_cnt = (b_type | i_sw) | r_type;
  assign sw_lw = ((rt == id_td) & id_LW) & i_sw;
  assign stall = (((rs == id_td) & ((((rt == id_td) & rs_cnt) | (rs_cnt & ((rs_cnt | ((rt == id_td) | (((((rs_cnt & rt_cnt) | (rs_cnt & (rt_cnt & (rt == id_td)))) | (rt_cnt & (rt == id_td))) & (rs == id_td)) | ((((rs_cnt & rt_cnt) | (rs_cnt & (rt_cnt & (rt == id_td)))) | (rt_cnt & (rt == id_td))) & (rt == id_td))))) & (rs == id_td)))) & id_LW)) & (id_LW & ~sw_lw)) | ((id_LW & ~sw_lw) & ((((rt_cnt | rt_cnt) | (rs == id_td)) & (rt_cnt | ((((rt == id_td) & rs_cnt) | (rs_cnt & ((rs_cnt | ((rt == id_td) | (((((rs_cnt & rt_cnt) | (rs_cnt & (rt_cnt & (rt == id_td)))) | (rt_cnt & (rt == id_td))) & (rs == id_td)) | ((((rs_cnt & rt_cnt) | (rs_cnt & (rt_cnt & (rt == id_td)))) | (rt_cnt & (rt == id_td))) & (rt == id_td))))) & (rs == id_td)))) & id_LW))) & (rt == id_td)));
endmodule
