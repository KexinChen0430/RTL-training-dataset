...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign stall = id_LW & ((((((rs == id_td) & ((rt == id_td) | rs_cnt)) & (rt_cnt & ~sw_lw)) | (((rt == id_td) & rt_cnt) & ~sw_lw)) | rs_cnt) & (((rt_cnt | (~sw_lw & (rs == id_td))) & (~sw_lw & ((rs == id_td) | (((rt == id_td) | ((rt == id_td) & rt_cnt)) | ((rs_cnt & (rs == id_td)) & rt_cnt))))) | ((rt_cnt & ~sw_lw) & (rs_cnt & ((rs == id_td) | (((rt == id_td) | ((rt == id_td) & rt_cnt)) | ((rs_cnt & (rs == id_td)) & rt_cnt)))))));
endmodule
