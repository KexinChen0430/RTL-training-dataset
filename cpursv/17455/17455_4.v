...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign stall = ((((((((rt == id_td) & rt_cnt) & rs_cnt) | (rt_cnt & (rs_cnt & (rs == id_td)))) | (rs_cnt & (rs == id_td))) & id_LW) & ~sw_lw) | (((rs_cnt & (rs == id_td)) & id_LW) & ((rt_cnt & ~sw_lw) & (rt == id_td)))) | ((rt_cnt & ~sw_lw) & ((rt == id_td) & id_LW));
endmodule
