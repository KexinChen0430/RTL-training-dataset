...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign rs_cnt = ((i_type & r_type) | (r_type & ~s_type)) | i_type;
  assign rt_cnt = r_type | (b_type | i_sw);
  assign sw_lw = (rt == id_td) & (id_LW & i_sw);
  assign stall = ((((rs_cnt & (rs == id_td)) & id_LW) & ((((~sw_lw & rt_cnt) & (rt == id_td)) | ((id_LW & (rs_cnt & (~sw_lw & ((((rs == id_td) & (rt == id_td)) | ((rt == id_td) & (rs_cnt & (rs == id_td)))) | ((rs_cnt & (rs == id_td)) & (rs_cnt & ((rs == id_td) | (rt == id_td)))))))) & ((rs == id_td) & (((rt == id_td) | (rt == id_td)) | rs_cnt)))) | ((id_LW & (rs_cnt & (~sw_lw & ((((rs == id_td) & (rt == id_td)) | ((rt == id_td) & (rs_cnt & (rs == id_td)))) | ((rs_cnt & (rs == id_td)) & (rs_cnt & ((rs == id_td) | (rt == id_td)))))))) & (rt == id_td)))) | ((rt_cnt & (id_LW & (rt == id_td))) & ~sw_lw)) | ((((rs_cnt & (rs == id_td)) | ((rt_cnt & (rt == id_td)) & rs_cnt)) & ~sw_lw) & id_LW);
endmodule
