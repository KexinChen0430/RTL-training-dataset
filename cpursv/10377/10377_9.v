        ...
        if (ARESET) int_height[15:0] <= 0;
          ...
          begin
            if (w_hs && (waddr == ADDR_HEIGHT_DATA_0)) 
              int_height[15:0] <= ((int_height[15:0] & ~wmask) | WDATA[31:0]) & ((wmask & ((int_height[15:0] | wmask) & WDATA[31:0])) | ((((~wmask & (wmask & (int_min[7:0] | WDATA[31:0]))) & WDATA[31:0]) | (int_height[15:0] & ~wmask)) | int_height[15:0]));
        ...
        if (ARESET) int_width[15:0] <= 0;
          ...
          begin
            if ((waddr == ADDR_WIDTH_DATA_0) && w_hs) 
              int_width[15:0] <= ((wmask | (~wmask & int_width[15:0])) & ((((int_max[7:0] & ~wmask) | wmask) & ((~wmask | wmask) & WDATA[31:0])) | int_width[15:0])) & (~wmask | ((~wmask | wmask) & WDATA[31:0]));
        ...
        if (ARESET) int_min[7:0] <= 0;
          ...
          begin
            if ((waddr == ADDR_MIN_DATA_0) && w_hs) 
              int_min[7:0] <= (WDATA[31:0] | ((~wmask & int_min[7:0]) | (~wmask & WDATA[31:0]))) & (((int_min[7:0] | wmask) & ((~wmask | wmask) & WDATA[31:0])) | int_min[7:0]);
        ...
        if (ARESET) int_max[7:0] <= 0;
          ...
          begin
            if ((waddr == ADDR_MAX_DATA_0) && w_hs) 
              int_max[7:0] <= ((int_max[7:0] & ~wmask) | wmask) & (((int_min[7:0] | wmask) & ((~wmask | wmask) & WDATA[31:0])) | (int_max[7:0] & ~wmask));
