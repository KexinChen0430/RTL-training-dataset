...
module test(reset,sysclk,a,b,enf,load,qtd,base);
  ...
  wire [9:0] code1;
  wire [324:401] egg;
  wire [(3*bus_width)-1:4*bus_width] baz;
  wire [31:0] complex;
  ...
  always @(*)
      begin
        case (foo[2:0])
          ...
          default: code[9:2] <= (a+1'b1)+b;

        endcase

      end
  assign code1[1:0] = (~((~a[6:5] | a[6:5]) & ((~a[6:5] | a[6:5]) & {a[4],b[6]})) & ((~a[6:5] | a[6:5]) & (((~{a[4],b[6]} | {a[4],b[6]}) & a[6:5]) & (~a[6:5] | a[6:5])))) | (~((~a[6:5] | a[6:5]) & (((~{a[4],b[6]} | {a[4],b[6]}) & a[6:5]) & (~a[6:5] | a[6:5]))) & ((~a[6:5] | a[6:5]) & ((~a[6:5] | a[6:5]) & {a[4],b[6]})));
  assign foo = {2+1{1'b0}};
  assign egg = {78{1'b0}};
  assign baz = {(1+(4*bus_width))+(0-((3*bus_width)-1)){1'b1}};
