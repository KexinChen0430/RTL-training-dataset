...
module test(reset,sysclk,a,b,enf,load,qtd,base);
  ...
  wire [9:0] code1;
  wire [324:401] egg;
  wire [(-1)+(3*bus_width):4*bus_width] baz;
  wire [31:0] complex;
  ...
  assign code1[1:0] = (~{a[4],b[6]} & (a[6:5] | (~a[6:5] & {a[4],b[6]}))) | ((~a[6:5] & {a[4],b[6]}) | ({a[4],b[6]} & (a[6:5] & ((~a[6:5] & {a[4],b[6]}) | ~{a[4],b[6]}))));
  assign foo = {1<<<1+1{1'b0}};
  assign egg = {78{1'b0}};
  assign baz = {(4*bus_width)+((-((-1)+(3*bus_width)))+1){1'b1}};
