...
module pcx_monitor(rclk,spc_pcx_req_pq,spc_pcx_data_pa);
  ...
  always @(posedge rclk)
      begin
        if (spc_pcx_data_pa[123] && any_req_pa && 
            (spc_pcx_data_pa[122:118] == 5'b10000)) 
          begin
            $display("PCX:  %t : I-fetch from address  0x%h",$time,
                     spc_pcx_data_pa[103:64]);
            if ((spc_pcx_data_pa[103:64] === GOOD_TRAP_3) || 
                (spc_pcx_data_pa[103:64] === GOOD_TRAP_1) || (spc_pcx_data_pa[103:64] === GOOD_TRAP_2)) 
              begin
            ...
            if ((spc_pcx_data_pa[103:64] === BAD_TRAP_3) || 
                (spc_pcx_data_pa[103:64] === BAD_TRAP_1) || (spc_pcx_data_pa[103:64] === BAD_TRAP_2)) 
              begin
