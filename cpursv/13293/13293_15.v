...
module VgaTiming(input  wire pclk,
                 input  wire rst,
  ...
  always @* 
      begin
        ...
        else if (hcount == (H_SYNC_START+(0-1))) 
          begin
            hcount_nxt = hcount+1;
        ...
        else if (hcount == ((H_SYNC_START+(0-1))+H_SYNC_TIME)) 
          begin
            hcount_nxt = hcount+1;
            if (H_SYNC_POL) hsync_nxt = 0;
            else hsync_nxt = 1;
        ...
        else if (hcount == (H_TOTAL_TIME+(0-1))) 
          begin
            hcount_nxt = 0;
            if (H_SYNC_POL) hsync_nxt = 0;
            else hsync_nxt = 1;
        ...
        if (hcount == (H_TOTAL_TIME+(0-1))) 
          begin
            if (vcount == (V_BLNK_START-1)) 
              begin
                vcount_nxt = 1+vcount;
            ...
            else if (vcount == (V_SYNC_START+(0-1))) 
              begin
                vcount_nxt = 1+vcount;
            ...
            else if (vcount == ((V_SYNC_TIME+V_SYNC_START)+(0-1))) 
              begin
                vcount_nxt = 1+vcount;
                if (V_SYNC_POL) vsync_nxt = 0;
                else vsync_nxt = 1;
            ...
            else if (vcount == ((0-1)+V_TOTAL_TIME)) 
              begin
                vcount_nxt = 0;
                if (V_SYNC_POL) vsync_nxt = 0;
                else vsync_nxt = 1;
