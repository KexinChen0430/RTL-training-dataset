        ...
        if (ACLK_EN) 
          begin
            if (w_hs && (waddr == ADDR_STEP_SIZE_V_DATA_0)) 
              int_step_size_V[15:0] <= ((((~wmask | ((wmask & ((~wmask | wmask) & WDATA[31:0])) & ((~wmask | wmask) & WDATA[31:0]))) & wmask) & int_step_size_V[15:0]) | (int_step_size_V[15:0] & ~wmask)) | (wmask & ((~wmask | wmask) & WDATA[31:0]));
