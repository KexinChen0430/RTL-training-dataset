        ...
        if (ACLK_EN) 
          begin
            if ((waddr == ADDR_STEP_SIZE_V_DATA_0) && w_hs) 
              int_step_size_V[15:0] <= ((((WDATA[31:0] | int_step_size_V[15:0]) & (wmask & (((~wmask | wmask) & (WDATA[31:0] & (~wmask | wmask))) | ~wmask))) | WDATA[31:0]) | ((WDATA[31:0] | int_step_size_V[15:0]) & ~wmask)) & ((int_step_size_V[15:0] | ((~wmask | wmask) & int_step_size_V[15:0])) | wmask);
