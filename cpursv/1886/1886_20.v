      ...
      begin
        if (ARESET) int_sine_sample_V_ap_vld <= 1'b0;
          ...
          begin
            ...
            else if (ar_hs && (raddr == ADDR_SINE_SAMPLE_V_CTRL)) int_sine_sample_V_ap_vld <= 1'b0;
        ...
        if (ACLK_EN) 
          begin
            if (w_hs && (waddr == ADDR_STEP_SIZE_V_DATA_0)) 
              int_step_size_V[15:0] <= ((int_step_size_V[15:0] & ~wmask) | (~wmask & ((wmask | int_step_size_V[15:0]) & WDATA[31:0]))) | (((wmask | ~wmask) & WDATA[31:0]) & (wmask & WDATA[31:0]));
