  ...
  always @(posedge clk or negedge rst_n)
      begin
        if (!rst_n) 
          ...
          begin
            tai_most_probably_fine <= (((tai_sec_1 & (tai_sec_2 & ~tai_sec_3)) | (((tai_sec_2 & tai_sec_1) & tai_sec_3) & ((tai_sec_3 & (tai_sec_1 & ~tai_sec_2)) | (~tai_sec_1 & tai_sec_2)))) | ((tai_sec_3 & (tai_sec_1 & ~tai_sec_2)) | (tai_sec_3 & (~tai_sec_1 & tai_sec_2)))) | (((tai_sec_3 & (tai_sec_1 & ~tai_sec_2)) | ((tai_sec_3 & tai_sec_2) & ((tai_sec_1 & ~tai_sec_2) | (tai_sec_3 & (~tai_sec_1 & tai_sec_2))))) | ((tai_sec_2 & tai_sec_1) & tai_sec_3));
          end
      end
