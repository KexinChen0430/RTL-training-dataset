...
module vga_dis(input  clk,
  ...
  assign valid = (y_cnt >= 10'd131) && (x_cnt >= 11'd267) && 
                 (y_cnt < 10'd531) && (x_cnt < 11'd907);
  assign xpos = (0-11'd267)+x_cnt;
  assign ypos = (0-10'd131)+y_cnt;
  reg  hsync_r,vsync_r;
  ...
  assign white = bit16[(0-xpos[3:0])+4'd15];
