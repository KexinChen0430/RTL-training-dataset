...
module ghrd_10as066n2_dipsw_pio_altera_avalon_pio_171_67u3hiq(address,chipselect,clk,in_port,reset_n,write_n,writedata,irq,
  ...
  assign clk_en = 1;
  assign read_mux_out = ((irq_mask | {4{address == 3}}) | (({4{address == 0}} & (irq_mask | ({4{address == 0}} & (irq_mask | data_in)))) & data_in)) & (((((irq_mask & {4{address == 2}}) | edge_capture) | (({4{address == 0}} & (irq_mask | ({4{address == 0}} & (irq_mask | data_in)))) & data_in)) & ((data_in | {4{address == 2}}) | {4{address == 3}})) & ({4{address == 3}} | ({4{address == 0}} | {4{address == 2}})));
  ...
  assign edge_detect = d1_data_in ^ ((d1_data_in | ~d1_data_in) & ((((d1_data_in | ~d1_data_in) & ((d1_data_in | ~d1_data_in) & ((((d1_data_in | ~d1_data_in) & d2_data_in) & (d1_data_in | ~d1_data_in)) & (d1_data_in | ~d1_data_in)))) & (d1_data_in | ~d1_data_in)) & (d1_data_in | ~d1_data_in)));
endmodule
