      ...
      begin
        if (!rst_n) 
          ...
          begin
            ...
            else if (DELAY != 2'b00) DELAY <= (-2'b1)+DELAY;
            else if (STATE == 3'o0) 
              begin
                STATE <= 3'o1;
                LCD_RST <= 1'b1;
                ...
                if (CLEAR) 
                  ...
                  begin
                    ...
                    if (INDEX < 64) 
                      begin
                        LCD_DI <= 1'b1;
                        if (display[INDEX>>1<<<1+(1<<<1*X_PAGE)<<<4] == 1'b1) LCD_DATA[3:0] <= 4'hF;
                        else LCD_DATA[3:0] <= 4'h0;
                        if (display[(((1<<<1*X_PAGE)+1)*1<<4)+INDEX>>1<<<1] == 1'b1) LCD_DATA[7:4] <= 4'hF;
