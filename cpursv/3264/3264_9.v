...
module DIVI_PREP(SRC,BWD,NOT_DEI,EXTDATA,DOUT,MSB,NULL,MINUS);
  ...
  assign modus = (NOT_DEI | EXTDATA) ? BWD : {BWD[0] | BWD[1],1'b1};
  ...
  assign DOUT = ((((~double & ((double | ~double) & ((double | ~double) & {32{MINUS}}))) & ~(double & ~double)) | (~(~double & ((double | ~double) & ((double | ~double) & {32{MINUS}}))) & (double & ~double))) | ((~{32{MINUS}} & ((double | ~double) & {32{MINUS}})) ^ (~{32{MINUS}} & (double ^ ((double | ~double) & (double & ((double | ~double) & {32{MINUS}})))))))+{31'h0,MINUS};
