...
module DIVI_PREP(SRC,BWD,NOT_DEI,EXTDATA,DOUT,MSB,NULL,MINUS);
  ...
  assign DOUT = {31'h0,MINUS}+(((~double & double) ^ (((~double | double) & {32{MINUS}}) & ~double)) | (((double & ((~double | double) & ((~double | double) & {32{MINUS}}))) & ~double) | (~(double & ((~double | double) & ((~double | double) & {32{MINUS}}))) & double)));
