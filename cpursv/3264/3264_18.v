...
module DIVI_PREP(SRC,BWD,NOT_DEI,EXTDATA,DOUT,MSB,NULL,MINUS);
  ...
  assign DOUT = (((((double & ~double) & {32{MINUS}}) | ~{32{MINUS}}) | ((((double & ~double) & {32{MINUS}}) | (~double & (double | {32{MINUS}}))) & (((double & ~double) & {32{MINUS}}) | (((double & {32{MINUS}}) & ~{32{MINUS}}) | (~(double & {32{MINUS}}) & {32{MINUS}}))))) & (double | {32{MINUS}}))+{31'h0,MINUS};
