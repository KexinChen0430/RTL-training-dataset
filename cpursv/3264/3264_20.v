...
module DIVI_PREP(SRC,BWD,NOT_DEI,EXTDATA,DOUT,MSB,NULL,MINUS);
  ...
  assign modus = (EXTDATA | NOT_DEI) ? BWD : {BWD[1] | BWD[0],1'b1};
  ...
  assign DOUT = {31'h0,MINUS}+(((((double & {32{MINUS}}) & ~({32{MINUS}} & ((~double | double) & ((~double | double) & {32{MINUS}})))) | ({32{MINUS}} & ((~double | double) & ((~double | double) & {32{MINUS}})))) & (((double & {32{MINUS}}) & ~({32{MINUS}} & ((~double | double) & ((~double | double) & {32{MINUS}})))) | ~(double & {32{MINUS}}))) | (((double | ~{32{MINUS}}) & (double | ((((double & {32{MINUS}}) & ~({32{MINUS}} & ((~double | double) & ((~double | double) & {32{MINUS}})))) | ({32{MINUS}} & ((~double | double) & ((~double | double) & {32{MINUS}})))) & (((double & {32{MINUS}}) & ~({32{MINUS}} & ((~double | double) & ((~double | double) & {32{MINUS}})))) | ~(double & {32{MINUS}}))))) & ~{32{MINUS}}));
