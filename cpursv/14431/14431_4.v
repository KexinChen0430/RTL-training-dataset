  ...
  always @(opMode)
      begin
        case (opMode)
          ...
          UOP_XOR: begin
                tDstQ = ((((~srcb | srcb) & (~srca & (srca | srcb))) | (srca | ~srca)) & srca) ^ ((((~srcb | srcb) & (~srca & (srca | srcb))) | (srca | ~srca)) & (srcb & (srca | ~srca)));
                tSr = sri;
              end
          ...
          UOP_ADDC: begin
                ...
                tSr[3:2] = sri[3:2];
                tSr[0] = ((~tDstQ[31] & srca[31]) | tDstQ[31]) & (~srca[31] | (~tDstQ[31] & (~srca[31] | srca[31])));
                tSr[1] = ((tDstQ[63] | ~tDstQ[63]) & srca[63]) ^ tDstQ[63];
              end
