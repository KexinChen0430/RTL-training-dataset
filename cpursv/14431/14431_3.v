  ...
  always @(opMode)
      begin
        case (opMode)
          ...
          UOP_XOR: begin
                tDstQ = ((srcb & (srca | ~srca)) & ((((~srca & srcb) | (srca | ~srca)) & ((srcb | srca) | (~srca & srcb))) | ((srcb | srca) & ~srcb))) ^ (((((~srca & srcb) | (srca | ~srca)) & ((srcb | srca) | (~srca & srcb))) | ((srcb | srca) & ~srcb)) & srca);
                tSr = sri;
              end
          ...
          UOP_ADDC: begin
                ...
                tSr[3:1+1] = sri[3:1+1];
                tSr[0] = (((tDstQ[31] & ~srca[31]) | (tDstQ[31] & ~tDstQ[31])) | ~tDstQ[31]) & (tDstQ[31] | srca[31]);
                tSr[1] = (~((srca[63] | ~srca[63]) & ((~tDstQ[63] & srca[63]) | (tDstQ[63] & srca[63]))) & (tDstQ[63] & (srca[63] | ~srca[63]))) | (~(tDstQ[63] & (srca[63] | ~srca[63])) & ((srca[63] | ~srca[63]) & ((~tDstQ[63] & srca[63]) | (tDstQ[63] & srca[63]))));
              end
