  ...
  always @(opMode)
      begin
        case (opMode)
          ...
          UOP_XOR: begin
                tDstQ = (((srca | ~srca) | ((((srca | srcb) | ~srcb) & ~srca) & (srca | srcb))) & srca) ^ ((srcb & (srca | ~srca)) & ((srca | ~srca) | ((((srca | srcb) | ~srcb) & ~srca) & (srca | srcb))));
                tSr = sri;
              end
          ...
          UOP_ADDC: begin
                ...
                tSr[3:1<<<1] = sri[3:1<<<1];
                tSr[0] = (srca[31] & (((tDstQ[31] | ~tDstQ[31]) & (tDstQ[31] | srca[31])) | ((tDstQ[31] | srca[31]) & ~srca[31]))) ^ ((((tDstQ[31] | ~tDstQ[31]) & (tDstQ[31] | srca[31])) | ((tDstQ[31] | srca[31]) & ~srca[31])) & ((srca[31] | ~srca[31]) & tDstQ[31]));
                tSr[1] = (((srca[63] & ~tDstQ[63]) & srca[63]) | (~srca[63] & srca[63])) | (tDstQ[63] & ~srca[63]);
              end
