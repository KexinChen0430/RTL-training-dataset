  ...
  always @(opMode)
      begin
        case (opMode)
          ...
          UOP_XOR: begin
                tDstQ = ((srca | ~srca) & (srcb | srca)) & (~srca | (~srcb | (~srcb & srca)));
                tSr = sri;
              end
          ...
          UOP_ADDC: begin
                ...
                tSr[3:2] = sri[3:2];
                tSr[0] = ((srca[31] | (tDstQ[31] & (~srca[31] | (srca[31] | tDstQ[31])))) & (~tDstQ[31] | (tDstQ[31] | (~srca[31] & tDstQ[31])))) & (~tDstQ[31] | (~srca[31] & tDstQ[31]));
                tSr[1] = (~tDstQ[63] & srca[63]) | (((((tDstQ[63] | (~tDstQ[63] & srca[63])) & ~srca[63]) | srca[63]) & ((tDstQ[63] & (~srca[63] | (tDstQ[63] | srca[63]))) & (((~srca[63] | (tDstQ[63] | srca[63])) & ~tDstQ[63]) | ~srca[63]))) & ~srca[63]);
              end
