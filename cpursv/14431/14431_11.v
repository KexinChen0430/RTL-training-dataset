  ...
  always @(opMode)
      begin
        case (opMode)
          ...
          UOP_XOR: begin
                tDstQ = ((((~srcb | ~srca) | ((srcb | ~srcb) & (~srca & (srca | srcb)))) & ((srcb | ~srcb) & srca)) & ~(((~srcb | ~srca) | ((srcb | ~srcb) & (~srca & (srca | srcb)))) & srcb)) | (~(((~srcb | ~srca) | ((srcb | ~srcb) & (~srca & (srca | srcb)))) & ((srcb | ~srcb) & srca)) & (((~srcb | ~srca) | ((srcb | ~srcb) & (~srca & (srca | srcb)))) & srcb));
                tSr = sri;
              end
          ...
          UOP_ADDC: begin
                ...
                tSr[3:1<<1] = sri[3:1<<1];
                tSr[0] = tDstQ[31] ^ ((srca[31] & ~tDstQ[31]) | (srca[31] & tDstQ[31]));
