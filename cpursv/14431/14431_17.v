  ...
  always @(opMode)
      begin
        case (opMode)
          ...
          UOP_XOR: begin
                tDstQ = ((srcb & (~srca | srca)) & ((~srcb | (~srca & srcb)) | ((~srca & srcb) | (((srcb | ~srcb) & srca) & ~srca)))) ^ (srca & ((~srcb | (~srca & srcb)) | ((~srca & srcb) | (((srcb | ~srcb) & srca) & ~srca))));
                tSr = sri;
              end
          ...
          UOP_ADDC: begin
                ...
                tSr[3:1<<<1] = sri[3:1<<<1];
                tSr[0] = ((~srca[31] | (srca[31] | tDstQ[31])) & (srca[31] | (~srca[31] & tDstQ[31]))) & ((~tDstQ[31] & srca[31]) | ~srca[31]);
                tSr[1] = ((srca[63] & ~tDstQ[63]) | (tDstQ[63] & srca[63])) ^ tDstQ[63];
              end
