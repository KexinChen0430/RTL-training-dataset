  ...
  always @(opMode)
      begin
        case (opMode)
          ...
          UOP_XOR: begin
                tDstQ = (((~srcb & (srca | srcb)) | ((srcb & (((~srca & srcb) | ~srcb) | srca)) | srca)) & ((~srcb | (srca | srcb)) & srca)) ^ (srcb & ((~srcb & (srca | srcb)) | ((srcb & (((~srca & srcb) | ~srcb) | srca)) | srca)));
                tSr = sri;
              end
          ...
          UOP_ADDC: begin
                if (sri[0]) tDstQ = (srcb+srca)+1;
                else tDstQ = srcb+srca;
                tSr[3:2] = sri[3:2];
                tSr[0] = (((~srca[31] | (~tDstQ[31] & (((~tDstQ[31] | tDstQ[31]) & (srca[31] | tDstQ[31])) & srca[31]))) & (tDstQ[31] & (~srca[31] | srca[31]))) & ~srca[31]) | (~tDstQ[31] & (((~tDstQ[31] | tDstQ[31]) & (srca[31] | tDstQ[31])) & srca[31]));
                tSr[1] = (((tDstQ[63] | ~tDstQ[63]) | (srca[63] & ~tDstQ[63])) & ((~srca[63] | ~tDstQ[63]) & (tDstQ[63] & (~srca[63] | srca[63])))) ^ (((~srca[63] & srca[63]) | (srca[63] & (srca[63] & ~tDstQ[63]))) & ((tDstQ[63] | ~tDstQ[63]) | (srca[63] & ~tDstQ[63])));
              end
