...
((en_ch[1] || cur_ch[5]) && cur_ch[4]))))) && 
(
((en_ch[2] || cur_ch[4]) && (en_ch[2] || en_ch[1])) || (cur_ch[1] && en_ch[3]) || cur_ch[3])) || 
(
((cur_ch[0] && en_ch[2]) || 
(
(en_ch[4] || 
(
((en_ch[2] || cur_ch[4]) && (en_ch[2] || en_ch[1])) || (cur_ch[1] && en_ch[3]))) && 
(en_ch[4] || 
(((en_ch[1] || cur_ch[5]) && cur_ch[5]) || 
((en_ch[1] || cur_ch[5]) && cur_ch[4]) || (cur_ch[1] && en_ch[3]))))) && 
(
((en_ch[4] && cur_ch[2]) || (cur_ch[1] && en_ch[3]) || 
en_ch[5] || 
(
(
((cur_ch[5] && en_ch[2]) || cur_ch[4] || cur_ch[0]) && cur_ch[0]) || 
((en_ch[1] || cur_ch[5]) && (en_ch[2] || en_ch[1]) && 
((cur_ch[5] && en_ch[2]) || cur_ch[4] || cur_ch[0])))) && 
((en_ch[4] && cur_ch[2]) || (cur_ch[1] && en_ch[3]) || 
en_ch[5] || 
((en_ch[2] || cur_ch[4]) && (en_ch[2] || en_ch[1]))) && cur_ch[2]))) && 
(
((cur_ch[0] && en_ch[2]) || 
((en_ch[1] || cur_ch[5]) && (en_ch[2] || en_ch[1]))) && 
((cur_ch[5] && en_ch[2]) || cur_ch[4] || 
(cur_ch[0] && en_ch[2])))) || 
(
((en_ch[4] && cur_ch[2]) || (cur_ch[1] && en_ch[3]) || 
en_ch[5]) && 
