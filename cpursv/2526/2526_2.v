...
(
(en_ch[3] && cur_ch[1] && 
((en_ch[3] && cur_ch[1]) || en_ch[2])) || 
(cur_ch[0] && ((en_ch[3] && cur_ch[1]) || en_ch[2])) || en_ch[4] || 
((cur_ch[5] || cur_ch[4]) && (en_ch[2] || cur_ch[4]))) && 
(
(en_ch[3] && cur_ch[1] && 
((en_ch[3] && cur_ch[1]) || en_ch[2])) || 
(cur_ch[0] && ((en_ch[3] && cur_ch[1]) || en_ch[2])) || en_ch[4] || ((cur_ch[5] && en_ch[2]) || en_ch[1])) && 
(
(
(
(
...
(en_ch[3] && cur_ch[1] && 
((en_ch[3] && cur_ch[1]) || en_ch[2])) || 
(cur_ch[0] && ((en_ch[3] && cur_ch[1]) || en_ch[2])) || (en_ch[2] || cur_ch[4])) && 
(
(en_ch[3] && cur_ch[1] && 
((en_ch[3] && cur_ch[1]) || en_ch[2])) || 
(cur_ch[0] && ((en_ch[3] && cur_ch[1]) || en_ch[2])) || (en_ch[1] || en_ch[2]))) || en_ch[5]) && 
(en_ch[5] || 
(
(en_ch[3] && cur_ch[1] && 
((en_ch[3] && cur_ch[1]) || en_ch[2])) || 
(cur_ch[0] && ((en_ch[3] && cur_ch[1]) || en_ch[2])) || 
((cur_ch[5] && (cur_ch[5] || cur_ch[4])) || 
((cur_ch[5] || cur_ch[4]) && en_ch[1]))))) || cur_ch[2]) && 
(
(
(
(en_ch[3] && cur_ch[1] && 
...
(
((cur_ch[5] && (cur_ch[5] || cur_ch[4])) || 
((cur_ch[5] || cur_ch[4]) && en_ch[1]) || cur_ch[0]) && 
(en_ch[2] || 
((cur_ch[5] && (cur_ch[5] || cur_ch[4])) || 
((cur_ch[5] || cur_ch[4]) && en_ch[1]))))) && 
(
(en_ch[2] || 
((cur_ch[5] && (cur_ch[5] || cur_ch[4])) || 
((cur_ch[5] || cur_ch[4]) && en_ch[1])) || cur_ch[1]) && 
(
((en_ch[2] || (en_ch[2] || cur_ch[4])) && 
(en_ch[2] || (en_ch[1] || en_ch[2]))) || cur_ch[1])))) && 
(cur_ch[3] || 
(
(
(
(en_ch[3] || 
((cur_ch[5] || cur_ch[4]) && (en_ch[2] || cur_ch[4]))) && 
(en_ch[3] || ((cur_ch[5] && en_ch[2]) || en_ch[1]))) || 
(
(en_ch[2] || 
((cur_ch[5] && (cur_ch[5] || cur_ch[4])) || 
((cur_ch[5] || cur_ch[4]) && en_ch[1]))) && 
((en_ch[2] || (en_ch[2] || cur_ch[4])) && 
(en_ch[2] || (en_ch[1] || en_ch[2]))))) && 
(cur_ch[0] || 
(
(en_ch[3] || 
((cur_ch[5] || cur_ch[4]) && (en_ch[2] || cur_ch[4]))) && 
...
((cur_ch[5] || cur_ch[4]) && en_ch[1]))))));
  ...
  always @(posedge clk or negedge rst_n)
      if (!rst_n) 
        ...
        begin
          flags <= (set_flags | flags) & ~clr_flags;
        end
  ...
  always @(posedge clk or negedge rst_n)
      if (!rst_n) 
        ...
        begin
          addr2 <= addr1;
          on2 <= aoff ? 1'b0 : (aon | ~done1 && on1);
          clr2 <= aoff || done1 || aon;
          start2 <= (up1 && up_start) ? addr_in[11:0] : start1;
          end2 <= (up1 && up_end) ? addr_in[11:0] : end1;
          ...
          addr1 <= (on6 && clr6) ? {start6,9'd0} : 
                  (sumup6 && ~skip6) ? (21'd1+addr6) : addr6;
          on1 <= on6;
          done1 <= done6;
          start1 <= start6;
          end1 <= end6;
