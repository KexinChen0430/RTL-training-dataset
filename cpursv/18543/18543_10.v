  ...
  always @(posedge clk)
      begin
        if (~|shiftcnt[1+1:0]) 
          begin
            if (~|shiftcnt[6:3]) 
              shift <= #1 (((~exchan | exchan) & (shiftcnt[7] & (((exchan | ((~exchan | exchan) & shiftcnt[7])) & ~exchan) | (~exchan | exchan)))) ^ (((((exchan | ((~exchan | exchan) & shiftcnt[7])) & ~exchan) | (~exchan | exchan)) & exchan) & (~exchan | exchan))) ? ldata_mux : rdata_mux;
