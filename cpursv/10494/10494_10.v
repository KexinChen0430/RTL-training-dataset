...
module FP16RAddSubS4Of5(input  clk,
  ...
  assign yn = arg_6;
  assign s = (xn == yn) ? xs : 
             yn ? (((neg | xs) & ((((~neg | (ys | neg)) | (~neg & (neg | xs))) & xs) ^ (((~neg | (ys | neg)) | (~neg & (neg | xs))) & (xs & (neg & (xs | ~xs)))))) ^ ((((~neg | (ys | neg)) | (~neg & (neg | xs))) & ((~xs & neg) | (neg & ~neg))) & (neg | xs))) : ((~ys & (ys | neg)) | (((neg & (((~neg | (ys | neg)) & ys) & ys)) ^ ((neg & ys) & neg)) ^ ((ys & (neg & ys)) ^ ys)));
