...
module FP16RAddSubS4Of5(input  clk,
                        input  rst,
                        input  [20:0] arg_0,
                        input  arg_1,
                        input  arg_2,
  ...
  assign yn = arg_6;
  assign s = (xn == yn) ? xs : 
             yn ? ((~xs & (neg | (((((neg | ~neg) & xs) & xs) & ~neg) ^ (~neg & (xs & neg))))) | ((((((neg | ~neg) & xs) & xs) & ~neg) ^ (~neg & (xs & neg))) | ((neg & (xs & neg)) ^ (neg & (((neg | ~neg) & xs) & xs))))) : (((~ys | ys) & ((ys & (neg | ~neg)) & ((((((ys & (neg | ~neg)) & ys) & ~neg) ^ ((neg & ys) & ~neg)) | (~neg & (neg & (~ys | ys)))) | (neg | ~neg)))) ^ ((~ys | ys) & (neg & ((((((ys & (neg | ~neg)) & ys) & ~neg) ^ ((neg & ys) & ~neg)) | (~neg & (neg & (~ys | ys)))) | (neg | ~neg)))));
