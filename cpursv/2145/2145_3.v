        ...
        if (!RST_N || CLR) 
          ...
          begin
            ...
            sempty <= (pos == 0) || 
                     (
(
((((pos == 0) && DEQ) || (DEQ && (pos == 1))) && !ENQ) || (pos == 1) || (pos == 0)) && (!ENQ && ((pos == 0) || DEQ)));
            sfull <= 
((pos == ((-1)+depth)) || 
(
((pos == ((-1)+depth)) && (pos == ((0-1<<<1)+depth))) || (!DEQ && (pos == ((0-1<<<1)+depth))))) && ((pos == ((-1)+depth)) || ENQ);
            if ((dempty && !sempty) || 
                (DEQ && (!dempty || !sempty) && !sempty)) 
              begin
                dreg <= dat[pos-1];
                dempty <= 1'b0;
              end
