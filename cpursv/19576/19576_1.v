...
module hi_sniffer(pck0,ck_1356meg,ck_1356megb,pwr_lo,pwr_hi,pwr_oe1,pwr_oe2,
                  pwr_oe3,pwr_oe4,adc_d,adc_clk,ssp_frame,ssp_din,ssp_dout,
                  ssp_clk,cross_hi,cross_lo,dbg,xcorr_is_848,snoop,
                  xcorr_quarter_freq);
  ...
  always @(posedge ssp_clk)
      begin
        if (ssp_cnt[2:0] == 3'd7) ssp_cnt[2:0] <= 3'd0;
        else ssp_cnt <= 1+ssp_cnt;
