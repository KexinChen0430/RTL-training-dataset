...
module dcache_pmem_mux(input  clk_i,
  ...
  assign inport0_ack_o = outport_ack_i && (select_q == 1'd0);
  assign inport0_error_o = outport_error_i && (select_q == 1'd0);
  ...
  assign inport1_accept_o = outport_accept_i && (select_i == 1'd1);
endmodule
