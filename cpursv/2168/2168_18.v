...
module DCA_CONTROL(BCLK,MCLK,BRESET,CUPDATE,DRAM_ACC,CA_SET,HIT_ALL,WRCFG,
  ...
  assign WE_CV = (((HIT_ALL | state[1]) & ~WCTRL[0]) | ((~WCTRL[0] | KILL) & CUPDATE)) | ((KILL | HIT_ALL) | (HIT_ALL | state[1]));
  ...
  assign WRSET0 = (WCTRL[1] & ~ca_set_d) | (((WCTRL[1] & ~ca_set_d) | (wr_puls & (WRITE & HIT_ALL))) & ~CA_SET);
  assign WRSET1 = (ca_set_d & WCTRL[1]) | ((((ca_set_d & WCTRL[1]) | (((~CA_SET & HIT_ALL) & WRITE) & wr_puls)) | wr_puls) & ((WRITE & HIT_ALL) & CA_SET));
