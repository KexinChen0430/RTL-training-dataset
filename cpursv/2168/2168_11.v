...
module DCA_CONTROL(BCLK,MCLK,BRESET,CUPDATE,DRAM_ACC,CA_SET,HIT_ALL,WRCFG,
  ...
  assign WE_CV = (CUPDATE & ((~WCTRL[0] | (KILL & HIT_ALL)) | KILL)) | ((state[1] | KILL) | HIT_ALL);
  ...
  assign WRSET0 = ((~ca_set_d & WCTRL[1]) | (~ca_set_d & (wr_puls & ((HIT_ALL & WRITE) & ~CA_SET)))) | (WRITE & ((~ca_set_d & WCTRL[1]) | (wr_puls & (HIT_ALL & ~CA_SET))));
  assign WRSET1 = (CA_SET & (HIT_ALL & (wr_puls & WRITE))) | ((ca_set_d & WCTRL[1]) | (ca_set_d & (CA_SET & (HIT_ALL & (wr_puls & WRITE)))));
