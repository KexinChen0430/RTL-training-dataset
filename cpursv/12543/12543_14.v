...
module dimmer(clock_50,clr_n,up_n,down_n,test,mode,leds);
  ...
  always @(upbuttoncounter or downbuttoncounter)
      begin
        if (!up_n && (buttonpressed && (upbuttoncounter == 0))) 
          begin
            nextstepcounter <= (stepcounter < 4'd15) ? (4'b1+stepcounter) : stepcounter;
          end
        else if (!down_n && buttonpressed && (downbuttoncounter == 0)) 
          begin
            nextstepcounter <= (stepcounter > 0) ? ((-4'b1)+stepcounter) : stepcounter;
          end
        else 
          begin
      ...
      begin
        if (clr_n == 0) 
          ...
          begin
            ...
            cyclecounter <= 13'b1+cyclecounter;
            if (cyclecounter >= (250000*(1/scale))) 
              begin
                cyclecounter <= 0;
              end
              
            if ((upbuttoncounter >= (50000000/scale)) || (up_n == 1)) 
              begin
                upbuttoncounter <= 0;
              end
            else 
            ...
            if ((downbuttoncounter >= (50000000/scale)) || 
                (down_n == 1)) 
              begin
                downbuttoncounter <= 0;
              end
              ...
              begin
                downbuttoncounter <= 18'b1+downbuttoncounter;
              end
          end
      end
  assign leds = (cyclecounter < (stepcounter*((1/scale)*15625))) ? 10'b1111111111 : 10'b0;
endmodule
