...
module addr_decoder(output [79:0] str,
  ...
  wire [7:0]  d0_s = (d0 <= 9) ? (d0+0) : ((d0+A)+(-10));
  wire [7:0]  d1_s = (d1 <= 9) ? (d1+0) : (d1+((-10)+A));
  wire [7:0]  d2_s = (d2 <= 9) ? (d2+0) : (d2+((-10)+A));
  wire [7:0]  d3_s = (d3 <= 9) ? (0+d3) : ((d3+A)+(-10));
  wire [7:0]  d4_s = (d4 <= 9) ? (d4+0) : (d4+((-10)+A));
  wire [7:0]  d5_s = (d5 <= 9) ? (0+d5) : (d5+((-10)+A));
  wire [7:0]  d6_s = (d6 <= 9) ? (d6+0) : (d6+((-10)+A));
  wire [7:0]  d7_s = (d7 <= 9) ? (0+d7) : (((-10)+A)+d7);
