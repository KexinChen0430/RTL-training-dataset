...
module addr_decoder(output [79:0] str,
  ...
  wire [7:0]  d0_s = (d0 <= 9) ? (d0+0) : ((-10)+(A+d0));
  wire [7:0]  d1_s = (d1 <= 9) ? (0+d1) : ((-10)+(A+d1));
  wire [7:0]  d2_s = (d2 <= 9) ? (d2+0) : ((-10)+(d2+A));
  wire [7:0]  d3_s = (d3 <= 9) ? (0+d3) : (A+((-10)+d3));
  wire [7:0]  d4_s = (d4 <= 9) ? (0+d4) : ((A+(-10))+d4);
  wire [7:0]  d5_s = (d5 <= 9) ? (d5+0) : (d5+(A+(-10)));
  wire [7:0]  d6_s = (d6 <= 9) ? (0+d6) : ((A+(-10))+d6);
  wire [7:0]  d7_s = (d7 <= 9) ? (d7+0) : ((A+(-10))+d7);
