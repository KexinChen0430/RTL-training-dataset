...
module stratixgx_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign rxanalogresetout = {HARD_RESET | rxanalogreset[3],HARD_RESET | rxanalogreset[2],rxanalogreset[1] | HARD_RESET,rxanalogreset[0] | HARD_RESET};
  assign txanalogresetout = {HARD_RESET,HARD_RESET,HARD_RESET,HARD_RESET};
  assign pllresetout = ((rxanalogresetout[3] & (rxanalogresetout[0] & txanalogresetout[0])) & (rxanalogresetout[1] & txanalogresetout[2])) & (txanalogresetout[3] & (rxanalogresetout[2] & txanalogresetout[1]));
