...
module stratixgx_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign rxanalogresetout = {rxanalogreset[3] | HARD_RESET,rxanalogreset[2] | HARD_RESET,rxanalogreset[1] | HARD_RESET,rxanalogreset[0] | HARD_RESET};
  assign txanalogresetout = {HARD_RESET,HARD_RESET,HARD_RESET,HARD_RESET};
  assign pllresetout = (((txanalogresetout[1] & rxanalogresetout[0]) & rxanalogresetout[2]) & (txanalogresetout[3] & txanalogresetout[2])) & ((rxanalogresetout[1] & rxanalogresetout[3]) & txanalogresetout[0]);
