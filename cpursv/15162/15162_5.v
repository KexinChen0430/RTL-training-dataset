...
module stratixgx_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign pllresetout = ((rxanalogresetout[2] & (rxanalogresetout[0] & txanalogresetout[0])) & (txanalogresetout[3] & txanalogresetout[2])) & ((rxanalogresetout[1] & rxanalogresetout[3]) & txanalogresetout[1]);
  assign rxdigitalresetout = {HARD_RESET | rxdigitalreset[3],rxdigitalreset[2] | HARD_RESET,rxdigitalreset[1] | HARD_RESET,HARD_RESET | rxdigitalreset[0]};
