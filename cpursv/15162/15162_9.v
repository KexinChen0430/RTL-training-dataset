...
module stratixgx_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign pllresetout = (rxanalogresetout[3] & (rxanalogresetout[2] & txanalogresetout[3])) & ((txanalogresetout[0] & (rxanalogresetout[1] & (txanalogresetout[2] & txanalogresetout[1]))) & rxanalogresetout[0]);
  ...
  assign txdigitalresetout = {HARD_RESET | txdigitalreset[3],HARD_RESET | txdigitalreset[2],HARD_RESET | txdigitalreset[1],txdigitalreset[0] | HARD_RESET};
endmodule
