...
module sync_debouncer_10ms(signal_debounced,clk_50mhz,rst,signal_async);
  ...
  always @(posedge clk_50mhz or posedge rst)
      ...
      else debounce_counter <= 1+debounce_counter;
  wire 
       debounce_counter_done = debounce_counter == 19'h7ffff;
