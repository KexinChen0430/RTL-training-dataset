...
module reg_read_arbitration(input  wire [3:0] get_opnd1,
                            input  wire is_opnd1,
  ...
  wire 
       opnd1_held = (get_opnd1 == 4'h0) ? hold_Q[0] : 
(get_opnd1 == 4'h1) ? hold_Q[1] : 
(get_opnd1 == 4'h2) ? hold_Q[2] : 
(get_opnd1 == 4'h3) ? hold_Q[3] : 
(get_opnd1 == 4'h4) ? hold_Q[4] : 
(get_opnd1 == 4'h5) ? hold_Q[5] : 
(get_opnd1 == 4'h6) ? hold_Q[6] : 
(get_opnd1 == 4'h7) ? hold_Q[7] : 
(get_opnd1 == 4'h8) ? hold_Q[8] : 
(get_opnd1 == 4'h9) ? hold_Q[9] : 
...
(get_opnd1 == 4'hE) ? hold_Q[14] : hold_Q[15];
  wire 
       opnd2_held = (get_opnd2 == 4'h0) ? hold_Q[0] : 
(get_opnd2 == 4'h1) ? hold_Q[1] : 
(get_opnd2 == 4'h2) ? hold_Q[2] : 
(get_opnd2 == 4'h3) ? hold_Q[3] : 
(get_opnd2 == 4'h4) ? hold_Q[4] : 
(get_opnd2 == 4'h5) ? hold_Q[5] : 
(get_opnd2 == 4'h6) ? hold_Q[6] : 
(get_opnd2 == 4'h7) ? hold_Q[7] : 
(get_opnd2 == 4'h8) ? hold_Q[8] : 
(get_opnd2 == 4'h9) ? hold_Q[9] : 
...
(get_opnd2 == 4'hE) ? hold_Q[14] : hold_Q[15];
  ...
  assign flags = {is_opnd1 & opnd1_held,is_opnd2 & opnd2_held};
