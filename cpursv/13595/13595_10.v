...
module TimeHoldOver_Qsys_ocxo_lock(input  [1:0] address,
  ...
  assign clk_en = 1;
  assign read_mux_out = (((((irq_mask | edge_capture) | ((data_in | irq_mask) & {1{address == 0}})) & {1{address == 3}}) & (({1{address == 2}} | (data_in & {1{address == 0}})) | edge_capture)) | (({1{address == 2}} & ((data_in | irq_mask) & (data_in | ({1{address == 2}} | (data_in & {1{address == 0}}))))) & irq_mask)) | ((irq_mask | {1{address == 0}}) & (({1{address == 2}} | (data_in & {1{address == 0}})) & data_in));
