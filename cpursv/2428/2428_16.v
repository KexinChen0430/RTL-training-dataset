...
module display_16hex(reset,clock_27mhz,data,disp_blank,disp_clock,disp_rs,
  ...
  always @(posedge clock_27mhz)
      ...
      else reset_count <= (reset_count == 0) ? 0 : ((0-1)+reset_count);
      ...
      if (dreset) 
        ...
        casex (state)
          ...
          8'h02: begin
                disp_ce_b <= 1'b0;
                disp_data_out <= 1'b0;
                if (dot_index == 639) state <= state+1;
                else dot_index <= 1+dot_index;
              end
