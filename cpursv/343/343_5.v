...
module uart_light_tx_ctrl  #(parameter 
       STATE_COUNT  = 2,
       IDLE         = 2'b00,
       LOAD         = 2'b01,
       TRANSMITTING = 2'b10)
  ...
  reg  [(0-1)+STATE_COUNT:0] state_cur,state_next;

  assign fifo_tx_full = fifo_full;
  assign fifo_tx_empty = fifo_empty;
  assign fifo_write_enable = ~fifo_full & word_ready;
