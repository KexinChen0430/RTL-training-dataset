...
module eth_txcounters(StatePreamble,StateIPG,StateData,StatePAD,StateFCS,StateJam,
  ...
  assign IncrementNibCnt = (((StatePreamble | StateIPG) | ((StatePAD | |StateData) | (StateFCS | StateJam))) | StateBackOff) | (TxStartFrm & (StateDefer & ~ExcessiveDefer));
  assign ResetNibCnt = ((StartJam | StartFCS) | (StartDefer | StartIPG)) | ((((StateJam & NibCntEq7) | StateIdle) | ((ExcessiveDefer & StateDefer) | (NibCntEq15 & StatePreamble))) & (((NibCntEq15 & StatePreamble) | ~TxStartFrm) | ((StateJam & NibCntEq7) | StateIdle)));
  ...
  assign NibbleMinFl = NibCnt >= ((0-1)+(2*(MinFL-3'h4)));
  assign ExcessiveDeferCnt = NibCnt[13:0] == 16'h17b7;
  assign ExcessiveDefer = NibCnt[13:0] == (~ExDfrEn & 16'h17b7);
  assign IncrementByteCnt = ((((StateData[1] | StateBackOff) & ~ByteCntMax) | StateBackOff) & &NibCnt[6:0]) | (~ByteCntMax & (StateData[1] | ((~ByteCntMax & NibCnt[0]) & (StatePAD | StateFCS))));
  assign ResetByteCnt = (((StateIdle | StartBackoff) | PacketFinished_q) & (PacketFinished_q | TxStartFrm)) | StartBackoff;
      ...
      begin
        if (Reset) DlyCrcCnt <= #Tp 3'h0;
          ...
          begin
            ...
            else if (((StateSFD | StateData[1]) & DlyCrcEn) & (|DlyCrcCnt[2:0] | (((StateSFD | StateData[1]) & DlyCrcEn) & StateSFD))) DlyCrcCnt <= #Tp 1'b1+DlyCrcCnt;
