...
module eth_txcounters(StatePreamble,StateIPG,StateData,StatePAD,StateFCS,StateJam,
  ...
  assign IncrementNibCnt = ((((StateFCS | (StatePAD | |StateData)) | (StatePreamble | StateIPG)) | ((StateBackOff | StateJam) | TxStartFrm)) & ((StatePAD | ((StateFCS | ((StatePreamble | |StateData) | StateIPG)) | StateBackOff)) | (~ExcessiveDefer & StateDefer))) | StateJam;
  assign ResetNibCnt = (((StartIPG | ((StatePreamble & NibCntEq15) | (StartDefer | ((NibCntEq7 & StateJam) | (ExcessiveDefer & ((~TxStartFrm & StateDefer) | (NibCntEq7 & StateJam))))))) | StateIdle) | StartFCS) | StartJam;
  ...
  assign NibbleMinFl = NibCnt >= ((MinFL+(-3'h4))<<1+(0-1));
  assign ExcessiveDeferCnt = NibCnt[13:0] == 16'h17b7;
  assign ExcessiveDefer = NibCnt[13:0] == (16'h17b7 & ~ExDfrEn);
  assign IncrementByteCnt = (((&NibCnt[6:0] & (((StateFCS | (StatePAD & NibCnt[0])) & (NibCnt[0] & ~ByteCntMax)) | StateBackOff)) | ((StateFCS | (StatePAD & NibCnt[0])) & (NibCnt[0] & ~ByteCntMax))) | ~ByteCntMax) & (((&NibCnt[6:0] & (((StateFCS | (StatePAD & NibCnt[0])) & (NibCnt[0] & ~ByteCntMax)) | StateBackOff)) | ((StateFCS | (StatePAD & NibCnt[0])) & (NibCnt[0] & ~ByteCntMax))) | StateData[1]);
      ...
      begin
        if (Reset) DlyCrcCnt <= #Tp 3'h0;
          ...
          begin
            ...
            else if ((DlyCrcEn & (StateSFD | |DlyCrcCnt[1<<<1:0])) & (StateSFD | StateData[1])) DlyCrcCnt <= #Tp 1'b1+DlyCrcCnt;
