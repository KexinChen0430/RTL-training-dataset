...
module CA_MATCH(CVALID,IOSEL,ADDR,TAG0,TAG1,CFG,WRITE,MMU_HIT,CI,INVAL_L,
  ...
  assign CA_HIT = ((valid_1 | (match_0 & (match_1 & valid_0))) | (match_0 & valid_0)) & (((((match_1 & ~DC_ILO) | ((match_0 & valid_0) & ((match_1 | valid_0) & match_0))) | (match_0 & (match_1 & valid_0))) & (((match_1 & ~DC_ILO) | (~DC_ILO & valid_1)) | (((match_0 & ~DC_ILO) | (~DC_ILO & valid_1)) & valid_0))) & CFG[0]);
