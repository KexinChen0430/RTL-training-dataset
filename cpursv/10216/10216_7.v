...
module gRRArbiter(input  clk,
  ...
  assign T23 = T24[4:0];
  assign T24 = T25 | T31;
  assign T25 = T26 & tvec_1;
  assign T26 = {7{T27}};
  assign T27 = T28[1];
  assign T28 = T29[1:0];
  assign T29 = (2**choose)*2'h1;
  assign tvec_1 = T30;
  ...
  assign T35 = T41 | T36;
  assign T36 = T37 & dvec_1;
  assign T37 = {32{T38}};
  assign T38 = T39[1];
  assign T39 = T40[1:0];
  assign T40 = (2**choose)*2'h1;
  assign dvec_1 = io_in_1_bits;
  assign T41 = T42 & dvec_0;
  assign T42 = {32{T43}};
  assign T43 = T39[0];
