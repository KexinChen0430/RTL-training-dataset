...
module event_tagger(strobe_channels,delta_channels,clk,reset_counter,
                    capture_operate,counter_operate,data,ready);
  ...
  always @(posedge clk)
      begin
        ...
        else if (((strobe_channels != 4'b0) && counter_operate) || 
                 ((timer == 36'b0) && counter_operate) || (strobe_channels != 4'b0)) 
          begin
            data[35:0] <= timer[35:0];
        ...
        timer <= reset_counter ? 0 : (counter_operate+timer);
      end
endmodule
