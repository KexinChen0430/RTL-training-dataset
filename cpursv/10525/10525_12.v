...
module osd(input  pclk,
  ...
  wire [9:0] 
       h_osd_end = (OSD_X_OFFSET+OSD_WIDTH>>1)+((0-1)+h_dsp_ctr);

  wire [9:0] 
       v_osd_start = ((0-OSD_HEIGHT>>1)+OSD_Y_OFFSET)+v_dsp_ctr;

  wire [9:0] 
       v_osd_end = OSD_Y_OFFSET+(OSD_HEIGHT>>1+(v_dsp_ctr+(0-1)));
  ...
  wire 
       osd_de = osd_enable && v_osd_active && h_osd_active;
