...
module apu_frame_counter(input  clk_in,
                         input  rst_in,
  ...
  always @* 
      begin
        ...
        if (apu_cycle_pulse_in) 
          begin
            d_apu_cycle_cnt = 15'h0001+q_apu_cycle_cnt;
            if ((q_apu_cycle_cnt == 15'h0E90) || 
                (q_apu_cycle_cnt == 15'h2BB1)) 
              begin
                e_pulse_out = 1'b1;
              end
            ...
            else if ((q_apu_cycle_cnt == 15'h3A42) && !q_seq_mode) 
              begin
                e_pulse_out = 1'b1;
                l_pulse_out = 1'b1;
        ...
        if (cpu_cycle_pulse_in && mode_wr_in) d_apu_cycle_cnt = 15'h48d0;
