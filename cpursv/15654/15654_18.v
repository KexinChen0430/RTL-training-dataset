...
module collision(input  clk,
  ...
  assign bm = ((((clxcon[5:0] & bpldata[5:0]) | (~clxcon[5:0] | ~clxcon[11:6])) & (~clxcon[11:6] | bpldata[5:0])) & (clxcon[5:0] | ~clxcon[11:6])) | (~clxcon[5:0] & ~bpldata[5:0]);
  assign oddmatch = (bm[0] & bm[4]) & (((dblpf & bm[4]) & (bm[2] & bm[0])) | (evenmatch & bm[2]));
  assign evenmatch = (bm[3] & bm[5]) & bm[1];
  assign sprmatch[0] = nsprite[0] | ((nsprite[0] | nsprite[1]) & (clxcon[12] & nsprite[1]));
  assign sprmatch[1] = (nsprite[2] | nsprite[3]) & (clxcon[13] | nsprite[2]);
