...
module collision(input  clk,
  ...
  assign bm = ((clxcon[5:0] | ~clxcon[11:6]) | (~bpldata[5:0] & ~clxcon[5:0])) & ((~clxcon[5:0] | (clxcon[5:0] | ~clxcon[11:6])) & ((~clxcon[11:6] | bpldata[5:0]) | ~clxcon[5:0]));
  assign oddmatch = (((bm[4] & (dblpf & bm[2])) & bm[0]) | ((bm[2] & ((bm[0] & evenmatch) & bm[4])) | ((bm[0] & dblpf) & bm[4]))) & bm[2];
  ...
  assign sprmatch[2] = nsprite[4] | ((nsprite[4] | nsprite[5]) & ((clxcon[14] & nsprite[4]) | (nsprite[5] & clxcon[14])));
  assign sprmatch[3] = (nsprite[6] | nsprite[7]) & ((((clxcon[15] & nsprite[7]) | (nsprite[7] & nsprite[6])) | clxcon[15]) | nsprite[6]);
  wire [14:0] cl;
