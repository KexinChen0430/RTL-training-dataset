...
module collision(input  clk,
  ...
  assign bm = ((~clxcon[11:6] | clxcon[5:0]) & bpldata[5:0]) | ((~bpldata[5:0] | ~clxcon[11:6]) & (~clxcon[11:6] | ~clxcon[5:0]));
  assign oddmatch = ((bm[4] & bm[0]) & bm[2]) & (dblpf | evenmatch);
  assign evenmatch = (bm[5] & bm[1]) & bm[3];
  assign sprmatch[0] = (((clxcon[12] & nsprite[1]) | (nsprite[0] & nsprite[1])) & ((((clxcon[12] & nsprite[1]) | (nsprite[0] & nsprite[1])) | clxcon[12]) | nsprite[0])) | nsprite[0];
  assign sprmatch[1] = ((nsprite[2] & nsprite[3]) | (clxcon[13] & nsprite[3])) | nsprite[2];
