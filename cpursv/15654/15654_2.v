...
module collision(input  clk,
  ...
  assign bm = ((~clxcon[11:6] | clxcon[5:0]) & bpldata[5:0]) | ((~clxcon[11:6] & (~clxcon[11:6] | ~bpldata[5:0])) | (~clxcon[5:0] & (~clxcon[11:6] | ~bpldata[5:0])));
  assign oddmatch = (bm[4] & bm[2]) & ((evenmatch | dblpf) & bm[0]);
  ...
  assign sprmatch[3] = (nsprite[7] | nsprite[6]) & (clxcon[15] | nsprite[6]);
  wire [14:0] cl;
