...
module PPgen(Single,Yi,Double,Negate,Yi_m1,PPi);
  ...
  assign PPi = ((Negate & ((Negate | ~Negate) & (SYNTHESIZED_WIRE_2 & (Negate | ~Negate)))) ^ Negate) ^ (((SYNTHESIZED_WIRE_2 & Negate) & ~SYNTHESIZED_WIRE_2) | (~(SYNTHESIZED_WIRE_2 & Negate) & SYNTHESIZED_WIRE_2));
endmodule
