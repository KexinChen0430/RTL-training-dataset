  ...
  always @(negedge sclk270 or posedge wcmd)
      if (wcmd) 
        ...
        begin
          waslate90 <= waslate90 || 
                      (enrd90 && 
(((ldqsr90 || udqsr90) && (enrd90 || udqsr90)) || 
waslate90));
          wasearly90 <= 
(enrd90 && 
((enrd90 || !udqsr90) && (!udqsr90 || !ldqsr90) && 
(enrd90 || udqsr90))) || wasearly90;
        end
      ...
      if (wcmd) 
        ...
        begin
          waslate270 <= waslate270 || 
                       ((waslate270 && enrd270) || 
(!ldqsr270 && (!udqsr270 || enrd270) && enrd270)) || 
                       ((!udqsr270 && waslate270) || (!udqsr270 && enrd270));
          wasearly270 <= (enrd270 && udqsr270) || 
                        ((wasearly270 || (enrd270 && udqsr270)) && udqsr270) || 
                        ((enrd270 || wasearly270) && (wasearly270 || ldqsr270));
        end
