...
(dcm_drst[0] || dcm_drst[1])) && (dcm_drst[0] || dcm_drst[1] || wcmd);
      ...
      if (wcmd) 
        ...
        begin
          waslate90 <= waslate90 || 
                      (enrd90 && 
(ldqsr90 || 
(udqsr90 || (waslate90 && enrd90) || waslate90)));
          wasearly90 <= wasearly90 || 
                       (
(wasearly90 || 
((enrd90 || !udqsr90) && (!ldqsr90 || !udqsr90))) && enrd90);
        end
  ...
  always @(posedge sclk270 or posedge wcmd)
      if (wcmd) 
        ...
        begin
          waslate270 <= (enrd270 && (!ldqsr270 || (!udqsr270 && enrd270))) || 
                       (waslate270 || (!udqsr270 && enrd270));
          wasearly270 <= (ldqsr270 && enrd270) || 
                        (wasearly270 || 
