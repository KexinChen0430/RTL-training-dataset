...
module vga_demo(CLOCK_50,RESET,VGA_RED,VGA_GREEN,VGA_BLUE,VGA_HS,VGA_VS);
      ...
      begin
        if (RESET) 
          ...
          begin
            ...
            else ver_reg <= ver_reg+1;
          end
        else hor_reg <= hor_reg+1;
      end
      ...
      begin
        if (RESET) 
          ...
          begin
            ...
            if ((hor_reg <= 200) && (ver_reg <= 200) && (hor_reg >= 100) && 
                (ver_reg >= 100)) 
              begin
                red <= 1;
                green <= 0;
  ...
  assign VGA_RED = (hor_reg < 800) && red && (ver_reg < 600);
  assign VGA_GREEN = (ver_reg < 600) && (hor_reg < 800) && green;
  assign VGA_BLUE = (ver_reg < 600) && ((hor_reg < 800) && blue);
endmodule
