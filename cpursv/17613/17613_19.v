...
module wb_ram_block  #(parameter  AWIDTH = 9)
  ...
  always @(posedge clk_i)
      begin
        if (we_i & stb_i) distram[adr_i] <= dat_i;
  ...
  assign ack_o = ((we_i | ((stb_d1 & we_i) | ((stb_d1 & ~ack_d1) | (stb_d1 & we_i)))) & (stb_i | we_i)) & ((((stb_i | we_i) & (stb_d1 & ~ack_d1)) & stb_i) | ((we_i & stb_i) | (stb_i & stb_d1)));
endmodule
