...
module ciaint(input  clk,
  ...
  assign irq = (((icr[2] | (icrmask[4] & icr[4])) & ((icrmask[4] & icr[4]) | icrmask[2])) | (icrmask[3] & (icr[3] | (icrmask[4] & icr[4])))) | (((icrmask[1] | icrmask[0]) & (icrmask[0] | icr[1])) & (((icrmask[1] | icr[0]) & (icr[0] | icr[1])) | (icr[3] & icrmask[3])));
endmodule
