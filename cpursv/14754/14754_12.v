...
module ciaint(input  clk,
  ...
  assign irq = ((icrmask[4] & icr[4]) | (((icr[3] & icrmask[3]) | (icr[2] & (icrmask[2] | (icr[3] & icrmask[3])))) | (((icrmask[2] & icr[2]) | icrmask[0]) & icr[0]))) | (icr[1] & (icrmask[1] & ((icr[0] | icr[1]) & (icrmask[1] | icr[0]))));
endmodule
