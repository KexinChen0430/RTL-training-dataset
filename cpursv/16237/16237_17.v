...
module iobus_2_connect(input  wire clk,
  ...
  assign m_pi_req = (0 | s1_pi_req) | s0_pi_req;
  assign m_iob_read = (m_iob_write | s1_iob_read) | s0_iob_read;
  assign m_dr_split = (s1_dr_split | 0) | s0_dr_split;
  assign m_rdi_data = (0 | s1_rdi_data) | s0_rdi_data;
