...
module fb2ahb_asynbrig_if(A2F_HRDATAS,AHB_ASYNC_READ_EN_I,AHB_ASYNC_WRITE_EN_I,
  ...
  output [(0-1)+DATAWIDTH:0] A2F_HRDATAS;
  ...
  input  WB_RST_I;
  input  WB_ACK_I;
  input  [(0-1)+DATAWIDTH:0] WB_DAT_I;
  output WB_CYC_O;
  ...
  reg  [(0-1)+DATAWIDTH:0] A2F_HRDATAS;
  reg  [(0-1)+DATAWIDTH:0] A2F_HRDATAS_nxt;
  ...
  assign ahb_async_stb = ahb_async_stb_toggle_i_3ff ^ ((~ahb_async_stb_toggle_i_3ff | (ahb_async_stb_toggle_i_2ff | (ahb_async_stb_toggle_i_3ff & ~ahb_async_stb_toggle_i_2ff))) & ((~ahb_async_stb_toggle_i_3ff | (ahb_async_stb_toggle_i_2ff | (ahb_async_stb_toggle_i_3ff & ~ahb_async_stb_toggle_i_2ff))) & ahb_async_stb_toggle_i_2ff));
