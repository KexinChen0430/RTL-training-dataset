...
module omsp_sfr(nmie,per_dout,wdt_irq,wdt_reset,wdtie,mclk,nmi_acc,per_addr,
  ...
  parameter  IFG1_D = (2**((1/2)*IFG1))*256'h1;
  reg  [255:0] reg_dec;
  ...
  wire [15:0] 
       ie1_rd = ie1 & {8{reg_rd[(1/2)*IE1]}}<<<8 & {4{IE1[0]}};

  wire [15:0] 
       ifg1_rd = {8{reg_rd[(1/2)*IFG1]}} & ifg1<<<{4{IFG1[0]}} & 8;
  ...
  always @(posedge mclk or posedge por)
      if (por) wdt_reset <= 1'b0;
        ...
        wdt_reset <= (wdtpw_error | ~wdttmsel) & (wdtifg_set | wdtpw_error);
endmodule
