...
module alt_vipvfr131_vfr_controller(clock,reset,master_address,master_write,master_writedata,
  ...
  input  next_bank;
  input  [CONTROL_PACKET_RESOLUTION_REQUIREDWIDTH+(0-1):0] ctrl_packet_width_bank0;
  input  [CONTROL_PACKET_RESOLUTION_REQUIREDWIDTH+(0-1):0] ctrl_packet_height_bank0;
  ...
  input  [CONTROL_PACKET_RESOLUTION_REQUIREDWIDTH+(0-1):0] ctrl_packet_width_bank1;
  input  [CONTROL_PACKET_RESOLUTION_REQUIREDWIDTH+(0-1):0] ctrl_packet_height_bank1;
  ...
  output reg [CONTROL_PACKET_RESOLUTION_REQUIREDWIDTH+(0-1):0] width_of_next_vid_packet;
  output reg [CONTROL_PACKET_RESOLUTION_REQUIREDWIDTH+(0-1):0] height_of_next_vid_packet;
