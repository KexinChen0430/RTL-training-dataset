...
module alt_vipvfr131_vfr_controller(clock,reset,master_address,master_write,master_writedata,
  ...
  input  [PACKET_ADDRESS_WIDTH+(0-1):0] vid_packet_base_address_bank0;
  input  [(0-1)+PACKET_SAMPLES_WIDTH:0] vid_packet_samples_bank0;
  input  [PACKET_WORDS_WIDTH+(0-1):0] vid_packet_words_bank0;
  ...
  input  [PACKET_ADDRESS_WIDTH+(0-1):0] vid_packet_base_address_bank1;
  input  [(0-1)+PACKET_SAMPLES_WIDTH:0] vid_packet_samples_bank1;
  input  [PACKET_WORDS_WIDTH+(0-1):0] vid_packet_words_bank1;
