...
module alt_vipvfr131_vfr_controller(clock,reset,master_address,master_write,master_writedata,
  ...
  input  [(-1)+CONTROL_PACKET_INTERLACED_REQUIREDWIDTH:0] ctrl_packet_interlaced_bank0;
  ...
  input  [(-1)+CONTROL_PACKET_INTERLACED_REQUIREDWIDTH:0] ctrl_packet_interlaced_bank1;
  ...
  output reg [(-1)+CONTROL_PACKET_INTERLACED_REQUIREDWIDTH:0] interlaced_of_next_vid_packet;
