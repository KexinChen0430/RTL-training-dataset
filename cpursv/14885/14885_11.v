      ...
      begin
        if (RESET == 1) 
          ...
          begin
            ...
            SCORE_C = 0;
            SCORE_M = 0;
            SCORE_M = SCORE*(1/1000);
            SCORE_C = (SCORE+(0-(SCORE_M*1000)))/100;
            SCORE_D = ((0-(100*SCORE_C))+(SCORE+(0-(SCORE_M*1000))))/10;
            SCORE_U = ((0-(100*SCORE_C))+((0-(10*SCORE_D))+(0-(SCORE_M*1000))))+SCORE;
            case (SCORE_M)
