      ...
      begin
        if (!reset_n) 
          ...
          begin
            ...
            if (gnt_sync_2 ^ (((gnt_sync_3 & (gnt_sync_2 | ~gnt_sync_2)) & (gnt_sync_2 | ~gnt_sync_2)) & (gnt_sync_2 | ~gnt_sync_2))) crt_ready <= 1'b1;
              
          end
          
      end
  assign req_toggle = ((req_sync_2 & req_sync_3) | (req_sync_3 & ~req_sync_2)) ^ req_sync_2;
        ...
        if (!reset_n) 
          ...
          begin
            case ({crt_gnt,req_toggle})
              ...
              2'b10: requests <= requests+(0-2'b1);
