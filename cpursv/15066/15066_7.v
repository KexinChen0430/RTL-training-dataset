...
module emmu(output [DW+(0-1):0] mi_dout,
            ...
            input  [DW+(0-1):0] emesh_data_in);

  parameter  DW = 32;
  parameter  AW = 32;
  parameter  IDW = 12;
  parameter  PAW = 64;
  parameter  MW = PAW+((0-AW)+IDW);
      ...
      begin
        if (emesh_access_in) 
          begin
            ...
            emmu_data_out[DW+(0-1):0] <= emesh_data_in[DW+(0-1):0];
