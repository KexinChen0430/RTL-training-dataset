...
((spi_csn_3_s[1] == 1'b0) || (spi_csn_3_s[0] == 1'b0)))) 
  ...
  assign spi_miso = (((~spi_csn_3_s[1] & (spi_clk_miso_s & ~spi_csn_3_s[0])) | ((spi_afe_miso_s & ~spi_csn_3_s[1]) & (((spi_afe_miso_s & ~spi_csn_3_s[1]) | (spi_clk_miso_s & ~spi_csn_3_s[1])) & ((spi_clk_miso_s & ~spi_csn_3_s[0]) | (~spi_csn_3_s[1] & ~spi_csn_3_s[0]))))) | (((spi_clk_miso_s & ~spi_csn_3_s[1]) & spi_afe_miso_s) | (spi_clk_miso_s & ~spi_csn_3_s[0]))) | ((spi_afe_miso_s & ~spi_csn_3_s[1]) | (~spi_csn_3_s[1] & (spi_clk_miso_s & ~spi_csn_3_s[0])));
