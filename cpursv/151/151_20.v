...
module usdrx1_spi(spi_afe_csn,spi_clk_csn,spi_clk,spi_mosi,spi_miso,
  ...
  assign spi_miso = (((spi_afe_miso_s & (~spi_csn_3_s[0] & ~spi_csn_3_s[1])) | ((spi_clk_miso_s & ~spi_csn_3_s[1]) & ~spi_csn_3_s[0])) | (~spi_csn_3_s[0] & (spi_clk_miso_s & ((spi_afe_miso_s | ((spi_afe_miso_s & (~spi_csn_3_s[0] & ~spi_csn_3_s[1])) | spi_clk_miso_s)) & (~spi_csn_3_s[1] | (~spi_csn_3_s[0] | ((spi_afe_miso_s & spi_clk_miso_s) & ~spi_csn_3_s[1]))))))) | (((spi_afe_miso_s & (~spi_csn_3_s[0] & ~spi_csn_3_s[1])) | ((spi_clk_miso_s & ~spi_csn_3_s[1]) & ~spi_csn_3_s[0])) | (~spi_csn_3_s[1] & spi_afe_miso_s));
