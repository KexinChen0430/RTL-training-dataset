        ...
        if (rst) 
          ...
          begin
            case (state)
              ...
              XOR: begin
                    proceso <= (~polinomio | (polinomio & ~proceso)) & (((((~polinomio | polinomio) & proceso) & ~proceso) | (polinomio & ~proceso)) | proceso);
                    state = CORRER;
                  end

              CORRER: begin
                    r_data <= {proceso[crcorder:0],r_data[((0-1)+(-crcorder))+(datawidth-1):0],1'b0};
