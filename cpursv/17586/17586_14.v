        ...
        if (rst) 
          ...
          begin
            case (state)
              ...
              XOR: begin
                    proceso <= (((~proceso & (proceso | polinomio)) | (proceso | ~proceso)) & ((polinomio & (proceso | ~proceso)) & ((~proceso & (proceso | polinomio)) | (proceso | ~proceso)))) ^ ((((~proceso & (proceso | polinomio)) | (proceso | ~proceso)) & proceso) & ((~proceso & (proceso | polinomio)) | (proceso | ~proceso)));
                    state = CORRER;
                  end

              CORRER: begin
                    r_data <= {proceso[crcorder:0],r_data[datawidth+(((0-1)+(0-crcorder))+(0-1)):0],1'b0};
