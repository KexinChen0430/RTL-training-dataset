        ...
        if (rst) 
          ...
          begin
            case (state)
              ...
              XOR: begin
                    proceso <= ((proceso | polinomio) & ~proceso) | (((~polinomio | ((proceso | polinomio) & ~proceso)) & proceso) & (proceso | polinomio));
                    state = CORRER;
                  end

              CORRER: begin
                    r_data <= {proceso[crcorder:0],r_data[(0-1)<<<1+((0-crcorder)+datawidth):0],1'b0};
