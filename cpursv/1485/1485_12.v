...
module cf_add(clk,data_1,data_2,data_3,data_4,data_p,ddata_in,ddata_out);

  parameter  DELAY_DATA_WIDTH = 16;
  parameter  DW = (0-1)+DELAY_DATA_WIDTH;
  input  clk;
  input  [24:0] data_1;
  input  [24:0] data_2;
  input  [24:0] data_3;
  ...
  always @(posedge clk)
      begin
        p2_ddata <= p1_ddata;
        p2_data_0 <= p1_data_2+p1_data_1;
        p2_data_1 <= p1_data_4+p1_data_3;
      end
  
  always @(posedge clk)
      begin
        p3_ddata <= p2_ddata;
        p3_data <= p2_data_1+p2_data_0;
      end
