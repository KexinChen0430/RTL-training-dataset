...
((state == PLAYER2) && (py2_draw || py1_draw))) || (py1_draw && (state == PLAYER1))) next_occupied = occupied | 1'b1<<<iSW<<<(0-1'b1);
          
        if ((state == PLAYER2) && py2_draw) next_symbol = symbol | 1'b1<<<iSW<<<(0-1'b1);
      ...
      begin
        if (WIN == PLAYER1_WIN) next_win = PLAYER1_WIN;
          ...
          begin
            ...
            if (
(((state == PLAYER1) || py2_draw) && 
((state == PLAYER2) && (py2_draw || py1_draw))) || (py1_draw && (state == PLAYER1))) 
              begin
