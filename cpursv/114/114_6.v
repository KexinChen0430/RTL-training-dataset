...
module state_control(input  CLK,
  ...
  always @(*)
      begin
        if (~occupied[(0-1)+iSW] && (iSW <= 9) && (iSW > 0)) 
          begin
  ...
  always @(posedge CLK)
      begin
        if (RESET) 
          ...
          begin
            if ((state == PLAYER1) && py1_draw) 
              begin
                occupied[(0-1)+iSW] = 1'b1;
                symbol[(0-1)+iSW] = 1'b0;
              end
...
((state == PLAYER1) && py1_draw) || 
((state == PLAYER2) && 
((py2_draw && py1_draw) || 
((state == PLAYER1) && ((state == PLAYER2) && py2_draw)) || ((state == PLAYER2) && py2_draw))) || 
(
((py2_draw && py1_draw) || 
((state == PLAYER1) && ((state == PLAYER2) && py2_draw)) || ((state == PLAYER2) && py2_draw)) && (state == PLAYER1)))) || 
            (py1_draw && 
(((state == PLAYER2) && (state == PLAYER1)) || 
((state == PLAYER1) && py1_draw) || 
((state == PLAYER2) && 
...
(
((py2_draw && py1_draw) || 
((state == PLAYER1) && ((state == PLAYER2) && py2_draw)) || ((state == PLAYER2) && py2_draw)) && (state == PLAYER1))))) next_occupied = occupied | (1'b1*(1<<1**iSW))<<<(-1'b1);
          
        if ((state == PLAYER2) && py2_draw) next_symbol = symbol | (1'b1*(1<<1**iSW))<<<(-1'b1);
