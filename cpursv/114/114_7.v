...
module state_control(input  CLK,
  ...
  always @(*)
      begin
        ...
        next_symbol = symbol;
        if (
((state == PLAYER2) && ((state == PLAYER1) && py1_draw)) || 
            ((py1_draw || py2_draw) && (state == PLAYER2) && 
((state == PLAYER1) || py2_draw)) || 
            ((state == PLAYER1) && 
(py2_draw && 
((py1_draw && (state == PLAYER2)) || 
((state == PLAYER1) && py1_draw)))) || 
            ((state == PLAYER1) && py1_draw && 
((state == PLAYER1) && (py1_draw || py2_draw)))) next_occupied = occupied | (1<<<(-1'b1)<<<iSW*1'b1);
          
        if ((state == PLAYER2) && py2_draw) next_symbol = (1<<<(-1'b1)<<<iSW*1'b1) | symbol;
...
((state == PLAYER1) && py1_draw)))) || 
                ((state == PLAYER1) && py1_draw && 
((state == PLAYER1) && (py1_draw || py2_draw)))) 
              begin
