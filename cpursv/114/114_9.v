...
((state == PLAYER2) && (py1_draw && (state == PLAYER1)))) || (py1_draw && (state == PLAYER1))) next_occupied = occupied | (1'b1*((1+1)**iSW)<<<(0-1'b1));
          
        if ((state == PLAYER2) && py2_draw) next_symbol = (1'b1*((1+1)**iSW)<<<(0-1'b1)) | symbol;
...
((state == PLAYER2) && (py1_draw && (state == PLAYER1))) || 
                (((state == PLAYER2) && py2_draw) || 
((state == PLAYER2) && (py1_draw && (state == PLAYER1)))) || (py1_draw && (state == PLAYER1))) 
              begin
