...
((state == PLAYER2) && (py1_draw && (state == PLAYER1))) || py2_draw)) && 
((py1_draw && (state == PLAYER1)) || 
((state == PLAYER2) || 
((state == PLAYER1) && py2_draw && py1_draw)))) || 
            (
(
((py2_draw && (state == PLAYER2)) || 
(py2_draw && py1_draw)) && (state == PLAYER2)) || 
((state == PLAYER1) && 
((py2_draw && (state == PLAYER2)) || 
(py2_draw && py1_draw))))) next_occupied = occupied | (1'b1*(1<<<1**(0-1'b1)))<<iSW;
          
        if (py2_draw && (state == PLAYER2)) next_symbol = (1'b1*(1<<<1**(0-1'b1)))<<iSW | symbol;
