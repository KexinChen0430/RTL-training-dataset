...
module state_control(input  CLK,
  ...
  always @(*)
      begin
        if ((iSW <= 9) && ((iSW > 0) && ~occupied[(0-1)+iSW])) 
          begin
  ...
  always @(posedge CLK)
      begin
        if (RESET) 
          ...
          begin
            if (py1_draw && 
                ((state == PLAYER1) && ((state == PLAYER2) || py1_draw))) 
              begin
  ...
  always @(*)
      begin
        ...
        if (
(py1_draw && 
((state == PLAYER1) && ((state == PLAYER2) || py1_draw)) && ((state == PLAYER1) && (py2_draw || py1_draw))) || 
            (((state == PLAYER2) && py2_draw) || 
(
((state == PLAYER1) || 
(py2_draw || 
(py1_draw && 
((state == PLAYER1) && ((state == PLAYER2) || py1_draw))))) && py1_draw && (state == PLAYER2)) || 
((state == PLAYER1) && ((state == PLAYER2) || py1_draw) && 
(py1_draw && py2_draw)))) next_occupied = occupied | ((1'b1*1<<(-1'b1))*1<<iSW);
          
        if ((state == PLAYER2) && py2_draw) next_symbol = ((1'b1*1<<(-1'b1))*1<<iSW) | symbol;
