...
(
(
((state == PLAYER2) && (py2_draw || py1_draw) && 
((state == PLAYER1) || py2_draw)) || py2_draw || 
((py2_draw || py1_draw) && (state == PLAYER1))) && (py1_draw || (state == PLAYER2)) && (state == PLAYER2)) || 
            (
(
((state == PLAYER2) && (py2_draw || py1_draw) && 
((state == PLAYER1) || py2_draw)) || py2_draw || 
((py2_draw || py1_draw) && (state == PLAYER1))) && (py1_draw || (state == PLAYER2)) && (state == PLAYER1))) next_occupied = (1'b1<<<iSW*1<<<(-1'b1)) | occupied;
          
        if ((state == PLAYER2) && py2_draw) next_symbol = (1'b1<<<iSW*1<<<(-1'b1)) | symbol;
...
((state == PLAYER2) && (py2_draw || py1_draw) && 
((state == PLAYER1) || py2_draw)) || py2_draw || 
((py2_draw || py1_draw) && (state == PLAYER1))) && (py1_draw || (state == PLAYER2)) && (state == PLAYER1))) 
              begin
