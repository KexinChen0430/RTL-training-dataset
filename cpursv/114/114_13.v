...
module state_control(input  CLK,
  ...
  always @(*)
      begin
        ...
        next_symbol = symbol;
        if ((py1_draw && (py2_draw && (state == PLAYER1))) || 
            (
(py1_draw && (state == PLAYER1) && (state == PLAYER2)) || 
(
((state == PLAYER2) || 
(py1_draw && (py2_draw && (state == PLAYER1)))) && py2_draw)) || (py1_draw && (state == PLAYER1))) next_occupied = 1'b1<<iSW<<(-1'b1) | occupied;
          
        if (py2_draw && (state == PLAYER2)) next_symbol = symbol | 1'b1<<iSW<<(-1'b1);
...
(
((state == PLAYER2) || 
(py1_draw && (py2_draw && (state == PLAYER1)))) && py2_draw)) || (py1_draw && (state == PLAYER1))) 
              begin
