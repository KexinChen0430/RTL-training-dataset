...
module SP_rf_LUT_RAM(clk,we,wa,di,re,do0,do1,do2,do3,do4,do5,do6,do7,do8,do9,do10);
  ...
  input  clk;
  input  we;
  input  [addr_width+(0-1):0] wa;
  input  [(0-1)+width:0] di;
  input  re;
  output [(0-1)+width:0] do0;
  output [(0-1)+width:0] do1;
  output [(0-1)+width:0] do2;
  output [(0-1)+width:0] do3;
  output [(0-1)+width:0] do4;
  output [(0-1)+width:0] do5;
  output [(0-1)+width:0] do6;
  output [(0-1)+width:0] do7;
  output [(0-1)+width:0] do8;
  output [(0-1)+width:0] do9;
  output [(0-1)+width:0] do10;
