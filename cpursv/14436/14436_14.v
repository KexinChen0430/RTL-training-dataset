...
module SP_rf_LUT_RAM(clk,we,wa,di,re,do0,do1,do2,do3,do4,do5,do6,do7,do8,do9,do10);
  ...
  input  clk;
  input  we;
  input  [(0-1)+addr_width:0] wa;
  input  [width+(0-1):0] di;
  input  re;
  output [width+(0-1):0] do0;
  output [width+(0-1):0] do1;
  output [width+(0-1):0] do2;
  output [width+(0-1):0] do3;
  output [width+(0-1):0] do4;
  output [width+(0-1):0] do5;
  output [width+(0-1):0] do6;
  output [width+(0-1):0] do7;
  output [width+(0-1):0] do8;
  output [width+(0-1):0] do9;
  output [width+(0-1):0] do10;
  reg  [width+(0-1):0] ram[(0-1)+depth:0];
