...
module fmlarb  #(parameter  fml_depth = 26)
  (input  sys_clk,
   ...
   input  [63:0] m4_di,
   output [63:0] m4_do,
   output reg [(-1)+fml_depth:0] s_adr,
   output reg s_stb,
   output reg s_we,
   input  s_ack,
  ...
  assign m3_ack = s_ack & (master == 3'd3);
