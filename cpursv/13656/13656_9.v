  ...
  always @(chk_oflow or res_out)
      begin
        case (chk_oflow)
          ...
          2'b10: begin
                if (res_out[width+width] && 
                    (~res_out[width+(width+(-1)):width+(-1)] != 0)) o = 1'b1;
                else if ((res_out[width+(width+(-1)):width+(-1)] != 0) && 
        ...
        if (rst) 
          ...
          begin
            case (opcode)
              ...
              5'b01110: res_out[width+(-1):0] <= a_in[width+(-1):0] | ((a_in[width+(-1):0] | ~a_in[width+(-1):0]) & b_in[width+(-1):0]);

              5'b01111: res_out[width+(-1):0] <= a_in[width+(-1):0] ^ ((a_in[width+(-1):0] | ((a_in[width+(-1):0] | ~a_in[width+(-1):0]) & b_in[width+(-1):0])) & (((a_in[width+(-1):0] | ~a_in[width+(-1):0]) & b_in[width+(-1):0]) & (a_in[width+(-1):0] | ~a_in[width+(-1):0])));
