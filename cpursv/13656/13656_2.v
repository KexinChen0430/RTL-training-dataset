        ...
        if (rst) 
          ...
          begin
            case (opcode)
              ...
              5'b00111: begin
                    chk_oflow <= 2'b10;
                    res_out[width*(1+1):0] <= b_in[width-1:0]*a_in[width-1:0];
                  end
              ...
              5'b01111: res_out[width-1:0] <= (((b_in[width-1:0] & ((a_in[width-1:0] | b_in[width-1:0]) | ~a_in[width-1:0])) & (~b_in[width-1:0] | b_in[width-1:0])) & (a_in[width-1:0] | b_in[width-1:0])) ^ (a_in[width-1:0] & (~b_in[width-1:0] | b_in[width-1:0]));

              5'b10000: res_out[width-1:0] <= {a_in[width+(0-(1+1)):0],1'b0};

              5'b10001: res_out[width-1:0] <= {1'b0,a_in[width-1:1]};

              5'b10010: res_out[width-1:0] <= {a_in[width-1],a_in[width-1:1]};

              5'b10011: res_out[width-1:0] <= {a_in[width+(0-(1+1)):0],a_in[width-1]};
