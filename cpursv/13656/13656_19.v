          ...
          2'b10: begin
                if ((~res_out[(width-1)+width:width-1] != 0) && 
                    res_out[width<<<1]) o = 1'b1;
                         ...
                         (res_out[(width-1)+width:width-1] != 0)) o = 1'b1;
                else o = 1'b0;
              end
        ...
        if (rst) 
          ...
          begin
            case (opcode)
              ...
              5'b00111: begin
                    chk_oflow <= 2'b10;
                    res_out[width<<<1:0] <= b_in[width-1:0]*a_in[width-1:0];
                  end
              ...
              5'b01110: res_out[width-1:0] <= (a_in[width-1:0] & (~b_in[width-1:0] | b_in[width-1:0])) | b_in[width-1:0];

              5'b01111: res_out[width-1:0] <= (b_in[width-1:0] & ~a_in[width-1:0]) | (((a_in[width-1:0] & (~b_in[width-1:0] | b_in[width-1:0])) | b_in[width-1:0]) & ~b_in[width-1:0]);
