...
module MusicScore(ReadOrWrite,Address,KeyInput,KeyOutput,TimeInput,TimeOutput,
  ...
  input  [(0-1)+DataLength:0] KeyInput,TimeInput;
  output reg [(0-1)+DataLength:0] KeyOutput,TimeOutput;
  ...
  reg  [(0-1)+DataLength:0] Keys[0:(0-1)+MemorySize];

  reg  [(0-1)+DataLength:0] Times[0:(0-1)+MemorySize];
