...
module jt10_adpcm_comb(input  rst_n,
                       input  clk,
                       input  cen,
                       input  [3:0] data,
                       input  chon,
  ...
  reg  [stepw+(0-1):0] step1,step2,step6;
  reg  [1+stepw:0] step3,step4,step5;
  ...
  always @(*)
      if (!rst_n) 
        ...
        begin
          ...
          if (chon5) 
            begin
              if (signEqu5 && (sign5 != x5[15])) x6 = sign5 ? 16'h8000 : 16'h7FFF;
              else x6 = x5;
              if (step5 < 127) step6 = 15'd127;
              else if (step5 > 24576) step6 = 15'd24576;
              else step6 = step5[14:0];
            end
          else 
            begin
              x6 = 'd0;
