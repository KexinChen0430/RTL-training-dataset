          ...
          begin
            ...
            if (saturate_mode == symmetric) 
              begin
                ...
                for (i = datain_width-round_width; i < ((0-saturate_width)+datain_width); i = 1+i)
                    begin
            ...
            if (saturate_mode == asymmetric) 
              begin
                for (i = 0; i < ((0-saturate_width)+datain_width); i = 1+i)
                    begin
                      max[i] = 1'b1;
                      min[i] = 1'b0;
                    end
            ...
            if (saturate_width == 1) 
              begin
                ...
                else sign_tmp = sign_tmp & datain[datain_width+(-1)];
              end
            else 
              begin
                for (i = (0-saturate_width)+datain_width; i < datain_width; i = 1+i)
                    begin
            ...
            if ((saturate_mode == symmetric) && (sign_tmp == 1'b1) && 
