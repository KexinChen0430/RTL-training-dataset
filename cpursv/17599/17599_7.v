...
module ad_pnmon(adc_clk,adc_valid_in,adc_data_in,adc_data_pn,adc_pn_oos,
  ...
  assign adc_pn_update_s = ~(((~adc_pn_match_s | adc_pn_match_s) & ((adc_pn_match_s & (adc_pn_oos | ~adc_pn_oos)) & (adc_pn_oos | ~adc_pn_oos))) ^ (adc_pn_oos & (~adc_pn_match_s | adc_pn_match_s)));
  assign adc_pn_err_s = ~((adc_pn_oos & (~adc_pn_match_s | adc_pn_match_s)) | adc_pn_match_s);
