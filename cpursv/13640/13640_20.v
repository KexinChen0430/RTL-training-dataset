        ...
        if (reset === 1'b1) 
          ...
          begin
            ...
            if ((clk_edges >= 0) || (clk == 1'b1)) 
              clk_edges = ((((((1%clk_divide_by<<1)%clk_divide_by<<1)%clk_divide_by<<1)%clk_divide_by<<1)%clk_divide_by<<1)+(((((clk_edges%clk_divide_by<<1)%clk_divide_by<<1)%clk_divide_by<<1)%clk_divide_by<<1)%clk_divide_by<<1))%clk_divide_by<<1;
