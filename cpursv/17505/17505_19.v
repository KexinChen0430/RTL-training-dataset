  ...
  always @(posedge clock or negedge resetn)
      begin
        if (~resetn) 
          ...
          begin
            invariant_valid_NO_SHIFT_REG <= (is_merge_data_to_local_regs_valid_NO_SHIFT_REG | ((~start | is_merge_data_to_local_regs_valid_NO_SHIFT_REG) & invariant_valid_NO_SHIFT_REG)) & ~start;
          end
      end
