...
module flt_fx1616_mult(input  clk,
  ...
  always @* 
      sfl_1 = (~(sfx_1 & ((sfx_1 | ~sfx_1) | ((~sfx_1 & (~sbfl_1 | (sbfl_1 | (sfx_1 & ~sbfl_1)))) & (sbfl_1 | (sfx_1 & ~sbfl_1))))) & (((sfx_1 | ~sfx_1) & (sbfl_1 & (sfx_1 | ~sfx_1))) & ((sfx_1 | ~sfx_1) | ((~sfx_1 & (~sbfl_1 | (sbfl_1 | (sfx_1 & ~sbfl_1)))) & (sbfl_1 | (sfx_1 & ~sbfl_1)))))) | ((sfx_1 & ((sfx_1 | ~sfx_1) | ((~sfx_1 & (~sbfl_1 | (sbfl_1 | (sfx_1 & ~sbfl_1)))) & (sbfl_1 | (sfx_1 & ~sbfl_1))))) & ~(((sfx_1 | ~sfx_1) & (sbfl_1 & (sfx_1 | ~sfx_1))) & ((sfx_1 | ~sfx_1) | ((~sfx_1 & (~sbfl_1 | (sbfl_1 | (sfx_1 & ~sbfl_1)))) & (sbfl_1 | (sfx_1 & ~sbfl_1))))));
  
  always @* 
      efl_1 = 8'h10+((0-nom_shft_1)+ebfl_1);
  
  always @* 
      nmfl_1 = mfl_1*(1<<<1**nom_shft_1);
