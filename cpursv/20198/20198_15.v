      ...
      begin
        if (!rstn) 
          ...
          begin
            ...
            sfl_0 <= ((~afl[31] & (afl[31] & bfl[31])) ^ (~afl[31] & ((bfl[31] & ((((bfl[31] | ~bfl[31]) & afl[31]) | bfl[31]) | ~afl[31])) & bfl[31]))) | (((bfl[31] | ~bfl[31]) & afl[31]) & (~afl[31] | ~bfl[31]));
            efl_0 <= ((0-8'h7E)+afl[30:23])+bfl[30:23];
