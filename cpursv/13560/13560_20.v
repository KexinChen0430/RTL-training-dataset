...
module bcdtoseg(nLT,nRBI,A3,A2,A1,A0,nBI,nRBO,nA,nB,nC,nD,nE,nF,nG);
...
(~nBI || 
(~nRBI || 
((SEGIN == 4'd0) && ((SEGIN == 4'd0) || nLT) && nLT))) && (~nBI || nLT))) || 
((~nRBI || ~nBI) && 
((SEGIN == 4'd0) && ((SEGIN == 4'd0) || nLT) && nLT))) && 
(
((SEGIN == 4'd0) && ((SEGIN == 4'd0) || nLT) && nLT) || (~nRBI && ~nBI) || ~nBI) && 
((~nRBI || ~nBI) && 
(
(~nBI || 
(~nRBI || 
