...
module serial(rxd,txd,clk);
  ...
  always @(present_state or snd_busy)
      begin
        case (present_state)
          ...
          1: begin
                snd_start <= 1'b0;
                if (snd_busy == 1'b0) next_state = s2;
          ...
          3: begin
                snd_start <= 1'b0;
                if (snd_busy == 1'b0) next_state = s3;
          ...
          5: begin
                snd_start <= 1'b0;
                if (snd_busy == 1'b0) next_state = s4;
          ...
          7: begin
                snd_start <= 1'b0;
                if (snd_busy == 1'b0) next_state = s1;
