...
module unpipeline  #(parameter 
       WIDTH_D           = 256,
       S_WIDTH_A         = 26,
       M_WIDTH_A         = $clog2((1/8)*WIDTH_D)+S_WIDTH_A,
       BURSTCOUNT_WIDTH  = 1,
