...
module blake2_G(input  wire [63:0] a,
  ...
  always @* 
      begin : G
        ...
        b1 = {b0[23:0],b0[63:24]};
        a1 = (b1+a0)+m1;
        d2 = (~a1 & (a1 | (~a1 & d1))) | ((((a1 | (~a1 & d1)) & (~d1 | d1)) & ~d1) & a1);
        d3 = {d2[15:0],d2[63:16]};
        c1 = c0+d3;
        b2 = (~(((b1 | ~b1) | (((~c1 | c1) & ~b1) & (c1 | ((~c1 | c1) & b1)))) & ((~b1 & b1) | (~c1 & b1))) & (((c1 & b1) ^ c1) & ((b1 | ~b1) | (((~c1 | c1) & ~b1) & (c1 | ((~c1 | c1) & b1)))))) | (~(((c1 & b1) ^ c1) & ((b1 | ~b1) | (((~c1 | c1) & ~b1) & (c1 | ((~c1 | c1) & b1))))) & (((b1 | ~b1) | (((~c1 | c1) & ~b1) & (c1 | ((~c1 | c1) & b1)))) & ((~b1 & b1) | (~c1 & b1))));
        b3 = {b2[62:0],b2[63]};
        internal_a_prim = a1;
        internal_b_prim = b3;
        internal_c_prim = c1;
