...
module blake2_G(input  wire [63:0] a,
  ...
  always @* 
      begin : G
        ...
        a0 = (m0+a)+b;
        d0 = (((a0 | ~a0) & ~d) | ~a0) & ((~d | d) & ((a0 | (((a0 | ~a0) & d) & (((a0 | ~a0) & ~d) | ~a0))) & (a0 | ~a0)));
        d1 = {d0[31:0],d0[63:32]};
        c0 = d1+c;
        b0 = (~((b | (c0 & (~b | b))) & c0) & ((b & (c0 | ~c0)) & (b | (c0 & (~b | b))))) | (~((b & (c0 | ~c0)) & (b | (c0 & (~b | b)))) & ((b | (c0 & (~b | b))) & c0));
        b1 = {b0[23:0],b0[63:24]};
        a1 = b1+(m1+a0);
        d2 = (~d1 & ((d1 | a1) & (~d1 | d1))) | (~a1 & (d1 | a1));
        d3 = {d2[15:0],d2[63:16]};
        c1 = d3+c0;
        b2 = (~c1 & b1) | ((~b1 | ((~c1 & (~b1 & c1)) | (~c1 & b1))) & ((~(c1 & b1) & c1) | ((~c1 & b1) & c1)));
        b3 = {b2[62:0],b2[63]};
        internal_a_prim = a1;
        internal_b_prim = b3;
        internal_c_prim = c1;
