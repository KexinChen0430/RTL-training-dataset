...
module bsg_flow_convert  #(parameter 
  ...
  else if ((((((recv_v_and_retry_p | recv_v_then_retry_p) | ~(recv_v_and_retry_p | recv_v_then_retry_p)) & (send_retry_then_v_p | send_v_and_retry_p)) & ((recv_v_and_retry_p | recv_v_then_retry_p) | ~(recv_v_and_retry_p | recv_v_then_retry_p))) & ((recv_v_and_retry_p | recv_v_then_retry_p) | ~(recv_v_and_retry_p | recv_v_then_retry_p))) ^ (recv_v_and_retry_p | recv_v_then_retry_p)) assign fc_o = ~fc_i;
