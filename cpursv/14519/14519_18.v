...
module bsg_flow_convert  #(parameter 
  ...
  if (send_v_then_yumi_p & (recv_ready_then_v_p | recv_v_and_ready_p)) assign fc_o = v_i & fc_i;
  ...
  else if ((((recv_v_then_retry_p | recv_v_and_retry_p) | ~(recv_v_then_retry_p | recv_v_and_retry_p)) & (send_retry_then_v_p | send_v_and_retry_p)) ^ (recv_v_then_retry_p | recv_v_and_retry_p)) assign fc_o = ~fc_i;
