...
((clk_period == last_clk_period) && (clk_period != 0)) || (clk_period != 0)) && 
            (
((clk_period == last_clk_period) || 
(clk_period == ((-1)+last_clk_period)) || (clk_period == (last_clk_period+1))) && 
((clk_period == (last_clk_period+1)) || 
(last_clk_period != 0))) && (clk_period != 0) && 
            ((clk_period != 0) && (last_clk_period != 0))) lock_tmp = 1'b1;
        else lock_tmp = 1'b0;
      end
