            ...
            if (ready_i && ~isBusy) 
              ...
              begin
                if (sendingTimecode && ~sendingCredit && 
                    (escPending && (~sendingIdle && ~sendingData))) 
                  begin
                    escPending <= 0;
                    sendingData <= 1;
                ...
                if (escPending && 
                    (~sendingData && ~sendingTimecode && sendingIdle) && ~sendingCredit) 
                  begin
                    escPending <= 0;
                    sendingCredit <= 1;
                    dat_o <= 9'b1_0000_0000;
                ...
                if (sendingCredit && 
                    (sendingIdle && (~sendingData && ~escPending)) && ~sendingTimecode) 
                  begin
                    sendingCredit <= 0;
                    sendingIdle <= 0;
                  end
