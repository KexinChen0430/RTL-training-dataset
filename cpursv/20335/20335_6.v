...
((dat_i[1:0] == 2'b10) || 
((dat_i[8] == 1) || 
(((dat_i[1:0] == 2'b10) && (dat_i[1:0] == 2'b01)) || 
((dat_i[1:0] == 2'b10) && (dat_i[8] == 1))))) && 
(((dat_i[1:0] == 2'b10) || (dat_i[1:0] == 2'b01)) && 
((dat_i[1:0] == 2'b01) || (dat_i[8] == 1)))) || (dat_i[1:0] == 2'b10)) && 
((dat_i[8] == 1) && 
(
((dat_i[1:0] == 2'b10) || 
((dat_i[8] == 1) || 
        ...
        if (txReset) 
          ...
          begin
            if (ready_i && ~isBusy) 
              ...
              begin
                if (~sendingIdle && ~sendingCredit && 
                    (sendingTimecode && (escPending && ~sendingData))) 
                  begin
                    escPending <= 0;
                    sendingData <= 1;
                ...
                if (sendingData && ~sendingCredit && 
                    (sendingTimecode && (~escPending && ~sendingIdle))) 
                  begin
                    sendingTimecode <= 0;
                    sendingData <= 0;
                  end
...
(~sendingData && ~sendingTimecode))) 
                ...
                if (~escPending && 
                    (sendingCredit && 
(sendingIdle && (~sendingData && ~sendingTimecode)))) 
                  begin
                    sendingCredit <= 0;
                    sendingIdle <= 0;
                  end
