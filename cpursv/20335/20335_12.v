            ...
            if (~isBusy && ready_i) 
              ...
              begin
                if (~sendingCredit && ~sendingIdle && 
                    (escPending && sendingTimecode) && ~sendingData) 
                  begin
                    escPending <= 0;
                    sendingData <= 1;
                ...
                if (sendingTimecode && sendingData && ~sendingIdle && 
                ...
                if (sendingCredit && 
                    (~escPending && ~sendingIdle && ~sendingTimecode) && ~sendingData) 
                  begin
                    sendingCredit <= 0;
                  end
                  
                if (sendingIdle && 
                    (escPending && (~sendingCredit && ~sendingData)) && ~sendingTimecode) 
                  begin
                    escPending <= 0;
                    sendingCredit <= 1;
                    dat_o <= 9'b1_0000_0000;
                ...
                if (sendingIdle && sendingCredit && ~sendingData && 
