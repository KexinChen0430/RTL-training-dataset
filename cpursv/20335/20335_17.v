...
((dat_i[1:0] == 2'b01) && 
((dat_i[1:0] == 2'b10) || 
((dat_i[1:0] == 2'b01) && (dat_i[8] == 1)))) || ((dat_i[1:0] == 2'b01) && (dat_i[8] == 1))));
          ...
          begin
            if (ready_i && ~isBusy) 
              ...
              begin
                ...
                if (~sendingIdle && ~escPending && ~sendingCredit && 
                ...
                if (~sendingTimecode && 
                    (~sendingIdle && ~sendingData && ~escPending && sendingCredit)) 
                  begin
                    sendingCredit <= 0;
                  end
                ...
                if (sendingCredit && sendingIdle && ~sendingData && ~escPending && 
                    ~sendingTimecode) 
                  begin
                    sendingCredit <= 0;
                    sendingIdle <= 0;
