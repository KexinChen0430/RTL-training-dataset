...
(~sendingCredit && ~sendingData && ~sendingIdle))) 
                ...
                if (sendingTimecode && ~sendingCredit && 
                    (~sendingIdle && sendingData) && ~escPending) 
                  begin
                    sendingTimecode <= 0;
                    sendingData <= 0;
                  end
                  
                if (~sendingTimecode && (~escPending && sendingCredit) && 
                ...
                if (~sendingTimecode && 
                    (sendingIdle && 
(escPending && (~sendingCredit && ~sendingData)))) 
                  begin
                    escPending <= 0;
                    sendingCredit <= 1;
                    dat_o <= 9'b1_0000_0000;
                ...
                if (sendingIdle && 
                    (~sendingTimecode && (~escPending && sendingCredit)) && ~sendingData) 
                  begin
                    sendingCredit <= 0;
                    sendingIdle <= 0;
                  end
