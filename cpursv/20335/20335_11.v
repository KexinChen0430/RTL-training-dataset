        ...
        if (txReset) 
          ...
          begin
            if (~isBusy && ready_i) 
              ...
              begin
                if (escPending && 
                    (~sendingIdle && ~sendingData && sendingTimecode) && ~sendingCredit) 
                  begin
                    escPending <= 0;
                    sendingData <= 1;
                ...
                if (sendingData && ~sendingCredit && 
                    (sendingTimecode && (~sendingIdle && ~escPending))) 
                  begin
                    sendingTimecode <= 0;
                    sendingData <= 0;
                  end
                ...
                if (~sendingData && escPending && sendingIdle && ~sendingTimecode && 
                    ~sendingCredit) 
                  begin
                    escPending <= 0;
                    sendingCredit <= 1;
