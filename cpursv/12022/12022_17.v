...
module Apb3Gpio(input  [3:0] io_apb_PADDR,
  ...
  assign ctrl_askWrite = io_apb_PWRITE && io_apb_PSEL[0] && io_apb_PENABLE;
  assign ctrl_askRead = io_apb_PSEL[0] && !io_apb_PWRITE && io_apb_PENABLE;
  assign ctrl_doWrite = io_apb_PWRITE && io_apb_PREADY && 
                        (io_apb_PSEL[0] && io_apb_PENABLE);
  assign ctrl_doRead = io_apb_PENABLE && 
                       (!io_apb_PWRITE && (io_apb_PREADY && io_apb_PSEL[0]));
