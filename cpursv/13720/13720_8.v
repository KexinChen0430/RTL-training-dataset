  ...
  always @(posedge clk_i)
      begin
        if (reset_i == 1'b0) 
          ...
          begin
            x1 <= x3>>B1 ^ (x3 & (~x3>>B1 | (x3 | x3>>B1)));
            x2 <= (((((2**B2)*x1) | x1) & (x1 | ~x1)) & ~((2**B2)*x1)) | (~x1 & ((((2**B2)*x1) | x1) & (x1 | ~x1)));
            x3 <= ((~x2>>B3 & (x2 | (x2>>B3 & (x2 | ((~x2 & x2>>B3) | ~x2>>B3))))) | ((x2 | (x2>>B3 & (x2 | ((~x2 & x2>>B3) | ~x2>>B3)))) & x2>>B3)) & ((~x2 & x2>>B3) | ~x2>>B3);
          end
      end
