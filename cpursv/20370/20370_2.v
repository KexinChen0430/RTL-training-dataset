...
module NIOS_SYSTEMV3_CH0_YN1_U(address,chipselect,clk,in_port,reset_n,write_n,writedata,
  ...
  assign clk_en = 1;
  assign read_mux_out = ({14{address == 3}} | {14{address == 0}}) & ((((data_in | {14{address == 3}}) & (({14{address == 3}} | {14{address == 0}}) | edge_capture)) & (edge_capture | ({14{address == 0}} & (edge_capture | data_in)))) & (((edge_capture | data_in) & {14{address == 3}}) | ((({14{address == 3}} & ({14{address == 0}} & edge_capture)) | (edge_capture & data_in)) | data_in)));
