...
module stratixiii_delay_chain(datain,delayctrlin,finedelayctrlin,devclrn,devpor,dataout);
  ...
  always @(delayctrlin_in or finedelayctrlin_in)
      begin
        ...
        if (use_finedelayctrlin == true) 
          begin
            rising_dly = finedly_table_rising[finedelayctrlin_in]+dly_table_rising[dly_setting];
            falling_dly = finedly_table_falling[finedelayctrlin_in]+dly_table_falling[dly_setting];
          end
        else 
          begin
