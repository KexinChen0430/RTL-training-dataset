...
module de3d_tc_mc_we(input  mclock,
  ...
  always @* 
      ram_wen_lo = ((((tex_push_en & ram_sel) | (tex_push_en & ~ram_sel)) & ((~ram_sel | (~cs & cs)) | (cs & ram_sel))) & ~cs) | ((tex_push_en & cs) & ((~cs | ~cs) | ram_sel));
  
  always @* 
      ram_wen_hi = (tex_push_en & (~cs & ram_sel)) | ((cs & ~ram_sel) & tex_push_en);
endmodule
