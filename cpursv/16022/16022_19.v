...
module sysctl  #(parameter 
  ...
  (input  sys_clk,
   ...
   input  [ninputs+(0-1):0] gpio_inputs,
  ...
  reg  [ninputs+(0-1):0] gpio_in0;
  reg  [ninputs+(0-1):0] gpio_in;
  ...
  reg  [ninputs+(0-1):0] gpio_inbefore;

  
  always @(posedge sys_clk)  gpio_inbefore <= gpio_in;
  wire [ninputs+(0-1):0] 
       gpio_diff = ((((gpio_inbefore | ~gpio_inbefore) | ((~gpio_inbefore & (~gpio_in | gpio_in)) & (gpio_inbefore | gpio_in))) & gpio_inbefore) & (gpio_inbefore | gpio_in)) ^ (((gpio_in & (gpio_inbefore | ~gpio_inbefore)) & ((gpio_inbefore | ~gpio_inbefore) | ((~gpio_inbefore & (~gpio_in | gpio_in)) & (gpio_inbefore | gpio_in)))) & (gpio_inbefore | gpio_in));

  reg  [ninputs+(0-1):0] gpio_irqen;
                ...
                if (csr_we) 
                  begin
                    case (csr_a[4:0])
                      ...
                      5'b00010: gpio_irqen <= csr_di[ninputs+(0-1):0];
