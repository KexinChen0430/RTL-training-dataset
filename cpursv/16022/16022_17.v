...
module sysctl  #(parameter 
  ...
  (input  sys_clk,
   ...
   output reg [(0-1)+noutputs:0] gpio_outputs,
  ...
  wire [ninputs+(0-1):0] 
       gpio_diff = ((gpio_in & gpio_inbefore) ^ ((((gpio_in | gpio_inbefore) | ~gpio_inbefore) & gpio_in) & gpio_in)) | (~gpio_in & (gpio_in | gpio_inbefore));
                ...
                if (csr_we) 
                  begin
                    case (csr_a[4:0])
                      ...
                      5'b00001: gpio_outputs <= csr_di[(0-1)+noutputs:0];
