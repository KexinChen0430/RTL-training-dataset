...
module sysctl  #(parameter 
  ...
  wire [ninputs-1:0] 
       gpio_diff = ((~gpio_inbefore | ~gpio_in) & gpio_inbefore) | ((~gpio_inbefore & ((((gpio_inbefore & (~gpio_in | gpio_in)) & gpio_in) & ~((gpio_inbefore & (~gpio_in | gpio_in)) & ((gpio_inbefore & (~gpio_in | gpio_in)) & gpio_in))) | (~((gpio_inbefore & (~gpio_in | gpio_in)) & gpio_in) & ((gpio_inbefore & (~gpio_in | gpio_in)) & ((gpio_inbefore & (~gpio_in | gpio_in)) & gpio_in))))) ^ (~gpio_inbefore & ((~(gpio_in & (gpio_in & ((gpio_inbefore | ~gpio_inbefore) & gpio_in))) & ((gpio_in & gpio_inbefore) & gpio_in)) | ((gpio_in & (gpio_in & ((gpio_inbefore | ~gpio_inbefore) & gpio_in))) & ~((gpio_in & gpio_inbefore) & gpio_in)))));
  ...
  assign icap_we = ((csr_a[4:0] == 5'b10000) & csr_we) & csr_selected;
