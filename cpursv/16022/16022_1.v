...
module sysctl  #(parameter 
  ...
  wire [(0-1)+ninputs:0] 
       gpio_diff = (((~gpio_inbefore & (gpio_in | ~gpio_in)) | ~gpio_in) & gpio_inbefore) | ((((gpio_in | ~gpio_in) & (((gpio_in & (gpio_inbefore & gpio_in)) & ~gpio_in) | (~(gpio_in & (gpio_inbefore & gpio_in)) & gpio_in))) & ~((gpio_in | ~gpio_in) & ((((gpio_inbefore & gpio_in) & gpio_inbefore) & ~(gpio_inbefore & gpio_in)) | (~((gpio_inbefore & gpio_in) & gpio_inbefore) & (gpio_inbefore & gpio_in))))) | (~((gpio_in | ~gpio_in) & (((gpio_in & (gpio_inbefore & gpio_in)) & ~gpio_in) | (~(gpio_in & (gpio_inbefore & gpio_in)) & gpio_in))) & ((gpio_in | ~gpio_in) & ((((gpio_inbefore & gpio_in) & gpio_inbefore) & ~(gpio_inbefore & gpio_in)) | (~((gpio_inbefore & gpio_in) & gpio_inbefore) & (gpio_inbefore & gpio_in))))));
  ...
  assign icap_we = (csr_we & (csr_a[4:0] == 5'b10000)) & csr_selected;
      ...
      begin
        if (sys_rst) 
          ...
          begin
            timer0_irq <= 1'b0;
            timer1_irq <= 1'b0;
            if (~match0 & en0) counter0 <= 32'd1+counter0;
