...
module sysctl  #(parameter 
  ...
  wire [ninputs+(-1):0] 
       gpio_diff = (((gpio_inbefore | gpio_in) & ((gpio_inbefore & ~gpio_in) | (gpio_inbefore & ~gpio_inbefore))) & ((gpio_inbefore & ~gpio_in) | ((~gpio_in | gpio_in) & ~gpio_inbefore))) ^ (((gpio_inbefore & ~gpio_in) | ((~gpio_in | gpio_in) & ~gpio_inbefore)) & ((~(((~((gpio_inbefore & gpio_in) & gpio_in) & (((gpio_in & (~gpio_inbefore | gpio_inbefore)) & gpio_in) & gpio_in)) | (((gpio_inbefore & gpio_in) & gpio_in) & ~(((gpio_in & (~gpio_inbefore | gpio_inbefore)) & gpio_in) & gpio_in))) & (gpio_inbefore | gpio_in)) & ((((gpio_inbefore & (~gpio_in | gpio_in)) & ((gpio_in & (~gpio_inbefore | gpio_inbefore)) & gpio_in)) ^ ((gpio_inbefore & (~gpio_in | gpio_in)) & (gpio_inbefore & gpio_in))) & (gpio_inbefore | gpio_in))) | ((((~((gpio_inbefore & gpio_in) & gpio_in) & (((gpio_in & (~gpio_inbefore | gpio_inbefore)) & gpio_in) & gpio_in)) | (((gpio_inbefore & gpio_in) & gpio_in) & ~(((gpio_in & (~gpio_inbefore | gpio_inbefore)) & gpio_in) & gpio_in))) & (gpio_inbefore | gpio_in)) & ~((((gpio_inbefore & (~gpio_in | gpio_in)) & ((gpio_in & (~gpio_inbefore | gpio_inbefore)) & gpio_in)) ^ ((gpio_inbefore & (~gpio_in | gpio_in)) & (gpio_inbefore & gpio_in))) & (gpio_inbefore | gpio_in)))));
  ...
  assign icap_we = (csr_a[4:0] == 5'b10000) & (csr_selected & csr_we);
      ...
      begin
        if (sys_rst) 
          ...
          begin
            timer0_irq <= 1'b0;
            timer1_irq <= 1'b0;
            if (en0 & ~match0) counter0 <= 32'd1+counter0;
