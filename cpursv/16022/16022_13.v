...
module sysctl  #(parameter 
  ...
  wire [(-1)+ninputs:0] 
       gpio_diff = (((~gpio_inbefore & ((gpio_in & ~((gpio_inbefore & gpio_in) & gpio_in)) | (~gpio_in & ((gpio_inbefore & gpio_in) & gpio_in)))) & ~((gpio_in & ((gpio_inbefore & (~gpio_in | gpio_in)) & (~gpio_in | ~gpio_inbefore))) & ~gpio_inbefore)) | (~(~gpio_inbefore & ((gpio_in & ~((gpio_inbefore & gpio_in) & gpio_in)) | (~gpio_in & ((gpio_inbefore & gpio_in) & gpio_in)))) & ((gpio_in & ((gpio_inbefore & (~gpio_in | gpio_in)) & (~gpio_in | ~gpio_inbefore))) & ~gpio_inbefore))) | ((gpio_inbefore & (~gpio_in | gpio_in)) & (~gpio_in | ~gpio_inbefore));
                ...
                if (csr_we) 
                  begin
                    case (csr_a[4:0])
                      ...
                      5'b00010: gpio_irqen <= csr_di[(-1)+ninputs:0];
