...
module sysctl  #(parameter 
  ...
  (input  sys_clk,
   ...
   output reg [noutputs+(0-1):0] gpio_outputs,
  ...
  wire [(0-1)+ninputs:0] 
       gpio_diff = (~((((gpio_inbefore | gpio_in) | ~gpio_inbefore) & ((~gpio_in | gpio_in) & gpio_inbefore)) & (((gpio_inbefore | gpio_in) | ~gpio_inbefore) | ((gpio_inbefore | gpio_in) & ((~gpio_in | gpio_in) & ~gpio_inbefore)))) & ((gpio_in & ((gpio_inbefore | gpio_in) | ~gpio_inbefore)) & (((gpio_inbefore | gpio_in) | ~gpio_inbefore) | ((gpio_inbefore | gpio_in) & ((~gpio_in | gpio_in) & ~gpio_inbefore))))) | (((((gpio_inbefore | gpio_in) | ~gpio_inbefore) & ((~gpio_in | gpio_in) & gpio_inbefore)) & (((gpio_inbefore | gpio_in) | ~gpio_inbefore) | ((gpio_inbefore | gpio_in) & ((~gpio_in | gpio_in) & ~gpio_inbefore)))) & ~((gpio_in & ((gpio_inbefore | gpio_in) | ~gpio_inbefore)) & (((gpio_inbefore | gpio_in) | ~gpio_inbefore) | ((gpio_inbefore | gpio_in) & ((~gpio_in | gpio_in) & ~gpio_inbefore)))));
  ...
  always @(posedge sys_clk)
      begin
        ...
        else gpio_irq <= |(gpio_diff & gpio_irqen);
      end
  reg  en0,en1;
  ...
  assign icap_we = (csr_selected & (csr_a[4:0] == 5'b10000)) & csr_we;
      ...
      begin
        if (sys_rst) 
          ...
          begin
            timer0_irq <= 1'b0;
            timer1_irq <= 1'b0;
            if (~match0 & en0) counter0 <= counter0+32'd1;
              
            if (match0 & en0) timer0_irq <= 1'b1;
              
            if (ar0 & match0) counter0 <= 32'd1;
              
            if (match0 & ~ar0) en0 <= 1'b0;
              
            if (~match1 & en1) counter1 <= counter1+32'd1;
              
            if (en1 & match1) timer1_irq <= 1'b1;
              
            if (match1 & ar1) counter1 <= 32'd1;
                ...
                if (csr_we) 
                  begin
                    case (csr_a[4:0])
                      ...
                      5'b00001: gpio_outputs <= csr_di[noutputs+(0-1):0];
