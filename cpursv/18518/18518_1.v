...
module speaker_iface(input  clk_i,
                     input  rst_i,
      ...
      begin
        if (rst_i) 
          ...
          begin
            ...
            if ((bCurrentClk != bFilterClk2) && 
                (bFilterClk1 == bFilterClk2)) 
              begin
                bCurrentClk <= bFilterClk2;
                if (bCurrentClk == 1'b1) fBCLK_HL <= 1'b1;
                  
              end
              
            if (fBCLK_HL) fBCLK_HL <= 1'b0;
              
          end
      end
  
  always @(posedge clk_i)  bDACLRCK <= aud_daclrck_i;
          ...
          begin
            ...
            if (bDACLRCK != bDACLRCK_old) 
              ...
              begin
                ...
                if (!fADCReady) {fADCReady,rADC} <= {rADC,aud_adcdat_i};
                  
              end
          end
        else if (ready_o) ready_o <= 1'b0;
