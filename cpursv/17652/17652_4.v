...
module DmaController(input  clk,
  ...
  always @(posedge clk)
      if (reset) 
        ...
        begin
          if (dmc_trigger && cpu_read && 
              ((dmc_state == 0) && 
(dmc_trigger || 
(cpu_read && (dmc_trigger || spr_state[0])))) && !odd_cycle) dmc_state <= 1;
          ...
          if (cpu_read && odd_cycle && (spr_state == 1)) spr_state <= 3;
  ...
  assign pause_cpu = cpu_read && (dmc_trigger || spr_state[0]);
