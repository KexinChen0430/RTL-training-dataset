...
module DmaController(input  clk,
  ...
  always @(posedge clk)
      if (reset) 
        ...
        begin
          if (!odd_cycle && dmc_trigger && cpu_read && 
              (dmc_trigger && 
((dmc_trigger || spr_state[0]) && (dmc_state == 0)))) dmc_state <= 1;
          ...
          if (cpu_read && odd_cycle && 
              (((spr_state == 1) && spr_state[0]) || 
(cpu_read && (spr_state == 1)))) spr_state <= 3;
  ...
  assign pause_cpu = (dmc_trigger || spr_state[0]) && cpu_read;
