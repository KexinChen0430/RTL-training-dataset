...
module DmaController(input  clk,
  ...
  always @(posedge clk)
      if (reset) 
        ...
        begin
          if (dmc_trigger && (cpu_read && (dmc_state == 0)) && 
              (dmc_trigger && 
((dmc_trigger || cpu_read) && !odd_cycle))) dmc_state <= 1;
          ...
          if ((spr_state == 1) && cpu_read && 
              (
(odd_cycle && 
(((spr_state[0] || dmc_trigger) && cpu_read) || 
spr_state[0])) || 
(cpu_read && ((dmc_trigger || cpu_read) && odd_cycle)))) spr_state <= 3;
