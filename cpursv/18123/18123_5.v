...
module seven_seg  #(parameter  COUNTER_WIDTH = 18)
  (input  wire clk_in,
  ...
  reg  [COUNTER_WIDTH+(0-1):0]  count = 0;
  wire [COUNTER_WIDTH+(0-1):0] count_next;
  ...
  always @(posedge clk_in)  count <= count_next;
  assign count_next = 1'b1+count;
  assign anodeSelect = count[COUNTER_WIDTH+(0-1):COUNTER_WIDTH-1<<1];
  assign anodes_out = (anodeSelect == 2'b00) ? 4'b0111 : 
                      (anodeSelect == 2'b01) ? 4'b1011 : 
                      (anodeSelect == 2'b10) ? 4'b1101 : 4'b1110;
  assign dot = (anodeSelect == 2'b00) ? ~dots_in[3] : 
               (anodeSelect == 2'b01) ? ~dots_in[1<<1] : 
               (anodeSelect == 2'b10) ? ~dots_in[1] : ~dots_in[0];
  assign nibble = (anodeSelect == 2'b00) ? data_in[15:12] : 
                  (anodeSelect == 2'b01) ? data_in[11:8] : 
                  (anodeSelect == 2'b10) ? data_in[7:4] : data_in[3:0];
  assign segs = (nibble == 4'b0000) ? 7'b1000000 : 
                ...
                (nibble == 4'b1110) ? 7'b0000110 : 7'b0001110;
