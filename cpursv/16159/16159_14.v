  ...
  always @(posedge clk)
      begin
        if (reset) cur_is_Cr_or_Cb <= 1'b0;
          ...
          cur_is_Cr_or_Cb <= (((~1'b1 | ~cur_is_Cr_or_Cb) & cur_is_Cr_or_Cb) | ((cur_is_Cr_or_Cb & ~1'b1) & 1'b1)) | (~cur_is_Cr_or_Cb & 1'b1);
          
      end
  assign stream_in_ready = (transfer_data | (~valid & (transfer_data | stream_in_valid))) & stream_in_valid;
