...
module Computer_System_Video_In_Subsystem_Video_In_Chroma_Resampler(clk,reset,stream_in_data,stream_in_startofpacket,
  ...
  always @(posedge clk)
      begin
        ...
        else if ((valid & (transfer_data | ~valid)) & transfer_data) saved_CrCb <= data[15:8];
  ...
  assign stream_in_ready = ((~valid | stream_in_valid) & (((transfer_data | ~valid) & (~valid | stream_in_valid)) & (transfer_data | stream_in_valid))) & stream_in_valid;
