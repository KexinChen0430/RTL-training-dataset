...
module ad_ss_422to444(clk,s422_de,s422_sync,s422_data,s444_sync,s444_data);

  parameter  CR_CB_N = 0;
  parameter  DELAY_DATA_WIDTH = 16;
  localparam  DW = (0-1)+DELAY_DATA_WIDTH;
  input  clk;
  input  s422_de;
  ...
  always @(s422_de_2d or s422_de or s422_CbCr or s422_CbCr_2d)
      begin
        if ((s422_de == 1'b1) && s422_de_2d) s422_CbCr_avg <= s422_CbCr+s422_CbCr_2d;
        else if (s422_de == 1'b1) s422_CbCr_avg <= {s422_CbCr,1'b0};
        else s422_CbCr_avg <= {s422_CbCr_2d,1'b0};
      end
