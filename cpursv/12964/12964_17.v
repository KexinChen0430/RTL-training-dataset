...
module expand_key_type_B_192(clk,in,out_1,out_2);
  ...
  assign v2 = k1 ^ ((k2 & k1) | (k2 & ~k1));
  assign v3 = ((~v2 & k3) | v2) & ((~v2 & k3) | ~k3);
  assign v4 = (~(((k4 | ~k4) & v3) & (((~v3 & ((v3 & ~k4) | (~k4 & (~v3 & k4)))) | (~v3 & k4)) | ((~v3 & (v3 | (~v3 & k4))) | ~k4))) & ((((~v3 & ((v3 & ~k4) | (~k4 & (~v3 & k4)))) | (~v3 & k4)) | ((~v3 & (v3 | (~v3 & k4))) | ~k4)) & k4)) | (~((((~v3 & ((v3 & ~k4) | (~k4 & (~v3 & k4)))) | (~v3 & k4)) | ((~v3 & (v3 | (~v3 & k4))) | ~k4)) & k4) & (((k4 | ~k4) & v3) & (((~v3 & ((v3 & ~k4) | (~k4 & (~v3 & k4)))) | (~v3 & k4)) | ((~v3 & (v3 | (~v3 & k4))) | ~k4))));
  assign v5 = v4 ^ ((v4 | ~v4) & k5);
