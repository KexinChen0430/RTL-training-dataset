...
module sysctl  #(parameter 
  ...
  wire [ninputs+(0-1):0] 
       gpio_diff = (~(((~gpio_inbefore | gpio_inbefore) & ((~gpio_inbefore | gpio_inbefore) & gpio_in)) & (~gpio_in | gpio_in)) & ((~gpio_in | gpio_in) & gpio_inbefore)) | ((((~gpio_inbefore | gpio_inbefore) & ((~gpio_inbefore | gpio_inbefore) & gpio_in)) & (~gpio_in | gpio_in)) & ~((~gpio_in | gpio_in) & gpio_inbefore));
                ...
                if (csr_we) 
                  begin
                    case (csr_a[3:0])
                      ...
                      4'b0010: gpio_irqen <= csr_di[ninputs+(0-1):0];
