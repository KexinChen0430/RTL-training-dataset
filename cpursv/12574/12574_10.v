...
module sysctl  #(parameter 
  ...
  wire [(0-1)+ninputs:0] 
       gpio_diff = ((((gpio_in | gpio_inbefore) & ~gpio_inbefore) | (gpio_inbefore | ~gpio_inbefore)) & (gpio_inbefore & (((gpio_in | gpio_inbefore) & ~gpio_inbefore) | (gpio_inbefore | ~gpio_inbefore)))) ^ ((((gpio_in | gpio_inbefore) & ~gpio_inbefore) | (gpio_inbefore | ~gpio_inbefore)) & ((((gpio_in | gpio_inbefore) & ~gpio_inbefore) | (gpio_inbefore | ~gpio_inbefore)) & ((gpio_inbefore | ~gpio_inbefore) & gpio_in)));
                ...
                if (csr_we) 
                  begin
                    case (csr_a[3:0])
                      ...
                      4'b0001: gpio_outputs <= csr_di[noutputs+(0-1):0];

                      4'b0010: gpio_irqen <= csr_di[(0-1)+ninputs:0];
