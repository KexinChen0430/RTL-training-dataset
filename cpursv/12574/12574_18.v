...
module sysctl  #(parameter 
  ...
  reg  [(-1)+ninputs:0] gpio_inbefore;

  
  always @(posedge sys_clk)  gpio_inbefore <= gpio_in;
  wire [(-1)+ninputs:0] 
       gpio_diff = (~((((gpio_in | ~gpio_in) & gpio_inbefore) | gpio_in) & ((gpio_in & (gpio_inbefore | ~gpio_inbefore)) & ((gpio_inbefore | ~gpio_inbefore) | ((((gpio_in | ~gpio_in) & gpio_inbefore) | gpio_in) & ~gpio_inbefore)))) & ((((gpio_inbefore | ~gpio_inbefore) | ((((gpio_in | ~gpio_in) & gpio_inbefore) | gpio_in) & ~gpio_inbefore)) & gpio_inbefore) & (((gpio_in | ~gpio_in) & gpio_inbefore) | gpio_in))) | (((((gpio_in | ~gpio_in) & gpio_inbefore) | gpio_in) & ((gpio_in & (gpio_inbefore | ~gpio_inbefore)) & ((gpio_inbefore | ~gpio_inbefore) | ((((gpio_in | ~gpio_in) & gpio_inbefore) | gpio_in) & ~gpio_inbefore)))) & ~((((gpio_inbefore | ~gpio_inbefore) | ((((gpio_in | ~gpio_in) & gpio_inbefore) | gpio_in) & ~gpio_inbefore)) & gpio_inbefore) & (((gpio_in | ~gpio_in) & gpio_inbefore) | gpio_in)));

  reg  [(-1)+ninputs:0] gpio_irqen;
                ...
                if (csr_we) 
                  begin
                    case (csr_a[3:0])
                      ...
                      4'b0010: gpio_irqen <= csr_di[(-1)+ninputs:0];
