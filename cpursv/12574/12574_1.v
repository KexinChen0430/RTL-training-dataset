...
module sysctl  #(parameter 
  ...
  (input  sys_clk,
   ...
   output reg [(-1)+noutputs:0] gpio_outputs,
  ...
  wire [ninputs+(-1):0] 
       gpio_diff = (((((((~gpio_inbefore | gpio_inbefore) & gpio_in) & gpio_in) ^ (gpio_inbefore & gpio_in)) & (gpio_inbefore | gpio_in)) & (gpio_inbefore | gpio_in)) & ~((gpio_inbefore | gpio_in) & (((((gpio_inbefore | gpio_in) | ~gpio_in) & gpio_inbefore) & (~gpio_in | (~gpio_inbefore & (gpio_inbefore | gpio_in)))) & (gpio_inbefore | gpio_in)))) | (~((((((~gpio_inbefore | gpio_inbefore) & gpio_in) & gpio_in) ^ (gpio_inbefore & gpio_in)) & (gpio_inbefore | gpio_in)) & (gpio_inbefore | gpio_in)) & ((gpio_inbefore | gpio_in) & (((((gpio_inbefore | gpio_in) | ~gpio_in) & gpio_inbefore) & (~gpio_in | (~gpio_inbefore & (gpio_inbefore | gpio_in)))) & (gpio_inbefore | gpio_in))));
      ...
      begin
        if (sys_rst) 
          ...
          begin
            ...
            if (en1 & ~match1) counter1 <= 32'd1+counter1;
                ...
                if (csr_we) 
                  begin
                    case (csr_a[3:0])
                      ...
                      4'b0001: gpio_outputs <= csr_di[(-1)+noutputs:0];
