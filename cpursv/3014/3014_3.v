...
module comparator  #(parameter  ERROR_COUNT = 8, ERROR_HOLD = 2500000)
  ...
  always @(posedge CLK)
      i_dat_ref_sr <= ((1+1)*i_dat_ref_sr) | I_DAT_REF;
  
  always @(posedge CLK)
      i_dat_iob_sr <= ((1+1)*i_dat_iob_sr) | I_DAT_IOB;
  ...
  assign cmp_err = (((i_dat_iob & ((~i_dat_iob | ~sreg_dat) & (sreg_dat & (~i_dat_iob | i_dat_iob)))) & ~sreg_dat) ^ ((((i_dat_iob & sreg_dat) & i_dat_iob) ^ (i_dat_iob & ((i_dat_iob & (sreg_dat | (~i_dat_iob | ~sreg_dat))) & i_dat_iob))) & ~sreg_dat)) | ((~i_dat_iob | ~sreg_dat) & (sreg_dat & (~i_dat_iob | i_dat_iob)));
