...
module comparator  #(parameter  ERROR_COUNT = 8, ERROR_HOLD = 2500000)
  ...
  always @(posedge CLK)
      i_dat_iob_sr <= (i_dat_iob_sr*2) | I_DAT_IOB;
  ...
  assign cmp_err = ((sreg_dat & i_dat_iob) | (~sreg_dat & i_dat_iob)) ^ ((sreg_dat & (~i_dat_iob | (sreg_dat | i_dat_iob))) & (sreg_dat | ~sreg_dat));
