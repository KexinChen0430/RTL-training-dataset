...
module eth_rxstatem(MRxClk,Reset,MRxDV,ByteCntEq0,ByteCntGreat2,Transmitting,
  ...
  assign StartIdle = (~MRxDV & (StateSFD | (StatePreamble | |StateData))) | (~MRxDV & StateDrop);
  assign StartPreamble = (StateIdle & (~Transmitting & MRxDV)) & ~MRxDEq5;
  assign StartSFD = (((MRxDV & (MRxDEq5 & StatePreamble)) | (~Transmitting & (MRxDEq5 & MRxDV))) & StateIdle) | (StatePreamble & ((MRxDV & (MRxDEq5 & StatePreamble)) | (~Transmitting & (MRxDEq5 & MRxDV))));
  assign StartData0 = MRxDV & ((StateData1 | StateSFD) & (((MRxDEqD & IFGCounterEq24) & MRxDV) | StateData1));
  assign StartData1 = StateData0 & (MRxDV & ~ByteCntMaxFrame);
  assign StartDrop = (((ByteCntMaxFrame & StateData0) & MRxDV) | ((StateSFD & (MRxDV & ~IFGCounterEq24)) & MRxDEqD)) | (((((~IFGCounterEq24 & StateSFD) | Transmitting) & (Transmitting | MRxDEqD)) & StateIdle) & MRxDV);
      ...
      begin
        if (Reset) 
          ...
          begin
            ...
            if (StartDrop | (StartSFD | StartIdle)) StatePreamble <= #Tp 1'b0;
            else if (StartPreamble) StatePreamble <= #Tp 1'b1;
              
            if (((StartData0 | StartIdle) | StartDrop) | StartPreamble) StateSFD <= #Tp 1'b0;
