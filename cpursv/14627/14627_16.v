...
module eth_rxstatem(MRxClk,Reset,MRxDV,ByteCntEq0,ByteCntGreat2,Transmitting,
  ...
  assign StartIdle = ((~MRxDV & StateDrop) | (~MRxDV & |StateData)) | ((StatePreamble & ~MRxDV) | ((StateSFD & ~MRxDV) | (~MRxDV & |StateData)));
  assign StartPreamble = MRxDV & (~MRxDEq5 & (StateIdle & ~Transmitting));
  assign StartSFD = ((StateIdle & ~Transmitting) | (MRxDV & (MRxDEq5 & StatePreamble))) & (MRxDEq5 & MRxDV);
  assign StartData0 = (StateSFD | (MRxDV & StateData1)) & ((MRxDV & StateData1) | (MRxDEqD & (MRxDV & IFGCounterEq24)));
  assign StartData1 = (StateData0 & ~ByteCntMaxFrame) & MRxDV;
  assign StartDrop = (((StateIdle | StateSFD) & (StateIdle | (~IFGCounterEq24 & MRxDEqD))) & (((~IFGCounterEq24 & MRxDEqD) & (MRxDV & StateSFD)) | (MRxDV & Transmitting))) | ((StateData0 & ((((MRxDEqD | (StateIdle & Transmitting)) & ~IFGCounterEq24) & StateSFD) | ((StateIdle & Transmitting) | ByteCntMaxFrame))) & MRxDV);
      ...
      begin
        if (Reset) 
          ...
          begin
            ...
            if (((StartData0 | StartDrop) | StartPreamble) | StartIdle) StateSFD <= #Tp 1'b0;
