...
module ExpRegisterFile(clk_in,reset_in,writeEnableR0_in,writeEnableR1_in,
                       writeValueR0_in,writeValueR1_in,readSelectA_in,readSelectB_in,
  ...
  input  [(0-1)+REGISTER_WIDTH:0] writeValueR0_in,writeValueR1_in;
  input  [1+1:0] readSelectA_in,readSelectB_in;
  output reg [(0-1)+REGISTER_WIDTH:0] readResultA_out,readResultB_out;
  reg  [(0-1)+REGISTER_WIDTH:0] reg0,reg1;
