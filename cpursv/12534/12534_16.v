...
module uartmm(input  clk,
  ...
  assign uart_busy = 0;
  assign strobe_b = (addr_b == 65538) | ((addr_b == 65537) | (addr_b == 65539));
  ...
  always @(posedge clk)
      if (~rst) 
        ...
        begin
          ...
          else if (((addr_b == 65539) & ~data_b_we) & uart_valid_r) 
            begin
              uart_valid_r <= 0;
            end
          else if (~uart_wr & ((uart_ready & data_b_we) & (addr_b == 65539))) 
            begin
