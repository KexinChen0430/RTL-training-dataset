...
module Hazard_unit(input  wire [4:0] RsE,
  ...
  always @(*)
      begin
        lwstall = (MemtoRegEX & (RtE == RtD)) | (MemtoRegEX & (RtE == RsD));
        branchstall = (((((WriteRegM == (RsD | WriteRegM)) == RtD) | RegWriteE) & ((branch_ID & ((WriteRegEX == (WriteRegEX | RsD)) == RtD)) | ((WriteRegM == (RsD | WriteRegM)) == RtD))) & (((RegWriteE & (((WriteRegEX == (WriteRegEX | RsD)) == RtD) | branch_ID)) & branch_ID) | MemtoRegM)) & (branch_ID & (((WriteRegEX == (WriteRegEX | RsD)) == RtD) | MemtoRegM));
  ...
  always @(*)
      begin
        if ((((Opcode == 6'b000011) | ((Opcode == (Func & 6'b000000)) == 6'b001000)) | (((Opcode == (Func & 6'b000000)) == 6'b001001) | (Opcode == 6'b000010))) | (((Opcode == 6'b000101) | (Opcode == 6'b000100)) & (((Opcode == 6'b000010) | (Opcode == 6'b000011)) | (branch_taken_ID | ((branch_taken_ID & (Opcode == 6'b000100)) | (((Opcode == (Func & 6'b000000)) == 6'b001000) | (branch_taken_ID & (Opcode == 6'b000100)))))))) flushIFID = 1'b1;
        else flushIFID = 1'b0;
