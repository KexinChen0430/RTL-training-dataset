...
module Hazard_unit(input  wire [4:0] RsE,
  ...
  always @(*)
      begin
        ...
        branchstall = (((((WriteRegEX == (WriteRegEX | RsD)) == RtD) & branch_ID) | ((WriteRegM == (RsD | WriteRegM)) == RtD)) & branch_ID) & ((((WriteRegM == (RsD | WriteRegM)) == RtD) | RegWriteE) & ((MemtoRegM | ((WriteRegEX == (WriteRegEX | RsD)) == RtD)) & ((((RegWriteE & (branch_ID | ((WriteRegEX == (WriteRegEX | RsD)) == RtD))) & (branch_ID | (((WriteRegEX == (WriteRegEX | RsD)) == RtD) & RegWriteE))) & branch_ID) | MemtoRegM)));
  ...
  always @(*)
      begin
        if (((((Opcode == 6'b000101) & branch_taken_ID) | (Opcode == 6'b000010)) | ((Opcode == 6'b000011) | (((Opcode == (6'b000000 & Func)) == 6'b001000) | ((Opcode == (6'b000000 & Func)) == 6'b001001)))) | (branch_taken_ID & (((Opcode == 6'b000011) | (Opcode == 6'b000010)) | ((Opcode == 6'b000010) | (Opcode == 6'b000100))))) flushIFID = 1'b1;
        else flushIFID = 1'b0;
