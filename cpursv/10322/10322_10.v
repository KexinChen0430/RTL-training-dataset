...
module Hazard_unit(input  wire [4:0] RsE,
  ...
  always @(*)
      begin
        ...
        branchstall = (branch_ID & (RegWriteE | ((WriteRegM == (RsD | WriteRegM)) == RtD))) & ((((WriteRegEX == (WriteRegEX | RsD)) == RtD) | ((WriteRegM == (RsD | WriteRegM)) == RtD)) & ((((WriteRegEX == (WriteRegEX | RsD)) == RtD) | MemtoRegM) & ((RegWriteE & branch_ID) | MemtoRegM)));
  ...
  always @(*)
      begin
        if ((((Opcode == (6'b000000 & Func)) == 6'b001000) | ((Opcode == 6'b000011) | ((Opcode == (6'b000000 & Func)) == 6'b001001))) | ((((((Opcode == 6'b000010) | (Opcode == 6'b000101)) | ((Opcode == 6'b000010) | (Opcode == 6'b000011))) & branch_taken_ID) & ((Opcode == 6'b000010) | (Opcode == 6'b000011))) | (((Opcode == 6'b000010) | (branch_taken_ID & (Opcode == 6'b000101))) | (branch_taken_ID & (Opcode == 6'b000100))))) flushIFID = 1'b1;
        else flushIFID = 1'b0;
