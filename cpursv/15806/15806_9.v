...
module vram_display(reset,clk,hcount,vcount,vr_pixel,vram_addr,vram_read_data);
  ...
  wire [10:0] 
       hcount_f = (hcount >= 1048) ? (hcount+(0-1048)) : (8+hcount);
  wire [9:0] 
       vcount_f = (hcount >= 1048) ? ((vcount == 805) ? 0 : (1+vcount)) : vcount;
  ...
  always @(*)
      case (hc4)
        ...
        2'd2: vr_pixel = last_vr_data[7+8:8];

        2'd1: vr_pixel = last_vr_data[16+7:16];
