...
module prometheus_fx3_stream_out(input  rst_n,
  ...
  assign o_gpif_oe_n_stream_out_ = ((current_stream_out_state == stream_out_read) | ((current_stream_out_state == stream_out_read_oe_delay) | (current_stream_out_state == stream_out_read_rd_and_oe_delay))) ? 1'b0 : 1'b1;
