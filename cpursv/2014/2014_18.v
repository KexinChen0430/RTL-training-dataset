...
module prometheus_fx3_stream_out(input  rst_n,
  ...
  assign o_gpif_oe_n_stream_out_ = (((current_stream_out_state == stream_out_read_oe_delay) | (current_stream_out_state == stream_out_read_rd_and_oe_delay)) | (current_stream_out_state == stream_out_read)) ? 1'b0 : 1'b1;
  ...
  always @(posedge clk_100 or negedge rst_n)
      begin
        ...
        else if ((rd_oe_delay_cnt > 1'b0) & (current_stream_out_state == stream_out_read_rd_and_oe_delay)) 
          begin
            rd_oe_delay_cnt <= (-1'b1)+rd_oe_delay_cnt;
          end
        else 
          begin
  ...
  always @(posedge clk_100 or negedge rst_n)
      begin
        ...
        else if ((current_stream_out_state == stream_out_read_oe_delay) & (oe_delay_cnt > 1'b0)) 
          begin
            oe_delay_cnt <= (-1'b1)+oe_delay_cnt;
          end
        else 
          begin
      ...
      begin
        ...
        case (current_stream_out_state)
          ...
          stream_out_idle: begin
                if ((i_gpif_in_ch1_rdy_d == 1'b1) & stream_out_mode_selected) 
                  begin
