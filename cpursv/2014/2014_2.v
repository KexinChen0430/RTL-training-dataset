...
module prometheus_fx3_stream_out(input  rst_n,
  ...
  assign o_gpif_oe_n_stream_out_ = (((current_stream_out_state == stream_out_read_oe_delay) | (current_stream_out_state == stream_out_read)) | (current_stream_out_state == stream_out_read_rd_and_oe_delay)) ? 1'b0 : 1'b1;
  ...
  always @(posedge clk_100 or negedge rst_n)
      begin
        if (!rst_n) 
          ...
          begin
            oe_delay_cnt <= (0-1'b1)+oe_delay_cnt;
          end
        else 
          begin
