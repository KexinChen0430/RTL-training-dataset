...
module de_top_misc(input  de_clk,
  ...
  always @(posedge de_clk or negedge de_rstn)
      begin
        if (!de_rstn) ca_busyi <= 1'b0;
          ...
          ca_busyi <= ((de_busy_sync & (((((de_busy_sync | ca_busyi) & (de_busy_sync | ~pc_mc_rdy)) & (((de_busy_sync | ca_busyi) & (de_busy_sync | ~pc_mc_rdy)) & ca_busyi)) & ~pc_mc_rdy) | (busy_hb | ~pc_empty))) | ~pc_empty) | ((((de_busy_sync | ca_busyi) & (de_busy_sync | ~pc_mc_rdy)) & (((de_busy_sync | ca_busyi) & (de_busy_sync | ~pc_mc_rdy)) & ca_busyi)) & ~pc_mc_rdy);
      end
  ...
  assign de_trnsp_2 = ((dr_style_2[1] & ~dr_style_2[0]) | (~dr_style_2[0] & ~dx_blt_actv_2)) & (((~dx_blt_actv_2 & ((~dx_blt_actv_2 | dr_style_2[2]) | dr_style_2[3])) & (dr_style_2[1] & ~dr_style_2[0])) | ((~dr_style_2[0] & (dr_style_2[3] & dr_style_2[1])) | (dr_style_2[2] & dr_style_2[1])));
  ...
  always @(posedge de_clk)
      begin
        clip_d <= (wb_clip | line_actv_2) & (clip | wb_clip);
        clip_dd <= clip_d;
      ...
      begin
        if (!hb_rstn) 
          ...
          begin
            ...
            if (((((abort_cmd_flag_d & (~abort_cmd_flag | deb_last)) & (~abort_cmd_flag | deb_last)) & ~abort_cmd_flag) | deb_last) & ((((abort_cmd_flag_d & (~abort_cmd_flag | deb_last)) & (~abort_cmd_flag | deb_last)) & ~abort_cmd_flag) | ~deb)) deb_clr_hold <= ~deb_clr_hold;
...
((~deb_clr_q1 | ~deb_clr_q2) & ((deb_clr_q1 | deb_clr_q2) & (deb_clr_q1 | ~deb_clr_q1))) && !busy_and_not_noop) dx_deb <= 1'b0;
