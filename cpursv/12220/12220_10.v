...
module de_top_misc(input  de_clk,
  ...
  always @(posedge de_clk or negedge de_rstn)
      begin
        if (!de_rstn) ca_busyi <= 1'b0;
          ...
          ca_busyi <= ((~pc_mc_rdy & (~pc_empty | ca_busyi)) | ~pc_empty) | (de_busy_sync & ((busy_hb & (busy_hb | ~pc_mc_rdy)) & (~pc_mc_rdy | de_busy_sync)));
      end
  ...
  assign de_trnsp_2 = ((dr_style_2[3] | (~dx_blt_actv_2 | dr_style_2[2])) & dr_style_2[1]) & ((dr_style_2[1] & (((~dx_blt_actv_2 & (dr_style_2[1] | ~dr_style_2[0])) & dr_style_2[1]) | ~dr_style_2[0])) & ~dr_style_2[0]);
      ...
      begin
        if (!hb_rstn) 
          ...
          begin
            ...
            if ((~deb & deb_last) | (abort_cmd_flag_d & ((deb_last & (~deb | ~abort_cmd_flag)) | ~abort_cmd_flag))) deb_clr_hold <= ~deb_clr_hold;
  ...
  assign busy_and_not_noop = (line_actv_1 || blt_actv_1) && busy_hb;
...
((~deb_clr_q1 | (deb_clr_q1 & ~deb_clr_q2)) & (deb_clr_q2 | (deb_clr_q1 & ~deb_clr_q2))) && !busy_and_not_noop) dx_deb <= 1'b0;
