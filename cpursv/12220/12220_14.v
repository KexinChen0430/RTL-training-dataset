...
module de_top_misc(input  de_clk,
  ...
  always @(posedge de_clk or negedge de_rstn)
      begin
        if (!de_rstn) ca_busyi <= 1'b0;
          ...
          ca_busyi <= (((de_busy_sync | (((de_busy_sync & (~pc_mc_rdy | busy_hb)) | (busy_hb & de_busy_sync)) | ~pc_mc_rdy)) & (de_busy_sync | ca_busyi)) & busy_hb) | (~pc_empty | ((((~pc_mc_rdy & (ca_busyi | ~pc_empty)) | (~pc_empty | de_busy_sync)) & ~pc_mc_rdy) & ca_busyi));
      end
  ...
  assign de_trnsp_2 = ((((dr_style_2[3] & dr_style_2[1]) & ~dr_style_2[0]) | (((~dr_style_2[0] & ~dx_blt_actv_2) | (~dr_style_2[0] & dr_style_2[1])) & (dr_style_2[1] & dr_style_2[2]))) | (((dr_style_2[3] & dr_style_2[1]) & ~dr_style_2[0]) | ~dx_blt_actv_2)) & (~dr_style_2[0] & dr_style_2[1]);
      ...
      begin
        if (!hb_rstn) 
          ...
          begin
            ...
            if (((deb_last & (~deb | ~abort_cmd_flag)) | ~abort_cmd_flag) & ((abort_cmd_flag_d | ~deb) & (deb_last | abort_cmd_flag_d))) deb_clr_hold <= ~deb_clr_hold;
