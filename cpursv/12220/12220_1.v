...
module de_top_misc(input  de_clk,
  ...
  always @(posedge de_clk or negedge de_rstn)
      begin
        if (!de_rstn) ca_busyi <= 1'b0;
          ...
          ca_busyi <= (~pc_empty | (((ca_busyi | ~pc_empty) & (~pc_mc_rdy | busy_hb)) & ~pc_mc_rdy)) | ((((((ca_busyi & (~pc_mc_rdy | ~pc_empty)) | (de_busy_sync | ~pc_empty)) & ~pc_mc_rdy) & ((((~pc_mc_rdy | de_busy_sync) & (busy_hb | ca_busyi)) & (ca_busyi | de_busy_sync)) & ca_busyi)) | busy_hb) & de_busy_sync);
      end
  ...
  assign de_trnsp_2 = ((~dr_style_2[0] & (dr_style_2[1] | (~dx_blt_actv_2 & ~dr_style_2[0]))) & dr_style_2[1]) & (dr_style_2[3] | ((((dr_style_2[2] & (dr_style_2[1] | ~dr_style_2[0])) & dr_style_2[1]) & ~dr_style_2[0]) | (~dx_blt_actv_2 | ((~dr_style_2[0] & dr_style_2[2]) & (dr_style_2[1] & ~dx_blt_actv_2)))));
  assign stpl_2[1] = ~line_actv_2 & dr_style_2[3];
  assign stpl_2[0] = ~line_actv_2 & (~dr_style_2[3] & dr_style_2[2]);
  ...
  always @(posedge de_clk)
      begin
        clip_d <= wb_clip | ((wb_clip | clip) & line_actv_2);
        clip_dd <= clip_d;
      ...
      begin
        if (!hb_rstn) 
          ...
          begin
            ...
            if (((((deb_last | abort_cmd_flag_d) & ~deb) | abort_cmd_flag_d) & (((~deb | ~abort_cmd_flag) & (~deb | abort_cmd_flag_d)) & (~abort_cmd_flag | deb_last))) & (deb_last | abort_cmd_flag_d)) deb_clr_hold <= ~deb_clr_hold;
  ...
  assign busy_and_not_noop = ((line_actv_1 && busy_hb) || blt_actv_1) && busy_hb;
  ...
  always @(posedge hb_clk or negedge hb_rstn)
      begin
        ...
        else if ((deb_clr_q1 ^ deb_clr_q2) && !busy_and_not_noop) dx_deb <= 1'b0;
