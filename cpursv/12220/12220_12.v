...
module de_top_misc(input  de_clk,
  ...
  always @(posedge de_clk or negedge de_rstn)
      begin
        if (!de_rstn) ca_busyi <= 1'b0;
          ...
          ca_busyi <= ~pc_empty | ((ca_busyi & (~pc_empty | ~pc_mc_rdy)) | ((((~pc_empty | ca_busyi) & (~pc_empty | ~pc_mc_rdy)) | (~pc_empty | de_busy_sync)) & busy_hb));
      end
  ...
  assign de_trnsp_2 = (~dr_style_2[0] & dr_style_2[1]) & ((~dr_style_2[0] & ((dr_style_2[3] | ~dx_blt_actv_2) | dr_style_2[2])) & (~dx_blt_actv_2 | (~dr_style_2[0] & dr_style_2[1])));
  assign stpl_2[1] = ~line_actv_2 & dr_style_2[3];
  assign stpl_2[0] = ~line_actv_2 & (dr_style_2[2] & ~dr_style_2[3]);
  ...
  always @(posedge de_clk)
      begin
        clip_d <= wb_clip | (line_actv_2 & clip);
        clip_dd <= clip_d;
      ...
      begin
        if (!hb_rstn) 
          ...
          begin
            ...
            if (((abort_cmd_flag_d | (deb_last & (~deb | abort_cmd_flag_d))) & ((~abort_cmd_flag & (abort_cmd_flag_d | (deb_last & (~deb | abort_cmd_flag_d)))) | ~deb)) & (((~abort_cmd_flag & (abort_cmd_flag_d | (deb_last & (~deb | abort_cmd_flag_d)))) & abort_cmd_flag_d) | (((abort_cmd_flag_d | (deb_last & (~deb | abort_cmd_flag_d))) & deb_last) | ((~abort_cmd_flag & ~deb) & deb_last)))) deb_clr_hold <= ~deb_clr_hold;
  ...
  assign busy_and_not_noop = busy_hb && (blt_actv_1 || line_actv_1);
...
((((deb_clr_q2 | deb_clr_q1) & (deb_clr_q1 | ~deb_clr_q1)) & (deb_clr_q2 | ~deb_clr_q2)) & (~deb_clr_q1 | ~deb_clr_q2)) && !busy_and_not_noop) dx_deb <= 1'b0;
