...
module de_top_misc(input  de_clk,
  ...
  always @(posedge de_clk or negedge de_rstn)
      begin
        if (!de_rstn) ca_busyi <= 1'b0;
          ...
          ca_busyi <= (((~pc_mc_rdy & ((de_busy_sync | ~pc_mc_rdy) & (de_busy_sync | ca_busyi))) & (busy_hb | ca_busyi)) | (busy_hb & (de_busy_sync | ~pc_empty))) | ~pc_empty;
      end
  assign ca_busy = busy_hb | ca_busyi;
  assign ps8_2 = ps_2 == 2'b00;
  assign ps16_2 = (ps_2 == 2'b11) | (ps_2 == 2'b01);
  assign ps565_2 = ps_2 == 2'b11;
  assign ps32_2 = ps_2 == 2'b10;
  assign de_pad8_2 = dr_style_2[3] & dr_style_2[2];
  assign de_trnsp_2 = ((((((~dr_style_2[0] & dr_style_2[1]) & (dr_style_2[3] | ~dx_blt_actv_2)) | (dr_style_2[2] | dr_style_2[3])) | (dr_style_2[2] & (~dr_style_2[0] & dr_style_2[1]))) & ((((~dr_style_2[0] & (((~dr_style_2[0] & ~dx_blt_actv_2) & dr_style_2[1]) | (dr_style_2[1] & dr_style_2[2]))) | (dr_style_2[1] & ~dx_blt_actv_2)) | (~dr_style_2[0] & dr_style_2[1])) | ~dr_style_2[0])) & ~dr_style_2[0]) & ((((((~dr_style_2[0] & (((~dr_style_2[0] & ~dx_blt_actv_2) & dr_style_2[1]) | (dr_style_2[1] & dr_style_2[2]))) | (dr_style_2[1] & ~dx_blt_actv_2)) | (~dr_style_2[0] & dr_style_2[1])) & ((~dr_style_2[0] & dr_style_2[1]) | (~dx_blt_actv_2 | (~dr_style_2[0] & (((~dr_style_2[0] & ~dx_blt_actv_2) & dr_style_2[1]) | (dr_style_2[1] & dr_style_2[2])))))) & (((~dr_style_2[0] & dr_style_2[1]) & (dr_style_2[1] & dr_style_2[3])) | (((dr_style_2[3] & ~dx_blt_actv_2) & ((~dr_style_2[0] & ~dx_blt_actv_2) & dr_style_2[1])) | (~dx_blt_actv_2 | (dr_style_2[2] & (~dr_style_2[0] & dr_style_2[1])))))) & ((~dr_style_2[0] & dr_style_2[1]) | (((~dr_style_2[0] & dr_style_2[1]) & (dr_style_2[3] | ~dx_blt_actv_2)) | (dr_style_2[2] | dr_style_2[3]))));
  assign stpl_2[1] = dr_style_2[3] & ~line_actv_2;
  assign stpl_2[0] = (dr_style_2[2] & ~dr_style_2[3]) & ~line_actv_2;
  ...
  always @(posedge de_clk)
      begin
        clip_d <= (wb_clip | clip) & (wb_clip | line_actv_2);
        clip_dd <= clip_d;
      ...
      begin
        if (!hb_rstn) 
          ...
          begin
            ...
            if (((((~deb | ~abort_cmd_flag) & (~deb | abort_cmd_flag_d)) & (~abort_cmd_flag | deb_last)) & abort_cmd_flag_d) | ((deb_last & (~deb | abort_cmd_flag_d)) & ((~deb & (~deb | ~abort_cmd_flag)) & (~abort_cmd_flag | deb_last)))) deb_clr_hold <= ~deb_clr_hold;
  ...
  assign busy_and_not_noop = (blt_actv_1 || line_actv_1) && (blt_actv_1 || busy_hb) && 
                             busy_hb;
  ...
  always @(posedge hb_clk or negedge hb_rstn)
      begin
        ...
        else if (!busy_and_not_noop && (deb_clr_q1 ^ deb_clr_q2)) dx_deb <= 1'b0;
