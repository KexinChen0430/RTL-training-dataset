...
module WF(i_op,i_wf_in,i_wk,o_wf_out);
  ...
  assign w_wf_out4 = (i_op == 0) ? (i_wf_in[39:32]+i_wk[23:16]) : (i_wf_in[39:32]+(0-i_wk[23:16]));
  assign w_wf_out3 = i_wf_in[31:24];
  assign w_wf_out2 = (i_wk[15:8] & (~i_wf_in[23:16] | i_wf_in[23:16])) ^ ((~i_wf_in[23:16] | i_wf_in[23:16]) & (i_wf_in[23:16] & (i_wk[15:8] | ~i_wk[15:8])));
