  ...
  always @* 
      begin
        ...
        case (current_state)
          ...
          cpurd_state0: begin
                m_cpurd_s0 = 1'b1;
                if ((h_svga_sel & g_memrd) & c_misc_b1) next_state = cpurd_state1;
                else next_state = cpurd_state0;
              end

          cpurd_state1: begin
                cpu_rd_req = 1'b1;
                m_cpurd_state1 = 1'b1;
                if (cpu_rd_gnt) next_state = cpurd_state2;
                else next_state = cpurd_state1;
              end
          ...
          cpurd_state2: begin
                ...
                cpurd_s2 = 1'b1;
                if (svga_ack) next_state = cpurd_state4;
                else next_state = cpurd_state2;
              end

          cpurd_state4: begin
                cpurd_s4 = 1'b1;
                cpu_rd_req = 1'b1;
                if (g_cpu_cycle_done) next_state = cpurd_state3;
                else next_state = cpurd_state2;
              end
          ...
          cpurd_state3: begin
                cpu_rd_req = 1'b1;
                cpurd_s3 = 1'b1;
                if (g_cpu_data_done) next_state = cpurd_state0;
                else next_state = cpurd_state3;
              end

        endcase

      end
  assign en_cpurd_addr = cpu_rd_gnt & g_memwr;
  assign m_memrd_ready_n = ~((cpu_rd_gnt & g_cpu_cycle_done) & ~t_data_ready_n);
  
  always @* 
      g_graph_data_in = m_t_mem_data_in;
endmodule
