      ...
      begin
        if (reset === 1'b1) 
          ...
          begin
            ...
            if ((clk == 1'b1) || (clk_edges >= 0)) 
              clk_edges = ((((((((((((clk_edges%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))+(((((((((((1%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2))%(clk_divide_by*2)))%(clk_divide_by*2);
