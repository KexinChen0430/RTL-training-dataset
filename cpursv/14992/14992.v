...
module jbi_adder_5b(sum,cout,oper1,oper2,cin);
  ...
  assign carry[2] = (((carry[0] & prop[0]) & prop[1]) | (gen[0] & prop[1])) | gen[1];
  assign gen[2] = oper1[2] & oper2[2];
  assign prop[2] = oper1[2] | oper2[2];
  assign sum[2] = (oper1[2] ^ oper2[2]) ^ carry[2];
  assign carry[3] = (((((carry[0] & prop[0]) & prop[1]) & prop[2]) | ((gen[0] & prop[1]) & prop[2])) | (gen[1] & prop[2])) | gen[2];
  assign gen[3] = oper1[3] & oper2[3];
  assign prop[3] = oper1[3] | oper2[3];
  assign sum[3] = (oper1[3] ^ oper2[3]) ^ carry[3];
  assign carry[4] = (((((((carry[0] & prop[0]) & prop[1]) & prop[2]) & prop[3]) | (((gen[0] & prop[1]) & prop[2]) & prop[3])) | ((gen[1] & prop[2]) & prop[3])) | (gen[2] & prop[3])) | gen[3];
  assign gen[4] = oper1[4] & oper2[4];
  assign prop[4] = oper1[4] | oper2[4];
  assign sum[4] = (oper1[4] ^ oper2[4]) ^ carry[4];
  assign carry[5] = (((((((((carry[0] & prop[0]) & prop[1]) & prop[2]) & prop[3]) & prop[4]) | ((((gen[0] & prop[1]) & prop[2]) & prop[3]) & prop[4])) | (((gen[1] & prop[2]) & prop[3]) & prop[4])) | ((gen[2] & prop[3]) & prop[4])) | (gen[3] & prop[4])) | gen[4];
  assign cout = carry[5];
endmodule
