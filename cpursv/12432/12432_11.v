...
module REGISTER_FILE  #(parameter 
  ...
  (input  CLK,
   ...
   input  [REGISTER_WIDTH+(0-1):0] RD_DATA,
   input  RD_WRITE_EN,
   output [REGISTER_WIDTH+(0-1):0] RS1_DATA,
   output [REGISTER_WIDTH+(0-1):0] RS2_DATA);

  reg  [REGISTER_WIDTH+(0-1):0] register[REGISTER_DEPTH+(0-1):0];
  reg  [REGISTER_WIDTH+(0-1):0] rs1_data_reg;
  reg  [REGISTER_WIDTH+(0-1):0] rs2_data_reg;
  integer i;
