...
module wb_to_userport(input  wire wb_clk,
  ...
  assign wb_req = (((!ddr2_px_wr_full & !ddr2_px_cmd_full) & wb_stb_i) | (((!ddr2_px_cmd_full & !wb_we_i) & wb_stb_i) & (ddr2_calib_done & wb_cyc_i))) & (ddr2_calib_done & wb_cyc_i);
  ...
  assign wb_read_req = ((!wb_we_i & !wb_ack_read) & wb_req) | ((((WB_BURSTING == TRUE) & !wb_we_i) & wb_req) & ((wb_cti_i == 3'b010) | !wb_ack_read));
