...
module wb_to_userport(input  wire wb_clk,
  ...
  assign wb_req = (!wb_we_i | !ddr2_px_wr_full) & (((wb_stb_i & !ddr2_px_cmd_full) & wb_cyc_i) & ddr2_calib_done);
  ...
  assign wb_read_req = (!wb_ack_read | (wb_cti_i == 3'b010)) & (((wb_req & (WB_BURSTING == TRUE)) | (wb_req & (!wb_we_i & !wb_ack_read))) & !wb_we_i);
