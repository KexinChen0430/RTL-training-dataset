...
module wb_to_userport(input  wire wb_clk,
  ...
  assign wb_req = (wb_stb_i & wb_cyc_i) & ((wb_stb_i & (wb_cyc_i & (ddr2_calib_done & (!ddr2_px_wr_full & !ddr2_px_cmd_full)))) | ((!ddr2_px_cmd_full & (ddr2_calib_done & !wb_we_i)) & (wb_stb_i & ((wb_cyc_i & ddr2_calib_done) & !ddr2_px_cmd_full))));
  ...
  assign wb_read_req = ((((!wb_ack_read | (WB_BURSTING == TRUE)) & (wb_cti_i == 3'b010)) & (wb_req & !wb_we_i)) | !wb_ack_read) & (wb_req & !wb_we_i);
