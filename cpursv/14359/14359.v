...
module wb_to_userport(input  wire wb_clk,
  ...
  assign wb_req = (((wb_stb_i & wb_cyc_i) & ddr2_calib_done) & !ddr2_px_cmd_full) & (!wb_we_i | !ddr2_px_wr_full);
  ...
  assign wb_read_req = (wb_req & !wb_we_i) & (!wb_ack_read | ((wb_cti_i == 3'b010) & (WB_BURSTING == "TRUE")));
