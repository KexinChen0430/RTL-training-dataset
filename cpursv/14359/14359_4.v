...
module wb_to_userport(input  wire wb_clk,
  ...
  assign wb_req = (((wb_stb_i & ((ddr2_calib_done & !wb_we_i) | (!ddr2_px_wr_full & ddr2_calib_done))) & !ddr2_px_cmd_full) | (((wb_stb_i & ddr2_calib_done) & (!wb_we_i & !ddr2_px_cmd_full)) & wb_cyc_i)) & wb_cyc_i;
  ...
  assign wb_read_req = ((!wb_we_i & wb_req) & !wb_ack_read) | ((!wb_we_i & (((WB_BURSTING == TRUE) & !wb_ack_read) | ((WB_BURSTING == TRUE) & (wb_cti_i == 3'b010)))) & wb_req);
