...
module wb_to_userport(input  wire wb_clk,
  ...
  reg  [BURST_ADDR_WIDTH+(0-1):0] burst_cnt;
  reg  bursting;
  wire addr_match;
  reg  burst_start;
  reg  read_done;
  ...
  assign wb_req = (ddr2_calib_done & !ddr2_px_cmd_full) & (((ddr2_calib_done & (!ddr2_px_cmd_full & !wb_we_i)) & (wb_cyc_i & wb_stb_i)) | ((wb_cyc_i & wb_stb_i) & !ddr2_px_wr_full));
  ...
  assign wb_read_req = ((!wb_we_i | (((wb_cti_i == 3'b010) | !wb_ack_read) & ((WB_BURSTING == TRUE) & (!wb_we_i & wb_req)))) & ((((wb_cti_i == 3'b010) | !wb_ack_read) & wb_req) | (((wb_cti_i == 3'b010) | !wb_ack_read) & ((WB_BURSTING == TRUE) & (!wb_we_i & wb_req))))) & ((WB_BURSTING == TRUE) | !wb_ack_read);
