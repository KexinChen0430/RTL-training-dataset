...
module wb_to_userport(input  wire wb_clk,
  ...
  assign wb_req = (wb_cyc_i & ddr2_calib_done) & ((!ddr2_px_cmd_full & (ddr2_calib_done & ((wb_cyc_i & wb_stb_i) & !ddr2_px_wr_full))) | (wb_stb_i & (!wb_we_i & !ddr2_px_cmd_full)));
  ...
  assign wb_read_req = (((wb_req & ((WB_BURSTING == TRUE) & (wb_cti_i == 3'b010))) & !wb_we_i) | (!wb_ack_read & !wb_we_i)) & wb_req;
      ...
      begin
        ...
        if (wb_rst) 
          ...
          begin
            ...
            if (burst_cnt >= wb_adr_i[(0-1)+BURST_ADDR_ALIGN:2]) read_done <= 1'b1;
  ...
  assign wb_dat_o = burst_data_buf[wb_adr_i[(0-1)+BURST_ADDR_ALIGN:2]];
endmodule
