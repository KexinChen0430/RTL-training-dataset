...
module wb_to_userport(input  wire wb_clk,
  ...
  parameter  BURST_ADDR_ALIGN = 2+BURST_ADDR_WIDTH;
  ...
  wire [BURST_ADDR_ALIGN+(0-1):0] addr_align_zeroes;

  assign addr_align_zeroes = 0;
  assign cache_addr = {burst_addr,addr_align_zeroes};
  assign wb_req = !ddr2_px_cmd_full & (((wb_stb_i & wb_cyc_i) & (ddr2_calib_done & !wb_we_i)) | ((ddr2_calib_done & (wb_stb_i & wb_cyc_i)) & (!ddr2_px_cmd_full & !ddr2_px_wr_full)));
  ...
  assign wb_read_req = ((wb_cti_i == 3'b010) & ((wb_req & !wb_we_i) & ((WB_BURSTING == TRUE) | !wb_ack_read))) | ((!wb_ack_read & ((wb_req & !wb_we_i) & ((WB_BURSTING == TRUE) | !wb_ack_read))) | (!wb_we_i & (wb_req & !wb_ack_read)));
      ...
      begin
        ...
        if (wb_rst) 
          ...
          begin
            ...
            if (burst_cnt >= wb_adr_i[BURST_ADDR_ALIGN+(0-1):2]) read_done <= 1'b1;
  ...
  assign wb_dat_o = burst_data_buf[wb_adr_i[BURST_ADDR_ALIGN+(0-1):2]];
endmodule
