      ...
      begin
        ...
        if (enable_i) 
          begin
            ...
            direction_o <= (((((quadA_i & !quadB_i) & !quadA_old) & !quadB_old) | (((quadA_i & quadB_i) & quadA_old) & !quadB_old)) | (((!quadA_i & quadB_i) & quadA_old) & quadB_old)) | (((!quadA_i & !quadB_i) & !quadA_old) & quadB_old);
            quadA_old <= quadA;
            quadB_old <= quadB;
            quadA <= quadA_i;
            quadB <= quadB_i;
