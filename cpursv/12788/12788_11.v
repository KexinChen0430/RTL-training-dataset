...
module altgxb_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign pllresetout = ((txanalogresetout[3] & txanalogresetout[2]) & (rxanalogresetout[3] & (rxanalogresetout[1] & txanalogresetout[1]))) & ((rxanalogresetout[2] & txanalogresetout[0]) & rxanalogresetout[0]);
  assign rxdigitalresetout = {rxdigitalreset[3] | HARD_RESET,HARD_RESET | rxdigitalreset[2],rxdigitalreset[1] | HARD_RESET,rxdigitalreset[0] | HARD_RESET};
