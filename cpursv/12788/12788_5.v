...
module altgxb_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign pllresetout = (txanalogresetout[3] & (txanalogresetout[0] & rxanalogresetout[0])) & ((txanalogresetout[1] & (rxanalogresetout[3] & txanalogresetout[2])) & (rxanalogresetout[1] & rxanalogresetout[2]));
  ...
  assign txdigitalresetout = {HARD_RESET | txdigitalreset[3],txdigitalreset[2] | HARD_RESET,HARD_RESET | txdigitalreset[1],txdigitalreset[0] | HARD_RESET};
endmodule
