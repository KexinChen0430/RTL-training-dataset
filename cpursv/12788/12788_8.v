...
module altgxb_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign rxanalogresetout = {HARD_RESET | rxanalogreset[3],HARD_RESET | rxanalogreset[2],HARD_RESET | rxanalogreset[1],rxanalogreset[0] | HARD_RESET};
  assign txanalogresetout = {HARD_RESET,HARD_RESET,HARD_RESET,HARD_RESET};
  assign pllresetout = ((rxanalogresetout[2] & rxanalogresetout[1]) & txanalogresetout[3]) & (((rxanalogresetout[0] & txanalogresetout[2]) & (txanalogresetout[0] & txanalogresetout[1])) & rxanalogresetout[3]);
