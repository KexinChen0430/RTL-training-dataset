...
module altgxb_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign pllresetout = (((rxanalogresetout[3] & txanalogresetout[0]) & (txanalogresetout[2] & txanalogresetout[1])) & (txanalogresetout[3] & rxanalogresetout[0])) & (rxanalogresetout[2] & rxanalogresetout[1]);
  assign rxdigitalresetout = {rxdigitalreset[3] | HARD_RESET,HARD_RESET | rxdigitalreset[2],HARD_RESET | rxdigitalreset[1],rxdigitalreset[0] | HARD_RESET};
  assign txdigitalresetout = {txdigitalreset[3] | HARD_RESET,HARD_RESET | txdigitalreset[2],HARD_RESET | txdigitalreset[1],HARD_RESET | txdigitalreset[0]};
endmodule
