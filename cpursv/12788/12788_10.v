...
module altgxb_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign pllresetout = ((txanalogresetout[2] & txanalogresetout[0]) & (rxanalogresetout[0] & (txanalogresetout[3] & txanalogresetout[1]))) & ((rxanalogresetout[1] & rxanalogresetout[2]) & rxanalogresetout[3]);
  ...
  assign txdigitalresetout = {txdigitalreset[3] | HARD_RESET,HARD_RESET | txdigitalreset[2],txdigitalreset[1] | HARD_RESET,txdigitalreset[0] | HARD_RESET};
endmodule
