...
module altgxb_xgm_reset_block(txdigitalreset,rxdigitalreset,rxanalogreset,pllreset,
  ...
  assign pllresetout = ((rxanalogresetout[0] & (rxanalogresetout[3] & rxanalogresetout[2])) & (rxanalogresetout[1] & txanalogresetout[1])) & (txanalogresetout[0] & (txanalogresetout[3] & txanalogresetout[2]));
  assign rxdigitalresetout = {rxdigitalreset[3] | HARD_RESET,rxdigitalreset[2] | HARD_RESET,rxdigitalreset[1] | HARD_RESET,HARD_RESET | rxdigitalreset[0]};
