      ...
      begin
        ...
        if (s_axis_tready == 1'b0) 
          begin
                  ...
                  begin
                    if (cnt_sclk < 8) 
                      begin
                        ...
                        if ((cnt_sclk == 7) && (cmd_reg[3:1<<<1] == 2'b00)) 
                          begin
                            end_sequence <= 1'b1;
                          end
                      ...
                      begin
                        sdi <= data_reg[31-cnt_sclk];
                        if ((cmd_reg[3:1<<<1] == 2'b01) && (cnt_sclk == 15)) 
                          begin
                            end_sequence <= 1'b1;
                          end
                      ...
                      begin
                        sdi <= data_reg[31-cnt_sclk];
                        if ((cnt_sclk == 23) && (cmd_reg[3:1<<<1] == 2'b10)) 
                          begin
                            end_sequence <= 1'b1;
                          end
            ...
            else if (cnt_clk == {{1'b0},{(0-1)+CLK_DIV{1'b1}}}) 
              begin
                sclk_reg <= 1'b0;
                sclk <= sclk_reg;
              end
