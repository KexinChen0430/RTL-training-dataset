...
module SCCBCtrl(clk_i,rst_i,sccb_clk_i,data_pulse_i,addr_i,data_i,data_o,
  ...
  assign sioc_o = ((start_i == 1) && 
                  (((stm >= 5) && (stm <= 12)) || (stm == 14) || 
((stm >= 16) && (stm <= 23)) || (stm == 25) || ((stm >= 27) && (stm <= 34)) || (stm == 36) || 
((stm >= 44) && (stm <= 51)) || (stm == 53) || ((stm >= 55) && (stm <= 62)) || (stm == 64))) ? sccb_clk_i : sccb_stm_clk;
  assign siod_io = ((stm == 13) || (stm == 14) || (stm == 24) || (stm == 25) || 
                   (stm == 35) || (stm == 36) || (stm == 52) || (stm == 53) || 
                   ((stm >= 54) && (stm <= 62))) ? 1'bz : bit_out;
