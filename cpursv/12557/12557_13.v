...
module testing_wb_slave(wb_dat_o,wb_ack_o,wb_err_o,wb_rty_o,wb_clk,wb_rst,wb_adr_i,
  ...
  input  [1:0] wb_bte_i;
  output reg [(0-1)+dw:0] wb_dat_o;
  output reg wb_ack_o;
  output reg wb_err_o;
  output reg wb_rty_o;
  reg  [(0-1)+dw:0] slave_reg0;
  reg  [(0-1)+dw:0] slave_reg1;
  reg  [(0-1)+dw:0] slave_reg2;
  reg  [(0-1)+dw:0] slave_reg3;
  reg  [aw-1:0] addr_reg;
  reg  [(0-1)+dw:0] data_reg;
