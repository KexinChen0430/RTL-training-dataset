...
module testing_wb_slave(wb_dat_o,wb_ack_o,wb_err_o,wb_rty_o,wb_clk,wb_rst,wb_adr_i,
                        wb_dat_i,wb_sel_i,wb_we_i,wb_cyc_i,wb_stb_i,wb_cti_i,wb_bte_i);
  ...
  input  wb_clk;
  input  wb_rst;
  input  [(0-1)+aw:0] wb_adr_i;
  input  [dw+(0-1):0] wb_dat_i;
  input  [3:0] wb_sel_i;
  input  wb_we_i;
  input  wb_cyc_i;
  input  wb_stb_i;
  ...
  input  [1:0] wb_bte_i;
  output reg [dw+(0-1):0] wb_dat_o;
  output reg wb_ack_o;
  output reg wb_err_o;
  output reg wb_rty_o;
  reg  [dw+(0-1):0] slave_reg0;
  reg  [dw+(0-1):0] slave_reg1;
  reg  [dw+(0-1):0] slave_reg2;
  reg  [dw+(0-1):0] slave_reg3;
  reg  [(0-1)+aw:0] addr_reg;
  reg  [dw+(0-1):0] data_reg;
            ...
            begin
              case (wb_adr_i[3:0])
                ...
                4'h0: begin
                      ...
                      slave_reg0[23:16] <= wb_sel_i[1+1] ? wb_dat_i[23:16] : slave_reg0[23:16];
                ...
                4'h4: begin
                      ...
                      slave_reg1[23:16] <= wb_sel_i[1+1] ? wb_dat_i[23:16] : slave_reg1[23:16];
                ...
                4'h8: begin
                      ...
                      slave_reg2[23:16] <= wb_sel_i[1+1] ? wb_dat_i[23:16] : slave_reg2[23:16];
                ...
                4'hC: begin
                      ...
                      slave_reg3[23:16] <= wb_sel_i[1+1] ? wb_dat_i[23:16] : slave_reg3[23:16];
