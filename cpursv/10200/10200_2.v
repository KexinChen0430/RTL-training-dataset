...
module FFS_LOGIK(SRC1,SRC2,BWD,FLAG,DOUT);
  ...
  assign byte_0 = (SRC2[4:3] == 2'b00) ? {SRC1[7],maske & SRC1[6:0]} : 8'h00;
  ...
  always @(*)
      casex (SRC2[4:3])
        ...
        2'b01: byte_1 = {SRC1[15],maske & SRC1[14:8]};
  ...
  always @(*)
      casex (SRC2[4:3])
        ...
        2'b10: byte_2 = {SRC1[23],maske & SRC1[22:16]};

        2'b11: byte_2 = 8'h00;

      endcase

  assign byte_3 = (SRC2[4:3] == 2'b11) ? {SRC1[31],maske & SRC1[30:24]} : SRC1[31:24];
