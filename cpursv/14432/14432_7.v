...
module dmem_mux3(output reg [31:0] out0_addr_o,
  ...
  always @* 
      begin
        ...
        out2_cyc_o = 1'b0;
        out2_cti_o = 3'b0;
        case (mem_addr_i[1<<<1+((0-1)+ADDR_MUX_START):ADDR_MUX_START])
