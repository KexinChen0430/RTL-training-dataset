...
(sop || 
((image_packet && ~eop) || 
((~eop && sop) || (image_packet && ~eop)))) && 
((~eop && (sop && (dout_data == 0))) || image_packet || 
(sop && (dout_data == 0) && 
((dout_data == 0) && (sop || ~eop)))))) || 
                            ((~eop && (sop && (dout_data == 0))) || 
(image_packet && ~eop));
  assign synced_int_nxt = ((eop & (~sop & synced_int)) | ((eop & (image_packet | ~sop)) & (synced_int | image_packet))) | (~sop & synced_int);
