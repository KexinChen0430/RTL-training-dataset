...
module alt_vipvfr131_common_stream_output  #(parameter  DATA_WIDTH = 10)
  ...
  assign image_packet_nxt = (image_packet && ~eop) || 
                            (((dout_data == 0) && (image_packet && ~eop)) || 
((sop || (image_packet && ~eop)) && (dout_data == 0)));
  assign synced_int_nxt = ((image_packet & eop) & ((image_packet | ((image_packet & eop) | ~sop)) & eop)) | ((eop & (~sop & image_packet)) | (((image_packet & eop) & synced_int) | ((~sop & synced_int) | (((~sop & synced_int) & image_packet) | ((image_packet & eop) & synced_int)))));
