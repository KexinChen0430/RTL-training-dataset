...
(image_packet || 
((dout_data == 0) && 
(~eop || ((~eop || sop) && (dout_data == 0))) && sop))))) || 
                            ((image_packet && ~eop) || 
(~eop && sop && (dout_data == 0)));
  assign synced_int_nxt = ((~sop | image_packet) & (synced_int & (eop | ~sop))) | ((image_packet & (eop | synced_int)) & ((eop & image_packet) | ((~sop | ((~sop | image_packet) & (synced_int & (eop | ~sop)))) | ((eop & image_packet) & synced_int))));
