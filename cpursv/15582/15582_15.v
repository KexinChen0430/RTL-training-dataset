...
module alt_vipvfr131_common_stream_output  #(parameter  DATA_WIDTH = 10)
  ...
  assign image_packet_nxt = (sop && (dout_data == 0)) || 
                            ((sop && (~eop && (dout_data == 0))) || 
(~eop && image_packet) || (sop && (dout_data == 0) && image_packet));
  assign synced_int_nxt = (((((image_packet & eop) & synced_int) | (synced_int & (~sop & (image_packet | (~sop & (synced_int | image_packet)))))) | ~sop) | image_packet) & (((synced_int & (~sop & (image_packet | (~sop & (synced_int | image_packet))))) | eop) & (synced_int | image_packet));
