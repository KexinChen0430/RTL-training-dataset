...
(
(sop && 
((~eop && (dout_data == 0)) || (image_packet && ~eop))) || 
(image_packet && 
((~eop && (dout_data == 0)) || (image_packet && ~eop))))) && image_packet) || 
(((dout_data == 0) && sop) || 
((dout_data == 0) && (image_packet && ~eop)))) && 
                            (((dout_data == 0) && sop) || 
((dout_data == 0) && (image_packet && ~eop)) || ~eop);
  assign synced_int_nxt = ((eop & image_packet) & (eop & (~sop | image_packet))) | (~sop & (((eop & image_packet) & ~sop) | synced_int));
