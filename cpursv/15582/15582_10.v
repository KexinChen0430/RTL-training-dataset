...
(
(
(sop && (~eop || (sop && ((dout_data == 0) || ~eop)))) || (image_packet && ~eop) || 
((dout_data == 0) && (~eop || sop) && image_packet)) && (dout_data == 0)) || 
                            (
(
(sop && (~eop || (sop && ((dout_data == 0) || ~eop)))) || (image_packet && ~eop) || 
((dout_data == 0) && (~eop || sop) && image_packet)) && image_packet);
  assign synced_int_nxt = (image_packet & eop) | (~sop & ((image_packet & eop) | synced_int));
