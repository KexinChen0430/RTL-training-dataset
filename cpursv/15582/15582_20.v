...
module alt_vipvfr131_common_stream_output  #(parameter  DATA_WIDTH = 10)
  ...
  assign image_packet_nxt = 
(
((sop && (dout_data == 0)) || 
((dout_data == 0) && (sop || ~eop)) || ~eop) && 
(image_packet || 
(
(
((sop && (dout_data == 0)) || 
((dout_data == 0) && (sop || ~eop)) || ~eop) && image_packet) || (dout_data == 0))) && sop) || 
                            (
(
((sop && (dout_data == 0)) || 
((dout_data == 0) && (sop || ~eop)) || ~eop) && 
...
(
((sop && (dout_data == 0)) || 
((dout_data == 0) && (sop || ~eop)) || ~eop) && image_packet) || (dout_data == 0))) && image_packet) || (sop && (dout_data == 0)));
  assign synced_int_nxt = ((((((((~sop & synced_int) & eop) | (image_packet & ~sop)) | (~sop & synced_int)) & synced_int) | eop) & ~sop) | ((((eop & image_packet) & ~sop) | (image_packet & (~sop & synced_int))) | (eop & image_packet))) & (((((eop & image_packet) & ~sop) | (image_packet & (~sop & synced_int))) | (eop & image_packet)) | synced_int);
