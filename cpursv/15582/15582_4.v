...
((~eop || sop) && image_packet && 
(~eop || (dout_data == 0))) || (sop && (dout_data == 0));
  assign synced_int_nxt = ((synced_int & ~sop) | image_packet) & ((eop | (image_packet & ((~sop & eop) | (synced_int & ~sop)))) | (((~sop & eop) | (synced_int & ~sop)) & synced_int));
