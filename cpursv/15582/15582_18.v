...
module alt_vipvfr131_common_stream_output  #(parameter  DATA_WIDTH = 10)
  ...
  assign image_packet_nxt = ((dout_data == 0) && sop) || 
                            (~eop && image_packet && sop) || (~eop && image_packet);
  assign synced_int_nxt = (eop | (((image_packet | ~sop) & synced_int) & (~sop | eop))) & (((image_packet & synced_int) | (eop & image_packet)) | ((synced_int | image_packet) & ((~sop & synced_int) | (((~sop & synced_int) & image_packet) | (~sop & eop)))));
