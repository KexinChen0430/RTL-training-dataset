...
(
(~eop && 
((sop && ((dout_data == 0) && ~eop)) || image_packet)) || image_packet || (dout_data == 0)) && sop && (dout_data == 0)) || 
(
(~eop && 
((sop && ((dout_data == 0) && ~eop)) || image_packet)) || image_packet))) || 
(~eop && 
((sop && ((dout_data == 0) && ~eop)) || image_packet))) && (sop || ((sop || image_packet) && ~eop));
  assign synced_int_nxt = (((~sop & synced_int) | (eop & ~sop)) & image_packet) | ((eop & image_packet) | (synced_int & ((~sop & synced_int) | (eop & ~sop))));
