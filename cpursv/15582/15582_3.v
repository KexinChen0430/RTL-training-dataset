...
module alt_vipvfr131_common_stream_output  #(parameter  DATA_WIDTH = 10)
  ...
  assign image_packet_nxt = (~eop && image_packet) || 
                            ((dout_data == 0) && 
((~eop || (sop && ((dout_data == 0) || ~eop))) && sop));
  assign synced_int_nxt = ((synced_int & (image_packet & (eop | ~sop))) | (~sop & synced_int)) | (((~sop | image_packet) & (eop | ~sop)) & ((synced_int & image_packet) | (image_packet & eop)));
