...
module alt_vipvfr131_common_stream_output  #(parameter  DATA_WIDTH = 10)
  ...
  assign image_packet_nxt = ((dout_data == 0) && sop) || 
                            (((dout_data == 0) || image_packet) && 
((image_packet && ~eop && sop) || (sop && ~eop) || 
(image_packet && ~eop)));
  assign synced_int_nxt = ((image_packet & eop) | (image_packet & ((((image_packet | ((~sop | image_packet) & synced_int)) & synced_int) & ~sop) | ((image_packet & (((image_packet | ((~sop | image_packet) & synced_int)) & synced_int) & ~sop)) | (~sop & eop))))) | (((((image_packet | ((~sop | image_packet) & synced_int)) & synced_int) & ~sop) | ((image_packet & (((image_packet | ((~sop | image_packet) & synced_int)) & synced_int) & ~sop)) | (~sop & eop))) & synced_int);
