...
(
(sop && ((sop && (dout_data == 0)) || image_packet)) || (~eop && image_packet)) && (~eop || (dout_data == 0));
  assign synced_int_nxt = (((eop & image_packet) & ~sop) | ((synced_int & (eop & image_packet)) | ((synced_int & (eop & image_packet)) | (~sop & synced_int)))) | (eop & image_packet);
