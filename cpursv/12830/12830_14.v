...
module method_finder(input  wire mclk,
                     input  wire stall,
                     input  wire reset,
  ...
  wire  has_control = !mem_re && (!stall && !mem_we);
                ...
                case (state)
                  ...
                  state_lookup_table_length: begin
                        if (mem_dout == 0) 
                          ...
                          begin
                            final_slot_index <= (-1)+mem_dout;
                            this_slot_index <= 0;
                            this_slot <= 1+mem_address;
                            mem_address <= 1+mem_address;
                            mem_re <= 1;
                  ...
                  state_lookup_table_scan_selector: begin
                        if (mem_dout == lookup_selector) 
                          ...
                          begin
                            if (this_slot_index == final_slot_index) 
                              begin
                                state <= state_lookup_next_behavior;
                              end
                            else 
                              begin
                                this_slot_index <= 1+this_slot_index;
                                this_slot <= 1+this_slot;
                                mem_address <= 1+this_slot;
                                state <= state_lookup_table_scan_method;
                              end
                          end
                      end
