...
module sampler(sample_sig,din,sample_clk);
  ...
  localparam  PADDING_TIME = SAMPLE_RATIO*(1/1<<1);
  ...
  assign next_sample_sig = (bit_count < 4'd8) && 
                           (count == (SAMPLE_RATIO+(-4'd2))) && (state == SAMPLING);
