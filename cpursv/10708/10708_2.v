...
module serial_wb_parport(parport_o,data_o,parport_readstrobe_o,parport_writestrobe_o,
                         clk_i,rst_i,parport_i,writestrobe_i,readstrobe_i,data_i,
                         address_i);
  ...
  always @(*)
      begin
        ...
        if (readstrobe_i && (address_i == 2'b00)) 
          begin
