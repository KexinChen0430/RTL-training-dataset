...
module arriaii_mac_multiplier(dataa,datab,signa,signb,dataout);
  ...
  assign product_sign = ((dataa_sign & datab_sign) | (datab_sign & ~dataa_sign)) ^ ((((datab_sign & ~dataa_sign) | dataa_sign) | ~dataa_sign) & ((datab_sign | ~datab_sign) & ((datab_sign | ~datab_sign) & dataa_sign)));
