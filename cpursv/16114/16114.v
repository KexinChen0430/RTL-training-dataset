...
module fifo_full_block(wr_fifo_full,wr_fifo_almost_full,wr_addr,wr_gray_pointer,
  ...
  assign wr_fifo_almost_full_next = (((wr_gray_next[AW-3:0] == wr_rd_gray_pointer[AW-3:0]) & (wr_gray_next[AW] ^ wr_rd_gray_pointer[AW])) & (wr_gray_next[AW-1] ^ wr_rd_gray_pointer[AW-1])) & (wr_gray_next[AW-2] ^ wr_rd_gray_pointer[AW-2]);
