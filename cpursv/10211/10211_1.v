...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = (((SH_VAL[7] | ROT) & (SIZE == 2'b00)) & ROT) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = (((ROT | (msb | (ROT & (SH_VAL[7] & ASH)))) & ASH) | ROT) & (SH_VAL[7] | ROT);
  assign mask_code[0] = (((SH_VAL[7] | ROT) & LSH) | ROT) | ((((SH_VAL[7] & ASH) & (LSH | ~msb)) | ((LSH | ((~msb & ASH) | (LSH & ASH))) & ROT)) | ROT);
