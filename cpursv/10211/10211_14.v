...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign mask_code[1] = (ROT | msb) & ((((ASH & SH_VAL[7]) | (((ASH & SH_VAL[7]) & ROT) & msb)) | (msb & ROT)) | ROT);
  assign mask_code[0] = (((((((ROT & LSH) | (LSH & SH_VAL[7])) | ((ASH & ROT) | (ASH & SH_VAL[7]))) | ((ASH & ~msb) & ROT)) | ROT) & ~msb) | (SH_VAL[7] & ((((((ASH & SH_VAL[7]) & ROT) | (~msb & LSH)) | LSH) | (ROT & SH_VAL[7])) | ROT))) | ROT;
