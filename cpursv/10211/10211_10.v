...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = ((((ASH | (SH_VAL[7] & ROT)) | ROT) & (SIZE == 2'b00)) & ROT) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = ((ROT | (SH_VAL[7] & ASH)) & (((ASH & msb) | ROT) & SH_VAL[7])) | ROT;
  assign mask_code[0] = (ROT | ((ASH & (~msb & SH_VAL[7])) | ((SH_VAL[7] & ASH) & ROT))) | (((((ROT | ((ASH & (~msb & SH_VAL[7])) | ((SH_VAL[7] & ASH) & ROT))) | (~msb & SH_VAL[7])) & ASH) | (LSH & (ASH & (~msb & SH_VAL[7])))) | (SH_VAL[7] & LSH));
