...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = (((ROT | (SH_VAL[7] & ASH)) & (SIZE == 2'b00)) & ROT) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = ((((msb & SH_VAL[7]) & ASH) | (SH_VAL[7] & ROT)) | (msb & ROT)) | ROT;
  assign mask_code[0] = ((SH_VAL[7] & ROT) | ((ROT | (SH_VAL[7] & ASH)) & ~msb)) | (((((ROT & (SH_VAL[7] & ASH)) | (ROT & LSH)) | (SH_VAL[7] & (((~msb & ASH) | SH_VAL[7]) & LSH))) | (ROT & (SH_VAL[7] & ASH))) | ROT);
