...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = ((SIZE == 2'b00) & ROT) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = (((SH_VAL[7] & (ASH | ROT)) | (msb & (SH_VAL[7] & (ASH | ROT)))) | ROT) & ((((((ASH & SH_VAL[7]) & msb) | ((ROT & (SH_VAL[7] | ASH)) & SH_VAL[7])) | msb) | (ROT & ((((((ROT & (SH_VAL[7] | ASH)) & SH_VAL[7]) | ((ASH & ~msb) | (LSH & ASH))) | ((~msb | (~msb & LSH)) | LSH)) | (ROT | (LSH | ((ROT & (SH_VAL[7] | ASH)) & SH_VAL[7])))) & ((ASH | (LSH & ASH)) | LSH)))) | ROT);
  assign mask_code[0] = ((((~msb & (ASH & SH_VAL[7])) & (ROT | (LSH | ((ROT & (SH_VAL[7] | ASH)) & SH_VAL[7])))) | ROT) | (SH_VAL[7] & (ROT | (LSH | ((ROT & (SH_VAL[7] | ASH)) & SH_VAL[7]))))) | (SH_VAL[7] & ((ASH & ~msb) | (~msb & LSH)));
