...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = (((SIZE == 2'b00) & ((ROT | (ASH & (~msb & (SH_VAL[7] & ASH)))) | (SH_VAL[7] & ASH))) & ROT) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = ROT | ((ROT & (SH_VAL[7] & ASH)) | (SH_VAL[7] & (msb & ASH)));
  assign mask_code[0] = ROT | ((((ROT | ((ROT | ((SH_VAL[7] & ROT) | ~msb)) & ((SH_VAL[7] & ASH) | (SH_VAL[7] & ROT)))) | (LSH | (~msb & (SH_VAL[7] & ASH)))) & ((~msb | (ROT & (SH_VAL[7] & ASH))) | SH_VAL[7])) & SH_VAL[7]);
