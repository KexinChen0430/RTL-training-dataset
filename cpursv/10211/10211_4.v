...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign mask_code[1] = (((((msb & ((ASH & ~msb) | SH_VAL[7])) & SH_VAL[7]) | (msb & (((((ASH & ~msb) & SH_VAL[7]) | ((SH_VAL[7] & ASH) & ROT)) | (ROT & ((~msb | LSH) & ASH))) | ROT))) & ASH) | ((((msb & ((ASH & ~msb) | SH_VAL[7])) & SH_VAL[7]) | (msb & (((((ASH & ~msb) & SH_VAL[7]) | ((SH_VAL[7] & ASH) & ROT)) | (ROT & ((~msb | LSH) & ASH))) | ROT))) & ROT)) | ROT;
  assign mask_code[0] = ((((SH_VAL[7] & (LSH | (SH_VAL[7] & ~msb))) & LSH) | (ROT & ((LSH | ASH) & ~msb))) | ROT) | (((ASH & ~msb) & SH_VAL[7]) | (SH_VAL[7] & ((LSH | ASH) & ~msb)));
