...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = (ROT & ((ROT | (ASH & SH_VAL[7])) & (SIZE == 2'b00))) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = ((((msb & ((ROT & ASH) | (ASH & SH_VAL[7]))) | ((SH_VAL[7] & ROT) & msb)) | (ROT & msb)) | (LSH & ROT)) | ROT;
  assign mask_code[0] = (((((~msb | SH_VAL[7]) & (~msb & ASH)) & SH_VAL[7]) & ((((ASH & (ROT | ~msb)) | LSH) | (LSH & ROT)) | ROT)) | ROT) | (((((SH_VAL[7] & (ROT | ~msb)) | ROT) & ASH) | (SH_VAL[7] & LSH)) | (LSH & ROT));
