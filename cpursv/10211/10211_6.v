...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = (ROT & (((ASH | (SH_VAL[7] & (ROT & (SH_VAL[7] | ~msb)))) | ROT) & (SIZE == 2'b00))) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = ((SH_VAL[7] & (ROT & (SH_VAL[7] | ~msb))) | (msb & (ASH & SH_VAL[7]))) | ROT;
  assign mask_code[0] = (((ASH & ROT) & SH_VAL[7]) | ((LSH | ~msb) & (ASH & SH_VAL[7]))) | (((SH_VAL[7] & (ROT | (LSH | (SH_VAL[7] & (ROT & (SH_VAL[7] | ~msb)))))) | (ROT & ((ASH & SH_VAL[7]) & ~msb))) | ROT);
