...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = ((((((((SH_VAL[7] & ~msb) & ASH) | (ROT & (~msb & ASH))) | (ROT & (((((~msb | ((ASH & SH_VAL[7]) & ROT)) | (ROT & LSH)) | ROT) | ((SH_VAL[7] & (ROT & (~msb | SH_VAL[7]))) | LSH)) & (ASH | LSH)))) | ROT) | (SH_VAL[7] | (((~msb & ASH) | LSH) & ROT))) & (SIZE == 2'b00)) & ROT) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = ((((((ASH & SH_VAL[7]) & ROT) | (msb & ASH)) | ROT) & ((SH_VAL[7] & ~msb) & ASH)) | ROT) | ((((ASH & SH_VAL[7]) & ROT) | ((((((msb | (((SH_VAL[7] & ~msb) & ASH) & ROT)) | (SH_VAL[7] & (ROT & (~msb | SH_VAL[7])))) | (ROT & LSH)) | ROT) & ASH) & ((SH_VAL[7] & ~msb) & ASH))) | (((ASH & SH_VAL[7]) & msb) | ((ASH & SH_VAL[7]) & ROT)));
  assign mask_code[0] = ((SH_VAL[7] & LSH) | ((ASH & SH_VAL[7]) & (((~msb & ASH) | LSH) | ~msb))) | (((ASH | (ASH & SH_VAL[7])) | ROT) & (ROT | ((SH_VAL[7] & ((~msb | SH_VAL[7]) & (((~msb & ASH) | LSH) | ~msb))) | ((((~msb & ASH) | LSH) | ~msb) & ROT))));
