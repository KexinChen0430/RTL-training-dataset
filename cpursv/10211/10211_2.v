...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = ((((((SH_VAL[7] & ASH) | (SH_VAL[7] & (ROT & (SH_VAL[7] | ASH)))) | ((ROT | (((SH_VAL[7] & (ROT & (SH_VAL[7] | ASH))) & ASH) | (~msb & (SH_VAL[7] & ASH)))) & ASH)) | ROT) & (SIZE == 2'b00)) & ROT) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = ((((((SH_VAL[7] & ASH) & msb) | (ROT & (~msb & (SH_VAL[7] & ASH)))) | (SH_VAL[7] & (ROT & (SH_VAL[7] | ASH)))) | ((SH_VAL[7] & (ROT & (SH_VAL[7] | ASH))) & ASH)) | ((SH_VAL[7] & (ROT & (SH_VAL[7] | ASH))) & ASH)) | ROT;
  assign mask_code[0] = ((LSH | ROT) | (~msb & ((((~msb & LSH) | (ASH & ~msb)) | LSH) | (((ASH | (SH_VAL[7] & (ROT & (SH_VAL[7] | ASH)))) | ((ASH & ~msb) & ROT)) | ROT)))) & (((SH_VAL[7] | ((((~msb & LSH) | (ASH & ~msb)) | LSH) & (ASH & ROT))) | ((((~msb & LSH) | (ASH & ~msb)) | LSH) & ROT)) | (ROT | ((LSH | ROT) & SH_VAL[7])));
