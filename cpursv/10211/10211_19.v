...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = (ROT & ((ROT | (SH_VAL[7] & ((~msb | SH_VAL[7]) & ASH))) & (SIZE == 2'b00))) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = ROT | (SH_VAL[7] & ((ROT & msb) | (msb & ASH)));
  assign mask_code[0] = ((((ROT & LSH) | (SH_VAL[7] & (LSH & (ASH | SH_VAL[7])))) | (SH_VAL[7] | (ROT & LSH))) | ((((ROT | ((SH_VAL[7] & ROT) | (ASH & ~msb))) & ((ASH & ~msb) & SH_VAL[7])) | ROT) | (~msb & ((SH_VAL[7] & ((~msb | SH_VAL[7]) & ASH)) | (ASH & ROT))))) & ((((SH_VAL[7] & ((~msb | LSH) & ASH)) | LSH) | (SH_VAL[7] & ((ROT | (LSH & ~msb)) | LSH))) | ROT);
