...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = (ROT & ((SIZE == 2'b00) & (ROT | (((((SH_VAL[7] & ((SH_VAL[7] | (~msb & ASH)) & ROT)) | (ASH & (SH_VAL[7] & (~msb & ASH)))) | (ASH & SH_VAL[7])) | (msb & (((SH_VAL[7] & ((SH_VAL[7] | (~msb & ASH)) & ROT)) | (ASH & (SH_VAL[7] & (~msb & ASH)))) | (ASH & SH_VAL[7])))) | ((((((SH_VAL[7] & ((SH_VAL[7] | (~msb & ASH)) & ROT)) | ((~msb & ASH) & (SH_VAL[7] & (~msb & ASH)))) | (SH_VAL[7] & (~msb & ASH))) | (ASH & ROT)) | ROT) & (msb & ((ASH | (ROT & ((ASH & LSH) | (~msb & ASH)))) | ROT))))))) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = (((ASH & msb) & SH_VAL[7]) | (SH_VAL[7] & ((SH_VAL[7] | (~msb & ASH)) & ROT))) | ROT;
  assign mask_code[0] = (((((ASH & LSH) | (~msb & ASH)) | LSH) & ROT) | (ROT | ((ROT & (ASH & SH_VAL[7])) | (SH_VAL[7] & LSH)))) | ((((~msb | LSH) | ROT) & ASH) & ((((((SH_VAL[7] & ((SH_VAL[7] | (~msb & ASH)) & ROT)) | ((~msb & ASH) & (SH_VAL[7] & (~msb & ASH)))) | (SH_VAL[7] & (~msb & ASH))) | (ASH & ROT)) | ROT) | SH_VAL[7]));
