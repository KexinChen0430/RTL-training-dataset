...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = ((((((((ROT & SH_VAL[7]) | (ROT & SH_VAL[7])) | (SH_VAL[7] & ASH)) | ASH) | (ROT & (~msb & (ROT | (ASH | LSH))))) | ROT) & (SIZE == 2'b00)) & ROT) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = ROT | (SH_VAL[7] & ((SH_VAL[7] | ASH) & (msb & ASH)));
  assign mask_code[0] = ((((LSH | (SH_VAL[7] & ASH)) & SH_VAL[7]) & ~msb) | ROT) | (((ROT & ASH) & SH_VAL[7]) | ((ROT & LSH) | (LSH & SH_VAL[7])));
