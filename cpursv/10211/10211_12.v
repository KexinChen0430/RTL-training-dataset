...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = (ROT & ((SIZE == 2'b00) & (((ASH | ROT) & ((ASH & ROT) | (SH_VAL[7] & ASH))) | ROT))) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = (((SH_VAL[7] & ASH) & msb) | (ROT & SH_VAL[7])) | ROT;
  assign mask_code[0] = (((ROT & ((LSH | ASH) & (~msb | LSH))) | (LSH & (SH_VAL[7] & (~msb & ASH)))) | (SH_VAL[7] & (((~msb & ASH) | SH_VAL[7]) & LSH))) | ((((SH_VAL[7] | ROT) & (~msb | ROT)) | ((SH_VAL[7] & (((~msb & ASH) | SH_VAL[7]) & LSH)) | (SH_VAL[7] & (ASH & ROT)))) & (ASH | ROT));
