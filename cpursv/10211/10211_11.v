...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign mask_code[1] = ((SH_VAL[7] & (ASH & msb)) | (((SH_VAL[7] & ASH) & ~msb) & ROT)) | ROT;
  assign mask_code[0] = (ROT | (((ASH & ROT) | (SH_VAL[7] & ASH)) & ((((~msb | (((SH_VAL[7] & ASH) & ~msb) & ROT)) | (((SH_VAL[7] | (ASH & ~msb)) & ROT) & SH_VAL[7])) | ((SH_VAL[7] & ASH) & ROT)) | ROT))) | (LSH & SH_VAL[7]);
