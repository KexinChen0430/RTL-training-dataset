...
module SHIFTER(MASKE,ROT,LSH,ASH,SIZE,SH_VAL,SH_DAT,SH_OUT,MASK_SEL);
  ...
  assign shift = (ROT & ((SIZE == 2'b00) & (ROT | ASH))) ? {2'b11,SH_VAL[2:0]} : SH_VAL[4:0];
  ...
  assign mask_code[1] = (((ROT & msb) | ((ASH & msb) & SH_VAL[7])) | ((ASH & ((((((((~msb | (~msb & SH_VAL[7])) | SH_VAL[7]) & ASH) & SH_VAL[7]) & ROT) | (((ASH & msb) | (ROT & msb)) & SH_VAL[7])) | msb) | ROT)) & (((SH_VAL[7] | ((((ASH & ROT) | (ASH & ((~msb & SH_VAL[7]) & ((((~msb | (~msb & SH_VAL[7])) | SH_VAL[7]) & ASH) & SH_VAL[7])))) | ((((~msb | (~msb & SH_VAL[7])) | SH_VAL[7]) & ASH) & SH_VAL[7])) & ~msb)) | (ROT & (ASH & (((((((~msb | (~msb & SH_VAL[7])) | SH_VAL[7]) & ASH) & SH_VAL[7]) & ROT) | ((~msb | LSH) | ((ROT & (ASH | SH_VAL[7])) & SH_VAL[7]))) | ROT)))) | ROT))) | ROT;
  assign mask_code[0] = ((((((((~msb & SH_VAL[7]) & ((((~msb | (~msb & SH_VAL[7])) | SH_VAL[7]) & ASH) & SH_VAL[7])) | LSH) | (ASH & (~msb | LSH))) & ROT) | (LSH & ((~msb & SH_VAL[7]) & ((((~msb | (~msb & SH_VAL[7])) | SH_VAL[7]) & ASH) & SH_VAL[7])))) | (LSH & SH_VAL[7])) | ROT) | (((((((~msb | (~msb & SH_VAL[7])) | SH_VAL[7]) & ASH) & SH_VAL[7]) & ROT) | ((ROT & (ASH | SH_VAL[7])) & SH_VAL[7])) | ((LSH & SH_VAL[7]) | (((~msb & SH_VAL[7]) & ((((~msb | (~msb & SH_VAL[7])) | SH_VAL[7]) & ASH) & SH_VAL[7])) | (SH_VAL[7] & (ASH & (~msb | LSH))))));
