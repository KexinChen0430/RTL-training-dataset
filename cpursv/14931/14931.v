...
module arbiter_for_OUT_req(clk,rst,OUT_req_rdy,v_ic_req,v_dc_req,v_mem_req,ic_req_ctrl,
                           dc_req_ctrl,mem_req_ctrl,ack_OUT_req,ack_ic_req,ack_dc_req,
                           ack_mem_req,select);
      ...
      begin
        ...
        case (state)
          ...
          ic_uploading: begin
                if (OUT_req_rdy) 
                  begin
                    if (ic_req_ctrl == 2'b11) nstate = arbiter_idle;
          ...
          dc_uploading: begin
                if (OUT_req_rdy) 
                  begin
                    if (dc_req_ctrl == 2'b11) nstate = arbiter_idle;
          ...
          mem_uploading: begin
                if (OUT_req_rdy) 
                  begin
                    if (mem_req_ctrl == 2'b11) nstate = arbiter_idle;
  ...
  always @(posedge clk)
      begin
        ...
        else if (update_priority) priority_2 <= {priority_2[0],priority_2[1]};
