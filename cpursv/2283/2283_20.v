  ...
  always @(posedge clock)
      begin
        ...
        if (idle_Special == no_idle) 
          begin
            zout_Multiply[32] <= ((~a_sign | ~b_sign) & a_sign) | ((~(~a_sign & (b_sign ^ (b_sign & (a_sign & b_sign)))) & (((a_sign & b_sign) ^ ((((~b_sign | b_sign) & a_sign) & b_sign) & a_sign)) & ~a_sign)) | ((~a_sign & (b_sign ^ (b_sign & (a_sign & b_sign)))) & ~(((a_sign & b_sign) ^ ((((~b_sign | b_sign) & a_sign) & b_sign) & a_sign)) & ~a_sign)));
            zout_Multiply[31:24] <= (1+a_exponent)+b_exponent;
