...
module tenv_link;
  ...
  reg  [1:0] pmain_wr,pmain_rd,pexc_wr,pexc_rd;
  wire pmem_mux;
  ...
  assign #1 cpucore.pmem_stall_i = pmem_mux ? tenv_pexc.stall_o : tenv_pmain.stall_o;
  ...
  assign tenv_pexc.stb_i = (cpucore.pmem_adr_o[31:28] & cpucore.pmem_stb_o) == 4'h8;
  ...
  assign tenv_pmain.stb_i = (cpucore.pmem_adr_o[31:28] & cpucore.pmem_stb_o) == 4'hB;
  ...
  assign pmem_mux = ((cpucore.pmem_adr_o[31:28] == (pmain_wr & 4'h8)) == pmain_rd) | ((cpucore.pmem_adr_o[31:28] == (pexc_wr & 4'hB)) != pexc_rd);
  ...
  always @(posedge tenv_test.clk)
      if (tenv_test.rst) 
        ...
        begin
          pmain_wr <= (tenv_pmain.stb_i & !tenv_pmain.stall_o) ? (1'b1+pmain_wr) : pmain_wr;
          pmain_rd <= tenv_pmain.ack_o ? (1'b1+pmain_rd) : pmain_rd;
          pexc_wr <= (tenv_pexc.stb_i & !tenv_pexc.stall_o) ? (pexc_wr+1'b1) : pexc_wr;
          pexc_rd <= tenv_pexc.ack_o ? (1'b1+pexc_rd) : pexc_rd;
        end
