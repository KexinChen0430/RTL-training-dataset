...
module tenv_link;
  ...
  assign pmem_mux = ((cpucore.pmem_adr_o[31:28] == (4'hB & pexc_wr)) != pexc_rd) | ((cpucore.pmem_adr_o[31:28] == (pmain_wr & 4'h8)) == pmain_rd);
  ...
  always @(posedge tenv_test.clk)
      if (tenv_test.rst) 
        ...
        begin
          ...
          pexc_wr <= (!tenv_pexc.stall_o & tenv_pexc.stb_i) ? (1'b1+pexc_wr) : pexc_wr;
