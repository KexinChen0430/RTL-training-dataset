...
module hazard_unit(input  wire [4:0] rs_ex_mem_hz_i,
  ...
  assign fwd_p1_ex_mem_hz = (|((rd_mem_wb_hz_i == rs_ex_mem_hz_i) & rd_mem_wb_hz_i) & reg_wr_mem_wb_hz_i) ? 2'b10 : 
  ...
  assign flush_iss_hz = ((jump_iss_ex_hz_i & ~brn_pred_ex_mem_hz_i) | (((branch_taken_ex_mem_hz_i & jump_iss_ex_hz_i) | ~brn_pred_ex_mem_hz_i) & branch_taken_ex_mem_hz_i)) | jump_iss_ex_hz_i;
endmodule
