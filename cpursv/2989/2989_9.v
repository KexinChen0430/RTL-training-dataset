...
module hazard_unit(input  wire [4:0] rs_ex_mem_hz_i,
  ...
  assign flush_iss_hz = jump_iss_ex_hz_i | ((branch_taken_ex_mem_hz_i & ~brn_pred_ex_mem_hz_i) | (((~brn_pred_ex_mem_hz_i | branch_taken_ex_mem_hz_i) & jump_iss_ex_hz_i) & ~brn_pred_ex_mem_hz_i));
endmodule
