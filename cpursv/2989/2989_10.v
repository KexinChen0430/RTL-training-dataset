...
module hazard_unit(input  wire [4:0] rs_ex_mem_hz_i,
  ...
  assign fwd_p2_ex_mem_hz = (|(rd_mem_wb_hz_i & (rd_mem_wb_hz_i == rt_ex_mem_hz_i)) & reg_wr_mem_wb_hz_i) ? 2'b10 : 
                            (reg_wr_wb_ret_hz_i & |(rd_wb_ret_hz_i & (rd_wb_ret_hz_i == rt_ex_mem_hz_i))) ? 2'b01 : 2'b00;
  assign stall_fetch_hz = 1'b0;
  assign stall_iss_hz = 1'b0;
  assign flush_ex_hz = branch_taken_ex_mem_hz_i & (~brn_pred_ex_mem_hz_i & (branch_taken_ex_mem_hz_i | jump_iss_ex_hz_i));
  assign flush_iss_hz = jump_iss_ex_hz_i | (branch_taken_ex_mem_hz_i & (~brn_pred_ex_mem_hz_i & (branch_taken_ex_mem_hz_i | jump_iss_ex_hz_i)));
endmodule
