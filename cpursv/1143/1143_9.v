...
module user_io(input  SPI_CLK,
  ...
  always @(posedge SPI_CLK)
      begin
        kbd_mouse_strobe_level <= #1 (~kbd_mouse_strobe & ((~kbd_mouse_strobe_level & kbd_mouse_strobe) | kbd_mouse_strobe_level)) | (~kbd_mouse_strobe_level & ((~kbd_mouse_strobe_level & kbd_mouse_strobe) | kbd_mouse_strobe_level));
        if (SPI_SS_IO == 1) 
          begin
            cnt <= 0;
          end
