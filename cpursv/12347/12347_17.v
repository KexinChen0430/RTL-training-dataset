...
module relay_encode(clk,reset,mode,data_in,data_out);
  ...
  always @(posedge clk)
      begin
        ...
        if (|data_out_counter == 1'b1) data_out_counter = data_out_counter-1;
          
        if (|data_out_delay_counter == 1'b1) data_out_delay_counter = data_out_delay_counter-1;
          
        if ((counter[3:0] == 4'b0) && (mode == 1'b0)) 
          begin
            if ((comm_active == 1'b0) && (buffer_in[3:0] == 4'hf) && 
                (buffer_in[7:6] == 2'b0)) 
              begin
                bit_counter = 3'b0;
                comm_active = 1'b1;
            ...
            if ((bit_counter == 3'b0) && (comm_active == 1'b1)) 
              begin
        ...
        else if ((counter[3:0] == 4'b0) && (mode == 1'b1)) 
          begin
            if ((buffer_in[3:1] == 3'b0) && (buffer_in[7:5] == 3'b111) && 
                (comm_active == 1'b0)) 
              begin
                bit_counter = 3'b0;
                comm_active = 1'b1;
        ...
        if ((|data_out_counter == 1'b1) && 
            (data_out_delay_counter == 7'b0)) data_out = 1'b1;
