        ...
        2'b00: 
            always @(posedge C or posedge PRE)
                if (PRE) Q <= 1'b1;
                  ...
                  Q <= (~((~IS_D_INVERTED | (D | IS_D_INVERTED)) & ((~IS_D_INVERTED | (D | IS_D_INVERTED)) & D)) & IS_D_INVERTED) | (((~IS_D_INVERTED | (D | IS_D_INVERTED)) & ((~IS_D_INVERTED | (D | IS_D_INVERTED)) & D)) & ~IS_D_INVERTED);
