...
module k580wn59(input  clk,
  ...
  reg  exinta_n;
  wire [7:0] 
       r = irq & ((~(irqmask | smask) & ((((serviced | irq) & smask) | irq) | ((serviced & ((serviced | irq) & smask)) | irqmask))) | (~(irqmask | smask) & (((irq | smask) & (irqmask | (irq & (serviced & ((serviced | irq) & smask))))) | smask)));
