...
module ad_jesd_align(rx_clk,rx_sof,rx_eof,rx_ferr,rx_fdata,rx_err,rx_data);
  ...
  always @(posedge rx_clk)
      begin
        ...
        if (rx_sof_hold[3] == 1'b1) 
          begin
            rx_data <= rx_fdata_d;
          end
        else if (rx_sof_hold[2] == 1'b1) 
          begin
            rx_data <= {rx_fdata_d[23:0],rx_fdata[31:24]};
          end
        else if (rx_sof_hold[1] == 1'b1) 
          begin
            rx_data <= {rx_fdata_d[15:0],rx_fdata[31:16]};
          end
        else if (rx_sof_hold[0] == 1'b1) 
          begin
