...
module scrambler  #(parameter  WIDTH = 512)
  ...
  generate
      for (i = 58; i < (WIDTH+58); i = i+1)
          begin : lp
            assign history[i] = (din[i+(-58)] & ~(((~history[i+(-58)] | history[i+(-58)]) & history[i+(-39)]) ^ history[i+(-58)])) | (((~history[i+(-39)] & (~history[i+(-58)] | history[i+(-58)])) | ~history[i+(-58)]) & ((~din[i+(-58)] | (din[i+(-58)] & ~(((~history[i+(-58)] | history[i+(-58)]) & history[i+(-39)]) ^ history[i+(-58)]))) & (history[i+(-58)] | history[i+(-39)])));
          end
  endgenerate
