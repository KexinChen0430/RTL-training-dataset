...
(
((^OD_H === 1'bx) || 
(!pwr_good_hold_mode && (OD_H === 0)) || !pwr_good_hold_mode) && (^HLD_H_N === 1'bx))) || 
            (((OD_H === 0) && (^HLD_H_N === 1'bx)) || 
(!pwr_good_hold_mode && (^HLD_H_N === 1'bx))) || 
            (((OD_H === 0) && (^HLD_H_N === 1'bx)) || 
(!pwr_good_hold_mode && (^HLD_H_N === 1'bx)) || 
((^OD_H === 1'bx) && 
(
((^OD_H === 1'bx) || 
(!pwr_good_hold_mode && (OD_H === 0)) || !pwr_good_hold_mode) && (^HLD_H_N === 1'bx))) || !pwr_good_hold_mode || 
((OD_H === 0) && 
((^OD_H === 1'bx) || 
(!pwr_good_hold_mode && (OD_H === 0)) || !pwr_good_hold_mode)))) 
          begin
            dm_final = 3'bxxx;
            slow_final = 1'bx;
