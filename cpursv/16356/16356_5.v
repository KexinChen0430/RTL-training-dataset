...
module auddma_engine(input  clk,
                     output dma,
  ...
  assign audlcena = (~(reg_address_in[7] & (~reg_address_in[8] & (~reg_address_in[2] & (~reg_address_in[3] & reg_address_in[5])))) & (reg_address_in[7] & (~reg_address_in[8] & (~reg_address_in[2] & (~reg_address_in[3] & reg_address_in[6]))))) | ((reg_address_in[7] & (~reg_address_in[8] & (~reg_address_in[2] & (~reg_address_in[3] & reg_address_in[5])))) & ~(reg_address_in[7] & (~reg_address_in[8] & (~reg_address_in[2] & (~reg_address_in[3] & reg_address_in[6])))));
  assign audlcsel = {~reg_address_in[5],reg_address_in[4]};
  
  always @(posedge clk)
      if (~reg_address_in[1] & audlcena) audlch[audlcsel] <= data_in[4:0];
        
  
  always @(posedge clk)
      if (reg_address_in[1] & audlcena) audlcl[audlcsel] <= data_in[15:1];
  ...
  always @(posedge clk)
      if (dmal) 
        audpt[channel] <= dmas ? audlcout[20:1] : (1'b1+audptout[20:1]);
