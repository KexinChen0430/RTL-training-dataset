...
module video_outmux(input  wire clk,
  ...
  always @(posedge clk)
      begin
        ...
        vvsync <= vsync;
        vcsync <= ~(((((hsync & vsync) & ~(hsync & (((~vsync | vsync) & hsync) & (~hsync | hsync)))) | (hsync & (((~vsync | vsync) & hsync) & (~hsync | hsync)))) & (((hsync & vsync) & ~(hsync & (((~vsync | vsync) & hsync) & (~hsync | hsync)))) | ~(hsync & vsync))) | (vsync & ~hsync));
      end
endmodule
