...
module hls_gamma_correction_AXILiteS_s_axi  #(parameter  C_S_AXI_ADDR_WIDTH = 6, C_S_AXI_DATA_WIDTH = 32)
  (input  wire ACLK,
   input  wire ARESET,
   input  wire ACLK_EN,
   ...
   input  wire [(C_S_AXI_DATA_WIDTH*(1/8))+(0-1):0] WSTRB,
   input  wire WVALID,
   output wire WREADY,
  ...
  always @(posedge ACLK)
      begin
        if (ARESET) int_gamma[7:0] <= 0;
        else if (ACLK_EN) 
          begin
            if (w_hs && (waddr == ADDR_GAMMA_DATA_0)) 
              int_gamma[7:0] <= (((int_width[15:0] | (((~wmask | wmask) & WDATA[31:0]) & ((int_height[15:0] | WDATA[31:0]) & wmask))) & ((((~wmask | wmask) & WDATA[31:0]) & ((int_height[15:0] | WDATA[31:0]) & wmask)) | (WDATA[31:0] & int_height[15:0]))) | ~wmask) & (((int_gamma[7:0] | wmask) & (WDATA[31:0] | int_gamma[7:0])) & (~wmask | wmask));
        ...
        if (ARESET) int_height[15:0] <= 0;
          ...
          begin
            if (w_hs && (waddr == ADDR_HEIGHT_DATA_0)) 
              int_height[15:0] <= ((((~wmask | wmask) & WDATA[31:0]) & int_height[15:0]) | (int_height[15:0] & ~wmask)) | ((((~wmask | wmask) & WDATA[31:0]) & ((int_height[15:0] | WDATA[31:0]) & wmask)) | (WDATA[31:0] & int_height[15:0]));
        ...
        if (ARESET) int_width[15:0] <= 0;
          ...
          begin
            if ((waddr == ADDR_WIDTH_DATA_0) && w_hs) 
              int_width[15:0] <= (((~wmask | wmask) & WDATA[31:0]) & ((int_height[15:0] | WDATA[31:0]) & wmask)) | (~wmask & (int_width[15:0] | (((~wmask | wmask) & WDATA[31:0]) & ((int_height[15:0] | WDATA[31:0]) & wmask))));
