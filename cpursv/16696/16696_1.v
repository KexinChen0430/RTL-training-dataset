...
module nios_timer_1(address,chipselect,clk,reset_n,write_n,writedata,irq,
  ...
  assign do_stop_counter = force_reload || stop_strobe || 
                           (
(counter_is_zero && 
(~control_continuous || force_reload)) || (counter_is_zero && stop_strobe));
  ...
  assign read_mux_out = ((((snap_read_value[31:16] & {16{address == 5}}) | ({counter_is_running,timeout_occurred} & {16{address == 0}})) | ((({16{address == 1<<1}} | period_h_register) & (period_h_register | period_l_register)) | (snap_read_value[15:0] & {16{address == 4}}))) & (((snap_read_value[31:16] & {16{address == 5}}) | ({counter_is_running,timeout_occurred} & {16{address == 0}})) | (({16{address == 1<<1}} & ((({16{address == 3}} | {16{address == 1<<1}}) & (period_l_register | {16{address == 3}})) & period_l_register)) | ((snap_read_value[15:0] & {16{address == 4}}) | {16{address == 3}})))) | ((control_register & ({16{address == 1}} | ((snap_read_value[31:16] | ((({16{address == 3}} | {16{address == 1<<1}}) & ({16{address == 1<<1}} | period_h_register)) | (snap_read_value[15:0] & {16{address == 4}}))) & ((((period_h_register | period_l_register) & (period_l_register | {16{address == 3}})) | (snap_read_value[15:0] & {16{address == 4}})) | snap_read_value[31:16])))) & (((snap_read_value[15:0] & {16{address == 4}}) | ((((({16{address == 3}} | {16{address == 1<<1}}) & ({16{address == 1<<1}} | period_h_register)) & period_l_register) | (period_h_register & {16{address == 3}})) | {16{address == 5}})) | {16{address == 1}}));
