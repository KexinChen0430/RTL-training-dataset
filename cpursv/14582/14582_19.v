...
module AR_RXD(input  clk,
  ...
  assign sig = in0 | in1;
  assign glitch = 
((cc != m12_5kb) || (!sig && (cc != (m12_5kb+(-1))))) && !sig && 
                  (((cc != (m100kb+(-1))) || (cc != m100kb)) && 
((cc != m50kb) || 
((cc != (m50kb+(-1))) || 
(
((cc != (m50kb+(-1))) && (!sig && (cc != m12_5kb))) || ((cc != m50kb) && !sig && (cc != m12_5kb))))));
  ...
  always @(posedge clk)
      begin
        ...
        data <= ((new_bit == 1) && (!sig && !err)) ? ((data*2)+1) : 
               (!err && (!sig && (new_bit == 0))) ? (data*2) : 
               (!sig && !err) ? data : 
               sig ? data : 0;
        if (((new_bit == 0) || (new_bit == 1)) && 
            (!sig && !err && (cb != 32))) cb <= cb+1;
