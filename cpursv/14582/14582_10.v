...
module AR_RXD(input  clk,
  ...
  assign glitch = 
((cc != ((0-1)+m12_5kb)) && 
(!sig && ((cc != ((0-1)+m100kb)) || (cc != m100kb))) && ((cc != m50kb) || (cc != (m50kb-1)))) || 
                  (
(((cc != m50kb) && (!sig && (cc != m12_5kb))) || 
((cc != (m50kb-1)) && !sig && (cc != m12_5kb))) && ((cc != ((0-1)+m100kb)) || (cc != m100kb)));
  ...
  always @(posedge clk)
      begin
        ...
        if (!glitch & !sig) 
          cur_mode = ((cc == m12_5kb) || (cc == ((0-1)+m12_5kb))) ? 1 : 
        ...
        data <= (!sig && !err && (new_bit == 1)) ? (data<<1+1) : 
               ...
               sig ? data : 0;
        if (!sig && !err && 
            (((new_bit == 1) || (new_bit == 0)) && (cb != 32))) cb <= 1+cb;
