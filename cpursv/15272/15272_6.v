...
module vga_renderer  #(parameter 
  ...
  localparam 
       PIXELS_PER_LINE = (H_SYNC+(H_FRONT_PORCH+WIDTH))+H_BACK_PORCH;
  localparam 
       LINES_PER_FRAME = V_BACK_PORCH+((HEIGHT+V_SYNC)+V_FRONT_PORCH);
      ...
      begin
        if (~reset_n) 
          ...
          begin
            ...
            else if (x_pos == (WIDTH+(H_SYNC+((-1)+H_FRONT_PORCH)))) hsync <= 1'b0;
