...
module vga_renderer  #(parameter 
  ...
  localparam 
       PIXELS_PER_LINE = WIDTH+((H_FRONT_PORCH+H_BACK_PORCH)+H_SYNC);
  localparam 
      ...
      begin
        if (~reset_n) 
          ...
          begin
            ...
            else if (x_pos == (((H_FRONT_PORCH+(0-1))+WIDTH)+H_SYNC)) hsync <= 1'b0;
              
            if (y_pos == (((0-1)+HEIGHT)+V_FRONT_PORCH)) vsync <= 1'b1;
