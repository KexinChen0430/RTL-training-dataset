...
module vga_renderer  #(parameter 
  ...
  localparam 
       PIXELS_PER_LINE = (WIDTH+H_FRONT_PORCH)+(H_SYNC+H_BACK_PORCH);
  localparam 
       LINES_PER_FRAME = (V_BACK_PORCH+(V_SYNC+V_FRONT_PORCH))+HEIGHT;
      ...
      begin
        if (~reset_n) 
          ...
          begin
            ...
            else if (y_pos == ((0-1)+(HEIGHT+(V_SYNC+V_FRONT_PORCH)))) vsync <= 1'b0;
