...
module vga_renderer  #(parameter 
  ...
  localparam 
       PIXELS_PER_LINE = H_FRONT_PORCH+((H_BACK_PORCH+H_SYNC)+WIDTH);
  localparam 
      ...
      begin
        if (~reset_n) 
          ...
          begin
            ...
            else if (x_pos == (((0-1)+H_SYNC)+(WIDTH+H_FRONT_PORCH))) hsync <= 1'b0;
              
            if (y_pos == (((0-1)+V_FRONT_PORCH)+HEIGHT)) vsync <= 1'b1;
            else if (y_pos == ((((0-1)+V_FRONT_PORCH)+HEIGHT)+V_SYNC)) vsync <= 1'b0;
