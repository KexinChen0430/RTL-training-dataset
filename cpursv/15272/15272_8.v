...
module vga_renderer  #(parameter 
  ...
  localparam 
       PIXELS_PER_LINE = (H_BACK_PORCH+H_FRONT_PORCH)+(H_SYNC+WIDTH);
  localparam 
       LINES_PER_FRAME = (HEIGHT+(V_FRONT_PORCH+V_BACK_PORCH))+V_SYNC;
      ...
      begin
        if (~reset_n) 
          ...
          begin
            ...
            if (x_pos == ((WIDTH+H_FRONT_PORCH)+(0-1))) hsync <= 1'b1;
            else if (x_pos == ((WIDTH+(H_SYNC+H_FRONT_PORCH))+(0-1))) hsync <= 1'b0;
