...
module eth_rxstatem(MRxClk,Reset,MRxDV,ByteCntEq0,ByteCntGreat2,Transmitting,
  ...
  assign StartIdle = ~MRxDV & ((StateSFD | StatePreamble) | (StateDrop | |StateData));
  assign StartPreamble = (~Transmitting & StateIdle) & (~MRxDEq5 & MRxDV);
  assign StartSFD = (MRxDEq5 & MRxDV) & ((~Transmitting & StateIdle) | StatePreamble);
  assign StartData0 = ((MRxDEqD & StateSFD) | (StateData1 & MRxDV)) & (MRxDV & (IFGCounterEq24 | StateData1));
  assign StartData1 = (MRxDV & ~ByteCntMaxFrame) & StateData0;
  assign StartDrop = (((MRxDEqD & (StateIdle & Transmitting)) | ((StateSFD & ((StateIdle | ~IFGCounterEq24) & (~IFGCounterEq24 | Transmitting))) & MRxDEqD)) & MRxDV) | (MRxDV & ((StateData0 & ByteCntMaxFrame) | (StateIdle & Transmitting)));
