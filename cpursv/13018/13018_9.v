...
module wb_dma_wb_mast(clk,rst,wb_data_i,wb_data_o,wb_addr_o,wb_sel_o,wb_we_o,
  ...
  assign mast_din_sel = ((mast_sel == 'b0010) || (mast_sel == 'b1000) || 
                        ((mast_sel == 'b0100) || (mast_sel == 'b0001))) ? {mast_din[7:0],mast_din[7:0],mast_din[7:0],mast_din[7:0]} : 
                        ((mast_sel == 'b1100) || (mast_sel == 'b0011)) ? {mast_din[15:0],mast_din[15:0]} : mast_din;
