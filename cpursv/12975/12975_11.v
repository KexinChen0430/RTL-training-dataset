  ...
  always @(posedge Clk)
      if (Clear_in) 
        ...
        begin
          ...
          GrayCount_out <= {BinaryCount[COUNTER_WIDTH+(-1)],BinaryCount[COUNTER_WIDTH-2:0] ^ ((BinaryCount[COUNTER_WIDTH-2:0] | ~BinaryCount[COUNTER_WIDTH-2:0]) & BinaryCount[COUNTER_WIDTH+(-1):1])};
        end
