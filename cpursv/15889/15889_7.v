...
module test_stub_scan(mux_drive_disable,mem_write_disable,sehold,se,testmode_l,
                      mem_bypass,so_0,so_1,so_2,ctu_tst_pre_grst_l,arst_l,
                      global_shift_enable,ctu_tst_scan_disable,ctu_tst_scanmode,
                      ctu_tst_macrotest,ctu_tst_short_chain,long_chain_so_0,
                      short_chain_so_0,long_chain_so_1,short_chain_so_1,
  ...
  assign mux_drive_disable = (se | ~ctu_tst_pre_grst_l) | short_chain_select;
  assign mem_write_disable = se | ~ctu_tst_pre_grst_l;
  assign sehold = ~se & ctu_tst_macrotest;
  assign se = global_shift_enable;
  assign testmode_l = ~ctu_tst_scanmode;
  assign mem_bypass = ~testmode_l & ~ctu_tst_macrotest;
  assign pin_based_scan = ctu_tst_scan_disable;
  assign short_chain_en = ~(se & pin_based_scan);
  assign short_chain_select = short_chain_en & (ctu_tst_short_chain & ~testmode_l);
