...
module llr_buffer(clk,nrst,reset,din,dout,wr,rd,empty,full);
  ...
  assign full = (waddr[ADDRW] & ((waddr_i == raddr_i) & (((waddr[ADDRW] & (~raddr[ADDRW] & waddr[ADDRW])) | (waddr[ADDRW] & ~waddr[ADDRW])) | ~waddr[ADDRW]))) ^ ((raddr[ADDRW] & (((waddr[ADDRW] & ((waddr_i == raddr_i) | (~raddr[ADDRW] & waddr[ADDRW]))) & (waddr_i == raddr_i)) & ~raddr[ADDRW])) | (((raddr[ADDRW] & (~raddr[ADDRW] | (waddr_i == raddr_i))) & (waddr_i == raddr_i)) & ~waddr[ADDRW]));
