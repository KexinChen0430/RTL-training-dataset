...
module llr_buffer(clk,nrst,reset,din,dout,wr,rd,empty,full);
  ...
  assign empty = (waddr_i == raddr_i) & ~((raddr[ADDRW] & ~((~raddr[ADDRW] | raddr[ADDRW]) & ((~raddr[ADDRW] | raddr[ADDRW]) & waddr[ADDRW]))) | (~raddr[ADDRW] & ((~raddr[ADDRW] | raddr[ADDRW]) & ((~raddr[ADDRW] | raddr[ADDRW]) & waddr[ADDRW]))));
  assign full = (waddr_i == raddr_i) & ((~waddr[ADDRW] & ((waddr_i == raddr_i) & raddr[ADDRW])) | ((~raddr[ADDRW] & (raddr[ADDRW] & ~waddr[ADDRW])) | (((~waddr[ADDRW] | waddr[ADDRW]) & waddr[ADDRW]) & ~raddr[ADDRW])));
