...
module llr_buffer(clk,nrst,reset,din,dout,wr,rd,empty,full);
  ...
  assign full = (((~raddr[ADDRW] & (waddr[ADDRW] | (waddr_i == raddr_i))) & (waddr_i == raddr_i)) & (((~waddr[ADDRW] | waddr[ADDRW]) & waddr[ADDRW]) | (raddr[ADDRW] & (~waddr[ADDRW] | waddr[ADDRW])))) | ((~waddr[ADDRW] & raddr[ADDRW]) & (waddr_i == raddr_i));
