...
module axi_stream_ingress_demo  #(parameter 
  ...
  (input  clk,
   ...
   input  i_tvalid,
   output reg o_tready,
   input  [(0-1)+DATA_WIDTH:0] i_tdata,
   input  [(0-1)+STROBE_WIDTH:0] i_tstrb,
   input  [(0-1)+STROBE_WIDTH:0] i_tkeep,
   input  i_tlast,
   input  [3:0] i_tuser,
   input  [3:0] i_tid,
   input  [31:0] i_tdest);
  ...
  reg  [3:0] state;
  reg  [ADDR_WIDTH+(0-1):0] address;
  reg  [(0-1)+DATA_WIDTH:0] control;
  reg  [(0-1)+DATA_WIDTH:0] status;
