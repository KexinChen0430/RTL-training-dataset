...
module der_reg_2(input  de_clk,
  ...
  assign buf_ctrl_2 = {buf_ctrl_r[12:4],(((buf_ctrl_r[3] & (buf_ctrl_r[0] | buf_ctrl_r[2])) & buf_ctrl_r[0]) | (buf_ctrl_r[2] & buf_ctrl_r[0])) | buf_ctrl_r[3],buf_ctrl_r[2:0]};
  wire [1:0] psize;
