...
module fifo_ctr(input  wire clk,
                input  wire rst_n,
                input  wire push,
                input  wire pop,
                output reg empty,
      ...
      begin
        ...
        case (state)
          ...
          FULL: begin
                ...
                else if (do_idle || do_push || do_push_pop) 
                  begin
