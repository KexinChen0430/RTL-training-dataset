...
module wcsl420(input  wire clk,
  ...
  wire  wcnsls_datai = iobus_iob_fm_datai & wcnsls_sel;

  wire [0:8] 
       ctl1n = {ctl1[12],ctl1[13],ctl1[10] | ctl1[11],ctl1[15],ctl1[14],1'b0,3'b0};

  wire [0:8] 
       ctl2n = {ctl2[12],ctl2[13],ctl2[10] | ctl2[11],ctl2[15],ctl2[14],1'b0,3'b0};

  wire [0:8] 
       ctl3n = {ctl3[12],ctl3[13],ctl3[10] | ctl3[11],ctl3[15],ctl3[14],1'b0,3'b0};

  wire [0:8] 
       ctl4n = {ctl4[12],ctl4[13],ctl4[11] | ctl4[10],ctl4[15],ctl4[14],1'b0,3'b0};

  assign iobus_iob_out = wcnsls_datai ? ~{ctl4n,ctl3n,ctl2n,ctl1n} : 36'b0;
endmodule
