  ...
  always @(posedge clk or negedge rst)
      begin
        if (!rst) counter <= 'h0;
          ...
          counter <= ((counter < 32'hFFFFFFFF) && (pin_select != 'h0)) ? (1'b1+counter) : 'h0;
      end
        ...
        if (!rst) pull_done <= 1'bz;
          ...
          begin
            pull_done <= ((pin_select[15:8] == 8'h53) && (counter < 'd3500000)) ? 1'b0 : 
                        ((counter < 'd100000000) && (pin_select[15:8] == 8'h4c)) ? 1'b0 : 
      ...
      begin
        if (!rst) press_done <= 1'b0;
          ...
          press_done <= ((counter > 'd3500000) && (pin_select[15:8] == 8'h53)) ? 1'b1 : 
                       ((counter > 'd100000000) && (pin_select[15:8] == 8'h4c)) ? 1'b1 : 
                       ((counter > 'd500000000) && (pin_select[15:8] == 8'h56)) ? 1'b1 : 
