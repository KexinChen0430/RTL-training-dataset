          ...
          begin
            case (switch)
              ...
              2'b00: begin
                    if (down) 
                      begin
                        y1 <= (y1 <= ((-YSPEED)+SCR_HEIGHT)) ? (YSPEED+y1) : y1;
                      end
                    else if (up) 
                      begin
                      ...
                      begin
                        x1 <= (x1 <= (SCR_WIDTH+(0-XSPEED))) ? (x1+XSPEED) : x1;
                      end
              ...
              2'b01: begin
                    if (down) 
                      begin
                        y2 <= (y2 <= ((-YSPEED)+SCR_HEIGHT)) ? (YSPEED+y2) : y2;
                      end
                    else if (up) 
                      begin
                      ...
                      begin
                        x2 <= (x2 <= (SCR_WIDTH+(0-XSPEED))) ? (x2+XSPEED) : x2;
                      end
              ...
              2'b10: begin
                    if (down) 
                      begin
                        y3 <= (y3 <= ((-YSPEED)+SCR_HEIGHT)) ? (y3+YSPEED) : y3;
                      end
                    else if (up) 
                      begin
                      ...
                      begin
                        x3 <= (x3 <= (SCR_WIDTH+(0-XSPEED))) ? (XSPEED+x3) : x3;
                      end
              ...
              2'b11: begin
                    if (down) 
                      begin
                        y4 <= (y4 <= ((-YSPEED)+SCR_HEIGHT)) ? (YSPEED+y4) : y4;
                      end
                    else if (up) 
                      begin
                      ...
                      begin
                        x4 <= (x4 <= (SCR_WIDTH+(0-XSPEED))) ? (x4+XSPEED) : x4;
                      end
