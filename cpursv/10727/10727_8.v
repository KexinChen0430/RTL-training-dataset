            ...
            case (switch)
              ...
              2'b00: begin
                    if (down) 
                      ...
                      begin
                        x1 <= (x1 <= ((0-XSPEED)+SCR_WIDTH)) ? (XSPEED+x1) : x1;
                      end
              ...
              2'b01: begin
                    if (down) 
                      begin
                        y2 <= (y2 <= (SCR_HEIGHT-YSPEED)) ? (YSPEED+y2) : y2;
                      end
                    else if (up) 
                      begin
                        y2 <= (y2 >= YSPEED) ? ((-YSPEED)+y2) : y2;
                      end
                    else if (left) 
                      begin
                        x2 <= (x2 >= XSPEED) ? ((0-XSPEED)+x2) : x2;
                      end
                    else if (right) 
                      begin
              ...
              2'b10: begin
                    if (down) 
                      ...
                      begin
                        x3 <= (x3 <= ((0-XSPEED)+SCR_WIDTH)) ? (x3+XSPEED) : x3;
                      end
