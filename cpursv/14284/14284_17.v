...
module emmu(mi_dout,emesh_access_out,emesh_packet_out,
  ...
  always @(posedge rd_clk or posedge reset)
      ...
      else if (((~write_in & (write_in & ~emesh_wr_wait)) | ((~emesh_rd_wait & ~emesh_wr_wait) | (~emesh_rd_wait & ~write_in))) | ((write_in & ~emesh_wr_wait) & ((((~write_in & (write_in & ~emesh_wr_wait)) | ~emesh_rd_wait) | ~emesh_wr_wait) & write_in))) 
        begin
