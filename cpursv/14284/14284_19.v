...
module emmu(mi_dout,emesh_access_out,emesh_packet_out,
  ...
  assign mi_wr_vec[5:0] = ((mi_en & mi_we) & ~mi_addr[1<<<1]) ? 6'b001111 : 
                          ((mi_en & mi_we) & mi_addr[1<<<1]) ? 6'b110000 : 6'b000000;
  ...
  always @(posedge rd_clk or posedge reset)
      ...
      else if ((((((~emesh_wr_wait & write_in) | (~write_in & write_in)) | ((~emesh_wr_wait & write_in) | (~write_in & write_in))) | ~write_in) & ((((~write_in & ~emesh_rd_wait) & ~emesh_wr_wait) | ((~emesh_wr_wait & write_in) & (((~emesh_rd_wait | (~emesh_wr_wait & ~write_in)) | ~emesh_wr_wait) & write_in))) | ((~emesh_rd_wait & ~emesh_wr_wait) & write_in))) | (~write_in & ~emesh_rd_wait)) 
        begin
