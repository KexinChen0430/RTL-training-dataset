...
module emmu(mi_dout,emesh_access_out,emesh_packet_out,
  ...
  assign mi_wr_vec[5:0] = ((mi_en & ~mi_addr[1<<1]) & mi_we) ? 6'b001111 : 
  ...
  always @(posedge rd_clk or posedge reset)
      ...
      else if (((~emesh_wr_wait & (~emesh_rd_wait | (write_in & ~emesh_wr_wait))) | ((write_in & ~emesh_wr_wait) & ~write_in)) | (~emesh_rd_wait & ~write_in)) 
        begin
