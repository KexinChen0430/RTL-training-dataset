...
module emmu(mi_dout,emesh_access_out,emesh_packet_out,
  ...
  assign emmu_rd_addr[(-1)+MAW:0] = emesh_packet_in[39:28];
  ...
  always @(posedge rd_clk or posedge reset)
      ...
      else if ((~write_in & ~emesh_rd_wait) | ((((~write_in & ~emesh_rd_wait) & write_in) | ((write_in & ~emesh_wr_wait) & (write_in & (~emesh_wr_wait | ~emesh_rd_wait)))) | (~emesh_wr_wait & (write_in & ~emesh_rd_wait)))) 
        begin
