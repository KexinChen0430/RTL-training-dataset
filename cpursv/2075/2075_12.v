...
module sram_ctl(input  wire clk_i,
  ...
  assign mem_go_o = (cpc_pause_o & cpc_pause_ack_i) ? ((rd_rise | ((A_i == 4'd0) & wr_rise)) & (A_i == 4'd0)) : ((cwr_rise | crd_rise) & cpc_en_i);
        ...
        begin
          if (incr_address & (mem_valid_i | mem_busy_i)) 
            ...
            case (A_i)
              ...
              4'b0000: begin
                    if ((rd_rise | ((A_i == 4'd0) & wr_rise)) | (wr_rise | ((A_i == 4'd0) & rd_rise))) incr_address <= 1'b1;
