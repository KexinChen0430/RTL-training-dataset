...
module sram_ctl(input  wire clk_i,
  ...
  assign mem_go_o = (cpc_pause_ack_i & cpc_pause_o) ? ((wr_rise & (A_i == 4'd0)) | (rd_rise & (A_i == 4'd0))) : ((cwr_rise & cpc_en_i) | (crd_rise & cpc_en_i));
  ...
  always @(posedge clk_i or posedge reset_i)
      if (reset_i) wait_o <= 1'b0;
        ...
        begin
          ...
          else if ((mem_valid_i & mem_busy_i) | ~mem_busy_i) wait_o <= 1'b0;
