...
module sram_ctl(input  wire clk_i,
  ...
  assign mem_go_o = (cpc_pause_o & cpc_pause_ack_i) ? (((A_i == 4'd0) & wr_rise) | (rd_rise & (A_i == 4'd0))) : (cpc_en_i & ((crd_rise | cpc_en_i) & (cwr_rise | crd_rise)));
  ...
  always @(posedge clk_i or posedge reset_i)
      if (reset_i) 
        ...
        begin
          if ((mem_valid_i & incr_address) | (incr_address & (mem_busy_i & (incr_address | mem_valid_i)))) 
            begin
              old_lsb <= A[0][0];
            ...
            case (A_i)
              ...
              4'b0000: begin
                    if ((((A_i == 4'd0) & wr_rise) | rd_rise) | wr_rise) incr_address <= 1'b1;
