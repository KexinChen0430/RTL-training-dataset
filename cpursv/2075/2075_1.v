...
module sram_ctl(input  wire clk_i,
  ...
  assign mem_go_o = (cpc_pause_ack_i & cpc_pause_o) ? (((A_i == 4'd0) & rd_rise) | ((A_i == 4'd0) & wr_rise)) : ((((crd_rise & cpc_en_i) | cwr_rise) | ((((crd_rise & cpc_en_i) | cwr_rise) & (((crd_rise | cpc_en_i) & cwr_rise) | cpc_en_i)) | crd_rise)) & cpc_en_i);
  ...
  always @(posedge clk_i or posedge reset_i)
      if (reset_i) 
        ...
        begin
          if (incr_address & (mem_valid_i | mem_busy_i)) 
            begin
              old_lsb <= A[0][0];
            ...
            case (A_i)
              ...
              4'b0000: begin
                    if ((rd_rise | ((A_i == 4'd0) & wr_rise)) | wr_rise) incr_address <= 1'b1;
  ...
  always @(posedge clk_i or posedge reset_i)
      if (reset_i) wait_o <= 1'b0;
        ...
        begin
          ...
          else if (~mem_busy_i | mem_valid_i) wait_o <= 1'b0;
