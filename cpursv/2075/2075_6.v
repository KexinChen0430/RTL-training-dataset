...
module sram_ctl(input  wire clk_i,
  ...
  assign mem_go_o = (cpc_pause_o & cpc_pause_ack_i) ? ((wr_rise | (rd_rise & (A_i == 4'd0))) & (A_i == 4'd0)) : (((cpc_en_i & crd_rise) | cwr_rise) & cpc_en_i);
        ...
        begin
          if (incr_address & (mem_valid_i | mem_busy_i)) 
            ...
            case (A_i)
              ...
              4'b0000: begin
                    if ((rd_rise | ((wr_rise | (rd_rise & (A_i == 4'd0))) & (A_i == 4'd0))) | wr_rise) incr_address <= 1'b1;
  ...
  always @(posedge clk_i or posedge reset_i)
      if (reset_i) wait_o <= 1'b0;
        ...
        begin
          ...
          else if (~mem_busy_i | (mem_valid_i & (((mem_busy_i & mem_valid_i) | incr_address) | mem_busy_i))) wait_o <= 1'b0;
