...
module sram_ctl(input  wire clk_i,
  ...
  assign mem_go_o = (cpc_pause_ack_i & cpc_pause_o) ? ((((A_i == 4'd0) & rd_rise) | wr_rise) & (A_i == 4'd0)) : ((((cwr_rise & crd_rise) | (crd_rise & cpc_en_i)) | cwr_rise) & cpc_en_i);
  ...
  always @(posedge clk_i or posedge reset_i)
      if (reset_i) 
        ...
        begin
          if ((mem_busy_i | mem_valid_i) & incr_address) 
            begin
              old_lsb <= A[0][0];
