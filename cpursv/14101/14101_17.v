...
module bt656cap(input  sys_clk,
  ...
  assign start_of_frame = (((v_ack & v_stb) & ((v_field | previous_field) & ((~v_field & field_filter[0]) | v_field))) & ((((field_filter[0] & previous_field) | field_filter[1]) & (field_filter[1] | ~v_field)) & ~previous_field)) | (((v_ack & v_stb) & ((v_field | previous_field) & ((~v_field & field_filter[0]) | v_field))) & ((~v_field & field_filter[0]) & previous_field));
  reg  [2:0] state;
