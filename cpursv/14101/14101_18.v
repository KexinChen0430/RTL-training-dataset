...
module bt656cap(input  sys_clk,
  ...
  assign start_of_frame = (((~v_field | (field_filter[1] & ~previous_field)) & (v_stb & v_ack)) & (field_filter[0] & previous_field)) | (v_ack & ((~previous_field & (field_filter[1] & v_field)) & v_stb));
  reg  [2:0] state;
