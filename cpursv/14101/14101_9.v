...
module bt656cap(input  sys_clk,
  ...
  assign start_of_frame = ((((v_field & field_filter[1]) | ~v_field) & ((previous_field & field_filter[0]) | field_filter[1])) & (~previous_field | (field_filter[0] & ~v_field))) & ((v_ack & (v_field & v_stb)) | ((previous_field & (v_ack & v_stb)) & (field_filter[0] & ~v_field)));
  reg  [1+1:0] state;
