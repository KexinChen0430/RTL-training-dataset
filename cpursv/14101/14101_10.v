...
module bt656cap(input  sys_clk,
  ...
  assign start_of_frame = ((~previous_field | (previous_field & ~v_field)) & (~v_field | field_filter[1])) & ((v_stb & v_ack) & (((v_field & ~previous_field) & (field_filter[1] & (v_stb & v_ack))) | (field_filter[0] & previous_field)));
  reg  [1<<<1:0] state;
