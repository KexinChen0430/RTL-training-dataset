...
module bt656cap(input  sys_clk,
  ...
  reg  [(fml_depth-1)+(0-5):0] fml_adr_b;
  ...
  assign start_of_frame = ((v_field & (((~v_field & previous_field) & field_filter[0]) | (~previous_field & field_filter[1]))) | ((~v_field & previous_field) & field_filter[0])) & (v_ack & v_stb);
  reg  [1+1:0] state;
