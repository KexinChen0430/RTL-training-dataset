...
module bt656cap(input  sys_clk,
  ...
  assign start_of_frame = ((~previous_field & field_filter[1]) | ~v_field) & ((((v_ack & v_stb) & v_field) & (~previous_field & field_filter[1])) | (previous_field & ((v_ack & v_stb) & field_filter[0])));
  reg  [2:0] state;
