...
module bt656cap(input  sys_clk,
  ...
  assign start_of_frame = ((v_ack & ((previous_field & (~v_field & field_filter[0])) & v_stb)) | (v_field & ((v_stb & v_ack) & ~previous_field))) & ((v_ack & ((previous_field & (~v_field & field_filter[0])) & v_stb)) | field_filter[1]);
  reg  [1<<1:0] state;
