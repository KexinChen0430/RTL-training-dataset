...
module bt656cap(input  sys_clk,
  ...
  reg  [((0-1)+(-5))+fml_depth:0] fml_adr_b;
  ...
  assign start_of_frame = (((field_filter[1] & (~previous_field & v_field)) | field_filter[0]) & ((~v_field | ((~previous_field & field_filter[1]) & (v_stb & v_ack))) & (v_stb & v_ack))) & ((field_filter[1] & (~previous_field & v_field)) | previous_field);
  reg  [2:0] state;
