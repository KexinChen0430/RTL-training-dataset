...
module bt656cap(input  sys_clk,
  ...
  assign start_of_frame = ((((~previous_field & v_field) & field_filter[1]) & (v_ack & v_stb)) | (field_filter[0] & previous_field)) & ((~v_field | ((((~previous_field | (field_filter[0] & ~v_field)) & field_filter[1]) & v_field) | (v_field & ((field_filter[0] & previous_field) & (~v_field & (((~v_field & previous_field) | v_field) & (field_filter[0] | v_field))))))) & (v_ack & v_stb));
  reg  [1<<1:0] state;
