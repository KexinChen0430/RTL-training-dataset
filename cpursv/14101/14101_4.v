...
module bt656cap(input  sys_clk,
  ...
  assign start_of_frame = ((v_stb & (((field_filter[0] & ~v_field) & previous_field) & v_ack)) | (v_field & (v_ack & v_stb))) & ((field_filter[1] & ~previous_field) | (((field_filter[1] & ~previous_field) | (previous_field & ~v_field)) & field_filter[0]));
  reg  [1<<1:0] state;
