...
module bt656cap(input  sys_clk,
  ...
  assign start_of_frame = (((field_filter[1] & ((field_filter[1] & ~previous_field) | ~v_field)) & (v_field & ~previous_field)) & (v_ack & v_stb)) | (((v_ack & v_stb) & ((field_filter[0] & previous_field) | (((field_filter[1] & ((field_filter[1] & ~previous_field) | ~v_field)) & (v_field & ~previous_field)) & (v_ack & v_stb)))) & ~v_field);
  reg  [1<<<1:0] state;
