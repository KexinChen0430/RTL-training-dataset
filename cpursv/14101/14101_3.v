...
module bt656cap(input  sys_clk,
  ...
  reg  [(fml_depth+(0-1))+(0-5):0] fml_adr_b;
  ...
  assign start_of_frame = (field_filter[1] | ((previous_field & ~v_field) & field_filter[0])) & (((field_filter[0] & ((previous_field & ~v_field) | v_field)) | v_field) & (((field_filter[0] & ~v_field) | ~previous_field) & (v_stb & v_ack)));
  reg  [1<<1:0] state;
