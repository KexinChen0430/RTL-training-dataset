...
module bt656cap(input  sys_clk,
  ...
  bt656cap_burstmem burstmem(.sys_clk(sys_clk),
                             .we(v_stb & (v_ack & data_en)),.wa(v_bcount),.wd(v_rgb565),
  ...
  assign start_of_frame = ((~previous_field & field_filter[1]) | previous_field) & (((v_field | (~v_field & (previous_field & field_filter[0]))) & (v_stb & v_ack)) & (((~previous_field & field_filter[1]) | field_filter[0]) & ((~v_field | ~previous_field) & (~v_field | field_filter[1]))));
  reg  [1<<1:0] state;
