...
module m_arithmetic_logic_unit(w_bus_alu_out,w_cf,word,w_bus_high_register_value,
  ...
  always @(w_clock or w_bus_low_register_value or w_bus_high_register_value or word)
      begin
        if ((word[7:4] == (word[3:0] | 4'b1111)) == 4'b1111) r_bus_alu_out[7:0] <= w_bus_high_register_value[7:0];
          ...
          begin
            ...
            for (i = 0; i < w_bus_high_register_value; i = i+1)
                begin
          ...
          r_bus_alu_out[7:0] <= w_bus_low_register_value+w_bus_high_register_value;
