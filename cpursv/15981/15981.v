...
module encode_8b10b(datain,dispin,dataout,dispout);
  ...
  wire 
       l22 = ((((ai & bi) & !ci) & !di) | (((ci & di) & !ai) & !bi)) | (!aeqb & !ceqd);
  wire  l40 = ((ai & bi) & ci) & di;
  wire  l04 = ((!ai & !bi) & !ci) & !di;
  wire 
       l13 = ((!aeqb & !ci) & !di) | ((!ceqd & !ai) & !bi);
  ...
  wire 
       io = ((((l22 & !ei) | (((ei & !di) & !ci) & !(ai & bi))) | (ei & l40)) | (((((ki & ei) & di) & ci) & !bi) & !ai)) | ((((ei & !di) & ci) & !bi) & !ai);
  wire 
  ...
  wire  pdos4 = (fi & gi) & hi;
  wire 
       illegalk = (ki & ((((ai | bi) | !ci) | !di) | !ei)) & ((((!fi | !gi) | !hi) | !ei) | !l31);
  wire  compls6 = (pd1s6 & !dispin) | (nd1s6 & dispin);
  wire  disp6 = dispin ^ (ndos6 | pdos6);
  wire  compls4 = (pd1s4 & !disp6) | (nd1s4 & disp6);

  assign dispout = disp6 ^ (ndos4 | pdos4);
  assign dataout = {jo ^ compls4,ho ^ compls4,go ^ compls4,fo ^ compls4,io ^ compls6,eo ^ compls6,do ^ compls6,co ^ compls6,bo ^ compls6,ao ^ compls6};
endmodule
