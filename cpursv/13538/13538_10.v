...
module stratixiii_mac_multiplier(dataa,datab,signa,signb,dataout);
  ...
  assign dataa_sign = dataa[dataa_width+(0-1)] && signa;
  assign datab_sign = signb && datab[datab_width+(0-1)];
  assign product_sign = ((datab_sign | dataa_sign) & ~datab_sign) | ((((~datab_sign | datab_sign) & (datab_sign & dataa_sign)) & ~((~datab_sign | datab_sign) & (datab_sign & (((datab_sign | dataa_sign) | ~dataa_sign) & datab_sign)))) | (~((~datab_sign | datab_sign) & (datab_sign & dataa_sign)) & ((~datab_sign | datab_sign) & (datab_sign & (((datab_sign | dataa_sign) | ~dataa_sign) & datab_sign)))));
