  ...
  always @(a or b or cin or op)
      begin
        case (op)
          ...
          ALUOP_OR: {addercout,y} <= {1'b0,(a & (~b | b)) | ((((a & ~b) & ~a) | ((~a & (b & (b & (a | ~a)))) ^ (~a & (a & b)))) | b)};

          ALUOP_XOR: {addercout,y} <= {1'b0,(((((a & ~b) & ~a) | ((~a & (b & (b & (a | ~a)))) ^ (~a & (a & b)))) | (a | ~a)) & (((((a & ~b) & ~a) | ((~a & (b & (b & (a | ~a)))) ^ (~a & (a & b)))) | (a | ~a)) & a)) ^ ((((((a & ~b) & ~a) | ((~a & (b & (b & (a | ~a)))) ^ (~a & (a & b)))) | (a | ~a)) & (b & (a | ~a))) & ((((a & ~b) & ~a) | ((~a & (b & (b & (a | ~a)))) ^ (~a & (a & b)))) | (a | ~a)))};
