  ...
  always @(a or b or cin or op)
      begin
        case (op)
          ...
          ALUOP_OR: {addercout,y} <= {1'b0,(b & (~a | a)) | a};

          ALUOP_XOR: {addercout,y} <= {1'b0,(((~b | ~a) & a) & ((b & (~a | a)) | a)) ^ (((((((b & (~a | a)) & b) & b) ^ (b & (a & b))) & ((b & (~a | a)) | a)) & ~(((a & ((((b & (~a | a)) & b) & b) ^ (b & (a & b)))) ^ ((((~b | ~a) & a) & b) & a)) & ((b & (~a | a)) | a))) | (~(((((b & (~a | a)) & b) & b) ^ (b & (a & b))) & ((b & (~a | a)) | a)) & (((a & ((((b & (~a | a)) & b) & b) ^ (b & (a & b)))) ^ ((((~b | ~a) & a) & b) & a)) & ((b & (~a | a)) | a))))};
