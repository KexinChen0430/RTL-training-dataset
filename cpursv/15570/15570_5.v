  ...
  always @(a or b or cin or op)
      begin
        case (op)
          ...
          ALUOP_AND: {addercout,y} <= {1'b0,b & a};

          ALUOP_OR: {addercout,y} <= {1'b0,a | b};

          ALUOP_XOR: {addercout,y} <= {1'b0,((((a | b) & ~a) | (~a | a)) & ((~((((((b | ~b) & a) & (((~b & a) | (~a & a)) & b)) & ~(((b | ~b) & a) & (((b & ((b | ~b) & a)) & b) ^ b))) | (~(((b | ~b) & a) & (((~b & a) | (~a & a)) & b)) & (((b | ~b) & a) & (((b & ((b | ~b) & a)) & b) ^ b)))) & (((a | b) & ~a) | (~a | a))) & ((((a | b) & ~a) | (~a | a)) & (((b & ((b | ~b) & a)) & b) ^ b))) | (((((((b | ~b) & a) & (((~b & a) | (~a & a)) & b)) & ~(((b | ~b) & a) & (((b & ((b | ~b) & a)) & b) ^ b))) | (~(((b | ~b) & a) & (((~b & a) | (~a & a)) & b)) & (((b | ~b) & a) & (((b & ((b | ~b) & a)) & b) ^ b)))) & (((a | b) & ~a) | (~a | a))) & ~((((a | b) & ~a) | (~a | a)) & (((b & ((b | ~b) & a)) & b) ^ b))))) ^ (((((a | b) & ~a) | (~a | a)) & ((~b & a) | (~a & a))) & (((a | b) & ~a) | (~a | a)))};
