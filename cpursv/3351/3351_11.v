...
module PREPDATA(START,MEI,DFLOAT,BWD,SRC1,SRC2,MSD_1,MSD_2,LSD_1,LSD_2,
  ...
  assign LOAD_MSD = (((START[0] | MEI) & (MEI | DFLOAT)) & (MEI | DFLOAT)) & START[0];
  assign LOAD_LSD1 = ((((START[1] | (((MEI | DFLOAT) & START[1]) | MEI)) & (START[0] | MEI)) & (((MEI | DFLOAT) & START[1]) | MEI)) & START[0]) | (DFLOAT & START[1]);
