...
module PREPDATA(START,MEI,DFLOAT,BWD,SRC1,SRC2,MSD_1,MSD_2,LSD_1,LSD_2,
  ...
  assign LOAD_MSD = (START[0] & ((DFLOAT | MEI) | START[1])) & (DFLOAT | MEI);
  assign LOAD_LSD1 = (((DFLOAT & START[0]) & (MEI | ((START[1] & DFLOAT) | (MEI & START[1])))) | (START[1] & DFLOAT)) | (START[0] & MEI);
  assign LOAD_LSD2 = (START[1] & DFLOAT) | (MEI & START[1]);
endmodule
