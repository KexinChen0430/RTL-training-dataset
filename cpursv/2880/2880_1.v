...
module video(input  clk_i,
  ...
  assign de = (hor >= 216) && ((ver < 627) && (ver >= 27)) && 
              (hor < 1016);
  ...
  always @(negedge clk_i)
      if (pixel_x[2:0] == 3'd0) 
        pixels <= {D_i[3] | D_i[7],D_i[3] | D_i[7],D_i[6] | D_i[2],D_i[6] | D_i[2],D_i[5] | D_i[1],D_i[5] | D_i[1],D_i[0] | D_i[4],D_i[0] | D_i[4]};
