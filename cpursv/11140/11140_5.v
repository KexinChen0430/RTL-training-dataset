...
module up_xfer_cntrl(up_rstn,up_clk,up_data_cntrl,up_xfer_done,d_rst,d_clk,
  ...
  assign up_xfer_enable_s = up_xfer_state ^ ((~up_xfer_state | (up_xfer_toggle | up_xfer_state)) & ((~up_xfer_state | (up_xfer_toggle | up_xfer_state)) & up_xfer_toggle));
  ...
  assign d_xfer_toggle_s = (d_xfer_toggle_m3 | d_xfer_toggle_m2) & (~d_xfer_toggle_m2 | ~d_xfer_toggle_m3);
