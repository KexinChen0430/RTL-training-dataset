...
module dut(ap_clk,ap_rst,in_fifo_V_dout,in_fifo_V_empty_n,
  ...
  always @(posedge ap_clk)
      begin : ap_ret_cnt
        if (ap_rst == 1'b1) 
          ...
          begin
            if ((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_24) 
              begin
                cnt <= tmp_fu_49_p2;
              end
  ...
  always @(in_fifo_V_empty_n or out_fifo_V_full_n)
      begin
        ap_sig_bdd_24 = (out_fifo_V_full_n == ap_const_logic_0) | (in_fifo_V_empty_n == ap_const_logic_0);
      end
  assign out_fifo_V_din = ap_const_lv32_FFFFFFFF+cnt;
  assign tmp_fu_49_p2 = ap_const_lv32_FFFFFFFF+cnt;
endmodule
