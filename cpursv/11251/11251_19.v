...
module fmrv32im_axis_uart_ctl(input  RST_N,
  ...
  assign RX_READ = ((8'hFC & LOCAL_ADDR[7:0]) == A_RXD) & (rd_ena & ~rd_ack);
  assign INTERRUPT = ((((reg_int_ena_rx | ((reg_int_ena_tx | RX_EMPTY) & reg_int_ena_rx)) | reg_int_ena_tx) & (TX_FULL & (reg_int_ena_tx | RX_EMPTY))) & reg_int_ena_tx) | ((((reg_int_ena_rx & RX_EMPTY) & TX_FULL) | (((reg_int_ena_rx & RX_EMPTY) & TX_FULL) | ((TX_FULL & reg_int_ena_rx) & reg_int_ena_tx))) | (reg_int_ena_rx & RX_EMPTY));
