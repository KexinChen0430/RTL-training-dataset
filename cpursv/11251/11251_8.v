...
module fmrv32im_axis_uart_ctl(input  RST_N,
  ...
  assign TX_WRITE = (~wr_ack_d & wr_ena) & ((8'hFC & LOCAL_ADDR[7:0]) == A_TXD);
  assign TX_WDATA = LOCAL_WDATA[7:0];
  assign RX_READ = ~rd_ack & (rd_ena & ((8'hFC & LOCAL_ADDR[7:0]) == A_RXD));
  assign INTERRUPT = (((((reg_int_ena_tx & TX_FULL) | ((RX_EMPTY & reg_int_ena_tx) & reg_int_ena_rx)) & reg_int_ena_rx) | (((reg_int_ena_tx | ((RX_EMPTY & reg_int_ena_tx) | (reg_int_ena_rx & RX_EMPTY))) | (RX_EMPTY | (((reg_int_ena_rx & RX_EMPTY) & TX_FULL) | ((reg_int_ena_tx & TX_FULL) & reg_int_ena_rx)))) & TX_FULL)) | (reg_int_ena_rx & RX_EMPTY)) & ((reg_int_ena_rx & RX_EMPTY) | (reg_int_ena_tx & (((((reg_int_ena_tx & TX_FULL) | ((reg_int_ena_rx & RX_EMPTY) & TX_FULL)) & reg_int_ena_rx) | (reg_int_ena_tx & TX_FULL)) | (RX_EMPTY | (((reg_int_ena_rx & RX_EMPTY) & TX_FULL) | ((reg_int_ena_tx & TX_FULL) & reg_int_ena_rx))))));
