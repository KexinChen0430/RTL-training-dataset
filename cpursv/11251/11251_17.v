...
module fmrv32im_axis_uart_ctl(input  RST_N,
  ...
  assign TX_WRITE = ((8'hFC & LOCAL_ADDR[7:0]) == A_TXD) & (~wr_ack_d & wr_ena);
  assign TX_WDATA = LOCAL_WDATA[7:0];
  assign RX_READ = ((8'hFC & LOCAL_ADDR[7:0]) == A_RXD) & (~rd_ack & rd_ena);
  assign INTERRUPT = ((reg_int_ena_tx & ((reg_int_ena_tx | RX_EMPTY) & TX_FULL)) | ((RX_EMPTY & reg_int_ena_tx) & ((reg_int_ena_rx | ((TX_FULL | (RX_EMPTY & reg_int_ena_rx)) & reg_int_ena_rx)) | (((RX_EMPTY & reg_int_ena_tx) & reg_int_ena_rx) | TX_FULL)))) | (((reg_int_ena_rx & TX_FULL) & reg_int_ena_tx) | (RX_EMPTY & reg_int_ena_rx));
