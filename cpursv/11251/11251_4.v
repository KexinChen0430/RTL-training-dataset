...
module fmrv32im_axis_uart_ctl(input  RST_N,
  ...
  assign wr_ena = (~LOCAL_RNW & LOCAL_CS) ? 1'b1 : 1'b0;
  ...
  assign TX_WRITE = (wr_ena & ((LOCAL_ADDR[7:0] & 8'hFC) == A_TXD)) & ~wr_ack_d;
  assign TX_WDATA = LOCAL_WDATA[7:0];
  assign RX_READ = (((LOCAL_ADDR[7:0] & 8'hFC) == A_RXD) & ~rd_ack) & rd_ena;
  assign INTERRUPT = ((TX_FULL & (((RX_EMPTY & reg_int_ena_tx) | (((RX_EMPTY | reg_int_ena_tx) & reg_int_ena_rx) & (TX_FULL & RX_EMPTY))) | (reg_int_ena_rx & RX_EMPTY))) | ((((reg_int_ena_tx & (reg_int_ena_rx & RX_EMPTY)) | TX_FULL) | ((reg_int_ena_rx & RX_EMPTY) | ((reg_int_ena_tx & (reg_int_ena_rx & RX_EMPTY)) | ((reg_int_ena_rx & reg_int_ena_tx) & TX_FULL)))) & ((reg_int_ena_tx & (((RX_EMPTY | reg_int_ena_tx) & TX_FULL) & TX_FULL)) | (reg_int_ena_rx & reg_int_ena_tx)))) | ((((RX_EMPTY & reg_int_ena_tx) | (((RX_EMPTY | reg_int_ena_tx) & reg_int_ena_rx) & (TX_FULL & RX_EMPTY))) | (reg_int_ena_rx & RX_EMPTY)) & (((reg_int_ena_tx & (reg_int_ena_rx & RX_EMPTY)) | TX_FULL) | ((reg_int_ena_rx & RX_EMPTY) | ((reg_int_ena_tx & (reg_int_ena_rx & RX_EMPTY)) | ((reg_int_ena_rx & reg_int_ena_tx) & TX_FULL)))));
