...
module fmrv32im_axis_uart_ctl(input  RST_N,
  ...
  assign RX_READ = ~rd_ack & (((LOCAL_ADDR[7:0] & 8'hFC) == A_RXD) & rd_ena);
  assign INTERRUPT = ((reg_int_ena_rx & RX_EMPTY) | (TX_FULL & (reg_int_ena_tx & RX_EMPTY))) | (TX_FULL & reg_int_ena_tx);
