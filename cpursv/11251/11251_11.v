...
module fmrv32im_axis_uart_ctl(input  RST_N,
  ...
  assign INTERRUPT = (reg_int_ena_rx & RX_EMPTY) | (((reg_int_ena_rx & (RX_EMPTY & reg_int_ena_tx)) | (reg_int_ena_tx & (reg_int_ena_rx & TX_FULL))) | (reg_int_ena_tx & (((RX_EMPTY | reg_int_ena_tx) & (TX_FULL | reg_int_ena_rx)) & TX_FULL)));
