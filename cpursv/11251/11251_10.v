...
module fmrv32im_axis_uart_ctl(input  RST_N,
                              input  CLK,
                              input  LOCAL_CS,
                              input  LOCAL_RNW,
                              output LOCAL_ACK,
  ...
  assign rd_ena = (LOCAL_RNW & LOCAL_CS) ? 1'b1 : 1'b0;
  ...
  assign TX_WRITE = ((8'hFC & LOCAL_ADDR[7:0]) == A_TXD) & (wr_ena & ~wr_ack_d);
  assign TX_WDATA = LOCAL_WDATA[7:0];
  assign RX_READ = rd_ena & (((8'hFC & LOCAL_ADDR[7:0]) == A_RXD) & ~rd_ack);
  assign INTERRUPT = (((reg_int_ena_tx & (TX_FULL | RX_EMPTY)) & (TX_FULL & ((RX_EMPTY | ((reg_int_ena_rx & RX_EMPTY) | (RX_EMPTY & reg_int_ena_tx))) | (((reg_int_ena_rx & RX_EMPTY) | (RX_EMPTY & reg_int_ena_tx)) | (((TX_FULL & RX_EMPTY) & reg_int_ena_rx) | reg_int_ena_tx))))) | (((reg_int_ena_rx & TX_FULL) | (reg_int_ena_rx & RX_EMPTY)) | (((reg_int_ena_rx & reg_int_ena_tx) & ((reg_int_ena_tx & (TX_FULL | RX_EMPTY)) & (TX_FULL & ((RX_EMPTY | ((reg_int_ena_rx & RX_EMPTY) | (RX_EMPTY & reg_int_ena_tx))) | (((reg_int_ena_rx & RX_EMPTY) | (RX_EMPTY & reg_int_ena_tx)) | (((TX_FULL & RX_EMPTY) & reg_int_ena_rx) | reg_int_ena_tx)))))) | (reg_int_ena_rx & (RX_EMPTY & reg_int_ena_tx))))) & (((((reg_int_ena_rx & RX_EMPTY) | (RX_EMPTY & reg_int_ena_tx)) | (((TX_FULL & RX_EMPTY) & reg_int_ena_rx) | reg_int_ena_tx)) & (TX_FULL & (reg_int_ena_tx | reg_int_ena_rx))) | RX_EMPTY);
