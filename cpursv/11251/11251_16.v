...
module fmrv32im_axis_uart_ctl(input  RST_N,
  ...
  assign TX_WRITE = (((LOCAL_ADDR[7:0] & 8'hFC) == A_TXD) & wr_ena) & ~wr_ack_d;
  assign TX_WDATA = LOCAL_WDATA[7:0];
  assign RX_READ = (((LOCAL_ADDR[7:0] & 8'hFC) == A_RXD) & rd_ena) & ~rd_ack;
  assign INTERRUPT = (((reg_int_ena_tx | (RX_EMPTY & reg_int_ena_rx)) & ((RX_EMPTY | ((TX_FULL & reg_int_ena_tx) | ((TX_FULL & RX_EMPTY) | (RX_EMPTY & reg_int_ena_rx)))) | TX_FULL)) & (reg_int_ena_tx | (RX_EMPTY & reg_int_ena_rx))) & (((TX_FULL & RX_EMPTY) | (RX_EMPTY & reg_int_ena_rx)) | ((((TX_FULL & reg_int_ena_tx) | (reg_int_ena_tx & reg_int_ena_rx)) & RX_EMPTY) | TX_FULL));
