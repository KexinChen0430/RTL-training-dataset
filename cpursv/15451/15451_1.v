...
module blockmem_rw32_r128(input  wire clk,
  ...
  assign internal_rd_data = {mem3_int_rd_data,mem2_int_rd_data,mem1_int_rd_data,mem0_int_rd_data};
  
  always @(posedge clk)
      begin : reg_update_mem0
        if (mem0_we) mem0[api_addr[7:2]] <= api_wr_data;
  ...
  always @(posedge clk)
      begin : reg_update_mem1
        if (mem1_we) mem1[api_addr[7:2]] <= api_wr_data;
  ...
  always @(posedge clk)
      begin : reg_update_mem2
        if (mem2_we) mem2[api_addr[7:2]] <= api_wr_data;
  ...
  always @(posedge clk)
      begin : reg_update_mem3
        if (mem3_we) mem3[api_addr[7:2]] <= api_wr_data;
