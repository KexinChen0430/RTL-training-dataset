...
module MMU_UP(BCLK,BRESET,NEW_PTB,PTB1,IVAR,WR_MRAM,VADR,VADR_R,MVALID,
  ...
  always @(posedge BCLK)
      run_over <= ((((NEW_PTB | ~old_rst) | (count != 4'hF)) & (BRESET & ~old_rst)) | (((NEW_PTB | ~old_rst) | (count != 4'hF)) & (BRESET & NEW_PTB))) | ((BRESET & ((count != 4'hF) & run_over)) | (((count != 4'hF) & (NEW_PTB | ~old_rst)) & BRESET));
