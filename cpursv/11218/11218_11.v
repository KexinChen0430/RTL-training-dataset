...
(force_reload || ~control_continuous || stop_strobe) && (counter_is_zero || (stop_strobe || force_reload));
  ...
  assign read_mux_out = (((snap_read_value[31:16] | ({16{address == 1}} & control_register)) | (((period_h_register & {16{address == 3}}) | ({16{address == 4}} & snap_read_value[15:0])) | (period_l_register & {16{address == 2}}))) | ({counter_is_running,timeout_occurred} & {16{address == 0}})) & ((({16{address == 5}} | ({16{address == 1}} & control_register)) | (((period_h_register & {16{address == 3}}) | ({16{address == 4}} & snap_read_value[15:0])) | (period_l_register & {16{address == 2}}))) | ({counter_is_running,timeout_occurred} & {16{address == 0}}));
  ...
  assign period_l_wr_strobe = (address == 2) && (~write_n && chipselect);
