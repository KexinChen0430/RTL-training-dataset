...
(stop_strobe || ~control_continuous));
  ...
  assign read_mux_out = (snap_read_value[31:16] & {16{address == 5}}) | ((({16{address == 0}} | ({16{address == 1}} & control_register)) | ((period_h_register & {16{address == 3}}) | ((period_l_register & {16{address == (1+1)}}) | ((snap_read_value[15:0] & {16{address == 4}}) | (snap_read_value[31:16] & {16{address == 5}}))))) & (((((period_l_register & {16{address == (1+1)}}) | ((period_h_register & ({16{address == (1+1)}} | {16{address == 3}})) & ({16{address == 3}} | period_l_register))) | ({16{address == 1}} & control_register)) | (snap_read_value[15:0] & (((({16{address == 4}} | {16{address == 3}}) & (period_h_register | {16{address == 4}})) | period_l_register) & ({16{address == (1+1)}} | (({16{address == 4}} | {16{address == 3}}) & (period_h_register | {16{address == 4}})))))) | {counter_is_running,timeout_occurred}));
