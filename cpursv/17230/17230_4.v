...
module link_rxi_router(fifo_read_cvre,read_out,write_out,dst_addr_out,src_addr_out,
  ...
  assign mesh_data_cvre[MDW+(0-1):0] = fifo_data_out_cvre[47:16];
  ...
  assign data_out[MDW+(0-1):0] = mesh_data_cvre[MDW+(0-1):0];
