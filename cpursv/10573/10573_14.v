...
(~((C0adr == Causeadr) && C0Write) && Interrupt)) || ~C0Wdata[1]) && (~State[1] || ~C0Wdata[1]) && 
...
(~C0Wdata[1] && C0Write && 
(Interrupt && (C0adr == Stateadr)) && ~State[1]) || 
(~(C0Write && (C0adr == Stateadr)) && 
(~State[1] && 
(~((C0adr == Causeadr) && C0Write) && Interrupt))) || 
(
(
(Interrupt && (~C0Wdata[1] && (C0adr == Stateadr))) || 
(~(C0Write && (C0adr == Stateadr)) && 
(~((C0adr == Causeadr) && C0Write) && Interrupt))) && C0Write)) && 
(
(~(C0Write && (C0adr == Stateadr)) && 
(~((C0adr == Causeadr) && C0Write) && Interrupt) && 
(C0Write && (C0adr == Stateadr) && Interrupt && 
