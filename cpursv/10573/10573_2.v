...
module Coprocessor0(input  clk,
  ...
  assign InteAccept = 
(
(C0Write && (Interrupt && (C0adr == Stateadr)) && 
(~(C0Write && (C0adr == Stateadr)) && 
~(C0Write && (C0adr == Causeadr)) && Interrupt)) || 
(~C0Wdata[1] && C0Write && 
(Interrupt && (C0adr == Stateadr))) || 
(
(Interrupt && ~(C0Write && (C0adr == Stateadr)) && 
(~(C0Write && (C0adr == Causeadr)) && ~State[1])) || 
(
(
(Interrupt && 
(~State[1] && ~(C0Write && (C0adr == Stateadr)))) || 
(~State[1] && 
(~C0Wdata[1] && C0Write && 
(Interrupt && (C0adr == Stateadr))))) && 
(~C0Wdata[1] && C0Write && 
...
(~State[1] && 
(~C0Wdata[1] && C0Write && 
(Interrupt && (C0adr == Stateadr))))) && ~(C0Write && (C0adr == Causeadr))))) && (~State[1] || ~C0Wdata[1]);
