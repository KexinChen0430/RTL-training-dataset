...
(~C0Wdata[1] && 
(~State[1] || 
(C0Write && Interrupt && (~State[1] || (C0adr == Stateadr))))))) && 
(
...
(Interrupt && 
(~C0Wdata[1] && (C0Write && (C0adr == Stateadr))) && ~State[1])) && ~(C0Write && (C0adr == Causeadr)))) || 
                      (Interrupt && 
(~C0Wdata[1] && (C0Write && (C0adr == Stateadr))) && ~State[1]) || 
                      (C0Write && (C0adr == Stateadr) && 
(~State[1] || (Interrupt && (~State[1] || ~C0Wdata[1]))) && 
(Interrupt && 
(~C0Wdata[1] && (C0Write && (C0adr == Stateadr)))));
