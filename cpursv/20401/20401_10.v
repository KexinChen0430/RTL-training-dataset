  ...
  generate
      for (b = 0; b < DATA_WIDTH; b = 1+b)
          begin : bit_loop
            if (AFI_RATIO == 2) 
              begin
                assign error_compute[b] = (((~read_data_r[DATA_WIDTH+b] & (~mask[1] & reference_data[DATA_WIDTH+b])) | ((((read_data_r[DATA_WIDTH+b] & ~reference_data[DATA_WIDTH+b]) | (~(reference_data[b] & ~mask[0]) & (~mask[0] & read_data_r[b]))) | (~(~mask[0] & read_data_r[b]) & (reference_data[b] & ~mask[0]))) & ((((~(reference_data[b] & ~mask[0]) & (~mask[0] & read_data_r[b])) | ~mask[1]) | (reference_data[b] & ~mask[0])) & (((~(reference_data[b] & ~mask[0]) & (~mask[0] & read_data_r[b])) | ~mask[1]) | ~(~mask[0] & read_data_r[b]))))) | (((((~read_data_r[(3*DATA_WIDTH)+b] & ~mask[3]) | (~mask[3] & (~reference_data[(3*DATA_WIDTH)+b] & read_data_r[(3*DATA_WIDTH)+b]))) & ((reference_data[(3*DATA_WIDTH)+b] | read_data_r[(3*DATA_WIDTH)+b]) & (reference_data[(3*DATA_WIDTH)+b] | ~reference_data[(3*DATA_WIDTH)+b]))) | (~mask[2] & ~reference_data[b+(DATA_WIDTH*2)])) & ((((~read_data_r[(3*DATA_WIDTH)+b] & ~mask[3]) | (~mask[3] & (~reference_data[(3*DATA_WIDTH)+b] & read_data_r[(3*DATA_WIDTH)+b]))) & ((reference_data[(3*DATA_WIDTH)+b] | read_data_r[(3*DATA_WIDTH)+b]) & (reference_data[(3*DATA_WIDTH)+b] | ~reference_data[(3*DATA_WIDTH)+b]))) | read_data_r[b+(DATA_WIDTH*2)]))) | (reference_data[b+(DATA_WIDTH*2)] & (~read_data_r[b+(DATA_WIDTH*2)] & ~mask[2]));
              end
            else 
              begin
                assign error_compute[b] = (~read_data_r[DATA_WIDTH+b] & (~mask[1] & reference_data[DATA_WIDTH+b])) | ((((read_data_r[DATA_WIDTH+b] & ~reference_data[DATA_WIDTH+b]) | (~(reference_data[b] & ~mask[0]) & (~mask[0] & read_data_r[b]))) | (~(~mask[0] & read_data_r[b]) & (reference_data[b] & ~mask[0]))) & ((((~(reference_data[b] & ~mask[0]) & (~mask[0] & read_data_r[b])) | ~mask[1]) | (reference_data[b] & ~mask[0])) & (((~(reference_data[b] & ~mask[0]) & (~mask[0] & read_data_r[b])) | ~mask[1]) | ~(~mask[0] & read_data_r[b]))));
