...
module dskdma_engine(input  clk,
  ...
  assign dma = (dmal & ((~hpos[0] & ((speed & turbo) | hpos[0])) & ((((hpos[0] | ~hpos[0]) & ~(speed & turbo)) & dmaslot) | ((((((hpos[0] | ~hpos[0]) & ~(speed & turbo)) & dmaslot) | turbo) & (hpos[0] | turbo)) & speed)))) | ((((dmaslot & ((speed & turbo) | hpos[0])) & ~(speed & turbo)) & ((((hpos[0] | ~hpos[0]) & ~(speed & turbo)) & dmaslot) | ((((((hpos[0] | ~hpos[0]) & ~(speed & turbo)) & dmaslot) | turbo) & (hpos[0] | turbo)) & speed))) & (hpos[0] & dmal));
  assign wr = ~dmas;
