...
module dskdma_engine(input  clk,
  ...
  assign dma = ((~hpos[0] | ((hpos[0] & ~(turbo & speed)) & ((dmaslot & ((~(turbo & speed) & dmaslot) | speed)) & (speed | hpos[0])))) & ((~(turbo & speed) | (hpos[0] & (((dmaslot & ((~(turbo & speed) & dmaslot) | speed)) & (speed | hpos[0])) & ((turbo | dmaslot) & (turbo | (hpos[0] & ~(turbo & speed))))))) | (turbo & speed))) & ((((turbo | dmaslot) & (turbo | (hpos[0] & ~(turbo & speed)))) & (((~(turbo & speed) & dmaslot) | speed) & (speed | hpos[0]))) & dmal);
  assign wr = ~dmas;
