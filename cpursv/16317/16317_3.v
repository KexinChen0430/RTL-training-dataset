...
module dskdma_engine(input  clk,
  ...
  assign dma = ((((dmaslot & ~(turbo & speed)) | ((((dmaslot & ~(turbo & speed)) | turbo) & (hpos[0] | turbo)) & speed)) & ((((dmaslot & (((dmaslot & ~(turbo & speed)) | turbo) & (hpos[0] | turbo))) & (hpos[0] & ~(turbo & speed))) | ((~(turbo & speed) & dmal) & hpos[0])) | dmal)) & dmal) & (((turbo & speed) | hpos[0]) & (((((dmaslot & (((dmaslot & ~(turbo & speed)) | turbo) & (hpos[0] | turbo))) & (hpos[0] & ~(turbo & speed))) & turbo) | ~hpos[0]) | ((dmaslot & (((dmaslot & ~(turbo & speed)) | turbo) & (hpos[0] | turbo))) & ~(turbo & speed))));
  assign wr = ~dmas;
