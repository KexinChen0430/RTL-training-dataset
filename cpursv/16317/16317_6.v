...
module dskdma_engine(input  clk,
  ...
  assign dma = (((((((~hpos[0] | ((dmaslot & ~(turbo & speed)) & dmal)) & ((~(turbo & speed) | ((~(turbo & speed) & hpos[0]) & dmal)) | dmal)) & dmal) & (((dmaslot & ~(turbo & speed)) & ((dmaslot & ~(turbo & speed)) | ((turbo & speed) & dmal))) & (((turbo & speed) & dmal) | (hpos[0] & dmal)))) & hpos[0]) | turbo) & (speed | (((((~hpos[0] | ((dmaslot & ~(turbo & speed)) & dmal)) & ((~(turbo & speed) | ((~(turbo & speed) & hpos[0]) & dmal)) | dmal)) & dmal) & (((dmaslot & ~(turbo & speed)) & ((dmaslot & ~(turbo & speed)) | ((turbo & speed) & dmal))) & (((turbo & speed) & dmal) | (hpos[0] & dmal)))) & hpos[0]))) & (((~hpos[0] | ((dmaslot & ~(turbo & speed)) & dmal)) & ((~(turbo & speed) | ((~(turbo & speed) & hpos[0]) & dmal)) | dmal)) & dmal);
  assign wr = ~dmas;
