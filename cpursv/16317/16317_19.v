...
module dskdma_engine(input  clk,
  ...
  assign dma = (((((turbo & speed) & ((hpos[0] & (turbo | (hpos[0] & dmaslot))) & (~(turbo & speed) | turbo))) & (dmaslot & ~(turbo & speed))) | ((((turbo & speed) & (((turbo & (~hpos[0] | (hpos[0] & dmaslot))) & ~hpos[0]) | (dmaslot & ~(turbo & speed)))) & ((dmaslot & ~(turbo & speed)) | speed)) | ~hpos[0])) | ((dmaslot & (hpos[0] | ~hpos[0])) & (~hpos[0] | ~(turbo & speed)))) & (((~(turbo & speed) & (hpos[0] & dmaslot)) | ((dmal & (turbo & speed)) | (((turbo & speed) & ((hpos[0] & (turbo | (hpos[0] & dmaslot))) & (~(turbo & speed) | turbo))) & (dmaslot & ~(turbo & speed))))) & dmal);
  assign wr = ~dmas;
