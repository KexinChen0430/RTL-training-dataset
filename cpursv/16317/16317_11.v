...
module dskdma_engine(input  clk,
  ...
  assign dma = ((dmal & ~(speed & turbo)) & (((hpos[0] & (speed | ~(speed & turbo))) & (speed | (dmaslot & hpos[0]))) & dmaslot)) | ((((hpos[0] & ((~(speed & turbo) & hpos[0]) | ~hpos[0])) & (~hpos[0] | (dmaslot & hpos[0]))) | ~hpos[0]) & ((speed & turbo) & dmal));
  assign wr = ~dmas;
