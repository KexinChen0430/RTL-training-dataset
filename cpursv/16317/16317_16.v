...
module dskdma_engine(input  clk,
  ...
  assign dma = (((turbo & speed) | hpos[0]) & (((~(turbo & speed) & dmaslot) | (hpos[0] & dmaslot)) | (turbo & speed))) & (((~hpos[0] | (((~(turbo & speed) & dmaslot) & ((hpos[0] & ~(turbo & speed)) | speed)) & (dmaslot | speed))) & ((~(turbo & speed) & dmaslot) | dmal)) & dmal);
  assign wr = ~dmas;
