...
module dskdma_engine(input  clk,
  ...
  assign dma = (((hpos[0] | ~hpos[0]) & (((speed & ~hpos[0]) | (((turbo & speed) & (dmaslot & ~(turbo & speed))) & hpos[0])) | ((dmaslot & ((turbo & speed) | hpos[0])) & (~(turbo & speed) & hpos[0])))) & ((turbo | (((dmaslot & ((turbo & speed) | hpos[0])) & (~(turbo & speed) & hpos[0])) & ((((hpos[0] & dmaslot) | speed) & (~(turbo & speed) | speed)) & turbo))) | ((dmaslot & ((turbo & speed) | hpos[0])) & (~(turbo & speed) & hpos[0])))) & ((hpos[0] | ~hpos[0]) & dmal);
  assign wr = ~dmas;
