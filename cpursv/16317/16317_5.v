...
module dskdma_engine(input  clk,
  ...
  assign dma = (turbo | ((((hpos[0] & ~(speed & turbo)) & (hpos[0] | (speed & turbo))) & ((speed & turbo) | dmaslot)) & ((dmaslot & (((((~(speed & turbo) & dmaslot) & ((hpos[0] & dmaslot) | speed)) & (speed | ~(speed & turbo))) & ((hpos[0] & (turbo | dmaslot)) & ((hpos[0] & ~(speed & turbo)) | turbo))) | dmal)) & dmal))) & (((((hpos[0] & ~(speed & turbo)) & (hpos[0] | (speed & turbo))) & ((speed & turbo) | dmaslot)) & ((dmaslot & (((((~(speed & turbo) & dmaslot) & ((hpos[0] & dmaslot) | speed)) & (speed | ~(speed & turbo))) & ((hpos[0] & (turbo | dmaslot)) & ((hpos[0] & ~(speed & turbo)) | turbo))) | dmal)) & dmal)) | (dmal & (~hpos[0] & speed)));
  assign wr = ~dmas;
