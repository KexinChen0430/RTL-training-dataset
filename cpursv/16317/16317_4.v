...
module dskdma_engine(input  clk,
  ...
  assign dma = dmal & (((dmaslot & (hpos[0] | (speed & turbo))) & ~(speed & turbo)) | ((((~(speed & turbo) | ~hpos[0]) & (hpos[0] | (speed & turbo))) & (~hpos[0] & turbo)) & ((speed & ((speed & ~hpos[0]) | (dmaslot & ~(speed & turbo)))) & (turbo | (dmaslot & ~(speed & turbo))))));
  assign wr = ~dmas;
