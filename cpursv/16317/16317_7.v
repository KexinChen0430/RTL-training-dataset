...
module dskdma_engine(input  clk,
  ...
  assign dma = ((hpos[0] | ~hpos[0]) & ((dmaslot & (((hpos[0] & ~(turbo & speed)) & (~hpos[0] | dmaslot)) & (~(turbo & speed) | ~hpos[0]))) | ((speed & (turbo | (hpos[0] & ~(turbo & speed)))) & (turbo | dmaslot)))) & (dmal & (~hpos[0] | (~(turbo & speed) & dmaslot)));
  assign wr = ~dmas;
