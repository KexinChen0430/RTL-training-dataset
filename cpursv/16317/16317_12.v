...
module dskdma_engine(input  clk,
  ...
  assign dma = (turbo | ((((((hpos[0] & ~(turbo & speed)) | turbo) & (dmaslot | turbo)) & dmal) & ~(turbo & speed)) & (((hpos[0] & (~hpos[0] | ~(turbo & speed))) & ((dmaslot & hpos[0]) | ~hpos[0])) & (dmaslot & ((turbo & speed) | (dmaslot & hpos[0])))))) & ((speed & (~hpos[0] & dmal)) | ((((((hpos[0] & ~(turbo & speed)) | turbo) & (dmaslot | turbo)) & dmal) & ~(turbo & speed)) & (((hpos[0] & (~hpos[0] | ~(turbo & speed))) & ((dmaslot & hpos[0]) | ~hpos[0])) & (dmaslot & ((turbo & speed) | (dmaslot & hpos[0]))))));
  assign wr = ~dmas;
