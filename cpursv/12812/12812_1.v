...
module des_sbox8(input  wire [0:5] right_xor_key_segment_din,
  ...
  always @(*)
      case ({right_xor_key_segment_din[0],right_xor_key_segment_din[5]})
        ...
        2'b00: case (right_xor_key_segment_din[1:4])
        ...
        2'b01: case (right_xor_key_segment_din[1:4])
        ...
        2'b10: case (right_xor_key_segment_din[1:4])
        ...
        2'b11: case (right_xor_key_segment_din[1:4])
