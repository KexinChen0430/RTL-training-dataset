...
module dummy_master(input  wire clock,
  ...
  always @(posedge clock)
      if (reset) 
        ...
        begin
          mem_id <= 1;
          lfsr <= {lfsr[31:0],(~lfsr[32] ^ (~lfsr[32] & lfsr[19])) ^ (((((~lfsr[32] & (~lfsr[19] | lfsr[19])) & (~lfsr[19] | lfsr[19])) & lfsr[19]) & ~lfsr[19]) | (~(((~lfsr[32] & (~lfsr[19] | lfsr[19])) & (~lfsr[19] | lfsr[19])) & lfsr[19]) & lfsr[19]))};
          if (mem_readdataid == 1) 
            begin
