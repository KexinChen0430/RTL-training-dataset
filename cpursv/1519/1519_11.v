  ...
  always @(posedge CLOCK_PIXEL or posedge RESET)
      begin
        if (RESET) 
          ...
          begin
            if (hor_reg == 840) hor_sync <= 1;
            else if (hor_reg == 928) hor_sync <= 0;
              
            if (ver_reg == 493) ver_sync <= 1;
            else if (ver_reg == 496) ver_sync <= 0;
              
            if ((hor_reg > 800) || (ver_reg > 480)) 
              begin
                red <= 0;
                green <= 0;
                blue <= 0;
              ...
              begin
                if ((hor_reg >= 100) && (ver_reg <= 200) && 
                    ((ver_reg >= 100) && (hor_reg <= 200))) 
                  begin
                    red <= 1;
                    green <= 1;
                    blue <= 1;
