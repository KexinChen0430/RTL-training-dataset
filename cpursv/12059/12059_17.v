...
module nukv_HT_Read_v2  #(parameter 
  ...
  assign hash_data = (selectInput == 1) ? input_data[(META_WIDTH+(HASHADDR_WIDTH+KEY_WIDTH))-1:KEY_WIDTH+META_WIDTH] : feedback_data[(META_WIDTH+(HASHADDR_WIDTH+KEY_WIDTH))-1:KEY_WIDTH+META_WIDTH];
                    ...
                    if ((output_ready == 1) && (rdcmd_ready == 1)) 
                      begin
                        ...
                        if ((selectInputNext == 0) && 
                            ((input_valid == 1) && (feedback_valid == 0))) 
                          begin
                            selectInput <= 1;
                            selectInputNext <= 0;
                          end
