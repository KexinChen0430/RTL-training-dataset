...
module nukv_HT_Read_v2  #(parameter 
  ...
  (input  wire clk,
   input  wire rst,
   input  wire [(HASHADDR_WIDTH+(KEY_WIDTH+META_WIDTH))-1:0] input_data,
   input  wire input_valid,
   output wire input_ready,
   input  wire [(HASHADDR_WIDTH+(KEY_WIDTH+META_WIDTH))-1:0] feedback_data,
   input  wire feedback_valid,
   output wire feedback_ready,
   output reg [(HASHADDR_WIDTH+(KEY_WIDTH+META_WIDTH))-1:0] output_data,
  ...
  assign hash_data = (selectInput == 1) ? input_data[(HASHADDR_WIDTH+(KEY_WIDTH+META_WIDTH))-1:KEY_WIDTH+META_WIDTH] : feedback_data[(HASHADDR_WIDTH+(KEY_WIDTH+META_WIDTH))-1:KEY_WIDTH+META_WIDTH];
