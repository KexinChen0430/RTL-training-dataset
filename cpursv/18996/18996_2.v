  ...
  always @(posedge core_sp_clk)
      begin
        if (reset) 
          ...
          begin
            if (((fifo_pr_bblock+1'b1) == previous_bblock) || 
                (((0-1'b1)+fifo_pr_bblock) == previous_bblock) || (fifo_pr_bblock == previous_bblock)) 
              begin
                jump_index_addr_reg <= 0;
              ...
              begin
                jump_index_addr_reg <= fifo_pr_nhop[12:1+1];
