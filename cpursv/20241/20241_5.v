...
module denise_bitplane_shifter(input  wire clk,
                               ...
                               input  wire [(0-1)+64:0] data_in,
                               input  wire [(0-1)+8:0] scroll,
                               output wire out);

  reg  [(0-1)+6:0] fmode_mask;
  reg  [(0-1)+64:0] shifter;
  reg  [(0-1)+64:0] scroller;
  reg  shift;
  reg  [(0-1)+6:0] select;
  wire scroller_out;
  reg  [(0-1)+8:0] sh_scroller;
  reg  [3+(0-1):0] sh_select;
  ...
  always @(*)
      begin
        if (shres) 
          ...
          begin
            shift = ((((((c3 | ~c3) & ~c1) & c1) | (c3 & c1)) | (c1 | ~c1)) & ~c1) ^ (c3 & (((((c3 | ~c3) & ~c1) & c1) | (c3 & c1)) | (c1 | ~c1)));
