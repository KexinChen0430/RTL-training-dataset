...
module MC6502InterruptLogic(clk,rst_x,i_irq_x,i_nmi_x,mc2il_data,mc2il_brk,il2mc_addr,
  ...
  assign il2mc_write = mc2il_brk | ((r_int_state == S_INT_PUSH_PCL) | (r_int_state == S_INT_PUSH_PSR));
  ...
  assign il2rf_set_i = !i_nmi_x | ((r_int_state == S_INT_PUSH_PSR) | !i_irq_x);
        ...
        if (!rst_x) 
          ...
          begin
            case (r_res_state)
              ...
              S_RES_IDLE: begin
                    if ((r_int_state == S_INT_PUSH_PSR) | !i_irq_x) 
                      begin
                        r_res_state <= S_RES_LOAD_PCL;
                        r_vector <= VECTOR_IRQ;
                      end
