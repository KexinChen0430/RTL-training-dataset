...
module MC6502InterruptLogic(clk,rst_x,i_irq_x,i_nmi_x,mc2il_data,mc2il_brk,il2mc_addr,
                            il2mc_read,il2mc_write,il2mc_data,rf2il_s,rf2il_psr,rf2il_pc,
                            il2rf_set_i,il2rf_set_b,il2rf_data,il2rf_set_pcl,
                            il2rf_set_pch,il2rf_pushed);
  ...
  assign il2mc_addr = il2mc_write ? {8'h01,rf2il_s} : {12'hfff,1'b1,r_vector,w_read_pch};
  assign il2mc_read = w_read_pch | w_read_pcl;
  assign il2mc_write = ((r_int_state == S_INT_PUSH_PSR) | (r_int_state == S_INT_PUSH_PCL)) | mc2il_brk;
  assign il2mc_data = mc2il_brk ? rf2il_pc[15:8] : 
                      (r_int_state == S_INT_PUSH_PCL) ? rf2il_pc[7:0] : 
                      (r_int_state == S_INT_PUSH_PSR) ? rf2il_psr : 8'hxx;
  assign il2rf_set_i = !i_nmi_x | (!i_irq_x | (r_int_state == S_INT_PUSH_PSR));
        ...
        if (!rst_x) 
          ...
          begin
            case (r_res_state)
              ...
              S_RES_IDLE: begin
                    if (!i_irq_x | (r_int_state == S_INT_PUSH_PSR)) 
                      begin
                        r_res_state <= S_RES_LOAD_PCL;
                        r_vector <= VECTOR_IRQ;
                      end
