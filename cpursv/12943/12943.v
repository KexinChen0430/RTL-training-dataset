...
module register_renaming_table  #(parameter  ENTRY_ID = 5'h0)
  (input  wire iCLOCK,
   input  wire inRESET,
          ...
          begin
            case (b_state)
              ...
              default: begin
                    ...
                    if (iROLLBACK_UPDATE_CANDIDATE3_VALID && 
                        (iROLLBACK_UPDATE_CANDIDATE3_LREGNAME == ENTRY_ID[4:0])) 
                      begin
                        b_rollback_point <= iROLLBACK_UPDATE_CANDIDATE3_PREGNAME;
                      end
                    else if (iROLLBACK_UPDATE_CANDIDATE2_VALID && 
                             (iROLLBACK_UPDATE_CANDIDATE2_LREGNAME == ENTRY_ID[4:0])) 
                      begin
                        b_rollback_point <= iROLLBACK_UPDATE_CANDIDATE2_PREGNAME;
                      end
                    else if (iROLLBACK_UPDATE_CANDIDATE1_VALID && 
                             (iROLLBACK_UPDATE_CANDIDATE1_LREGNAME == ENTRY_ID[4:0])) 
                      begin
                        b_rollback_point <= iROLLBACK_UPDATE_CANDIDATE1_PREGNAME;
                      end
                    else if (iROLLBACK_UPDATE_CANDIDATE0_VALID && 
                             (iROLLBACK_UPDATE_CANDIDATE0_LREGNAME == ENTRY_ID[4:0])) 
                      begin
                    ...
                    if (!iLOCK) 
                      begin
                        ...
                        if (iREGIST_1_VALID && 
                            (ENTRY_ID[4:0] == iREGIST_1_LOGIC_DESTINATION)) 
                          begin
                            b_valid <= 1'b1;
                            b_regname <= iREGIST_1_REGNAME;
                          end
                        else if (iREGIST_0_VALID && 
                                 (ENTRY_ID[4:0] == iREGIST_0_LOGIC_DESTINATION)) 
                          begin
                            b_valid <= 1'b1;
