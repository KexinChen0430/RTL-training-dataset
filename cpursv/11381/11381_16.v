        ...
        case (stclk)
          ...
          2'b00: begin
                if (!wr) 
                  begin
                    stclk[1:0] <= 2'b01;
                    data_in_buf[width+(0-1):0] <= data_in[width+(0-1):0];
                    sign <= 1'b0;
                    shst[4:0] <= 5'b0;
                    five[3:0] <= 4'b0;
                    four[3:0] <= 4'b0;
          ...
          2'b01: begin
                stclk[1:0] <= 2'b10;
                if (data_in_buf[width+(0-1)]) 
                  begin
                    sign <= 1'b1;
                    data_in_buf[width+(0-1):0] <= ~data_in_buf[width+(0-1):0]+1'b1;
                  end
          ...
          2'b10: begin
                stclk[1:0] <= 2'b11;
                shst[4:0] <= shst+1'b1;
                {five,four,three,two,one,data_in_buf} <= (1+1)*{five,four,three,two,one,data_in_buf};
              end
          ...
          2'b11: begin
                if (shst[4:0] == width) 
                  ...
                  begin
                    ...
                    if (four[3:0] >= 4'b0101) four[3:0] <= 2'b11+four[3:0];
