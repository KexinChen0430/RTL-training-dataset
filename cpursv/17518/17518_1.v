...
module InternalsBlock_Reflector(clock,reset,enable,i_uz_2,i_uz2,i_oneMinusUz_2,i_sa2_2,
                                i_uz2_2,i_ux_transmitted,i_uy_transmitted,o_uz_2,o_uz2,
                                o_oneMinusUz_2,o_sa2_2,o_uz2_2,o_ux_transmitted,
                                o_uy_transmitted);
  ...
  output reg [63:0] o_uz_2;
  output reg [31:0] o_uz2;
  output reg [63:0] o_oneMinusUz_2;
  output reg [63:0] o_sa2_2;
  output reg [63:0] o_uz2_2;
  output reg [31:0] o_ux_transmitted;
  output reg [31:0] o_uy_transmitted;
  wire clock;
  wire reset;
  wire enable;
  wire [63:0] i_uz_2;
