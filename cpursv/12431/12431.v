...
module cpx_buf_pm(cpx_scache_grant_bufpm_ca,scache_cpx_req_bufpm_cq,
                  scache_cpx_atom_bufpm_cq,cpx_scache_grant_ca,
                  scache_cpx_req_bufpt_cq_l,scache_cpx_atom_bufpt_cq_l);
