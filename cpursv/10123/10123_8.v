...
module Registrodesplazamiento  #(parameter  Width = 10)
  ...
  assign Y2 = Aux[(0-1)+(3*Width):Width<<1];
  assign Y3 = Aux[(4*Width)+(0-1):3*Width];
  assign Y4 = Aux[(0-1)+(5*Width):4*Width];
  assign Y5 = Aux[(Width*6)-1:5*Width];
  assign Y6 = Aux[(7*Width)+(0-1):Width*6];
  assign Y7 = Aux[(8*Width)-1:7*Width];
  assign Y8 = Aux[(9*Width)+(0-1):8*Width];
