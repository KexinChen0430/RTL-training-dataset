...
module memory(gm_or_lds,rd_en,wr_en,addresses,wr_data,input_tag,rd_data,
  ...
  assign rd_lds = {lds_memory[3+addresses],lds_memory[addresses+2],lds_memory[addresses+1],lds_memory[addresses]};
  assign rd_dm = {data_memory[3+addresses],data_memory[addresses+2],data_memory[addresses+1],data_memory[addresses]};
