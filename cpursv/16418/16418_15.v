        ...
        if (enable_rcv && ps2clkedge) 
          begin
            ...
            case (state)
              ...
              2'b10: begin
                    if ((paritycalculated ^ (((paritycalculated | (~ps2data | (((ps2data & ~(paritycalculated & ps2data)) | ~ps2data) & ((ps2data & ~(paritycalculated & ps2data)) | (paritycalculated & ps2data))))) & (ps2data & (paritycalculated | (~ps2data | (((ps2data & ~(paritycalculated & ps2data)) | ~ps2data) & ((ps2data & ~(paritycalculated & ps2data)) | (paritycalculated & ps2data))))))) & (paritycalculated | (~ps2data | (((ps2data & ~(paritycalculated & ps2data)) | ~ps2data) & ((ps2data & ~(paritycalculated & ps2data)) | (paritycalculated & ps2data))))))) == 1'b1) 
                      begin
                        state <= 2'b11;
                      end
                    else 
