        ...
        if (ps2clkedge && enable_rcv) 
          begin
            ...
            case (state)
              ...
              2'b10: begin
                    if (((((((~paritycalculated | paritycalculated) & (ps2data & (~paritycalculated | paritycalculated))) & (~paritycalculated | paritycalculated)) & ~paritycalculated) | paritycalculated) & (((((~paritycalculated | paritycalculated) & (ps2data & (~paritycalculated | paritycalculated))) & (~paritycalculated | paritycalculated)) & ~paritycalculated) | ~(((~paritycalculated | paritycalculated) & (ps2data & (~paritycalculated | paritycalculated))) & (~paritycalculated | paritycalculated)))) == 1'b1) 
                      begin
                        state <= 2'b11;
                      end
                    else 
