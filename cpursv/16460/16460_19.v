...
module rnd_vec_gen(clk,init,save,restore,next,out);
  ...
  reg  [(0-1)+OUT_SIZE:0] rndbase_main[0:LFSR_LENGTH-1];
  reg  [(0-1)+OUT_SIZE:0] rndbase_store[0:LFSR_LENGTH-1];
  ...
  task shift_lfsr;
    ...
    begin : blk3
      ...
      sum = rndbase_main[LFSR_LENGTH-1]+rndbase_main[(0-1)+LFSR_FEEDBACK];
