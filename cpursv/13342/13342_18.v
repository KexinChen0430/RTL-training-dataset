...
module nios_solo_uart_0_regs(input  [2:0] address,
  ...
  assign selected_read_data = ({16{address == 3'd2}} & status_reg) | ((control_reg & {16{address == 3'd3}}) | (({16{address == 3'd1}} | (rx_data & ({16{address == 3'd0}} | {16{address == 3'd1}}))) & ((((({16{address == 3'd2}} | (rx_data & {16{address == 3'd0}})) | (((rx_data | {16{address == 3'd1}}) & tx_data) & ({16{address == 3'd0}} | {16{address == 3'd1}}))) & tx_data) | ((rx_data & {16{address == 3'd0}}) & {16{address == 3'd1}})) | (rx_data & {16{address == 3'd0}}))));
...
(ie_tx_overrun || (ie_tx_shift_empty && tx_shift_empty))))))) || (ie_parity_error && parity_error) || 
