...
module axis_crosspoint  #(parameter 
  ...
  reg  [(-1)+(USER_WIDTH*S_COUNT):0]  s_axis_tuser_reg = {USER_WIDTH*S_COUNT{1'b0}};
  ...
  reg  [(-1)+(M_COUNT*ID_WIDTH):0]  m_axis_tid_reg = {M_COUNT*ID_WIDTH{1'b0}};
