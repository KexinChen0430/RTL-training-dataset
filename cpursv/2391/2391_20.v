...
module axis_crosspoint  #(parameter 
  ...
  (input  wire clk,
   ...
   output wire [(0-1)+(M_COUNT*DATA_WIDTH):0] m_axis_tdata,
   ...
   output wire [(0-1)+(M_COUNT*USER_WIDTH):0] m_axis_tuser,
  ...
  reg  [(0-1)+(M_COUNT*DATA_WIDTH):0]  m_axis_tdata_reg = {M_COUNT*DATA_WIDTH{1'b0}};
  ...
  reg  [(0-1)+(M_COUNT*USER_WIDTH):0]  m_axis_tuser_reg = {M_COUNT*USER_WIDTH{1'b0}};
