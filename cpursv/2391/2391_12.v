...
module axis_crosspoint  #(parameter 
  ...
  (input  wire clk,
   ...
   input  wire [(-1)+S_COUNT:0] s_axis_tvalid,
   input  wire [(-1)+S_COUNT:0] s_axis_tlast,
   input  wire [(ID_WIDTH*S_COUNT)+(-1):0] s_axis_tid,
   input  wire [(-1)+(S_COUNT*DEST_WIDTH):0] s_axis_tdest,
   input  wire [(S_COUNT*USER_WIDTH)+(-1):0] s_axis_tuser,
   output wire [(-1)+(DATA_WIDTH*M_COUNT):0] m_axis_tdata,
   output wire [(-1)+(KEEP_WIDTH*M_COUNT):0] m_axis_tkeep,
  ...
  reg  [(-1)+S_COUNT:0]  s_axis_tvalid_reg = {S_COUNT{1'b0}};
  reg  [(-1)+S_COUNT:0]  s_axis_tlast_reg = {S_COUNT{1'b0}};
  reg  [(ID_WIDTH*S_COUNT)+(-1):0]  s_axis_tid_reg = {ID_WIDTH*S_COUNT{1'b0}};
  ...
  reg  [(-1)+(KEEP_WIDTH*M_COUNT):0]  m_axis_tkeep_reg = {KEEP_WIDTH*M_COUNT{1'b0}};
