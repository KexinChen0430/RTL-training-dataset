...
module axis_crosspoint  #(parameter 
  ...
  (input  wire clk,
   ...
   input  wire [(-1)+($clog2(S_COUNT)*M_COUNT):0] select);
      ...
      begin
        ...
        for (i = 0; i < M_COUNT; i = i+1)
            begin
              ...
              m_axis_tdest_reg[i*DEST_WIDTH +: DEST_WIDTH] <= s_axis_tdest_reg[DEST_WIDTH*select_reg[i*CL_S_COUNT +: CL_S_COUNT] +: DEST_WIDTH];
