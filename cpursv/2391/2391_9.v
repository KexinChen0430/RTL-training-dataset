...
module axis_crosspoint  #(parameter 
  ...
  (input  wire clk,
   ...
   output wire [(-1)+(DEST_WIDTH*M_COUNT):0] m_axis_tdest,
   output wire [(-1)+(USER_WIDTH*M_COUNT):0] m_axis_tuser,
  ...
  reg  [(-1)+(DEST_WIDTH*M_COUNT):0]  m_axis_tdest_reg = {DEST_WIDTH*M_COUNT{1'b0}};
  reg  [(-1)+(USER_WIDTH*M_COUNT):0]  m_axis_tuser_reg = {USER_WIDTH*M_COUNT{1'b0}};
