...
(
((operation_iter == vectoring) && 
(y_iter[30:23] == 8'b0)) || (exponentbar >= 8'b00001111))) || 
(
((exponentbar >= 8'b00001110) && 
((operation_iter == vectoring) && 
((mode_iter == 2'b01) && (exponentbar[7] == 1'b0)))) || 
((operation_iter == vectoring) && 
((exponentbar >= 8'b00001110) && (mode_iter == 2'b11)) && (exponentbar[7] == 1'b0))) || 
...
((mode_iter == 2'b01) && (exponentbar[7] == 1'b0)))) || 
((operation_iter == vectoring) && 
((exponentbar >= 8'b00001110) && (mode_iter == 2'b11)) && (exponentbar[7] == 1'b0))) || (operation_iter == rotation)))) 
                  begin
                    x_out <= x_iter;
                    y_out <= y_iter;
                    z_out <= z_iter;
