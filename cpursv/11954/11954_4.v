...
(exponentbar[7] == 1'b0)) && 
(
((exponentbar >= 8'b00001110) && (mode_iter == 2'b01)) || (exponentbar >= 8'b00001111))) || 
...
(exponentbar[7] == 1'b0)) && 
(
((exponentbar >= 8'b00001110) && (mode_iter == 2'b01)) || (exponentbar >= 8'b00001111))) || (exponentbar[7] == 1'b0)))) || 
(
(
((z_iter[30:23] <= 8'b00000000) && 
(operation_iter == rotation)) || (y_iter[30:23] == 8'b0)) && 
