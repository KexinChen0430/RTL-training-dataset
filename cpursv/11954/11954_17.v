  ...
  always @(*)
      begin
        case (operation_iter)
          ...
          vectoring: exponent <= y_iter[30:23]+(0-x_iter[30:23]);

          default: exponent <= y_iter[30:23]+(0-x_iter[30:23]);
...
(mode_iter != mode_linear)))) && (exponentbar[7] == 1'b0)) || 
(
(
((operation_iter == vectoring) || 
(
...
((exponentbar[7] == 1'b0) && 
(exponentbar >= 8'b00001110)) && ((mode_iter == 2'b01) || (mode_iter == 2'b11))) || 
(
((operation_iter == vectoring) || 
(
((operation_iter == vectoring) || 
...
((mode_iter == 2'b11) || 
((y_iter[30:23] == 8'b0) || (mode_iter == 2'b01)))))) || 
((operation_iter == rotation) && 
(mode_iter != mode_linear) && (z_iter[30:23] <= 8'b00000000)))) 
                  begin
                    x_out <= x_iter;
                    y_out <= y_iter;
                    z_out <= z_iter;
