...
module StripCrc(input  clk,
  ...
  assign T40 = (io_in_vld & ((~io_in_vld | io_in_vld) | ((((1'h1 & io_in_vld) & ~io_in_vld) ^ (~io_in_vld & (1'h1 & ((~io_in_vld | io_in_vld) & 1'h1)))) | ((io_in_vld & (~1'h1 | 1'h1)) & ~io_in_vld)))) ^ (((~io_in_vld | io_in_vld) & 1'h1) & ((~io_in_vld | io_in_vld) | ((((1'h1 & io_in_vld) & ~io_in_vld) ^ (~io_in_vld & (1'h1 & ((~io_in_vld | io_in_vld) & 1'h1)))) | ((io_in_vld & (~1'h1 | 1'h1)) & ~io_in_vld))));
