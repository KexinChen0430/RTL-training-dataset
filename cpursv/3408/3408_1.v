...
module StripCrc(input  clk,
  ...
  assign T11 = T13 | T12;
  assign T12 = io_in_eof & frame_vld;
  ...
  assign T31 = io_in_vld & io_in_eof;
  assign T32 = T38 | T33;
  assign T33 = T37 & T34;
  assign T34 = T36 | T35;
  ...
  assign T40 = ((((io_in_vld & ~1'h1) | 1'h1) & (((io_in_vld | ~io_in_vld) | (~io_in_vld & ((io_in_vld & ~1'h1) | 1'h1))) & (io_in_vld & (~1'h1 | 1'h1)))) & ~((((io_in_vld | ~io_in_vld) | (~io_in_vld & ((io_in_vld & ~1'h1) | 1'h1))) & 1'h1) & ((io_in_vld & ~1'h1) | 1'h1))) | (~(((io_in_vld & ~1'h1) | 1'h1) & (((io_in_vld | ~io_in_vld) | (~io_in_vld & ((io_in_vld & ~1'h1) | 1'h1))) & (io_in_vld & (~1'h1 | 1'h1)))) & ((((io_in_vld | ~io_in_vld) | (~io_in_vld & ((io_in_vld & ~1'h1) | 1'h1))) & 1'h1) & ((io_in_vld & ~1'h1) | 1'h1)));
