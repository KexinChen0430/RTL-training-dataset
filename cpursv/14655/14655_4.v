...
module SPI_24_slave(input  clk,
  ...
  always @(posedge clk)
      begin
        kbd_received <= SCK_risingedge && ((bitcnt == 5'd4) && SPI_Active);
        pnl_received <= SCK_risingedge && ((bitcnt == 5'd15) && SPI_Active);
        data_received <= SCK_risingedge && (SPI_Active && (bitcnt == 5'd23));
      end
endmodule
