...
module SPI_24_slave(input  clk,
  ...
  always @(posedge clk)
      begin
        kbd_received <= (bitcnt == 5'd4) && (SCK_risingedge && SPI_Active);
        pnl_received <= (bitcnt == 5'd15) && SCK_risingedge && SPI_Active;
        data_received <= (bitcnt == 5'd23) && (SCK_risingedge && SPI_Active);
      end
endmodule
