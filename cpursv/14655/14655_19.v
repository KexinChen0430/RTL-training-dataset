...
module SPI_24_slave(input  clk,
  ...
  always @(posedge clk)
      begin
        kbd_received <= (bitcnt == 5'd4) && (SPI_Active && SCK_risingedge);
        pnl_received <= SPI_Active && (bitcnt == 5'd15) && SCK_risingedge;
        data_received <= (bitcnt == 5'd23) && (SPI_Active && SCK_risingedge);
      end
endmodule
