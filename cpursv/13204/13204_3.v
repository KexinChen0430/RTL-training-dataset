...
module vgascan(clk,hsync,vsync,realx,realy,videoActive,pre_xstart,pre_xend);
  ...
  reg  videoActiveX;
  reg  videoActiveY;
  wire  videoActive = videoActiveY & videoActiveX;
