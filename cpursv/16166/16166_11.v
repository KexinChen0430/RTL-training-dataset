...
module phsaligner  #(parameter 
  ...
  reg  [(0-1)+SRCHTIMERWD:0] ctkn_srh_timer;
  ...
  always @(posedge clk)
      begin
        ...
        else ctkn_counter <= #1 1'b1+ctkn_counter;
      end
  reg  ctkn_cnt_tout;
  ...
  reg  [BLNKPRD_CNT_WD+(0-1):0]  blnkprd_cnt = {BLNKPRD_CNT_WD{1'b0}};
