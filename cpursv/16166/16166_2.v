...
module phsaligner  #(parameter 
  ...
  reg  [CTKNCNTWD+(0-1):0] ctkn_counter;
  ...
  reg  [(0-1)+nSTATES:0]  cstate = {{(0-1)+nSTATES{1'b0}},1'b1};

  reg  [(0-1)+nSTATES:0] nstate;
  ...
  reg  [(0-1)+BLNKPRD_CNT_WD:0]  blnkprd_cnt = {BLNKPRD_CNT_WD{1'b0}};
