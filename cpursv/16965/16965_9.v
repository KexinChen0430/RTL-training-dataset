...
module sia_receiver(input  clk_i,
  ...
  reg  d0,d1,c0,c1;
  wire 
       edgeDetected = ((((eedd_i & ~d0) | ((eedc_i | eedd_i) & ((~d1 & d0) | eedc_i))) & (((d1 | d0) & (d1 | ~d1)) | eedc_i)) & ((d1 & ~d0) & (eedd_i | ((eedd_i | (eedc_i & c0)) & ~c1)))) | ((((eedd_i & ~d0) | ((eedc_i | eedd_i) & ((~d1 & d0) | eedc_i))) & (((d1 | d0) & (d1 | ~d1)) | eedc_i)) & (((~c1 & eedc_i) & c0) | ((eedd_i & ~d1) & d0)));
