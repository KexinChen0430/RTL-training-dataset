...
module sia_receiver(input  clk_i,
  ...
  parameter  SRW = SHIFT_REG_WIDTH+(0-1);
  ...
  reg  d0,d1,c0,c1;
  wire 
       edgeDetected = (((c0 & ~c1) | (eedd_i & (((~d1 & d0) & (((~d1 & (eedd_i & d0)) | c0) | (eedd_i & (~d0 & d1)))) | ((((~d1 & (eedd_i & d0)) | c0) | (eedd_i & (~d0 & d1))) & ((((d0 | d1) & ~d1) | d1) & ~d0))))) & (eedd_i & (((eedc_i | (~d0 & d1)) | d0) & (~d1 | (eedc_i | ~d0))))) | (eedc_i & ((c0 & ~c1) | (eedd_i & (((~d1 & d0) & (((~d1 & (eedd_i & d0)) | c0) | (eedd_i & (~d0 & d1)))) | ((((~d1 & (eedd_i & d0)) | c0) | (eedd_i & (~d0 & d1))) & ((((d0 | d1) & ~d1) | d1) & ~d0))))));
  ...
  generate
      for (i = 0; i <= SRW; i = i+1)
          begin
            assign shiftRegister_rev[i] = shiftRegister[(0-i)+SRW];
          end
  endgenerate
