...
module sia_receiver(input  clk_i,
  ...
  reg  d0,d1,c0,c1;
  wire 
       edgeDetected = ((((~d0 & d1) | (d1 & (d0 & ~d1))) & eedd_i) | (eedd_i & (d0 & ~d1))) | ((c0 & ((((~d0 & d1) | (d1 & (d0 & ~d1))) & eedd_i) | (eedd_i & (d0 & ~d1)))) | (~c1 & (((eedc_i | ((eedc_i | (eedd_i & ~d1)) & d0)) | (((eedd_i | eedc_i) & (d0 & ~d1)) | ((eedd_i | eedc_i) & ((~d0 & d1) | (d1 & (d0 & ~d1)))))) & c0)));
