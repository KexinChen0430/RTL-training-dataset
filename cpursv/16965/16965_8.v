...
module sia_receiver(input  clk_i,
  ...
  parameter  BW = (-1)+BITS_WIDTH;
  reg  [SRW:0] shiftRegister;
  reg  [BRW:0] sampleCtr;
  reg  [BW:0] bitsLeft;
  reg  d0,d1,c0,c1;
  wire 
       edgeDetected = ((eedd_i & ((d1 & (~(eedd_i & d0) & eedd_i)) | (((((eedd_i & (d0 & ~d1)) | (~c1 & c0)) & eedc_i) | ((eedd_i & (~d0 & d1)) & eedc_i)) | (((eedd_i & d0) & ~(eedd_i & d1)) | (~c1 & c0))))) | ((((eedd_i & (d0 & ~d1)) | (~c1 & c0)) & eedc_i) | ((eedd_i & (~d0 & d1)) & eedc_i))) & ((((d0 | (~d0 & d1)) & ~d1) | (~d0 & d1)) | eedc_i);
