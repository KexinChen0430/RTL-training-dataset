...
module axis_frame_fifo  #(parameter 
  ...
  reg   drop_frame = 1'b0;
  reg  [DATA_WIDTH+((0-1)+1):0]  data_out_reg = {1'b0,{DATA_WIDTH{1'b0}}};
  reg  [DATA_WIDTH+((0-1)+1):0] mem[(0-1)+(2**ADDR_WIDTH):0];
  reg   output_read = 1'b0;
  reg   output_axis_tvalid_reg = 1'b0;
  wire [DATA_WIDTH+((0-1)+1):0]  data_in = {input_axis_tlast,input_axis_tdata};
  wire 
