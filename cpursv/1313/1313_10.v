  ...
  always @* 
      begin : alu
        ...
        case (operation)
          ...
          OP_OR: begin
                tmp_result = (((~op_a & ((~op_b | op_b) & op_a)) | ((~op_a & (((op_b & op_a) & op_b) ^ (op_b & (((~op_a | op_a) & op_b) & op_b)))) ^ ((((op_a & (((op_b & op_a) & op_b) ^ (op_b & (((~op_a | op_a) & op_b) & op_b)))) & ~(op_a & ((~(((~op_b | op_b) & op_a) & op_b) & ((op_b & op_a) & ((~op_b | op_b) & op_a))) | ((((~op_b | op_b) & op_a) & op_b) & ~((op_b & op_a) & ((~op_b | op_b) & op_a)))))) | (~(op_a & (((op_b & op_a) & op_b) ^ (op_b & (((~op_a | op_a) & op_b) & op_b)))) & (op_a & ((~(((~op_b | op_b) & op_a) & op_b) & ((op_b & op_a) & ((~op_b | op_b) & op_a))) | ((((~op_b | op_b) & op_a) & op_b) & ~((op_b & op_a) & ((~op_b | op_b) & op_a))))))) & ~op_a))) | op_b) | ((~op_b | op_b) & op_a);
              end

          OP_XOR: begin
                tmp_result = ((op_b & op_a) ^ (((~op_a | op_a) & op_b) & op_b)) | ((op_a & (((~op_b | op_b) & ~op_a) | ~op_b)) & ~op_b);
              end
