...
module SensorFSM  #(parameter  DataWidth = 8)
  (input  Reset_n_i,
   ...
   output [(0-1)+(DataWidth*(1+1)):0] SensorValueL_o,
   output [(0-1)+(DataWidth*(1+1)):0] SensorValueR_o,
   ...
   input  [(0-1)+(DataWidth*(1+1)):0] ParamCounterPresetH_i,
   input  [(0-1)+(DataWidth*(1+1)):0] ParamCounterPresetL_i);
  ...
  wire [(0-1)+(DataWidth*(1+1)):0] SensorValue;
  reg  [(0-1)+(DataWidth*(1+1)):0] WordL;
  reg  [(0-1)+(DataWidth*(1+1)):0] WordR;
