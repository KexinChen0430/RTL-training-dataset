...
module SensorFSM  #(parameter  DataWidth = 8)
  (input  Reset_n_i,
   ...
   output [(1<<1*DataWidth)-1:0] SensorValueL_o,
   output [(1<<1*DataWidth)-1:0] SensorValueR_o,
   ...
   input  [(1<<1*DataWidth)-1:0] ParamCounterPresetH_i,
   input  [(1<<1*DataWidth)-1:0] ParamCounterPresetL_i);
  ...
  reg  [(1<<1*DataWidth)-1:0] WordL;
  reg  [(1<<1*DataWidth)-1:0] WordR;
