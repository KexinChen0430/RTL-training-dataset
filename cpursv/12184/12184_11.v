...
module SensorFSM  #(parameter  DataWidth = 8)
  (input  Reset_n_i,
   ...
   output [(0-1)+DataWidth<<1:0] SensorValueL_o,
   output [(0-1)+DataWidth<<1:0] SensorValueR_o,
   ...
   input  [(0-1)+DataWidth<<1:0] ParamCounterPresetH_i,
   input  [(0-1)+DataWidth<<1:0] ParamCounterPresetL_i);
  ...
  reg  [1<<1:0] SensorFSM_State;
  reg  [1<<1:0] SensorFSM_NextState;
  wire SensorFSM_TimerOvfl;
  reg  SensorFSM_TimerPreset;
  reg  SensorFSM_TimerEnable;
  reg  SensorFSM_StoreLocal;
  reg  SensorFSM_StoreRemote;
  wire [(0-1)+DataWidth<<1:0] SensorValue;
  reg  [(0-1)+DataWidth<<1:0] WordL;
  reg  [(0-1)+DataWidth<<1:0] WordR;
  ...
  always @(SensorFSM_State or Enable_i or SensorFSM_TimerOvfl or MeasureFSM_Done_i or MeasureFSM_Error_i)
      begin
