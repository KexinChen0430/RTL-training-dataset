...
module StreamFifo(input  io_push_valid,
  ...
  assign _zz_11 = (0-pushPtr_value)+popPtr_value;
  ...
  assign pushPtr_willOverflow = pushPtr_willIncrement && pushPtr_willOverflowIfInc;
  
  always @(*)
      begin
        pushPtr_valueNext = _zz_8+pushPtr_value;
        if (pushPtr_willClear) 
          begin
  ...
  always @(*)
      begin
        popPtr_valueNext = _zz_10+popPtr_value;
        if (popPtr_willClear) 
          begin
  ...
  assign pushing = _zz_5 && io_push_valid;
  assign popping = _zz_6 && io_pop_ready;
  assign empty = !risingOccupancy && ptrMatch;
  assign full = risingOccupancy && ptrMatch;
  assign _zz_5 = !full;
  assign _zz_6 = !(!full && _zz_2) && !empty;
  assign _zz_3 = 1'b1;
