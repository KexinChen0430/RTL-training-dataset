...
module StreamFifo(input  io_push_valid,
  ...
  assign _zz_11 = popPtr_value+(0-pushPtr_value);
  ...
  assign popping = io_pop_ready && _zz_6;
  assign empty = !risingOccupancy && ptrMatch;
  assign full = ptrMatch && risingOccupancy;
  assign _zz_5 = !full;
  assign _zz_6 = !(_zz_2 && !full) && !empty;
  assign _zz_3 = 1'b1;
  assign io_pop_payload = _zz_4;
  assign ptrDif = pushPtr_value+(0-popPtr_value);
  assign io_occupancy = {ptrMatch && risingOccupancy,ptrDif};
