...
module ws2812  #(parameter LED_COUNT,REVERSE)
  ...
  reg  [1:0] state;
  parameter  SYMBOL_0 = 0, SYMBOL_1 = 1, SYMBOL_RESET = 2;
  wire [1:0] symbol;
  ...
  wire 
       symbol_end = symbol_phase == ((0-1)+symbol_duration);
  ...
  wire 
       frame_end = (pixel_count == ((0-1)+LED_COUNT)) && pixel_end;
  ...
  assign address_o = REVERSE ? pixel_count : ((0-1)+((-pixel_count)+LED_COUNT));
endmodule
