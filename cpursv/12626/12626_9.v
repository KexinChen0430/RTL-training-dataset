...
module ws2812  #(parameter LED_COUNT,REVERSE)
  ...
  wire 
       symbol_end = symbol_phase == (symbol_duration+(0-1));
  ...
  wire 
       frame_end = pixel_end && (pixel_count == ((0-1)+LED_COUNT));
  ...
  assign address_o = REVERSE ? pixel_count : (LED_COUNT+((0-1)+(-pixel_count)));
endmodule
