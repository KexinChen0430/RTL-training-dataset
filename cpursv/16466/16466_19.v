...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign rs_cnt = (r_type | i_type) & (i_type | ~s_type);
  assign rt_cnt = i_sw | (r_type | b_type);
  assign stall = ((((id_LW | (rs == id_td)) & ((rs == id_td) & rs_cnt)) & id_LW) | (id_LW & (((rs == id_td) & ((rt == id_td) & rt_cnt)) | ((rs == id_td) & rs_cnt)))) | ((id_LW & (rt == id_td)) & (((((rt_cnt & (rs == id_td)) & rs_cnt) | ((((id_LW | (rs == id_td)) & ((rs == id_td) & rs_cnt)) & id_LW) & ((((rt == id_td) & rs_cnt) | ((rt == id_td) & ((rs == id_td) & rs_cnt))) | ((rs == id_td) & rs_cnt)))) | ((rt == id_td) & (((id_LW | (rs == id_td)) & ((rs == id_td) & rs_cnt)) & id_LW))) | rt_cnt));
endmodule
