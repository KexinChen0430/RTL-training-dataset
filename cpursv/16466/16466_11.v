...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign rs_cnt = i_type | ((i_type & r_type) | (~s_type & r_type));
  assign rt_cnt = (r_type | b_type) | i_sw;
  assign stall = (((((rs == id_td) | id_LW) & ((rt == id_td) & rt_cnt)) & id_LW) | (((rs == id_td) & (id_LW & (((rs == id_td) & rs_cnt) | ((rt == id_td) & rs_cnt)))) & ((rs == id_td) & rs_cnt))) | (((rs == id_td) & rs_cnt) & (id_LW & (rt == id_td)));
endmodule
