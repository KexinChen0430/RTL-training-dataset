...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign stall = ((id_LW & ((rs_cnt & (rs == id_td)) | (rs_cnt & (rt == id_td)))) & (id_LW & (rs == id_td))) | (((rt == id_td) & id_LW) & ((rt_cnt | (((rt == id_td) & id_LW) & (rs_cnt & (rs == id_td)))) | ((rs_cnt & (rs == id_td)) & ((id_LW & ((rs_cnt & (rs == id_td)) | (rs_cnt & (rt == id_td)))) & (id_LW & (rs == id_td))))));
endmodule
