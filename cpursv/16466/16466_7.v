...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign stall = id_LW & (((rs_cnt & rt_cnt) & (rs == id_td)) | ((((rt == id_td) & (((rs == id_td) | (rt_cnt & ((rt == id_td) | (rs == id_td)))) & rt_cnt)) | (id_LW & ((rt == id_td) & (((rs == id_td) | (rt_cnt & ((rt == id_td) | (rs == id_td)))) & rt_cnt)))) | (((id_LW & ((rt == id_td) & (((rs == id_td) | (rt_cnt & ((rt == id_td) | (rs == id_td)))) & rt_cnt))) | rs_cnt) & ((rs == id_td) & id_LW))));
endmodule
