...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign rs_cnt = (((r_type | (r_type & i_type)) | i_type) & ~s_type) | i_type;
  assign rt_cnt = (b_type | i_sw) | r_type;
  assign stall = ((rs_cnt & (id_LW & ((rs == id_td) | (((rt == id_td) & (((rt_cnt | rt_cnt) | rs_cnt) & (rs == id_td))) | ((rt == id_td) & rt_cnt))))) | (rs_cnt & (id_LW & ((rs == id_td) | (((rt == id_td) & (((rt_cnt | rt_cnt) | rs_cnt) & (rs == id_td))) | ((rt == id_td) & rt_cnt)))))) | ((rt == id_td) & (id_LW & (rt_cnt & ((rs == id_td) | (((rt == id_td) & (((rt_cnt | rt_cnt) | rs_cnt) & (rs == id_td))) | ((rt == id_td) & rt_cnt))))));
endmodule
