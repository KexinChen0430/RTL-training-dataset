...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign rs_cnt = i_type | ((r_type | i_type) & ~s_type);
  assign rt_cnt = i_sw | (r_type | b_type);
  assign stall = ((((rt == id_td) & (id_LW & (((((((rs == id_td) & (rt_cnt & (rt == id_td))) | (rt_cnt & (rs_cnt & (rs == id_td)))) | (((rs == id_td) & ((((rs_cnt & (rs == id_td)) & (rt == id_td)) | rt_cnt) | rs_cnt)) & (rs_cnt & (rs == id_td)))) | rs_cnt) | (((rs_cnt & rt_cnt) | ((rs == id_td) & (rt_cnt & (rt == id_td)))) | (rt_cnt & (rt == id_td)))) & rt_cnt))) | rs_cnt) & (id_LW & (rs == id_td))) | ((rt == id_td) & (id_LW & (((((((rs == id_td) & (rt_cnt & (rt == id_td))) | (rt_cnt & (rs_cnt & (rs == id_td)))) | (((rs == id_td) & ((((rs_cnt & (rs == id_td)) & (rt == id_td)) | rt_cnt) | rs_cnt)) & (rs_cnt & (rs == id_td)))) | rs_cnt) | (((rs_cnt & rt_cnt) | ((rs == id_td) & (rt_cnt & (rt == id_td)))) | (rt_cnt & (rt == id_td)))) & rt_cnt)));
endmodule
