...
module StallControlLogic(rs,rt,op,func,id_td,id_LW,stall);
  ...
  assign stall = (((((((rt == id_td) & ((rs == id_td) & rs_cnt)) | ((rt_cnt & ((rt == id_td) | (rs == id_td))) & rs_cnt)) | ((rt_cnt & ((rt == id_td) | (rs == id_td))) & (rt == id_td))) | (rt == id_td)) | rs_cnt) & ((rt_cnt & id_LW) | ((rs_cnt & ((rs == id_td) | rt_cnt)) & id_LW))) & ((rt == id_td) | (rs == id_td));
endmodule
