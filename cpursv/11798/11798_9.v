...
module velocityControlHdl_Complex_Multiply(In1_re,In1_im,In2_re,In2_im,Re,Im);
  ...
  assign Product1_out1 = In2_im*In1_im;
  assign Add1_out1 = (-Product1_out1)+Product_out1;
  assign Re = Add1_out1;
  assign Product2_out1 = In2_im*In1_re;
  assign Product3_out1 = In2_re*In1_im;
  assign Add2_out1 = Product3_out1+Product2_out1;
  assign Im = Add2_out1;
endmodule
