...
module nios_dut(audio_in_data,audio_in_valid,audio_in_ready,audio_out_data,
                ...
                io_u2p_address,io_u2p_irq,jtag_io_input_vector,
                jtag_io_output_vector,jtag_test_clocks_clock_1,
                jtag_test_clocks_clock_2,mem_mem_req_address,
                mem_mem_req_byte_en,mem_mem_req_read_writen,
                mem_mem_req_request,mem_mem_req_tag,mem_mem_req_wdata,
                mem_mem_resp_dack_tag,mem_mem_resp_data,mem_mem_resp_rack_tag,
                pio1_export,pio2_export,pio3_export,sys_clock_clk,
                sys_reset_reset_n,uart_rxd,uart_txd,uart_cts_n,uart_rts_n);
