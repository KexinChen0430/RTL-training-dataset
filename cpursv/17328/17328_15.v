...
module sound_mulacc(clock,vol_in,dat_in,mode_inv7b,load,clr_sum,ready,sum_out);
  ...
  always @(posedge clock)
      begin
        ...
        else counter <= 4'd1+counter;
      end
  assign add_data = shifter[0] ? adder : 6'd0;
  assign sum_unreg[6:0] = add_data[5:0]+sum_reg[6:1];
  ...
  always @(posedge clock)
      begin
        if (!load) 
          ...
          begin
            sum_reg[6:0] <= 7'd0;
            shifter[7] <= ~(((~mode_inv7b & (dat_in[7] | ~dat_in[7])) | ~dat_in[7]) & ((((~mode_inv7b | (dat_in[7] & (((~(mode_inv7b & dat_in[7]) & (((mode_inv7b & (dat_in[7] | ~dat_in[7])) & (dat_in[7] | ~dat_in[7])) & mode_inv7b)) | (mode_inv7b & dat_in[7])) & ((~(mode_inv7b & dat_in[7]) & (((mode_inv7b & (dat_in[7] | ~dat_in[7])) & (dat_in[7] | ~dat_in[7])) & mode_inv7b)) | ~(((mode_inv7b & (dat_in[7] | ~dat_in[7])) & (dat_in[7] | ~dat_in[7])) & mode_inv7b))))) & ((~mode_inv7b & (dat_in[7] | ~dat_in[7])) | ~dat_in[7])) & dat_in[7]) | ((((~(mode_inv7b & dat_in[7]) & (((mode_inv7b & (dat_in[7] | ~dat_in[7])) & (dat_in[7] | ~dat_in[7])) & mode_inv7b)) | (mode_inv7b & dat_in[7])) & ((~(mode_inv7b & dat_in[7]) & (((mode_inv7b & (dat_in[7] | ~dat_in[7])) & (dat_in[7] | ~dat_in[7])) & mode_inv7b)) | ~(((mode_inv7b & (dat_in[7] | ~dat_in[7])) & (dat_in[7] | ~dat_in[7])) & mode_inv7b))) & (dat_in[7] | mode_inv7b))));
  ...
  assign temp_sum[1:0] = (old_data_in+mul_out)+carry_in;
