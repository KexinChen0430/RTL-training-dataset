  ...
  always @(posedge clock)
      begin
        if (!load) 
          ...
          begin
            sum_reg[6:0] <= 7'd0;
            shifter[7] <= ~((((dat_in[7] & ~((dat_in[7] | ~dat_in[7]) & (dat_in[7] & mode_inv7b))) | ((dat_in[7] | ~dat_in[7]) & (dat_in[7] & mode_inv7b))) & ((dat_in[7] & ~((dat_in[7] | ~dat_in[7]) & (dat_in[7] & mode_inv7b))) | ~dat_in[7])) | ((dat_in[7] & mode_inv7b) ^ mode_inv7b));
