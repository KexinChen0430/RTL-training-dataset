...
module parameterized_RAM_last  #(parameter  SIZE = 10, LOOP = 2)
  ...
  reg  [7:0] RAM[((SIZE*2)*LOOP)-1'b1:0];
  reg  [$clog2((SIZE*2)*LOOP):0]  rd_addr = 0;
  reg  [$clog2(((SIZE*2)*LOOP)-1'b1):0]  wr_addr = 0;
