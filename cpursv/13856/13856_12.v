...
module parameterized_RAM_last  #(parameter  SIZE = 10, LOOP = 1<<<1)
  ...
  reg  [7:0] RAM[(LOOP<<<1*SIZE)+(0-1'b1):0];
  reg  [$clog2(LOOP<<<1*SIZE):0]  rd_addr = 0;
  reg  [$clog2((LOOP<<<1*SIZE)+(0-1'b1)):0]  wr_addr = 0;
