...
module jt12_amp(input  clk,
  ...
  wire signed  [15:0]  x3 = pre+x2;
  wire signed  [15:0]  x4 = (2**2)*pre;
  wire signed  [16:0]  x6 = x4+x2;
  wire signed  [16:0]  x8 = pre*(2**3);
  wire signed  [17:0]  x12 = x4+x8;
  wire signed  [17:0]  x16 = pre*(2**4);
