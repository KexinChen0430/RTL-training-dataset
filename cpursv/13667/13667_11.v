          ...
          begin
            ...
            if (datain_width > round_width) 
              begin
                ...
                for (i = 0; i < (datain_width+((0-round_width)+(0-1))); i = i+1)
                    begin
                      sign = sign | datain[i];
                      dataout_value[i] = 1'bX;
                    end
                dataout_value[datain_width+((0-round_width)+(0-1))] = 1'bX;
                if (datain[datain_width+((0-round_width)+(0-1))] == 1'b0) 
                  begin
                    dataout_tmp = result_tmp;
                  end
                else if ((sign == 1'b1) && 
                         (datain[datain_width+((0-round_width)+(0-1))] == 1'b1)) 
                  begin
                  ...
                  begin
                    if (round_mode == nearest_even) 
                      begin
                        if (result_tmp%1<<<1) dataout_tmp = 1'b1+result_tmp;
