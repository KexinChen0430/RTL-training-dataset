          ...
          begin
            ...
            if (datain_width > round_width) 
              begin
                ...
                for (i = 0; i < ((0-1)+((0-round_width)+datain_width)); i = i+1)
                    begin
                      sign = sign | datain[i];
                      dataout_value[i] = 1'bX;
                    end
                dataout_value[(0-1)+((0-round_width)+datain_width)] = 1'bX;
                if (datain[(0-1)+((0-round_width)+datain_width)] == 1'b0) 
                  begin
                    dataout_tmp = result_tmp;
                  end
                else if (
(datain[(0-1)+((0-round_width)+datain_width)] == 1'b1) && (sign == 1'b1)) 
                  begin
