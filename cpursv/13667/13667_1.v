          ...
          begin
            ...
            if (datain_width > round_width) 
              begin
                ...
                for (i = 0; i < ((-1)+(datain_width-round_width)); i = 1+i)
                    begin
                      sign = datain[i] | sign;
                      dataout_value[i] = 1'bX;
                    end
                dataout_value[(-1)+(datain_width-round_width)] = 1'bX;
                if (datain[(-1)+(datain_width-round_width)] == 1'b0) 
                  begin
                    dataout_tmp = result_tmp;
                  end
                else if ((datain[(-1)+(datain_width-round_width)] == 1'b1) && 
                         (sign == 1'b1)) 
                  begin
