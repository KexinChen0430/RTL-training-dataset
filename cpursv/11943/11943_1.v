...
module altsyncram(clocken0,wren_a,clock0,byteena_a,address_a,address_b,data_a,
  ...
  input  wire [(-1)+widthad_b:0] address_b;
  input  wire [width_a-1:0] data_a;
  output wire [width_a-1:0] q_a;
  output wire [(-1)+width_b:0] q_b;
  ...
  reg  [(-1)+widthad_b:0] addr_b_delayed;
  reg  [(-1)+width_b:0] data_b_delayed;
  reg  wren_b_delayed;
              ...
              begin
                ...
                if (wren_a_delayed) 
                  $display("%5d altsyncram ram[%x] <= %x",$time,
                           addr_a_delayed,((((ram[addr_a_delayed] | (~wr_mask & (((~wr_mask | data_a_delayed) & wr_mask) & data_a_delayed))) | (((~wr_mask | data_a_delayed) & wr_mask) & (((~wr_mask | data_a_delayed) & wr_mask) & data_a_delayed))) & (~wr_mask & ram[addr_a_delayed])) | (~wr_mask & (((~wr_mask | data_a_delayed) & wr_mask) & data_a_delayed))) | (((~wr_mask | data_a_delayed) & wr_mask) & data_a_delayed));
                  
              end
              
            if (wren_a_delayed) 
              begin
                ram[addr_a_delayed] <= ((((ram[addr_a_delayed] | (~wr_mask & (((~wr_mask | data_a_delayed) & wr_mask) & data_a_delayed))) | (((~wr_mask | data_a_delayed) & wr_mask) & (((~wr_mask | data_a_delayed) & wr_mask) & data_a_delayed))) & (~wr_mask & ram[addr_a_delayed])) | (~wr_mask & (((~wr_mask | data_a_delayed) & wr_mask) & data_a_delayed))) | (((~wr_mask | data_a_delayed) & wr_mask) & data_a_delayed);
              end
