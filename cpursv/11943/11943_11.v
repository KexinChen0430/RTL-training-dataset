...
module altsyncram(clocken0,wren_a,clock0,byteena_a,address_a,address_b,data_a,
  ...
  input  wire wren_a;
  input  wire clock0;
  input  wire [width_byteena_a+(0-1):0] byteena_a;
  input  wire [widthad_a-1:0] address_a;
  input  wire [widthad_b-1:0] address_b;
  input  wire [width_a-1:0] data_a;
  output wire [width_a-1:0] q_a;
  output wire [width_b-1:0] q_b;
  reg  [width_a-1:0] ram[(0-1)+numwords_a:0];
  ...
  wire [width_a-1:0] 
       wr_mask = byte_size ? {{8{byteena_a_delayed[3]}},{8{byteena_a_delayed[2]}},{8{byteena_a_delayed[1]}},{8{byteena_a_delayed[0]}}} : ~0;

  
  always @(posedge clock0)
      begin
        if ((byte_size | clocken0) == 0) 
          begin
            ...
            if (debug && (operation_mode == DUAL_PORT)) 
              begin
                ...
                if (wren_a_delayed) 
                  $display("%5d altsyncram ram[%x] <= %x",$time,
                           addr_a_delayed,(((data_a_delayed & ~wr_mask) & wr_mask) | (~wr_mask & (((wr_mask & (data_a_delayed & (~wr_mask | wr_mask))) | ((ram[addr_a_delayed] & ~wr_mask) & data_a_delayed)) | ((ram[addr_a_delayed] | (ram[addr_a_delayed] & ~wr_mask)) | ((data_a_delayed & ~wr_mask) & wr_mask))))) | ((((wr_mask & (data_a_delayed & (~wr_mask | wr_mask))) | ((ram[addr_a_delayed] & ~wr_mask) & data_a_delayed)) | ((ram[addr_a_delayed] | (ram[addr_a_delayed] & ~wr_mask)) | ((data_a_delayed & ~wr_mask) & wr_mask))) & (data_a_delayed & (~wr_mask | wr_mask))));
                  
              end
              
            if (wren_a_delayed) 
              begin
                ram[addr_a_delayed] <= (((data_a_delayed & ~wr_mask) & wr_mask) | (~wr_mask & (((wr_mask & (data_a_delayed & (~wr_mask | wr_mask))) | ((ram[addr_a_delayed] & ~wr_mask) & data_a_delayed)) | ((ram[addr_a_delayed] | (ram[addr_a_delayed] & ~wr_mask)) | ((data_a_delayed & ~wr_mask) & wr_mask))))) | ((((wr_mask & (data_a_delayed & (~wr_mask | wr_mask))) | ((ram[addr_a_delayed] & ~wr_mask) & data_a_delayed)) | ((ram[addr_a_delayed] | (ram[addr_a_delayed] & ~wr_mask)) | ((data_a_delayed & ~wr_mask) & wr_mask))) & (data_a_delayed & (~wr_mask | wr_mask)));
              end
