...
(
((i_in === 1'bz) || (ib_in == 1'b1) || (i_in == 1'b0)) && (ib_in === 1'bz) && (i_in === 1'bz))) || (ib_in == 1'b1))) || 
(
((i_in == 1'b0) && 
(
((i_in === 1'bz) || (ib_in == 1'b1) || (i_in == 1'b0)) && (ib_in === 1'bz))) || 
(
((i_in === 1'bz) || (ib_in == 1'b1) || (i_in == 1'b0)) && (ib_in === 1'bz) && (i_in === 1'bz)))) && 
                 ((i_in === 1'bz) || ((i_in == 1'b0) && (ib_in == 1'b1)) || 
((i_in == 1'b0) && 
(
((i_in === 1'bz) || (ib_in == 1'b1) || (i_in == 1'b0)) && (ib_in === 1'bz))))) 
