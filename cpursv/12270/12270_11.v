...
module maple_in(input  rst,
  ...
  always @(*)
      begin
        ...
        p1_edge = !in_p1_q && in_p1_old_q;
        p5_edge = !in_p5_q && in_p5_old_q;
        mode_d = MODE_IDLE;
        cnt_d = 3'b0;
          ...
          begin
            ...
            case (mode_q)
              ...
              MODE_PHASE1,MODE_PHASE1_PRE: begin
                    if (p1_value && p5_edge && (cnt_q == 0)) 
                      begin
                        if (mode_q == MODE_PHASE1_PRE) 
                          begin
                            mode_d = MODE_PHASE1;
                          end
                        else 
