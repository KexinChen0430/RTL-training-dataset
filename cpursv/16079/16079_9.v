...
module HazardsUnit(input  branchID,
  ...
  assign lwstall = ((rsID == rtEX) && memToRegEX) || 
  ...
  assign branchstall = (branchID && regWriteEX && (writeRegEX == rtID)) || 
                       (
((writeRegMEM == rtID) && 
((writeRegEX == rsID) || branchID) && branchID && memToRegMEM) || 
((memToRegMEM && branchID && (writeRegMEM == rsID)) || 
(regWriteEX && (branchID && (writeRegEX == rsID)))));
