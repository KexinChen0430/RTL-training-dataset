...
module vga(hsync,vsync,x,y,ve,newline,newfield,clk_p,rst);
  ...
  parameter 
       line = (h_front_porch+h_pixel)+(h_sync_pulse+h_back_porch);

  parameter 
       field = (v_pixel+(v_sync_pulse+v_front_porch))+v_back_porch;
