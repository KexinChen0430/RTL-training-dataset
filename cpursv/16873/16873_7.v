            ...
            if (prescale_reg > 0) 
                  ...
                  begin
                    ...
                    if (uart_parity == 2'b00) 
                      case (uart_bits)
                        ...
                        2'b11: data_reg <= {6'b111111,input_axis_tdata[(0-4)+DATA_WIDTH:0]};
                      ...
                      case (uart_bits)
                        ...
                        2'b11: data_reg <= {5'b11111,parity,input_axis_tdata[(0-4)+DATA_WIDTH:0]};
              ...
              begin
                if (bit_cnt > 1) 
                  begin
                    bit_cnt <= (-1)+bit_cnt;
                    if ((bit_cnt == 2) && (uart_stopbit[1] == 1'b1)) prescale_reg <= (-1)+(2*prescale<<<1);
