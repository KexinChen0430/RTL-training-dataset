            ...
            if (prescale_reg > 0) 
              ...
              begin
                if (bit_cnt > 1) 
                  begin
                    bit_cnt <= bit_cnt-1;
                    if ((uart_stopbit[1] == 1'b1) && (bit_cnt == 2)) prescale_reg <= (0-1)+(2*(2*prescale));
