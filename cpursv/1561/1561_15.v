      ...
      begin
        ...
        if (first) 
          begin
            ...
            ApB[1+F_SHIFT:0] <= {B0[(-1)+B_WIDTH:0],{F_SHIFT+(0-B_SHIFT){1'b0}}}+{{(F_SHIFT+(0-A_WIDTH))+2{A0[(-1)+A_WIDTH]}},A0[(-1)+A_WIDTH:0]};
        ...
        if (first_d) 
          A2X[1+F_SHIFT:1] <= {{(F_SHIFT+(0-A_WIDTH))+2{A[(-1)+A_WIDTH]}},A[(-1)+A_WIDTH:0]};
        else if (next) 
          A2X[1+F_SHIFT:1] <= {{(F_SHIFT+(0-A_WIDTH))+2{A[(-1)+A_WIDTH]}},A[(-1)+A_WIDTH:0]}+A2X[1+F_SHIFT:1];
