...
module lens_flat_line(pclk,first,next,F0,ERR0,A0,B0,F,ERR);
  ...
  reg  [(0-1)+A_WIDTH:0] A;
  wire [1+F_SHIFT:0] 
       preERR = {A2X[1+F_SHIFT:1],1'b0}+((-{dF[1:0],{F_SHIFT{1'b0}}})+ApB[1+F_SHIFT:0]);
  wire [1:0] 
       inc = {(~preERR[F_SHIFT] | ~preERR[(0-1)+F_SHIFT]) & preERR[1+F_SHIFT],(preERR[1+F_SHIFT:(0-1)+F_SHIFT] != 3'h7) & (preERR[1+F_SHIFT:(0-1)+F_SHIFT] != 3'h0)};
      ...
      begin
        ...
        if (first) 
          begin
            ...
            ApB[1+F_SHIFT:0] <= {{1+(F_SHIFT+(1+(0-A_WIDTH))){A0[(0-1)+A_WIDTH]}},A0[(0-1)+A_WIDTH:0]}+{B0[(0-1)+B_WIDTH:0],{F_SHIFT-B_SHIFT{1'b0}}};
          ...
          begin
            ...
            ERR[1+F_SHIFT:F_SHIFT] <= preERR[1+F_SHIFT:F_SHIFT]+(0-inc[1:0]);
          end
        ...
        if (first_d) 
          A2X[1+F_SHIFT:1] <= {{1+(F_SHIFT+(1+(0-A_WIDTH))){A[(0-1)+A_WIDTH]}},A[(0-1)+A_WIDTH:0]};
        else if (next) 
          A2X[1+F_SHIFT:1] <= A2X[1+F_SHIFT:1]+{{1+(F_SHIFT+(1+(0-A_WIDTH))){A[(0-1)+A_WIDTH]}},A[(0-1)+A_WIDTH:0]};
