...
module rd_bitslip  #(parameter  TCQ = 100)
  (input  clk,
  ...
  always @(posedge clk)  din2_r <= #TCQ din[2];
  
  always @(bitslip_cnt or din or din2_r)
      case (bitslip_cnt)

        2'b00: slip_out = {din[3],din[2],din[1],din[0]};

        2'b01: slip_out = {din[4],din[3],din[2],din[1]};

        2'b10: slip_out = {din[5],din[4],din[3],din[2]};

        2'b11: slip_out = {din2_r,din[5],din[4],din[3]};
