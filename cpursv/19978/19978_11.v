...
module debounce(clk,reset_n,data_in,data_out);
  ...
  output wire [(0-1)+WIDTH:0] data_out;
  reg  [(0-1)+TIMEOUT_WIDTH:0] counter[0:(0-1)+WIDTH];
  wire counter_reset[0:(0-1)+WIDTH];
  wire counter_enable[0:(0-1)+WIDTH];
          ...
          begin : debounce_counter_loop
            ...
            if (POLARITY == HIGH) 
              ...
              begin
                ...
                assign counter_enable[i] = (counter[i] < TIMEOUT) & (data_in[i] == 0);
