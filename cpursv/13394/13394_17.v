...
module axis_srl_fifo  #(parameter 
  ...
  (input  wire clk,
   ...
   input  wire [(-1)+KEEP_WIDTH:0] s_axis_tkeep,
   input  wire s_axis_tvalid,
   output wire s_axis_tready,
   input  wire s_axis_tlast,
   input  wire [(-1)+ID_WIDTH:0] s_axis_tid,
   input  wire [DEST_WIDTH-1:0] s_axis_tdest,
   input  wire [USER_WIDTH-1:0] s_axis_tuser,
   output wire [(-1)+DATA_WIDTH:0] m_axis_tdata,
   output wire [(-1)+KEEP_WIDTH:0] m_axis_tkeep,
   output wire m_axis_tvalid,
   input  wire m_axis_tready,
   output wire m_axis_tlast,
   output wire [(-1)+ID_WIDTH:0] m_axis_tid,
   output wire [DEST_WIDTH-1:0] m_axis_tdest,
   output wire [USER_WIDTH-1:0] m_axis_tuser,
   output wire [(-1)+$clog2(DEPTH+1):0] count);
  ...
  reg  [(-1)+$clog2(DEPTH+1):0]  ptr_reg = 0;
