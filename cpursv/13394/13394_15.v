...
module axis_srl_fifo  #(parameter 
  ...
  (input  wire clk,
   ...
   input  wire [(-1)+DEST_WIDTH:0] s_axis_tdest,
   input  wire [(-1)+USER_WIDTH:0] s_axis_tuser,
   ...
   output wire [(-1)+DEST_WIDTH:0] m_axis_tdest,
   output wire [(-1)+USER_WIDTH:0] m_axis_tuser,
