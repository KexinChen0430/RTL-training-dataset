...
module axis_srl_fifo  #(parameter 
  ...
  (input  wire clk,
   ...
   input  wire [DEST_WIDTH+(0-1):0] s_axis_tdest,
   input  wire [USER_WIDTH+(0-1):0] s_axis_tuser,
   ...
   output wire [DEST_WIDTH+(0-1):0] m_axis_tdest,
   output wire [USER_WIDTH+(0-1):0] m_axis_tuser,
  ...
  reg  [WIDTH+(0-1):0] data_reg[DEPTH-1:0];
