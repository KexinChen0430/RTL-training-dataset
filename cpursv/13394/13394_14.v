...
module axis_srl_fifo  #(parameter 
  ...
  (input  wire clk,
   ...
   input  wire [KEEP_WIDTH+(0-1):0] s_axis_tkeep,
   ...
   output wire [KEEP_WIDTH+(0-1):0] m_axis_tkeep,
  ...
  reg  [WIDTH-1:0] data_reg[DEPTH+(0-1):0];
  ...
  wire  ptr_full1 = ptr_reg == (DEPTH+(0-1));
  ...
  always @* 
      begin
        ...
        if (m_axis_tready && (s_axis_tready && s_axis_tvalid)) 
          begin
            shift = 1'b1;
            inc = ptr_empty;
            empty_next = 1'b0;
