...
module SFPU_MUL(SRC1,SRC2,MRESULT,NZEXP,OUT);
  ...
  assign sign = ((((((SRC2[31] & ((SRC1[31] & ~SRC2[31]) | ~zero)) & ~zero) | (SRC1[31] & ~SRC2[31])) & (~SRC1[31] | ((SRC1[31] & ~SRC1[31]) | (SRC1[31] & ~SRC2[31])))) & ((SRC2[31] & ((SRC1[31] & ~SRC2[31]) | ~zero)) & ~zero)) & ~SRC1[31]) | (((((SRC2[31] & ~SRC1[31]) | (~SRC1[31] & (SRC1[31] & ~SRC2[31]))) | SRC1[31]) & ~SRC2[31]) & ~zero);
  ...
  assign expoh = (0-10'h07E)+exponent;
  assign expol = (0-10'h07F)+exponent;
