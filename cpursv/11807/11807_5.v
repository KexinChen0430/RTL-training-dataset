...
module SFPU_MUL(SRC1,SRC2,MRESULT,NZEXP,OUT);
  ...
  assign zero = ~NZEXP[1<<1] | ~NZEXP[1];
  assign sign = (((~zero & ~(~zero & SRC2[31])) | ((~(~zero & SRC1[31]) & (~zero | ~SRC2[31])) & ~zero)) & SRC1[31]) | (((~zero & ~(~zero & SRC2[31])) | ((~(~zero & SRC1[31]) & (~zero | ~SRC2[31])) & ~zero)) & (~(~zero & SRC1[31]) & SRC2[31]));
