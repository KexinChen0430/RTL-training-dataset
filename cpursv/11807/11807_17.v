...
module SFPU_MUL(SRC1,SRC2,MRESULT,NZEXP,OUT);
  ...
  assign sign = ((SRC1[31] & (((~zero & (SRC1[31] | ~SRC1[31])) & ~SRC1[31]) | ((~zero & (SRC1[31] | ~SRC1[31])) & ~SRC2[31]))) & (~zero & ~SRC2[31])) | (~zero & (~SRC1[31] & (SRC1[31] | SRC2[31])));
  ...
  assign expoh = exponent+(0-10'h07E);
