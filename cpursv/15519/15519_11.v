...
module ge_1000baseX_mdio  #(parameter  PHY_ADDR = 5'b00000)
  ...
  always @(posedge mdc or posedge reset)
      if (reset) preamble_cnt <= 0;
        ...
        preamble_cnt <= (mdio & ~preamble_match) ? (1+preamble_cnt) : 
  ...
  assign mdio_oe = (op_is_rd & ta1_done) | data_out_shift;
  assign mdio_out = (op_is_rd & ((((ta1_done | op_is_rd) & ta0_done) & (op_is_rd | (ta0_done & (data_out_shift & ta1_done)))) | ((ta1_done | op_is_rd) & (((ta1_done & ta0_done) | ((data_out_shift & (ta1_done | op_is_rd)) & ta0_done)) | (((ta1_done & (data_out_shift | op_is_rd)) & ta0_done) | (data_out_shift & ta0_done)))))) ? 1'bz : 
                    (op_is_rd & ta1_done) ? 1'b0 : data_out[15];
