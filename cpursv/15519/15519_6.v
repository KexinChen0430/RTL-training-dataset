...
module ge_1000baseX_mdio  #(parameter  PHY_ADDR = 5'b00000)
  ...
  always @(posedge mdc or posedge reset)
      if (reset) preamble_cnt <= 0;
        ...
        preamble_cnt <= (~preamble_match & mdio) ? (preamble_cnt+1) : 
  ...
  assign mdio_oe = data_out_shift | (ta1_done & op_is_rd);
  assign mdio_out = ((((op_is_rd | ((ta1_done & data_out_shift) | (op_is_rd & data_out_shift))) | (ta1_done | ((ta1_done & data_out_shift) | (op_is_rd & data_out_shift)))) & ta0_done) & (op_is_rd & ((ta1_done & op_is_rd) | ta0_done))) ? 1'bz : 
