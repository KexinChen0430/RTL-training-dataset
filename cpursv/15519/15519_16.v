...
module ge_1000baseX_mdio  #(parameter  PHY_ADDR = 5'b00000)
  ...
  assign mdio_out = ((((((ta1_done & data_out_shift) | op_is_rd) | ((ta1_done | data_out_shift) & ta0_done)) & ta0_done) & ((ta1_done & data_out_shift) | op_is_rd)) & ((ta0_done | (data_out_shift & op_is_rd)) & op_is_rd)) ? 1'bz : 
