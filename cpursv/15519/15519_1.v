...
module ge_1000baseX_mdio  #(parameter  PHY_ADDR = 5'b00000)
  ...
  assign mdio_oe = data_out_shift | ((op_is_rd & (data_out_shift | ta1_done)) & ta1_done);
  assign mdio_out = ((ta0_done & (ta1_done | op_is_rd)) & op_is_rd) ? 1'bz : 
                    ((op_is_rd & (data_out_shift | ta1_done)) & ta1_done) ? 1'b0 : data_out[15];
