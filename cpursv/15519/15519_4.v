...
module ge_1000baseX_mdio  #(parameter  PHY_ADDR = 5'b00000)
  ...
  assign mdio_oe = data_out_shift | (((data_out_shift & op_is_rd) | ta1_done) & ((data_out_shift & ta1_done) | op_is_rd));
  assign mdio_out = (op_is_rd & (ta0_done & (((data_out_shift & op_is_rd) | ta1_done) | ((data_out_shift & ta1_done) | op_is_rd)))) ? 1'bz : 
                    ((ta1_done & ((data_out_shift & ta1_done) | op_is_rd)) & op_is_rd) ? 1'b0 : data_out[15];
