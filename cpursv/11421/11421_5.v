...
module stratixgx_lvds_rx_fifo_sync_ram(clk,datain,reset,waddr,raddr,we,dataout);

  parameter  ram_width = 10;
  input  clk;
  input  reset;
  input  [(0-1)+ram_width:0] datain;
  input  [1:0] waddr;
  input  [1:0] raddr;
  input  we;
  output [(0-1)+ram_width:0] dataout;
  reg  [(0-1)+ram_width:0] dataout_tmp;
  reg  [(0-1)+ram_width:0] 
      ram_d0,
      ram_d1,
      ram_d2,
      ...
      ram_q2,
      ram_q3;
  wire [(0-1)+ram_width:0] data_reg0,data_reg1,data_reg2,data_reg3;
  ...
  always @(we or data_reg0 or data_reg1 or data_reg2 or data_reg3 or ram_q0 or ram_q1 or ram_q2 or ram_q3)
      begin
        if (we == 1'b1) 
          begin
            ram_d0 <= data_reg0;
