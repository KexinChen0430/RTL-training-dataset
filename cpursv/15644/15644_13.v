...
module erx_remap(emesh_access_out,emesh_packet_out,clk,reset,emesh_access_in,
  ...
  assign static_remap[31:20] = (addr_in[31:20] | (remap_pattern[11:0] & remap_sel[11:0])) & (((~remap_sel[11:0] | (~remap_sel[11:0] & addr_in[31:20])) | (addr_in[31:20] & remap_pattern[11:0])) | (((remap_sel[11:0] & ~remap_sel[11:0]) | (remap_sel[11:0] & (addr_in[31:20] & remap_pattern[11:0]))) | (((remap_pattern[11:0] | addr_in[31:20]) & remap_sel[11:0]) & (remap_pattern[11:0] & remap_sel[11:0]))));
  assign static_remap[19:0] = addr_in[19:0];
  assign dynamic_remap[31:0] = (addr_in[31:0]+(-colid<<<20))+(remap_base[31:0]+(0-addr_in[31:26]<<$clog2(colid)));
