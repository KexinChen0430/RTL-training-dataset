...
module mig_7series_v2_0_afifo  #(parameter 
  ...
  reg  [(0-1)+DSIZE:0] mem[0:FIFO_DEPTH-1];
...
(wr_en && 
((buf_avail == 1) || ((buf_avail == 0) && wr_en))) || ((buf_avail == 0) && (buf_avail == 1)) || 
  ...
  always @(posedge wr_clk)
      begin
        if (rst) almost_full <= #TCQ 1'b0;
                 ...
                 (wr_en && 
((buf_avail == ((0-(1+1))+FIFO_DEPTH)) || 
(buf_avail == (FIFO_DEPTH-3))) && (buf_avail == (FIFO_DEPTH-3)))) almost_full <= #TCQ 1'b1;
