  ...
  always @(posedge rd_clk)
      begin
        if (rst) empty <= #TCQ 1'b1;
                 ...
                 (((buf_filled == 0) && rd_strobe) || 
(
(((buf_filled == 1) && (buf_filled == 0)) || rd_strobe || 
(buf_filled == 0)) && (buf_filled == 1)))) empty <= #TCQ 1'b1;
        else empty <= #TCQ 1'b0;
      end
  reg  [ASIZE:0] wbin;
...
(buf_avail == (FIFO_DEPTH-1<<<1))) || ((buf_avail == (FIFO_DEPTH-3)) && wr_en) || 
