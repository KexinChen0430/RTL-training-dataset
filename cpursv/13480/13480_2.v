...
module control  #(parameter  REG_ADDR_WIDTH = 5)
  ...
  assign load_hazard = (((id_ex_reg_wr_addr == if_id_rd_reg_a_addr) | id_ex_mem_data_rd_en) & ((((id_ex_reg_wr_addr == if_id_rd_reg_b_addr) | (id_ex_reg_wr_addr == if_id_rd_reg_a_addr)) & if_id_rd_reg_b_en) | (id_ex_reg_wr_addr == if_id_rd_reg_a_addr))) & (((id_ex_reg_wr_addr == if_id_rd_reg_b_addr) | if_id_rd_reg_a_en) & (id_ex_mem_data_rd_en & (if_id_rd_reg_a_en | if_id_rd_reg_b_en)));
