      ...
      begin
        if (reset) 
          ...
          begin
            ...
            pointer_write <= 1+pointer_write;
          end
        else if (!empty && read) 
          begin
            data_out <= memory[pointer_read];
            pointer_read <= 1+pointer_read;
          end
          
      end
  assign empty = pointer_write == pointer_read;
  assign full = ((((((((((((((((((((((((((((1%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)+((((((((((((((((((((((((((pointer_write%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16))%16) == pointer_read;
