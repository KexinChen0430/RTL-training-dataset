...
module fifo(clk,reset,data_in,write,read,data_out,empty,full,errors);
  ...
  assign full = (((((((((((((((((((((((((((((((1%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)+(((((((((((((((((((((((((((((pointer_write%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16)%16))%16) == pointer_read;
  
  always @(pointer_write or pointer_read)
      begin
        if (empty && read) error_underflow <= 1;
          
        if (write && full) error_overflow <= 1;
          
        if (error_underflow && !read) error_underflow <= 0;
          
        if (error_overflow && !write) error_overflow <= 0;
