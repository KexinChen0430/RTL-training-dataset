...
module icache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  localparam  TAGWIDTH = ((0-1<<1)+(0-CWIDTH))+AWIDTH;
  ...
  wire [(-1)+CWIDTH:0] rd_line,wr_line;
  ...
  assign iwb_ack_o = (stb_d1 | cache_hit) & (iwb_stb_i & (~ack_d1 | cache_hit));
  ...
  assign store_in_cache = iwb_stb_i & (((cache_hit | ((stb_d1 | cache_hit) & (iwb_stb_i & (~ack_d1 | cache_hit)))) & (~ack_d1 & stb_d1)) & miss_d1);
endmodule
