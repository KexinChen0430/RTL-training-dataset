...
module icache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  wire 
       cache_hit = (tag_out == iwb_adr_i[(-1)+AWIDTH:1+(CWIDTH+1)]) & valid_out;
  ...
  assign iwb_ack_o = ((cache_hit | ~ack_d1) & (((stb_d1 & cache_hit) | (iwb_stb_i & stb_d1)) | cache_hit)) & (iwb_stb_i & (((stb_d1 & cache_hit) | (iwb_stb_i & stb_d1)) | cache_hit));
  ...
  assign store_in_cache = ((miss_d1 & ~ack_d1) & stb_d1) & iwb_stb_i;
endmodule
