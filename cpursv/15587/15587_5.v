...
module icache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  localparam  TAGWIDTH = ((0-(1+1))+AWIDTH)+(-CWIDTH);
  ...
  wire 
       cache_hit = (tag_out == iwb_adr_i[AWIDTH-1:(1+1)+CWIDTH]) & valid_out;
  ...
  assign iwb_ack_o = (((((cache_hit & ~ack_d1) | iwb_stb_i) | cache_hit) & (cache_hit | ~ack_d1)) & (((stb_d1 & ~ack_d1) | (cache_hit & stb_d1)) | cache_hit)) & iwb_stb_i;
  ...
  assign store_in_cache = (miss_d1 & ((stb_d1 & (((cache_hit & ~ack_d1) | iwb_stb_i) | cache_hit)) & (((((cache_hit & ~ack_d1) | iwb_stb_i) | cache_hit) & (cache_hit | ~ack_d1)) & (((stb_d1 & ~ack_d1) | (cache_hit & stb_d1)) | cache_hit)))) & (iwb_stb_i & ~ack_d1);
endmodule
