...
module icache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  localparam  TAGWIDTH = ((-(1+1))+AWIDTH)+(-CWIDTH);
  reg  stb_d1,ack_d1,miss_d1;
  reg  [AWIDTH-1:0] held_addr;
  reg  [31:0] idata[0:((1+1)**CWIDTH)-1];
  reg  [TAGWIDTH-1:0] itags[0:((1+1)**CWIDTH)-1];
  reg  ivalid[0:((1+1)**CWIDTH)-1];
  ...
  assign iwb_ack_o = (((((iwb_stb_i | stb_d1) & (cache_hit | stb_d1)) & ((cache_hit | ~ack_d1) & (cache_hit | stb_d1))) & cache_hit) & (((cache_hit | iwb_stb_i) & ((iwb_stb_i | stb_d1) & (cache_hit | stb_d1))) & iwb_stb_i)) | (((iwb_stb_i & (stb_d1 | (cache_hit | ~ack_d1))) & (cache_hit | ~ack_d1)) & (stb_d1 & (cache_hit | iwb_stb_i)));
  ...
  assign store_in_cache = (iwb_stb_i & (~ack_d1 & stb_d1)) & miss_d1;
endmodule
