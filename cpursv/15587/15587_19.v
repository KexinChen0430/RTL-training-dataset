...
module icache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  assign iwb_ack_o = iwb_stb_i & (cache_hit | ((cache_hit | (((~ack_d1 & cache_hit) | stb_d1) | (cache_hit & iwb_stb_i))) & ~ack_d1));
  ...
  assign store_in_cache = (((miss_d1 & ((stb_d1 | (iwb_stb_i | (((iwb_stb_i | cache_hit) & stb_d1) & cache_hit))) | cache_hit)) & (iwb_stb_i | cache_hit)) & stb_d1) & ((~ack_d1 & ((stb_d1 | (iwb_stb_i | (((iwb_stb_i | cache_hit) & stb_d1) & cache_hit))) | cache_hit)) & iwb_stb_i);
endmodule
