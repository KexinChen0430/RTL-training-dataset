...
module icache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  localparam  TAGWIDTH = ((-2)+(0-CWIDTH))+AWIDTH;
  ...
  wire 
       cache_hit = (tag_out == iwb_adr_i[AWIDTH-1:CWIDTH+2]) & valid_out;
  ...
  assign iwb_ack_o = ((cache_hit | stb_d1) & (cache_hit | ~ack_d1)) & (((iwb_stb_i & ~ack_d1) | cache_hit) & iwb_stb_i);
  ...
  assign store_in_cache = ((miss_d1 & (stb_d1 & (cache_hit | iwb_stb_i))) & iwb_stb_i) & (~ack_d1 & ((((cache_hit | iwb_stb_i) & (stb_d1 | (cache_hit | ~ack_d1))) & (cache_hit | ~ack_d1)) & ((cache_hit | stb_d1) & (cache_hit | ~ack_d1))));
endmodule
