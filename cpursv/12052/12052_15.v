...
module syntheses_implementation_interface_out(input  valid_in,
                                              ...
                                              input  [1+(0-1):0] set_strb_in,
                                              input  [8+(0-1):0] set_addr_in,
                                              input  [1+(0-1):0] ready_out);

  wire [1+(0-1):0] ready_out_net;
  wire fir_compiler_7_2_1_m_axis_data_tvalid_net;
  wire [32-1:0] concat_y_net;
  wire [1+(0-1):0] logical_y_net;
  wire axi_fifo_m_axis_tlast_net;
  wire [1+(0-1):0] set_stb_in_net;
  wire [8+(0-1):0] set_addr_in_net;
