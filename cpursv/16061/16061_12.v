...
module SensorFSM  #(parameter  DataWidth = 8)
  (input  Reset_n_i,
   ...
   output [(0-1)+(DataWidth*1<<<1):0] SensorValue_o,
   ...
   input  [(0-1)+(DataWidth*1<<<1):0] ParamThreshold_i,
   input  [(0-1)+(DataWidth*1<<<1):0] ParamCounterPreset_i);
  ...
  reg  [(0-1)+(DataWidth*1<<<1):0] Word0;
  wire [(0-1)+(DataWidth*1<<<1):0] AbsDiffResult;
  ...
  reg  [(0-1)+(DataWidth*1<<<1):0] SensorFSM_Timer;
  ...
  wire [(0-1)+(DataWidth*1<<<1):0] DiffBA;

  assign DiffAB = {1'b0,SensorValue}-{1'b0,Word0};
  assign DiffBA = (-SensorValue)+Word0;
  assign AbsDiffResult = DiffAB[DataWidth*1<<<1] ? DiffBA : DiffAB[(0-1)+(DataWidth*1<<<1):0];
