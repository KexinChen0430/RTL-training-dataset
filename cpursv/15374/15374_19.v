...
module dcache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  wire 
       cache_hit = (tag_out == dwb_adr_i[AWIDTH+(0-1):CWIDTH+2]) & valid_out;
  ...
  assign dwb_ack_o = ((stb_d1 | (dwb_we_i | ((~ack_d1 | dwb_we_i) & stb_d1))) & (~ack_d1 | ((dwb_stb_i & (stb_d1 | (dwb_we_i | ((~ack_d1 | dwb_we_i) & stb_d1)))) & ((((stb_d1 | (dwb_we_i | ((~ack_d1 | dwb_we_i) & stb_d1))) & (stb_d1 | dwb_stb_i)) & ((dwb_stb_i & (stb_d1 | (dwb_we_i | ((~ack_d1 | dwb_we_i) & stb_d1)))) | dwb_we_i)) & dwb_we_i)))) & dwb_stb_i;
