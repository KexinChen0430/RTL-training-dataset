...
module dcache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  wire 
       cache_hit = (tag_out == dwb_adr_i[(-1)+AWIDTH:CWIDTH+1<<1]) & valid_out;
  ...
  assign dwb_ack_o = (dwb_stb_i & (((dwb_we_i | dwb_stb_i) & (stb_d1 | dwb_we_i)) & (dwb_stb_i | stb_d1))) & ((((dwb_we_i & stb_d1) | ~ack_d1) | dwb_we_i) & (stb_d1 | dwb_we_i));
