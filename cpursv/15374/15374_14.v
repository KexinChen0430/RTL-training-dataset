...
module dcache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  wire [(0-1)+TAGWIDTH:0]  tag_out = dtags[rd_line];
  ...
  wire 
       cache_hit = (tag_out == dwb_adr_i[AWIDTH-1:2+CWIDTH]) & valid_out;
  ...
  assign dwb_ack_o = (((dwb_stb_i & dwb_we_i) | stb_d1) & (~ack_d1 | (dwb_stb_i & dwb_we_i))) & (((((dwb_stb_i | (dwb_we_i & stb_d1)) | (dwb_we_i & stb_d1)) | dwb_we_i) & (dwb_we_i | stb_d1)) & dwb_stb_i);
