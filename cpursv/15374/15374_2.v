...
module dcache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  reg  [(-1)+TAGWIDTH:0] dtags[0:1<<<CWIDTH+(-1)];
  ...
  wire [(-1)+TAGWIDTH:0]  tag_out = dtags[rd_line];
  ...
  wire 
       cache_hit = valid_out & (tag_out == dwb_adr_i[AWIDTH+(-1):CWIDTH+1<<<1]);
  ...
  assign dwb_ack_o = (((dwb_we_i & dwb_stb_i) | ((((dwb_we_i & dwb_stb_i) | (~ack_d1 & dwb_we_i)) | ~ack_d1) & stb_d1)) & (dwb_we_i | ((dwb_we_i & stb_d1) | dwb_stb_i))) & dwb_stb_i;
