...
module dcache  #(parameter  AWIDTH = 14, CWIDTH = 6)
  ...
  wire 
       cache_hit = (tag_out == dwb_adr_i[AWIDTH-1:(1+CWIDTH)+1]) & valid_out;
  ...
  assign dwb_ack_o = dwb_stb_i & ((dwb_we_i | (~ack_d1 | ((stb_d1 & (stb_d1 | dwb_we_i)) & dwb_we_i))) & (stb_d1 | dwb_we_i));
