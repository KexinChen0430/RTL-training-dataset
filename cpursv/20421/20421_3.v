...
module axi_hp_abort(input  hclk,
  ...
  assign busy = busy_r;
  assign afi_rready = 
((|r_count && busy_aborting && |afi_rcount[7:1]) || 
(!afi_rready_r && afi_rcount[0] && busy_aborting)) && |r_count;
  ...
  always @(posedge hclk)
      begin
        ...
        adav <= 
(!reset_counters && 
((!ard && awr) || (!ard && aw_count[0]) || (!ard && awr) || 
((!ard && aw_count[0]) || |aw_count[5:1]))) || (!ard && awr) || 
               ((aw_count[0] && awr) || (!ard && aw_count[0]));
        ard_r <= !ard && 
...
adav);
        ...
        dirty <= |aw_count || 
                (|r_count && busy_aborting && |afi_rcount[7:1]) || |r_count;
      end
  ...
  always @(posedge hclk)
      begin
        ...
        if ((|afi_rcount && abort) || (|afi_wacount && abort) || 
            (abort && |afi_wcount) || (abort && |afi_racount)) busy_aborting <= 1;
