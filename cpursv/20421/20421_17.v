...
module axi_hp_abort(input  hclk,
  ...
  assign busy = busy_r;
  assign afi_rready = 
(!afi_rready_r && |r_count && busy_aborting && afi_rcount[0]) || 
                      (!afi_rready_r && |r_count && busy_aborting && afi_rcount[0]) || (|r_count && busy_aborting && |afi_rcount[7:1]);
...
(w_count[3:0] == aw_lengths_ram[aw_lengths_raddr]));
  ...
  always @(posedge hclk)
      begin
        ...
        adav <= (|aw_count[5:1] && !reset_counters) || 
               ((aw_count[0] && (!ard || (aw_count[0] && awr))) || 
(!ard && 
((aw_count[0] && awr) || 
((aw_count[0] && awr) || 
...
adav);
  ...
  always @(posedge hclk)
      begin
        ...
        if ((|afi_rcount && abort) || (abort && |afi_wacount) || 
            ((|afi_wcount && abort) || (abort && |afi_racount))) busy_aborting <= 1;
