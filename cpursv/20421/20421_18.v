...
module axi_hp_abort(input  hclk,
  ...
  reg   ard_r = 0;
  wire 
       ard = adav && ((ard_r || |w_count[7:4]) && (adav || ard_r));
  ...
  assign busy = busy_r;
  assign afi_rready = (busy_aborting && (|afi_rcount[7:1] && |r_count)) || 
                      (|r_count && 
(busy_aborting && (afi_rcount[0] && !afi_rready_r)));
  ...
  always @(posedge hclk)
      begin
        ...
        adav <= 
(
((!ard && ((aw_count[0] && !ard) || awr)) || 
(aw_count[0] || 
(!reset_counters && 
(|aw_count[5:1] || (aw_count[0] && awr))))) && awr) || (!ard && ((aw_count[0] && !ard) || awr)) || 
               ((!reset_counters || !ard) && 
((!ard && awr) || aw_count[0] || !reset_counters) && |aw_count[5:1]);
        ...
        if (reset_counters) w_count <= 0;
          ...
          w_count <= (w_count+(0-1))+(-{4'b0,aw_lengths_ram[aw_lengths_raddr]});
  ...
  always @(posedge hclk)
      begin
        ...
        if ((|afi_wacount && abort) || (abort && |afi_rcount) || 
            (|afi_racount && abort) || (abort && |afi_rcount) || 
            ((|afi_wacount || |afi_racount || |afi_wcount) && abort)) busy_aborting <= 1;
