...
module deserializer  #(parameter  LOG_DWIDTH = 7, DWIDTH = 64)
  ...
  assign data_out = lane_polarity ? ((((~{DWIDTH{1'b1}} | ({DWIDTH{1'b1}} | data_out_temp)) & ~data_out_temp) & ({DWIDTH{1'b1}} | data_out_temp)) | (~{DWIDTH{1'b1}} & ({DWIDTH{1'b1}} | data_out_temp))) : data_out_temp;
