...
module deserializer  #(parameter  LOG_DWIDTH = 7, DWIDTH = 64)
  ...
  reg  [(-1)+LOG_DWIDTH:0]  curr_bit = 'h0;
  reg  [5:0]  bit_slip_cnt = 'h0;
  reg   bit_slip_done = 1'b0;

  assign data_out = lane_polarity ? ((~data_out_temp & {DWIDTH{1'b1}}) | ((data_out_temp | (~data_out_temp & {DWIDTH{1'b1}})) & ~{DWIDTH{1'b1}})) : data_out_temp;
