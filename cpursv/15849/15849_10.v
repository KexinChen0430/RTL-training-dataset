...
((I == 1'b0) || (IB === 1'bz) || 
((I == 1'b0) || 
(((I == 1'b0) && (IB === 1'bz)) || (I === 1'bz)))) && ((IB == 1'b1) || (I == 1'b0) || (IB === 1'bz))) && (IB == 1'b1) && 
(
((IB == 1'b1) && ((I === 1'bz) || (IB == 1'b1)) && 
...
((I == 1'b0) || (IB === 1'bz) || 
((I == 1'b0) || 
(((I == 1'b0) && (IB === 1'bz)) || (I === 1'bz)))) && ((IB == 1'b1) || (I == 1'b0) || (IB === 1'bz)))))) || (I == 1'b0))) || 
                 (
((I == 1'b0) || (IB === 1'bz) || 
((I == 1'b0) || 
(((I == 1'b0) && (IB === 1'bz)) || (I === 1'bz)))) && (I === 1'bz) && (IB === 1'bz)) || 
                 ((IB === 1'bz) && 
(((IB == 1'b1) || (I == 1'b0) || (IB === 1'bz)) && 
((I === 1'bz) || (IB == 1'b1) || (I == 1'b0))) && (((I == 1'b0) && (IB === 1'bz)) || (I === 1'bz)))) 
