...
module IBUFDS_DIFF_OUT_INTERMDISABLE(O,OB,I,IB,IBUFDISABLE,INTERMDISABLE);
  ...
  always @(I or IB or DQS_BIAS_BINARY)
      begin
        ...
        else if (((IB === 1'bz) || (I === 1'bz) || (I == 1'b0)) && 
                 (IB == 1'b1) && (((IB == 1'b1) || (IB === 1'bz)) && (I == 1'b0))) o_out <= I;
        else if (
((IB === 1'bz) || 
(
(((IB === 1'bz) || (I === 1'bz) || (I == 1'b0)) && 
(IB == 1'b1) && (((IB == 1'b1) || (IB === 1'bz)) && (I == 1'b0))) || 
((I === 1'bz) && ((IB === 1'bz) || (I === 1'bz)) && 
(IB === 1'bz))) || 
(
(
((I === 1'bz) && ((IB === 1'bz) || (I === 1'bz)) && 
(IB === 1'bz)) || (I == 1'b0) || (IB == 1'b1)) && ((IB === 1'bz) || (I === 1'bz) || (I == 1'b0)) && 
((I === 1'bz) || 
(
((I === 1'bz) && ((IB === 1'bz) || (I === 1'bz)) && 
(IB === 1'bz)) || (I == 1'b0))) && 
(((IB == 1'b1) || (IB === 1'bz)) && 
((IB === 1'bz) || (I === 1'bz)) && ((IB === 1'bz) || (I === 1'bz) || (I == 1'b0))))) && 
                 ((I === 1'bz) || 
(
((I === 1'bz) && ((IB === 1'bz) || (I === 1'bz)) && 
(IB === 1'bz)) || (I == 1'b0)))) 
