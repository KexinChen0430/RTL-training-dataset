...
module vga_hint(input  hclk,
  ...
  always @(posedge hclk or negedge resetn)
      if (!resetn) 
        ...
        begin
          ...
          else if ((((done_1 | ~done_1) & (((done_1 | ~done_1) & done_0) & (done_0 | ~done_0))) & ~((done_1 | ~done_1) & (done_1 & (done_0 | ~done_0)))) | (~((done_1 | ~done_1) & (((done_1 | ~done_1) & done_0) & (done_0 | ~done_0))) & ((done_1 | ~done_1) & (done_1 & (done_0 | ~done_0))))) vga_ready_2 <= 1'b1;
  ...
  assign svga_req = (((req1 & req0) & ~req0) ^ ((((req0 | ~req0) & req1) & req1) & ~req0)) | (~req1 & (req0 | req1));
