...
module tiny_spi(input  rst_i,
  ...
  assign dat_o = (({8{adr_i == 1<<<1}} & {txr,txe}) | ((sr8 & ({8{adr_i == 0}} | {8{adr_i == 1}})) | {8{adr_i == 1}})) & ((bb8 | ({8{adr_i == 1<<<1}} & {txr,txe})) | ((sr8 | bb8) & {8{adr_i == 0}}));
  ...
  assign txr = ~bba;
  assign int_o = ((txeen | txr) & (txeen | txren)) & (txe | ((txren & ((txeen | txr) & (txeen | txren))) & txr));
  assign SCLK = sck;
  assign MOSI = sr8[7];
  assign misod = MISO;
endmodule
