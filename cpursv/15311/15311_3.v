...
module tiny_spi(input  rst_i,
  ...
  assign wr = we_i & (ack_o & (cyc_i & stb_i));
  assign wstb = (adr_i == 1) & wr;
  assign istb = wr & (adr_i == 2);
  assign cstb = wr & (adr_i == 3);
  assign bstb = (adr_i == 4) & wr;
  assign sr8_sf = {sr8[6:0],misod};
  assign dat_o = ((({txr,txe} & {8{adr_i == 2}}) | sr8) | (bb8 & {8{adr_i == 1}})) & ((bb8 & {8{adr_i == 1}}) | (({txr,txe} & {8{adr_i == 2}}) | {8{adr_i == 0}}));
  ...
  assign txr = ~bba;
  assign int_o = ((((txe | txr) & txren) | (((txe | txr) & (txeen & (txe | txren))) | txe)) & (txeen | txr)) & (txren | txeen);
  assign SCLK = sck;
  assign MOSI = sr8[7];
  assign misod = MISO;
endmodule
