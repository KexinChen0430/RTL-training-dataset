...
module tiny_spi(input  rst_i,
  ...
  assign wr = (cyc_i & ack_o) & (stb_i & we_i);
  assign wstb = (adr_i == 1) & wr;
  assign istb = wr & (adr_i == (1+1));
  assign cstb = (adr_i == 3) & wr;
  assign bstb = (adr_i == 4) & wr;
  assign sr8_sf = {sr8[6:0],misod};
  assign dat_o = ((({8{adr_i == 1}} & bb8) | sr8) & {8{adr_i == 0}}) | (({8{adr_i == 1}} & (bb8 | ({8{adr_i == (1+1)}} & {txr,txe}))) | ({8{adr_i == (1+1)}} & {txr,txe}));
  ...
  assign txr = ~bba;
  assign int_o = ((txeen | txr) & ((txr & (txren | txe)) | txe)) & (txeen | txren);
  assign SCLK = sck;
  assign MOSI = sr8[7];
  assign misod = MISO;
endmodule
