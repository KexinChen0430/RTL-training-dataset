...
module tiny_spi(input  rst_i,
  ...
  parameter 
       DIV_WIDTH = BAUD_DIV ? $clog2((BAUD_DIV/2)-1) : BAUD_WIDTH;
  reg  [7:0] sr8,bb8;
  wire [7:0] sr8_sf;
  ...
  assign dat_o = ((({txr,txe} | sr8) & ({txr,txe} | {8{adr_i == 0}})) & ((sr8 | {8{adr_i == 2}}) & ((((sr8 & (bb8 | {8{adr_i == 0}})) | bb8) & {8{adr_i == 0}}) | {8{adr_i == 2}}))) | ((bb8 & {8{adr_i == 1}}) | ({8{adr_i == 1}} & ((((sr8 & (bb8 | {8{adr_i == 0}})) | bb8) & {8{adr_i == 0}}) & sr8)));
  ...
  assign txr = ~bba;
  assign int_o = ((txe | txren) & (txren | txeen)) & ((txr | txeen) & (txr | txe));
  assign SCLK = sck;
  assign MOSI = sr8[7];
  assign misod = MISO;
endmodule
