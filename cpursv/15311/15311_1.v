...
module tiny_spi(input  rst_i,
  ...
  assign dat_o = (((((bb8 | {8{adr_i == 0}}) & ({8{adr_i == 1}} | {8{adr_i == 0}})) & (sr8 | (({8{adr_i == 1}} | {8{adr_i == 1<<1}}) & (bb8 | {8{adr_i == 1<<1}})))) | {8{adr_i == 1<<1}}) & {txr,txe}) | (((({8{adr_i == 0}} & sr8) & bb8) | ((bb8 | sr8) & ((bb8 | {8{adr_i == 0}}) & {8{adr_i == 1}}))) | ({8{adr_i == 0}} & sr8));
  ...
  assign txr = ~bba;
  assign int_o = (txeen & txe) | (txren & txr);
  assign SCLK = sck;
  assign MOSI = sr8[7];
  assign misod = MISO;
endmodule
