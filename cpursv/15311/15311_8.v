...
module tiny_spi(input  rst_i,
  ...
  assign wr = (we_i & stb_i) & (ack_o & cyc_i);
  assign wstb = (adr_i == 1) & wr;
  assign istb = (adr_i == 1<<<1) & wr;
  assign cstb = wr & (adr_i == 3);
  assign bstb = wr & (adr_i == 4);
  assign sr8_sf = {sr8[6:0],misod};
  assign dat_o = ({8{adr_i == 1}} & (bb8 | ((bb8 | sr8) & {8{adr_i == 0}}))) | ((((({8{adr_i == 1<<<1}} | {8{adr_i == 0}}) & (sr8 | {8{adr_i == 1<<<1}})) | (({8{adr_i == 0}} | ({8{adr_i == 1}} & (bb8 | ((bb8 | sr8) & {8{adr_i == 0}})))) & (((bb8 | ((bb8 | sr8) & {8{adr_i == 0}})) & sr8) | ({8{adr_i == 1}} & (bb8 | ((bb8 | sr8) & {8{adr_i == 0}})))))) & {txr,txe}) | ((({8{adr_i == 0}} | ({8{adr_i == 1}} & (bb8 | ((bb8 | sr8) & {8{adr_i == 0}})))) & (((bb8 | ((bb8 | sr8) & {8{adr_i == 0}})) & sr8) | ({8{adr_i == 1}} & (bb8 | ((bb8 | sr8) & {8{adr_i == 0}}))))) & (((sr8 & (({8{adr_i == 0}} | {8{adr_i == 1}}) & ({8{adr_i == 1}} | sr8))) & {8{adr_i == 0}}) | {txr,txe})));
  ...
  always @(bba or bc or cc or ccr or cpha or cpol or spi_seq)
      begin
        ...
        case (spi_seq)
          ...
          PHASE2: begin
                sck = ((cpol | cpha) & (cpha | ~cpha)) & ((~cpol & cpha) | ~cpha);
  ...
  assign txr = ~bba;
  assign int_o = ((((txr | txe) & txren) | txe) & txeen) | (txren & txr);
  assign SCLK = sck;
  assign MOSI = sr8[7];
  assign misod = MISO;
endmodule
