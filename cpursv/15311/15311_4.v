...
module tiny_spi(input  rst_i,
  ...
  parameter 
       DIV_WIDTH = BAUD_DIV ? $clog2((-1)+((1/(1+1))*BAUD_DIV)) : BAUD_WIDTH;
  reg  [7:0] sr8,bb8;
  wire [7:0] sr8_sf;
  reg  [(-1)+BC_WIDTH:0] bc,bc_next;
  ...
  assign dat_o = (({8{adr_i == (1+1)}} | (({8{adr_i == 0}} | ((bb8 & ((sr8 | bb8) & ({8{adr_i == 1}} | sr8))) & {8{adr_i == 1}})) & (((sr8 | bb8) & ({8{adr_i == 1}} | sr8)) | {8{adr_i == (1+1)}}))) & {txr,txe}) | ((({8{adr_i == 0}} & ((({8{adr_i == 0}} | bb8) & sr8) | bb8)) | (({8{adr_i == 1}} & (sr8 | bb8)) & ({8{adr_i == 0}} | bb8))) & (sr8 | (({8{adr_i == 1}} & (sr8 | bb8)) & ({8{adr_i == 0}} | bb8))));
  ...
  always @(bba or bc or cc or ccr or cpha or cpol or spi_seq)
      begin
        sck = cpol;
        cc_next = BAUD_DIV ? ((-1)+((1/(1+1))*BAUD_DIV)) : ccr;
        bc_next = bc;
        ld = 1'b0;
        sf = 1'b0;
        case (spi_seq)
          ...
          PHASE2: begin
                sck = (~cpha & cpol) | (cpha & (~cpha | (~cpol & cpha)));
  ...
  assign txr = ~bba;
  assign int_o = (txr & txren) | (txeen & txe);
  assign SCLK = sck;
  assign MOSI = sr8[7];
  assign misod = MISO;
endmodule
