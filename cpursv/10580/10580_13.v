...
module jserialadder(y,carryout,isValid,currentsum,currentcarryout,
  ...
  always @(posedge clk)
      begin
        currentsum <= ((~intermediatecarry & ~(a & ~intermediatecarry)) & b) | ((~((~a & b) | (~b & a)) & intermediatecarry) | (~intermediatecarry & (a & ~(~intermediatecarry & b))));
        currentcarryout <= (a & ((((b & intermediatecarry) | (b & a)) | intermediatecarry) | b)) | ((b & intermediatecarry) | (b & a));
      end
