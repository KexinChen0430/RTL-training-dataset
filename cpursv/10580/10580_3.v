...
module jserialadder(y,carryout,isValid,currentsum,currentcarryout,
  ...
  always @(posedge clk)
      begin
        currentsum <= ((b & (~intermediatecarry & ~(a & ~intermediatecarry))) | (((~intermediatecarry & ~(b & ~intermediatecarry)) & a) | intermediatecarry)) & (~intermediatecarry | ~(b ^ a));
        currentcarryout <= ((intermediatecarry | b) & (b | a)) & (a | intermediatecarry);
      end
