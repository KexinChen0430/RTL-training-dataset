...
module master_updateable_megarom(inout  wire [7:0] D,
  ...
  assign flash_nOE = !(
(reading_memory && (!bbc_A[16] && allowing_bbc_access)) || 
(!bbc_A[16] && allowing_bbc_access && 
((!bbc_nCE || !bbc_A[16]) && 
(reading_memory || !bbc_nCE))) || reading_memory);
  assign writing_memory = accessing_memory && !rnw;
  assign flash_nWE = !(writing_memory && !allowing_bbc_access);
  assign D = ((rnw == 1'b0) && (allowing_bbc_access == 1'b0) && 
             (driving_bus == 1'b1)) ? spi_D : 8'bZZZZZZZZ;
