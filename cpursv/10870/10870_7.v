...
(
(
((!bbc_A[16] || reading_memory) && 
(!bbc_A[16] && allowing_bbc_access)) || reading_memory) && (allowing_bbc_access && !bbc_nCE)));
  assign writing_memory = !rnw && accessing_memory;
  assign flash_nWE = !(!allowing_bbc_access && writing_memory);
  assign D = ((rnw == 1'b0) && 
             ((allowing_bbc_access == 1'b0) && (driving_bus == 1'b1))) ? spi_D : 8'bZZZZZZZZ;
