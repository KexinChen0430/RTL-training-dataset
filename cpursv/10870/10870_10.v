...
module master_updateable_megarom(inout  wire [7:0] D,
  ...
  assign reading_memory = rnw && accessing_memory;
  assign flash_nOE = !((reading_memory || allowing_bbc_access) && 
(reading_memory || (!bbc_nCE && !bbc_A[16])));
  assign writing_memory = !rnw && accessing_memory;
  assign flash_nWE = !(writing_memory && !allowing_bbc_access);
  assign D = ((allowing_bbc_access == 1'b0) && (driving_bus == 1'b1) && 
             (rnw == 1'b0)) ? spi_D : 8'bZZZZZZZZ;
