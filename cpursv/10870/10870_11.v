...
(
(
((allowing_bbc_access && !bbc_A[16]) || 
((!bbc_nCE || !bbc_A[16]) && 
((!bbc_A[16] && !bbc_nCE) || !bbc_nCE || reading_memory)) || reading_memory) && reading_memory) || 
((reading_memory && allowing_bbc_access) || 
(allowing_bbc_access && !bbc_A[16]))) && 
((!bbc_A[16] && !bbc_nCE) || !bbc_nCE || reading_memory));
