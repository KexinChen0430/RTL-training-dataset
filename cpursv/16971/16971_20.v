      ...
      begin
        if (rstn == 1'b0) 
          ...
          begin
            ...
            else if ((dma_prg_addr_reg[3:1<<<1] == EP_ADDR_DW3) & (dma_prg_wrena_reg == 1'b1)) init_shift <= 1'b0;
      ...
      begin
        if (soft_dma_reset == 1'b1) 
          ...
          begin
            ...
            prg_reg_DW3 <= ((dma_prg_addr_reg[3:1<<<1] == EP_ADDR_DW3) & (dma_prg_wrena_reg == 1'b1)) ? dma_prg_wrdata_reg : prg_reg_DW3;
