      ...
      begin
        if (rstn == 1'b0) 
          ...
          begin
            ...
            soft_dma_reset <= ((dma_prg_wrdata_reg[15:0] == 16'hFFFF) & (dma_prg_addr_reg[3:1<<<1] == EP_ADDR_DW0)) & (dma_prg_wrena_reg == 1'b1);
      ...
      begin
        if (soft_dma_reset == 1'b1) 
          ...
          begin
            ...
            prg_reg_DW2 <= ((dma_prg_addr_reg[3:1<<<1] == EP_ADDR_DW2) & (dma_prg_wrena_reg == 1'b1)) ? dma_prg_wrdata_reg : prg_reg_DW2;
