...
module WBDevIntercon(output [7:0] cpu_dat_o,
  ...
  assign ack_s2m = (ad_ack_i | tmr_ack_i) | (rs2_ack_i | t16_ack_i);
  ...
  assign dat_s2m = (({8{t16_ss}} | (ad_dat_i & {8{ad_ss}})) | ((((ad_dat_i & {8{ad_ss}}) | (rs2_dat_i & (((ad_dat_i & {8{ad_ss}}) | (ad_dat_i & {8{ad_ss}})) | {8{rs2_ss}}))) | tmr_dat_i) & ({8{tmr_ss}} | ({8{rs2_ss}} & rs2_dat_i)))) & ((((tmr_dat_i & {8{tmr_ss}}) | ({8{rs2_ss}} & (rs2_dat_i | (tmr_dat_i & {8{tmr_ss}})))) | ((t16_dat_i | (((((ad_dat_i & {8{ad_ss}}) | (ad_dat_i & {8{ad_ss}})) | {8{rs2_ss}}) & (((ad_dat_i & {8{ad_ss}}) | (rs2_dat_i & (((ad_dat_i & {8{ad_ss}}) | (ad_dat_i & {8{ad_ss}})) | {8{rs2_ss}}))) | tmr_dat_i)) & rs2_dat_i)) | (ad_dat_i & {8{ad_ss}}))) | ({8{tmr_ss}} & (((ad_dat_i & {8{ad_ss}}) | (rs2_dat_i & (((ad_dat_i & {8{ad_ss}}) | (ad_dat_i & {8{ad_ss}})) | {8{rs2_ss}}))) | tmr_dat_i)));
