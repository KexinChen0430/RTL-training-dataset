  ...
  always @(posedge clk)
      begin
        if ((cpu_rd == 1) && (cpu_wr == 0) && 
            ((cpu_mreq == 0) && (cpu_addr == 16'h92c1))) 
          begin
            copy_enable = cpu_data;
          end
        else if ((cpu_mreq == 0) && 
                 ((cpu_addr >= 16'h8000) && (cpu_addr <= 16'h92bf) && 
(cpu_rd == 1)) && ((cpu_wr == 0) && (copy_in_progress == 0))) 
          begin
        ...
        else if ((cpu_rd == 0) && (cpu_mreq == 0) && 
                 ((copy_in_progress == 0) && (cpu_addr <= 16'h92bf)) && ((cpu_addr >= 16'h8000) && (cpu_wr == 1))) 
          begin
            back_vram_addr = cpu_addr[12:0];
            back_vram_rd_low = 0;
            vram_read = 1;
