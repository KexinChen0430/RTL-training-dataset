...
module cpu_vreg(input  wire clk,
  ...
  always @(posedge clk)
      begin
        ...
        else if ((cpu_addr >= 16'h8000) && 
                 ((copy_in_progress == 0) && (cpu_wr == 0)) && 
                 ((cpu_mreq == 0) && (cpu_addr <= 16'h92bf) && (cpu_rd == 1))) 
          begin
        ...
        else if ((cpu_mreq == 0) && (cpu_addr <= 16'h92bf) && 
                 (cpu_addr >= 16'h8000) && 
                 ((cpu_wr == 1) && 
((copy_in_progress == 0) && (cpu_rd == 0)))) 
          begin
            back_vram_addr = cpu_addr[12:0];
            back_vram_rd_low = 0;
            vram_read = 1;
