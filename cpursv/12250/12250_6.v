...
module idecoder(input  iAZERO,
  ...
  assign oPCJEN = 
(
((~iAZERO && iAZERO && (iAZERO && wJZ)) || 
(iAZERO && wJNZ && (iAZERO && wJZ)) || wJNZ) && ~iAZERO && ((iAZERO && wJNZ) || (iAZERO && wJZ))) || 
                  (
((~iAZERO && iAZERO && (iAZERO && wJZ)) || 
(iAZERO && wJNZ && (iAZERO && wJZ)) || wJNZ) && ~iAZERO) || 
                  ((wJZ && wJNZ && ~iAZERO) || 
(wJNZ && (~iAZERO && iAZERO && (iAZERO && wJZ))) || (iAZERO && wJZ));
