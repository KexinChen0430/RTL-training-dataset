...
module idecoder(input  iAZERO,
  ...
  assign oPCJEN = (~iAZERO || wJZ) && 
                  ((wJNZ && iAZERO) || 
(wJNZ && iAZERO && (~iAZERO || wJZ) && wJZ && ~iAZERO) || 
((wJNZ || wJZ) && 
(~iAZERO || (wJNZ && iAZERO && (~iAZERO || wJZ)) || iAZERO) && wJNZ && ~iAZERO) || 
((wJNZ && iAZERO && (~iAZERO || wJZ) && wJZ) || 
(wJZ && ~iAZERO && wJNZ) || 
((~iAZERO || wJZ) && (wJNZ || iAZERO) && iAZERO && wJZ)));
