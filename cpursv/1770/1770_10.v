...
module serial_wb_wbmaster(input  wire clk_i,
  ...
  assign cycle_terminated = wbm_ack_i || (wbm_rty_i || wbm_err_i);
  wire ctrl_write;
  ...
  always @(ctrl_write or cycle_terminated or data_i or statusreg_r or wb_state_r or wbm_err_i or wbm_rty_i)
      begin
        ...
        else if ((wb_state_r == 2'b00) && ctrl_write && data_i[0]) 
          begin
            wbm_cyc_o = 1;
            wbm_stb_o = 1;
        ...
        else if ((wb_state_r != 2'b00) && cycle_terminated) 
          begin
            next_wb_state = 2'b00;
            next_statusreg[0] = 0;
            next_statusreg[1] = wbm_err_i;
