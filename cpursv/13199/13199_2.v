              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,1'd1}] <= dina[(-1)+(DATA_WIDTH_B*1<<<1):DATA_WIDTH_B];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd1}] <= dina[(-1)+(DATA_WIDTH_B*1<<<1):DATA_WIDTH_B];
                    m_ram[{addra,2'd2}] <= dina[(3*DATA_WIDTH_B)+(-1):DATA_WIDTH_B*1<<<1];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd1}] <= dina[(-1)+(DATA_WIDTH_B*1<<<1):DATA_WIDTH_B];
                    m_ram[{addra,3'd2}] <= dina[(3*DATA_WIDTH_B)+(-1):DATA_WIDTH_B*1<<<1];
