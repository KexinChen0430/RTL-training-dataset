              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,1'd1}] <= dina[(DATA_WIDTH_B*2)-1:DATA_WIDTH_B];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd1}] <= dina[(DATA_WIDTH_B*2)-1:DATA_WIDTH_B];
                    m_ram[{addra,2'd2}] <= dina[(DATA_WIDTH_B*3)+(-1):DATA_WIDTH_B*2];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd1}] <= dina[(DATA_WIDTH_B*2)-1:DATA_WIDTH_B];
                    m_ram[{addra,3'd2}] <= dina[(DATA_WIDTH_B*3)+(-1):DATA_WIDTH_B*2];
                    ...
                    m_ram[{addra,3'd6}] <= dina[(-1)+(DATA_WIDTH_B*7):DATA_WIDTH_B*6];
                    m_ram[{addra,3'd7}] <= dina[(-1)+(DATA_WIDTH_B*8):DATA_WIDTH_B*7];
                  end
