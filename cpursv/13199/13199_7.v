...
module ad_mem_asym(clka,wea,addra,dina,clkb,addrb,doutb);
  ...
  reg  [(0-1)+DATA_WIDTH_B:0] m_ram[0:MEM_SIZE-1];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,1'd1}] <= dina[(0-1)+((1+1)*DATA_WIDTH_B):DATA_WIDTH_B];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd1}] <= dina[(0-1)+((1+1)*DATA_WIDTH_B):DATA_WIDTH_B];
                    m_ram[{addra,2'd2}] <= dina[(0-1)+(3*DATA_WIDTH_B):(1+1)*DATA_WIDTH_B];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd1}] <= dina[(0-1)+((1+1)*DATA_WIDTH_B):DATA_WIDTH_B];
                    m_ram[{addra,3'd2}] <= dina[(0-1)+(3*DATA_WIDTH_B):(1+1)*DATA_WIDTH_B];
                    m_ram[{addra,3'd3}] <= dina[(0-1)+(DATA_WIDTH_B*4):3*DATA_WIDTH_B];
                    m_ram[{addra,3'd4}] <= dina[(DATA_WIDTH_B*5)+(0-1):DATA_WIDTH_B*4];
                    m_ram[{addra,3'd5}] <= dina[(DATA_WIDTH_B*6)+(0-1):DATA_WIDTH_B*5];
                    m_ram[{addra,3'd6}] <= dina[(DATA_WIDTH_B*7)-1:DATA_WIDTH_B*6];
                    m_ram[{addra,3'd7}] <= dina[(0-1)+(DATA_WIDTH_B*8):DATA_WIDTH_B*7];
                  end
