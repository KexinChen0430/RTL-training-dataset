...
module ad_mem_asym(clka,wea,addra,dina,clkb,addrb,doutb);
  ...
  reg  [DATA_WIDTH_B+(0-1):0] m_ram[0:MEM_SIZE-1];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd2}] <= dina[(3*DATA_WIDTH_B)-1:DATA_WIDTH_B+DATA_WIDTH_B];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd2}] <= dina[(3*DATA_WIDTH_B)-1:DATA_WIDTH_B+DATA_WIDTH_B];
                    ...
                    m_ram[{addra,3'd7}] <= dina[(DATA_WIDTH_B*8)+(0-1):DATA_WIDTH_B*7];
                  end
