              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,1'd1}] <= dina[(-1)+(1<<<1*DATA_WIDTH_B):DATA_WIDTH_B];
                  end
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,2'd1}] <= dina[(-1)+(1<<<1*DATA_WIDTH_B):DATA_WIDTH_B];
                    m_ram[{addra,2'd2}] <= dina[(DATA_WIDTH_B*3)-1:1<<<1*DATA_WIDTH_B];
              ...
              begin
                if (wea == 1'b1) 
                  begin
                    ...
                    m_ram[{addra,3'd1}] <= dina[(-1)+(1<<<1*DATA_WIDTH_B):DATA_WIDTH_B];
                    m_ram[{addra,3'd2}] <= dina[(DATA_WIDTH_B*3)-1:1<<<1*DATA_WIDTH_B];
                    m_ram[{addra,3'd3}] <= dina[(DATA_WIDTH_B*4)-1:DATA_WIDTH_B*3];
                    m_ram[{addra,3'd4}] <= dina[(-1)+(DATA_WIDTH_B*5):DATA_WIDTH_B*4];
                    m_ram[{addra,3'd5}] <= dina[(-1)+(DATA_WIDTH_B*6):DATA_WIDTH_B*5];
