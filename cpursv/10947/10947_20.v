...
module FullAdderViaHAs;
  ...
  assign FullAdderViaHAs0_0_s_HA1HA2 = x1 ^ ((x2 & (x1 | ~x1)) & (x1 | ~x1));
  assign FullAdderViaHAs0_0_c_HA1CL = x1 & x2;
  assign s = ((((~FullAdderViaHAs0_0_s_HA1HA2 | FullAdderViaHAs0_0_s_HA1HA2) & cin) & (~FullAdderViaHAs0_0_s_HA1HA2 | ~cin)) & (cin | FullAdderViaHAs0_0_s_HA1HA2)) ^ (((cin | FullAdderViaHAs0_0_s_HA1HA2) & (((cin | ~cin) & FullAdderViaHAs0_0_s_HA1HA2) & FullAdderViaHAs0_0_s_HA1HA2)) ^ ((FullAdderViaHAs0_0_s_HA1HA2 & cin) & (cin | FullAdderViaHAs0_0_s_HA1HA2)));
