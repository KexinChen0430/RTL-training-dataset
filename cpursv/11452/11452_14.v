...
module ic_download(clk,rst,rep_flit_ic,v_rep_flit_ic,rep_ctrl_ic,mem_flits_ic,
  ...
  always @(posedge clk)
      begin
        ...
        else if (en_rep_flit_ic && en_instword[0]) inst_word[15:0] <= inst_word_in[15:0];
  ...
  always @(posedge clk)
      begin
        ...
        else if (en_rep_flit_ic && en_instword[1]) inst_word[31:16] <= inst_word_in[31:16];
  ...
  always @(posedge clk)
      begin
        ...
        else if (en_instword[2] && en_rep_flit_ic) inst_word[47:32] <= inst_word_in[47:32];
  ...
  always @(posedge clk)
      begin
        ...
        else if (en_instword[3] && en_rep_flit_ic) inst_word[63:48] <= inst_word_in[63:48];
  ...
  always @(posedge clk)
      begin
        ...
        else if (en_instword[4] && en_rep_flit_ic) inst_word[79:64] <= inst_word_in[79:64];
  ...
  always @(posedge clk)
      begin
        ...
        else if (en_rep_flit_ic && en_instword[5]) inst_word[95:80] <= inst_word_in[95:80];
  ...
  always @(posedge clk)
      begin
        ...
        else if (en_rep_flit_ic && en_instword[7]) inst_word[127:112] <= inst_word_in[127:112];
  ...
  always @(posedge clk)
      begin
        ...
        else if (inc_cnt) cnt <= 3'b001+cnt;
