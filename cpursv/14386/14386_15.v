...
module IO_SWITCH(BCLK,BRESET,I_IOA,D_IOA,I_IORD,D_IORD,D_IOWR,IO_READY,
  ...
  always @(posedge BCLK)
      ...
      else ilo_flag <= ((sel_dp & D_IORD) | ilo_keep) | DCWACC[0];
  assign ilo_keep = (~DCWACC[1] & ilo_flag) & ~D_IOWR;
  assign ILO = ((ILO_SIG & DCWACC[1]) | (ILO_SIG & (ilo_flag | ((D_IOWR | (D_IORD & DCWACC[0])) | DCWACC[0])))) | (ILO_SIG & ((sel_dp & D_IORD) | (D_IORD & DCWACC[0])));
endmodule
