...
module IO_SWITCH(BCLK,BRESET,I_IOA,D_IOA,I_IORD,D_IORD,D_IOWR,IO_READY,
  ...
  always @(posedge BCLK)
      if (!ILO_SIG) ilo_flag <= 1'b0;
        ...
        ilo_flag <= (((ilo_keep | ilo_keep) | (DCWACC[0] | sel_dp)) & D_IORD) | (DCWACC[0] | ilo_keep);
  assign ilo_keep = (~DCWACC[1] & ilo_flag) & ~D_IOWR;
  assign ILO = (((DCWACC[0] | sel_dp) & ((ILO_SIG & D_IORD) | ((ilo_flag | DCWACC[0]) & ILO_SIG))) | (ilo_flag & ((ILO_SIG & D_IORD) | ((ilo_flag | DCWACC[0]) & ILO_SIG)))) | (((DCWACC[1] | D_IOWR) | ((D_IORD & sel_dp) | DCWACC[0])) & ILO_SIG);
endmodule
