...
module IO_SWITCH(BCLK,BRESET,I_IOA,D_IOA,I_IORD,D_IORD,D_IOWR,IO_READY,
  ...
  assign sel_dp = ((select == 2'b10) | (select == 2'b00)) & ((select == 2'b10) | daten);
  ...
  always @(posedge BCLK)
      if (!ILO_SIG) ilo_flag <= 1'b0;
        ...
        ilo_flag <= ((ilo_keep | sel_dp) & ((ilo_keep | ilo_keep) | (D_IORD | DCWACC[0]))) | DCWACC[0];
  assign ilo_keep = (~D_IOWR & ilo_flag) & ~DCWACC[1];
  assign ILO = (((ilo_flag | ((D_IOWR | (sel_dp & DCWACC[0])) | DCWACC[0])) & ((ILO_SIG & D_IOWR) | ((ILO_SIG & ilo_flag) | ((DCWACC[0] & ILO_SIG) | (ILO_SIG & sel_dp))))) | (((ILO_SIG & D_IOWR) | ((ILO_SIG & ilo_flag) | ((DCWACC[0] & ILO_SIG) | (ILO_SIG & sel_dp)))) & D_IORD)) | ((DCWACC[0] & ILO_SIG) | (((DCWACC[1] & ILO_SIG) | ((ILO_SIG & D_IOWR) & (sel_dp & D_IORD))) | ((sel_dp & D_IORD) & ILO_SIG)));
endmodule
