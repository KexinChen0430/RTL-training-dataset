...
module IO_SWITCH(BCLK,BRESET,I_IOA,D_IOA,I_IORD,D_IORD,D_IOWR,IO_READY,
  ...
  always @(posedge BCLK)
      if (!ILO_SIG) ilo_flag <= 1'b0;
        ...
        ilo_flag <= (D_IORD & (((sel_dp | (sel_dp & DCWACC[0])) | DCWACC[0]) | ilo_keep)) | (DCWACC[0] | ilo_keep);
  assign ilo_keep = (~D_IOWR & ilo_flag) & ~DCWACC[1];
  assign ILO = (D_IOWR & ILO_SIG) | (((((DCWACC[0] | DCWACC[1]) | ((sel_dp | ilo_flag) & (D_IORD | ilo_flag))) & (ILO_SIG & ilo_flag)) | (ILO_SIG & (((sel_dp | (sel_dp & DCWACC[0])) | DCWACC[0]) & D_IORD))) | ((((DCWACC[0] | DCWACC[1]) & ILO_SIG) | (((ILO_SIG & ilo_flag) | ((ILO_SIG & (((sel_dp | (sel_dp & DCWACC[0])) | DCWACC[0]) & D_IORD)) | (ILO_SIG & DCWACC[0]))) & ilo_flag)) | (ILO_SIG & ilo_flag)));
endmodule
