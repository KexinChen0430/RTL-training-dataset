...
module IO_SWITCH(BCLK,BRESET,I_IOA,D_IOA,I_IORD,D_IORD,D_IOWR,IO_READY,
  ...
  assign sel_dp = (select == 2'b10) | (((select == 2'b10) & (select == 2'b00)) | ((select == 2'b00) & daten));
  ...
  assign interrupt = GENSTAT[0] | GENSTAT[1];
  ...
  always @(posedge BCLK)
      if (!ILO_SIG) ilo_flag <= 1'b0;
        ...
        ilo_flag <= ilo_keep | ((DCWACC[0] | sel_dp) & ((DCWACC[0] | ilo_keep) | ((ilo_keep | ilo_keep) | D_IORD)));
  assign ilo_keep = (~D_IOWR & ~DCWACC[1]) & ilo_flag;
  assign ILO = ((ILO_SIG & ((DCWACC[0] | (D_IORD | D_IOWR)) | ilo_flag)) & (D_IOWR | (((ilo_flag | (sel_dp & DCWACC[0])) | DCWACC[0]) | ((ilo_flag | ilo_flag) | sel_dp)))) | ((((ILO_SIG & DCWACC[1]) | ((D_IORD & sel_dp) & ILO_SIG)) | (DCWACC[0] & (((((D_IORD & sel_dp) | DCWACC[0]) & (D_IOWR & ILO_SIG)) | (ILO_SIG & DCWACC[0])) | ((D_IORD & sel_dp) & ILO_SIG)))) | (ILO_SIG & DCWACC[0]));
endmodule
