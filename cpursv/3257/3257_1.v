...
module wishbone_interconnect(clk,rst,i_m_we,i_m_cyc,i_m_sel,i_m_stb,o_m_ack,i_m_dat,
                             o_m_dat,i_m_adr,o_m_int,o_s0_we,o_s0_cyc,o_s0_sel,o_s0_stb,
                             i_s0_ack,o_s0_dat,i_s0_dat,o_s0_adr,i_s0_int,o_s1_we,o_s1_cyc,
                             o_s1_sel,o_s1_stb,i_s1_ack,o_s1_dat,i_s1_dat,o_s1_adr,
                             i_s1_int);
  ...
  always @(slave_select or i_s0_dat or i_s1_dat or interrupts)
      begin
        case (slave_select)
  ...
  always @(slave_select or i_s0_ack or i_s1_ack)
      begin
        case (slave_select)
