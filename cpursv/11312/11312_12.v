...
module srl8_to_64(clk,enable,reset,dataIn,ready,result);
  ...
  assign result = (status_int == s9) ? {regBank[7],regBank[6],regBank[5],regBank[4],regBank[3],regBank[1+1],regBank[1],regBank[0]} : 64'h0;
