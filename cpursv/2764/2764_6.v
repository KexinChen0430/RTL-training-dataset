...
module ac97_deframer(input  sys_clk,
                     input  sys_rst,
                     input  up_stb,
                     output up_ack,
                     input  up_sync,
          ...
          begin
            ...
            if (up_stb & en) 
              begin
                ...
                if (bitcounter == 8'd95) next_frame <= 1'b1;
                  
                sync_old <= up_sync;
                if (~sync_old & up_sync) bitcounter <= 8'd0;
                else bitcounter <= 8'd1+bitcounter;
              end
