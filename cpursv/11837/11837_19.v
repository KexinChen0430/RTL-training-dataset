...
module I2CTest(CLCK,SCL,SDA);
  ...
  always @(posedge SCL_negedge)
      if (addressmatch & ((bitcount == 8) | (((bitcount == 8) | ((((((bitcount == 8) | (bitcount == 17)) & (bitcount == 17)) & (bitcount == 8)) | ~rw) | ((((bitcount == 8) | (bitcount == 17)) & (bitcount == 17)) & (bitcount == 8)))) & (addressmatch & (bitcount == 17))))) 
        begin
          sdadata = 1'b0;
          currvalue = 0;
        end
      else if ((bitcount >= 9) & (addressmatch & ((currvalue < valuecnt) & rw))) 
        begin
