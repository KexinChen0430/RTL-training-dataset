...
module I2CTest(CLCK,SCL,SDA);
  ...
  always @(posedge SCL_negedge)
      if (((((bitcount == 17) & (bitcount == 8)) | ((~rw & ((~rw & (bitcount == 8)) | (bitcount == 17))) & (((bitcount == 8) & addressmatch) | (addressmatch & (bitcount == 17))))) | (bitcount == 8)) & ((addressmatch & (bitcount == 17)) | ((((((bitcount == 17) & (bitcount == 8)) | ~rw) | ((bitcount == 17) & (bitcount == 8))) | (bitcount == 8)) & addressmatch))) 
        begin
          sdadata = 1'b0;
          currvalue = 0;
        end
      else if ((rw & (currvalue < valuecnt)) & (((bitcount >= 9) & (~rw | addressmatch)) & addressmatch)) 
        begin
