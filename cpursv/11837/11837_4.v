...
module I2CTest(CLCK,SCL,SDA);
  ...
  always @(posedge SCL_posedge or negedge incycle)
      if (~incycle) 
        ...
        begin
          ...
          if ((bitcount > 9) & ~rw) datain[17+(0-bitcount)] = SDA_synched;
  ...
  always @(posedge SCL_negedge)
      if (addressmatch & (((addressmatch | ((((bitcount == 17) | ((bitcount == 8) & ~rw)) & ~rw) & (bitcount == 17))) & (((bitcount == 8) | (((bitcount == 8) & (bitcount == 17)) | ((((bitcount == 17) | ((bitcount == 8) & ~rw)) & ~rw) & (bitcount == 17)))) | ~rw)) & ((bitcount == 8) | (((bitcount == 8) & (bitcount == 17)) | ((((bitcount == 17) | ((bitcount == 8) & ~rw)) & ~rw) & (bitcount == 17)))))) 
        begin
          sdadata = 1'b0;
          currvalue = 0;
        end
      else if (rw & ((((currvalue < valuecnt) & (bitcount >= 9)) & (addressmatch | ((((bitcount == 17) | ((bitcount == 8) & ~rw)) & ~rw) & (bitcount == 17)))) & addressmatch)) 
        begin
          if ((((0-9)+bitcount)-(currvalue*9)) == 8) 
            begin
              sdadata = 1'bz;
              currvalue = currvalue+1;
            end
          else sdadata = datain[7+(-(((0-9)+bitcount)-(currvalue*9)))];
        end
      else sdadata = 1'bz;
  assign SDA = sdadata;
endmodule
