...
module niosII_system_switch(address,chipselect,clk,in_port,reset_n,write_n,writedata,irq,
  ...
  assign clk_en = 1;
  assign read_mux_out = (((irq_mask & {4{address == 2}}) | (({4{address == 0}} & (data_in | {4{address == 2}})) & (edge_capture & data_in))) | (((irq_mask | {4{address == 3}}) & edge_capture) & ({4{address == 3}} | {4{address == 2}}))) | ((({4{address == 0}} & data_in) | {4{address == 3}}) & ((irq_mask | data_in) & ((((({4{address == 0}} | {4{address == 2}}) & data_in) | (({4{address == 0}} | {4{address == 2}}) & data_in)) | {4{address == 2}}) & (irq_mask | {4{address == 0}}))));
