...
module mor1kx_branch_predictor_saturation_counter(input  clk,
  ...
  assign predicted_flag_o = (op_bf_i || !state[1]) && 
                            ((flag_i && !flag_i) || 
(((flag_i && !flag_i && op_bnf_i) || op_bnf_i) && 
((flag_i && !flag_i && op_bnf_i) || !state[1])) || (op_bnf_i && op_bf_i) || op_bnf_i || 
(op_bf_i && 
(
(op_bf_i && 
(((flag_i && !flag_i && op_bnf_i) || op_bnf_i) && 
((flag_i && !flag_i && op_bnf_i) || !state[1]))) || state[1])));
  wire 
       brn_taken = (!flag_i && (execute_op_bnf_i || flag_i)) || 
