...
(((op_bnf_i && (!flag_i && flag_i)) || op_bnf_i) && 
((op_bnf_i && (!flag_i && flag_i)) || !state[1]))) && 
                            (!state[1] || 
(
(((op_bnf_i && (!flag_i && flag_i)) || op_bnf_i) && 
((op_bnf_i && (!flag_i && flag_i)) || !state[1])) || (!state[1] && op_bf_i)) || op_bf_i);
  wire 
       brn_taken = 
((!flag_i && flag_i) || 
...
(((execute_op_bnf_i && flag_i) || execute_op_bf_i) && 
flag_i))))) && 
((!flag_i && flag_i) || (execute_op_bnf_i || flag_i));
