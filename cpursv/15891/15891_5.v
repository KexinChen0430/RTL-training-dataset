...
module fx3_bus_controller(input  clk,
  ...
  assign w_out_path_idle = !o_out_path_enable && !i_out_path_busy && 
                           (!i_out_path_finished && !i_out_path_ready);
      ...
      begin
        if (rst) 
          ...
          begin
            ...
            if (i_out_ch0_rdy && !i_out_ch1_rdy) 
              begin
                r_out_buf_sel_next <= 0;
              end
            ...
            if (w_in_data_avail && i_master_rdy && !o_in_path_enable) 
              begin
