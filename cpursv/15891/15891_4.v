...
module fx3_bus_controller(input  clk,
  ...
  assign w_out_path_idle = !i_out_path_finished && !o_out_path_enable && 
                           (!i_out_path_ready && !i_out_path_busy);
      ...
      begin
        if (rst) 
          ...
          begin
            ...
            if (i_master_rdy && !o_in_path_enable && w_in_data_avail) 
              begin
            ...
            if (w_in_path_idle && i_out_path_ready) 
              begin
                o_out_path_enable <= 1;
                o_out_dma_buf_ready <= 0;
              end
              ...
              begin
                if (!o_out_dma_buf_ready && w_out_buf_avail) 
                  begin
