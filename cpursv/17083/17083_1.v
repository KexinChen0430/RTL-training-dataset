...
module m_instruction_logic_unit(w_jump_flag,w_data_mem_write_flag,w_store_word_flag,
                                w_store_pc_flag,w_load_word_flag,w_write_back_flag,
                                w_write_back_reg,w_bus_wordin,w_cf,w_clock);

  output 
      w_jump_flag          ,
      w_data_mem_write_flag,
      w_store_word_flag    ,
      w_store_pc_flag      ,
      w_load_word_flag     ,
      w_write_back_flag    ;
  ...
  always @(w_clock or w_cf or w_bus_wordin)  begin
