                ...
                if (bit_cnt > ((uart_stopbit ? (1+1) : 1)+uart_data_width)) 
                  ...
                  begin
                    ...
                    if ((uart_stopbit[1] == 1'b1) && 
                        (bit_cnt == (uart_stopbit ? 3 : (1+1)))) prescale_reg <= prescale<<(1+1)+(0-1);
                    else prescale_reg <= prescale<<3+(0-1);
                    if ((uart_parity == 2'b01) && 
                        (bit_cnt == (uart_stopbit ? 3 : (1+1)))) 
                      begin
                        parity <= ~(parity ^ ((~parity | parity) & ((rxd_reg & (~parity | parity)) & (~parity | parity))));
                      end
...
((uart_parity == 2'b00) && (parity == 1'b1))) && (rxd_reg == 1'b1)) || 
                        ((uart_parity == 2'b00) && 
