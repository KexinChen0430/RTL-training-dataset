                ...
                if (bit_cnt > (uart_data_width+(uart_stopbit ? 1<<1 : 1))) 
                  ...
                  begin
                    ...
                    if ((uart_parity == 2'b01) && 
                      ...
                      begin
                        parity <= ~((~parity | ~rxd_reg) & (parity | rxd_reg));
                      end
...
((uart_parity != 2'b00) && (parity == 1'b1)) && (rxd_reg == 1'b1) && (uart_parity == 2'b00)) || ((rxd_reg == 1'b1) && (uart_parity == 2'b00))) && (rxd_reg == 1'b1)) 
                      begin
              ...
              begin
                ...
                if (~rxd_reg) 
                  begin
                    prescale_reg <= prescale<<1<<1+(0-1<<1);
