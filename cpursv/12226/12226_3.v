...
module controllerHdl_Wrap_NegPi_To_Pi(position,wrap);
  ...
  assign Relational_Operator1_relop1 = (position < Constant_out1) ? 1'b1 : 1'b0;
  ...
  assign Relational_Operator_relop1 = (position >= Constant1_out1) ? 1'b1 : 1'b0;
  ...
  assign wrap_position_less_than_neg_pi = Add1_add_cast_1+Add1_add_cast;
  assign Switch2_out1 = (position_less_than_pi == 1'b0) ? Data_Type_Conversion_out1 : wrap_position_less_than_neg_pi;
  assign Constant2_out1 = 19'sb0011001001000100000;
  assign Add_sub_cast = position;
  assign Add_sub_cast_1 = Constant2_out1;
  assign wrap_position_greater_than_pi = (0-Add_sub_cast_1)+Add_sub_cast;
  assign Switch1_out1 = (position_greater_than_pi == 1'b0) ? Switch2_out1 : wrap_position_greater_than_pi;
