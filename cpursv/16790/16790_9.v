...
module wb_zbt(input  clk,
  ...
  assign pipeline_in[18:1] = ((({18{prefetch_enable}} | wbB_adr_i[19:2]) & ({18{prefetch_enable}} | {18{bus_selected[1]}})) | ((wbB_adr_i[19:2] | wbA_adr_i[19:2]) & ((wbA_adr_i[19:2] | {18{bus_selected[1]}}) & ((({18{prefetch_enable}} | wbB_adr_i[19:2]) & ({18{prefetch_enable}} | {18{bus_selected[1]}})) | {18{bus_selected[0]}})))) & (((prefetch_address | {18{bus_selected[1]}}) | ((wbA_adr_i[19:2] | {18{bus_selected[1]}}) & {18{bus_selected[0]}})) & ((({18{bus_selected[0]}} & (wbB_adr_i[19:2] | wbA_adr_i[19:2])) | (wbB_adr_i[19:2] | prefetch_address)) & (((wbA_adr_i[19:2] | {18{bus_selected[1]}}) & (wbB_adr_i[19:2] | wbA_adr_i[19:2])) | {18{prefetch_enable}})));
  assign pipeline_in[0] = (bus_selected[0] | bus_selected[1]) & ((bus_selected[0] | wbB_we_i) & ((wbA_we_i | wbB_we_i) & (bus_selected[1] | wbA_we_i)));
  assign sram_a = pipeline_in[18:1];
  assign sram_bw = ~((({4{bus_selected[0]}} & (wbA_sel_i | {4{bus_selected[1]}})) & (wbB_sel_i | wbA_sel_i)) | (((wbA_sel_i | {4{bus_selected[1]}}) & wbB_sel_i) & ((wbB_sel_i | wbA_sel_i) & {4{bus_selected[1]}})));
  assign sram_we = ~pipeline_in[0];
  wire [31:0] bus_wdata;

  assign wbA_ack_o = busA_active & hitA;
  assign wbB_ack_o = hitB & busB_active;
  assign bus_wdata = ({32{hitB}} | (({32{hitB}} | wbA_dat_i) & {32{hitA}})) & (({32{hitB}} | wbA_dat_i) & (wbB_dat_i | ((wbB_dat_i | {32{hitA}}) & wbA_dat_i)));
