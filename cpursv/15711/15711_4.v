...
module VGAController(PixelClock,inRed,inGreen,inBlue,outRed,outGreen,outBlue,
  ...
  assign outRed = ((XTiming <= ((XSynchPulse+XVisible)+XBackPorch)) && 
                  (XTiming >= (XSynchPulse+XBackPorch))) ? inRed : 8'b0;
  assign outGreen = ((XTiming <= ((XSynchPulse+XVisible)+XBackPorch)) && 
                    (XTiming >= (XSynchPulse+XBackPorch))) ? inGreen : 8'b0;
  assign outBlue = ((XTiming <= ((XSynchPulse+XVisible)+XBackPorch)) && 
