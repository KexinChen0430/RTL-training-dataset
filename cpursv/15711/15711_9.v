...
module VGAController(PixelClock,inRed,inGreen,inBlue,outRed,outGreen,outBlue,
  ...
  assign outRed = ((XTiming <= ((XSynchPulse+XBackPorch)+XVisible)) && 
                  (XTiming >= (XSynchPulse+XBackPorch))) ? inRed : 8'b0;
  assign outGreen = ((XTiming <= ((XSynchPulse+XBackPorch)+XVisible)) && 
                    (XTiming >= (XSynchPulse+XBackPorch))) ? inGreen : 8'b0;
  assign outBlue = ((XTiming <= ((XSynchPulse+XBackPorch)+XVisible)) && 
