...
module VGAController(PixelClock,inRed,inGreen,inBlue,outRed,outGreen,outBlue,
  ...
  assign outRed = ((XTiming <= ((XVisible+XBackPorch)+XSynchPulse)) && 
                  (XTiming >= (XBackPorch+XSynchPulse))) ? inRed : 8'b0;
  assign outGreen = ((XTiming <= ((XVisible+XBackPorch)+XSynchPulse)) && 
                    (XTiming >= (XBackPorch+XSynchPulse))) ? inGreen : 8'b0;
  assign outBlue = ((XTiming <= ((XVisible+XBackPorch)+XSynchPulse)) && 
