...
module axi_conduit_merger  #(parameter 
  ...
  (output m_awvalid,
   ...
   input  [(0-1)+DATA_WIDTH:0] m_rdata,
   input  [ID_WIDTH-1:0] m_rid,
   output [(0-1)+DATA_WIDTH:0] m_wdata,
   output [(0-1)+((1/8)*DATA_WIDTH):0] m_wstrb,
   ...
   output [(0-1)+DATA_WIDTH:0] s_rdata,
   output [ID_WIDTH-1:0] s_rid,
   input  [(0-1)+DATA_WIDTH:0] s_wdata,
   input  [(0-1)+((1/8)*DATA_WIDTH):0] s_wstrb,
