...
module axi_conduit_merger  #(parameter 
  ...
  (output m_awvalid,
   ...
   input  m_awready,
   output [(-1)+AXUSER_WIDTH:0] m_awuser,
   output m_arvalid,
   output [3:0] m_arlen,
   ...
   input  m_arready,
   output [(-1)+AXUSER_WIDTH:0] m_aruser,
   input  m_rvalid,
   input  m_rlast,
   input  [1:0] m_rresp,
   output m_rready,
   ...
   output [(-1)+ID_WIDTH:0] m_awid,
   output [ADDRESS_WIDTH-1:0] m_araddr,
   output [(-1)+ID_WIDTH:0] m_arid,
   input  [DATA_WIDTH+(-1):0] m_rdata,
   input  [(-1)+ID_WIDTH:0] m_rid,
   output [DATA_WIDTH+(-1):0] m_wdata,
   output [(-1)+((1/8)*DATA_WIDTH):0] m_wstrb,
   output [(-1)+ID_WIDTH:0] m_wid,
   input  [(-1)+ID_WIDTH:0] m_bid,
   input  s_awvalid,
   input  [3:0] s_awlen,
   ...
   output s_awready,
   input  [(-1)+AXUSER_WIDTH:0] s_awuser,
   input  s_arvalid,
   input  [3:0] s_arlen,
   ...
   output s_arready,
   input  [(-1)+AXUSER_WIDTH:0] s_aruser,
   output s_rvalid,
   output s_rlast,
   output [1:0] s_rresp,
   input  s_rready,
   ...
   input  [(-1)+ID_WIDTH:0] s_awid,
   input  [ADDRESS_WIDTH-1:0] s_araddr,
   input  [(-1)+ID_WIDTH:0] s_arid,
   output [DATA_WIDTH+(-1):0] s_rdata,
   output [(-1)+ID_WIDTH:0] s_rid,
   input  [DATA_WIDTH+(-1):0] s_wdata,
   input  [(-1)+((1/8)*DATA_WIDTH):0] s_wstrb,
   input  [(-1)+ID_WIDTH:0] s_wid,
   output [(-1)+ID_WIDTH:0] s_bid,
   input  [3:0] c_awcache,
   input  [1<<1:0] c_awprot,
   input  [(-1)+AXUSER_WIDTH:0] c_awuser,
   input  [3:0] c_arcache,
   input  [1<<1:0] c_arprot,
   input  [(-1)+AXUSER_WIDTH:0] c_aruser,
   input  clk,
   input  rst_n);
  ...
  wire [3:0] v_awcache;
  wire [1<<1:0] v_awprot;
  wire [(-1)+AXUSER_WIDTH:0] v_awuser;
  reg  [3:0] r_awcache;
  reg  [1<<1:0] r_awprot;
  reg  [(-1)+AXUSER_WIDTH:0] r_awuser;
  wire [3:0] v_arcache;
  wire [1<<1:0] v_arprot;
  wire [(-1)+AXUSER_WIDTH:0] v_aruser;
  reg  [3:0] r_arcache;
  reg  [1<<1:0] r_arprot;
  reg  [(-1)+AXUSER_WIDTH:0] r_aruser;
