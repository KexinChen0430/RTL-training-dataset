...
module MMU_MATCH(USER,READ,WRITE,RMW,MCR_FLAGS,MVALID,VADR_R,MMU_VA,IVAR,
  ...
  assign zugriff = ((WRITE & ((RMW | WRITE) & USER)) | READ) | WRITE;
  ...
  assign match = (VADR_R[31:20] == MMU_VA[31:20]) & (((MVALID[15:0] & maske) != 16'h0000) & (adr_space == as_sorte));
  assign alles_ok = ((~PROT_ERROR & ~WRITE) & (((match | ~WRITE) & (MMU_VA[17] | ~WRITE)) & match)) | (~PROT_ERROR & (MMU_VA[17] & match));
  ...
  assign ena_prot = match & ((zugriff & VIRTUELL) & (MMU_VA[17] | match));
