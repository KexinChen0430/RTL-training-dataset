...
module Cfu(input  cmd_valid,
  ...
  assign cfu0[31:0] = cmd_payload_inputs_1[23:16]+(((cmd_payload_inputs_0[15:8]+cmd_payload_inputs_1[15:8])+(cmd_payload_inputs_1[31:24]+cmd_payload_inputs_0[31:24]))+(cmd_payload_inputs_0[23:16]+(cmd_payload_inputs_1[7:0]+cmd_payload_inputs_0[7:0])));
  wire [31:0] cfu1;
