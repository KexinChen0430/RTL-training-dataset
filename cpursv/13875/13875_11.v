...
module BarrelShifter(inputA,Bse,control,outputBS,N,Zero,C);
      ...
      begin
        ...
        case (control)
          ...
          3: begin
                if (Bse < 32) 
                  begin
                    outputBS = (1<<<1**Bse)*inputA;
                    aux1 = inputA>>(0-Bse)+32;
                    C = |aux1;
                    Zero = zer;
                    N = outputBS[31];
                  end
