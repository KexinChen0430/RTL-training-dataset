...
(!m1_n && (!m1_n || zneg) && zneg && 
((zneg || !iorq_n) && 
((!iorq_n && (zneg || !iorq_n) && zneg) || intctr[9:8] || 
!iorq_n || zneg) && 
((!iorq_n && (zneg || !iorq_n) && zneg) || intctr[9:8] || 
!iorq_n))) || 
((!iorq_n && (zneg || !iorq_n) && zneg) || intctr[9:8])) && ((!m1_n && !iorq_n) || intctr[9:8]) && 
                  (
((!iorq_n && (zneg || !iorq_n) && zneg) || intctr[9:8] || 
(!m1_n && (!m1_n || zneg) && zneg)) && (!m1_n || intctr[9:8]) && 
(
(intctr[9:8] || 
((!m1_n && (!m1_n || zneg) && zneg) || !iorq_n)) && 
(zneg || 
((!iorq_n && (zneg || !iorq_n) && zneg) || intctr[9:8]))));
