...
module zint(input  wire fclk,
  ...
  assign intend = (intctr[9:8] || !iorq_n) && (zneg || intctr[9:8]) && 
                  (
(zneg && 
(
((intctr[9:8] || !iorq_n) && (zneg || intctr[9:8])) || ((zneg || intctr[9:8]) && (intctr[9:8] || !m1_n))) && ((zneg || intctr[9:8]) && (intctr[9:8] || !m1_n))) || (intctr[9:8] || (!iorq_n && !m1_n)));
