...
module jt12_pg_dt(input  [1<<<1:0] block,
                  input  [10:0] fnum,
                  input  [1<<<1:0] detune,
  ...
  always @(*)
      begin
        ...
        case (detune[1:0])
          ...
          2'd1: detune_kf = {1'b0,keycode}+(0-6'd4);

          2'd2: detune_kf = 6'd4+{1'b0,keycode};

          2'd3: detune_kf = 6'd8+{1'b0,keycode};

          default: detune_kf = {1'b0,keycode};

        endcase

        case (detune_kf[1<<<1:0])
        ...
        case (detune_kf[5:3])
          ...
          3'd2: detune_unlimited = {3'd0,pow2[4:1<<<1]};
        ...
        detune_signed = !detune[1<<<1] ? {1'b0,detune_limited} : (6'd1+~{1'b0,detune_limited});
      end
endmodule
