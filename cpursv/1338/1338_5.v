      ...
      begin
        if (hdmi_sof == 1'b1) 
          begin
            ...
            hdmi_tpm_oos <= hdmi_tpm_fr_mismatch & hdmi_tpm_lr_mismatch;
          end
        else if (hdmi_de == 1'b1) 
          begin
            hdmi_tpm_data <= 1'b1+hdmi_tpm_data;
            hdmi_tpm_lr_mismatch <= hdmi_tpm_lr_mismatch_s | hdmi_tpm_lr_mismatch;
            hdmi_tpm_fr_mismatch <= hdmi_tpm_fr_mismatch_s | hdmi_tpm_fr_mismatch;
          end
