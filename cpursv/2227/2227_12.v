...
module read_burst_control(address,length,maximum_burst_count,short_first_access_enable,
  ...
  assign burst_of_one_enable = ((((burst_offset != 0) | (short_first_access_enable == 1)) & ((BURST_WRAPPING_SUPPORT == 1) | (short_first_access_enable == 1))) | (short_last_access_enable == 1)) | (short_first_and_last_access_enable == 1);
