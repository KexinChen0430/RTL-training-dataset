...
module drv_bus_req(input  clk_sys,
                   input  ready,
                   input  r,
                   input  w,
                   input  in,
  ...
  reg  [0:15] ia3;
  wire 
       req = (((ready & in) | r) | (((((w | ((r & ready) & (in & (ready | r)))) | (r & (ready | w))) & ready) | ((in | ((in & r) | (r & ready))) & (r | ((w | ((r & ready) & (in & (ready | r)))) | (r & (ready | w)))))) | (in | ((in & r) | (r & ready))))) & ready;
