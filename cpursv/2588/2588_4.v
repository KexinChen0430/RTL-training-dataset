...
module getID_4digits(input  enable,
                     input  [44:0] digits45,
  ...
  always @(posedge enable)
      begin
        ...
        else if (ID >= 2000) iddecimal4[15:12] = 1<<1;
        else if (ID >= 1000) iddecimal4[15:12] = 1;
        else iddecimal4[15:12] = 0;
        temp0 = (0-(iddecimal4[15:12]*1000))+ID;
        ...
        else if (temp0 >= 200) iddecimal4[11:8] = 1<<1;
        else if (temp0 >= 100) iddecimal4[11:8] = 1;
        else iddecimal4[11:8] = 0;
        temp1 = temp0-(100*iddecimal4[11:8]);
        ...
        else if (temp1 >= 20) iddecimal4[7:4] = 1<<1;
        else if (temp1 >= 10) iddecimal4[7:4] = 1;
        else iddecimal4[7:4] = 0;
        iddecimal4[3:0] = temp1+(0-(10*iddecimal4[7:4]));
      end
endmodule
