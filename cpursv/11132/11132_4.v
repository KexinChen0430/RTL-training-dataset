...
(framing_error || break_detect));
  ...
  assign selected_read_data = ((tx_data & {16{address == 3'd1}}) | ((({16{address == 3'd1}} | {16{address == 3'd0}}) & (tx_data | {16{address == 3'd0}})) & rx_data)) | ((control_reg & {16{address == 3'd3}}) | ((((({16{address == 3'd1}} | (status_reg | ({16{address == 3'd0}} & (((({16{address == 3'd1}} | {16{address == 3'd0}}) & ({16{address == 3'd1}} | rx_data)) & rx_data) & ((({16{address == 3'd2}} | (({16{address == 3'd1}} | {16{address == 3'd0}}) & (tx_data | {16{address == 3'd0}}))) & ((tx_data | rx_data) & ({16{address == 3'd1}} | rx_data))) | (({16{address == 3'd2}} | (({16{address == 3'd1}} | {16{address == 3'd0}}) & (tx_data | {16{address == 3'd0}}))) & {16{address == 3'd2}})))))) & ((({16{address == 3'd1}} | {16{address == 3'd0}}) & ({16{address == 3'd1}} | rx_data)) | {16{address == 3'd2}})) & {16{address == 3'd2}}) & status_reg) | ({16{address == 3'd4}} & baud_divisor)));
...
(break_detect && ie_break_detect))) || (ie_tx_ready && tx_ready) || 
