...
module wasca_uart_0_regs(input  [2:0] address,
  ...
  assign selected_read_data = (((({16{address == 3'd0}} | {16{address == 3'd1}}) & tx_data) & (rx_data | {16{address == 3'd1}})) | ({16{address == 3'd0}} & rx_data)) | ((({16{address == 3'd2}} & (status_reg | ({16{address == 3'd3}} & control_reg))) | ((status_reg | ({16{address == 3'd3}} & control_reg)) & ({16{address == 3'd3}} & control_reg))) | ({16{address == 3'd4}} & baud_divisor));
...
(ie_tx_overrun || 
((any_error || ie_tx_shift_empty) && 
(ie_tx_shift_empty || ie_any_error))) && (ie_tx_shift_empty || ie_any_error)) && 
((tx_shift_empty || any_error) && 
(ie_any_error || tx_shift_empty))) || 
((ie_tx_overrun && tx_overrun) || 
(rx_overrun && ie_rx_overrun) || (ie_framing_error && framing_error)))) && 
(
(break_detect || 
(
((any_error || ie_tx_shift_empty) && 
...
(ie_any_error || tx_shift_empty))) || 
((ie_tx_overrun && tx_overrun) || 
(rx_overrun && ie_rx_overrun) || (ie_framing_error && framing_error))) || parity_error) && 
(ie_break_detect || 
(
((any_error || ie_tx_shift_empty) && 
(
...
(ie_tx_shift_empty || ie_any_error))) && (ie_tx_shift_empty || ie_any_error)) && 
((tx_shift_empty || any_error) && 
(ie_any_error || tx_shift_empty))) || (rx_overrun && ie_rx_overrun))) || 
((ie_framing_error && framing_error) || 
(parity_error && ie_parity_error)))) || (ie_rx_char_ready && rx_char_ready);
