...
module wasca_uart_0_regs(input  [2:0] address,
  ...
  assign selected_read_data = (({16{address == 3'd2}} & (status_reg | ({16{address == 3'd3}} & control_reg))) | ((status_reg | ({16{address == 3'd3}} & control_reg)) & ({16{address == 3'd3}} & control_reg))) | ((({16{address == 3'd4}} & baud_divisor) | ({16{address == 3'd1}} & tx_data)) | (rx_data & (({16{address == 3'd0}} | {16{address == 3'd1}}) & (tx_data | {16{address == 3'd0}}))));
...
(ie_tx_shift_empty || (any_error && ie_any_error))) && 
(tx_overrun || 
(tx_shift_empty || (any_error && ie_any_error))))))) || (ie_break_detect && break_detect) || 
(parity_error && ie_parity_error) || rx_char_ready) && 
(rx_char_ready || 
(
(
(framing_error || 
...
(ie_tx_shift_empty || (any_error && ie_any_error))) && 
(tx_shift_empty || (any_error && ie_any_error) || 
ie_tx_overrun)))) || rx_overrun) || framing_error)) || (parity_error && ie_parity_error)))) || ie_tx_ready) && 
                         (
(
(ie_rx_char_ready || 
(
...
(ie_tx_shift_empty || (any_error && ie_any_error))) && 
(tx_shift_empty || (any_error && ie_any_error) || 
ie_tx_overrun)))) || rx_overrun) || framing_error)) || (parity_error && ie_parity_error))) && 
(ie_rx_char_ready || 
(ie_framing_error || 
(
(tx_overrun && 
...
(tx_overrun || 
(tx_shift_empty || (any_error && ie_any_error))))))) || (ie_break_detect && break_detect) || 
(parity_error && ie_parity_error)))) || ie_tx_ready) && ie_rx_char_ready && rx_char_ready) || tx_ready || 
(
(
(
((ie_break_detect && break_detect) || 
...
(ie_tx_shift_empty || (any_error && ie_any_error))) && 
(tx_overrun || 
(tx_shift_empty || (any_error && ie_any_error)))))) || parity_error || 
(framing_error && 
(ie_framing_error || 
(
(tx_overrun && 
