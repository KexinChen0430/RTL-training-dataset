...
module shift(Inst,Enable,RD2_input,ALUSrc2_output);
  ...
  assign internal_output = (sh[1] == 1) ? ((sh[0] == 1) ? (RD2_input<<(0-shamt5)<<<32 | RD2_input>>shamt5) : (RD2_input>>shamt5 | ({32{1'b1}}<<(0-shamt5)*(2**32)))) : 
                           (sh[0] == 1) ? RD2_input>>shamt5 : (RD2_input*(2**shamt5));
