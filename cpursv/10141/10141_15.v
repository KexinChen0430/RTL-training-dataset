...
module shift(Inst,Enable,RD2_input,ALUSrc2_output);
  ...
  assign internal_output = (sh[1] == 1) ? ((sh[0] == 1) ? (RD2_input<<(32+(0-shamt5)) | RD2_input>>shamt5) : ({32{1'b1}}<<<(0-shamt5)<<32 | RD2_input>>shamt5)) : 
                           (sh[0] == 1) ? RD2_input>>shamt5 : ((1<<<1**shamt5)*RD2_input);
