      ...
      begin
        ...
        case (cpu_state_d)
          ...
          NORMAL: begin
                ...
                if (((!pl_stall_mem & (pl_stall_eret | pl_stall_branch)) | ((((exception & pl_stall_branch) | ((exception & pl_stall_branch) & (exception & !pl_stall_mem))) | (exception & !pl_stall_mem)) | ((pl_stall_eret & !pl_stall_mem) | ((exception & pl_stall_branch) & (exception & !pl_stall_mem))))) | exception) 
                  begin
                    instr_next = !pmem_cmdok & !(((exception & !pl_stall_mem) | pl_stall_eret) | exception);
                    pl_instr_fstage = ((!pmem_cmdok | (exception & pl_stall_eret)) | (((exception & !pl_stall_mem) | pl_stall_eret) | exception)) ? 32'd0 : pmem_cmd;
