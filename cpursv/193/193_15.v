      ...
      begin
        ...
        case (cpu_state_d)
          ...
          NORMAL: begin
                ...
                if (((((exception | (((!pl_stall_mem & exception) | pl_stall_branch) | (exception & (pl_stall_eret & (!pl_stall_mem | exception))))) & (!pl_stall_mem | exception)) & pl_stall_branch) | (((exception & (pl_stall_eret & (!pl_stall_mem | exception))) | (!pl_stall_mem & exception)) | (pl_stall_eret & !pl_stall_mem))) | ((exception | (((!pl_stall_mem & exception) | pl_stall_branch) | (exception & (pl_stall_eret & (!pl_stall_mem | exception))))) & (!pl_stall_mem | exception))) 
                  begin
                    instr_next = !(pl_stall_eret | exception) & !pmem_cmdok;
                    pl_instr_fstage = (exception | (((!pl_stall_mem & exception) | (!pmem_cmdok | pl_stall_eret)) | (exception & pl_stall_branch))) ? 32'd0 : pmem_cmd;
