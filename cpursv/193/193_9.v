      ...
      begin
        ...
        case (cpu_state_d)
          ...
          NORMAL: begin
                ...
                if ((((((pl_stall_eret & exception) | (!pl_stall_mem & (pl_stall_eret & exception))) | (!pl_stall_mem & ((!pl_stall_mem | pl_stall_branch) & (((pl_stall_eret & exception) | pl_stall_branch) | exception)))) | ((exception & pl_stall_branch) | (pl_stall_eret & exception))) | exception) | (pl_stall_eret & (exception | !pl_stall_mem))) 
                  begin
                    instr_next = !(exception | pl_stall_eret) & !pmem_cmdok;
                    pl_instr_fstage = (!pmem_cmdok | (exception | pl_stall_eret)) ? 32'd0 : pmem_cmd;
