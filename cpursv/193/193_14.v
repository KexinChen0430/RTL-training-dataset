      ...
      begin
        ...
        case (cpu_state_d)
          ...
          NORMAL: begin
                ...
                if ((((pl_stall_branch & !pl_stall_mem) | (((!pl_stall_mem & exception) | ((exception & ((exception | pl_stall_eret) & pl_stall_branch)) | (exception & pl_stall_eret))) | (((((exception & ((exception | pl_stall_eret) & pl_stall_branch)) & (!pl_stall_mem & exception)) | (pl_stall_eret & (!pl_stall_mem & exception))) | (pl_stall_branch & !pl_stall_mem)) | (((exception & ((exception | pl_stall_eret) & pl_stall_branch)) | (exception & pl_stall_eret)) & (!pl_stall_mem & exception))))) | exception) | ((((((exception & ((exception | pl_stall_eret) & pl_stall_branch)) & (!pl_stall_mem & exception)) | (pl_stall_branch | (exception & pl_stall_eret))) | pl_stall_eret) & !pl_stall_mem) & pl_stall_eret)) 
                  begin
                    instr_next = !pmem_cmdok & !(exception | pl_stall_eret);
                    pl_instr_fstage = ((!pmem_cmdok | pl_stall_eret) | (exception | pl_stall_eret)) ? 32'd0 : pmem_cmd;
