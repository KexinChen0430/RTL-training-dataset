      ...
      begin
        ...
        case (cpu_state_d)
          ...
          NORMAL: begin
                ...
                if (((pl_stall_branch | (pl_stall_eret | (exception & !pl_stall_mem))) & !pl_stall_mem) | exception) 
                  begin
                    instr_next = !(exception | (pl_stall_eret | (exception & pl_stall_branch))) & !pmem_cmdok;
                    pl_instr_fstage = ((exception | (pl_stall_eret | (exception & pl_stall_branch))) | (!pmem_cmdok | (exception & !pl_stall_mem))) ? 32'd0 : pmem_cmd;
