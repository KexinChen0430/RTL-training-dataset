...
module xnor_test;
  ...
  begin
    ...
    for (small1 = 0; small1 < 15; small1 = 1+small1)
        begin
          large1 = {12'b0,small1};
    ...
    for (large1 = 0; large1 < 1000; large1 = 1+large1)
        begin
          large2 = 1511+large1;
          large3 = ~((~large1 | ~large2) & ((~large2 | large2) & (large2 | large1)));
          large4 = (large1 | ((~large1 & ~large2) | (~large2 & large2))) & ((large1 & large2) | ((~large2 | large2) & ~large1));
          if (large3 !== large4) 
            begin
              fail = 1;
