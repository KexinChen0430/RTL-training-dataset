...
module read_data(input  [3:0] h_byte_en_n,
  ...
  always @* 
      begin
        ...
        case (current_state)
          ...
          m2hrd_state0: begin
                m2hrd_s0 = 1'b1;
                if (((((en_cy4_ff | en_cy1_ff) & mem_read) | en_cy2_ff) & mem_read) | (en_cy3_ff & mem_read)) next_state = m2hrd_state1;
                else next_state = m2hrd_state0;
              end

          m2hrd_state1: begin
                m2hrd_s1 = 1'b1;
                if ((((en_cy4_ff & dly_rd_en) | en_cy3_ff) & (mem_read & dly_rd_en)) | (((((((en_cy4_ff | (en_cy3_ff & dly_rd_en)) & mem_read) & en_cy3_ff) & dly_rd_en) | (en_cy4_ff & dly_rd_en)) | ((en_cy2_ff & mem_read) & dly_rd_en)) & ((en_cy2_ff | en_cy3_ff) & mem_read))) next_state = m2hrd_state2;
          ...
          m2hrd_state2: begin
                m2hrd_s2 = 1'b1;
                if (((en_cy4_ff & dly_rd_en) | en_cy3_ff) & (mem_read & dly_rd_en)) next_state = m2hrd_state3;
          ...
          m2hrd_state3: begin
                m2hrd_s3 = 1'b1;
                if ((mem_read & (en_cy4_ff & ((en_cy4_ff & dly_rd_en) | en_cy3_ff))) & dly_rd_en) next_state = m2hrd_state4;
  ...
  assign wren_1 = wren[1] & (((wren[1] & rd_en_0) | rd_en_1) & (wren[1] | rd_en_0));
  assign wren_2 = (rd_en_0 & wren[2]) | ((wren[2] & (rd_en_1 | wren[0])) & rd_en_1);
