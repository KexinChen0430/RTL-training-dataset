...
module read_data(input  [3:0] h_byte_en_n,
  ...
  always @* 
      begin
        ...
        case (current_state)
          ...
          m2hrd_state0: begin
                m2hrd_s0 = 1'b1;
                if (mem_read & ((((en_cy2_ff & (((en_cy3_ff | en_cy2_ff) | mem_read) | en_cy1_ff)) & mem_read) | ((en_cy3_ff | en_cy4_ff) | (mem_read & en_cy1_ff))) & (((mem_read & en_cy1_ff) | en_cy4_ff) | mem_read))) next_state = m2hrd_state1;
                else next_state = m2hrd_state0;
              end

          m2hrd_state1: begin
                m2hrd_s1 = 1'b1;
                if (((mem_read & (dly_rd_en | ((en_cy2_ff | ((((en_cy3_ff | en_cy4_ff) & (dly_rd_en | en_cy4_ff)) & dly_rd_en) & ((en_cy3_ff & (dly_rd_en | en_cy4_ff)) & (en_cy3_ff | en_cy4_ff)))) | (dly_rd_en & en_cy2_ff)))) & dly_rd_en) & (((dly_rd_en & en_cy2_ff) | en_cy3_ff) | (dly_rd_en & en_cy4_ff))) next_state = m2hrd_state2;
          ...
          m2hrd_state2: begin
                m2hrd_s2 = 1'b1;
                if ((((en_cy3_ff | en_cy4_ff) & (dly_rd_en | en_cy4_ff)) & dly_rd_en) & mem_read) next_state = m2hrd_state3;
          ...
          m2hrd_state3: begin
                m2hrd_s3 = 1'b1;
                if (((((en_cy3_ff | en_cy4_ff) & (dly_rd_en | en_cy4_ff)) & dly_rd_en) & mem_read) & (dly_rd_en & en_cy4_ff)) next_state = m2hrd_state4;
                else if ((((en_cy3_ff | en_cy4_ff) & (dly_rd_en | en_cy4_ff)) & dly_rd_en) & ((en_cy3_ff & (dly_rd_en | en_cy4_ff)) & (en_cy3_ff | en_cy4_ff))) next_state = m2hrd_state5;
                else next_state = m2hrd_state3;
              end

          m2hrd_state4: begin
                m2hrd_s4 = 1'b1;
                if ((mem_read & (dly_rd_en | ((en_cy2_ff | ((((en_cy3_ff | en_cy4_ff) & (dly_rd_en | en_cy4_ff)) & dly_rd_en) & ((en_cy3_ff & (dly_rd_en | en_cy4_ff)) & (en_cy3_ff | en_cy4_ff)))) | (dly_rd_en & en_cy2_ff)))) & dly_rd_en) next_state = m2hrd_state5;
  ...
  always @* 
      begin
        casex ({m2hrd_s1,m2hrd_s2,m2hrd_s3,m2hrd_s4,m_odd_even})
          ...
          5'b01xx0: begin
                if (((h_byte_en_n == (h_byte_en_n | 4'b1001)) == (4'b0101 | h_byte_en_n)) == 4'b0001) wren[3:0] = 4'b1100;
  ...
  assign wren_0 = (rd_en_0 | rd_en_1) & wren[0];
  assign wren_1 = wren[1] & (rd_en_0 | rd_en_1);
  assign wren_2 = (rd_en_0 | rd_en_1) & wren[2];
  assign wren_3 = wren[3] & (rd_en_0 | (rd_en_1 & wren[3]));
