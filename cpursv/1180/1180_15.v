...
module works_only_with_16_32_64_gtx_input_data_width;
  ...
  always @(posedge clk)
      rxcom_timer <= ((rst | ((rxcominitdet & ((state_wait_comwake & rxcomwakedet) | state_wait_cominit)) | (state_wait_comwake & rxcomwakedet))) | ((rxcominit_done | (state_wait_comwake & rxcomwake_done)) & ((state_wait_comwake & rxcomwake_done) | state_wait_cominit))) ? 10'h0 : 
                    (((((state_idle | rxcominitdet_l) & cominit_req_l) | rxcominitdet_l) & ((cominit_req_l | state_wait_cominit) & (state_idle | state_wait_cominit))) | ((((state_wait_comwake | (state_idle | state_wait_cominit)) & ((cominit_req_l | state_wait_cominit) | state_wait_comwake)) & (((cominit_req_l & state_idle) | state_wait_comwake) | rxcominitdet_l)) & rxcomwakedet_l)) ? (rxcom_timer+CLK_TO_TIMER_CONTRIB[9:0]) : 10'h0;
