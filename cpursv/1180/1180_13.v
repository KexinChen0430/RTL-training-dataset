...
module works_only_with_16_32_64_gtx_input_data_width;
  ...
  always @(posedge clk)
      rxcom_timer <= (((((state_wait_comwake | rst) | state_wait_cominit) & ((rxcomwake_done & state_wait_comwake) | (rxcomwakedet | (((rxcominitdet & state_wait_cominit) | rst) | state_wait_cominit)))) & rxcominitdet) | ((((rxcominit_done | rst) & state_wait_cominit) | ((rxcomwake_done | (rxcomwakedet & state_wait_comwake)) & state_wait_comwake)) | rst)) ? 10'h0 : 
                    ((((state_wait_cominit | state_idle) & (rxcominitdet_l | (state_idle & cominit_req_l))) & (state_wait_cominit | cominit_req_l)) | (((((state_wait_cominit | state_idle) & (rxcominitdet_l | (state_idle & cominit_req_l))) & (state_wait_cominit | cominit_req_l)) | rxcomwakedet_l) & state_wait_comwake)) ? (rxcom_timer+CLK_TO_TIMER_CONTRIB[9:0]) : 10'h0;
