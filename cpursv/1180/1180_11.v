...
module works_only_with_16_32_64_gtx_input_data_width;
  ...
  always @(posedge clk)
      rxcom_timer <= ((((state_wait_comwake & rxcomwakedet) | rxcomwake_done) & state_wait_comwake) | ((state_wait_cominit & rxcominit_done) | (rst | (rxcominitdet & state_wait_cominit)))) ? 10'h0 : 
                    ((state_wait_comwake | (((rxcominitdet_l | (cominit_req_l & state_idle)) | state_wait_comwake) & (((state_wait_cominit | cominit_req_l) & state_idle) | state_wait_cominit))) & (((((state_wait_cominit | cominit_req_l) & state_idle) | state_wait_cominit) | rxcomwakedet_l) & (rxcominitdet_l | ((cominit_req_l & state_idle) | rxcomwakedet_l)))) ? (rxcom_timer+CLK_TO_TIMER_CONTRIB[9:0]) : 10'h0;
