...
module works_only_with_16_32_64_gtx_input_data_width;
  ...
  always @(posedge clk)
      rxcom_timer <= ((state_wait_comwake & ((rst | ((rxcominitdet & state_wait_cominit) | ((rxcomwake_done & state_wait_comwake) | rxcomwakedet))) | (state_wait_cominit & (rxcominit_done | rst)))) | ((rst | ((rxcominitdet | (rxcomwake_done & state_wait_comwake)) | (rxcominit_done & (rst | state_wait_cominit)))) & ((((rxcomwake_done & state_wait_comwake) | rxcominit_done) & ((state_wait_comwake | state_wait_cominit) & (state_wait_cominit | rxcomwake_done))) | (rst | state_wait_cominit)))) ? 10'h0 : 
                    (((rxcomwakedet_l | ((rxcominitdet_l & state_wait_cominit) | (((rxcominitdet_l & state_wait_cominit) | state_idle) & cominit_req_l))) & state_wait_comwake) | ((rxcominitdet_l & state_wait_cominit) | (((rxcominitdet_l & state_wait_cominit) | state_idle) & cominit_req_l))) ? (rxcom_timer+CLK_TO_TIMER_CONTRIB[9:0]) : 10'h0;
