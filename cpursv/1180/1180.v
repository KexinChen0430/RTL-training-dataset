...
module works_only_with_16_32_64_gtx_input_data_width;
  ...
  always @(posedge clk)
      rxcom_timer <= ((((rst | (rxcominit_done & state_wait_cominit)) | (rxcomwake_done & state_wait_comwake)) | (rxcominitdet & state_wait_cominit)) | (rxcomwakedet & state_wait_comwake)) ? 10'h0 : 
                    (((cominit_req_l & state_idle) | (rxcominitdet_l & state_wait_cominit)) | (rxcomwakedet_l & state_wait_comwake)) ? (rxcom_timer+CLK_TO_TIMER_CONTRIB[9:0]) : 10'h0;
