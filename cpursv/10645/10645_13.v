...
module altera_avalon_st_bytes_to_packets  #(parameter  CHANNEL_WIDTH = 8, ENCODING = 0)
  ...
  assign data_out = received_esc ? ((~in_data | ~8'h20) & (8'h20 | ((in_data & (~in_data | ~8'h20)) & ~8'h20))) : in_data;
                  ...
                  begin
                    if (in_ready & in_valid) 
                      begin
                        ...
                        if ((((~escape_char & ((received_esc | ~eop_char) & (received_esc | ~sop_char))) & received_channel) | (received_channel & received_esc)) & (~channel_char | (received_channel & received_esc))) 
                          begin
                            received_channel <= 0;
                          end
                          
                        if ((~channel_char | received_esc) & ((received_varchannel & ~varchannelesc_char) & (((~eop_char & ~sop_char) | (received_varchannel & (received_esc & ~varchannelesc_char))) & (~escape_char | (received_varchannel & (received_esc & ~varchannelesc_char)))))) 
                          begin
                            received_varchannel <= 0;
                          end
              ...
              begin
                if (!reset_n) 
                  ...
                  begin
                    if (in_ready & in_valid) 
                      begin
                        if (~eop_char & ((~escape_char & (ENCODING & channel_char)) & (~sop_char & ~received_esc))) 
                          begin
                            out_channel <= 'h0;
                          end
                        else if ((~received_channel & ((((~escape_char & ~channel_char) | received_esc) & ((received_esc | ~eop_char) & (received_esc | ~sop_char))) & received_varchannel)) | (((((~escape_char & ~channel_char) | received_esc) & ((received_esc | ~eop_char) & (received_esc | ~sop_char))) & received_varchannel) & received_esc)) 
                          begin
                  ...
                  begin
                    if (in_ready & in_valid) 
                      begin
                        ...
                        else if (~eop_char & ((~escape_char & (ENCODING & channel_char)) & (~sop_char & ~received_esc))) 
                          begin
                            out_channel <= 'h0;
                          end
                        else if ((~received_channel & ((((~escape_char & ~channel_char) | received_esc) & ((received_esc | ~eop_char) & (received_esc | ~sop_char))) & received_varchannel)) | (((((~escape_char & ~channel_char) | received_esc) & ((received_esc | ~eop_char) & (received_esc | ~sop_char))) & received_varchannel) & received_esc)) 
