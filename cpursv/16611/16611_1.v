            ...
            if (io_stb_i) 
              begin
                case (io_addr_i[11:8])
                  ...
                  4'd0: io_data_o <= periph0_data_i;

                  4'd1: io_data_o <= periph1_data_i;

                  4'd2: io_data_o <= periph2_data_i;

                  4'd3: io_data_o <= periph3_data_i;

                  4'd4: io_data_o <= periph4_data_i;

                  4'd5: io_data_o <= periph5_data_i;

                  4'd6: io_data_o <= periph6_data_i;

                  4'd7: io_data_o <= periph7_data_i;
