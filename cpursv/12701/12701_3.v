...
module TMCounter  #(parameter  CNT_PRESC = 24, ENA_TMR = 1)
  ...
  assign blk_we = wb_stb_i && ENA_TMR && (wb_we_i && (wb_adr_i == 3'b111));
  assign wb_ack_o = wb_stb_i && 
                    (
((cnt_blk_r == 0) && 
(((state == DELAY) || !blk_we) && 
((state == DELAY) || wb_stb_i))) || 
((!blk_we || wb_stb_i) && ((state == DELAY) || !blk_we) && 
wb_stb_i && !blk_we));
  ...
  always @(posedge wb_clk_i)
      begin : do_pwm_val_write
        if (wb_stb_i && (wb_adr_i != 3'b111) && 
            (!wb_rst_i && ((wb_adr_i != 3'b110) && wb_we_i))) pwm_val_r[wb_adr_i] <= wb_dat_i;
  ...
  always @(posedge wb_clk_i)
      begin : do_pwm_ena_write
        ...
        else if (wb_we_i && (wb_adr_i == 3'b110) && (!blk_we || wb_stb_i) && 
