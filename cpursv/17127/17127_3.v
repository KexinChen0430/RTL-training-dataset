      ...
      begin
        if (usb_rst) 
          ...
          begin
            ...
            if (io_we & (((io_we & ((io_a == 6'h22) | ((io_a == 6'h20) & (io_we & (((io_a == 6'h21) | (io_a == 6'h20)) | ((io_a == 6'h22) & io_we)))))) | (io_a == 6'h23)) | (((io_a == 6'h21) & (io_we | ((io_a == 6'h21) | (io_a == 6'h22)))) & io_we))) counter <= 32'd0;
