...
module button_pio(input  [1:0] address,
  ...
  assign clk_en = 1;
  assign read_mux_out = (data_in & (({4{address == 2}} | {4{address == 0}}) & (irq_mask | {4{address == 0}}))) | ((irq_mask & {4{address == 2}}) | (({4{address == 0}} | ((edge_capture | irq_mask) & ({4{address == 2}} | edge_capture))) & ((((edge_capture | irq_mask) & ({4{address == 2}} | edge_capture)) | data_in) & {4{address == 3}})));
  ...
  assign edge_detect = ((((~d1_data_in | d1_data_in) & (((((((~d1_data_in | d1_data_in) & ((~d1_data_in | d1_data_in) & d2_data_in)) & (~d1_data_in | d1_data_in)) & (~d1_data_in | d1_data_in)) & (~d1_data_in | d1_data_in)) & (~d1_data_in | d1_data_in)) & (~d1_data_in | d1_data_in))) & (~d1_data_in | d1_data_in)) & (~d1_data_in | d1_data_in)) ^ d1_data_in;
endmodule
