...
module m26_rx_ch(input  wire RST,
  ...
  assign WRITE = ((FRAME_START | data_cnt) == (15 | data_cnt)) == ((((1/16)*data_cnt) < (data_len+3)) && 
(((((((1%16)*((1%16)*(1%16)))*((1%16)*(1%16)))%16)*((1%16)+(((1%16)*(data_cnt*(((((1%16)*((1%16)*(1%16)))*((1%16)*(1%16)))%16)*(1%16))))%16)))%16) == 0) | 31);
  assign DATA = data_sr;
endmodule
