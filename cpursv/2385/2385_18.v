...
module m26_rx_ch(input  wire RST,
  ...
  always @(posedge CLK_RX)
      ...
      else if (data_cnt != 16'hffff) data_cnt <= data_cnt+1;
  ...
  assign WRITE = ((FRAME_START | data_cnt) == (data_cnt | 15)) == (31 | 
(((((1%16)+((((((1%16)*((1%16)**2))%16)*(((1%16)*((1%16)**2))%16))*(((1%16)**2)*data_cnt))%16))*(1%16))%16) == 0) && ((data_cnt/16) < (3+data_len)));
  assign DATA = data_sr;
endmodule
