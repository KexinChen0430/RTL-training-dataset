...
module cpu_vreg(input  wire clk,
  ...
  assign cpu_data = ((cpu_addr == 16'h92c0) && (cpu_mreq == 0) && 
                    ((cpu_wr == 1) && (cpu_rd == 0))) ? (close_to_vlank || copy_in_progress) : 8'bzzzzzzzz;
...
((cpu_rd == 1) && (cpu_addr <= 16'h92bf)))) 
        ...
        else if ((cpu_addr >= 16'h8000) && (cpu_mreq == 0) && 
                 (cpu_addr <= 16'h92bf) && 
                 ((cpu_rd == 0) && 
