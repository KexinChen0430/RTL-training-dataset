...
module cpu_vreg(input  wire clk,
  ...
  assign cpu_data = ((cpu_mreq == 0) && (cpu_wr == 1) && (cpu_rd == 0) && 
                    (cpu_addr == 16'h92c0)) ? (copy_in_progress || close_to_vlank) : 8'bzzzzzzzz;
  assign cpu_data = vram_read ? back_vram_data : 8'bzzzzzzzz;
  
  always @(posedge clk)
      begin
        if ((cpu_wr == 0) && 
            ((cpu_rd == 1) && (copy_in_progress == 0) && 
((cpu_addr <= 16'h92bf) && (cpu_mreq == 0) && 
(cpu_addr >= 16'h8000)))) 
          begin
        ...
        else if ((cpu_addr <= 16'h92bf) && 
                 ((cpu_addr >= 16'h8000) && (copy_in_progress == 0) && 
(cpu_wr == 1)) && ((cpu_mreq == 0) && (cpu_rd == 0))) 
          begin
            back_vram_addr = cpu_addr[12:0];
            back_vram_rd_low = 0;
            vram_read = 1;
