...
module cpu_vreg(input  wire clk,
  ...
  assign cpu_data = ((cpu_mreq == 0) && (cpu_rd == 0) && 
                    ((cpu_addr == 16'h92c0) && (cpu_wr == 1))) ? (close_to_vlank || copy_in_progress) : 8'bzzzzzzzz;
  assign cpu_data = vram_read ? back_vram_data : 8'bzzzzzzzz;
  
  always @(posedge clk)
      begin
        if ((cpu_addr >= 16'h8000) && (cpu_mreq == 0) && 
            (copy_in_progress == 0) && 
            ((cpu_rd == 1) && 
((cpu_addr <= 16'h92bf) && (cpu_wr == 0)))) 
          begin
            ...
            vram_read = 0;
                 ...
                 ((cpu_addr >= 16'h8000) && 
((copy_in_progress == 0) && (cpu_wr == 1)) && ((cpu_mreq == 0) && (cpu_rd == 0)))) 
          begin
            back_vram_addr = cpu_addr[12:0];
            back_vram_rd_low = 0;
            vram_read = 1;
