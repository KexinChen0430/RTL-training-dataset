...
module altera_customins_master_translator  #(parameter  SHARED_COMB_AND_MULTI = 0)
  ...
  generate
      if (SHARED_COMB_AND_MULTI == 0) 
        ...
        begin
          ...
          assign ci_slave_result = ci_slave_multi_done ? multi_ci_master_result : comb_ci_master_result;
        end
  endgenerate
