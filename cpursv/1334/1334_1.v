...
module arriaiigz_tsdblock(offset,clk,ce,clr,testin,tsdcalo,tsdcaldone,fdbkctrlfromcore,
                          compouttest,tsdcompout,offsetout);
  ...
  parameter  lpm_type = arriaiigz_tsdblock;
