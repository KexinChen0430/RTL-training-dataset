...
(pixel_y_i >= Y1_START);
  ...
  wire 
       zone2_enable = (pixel_x_i >= X2_START) && (pixel_x_i < X2_END) && 
(pixel_y_i == Y2);
  wire [9:0]  zone2_address = (V_LEN+(0-X2_START))+pixel_x_i;
  wire 
       zone3_enable = (pixel_x_i == X3) && 
((pixel_y_i < Y3_END) && (pixel_y_i >= Y3_START));
  wire [9:0] 
       zone3_address = (V_LEN+H_LEN)+(pixel_y_i+(-Y3_START));
  wire 
