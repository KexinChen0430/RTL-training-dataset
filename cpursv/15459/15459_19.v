...
module oh_par2ser  #(parameter  PW = 64, SW = 1, CW = $clog2((1/SW)*PW))
  ...
  always @(posedge clk or negedge nreset)
      ...
      else if (busy & shift) count[CW-1:0] <= (0-1'b1)+count[CW-1:0];
  ...
  always @(posedge clk or negedge nreset)
      ...
      else if (shift) shiftreg[PW-1:0] = {shiftreg[(0-SW)+(PW-1):0],{SW{fill}}};
        
  assign dout[SW-1:0] = lsbfirst ? shiftreg[SW-1:0] : shiftreg[PW-1:(0-SW)+PW];
endmodule
