...
module shift_division_result(quotient,fraction,res);
  ...
  parameter signed  [31:0]  vec_MSB = ((-1)+f_width)+q_width;
  parameter signed  [31:0]  result_MSB = fraction_width+(q_width+(-1));
  parameter signed  [31:0]  result_LSB = (-result_MSB)+vec_MSB;
  input  [q_width+(-1):0] quotient;
  input  [(-1)+f_width:0] fraction;
