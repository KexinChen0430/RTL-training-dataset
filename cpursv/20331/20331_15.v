...
module shift_division_result(quotient,fraction,res);
  ...
  parameter signed  [31:0]  vec_MSB = (q_width+(0-1))+f_width;
  parameter signed  [31:0]  result_MSB = q_width+(fraction_width+(0-1));
  parameter signed  [31:0]  result_LSB = vec_MSB-result_MSB;
  input  [q_width+(0-1):0] quotient;
