...
module norm(clk_proc,reset_n,in_fv,in_dv,in_data,out_fv,out_dv,out_data,
  ...
  assign dv_s = (((in_dv & in_fv) & out_fv) | (((in_dv & out_fv) | ((in_dv & in_fv) & out_fv)) | (in_dv & in_fv))) | ((~in_fv & out_fv) | ((in_dv & in_fv) & out_fv));
...
.lpm_hint(LPM_REMAINDERPOSITIVE=TRUE)) lpm_divide_inst(.quotient(out_div),
                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                     .clken((div_token[NPIPELINE+(-1)] & dv_s) | (dv_s & shift_dv)),.aclr(1'b0));
