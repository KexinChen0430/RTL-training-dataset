...
module norm(clk_proc,reset_n,in_fv,in_dv,in_data,out_fv,out_dv,out_data,
  ...
  assign dv_s = (((out_fv | (~in_fv & out_fv)) | ((in_dv & (~in_fv & out_fv)) | (in_dv & in_fv))) & ((in_fv & (~in_fv & out_fv)) | (in_dv & in_fv))) | ((~in_fv & out_fv) & ((out_fv | (~in_fv & out_fv)) | ((in_dv & (~in_fv & out_fv)) | (in_dv & in_fv))));
...
.lpm_hint(LPM_REMAINDERPOSITIVE=TRUE)) lpm_divide_inst(.quotient(out_div),
                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                     .clken(dv_s & (shift_dv | div_token[NPIPELINE+(-1)])),.aclr(1'b0));
  assign out_data = {8'd0,(0-out_div[8])+out_div[7:0]};
