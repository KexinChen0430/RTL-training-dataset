  ...
  always @(negedge clk)
      begin
        ...
        blank = ((vcounter < (V_PERIOD-V_FRONTPORCH)) && 
                ...
                ((hcounter >= (H_PULSEWIDTH+H_BACKPORCH)) && 
(hcounter < ((-H_FRONTPORCH)+H_PERIOD)))) ? 0 : 1;
        hcounter = hcounter+1;
        ...
        hcount = ((hcounter >= (H_PULSEWIDTH+H_BACKPORCH)) && 
                 (hcounter < ((-H_FRONTPORCH)+H_PERIOD))) ? (((0-H_BACKPORCH)+(0-H_PULSEWIDTH))+hcounter) : 0;
        vcount = ((vcounter < (V_PERIOD-V_FRONTPORCH)) && 
                 (vcounter >= (V_BACKPORCH+V_PULSEWIDTH))) ? ((vcounter-V_PULSEWIDTH)+(0-V_BACKPORCH)) : 0;
      end
endmodule
