...
(hcounter < (H_PERIOD-H_FRONTPORCH)))) ? 0 : 1;
        hcounter = 1+hcounter;
        ...
        hcount = ((hcounter >= (H_PULSEWIDTH+H_BACKPORCH)) && 
                 (hcounter < (H_PERIOD-H_FRONTPORCH))) ? (((-H_BACKPORCH)+hcounter)+(0-H_PULSEWIDTH)) : 0;
        vcount = ((vcounter < (V_PERIOD+(-V_FRONTPORCH))) && 
                 (vcounter >= (V_BACKPORCH+V_PULSEWIDTH))) ? ((vcounter-V_PULSEWIDTH)-V_BACKPORCH) : 0;
      end
endmodule
