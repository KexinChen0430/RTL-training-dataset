...
(vcounter < (V_PERIOD+(0-V_FRONTPORCH))))) ? 0 : 1;
        hcounter = 1+hcounter;
        ...
        hcount = ((hcounter >= (H_BACKPORCH+H_PULSEWIDTH)) && 
                 (hcounter < ((0-H_FRONTPORCH)+H_PERIOD))) ? (((0-H_PULSEWIDTH)+hcounter)+(0-H_BACKPORCH)) : 0;
        vcount = ((vcounter >= (V_BACKPORCH+V_PULSEWIDTH)) && 
                 (vcounter < (V_PERIOD+(0-V_FRONTPORCH)))) ? (((0-V_BACKPORCH)+vcounter)+(-V_PULSEWIDTH)) : 0;
      end
endmodule
