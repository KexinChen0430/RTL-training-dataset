...
(vcounter < ((-V_FRONTPORCH)+V_PERIOD)))) ? 0 : 1;
        hcounter = hcounter+1;
        ...
        hcount = ((hcounter >= (H_PULSEWIDTH+H_BACKPORCH)) && 
                 (hcounter < ((0-H_FRONTPORCH)+H_PERIOD))) ? (((0-H_PULSEWIDTH)+hcounter)+(-H_BACKPORCH)) : 0;
        vcount = ((vcounter >= (V_PULSEWIDTH+V_BACKPORCH)) && 
                 (vcounter < ((-V_FRONTPORCH)+V_PERIOD))) ? ((vcounter+(-V_BACKPORCH))+(0-V_PULSEWIDTH)) : 0;
      end
endmodule
