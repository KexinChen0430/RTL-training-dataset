...
(vcounter < ((0-V_FRONTPORCH)+V_PERIOD)))) ? 0 : 1;
        hcounter = 1+hcounter;
        ...
        hcount = ((hcounter >= (H_BACKPORCH+H_PULSEWIDTH)) && 
                 (hcounter < (H_PERIOD-H_FRONTPORCH))) ? ((0-H_PULSEWIDTH)+((0-H_BACKPORCH)+hcounter)) : 0;
        vcount = ((vcounter >= (V_BACKPORCH+V_PULSEWIDTH)) && 
                 (vcounter < ((0-V_FRONTPORCH)+V_PERIOD))) ? (((-V_PULSEWIDTH)+(-V_BACKPORCH))+vcounter) : 0;
      end
endmodule
