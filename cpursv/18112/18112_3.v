...
(hcounter >= (H_BACKPORCH+H_PULSEWIDTH)))) ? 0 : 1;
        hcounter = 1+hcounter;
        ...
        hcount = ((hcounter < ((-H_FRONTPORCH)+H_PERIOD)) && 
                 (hcounter >= (H_BACKPORCH+H_PULSEWIDTH))) ? ((0-H_BACKPORCH)+(hcounter+(0-H_PULSEWIDTH))) : 0;
        vcount = ((vcounter >= (V_BACKPORCH+V_PULSEWIDTH)) && 
                 (vcounter < (V_PERIOD+(-V_FRONTPORCH)))) ? (((-V_BACKPORCH)+vcounter)+(-V_PULSEWIDTH)) : 0;
      end
endmodule
