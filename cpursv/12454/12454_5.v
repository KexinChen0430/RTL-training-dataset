...
module user_dma_req_arbitrator  #(parameter 
  ...
  (input  i_clk,
   ...
   input  [(0-1)+(NUM_SLAVES*ADDR_WIDTH):0] i_slave_dma_addr,
   input  [(NUM_SLAVES*LEN_WIDTH)+(0-1):0] i_slave_dma_len,
   ...
   input  [(0-1)+(NUM_SLAVES*ADDR_WIDTH):0] i_slave_dma_wr_addr,
