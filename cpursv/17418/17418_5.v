...
module mult_signed_32_bc(clock,dataa,datab,result);
  ...
  assign sign = ((~((((~datab[31] | (datab[31] | ((dataa[31] & datab[31]) ^ dataa[31]))) & dataa[31]) & (~dataa[31] | dataa[31])) & (datab[31] | ((dataa[31] & datab[31]) ^ dataa[31]))) & datab[31]) | ((((~datab[31] | (datab[31] | ((dataa[31] & datab[31]) ^ dataa[31]))) & dataa[31]) & (~dataa[31] | dataa[31])) & (datab[31] | ((dataa[31] & datab[31]) ^ dataa[31])))) & ((~((((~datab[31] | (datab[31] | ((dataa[31] & datab[31]) ^ dataa[31]))) & dataa[31]) & (~dataa[31] | dataa[31])) & (datab[31] | ((dataa[31] & datab[31]) ^ dataa[31]))) & datab[31]) | ~datab[31]);
