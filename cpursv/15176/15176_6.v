...
module jt10_adpcmb(input  rst_n,
  ...
  reg  signed  [xw+(0-1):0] x1,next_x5;
  reg  [stepw+(0-1):0] step1;
  reg  [1+stepw:0] next_step3;

  assign pcm = x1[xw+(0-1):xw-16];
  wire [xw+(0-1):0]  limpos = {1'b0,{xw+(0-1){1'b1}}};

  wire [xw+(0-1):0]  limneg = {1'b1,{xw+(0-1){1'b0}}};
            ...
            begin
              ...
              if (chon) 
                begin
                  if (adv2[0]) 
                    begin
                      if ((sign_data5 == x1[xw+(0-1)]) && 
                          (x1[xw+(0-1)] != next_x5[xw+(0-1)])) x1 <= x1[xw+(0-1)] ? limneg : limpos;
                      else x1 <= next_x5;
