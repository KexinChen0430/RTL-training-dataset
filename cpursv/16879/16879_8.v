...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign v1_rising_edge = (0-is_ap_line)+is_v1_rising_edge;
  ...
  assign h_total_minus_one_nxt = is_h_blank+((-16'd1)+is_sample_count_f0);
  assign v_total_minus_one_nxt = v_total+(-16'd1);
  assign ap_line_nxt = is_ap_line;
  assign ap_line_end_nxt = v_total+(0-is_ap_line);
  assign h_blank_nxt = is_h_blank;
  assign sav_nxt = (0-trs)+is_h_blank;
  ...
  assign f_falling_edge_nxt = v_total+(-(is_ap_line+(0-is_f_falling_edge)));
  assign total_line_count_f0_nxt_full = ((is_v_blank+is_v1_front_porch)+(0-is_v_front_porch))+(is_line_count_f0+(-16'd1));
  assign total_line_count_f1_nxt_full = (is_v1_blank+(-16'd1))+(is_line_count_f1+(is_v_front_porch+(-is_v1_front_porch)));
  ...
  assign f2_anc_v_start_nxt = (-(is_ap_line-is_anc_line))+v_total;
  assign f1_anc_v_start_nxt = is_v1_anc_line+(0-is_ap_line);
endmodule
