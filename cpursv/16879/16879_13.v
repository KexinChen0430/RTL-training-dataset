...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign f_falling_edge_nxt = (0-(is_ap_line+(-is_f_falling_edge)))+v_total;
  assign total_line_count_f0_nxt_full = (is_line_count_f0+(-16'd1))+((0-is_v_front_porch)+(is_v1_front_porch+is_v_blank));
  assign total_line_count_f1_nxt_full = ((is_v_front_porch+is_line_count_f1)+(is_v1_blank+(0-is_v1_front_porch)))+(-16'd1);
