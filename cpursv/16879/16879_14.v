...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign v1_rising_edge = (-is_ap_line)+is_v1_rising_edge;
  ...
  assign f_falling_edge_nxt = v_total+(0-((-is_f_falling_edge)+is_ap_line));
  assign total_line_count_f0_nxt_full = ((-is_v_front_porch)+is_v1_front_porch)+(((0-16'd1)+is_line_count_f0)+is_v_blank);
  assign total_line_count_f1_nxt_full = is_line_count_f1+(((0-16'd1)+(0-is_v1_front_porch))+(is_v_front_porch+is_v1_blank));
