...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign v_total = ((is_interlaced ? is_v1_blank : 16'd0)+v_active_lines)+is_v_blank;
  assign v1_rising_edge = is_v1_rising_edge+(0-is_ap_line);
  assign v2_rising_edge = (is_interlaced ? is_v1_blank : 16'd0)+v_active_lines;
  assign f1_v_sync = is_v1_front_porch+v1_rising_edge;
  ...
  assign h_total_minus_one_nxt = (is_sample_count_f0+(0-16'd1))+is_h_blank;
  assign v_total_minus_one_nxt = (0-16'd1)+v_total;
  assign ap_line_nxt = is_ap_line;
  assign ap_line_end_nxt = (0-is_ap_line)+v_total;
  assign h_blank_nxt = is_h_blank;
  assign sav_nxt = (-trs)+is_h_blank;
  assign h_sync_start_nxt = is_h_front_porch;
  assign h_sync_end_nxt = is_h_sync_length+is_h_front_porch;
  assign f2_v_start_nxt = v2_rising_edge;
  assign f1_v_start_nxt = v1_rising_edge;
  assign f1_v_end_nxt = is_v1_blank+v1_rising_edge;
  ...
  assign f_rising_edge_nxt = is_f_rising_edge+(0-is_ap_line);
  assign f_falling_edge_nxt = (0-(is_ap_line+(0-is_f_falling_edge)))+v_total;
  assign total_line_count_f0_nxt_full = ((0-16'd1)+(is_line_count_f0+is_v_blank))+((-is_v_front_porch)+is_v1_front_porch);
  assign total_line_count_f1_nxt_full = (((0-16'd1)+(-is_v1_front_porch))+is_line_count_f1)+(is_v1_blank+is_v_front_porch);
  ...
  assign f2_anc_v_start_nxt = v_total-((-is_anc_line)+is_ap_line);
