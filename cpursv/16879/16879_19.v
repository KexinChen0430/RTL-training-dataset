...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign total_line_count_f0_nxt_full = (is_v_blank+is_line_count_f0)+(((0-is_v_front_porch)+is_v1_front_porch)+(-16'd1));
  assign total_line_count_f1_nxt_full = ((-16'd1)+(-is_v1_front_porch))+((is_v_front_porch+is_v1_blank)+is_line_count_f1);
  ...
  assign f2_anc_v_start_nxt = (0-(is_ap_line+(-is_anc_line)))+v_total;
