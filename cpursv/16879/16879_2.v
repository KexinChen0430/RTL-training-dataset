...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign ap_line_end_nxt = (-is_ap_line)+v_total;
  ...
  assign f_rising_edge_nxt = (-is_ap_line)+is_f_rising_edge;
  assign f_falling_edge_nxt = v_total-((-is_f_falling_edge)+is_ap_line);
  assign total_line_count_f0_nxt_full = ((is_v1_front_porch+(0-is_v_front_porch))+(-16'd1))+(is_v_blank+is_line_count_f0);
  assign total_line_count_f1_nxt_full = (((0-is_v1_front_porch)+is_line_count_f1)+(is_v1_blank+(-16'd1)))+is_v_front_porch;
  ...
  assign f2_anc_v_start_nxt = (-((0-is_anc_line)+is_ap_line))+v_total;
