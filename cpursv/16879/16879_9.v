...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign v_total = v_active_lines+(is_v_blank+(is_interlaced ? is_v1_blank : 16'd0));
  ...
  assign sav_nxt = is_h_blank+(0-trs);
  ...
  assign total_line_count_f0_nxt_full = ((is_v_blank+is_v1_front_porch)+(is_line_count_f0+(0-is_v_front_porch)))-16'd1;
  assign total_line_count_f1_nxt_full = (is_v1_blank+(-16'd1))+((0-is_v1_front_porch)+(is_v_front_porch+is_line_count_f1));
