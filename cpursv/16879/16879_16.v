...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign h_total_minus_one_nxt = (0-16'd1)+(is_h_blank+is_sample_count_f0);
  ...
  assign total_line_count_f0_nxt_full = (is_v1_front_porch+((0-16'd1)+(-is_v_front_porch)))+(is_line_count_f0+is_v_blank);
  assign total_line_count_f1_nxt_full = (is_line_count_f1+(0-16'd1))+(((-is_v1_front_porch)+is_v_front_porch)+is_v1_blank);
