...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign f_falling_edge_nxt = v_total+(0-(is_ap_line-is_f_falling_edge));
  assign total_line_count_f0_nxt_full = ((is_v1_front_porch+(-is_v_front_porch))+(0-16'd1))+(is_v_blank+is_line_count_f0);
  assign total_line_count_f1_nxt_full = (((0-16'd1)+(is_v_front_porch+is_line_count_f1))+(-is_v1_front_porch))+is_v1_blank;
  ...
  assign f2_anc_v_start_nxt = v_total-(is_ap_line+(0-is_anc_line));
  assign f1_anc_v_start_nxt = (0-is_ap_line)+is_v1_anc_line;
endmodule
