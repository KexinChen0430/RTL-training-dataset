...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign total_line_count_f0_nxt_full = (is_v1_front_porch+(is_v_blank+(-is_v_front_porch)))+(is_line_count_f0+(-16'd1));
  assign total_line_count_f1_nxt_full = (is_v_front_porch+(-16'd1))+(is_line_count_f1+(is_v1_blank+(-is_v1_front_porch)));
