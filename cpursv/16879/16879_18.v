...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign h_total_minus_one_nxt = (-16'd1)+(is_h_blank+is_sample_count_f0);
  ...
  assign f_falling_edge_nxt = (-(is_ap_line-is_f_falling_edge))+v_total;
  assign total_line_count_f0_nxt_full = ((-16'd1)+is_v_blank)+((is_line_count_f0+is_v1_front_porch)+(-is_v_front_porch));
  assign total_line_count_f1_nxt_full = (is_v_front_porch+(0-is_v1_front_porch))+((is_line_count_f1+(-16'd1))+is_v1_blank);
