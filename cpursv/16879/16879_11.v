...
module alt_vipitc131_IS2Vid_calculate_mode(input  [3:0] trs,
  ...
  assign v_total_minus_one_nxt = v_total+(0-16'd1);
  ...
  assign f_falling_edge_nxt = (-((-is_f_falling_edge)+is_ap_line))+v_total;
  assign total_line_count_f0_nxt_full = is_line_count_f0+(((is_v1_front_porch+(0-16'd1))+is_v_blank)+(0-is_v_front_porch));
  assign total_line_count_f1_nxt_full = (((is_v1_blank+is_v_front_porch)+is_line_count_f1)+(0-is_v1_front_porch))+(0-16'd1);
  ...
  assign f2_anc_v_start_nxt = v_total-((0-is_anc_line)+is_ap_line);
