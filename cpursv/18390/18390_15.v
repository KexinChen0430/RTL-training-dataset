...
module fltr_compute_h1(clk,din,dout);
  ...
  always @(posedge clk)
      begin
        ...
        q7 <= 5'b10001*din[7:0];
        d_out_tmp <= ({q1[16],q1[16],q1[16],q1}+{q2[16],q2[16],q2[16],q2})+(({q5[16],q5[16],q5[16],q5}+({q7[16],q7[16],q7[16],q7}+{q3[16],q3[16],q3[16],q3}))+({q6[16],q6[16],q6[16],q6}+{q4[16],q4[16],q4[16],q4}));
        dout <= d_out_tmp[18:3];
      end
endmodule
