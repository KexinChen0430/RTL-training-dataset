...
module dcm_sp_clock_lost(clock,enable,lost,rst);
  ...
  always @(posedge clock or posedge rst)
      if (rst == 1) period <= 0;
        ...
        begin
          ...
          else if ((clock_edge != 0) && 
                   ((clock_second_pos == 1) && (period == 0))) period <= period_tmp;
  ...
  always @(period)
      begin
        ...
        period_chk_win = ((1/10)*9.1)*period;
      end
        ...
        begin
          if ((enable == 1) && (clock_second_neg == 1)) 
            begin
              ...
              #(period_chk_win) 
                if ((period <= period_neg) && (clock_high != 1) && 
                    ((rst == 0) && (clock_negedge != 1))) lost_f <= 1;
