  ...
  always @(posedge clock or posedge rst)
      if (rst == 1) period <= 0;
        ...
        begin
          ...
          else if ((clock_second_pos == 1) && (period == 0) && 
        ...
        begin
          ...
          if ((period_neg != 0) && 
              (period_neg_tmp <= period_neg_tmp_win)) period_neg <= period_neg_tmp;
                   ...
                   ((clock_second_neg == 1) && (clock_edge_neg != 0))) period_neg <= period_neg_tmp;
        ...
        begin
          if ((enable == 1) && (clock_second_neg == 1)) 
            begin
              ...
              #(period_chk_win) 
                if ((rst == 0) && (clock_high != 1) && 
                    ((period <= period_neg) && (clock_negedge != 1))) lost_f <= 1;
