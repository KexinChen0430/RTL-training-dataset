...
module dcm_sp_clock_lost(clock,enable,lost,rst);
      ...
      if (rst == 1) period <= 0;
        ...
        begin
          ...
          if ((period != 0) && (period_tmp <= period_tmp_win)) period <= period_tmp;
                   ...
                   ((clock_edge != 0) && (period == 0))) period <= period_tmp;
  ...
  always @(negedge clock or posedge rst)
      if (rst) period_neg <= 0;
        ...
        begin
          clock_edge_neg <= $time;
          period_neg_tmp = (-clock_edge_neg)+$time;
          if ((period_neg != 0) && 
          ...
          else if ((clock_edge_neg != 0) && 
                   ((clock_second_neg == 1) && (period_neg == 0))) period_neg <= period_neg_tmp;
  ...
  always @(posedge clock or posedge rst)
      if (rst) lost_r <= 0;
        ...
        begin
          ...
          #(period_chk_win) 
            if ((rst == 0) && (clock_posedge != 1) && (clock_low != 1)) lost_r <= 1;
        ...
        begin
          if ((clock_second_neg == 1) && (enable == 1)) 
            begin
              ...
              #(period_chk_win) 
                if ((clock_negedge != 1) && (clock_high != 1) && 
                    ((period <= period_neg) && (rst == 0))) lost_f <= 1;
