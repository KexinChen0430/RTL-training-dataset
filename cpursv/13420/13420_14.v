  ...
  always @(negedge clock or posedge rst)
      if (rst) period_neg <= 0;
        ...
        begin
          ...
          else if ((clock_second_neg == 1) && 
                   ((clock_edge_neg != 0) && (period_neg == 0))) period_neg <= period_neg_tmp;
  ...
  always @(posedge clock or posedge rst)
      if (rst) lost_r <= 0;
        ...
        begin
          ...
          #(period_chk_win) 
            if ((rst == 0) && 
                ((clock_posedge != 1) && (clock_low != 1))) lost_r <= 1;
        ...
        begin
          if ((clock_second_neg == 1) && (enable == 1)) 
            begin
              ...
              #(period_chk_win) 
                if ((clock_high != 1) && (clock_negedge != 1) && (rst == 0) && 
                    (period <= period_neg)) lost_f <= 1;
