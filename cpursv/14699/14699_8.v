...
module soc_system_button_pio(address,chipselect,clk,in_port,reset_n,write_n,writedata,irq,
  ...
  assign clk_en = 1;
  assign read_mux_out = (((((irq_mask & {4{address == 2}}) | {4{address == 3}}) & ((({4{address == 2}} & ((data_in & (({4{address == 0}} | ((data_in | {4{address == 2}}) & {4{address == 0}})) | {4{address == 2}})) & (((data_in & ({4{address == 0}} | irq_mask)) | irq_mask) & {4{address == 0}}))) | (irq_mask & {4{address == 2}})) | ((data_in & (({4{address == 0}} | ((data_in | {4{address == 2}}) & {4{address == 0}})) | {4{address == 2}})) & (((data_in & ({4{address == 0}} | irq_mask)) | irq_mask) & {4{address == 0}})))) | (({4{address == 3}} | {4{address == 0}}) & (({4{address == 3}} | (data_in & (({4{address == 0}} | ((data_in | {4{address == 2}}) & {4{address == 0}})) | {4{address == 2}}))) & edge_capture))) | ((edge_capture & irq_mask) & {4{address == 2}})) | ((data_in & (({4{address == 0}} | ((data_in | {4{address == 2}}) & {4{address == 0}})) | {4{address == 2}})) & (((data_in & ({4{address == 0}} | irq_mask)) | irq_mask) & {4{address == 0}}));
