...
module mem_16nm_bist_ctrl(input  wire bist_clk,
          ...
          begin
            if (bist_on) 
              begin
                ...
                bist_en_1 <= #0 1'b1;
                bist_en_2 <= #0 1'b1;
                bist_addr_0 <= #0 1+bist_addr_0;
                bist_addr_1 <= #0 1+bist_addr_1;
                bist_addr_2 <= #0 1+bist_addr_2;
                bist_wr_data_0 <= #0 1+bist_wr_data_0;
                bist_wr_data_1 <= #0 1+bist_wr_data_1;
