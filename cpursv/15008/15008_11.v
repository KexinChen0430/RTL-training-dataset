...
module tmu2_ctlif  #(parameter  csr_addr = 4'h0, fml_depth = 26)
  (input  sys_clk,
   input  sys_rst,
   input  [13:0] csr_a,
   input  csr_we,
                ...
                if (csr_we) 
                  begin
                    case (csr_a[4:0])
                      ...
                      5'b00110: tex_fbuf <= csr_di[(0-1)+fml_depth:1];
                      ...
                      5'b01011: dst_fbuf <= csr_di[(0-1)+fml_depth:1];
