...
module bw_r_tlb_data_ram(rd_data,rw_index_vld,wr_vld_tmp,clk,cam_vld,rw_index,
  ...
  wire 
       wr_en = (rw_index_vld & (~rw_disable & wr_vld_tmp)) | (((~rw_index_vld & tlb_index_vld) & wr_vld_tmp) & ~rw_disable);
  ...
  wire 
       rd_en = ((cam_vld | (rd_data & (~rw_disable | cam_vld))) | rd_data) & ~rw_disable;
  ...
  always @(negedge clk)
      begin
        if (((~rw_disable | rd_data) & (cam_vld & !cam_hit_any)) & ~rw_disable) 
          begin
