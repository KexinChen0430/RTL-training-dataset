...
module memory_epp(input  wire mclk,
                  input  wire epp_astb,
                  input  wire epp_dstb,
                  input  wire epp_wr,
                  output reg epp_wait,
            ...
            case (epp_state)
              ...
              epp_state_data_read: begin
                    ...
                    case (epp_address)
                      ...
                      epp_reg_status: epp_data_reg <= {status,6'b0};

                      epp_reg_mem_addr: epp_data_reg <= address_array[index];

                      epp_reg_mem_data: epp_data_reg <= din_array[index];

                      default: epp_data_reg <= 0;
              ...
              epp_state_data_write: begin
                    epp_wait <= 1;
                    if (epp_address == epp_reg_mem_data) 
                      begin
