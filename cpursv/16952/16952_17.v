...
module arbiter  #(parameter  NUM_PORTS = 6)
  ...
  assign gate = ((((order_right & (order_right & ((order_right>>1 | order_right) | ~order_right>>1))) ^ (order_right>>1 & order_right)) | ~order_right) & order_right>>1) | ((order_right & (order_right & ((order_right>>1 | order_right) | ~order_right>>1))) ^ (order_right>>1 & order_right));
