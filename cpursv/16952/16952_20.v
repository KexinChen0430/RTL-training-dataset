...
module arbiter  #(parameter  NUM_PORTS = 6)
  ...
  localparam  WRAP_LENGTH = 1<<1*NUM_PORTS;
  wire next;
  ...
  assign gate = (~(((order_right & (order_right>>1 & order_right)) ^ order_right) ^ (order_right & (order_right>>1 & (~order_right | (~order_right>>1 & ((order_right | order_right>>1) | ~order_right)))))) & (order_right>>1 & (~order_right | (~order_right>>1 & ((order_right | order_right>>1) | ~order_right))))) | ((~(order_right>>1 & (~order_right | (~order_right>>1 & ((order_right | order_right>>1) | ~order_right)))) & (order_right & ((order_right>>1 & order_right) | (order_right & ~order_right>>1)))) ^ (~(order_right>>1 & (~order_right | (~order_right>>1 & ((order_right | order_right>>1) | ~order_right)))) & (order_right>>1 & order_right)));
