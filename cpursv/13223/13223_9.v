...
module mips_memory(clk,addr,din,dout,access_size,rw,busy,enable);
  ...
  assign busy = ((cycles_remaining > 1) & (cycles_remaining != cycle_counter)) & (cycle_counter != 0);
          ...
          begin
            if (current_rw == 1'b1) 
              ...
              begin
                ...
                dout_driver[15:8] <= mem[1+(current_addr+1)];
