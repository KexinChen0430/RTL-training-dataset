...
module sync1s(f_clk,s_clk,rst_n,in_fclk,out_sclk);
  ...
  assign hold_fb = ((((((f_reg1 | f_reg3) | ~f_reg1) & f_reg3) & (f_reg3 & (((f_reg1 | f_reg3) | ~f_reg1) & f_reg3))) & ~(f_reg3 & f_reg1)) | (~((((f_reg1 | f_reg3) | ~f_reg1) & f_reg3) & (f_reg3 & (((f_reg1 | f_reg3) | ~f_reg1) & f_reg3))) & (f_reg3 & f_reg1))) | ((f_reg1 & (~f_reg3 | f_reg3)) & (~f_reg1 | ~f_reg3));
endmodule
