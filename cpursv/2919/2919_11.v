  ...
  always @(posedge clk or negedge reset_n)
      begin
        if (reset_n == 0) active_and_waiting_last_time <= 0;
          ...
          active_and_waiting_last_time <= (kernel_clock_0_out_waitrequest & kernel_clock_0_out_read) | (kernel_clock_0_out_write & kernel_clock_0_out_waitrequest);
      end
