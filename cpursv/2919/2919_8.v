...
module kernel_clock_0_out_arbitrator(input  clk,
  ...
  assign r_2 = (((1 & kernel_clock_0_out_write) & (~d1_vga_0_avalon_slave_0_end_xfer & vga_0_avalon_slave_0_wait_counter_eq_0)) | (1 & ~kernel_clock_0_out_qualified_request_vga_0_avalon_slave_0)) | ((((kernel_clock_0_out_read & (~d1_vga_0_avalon_slave_0_end_xfer & 1)) | (kernel_clock_0_out_read & (~kernel_clock_0_out_qualified_request_vga_0_avalon_slave_0 | ~kernel_clock_0_out_read))) | ~kernel_clock_0_out_read) & (~kernel_clock_0_out_write & 1));
