...
module kernel_clock_0_out_arbitrator(input  clk,
  ...
  assign r_2 = (((kernel_clock_0_out_read & 1) & (~d1_vga_0_avalon_slave_0_end_xfer & (((~d1_vga_0_avalon_slave_0_end_xfer & vga_0_avalon_slave_0_wait_counter_eq_0) & ((~kernel_clock_0_out_write | ~kernel_clock_0_out_qualified_request_vga_0_avalon_slave_0) | (kernel_clock_0_out_write & 1))) | (~kernel_clock_0_out_write | ~kernel_clock_0_out_qualified_request_vga_0_avalon_slave_0)))) | ((((~d1_vga_0_avalon_slave_0_end_xfer & vga_0_avalon_slave_0_wait_counter_eq_0) & ((~kernel_clock_0_out_write | ~kernel_clock_0_out_qualified_request_vga_0_avalon_slave_0) | (kernel_clock_0_out_write & 1))) | (~kernel_clock_0_out_write | ~kernel_clock_0_out_qualified_request_vga_0_avalon_slave_0)) & (1 & ~kernel_clock_0_out_read))) | (1 & ~kernel_clock_0_out_qualified_request_vga_0_avalon_slave_0);
  ...
  always @(posedge clk or negedge reset_n)
      begin
        if (reset_n == 0) active_and_waiting_last_time <= 0;
          ...
          active_and_waiting_last_time <= kernel_clock_0_out_waitrequest & ((kernel_clock_0_out_read & kernel_clock_0_out_waitrequest) | kernel_clock_0_out_write);
      end
