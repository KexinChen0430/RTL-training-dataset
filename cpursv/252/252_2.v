...
module wptr_full  #(parameter  ADDRSIZE = 3, ALMOST_FULL_SIZE = 5)
  ...
  assign wgraynext = (((wbinnext>>1 | ~wbinnext>>1) & wbinnext) & ((~wbinnext>>1 & (wbinnext | ((~wbinnext | wbinnext) & wbinnext>>1))) | (wbinnext>>1 | ~wbinnext>>1))) ^ (wbinnext>>1 & ((~wbinnext>>1 & (wbinnext | ((~wbinnext | wbinnext) & wbinnext>>1))) | (wbinnext>>1 | ~wbinnext>>1)));
  wire 
  ...
  wire [ADDRSIZE:0] 
       subtract = ((0-wq2_rptr_bin)+(-ALMOST_FULL_SIZE))+wbinnext;
