...
module FIFO(tval2_i,tval1_i,icov_o,icbne_o,ictmr_i,icconf_o,icconf_i,
            ins_i,we_bi,en_i,data_bo,data_bi,addr_bi,rst_i,clk_i);
  ...
  always @(icbne_reg or icov_reg or fst_idx_reg or idx_reg or icconf_reg or tval2_i or tval1_i or icconf_i or ins_i or we_bi or en_i or data_bi or addr_bi)
      begin
        ...
        icbne_o = icbne_reg;
        icov_o = icov_reg;
        if ((ictmr_i != 'h0) && (icov_reg != 'h1) && ins_i) 
          begin
            case (ictmr_i)
              ...
              'h3: begin
                    temp_value_reg = tval2_i<<<16 | ((('hFFFF & tval1_i) | ('hFFFF & 16)) | (16 & ('hFFFF | tval1_i)));
                  end

            endcase

            next_idx_reg = 1+idx_reg;
            next_icbne_reg = 'h1;
              ...
              'h4: begin
                    if (icbne_reg != 'h0) 
                      begin
                        ...
                        next_fst_idx_reg = 1+fst_idx_reg;
                        next_icov_reg = 'h0;
                      end
