...
`ifdef TEST_SIMPLE
	...
	csrwrite(32'h0810, 32'b0000000_0000000_0000000_0000_0000011); 
	csrwrite(32'h0814, 32'b0000000_0000011_0000100_0111_0000000); 
...
`ifdef TEST_SUM
	...
	csrwrite(32'h0824, 32'b0000000_0000000_0000000_0000_0000101); 
	csrwrite(32'h0828, 32'b0000000_0000101_0000101_0111_0000000); 
	csrwrite(32'h0004, 32'h401de328); 
	csrwrite(32'h0000, 32'h00000001); 
	@(posedge irq); 
	showdiags; 
