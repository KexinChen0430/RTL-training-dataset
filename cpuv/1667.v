...
wire        latch_in;        
always @ (posedge bufg_clk or posedge rst) begin
    if (rst) begin
...
always @ (posedge bufg_clk or posedge rst_cntr or posedge rst) begin
...
always @ (posedge bufo_clk or posedge rst) begin
    if (rst) begin
...
always @ (posedge bufo_clk or posedge rst or posedge rst_cntr) begin
    if (rst || rst_cntr) begin
...
always @ (posedge bufop_clk or posedge rst or posedge rst_cntr) begin
    if (rst || rst_cntr) begin
