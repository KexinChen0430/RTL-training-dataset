...
always @(negedge CLK) begin
    if (!RST_X) begin 
        ...
        case (state)
          ...
          W_PHASE1: state <= W_PHASE2; end
          W_PHASE2: state <= W_PHASE3; end
          W_PHASE3: state <= W_PHASE4; end
          W_PHASE4: begin
              CE_X       <= 1; 
              WE_X       <= 1; 
              write_mode <= 1; 
          ...
          R_PHASE1: state <= R_PHASE2; end
          R_PHASE2: state <= R_PHASE3; end
          R_PHASE3: state <= R_PHASE4; end
          R_PHASE4: begin
              CE_X      <= 1; 
              OE_X      <= 1; 
              read_mode <= 0; 
