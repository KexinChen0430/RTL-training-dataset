...
always @ (posedge clk) begin
    if (enable) begin
        ...
        if (tFracC2[52:0] == 0) begin
            sgnc = 0;
            tFracC = 0;
            exc = 0;
        end else if (tFracC2[53:52] == 0) begin
            if (tFracC2[52:21] == 0) begin
