module pcx_buf_p0_odd(
   ...
   arbpc4_pcxdp_shift_px, sctag1_pcx_stall_bufp0odd_pq,
   ...
   arbpc4_pcxdp_shift_bufp1_px_l, sctag1_pcx_stall_pq
   );
   ...
   output 		sctag1_pcx_stall_bufp0odd_pq;
