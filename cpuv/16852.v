module pipedereg(
  i_wreg, i_m2reg, i_wmem, i_aluc, i_aluimm, i_a, i_b, i_imm, i_rn, i_shift, i_jal, i_pc4, i_sa,
  clk, rst,
  o_wreg, o_m2reg, o_wmem, o_aluc, o_aluimm, o_a, o_b, o_imm, o_rn, o_shift, o_jal, o_pc4, o_sa
);
