...
decode_32 decode_ut(		
	...
	.reset_in(reset),			
	.clk_in(clk),				
	.insn_pc_in(insn_address),			
	.stall_in(stall),			
	.reg_select_out(reg_select),		
	.rsa_out(rsa),				
	.rsb_out(rsb),				
	.rd_out(rd),				
	.imm_out(imm),				
	.aluop_out(aluop),			
	.jlnk_out(jlnk),			
	.pc_change_rel_out(pc_change_relative),	
	.pc_change_abs_out(pc_change_absolute),	
	.mem_read_out(mem_read),		
	.mem_write_out(mem_write),		
	.nri_flg_out(nri_flag),			
	.branch_funct_out(branch_funct),	
	.stall_out(stall_output),			
	.memsync_out(memsync),			
	.syscall_out(syscall),			
	.pem_inc_req_out(permission_inc),		
	.pem_dec_req_out(permission_dec),		
	.sysreg_addr_out(sysreg_addr),		
	.sysreg_data_out(sysreg_data),		
	.sysreg_data_in(sysreg_data_input),		
	.insn_pc_out(insn_pc_output),			
	.cp_insn_out(cp_insn)			
	);
integer i;
integer count;
