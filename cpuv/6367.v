...
input[1:0] RegRead,                 
output Rs_LoudUse_Forward,          
output Rt_LoudUse_Forward           
);
assign Rs_EX_Forward = ((RegDst[1] === 1'b1)&&((Rs_From_ID_EX === Rd_From_EX_MEM) && (RegWrite_From_EX_MEM !== 4'b0000)))?(2'b01):
                       ((RegDst[1] === 1'b1) && (Rs_From_ID_EX === Rd_From_MEM_WB) && (RegWrite_From_MEM_WB !== 4'b0000)?2'b10:2'b00);
assign Rt_EX_Forward = ((RegDst[0] === 1'b1)&&((Rt_From_ID_EX === Rd_From_EX_MEM) && (RegWrite_From_EX_MEM !== 4'b0000)))?(2'b01):
                       ((RegDst[0] === 1'b1) && (Rt_From_ID_EX === Rd_From_MEM_WB) && (RegWrite_From_MEM_WB !== 4'b0000)?2'b10:2'b00);
