...
always @ (State, MFC)
    case (State)
        3'b000 : begin  end 
        3'b001 : begin  IR_CU = 1; CU = 4'hf; MARLOAD = 1; opcode = 16; end 
        3'b010 : begin  IR_CU = 1; CU = 4'hf; opcode = 17; PCLOAD = 1; end 
        3'b011 : begin  MFA = 1; READ_WRITE = 1; WORD_BYTE = 1; end 
        3'b100 : begin  MBRLOAD = 1; IRLOAD = 1; end 
        3'b101 : begin  end 
        3'b110 : begin  end 
        default : begin end
    endcase
