...
output reg ex_wb_memtoreg;
output reg ex_mem_memread;
output reg ex_mem_memwrite;
output reg ex_mem_ll_mem;
output reg ex_mem_sc_mem;
output reg ex_regdst;
output reg [1:0] ex_aluop;
output reg ex_alusrc;
output reg [31:0] ex_regread1;
output reg [31:0] ex_regread2;
output reg [31:0] ex_sign_extend;
output reg [4:0] ex_reg_rs;
output reg [4:0] ex_reg_rt;
output reg [4:0] ex_reg_rd;
