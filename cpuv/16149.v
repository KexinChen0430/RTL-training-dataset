module wb_bridge_16_32
  #(parameter AWIDTH=16) 
    (input wb_clk, input wb_rst, 
     ...
     input [AWIDTH-1:0] A_adr_i, input [31:0] A_dat_i, 
     output [31:0] A_dat_o, output A_ack_o, 
     output B_cyc_o, output B_stb_o, output B_we_o, output [1:0] B_sel_o, 
     output [AWIDTH-1:0] B_adr_o, output [15:0] B_dat_o, 
     input [15:0] B_dat_i, input B_ack_i 
     );
   reg [15:0] 		 holding; 
   reg 			 phase; 
