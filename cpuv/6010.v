...
assign cmd_write_stop = cmd_in[3:0] == 4'b1001;
assign cmd_read = cmd_in[3:0] == 4'b1000;
assign cmd_atomic_cas = cmd_in[3:0] == 4'b1011;
assign cmd_atomic_add = cmd_in[3:0] == 4'b1100;
assign cmd_atomic_and = cmd_in[3:0] == 4'b1101;
assign cmd_atomic_or = cmd_in[3:0] == 4'b1110;
assign cmd_atomic_xor = cmd_in[3:0] == 4'b1111;
