module arriaiigz_dpa_retime_block(
    clkin,    
    datain,   
    reset,    
    clk0,     
...
always @(posedge clkin) begin
    if (first_clkin_edge_detect == 1'b0) begin
    ...
    if (((clk_period == last_clk_period) || (clk_period == last_clk_period - 1) || (clk_period == last_clk_period + 1)) &&
        (clk_period != 0) && (last_clk_period != 0)) begin
        lock_tmp = 1'b1;
    end else begin
        lock_tmp = 1'b0;
    end
