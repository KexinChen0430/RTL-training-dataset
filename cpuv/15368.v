module register(
    data1, data2, data4, data5, data7, data8, data10, data11,
    data3, data6, data9, data12, data13,
    reg_number1, reg_number2, reg_number3, reg_number4, reg_number5, reg_number6,
    reg_number7, reg_number8, reg_number9, reg_number10, reg_number11, reg_number12,
    reg_number13,
    read1, read2, read4, read5, read7, read8, read10, read11,
    write3, write6, write9, write12, write13
);
